...
namespace GeneXus.Programs {
   public class tipoclienteprompt : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918535149", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tipoclienteprompt.js", "?202551918535149", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public class tipoclienteprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(TipoClienteId,'9999'), 2) like '%' || :lV14FilterFullText) or ( TipoClienteDescricao like '%' || :lV14FilterFullText) or ( 'física' like '%' || LOWER(:lV14FilterFullText) and TipoClienteTipoPessoa = ( 'FISICA')) or ( 'jurídica' like '%' || LOWER(:lV14FilterFullText) and TipoClienteTipoPessoa = ( 'JURIDICA')))");
         }
         else
         {
            GXv_int3[0] = 1;
