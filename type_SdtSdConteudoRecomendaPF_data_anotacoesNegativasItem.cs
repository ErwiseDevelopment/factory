...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SdConteudoRecomendaPF.data.anotacoesNegativasItem" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"SdConteudoRecomendaPF.data.anotacoesNegativasItem", Namespace="Factory2")]
