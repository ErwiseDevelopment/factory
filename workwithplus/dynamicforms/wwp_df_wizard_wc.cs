   ...
   public class wwp_df_wizard_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_wizard_wc"+UrlEncode(StringUtil.RTrim(AV19WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV15SessionId,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV29DefaultStep));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_wizard_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB150( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_wizard_wc");
            }
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnprevious_Internalname, "", "Anterior", bttBtnprevious_Jsonclick, 5, "Anterior", "", StyleString, ClassString, bttBtnprevious_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOPREVIOUS\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WorkWithPlus/DynamicForms/WWP_DF_Wizard_WC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnnext_Internalname, "", bttBtnnext_Caption, bttBtnnext_Jsonclick, 5, "Próximo", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WorkWithPlus/DynamicForms/WWP_DF_Wizard_WC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_wizard_wc")), "workwithplus.dynamicforms.wwp_df_wizard_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_wizard_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E13152( )
      {
         ...
         if ( AV5HasErrors )
         {
            ...
            {
               AV30GXV1 = 1;
               while ( AV30GXV1 <= AV7Messages.Count )
               {
                  AV6Message = ((GeneXus.Utils.SdtMessages_Message)AV7Messages.Item(AV30GXV1));
      ...
      protected void S152( )
      {
         ...
         if ( StringUtil.StrCmp(AV19WWPDynamicFormMode, "DSP") != 0 )
         {
            ...
            {
               A105WWPFormElementType = H00152_A105WWPFormElementType[0];
               A95WWPFormVersionNumber = H00152_A95WWPFormVersionNumber[0];
               A94WWPFormId = H00152_A94WWPFormId[0];
               A98WWPFormElementId = H00152_A98WWPFormElementId[0];
               A100WWPFormElementOrderIndex = H00152_A100WWPFormElementOrderIndex[0];
               new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_validatestep(context ).execute(  AV21WWPFormInstance,  A98WWPFormElementId,  true, out  AV5HasErrors, out  AV9ErrorIds, out  AV7Messages) ;
               AssignAttri(sPrefix, false, "AV5HasErrors", AV5HasErrors);
               AssignAttri(sPrefix, false, "AV9ErrorIds", AV9ErrorIds);
               if ( AV5HasErrors )
               {
                  if ( AV7Messages.Count == 0 )
                  {
                     AV10CurrentStep = StringUtil.Trim( StringUtil.Str( (decimal)(A98WWPFormElementId), 4, 0));
                     AssignAttri(sPrefix, false, "AV10CurrentStep", AV10CurrentStep);
                     /* Execute user subroutine: 'LOAD WIZARD STEPS AND CONTENT' */
                     S112 ();
                     if ( returnInSub )
            ...
            if ( ! AV5HasErrors )
            {
               AV22Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory21");
            ...
            {
               AV32GXV2 = 1;
               while ( AV32GXV2 <= AV7Messages.Count )
               {
                  AV6Message = ((GeneXus.Utils.SdtMessages_Message)AV7Messages.Item(AV32GXV2));
                  GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  AV6Message.gxTpr_Description,  "error",  "",  "true",  ""));
      ...
      protected void S162( )
      {
         ...
         if ( AV23HasConditionalSteps )
         {
            ...
            while ( ( AV25NextOrPrevStepIndex >= 1 ) && ( AV25NextOrPrevStepIndex <= AV18WizardSteps.Count ) )
            {
               ...
               {
                  A98WWPFormElementId = H00153_A98WWPFormElementId[0];
                  A105WWPFormElementType = H00153_A105WWPFormElementType[0];
                  A95WWPFormVersionNumber = H00153_A95WWPFormVersionNumber[0];
                  A94WWPFormId = H00153_A94WWPFormId[0];
                  A124WWPFormElementMetadata = H00153_A124WWPFormElementMetadata[0];
                  AV8WWP_DF_StepMetadata.FromJSonString(A124WWPFormElementMetadata, null);
      ...
      protected void S112( )
      {
         ...
         if ( AV23HasConditionalSteps )
         {
            AV18WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Factory21");
            ...
            {
               A105WWPFormElementType = H00154_A105WWPFormElementType[0];
               A95WWPFormVersionNumber = H00154_A95WWPFormVersionNumber[0];
               A94WWPFormId = H00154_A94WWPFormId[0];
               A124WWPFormElementMetadata = H00154_A124WWPFormElementMetadata[0];
               A98WWPFormElementId = H00154_A98WWPFormElementId[0];
               A117WWPFormElementTitle = H00154_A117WWPFormElementTitle[0];
               A100WWPFormElementOrderIndex = H00154_A100WWPFormElementOrderIndex[0];
               AV8WWP_DF_StepMetadata = new WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_StepMetadata(context);
               AV8WWP_DF_StepMetadata.FromJSonString(A124WWPFormElementMetadata, null);
               ...
               if ( AV24IncludeStep )
               {
                  ...
                  AV17WizardStep.gxTpr_Code = StringUtil.Trim( StringUtil.Str( (decimal)(A98WWPFormElementId), 4, 0));
                  AV17WizardStep.gxTpr_Title = A117WWPFormElementTitle;
                  ...
                  if ( ( String.IsNullOrEmpty(StringUtil.RTrim( AV10CurrentStep)) || ( StringUtil.StrCmp(AV10CurrentStep, AV17WizardStep.gxTpr_Code) == 0 ) ) && ! AV14IsCurrentStepAuxAssigned && ! AV28WizardContentAlreadyLoaded )
                  {
                     ...
                     if ( StringUtil.Len( WebComp_Dynamicformfs_wc_Component) != 0 )
                     {
                        ...
                        WebComp_Dynamicformfs_wc.componentprepare(new Object[] {(string)sPrefix+"W0018",(string)"",(string)AV19WWPDynamicFormMode,(short)A98WWPFormElementId,(short)0,(short)AV15SessionId,(GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance)AV21WWPFormInstance});
      ...
      protected void S172( )
      {
         ...
         bttBtnnext_Caption = ((AV12CurrentStepIndex<AV18WizardSteps.Count) ? "Próximo" : "Finalizar");
      ...
      protected void S122( )
      {
         ...
         AssignAttri(sPrefix, false, "AV12CurrentStepIndex", StringUtil.LTrimStr( (decimal)(AV12CurrentStepIndex), 4, 0));
         AV35GXV3 = 1;
         while ( AV35GXV3 <= AV18WizardSteps.Count )
         {
            AV17WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.Item(AV35GXV3));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101972158", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_wizard_wc.js", "?20256101972159", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOPREVIOUS'","""{"handler":"E12152","iparms":[{"av":"AV25NextOrPrevStepIndex","fld":"vNEXTORPREVSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV12CurrentStepIndex","fld":"vCURRENTSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"AV11CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"AV23HasConditionalSteps","fld":"vHASCONDITIONALSTEPS","type":"boolean"},{"av":"A100WWPFormElementOrderIndex","fld":"WWPFORMELEMENTORDERINDEX","pic":"ZZZ9","type":"int"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"A124WWPFormElementMetadata","fld":"WWPFORMELEMENTMETADATA","type":"vchar"},{"av":"A98WWPFormElementId","fld":"WWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"A117WWPFormElementTitle","fld":"WWPFORMELEMENTTITLE","type":"vchar"},{"av":"AV10CurrentStep","fld":"vCURRENTSTEP","type":"svchar"},{"av":"AV28WizardContentAlreadyLoaded","fld":"vWIZARDCONTENTALREADYLOADED","type":"boolean"},{"av":"AV19WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV13FindNext","fld":"vFINDNEXT","type":"boolean"}]""");
         setEventMetadata("'DOPREVIOUS'",""","oparms":[{"av":"AV25NextOrPrevStepIndex","fld":"vNEXTORPREVSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV10CurrentStep","fld":"vCURRENTSTEP","type":"svchar"},{"av":"AV12CurrentStepIndex","fld":"vCURRENTSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV13FindNext","fld":"vFINDNEXT","type":"boolean"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"AV23HasConditionalSteps","fld":"vHASCONDITIONALSTEPS","type":"boolean"},{"av":"AV11CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"lblStepdescription_Caption","ctrl":"STEPDESCRIPTION","prop":"Caption"},{"ctrl":"DYNAMICFORMFS_WC"},{"ctrl":"WIZARDHEADER"},{"av":"AV26NextOrPrevStepId","fld":"vNEXTORPREVSTEPID","pic":"ZZZ9","type":"int"},{"ctrl":"BTNPREVIOUS","prop":"Visible"},{"ctrl":"BTNNEXT","prop":"Caption"}]}""");
         setEventMetadata("'DONEXT'","""{"handler":"E13152","iparms":[{"av":"AV12CurrentStepIndex","fld":"vCURRENTSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV5HasErrors","fld":"vHASERRORS","type":"boolean"},{"av":"AV7Messages","fld":"vMESSAGES","type":""},{"av":"AV9ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV25NextOrPrevStepIndex","fld":"vNEXTORPREVSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV11CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"A100WWPFormElementOrderIndex","fld":"WWPFORMELEMENTORDERINDEX","pic":"ZZZ9","type":"int"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"A98WWPFormElementId","fld":"WWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV23HasConditionalSteps","fld":"vHASCONDITIONALSTEPS","type":"boolean"},{"av":"A124WWPFormElementMetadata","fld":"WWPFORMELEMENTMETADATA","type":"vchar"},{"av":"A117WWPFormElementTitle","fld":"WWPFORMELEMENTTITLE","type":"vchar"},{"av":"AV10CurrentStep","fld":"vCURRENTSTEP","type":"svchar"},{"av":"AV28WizardContentAlreadyLoaded","fld":"vWIZARDCONTENTALREADYLOADED","type":"boolean"},{"av":"AV13FindNext","fld":"vFINDNEXT","type":"boolean"}]""");
         setEventMetadata("'DONEXT'",""","oparms":[{"av":"AV11CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"AV21WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV7Messages","fld":"vMESSAGES","type":""},{"av":"AV9ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV5HasErrors","fld":"vHASERRORS","type":"boolean"},{"av":"AV10CurrentStep","fld":"vCURRENTSTEP","type":"svchar"},{"av":"AV12CurrentStepIndex","fld":"vCURRENTSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV13FindNext","fld":"vFINDNEXT","type":"boolean"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"AV23HasConditionalSteps","fld":"vHASCONDITIONALSTEPS","type":"boolean"},{"av":"lblStepdescription_Caption","ctrl":"STEPDESCRIPTION","prop":"Caption"},{"ctrl":"DYNAMICFORMFS_WC"},{"ctrl":"WIZARDHEADER"},{"av":"AV26NextOrPrevStepId","fld":"vNEXTORPREVSTEPID","pic":"ZZZ9","type":"int"},{"av":"AV25NextOrPrevStepIndex","fld":"vNEXTORPREVSTEPINDEX","pic":"ZZZ9","type":"int"},{"ctrl":"BTNPREVIOUS","prop":"Visible"},{"ctrl":"BTNNEXT","prop":"Caption"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E14152","iparms":[{"av":"AV27AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV23HasConditionalSteps","fld":"vHASCONDITIONALSTEPS","type":"boolean"},{"av":"A100WWPFormElementOrderIndex","fld":"WWPFORMELEMENTORDERINDEX","pic":"ZZZ9","type":"int"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"A124WWPFormElementMetadata","fld":"WWPFORMELEMENTMETADATA","type":"vchar"},{"av":"A98WWPFormElementId","fld":"WWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"A117WWPFormElementTitle","fld":"WWPFORMELEMENTTITLE","type":"vchar"},{"av":"AV10CurrentStep","fld":"vCURRENTSTEP","type":"svchar"},{"av":"AV28WizardContentAlreadyLoaded","fld":"vWIZARDCONTENTALREADYLOADED","type":"boolean"},{"av":"AV19WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV12CurrentStepIndex","fld":"vCURRENTSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"AV11CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV21WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV28WizardContentAlreadyLoaded","fld":"vWIZARDCONTENTALREADYLOADED","type":"boolean"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"AV23HasConditionalSteps","fld":"vHASCONDITIONALSTEPS","type":"boolean"},{"av":"AV12CurrentStepIndex","fld":"vCURRENTSTEPINDEX","pic":"ZZZ9","type":"int"},{"av":"AV11CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"lblStepdescription_Caption","ctrl":"STEPDESCRIPTION","prop":"Caption"},{"ctrl":"DYNAMICFORMFS_WC"},{"ctrl":"WIZARDHEADER"},{"ctrl":"BTNPREVIOUS","prop":"Visible"},{"ctrl":"BTNNEXT","prop":"Caption"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H00152_A105WWPFormElementType = new short[1] ;
         H00152_A95WWPFormVersionNumber = new short[1] ;
         H00152_A94WWPFormId = new short[1] ;
         H00152_A98WWPFormElementId = new short[1] ;
         H00152_A100WWPFormElementOrderIndex = new short[1] ;
         AV22Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory21");
         AV16WebSession = context.GetSession();
         AV8WWP_DF_StepMetadata = new WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_StepMetadata(context);
         H00153_A98WWPFormElementId = new short[1] ;
         H00153_A105WWPFormElementType = new short[1] ;
         H00153_A95WWPFormVersionNumber = new short[1] ;
         H00153_A94WWPFormId = new short[1] ;
         H00153_A124WWPFormElementMetadata = new string[] {""} ;
         H00154_A105WWPFormElementType = new short[1] ;
         H00154_A95WWPFormVersionNumber = new short[1] ;
         H00154_A94WWPFormId = new short[1] ;
         H00154_A124WWPFormElementMetadata = new string[] {""} ;
         H00154_A98WWPFormElementId = new short[1] ;
         H00154_A117WWPFormElementTitle = new string[] {""} ;
         H00154_A100WWPFormElementOrderIndex = new short[1] ;
         AV17WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_wizard_wc__default(),
            new Object[][] {
                new Object[] {
               H00152_A105WWPFormElementType, H00152_A95WWPFormVersionNumber, H00152_A94WWPFormId, H00152_A98WWPFormElementId, H00152_A100WWPFormElementOrderIndex
               }
               , new Object[] {
               H00153_A98WWPFormElementId, H00153_A105WWPFormElementType, H00153_A95WWPFormVersionNumber, H00153_A94WWPFormId, H00153_A124WWPFormElementMetadata
               }
               , new Object[] {
               H00154_A105WWPFormElementType, H00154_A95WWPFormVersionNumber, H00154_A94WWPFormId, H00154_A124WWPFormElementMetadata, H00154_A98WWPFormElementId, H00154_A117WWPFormElementTitle, H00154_A100WWPFormElementOrderIndex
               }
            }
         );
      ...
      private short[] H00152_A105WWPFormElementType ;
      private short[] H00152_A95WWPFormVersionNumber ;
      private short[] H00152_A94WWPFormId ;
      private short[] H00152_A98WWPFormElementId ;
      private short[] H00152_A100WWPFormElementOrderIndex ;
      ...
      private short[] H00153_A98WWPFormElementId ;
      private short[] H00153_A105WWPFormElementType ;
      private short[] H00153_A95WWPFormVersionNumber ;
      private short[] H00153_A94WWPFormId ;
      private string[] H00153_A124WWPFormElementMetadata ;
      private short[] H00154_A105WWPFormElementType ;
      private short[] H00154_A95WWPFormVersionNumber ;
      private short[] H00154_A94WWPFormId ;
      private string[] H00154_A124WWPFormElementMetadata ;
      private short[] H00154_A98WWPFormElementId ;
      private string[] H00154_A117WWPFormElementTitle ;
      private short[] H00154_A100WWPFormElementOrderIndex ;
   ...
   public class wwp_df_wizard_wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH00154;
          prmH00154 = new Object[] {
          new ParDef("AV21WWPF_1Wwpformid",GXType.Int16,4,0) ,
          new ParDef("AV21WWPF_2Wwpformversionnumbe",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00152", "SELECT WWPFormElementType, WWPFormVersionNumber, WWPFormId, WWPFormElementId, WWPFormElementOrderIndex FROM WWP_FormElement WHERE (WWPFormId = :AV21WWPF_1Wwpformid) AND (WWPFormVersionNumber = :AV21WWPF_2Wwpformversionnumbe) AND (WWPFormElementType = 5) ORDER BY WWPFormElementOrderIndex ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00152,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00153", "SELECT WWPFormElementId, WWPFormElementType, WWPFormVersionNumber, WWPFormId, WWPFormElementMetadata FROM WWP_FormElement WHERE (WWPFormId = :AV21WWPF_1Wwpformid and WWPFormVersionNumber = :AV21WWPF_2Wwpformversionnumbe and WWPFormElementId = :AV26NextOrPrevStepId) AND (WWPFormElementType = 5) ORDER BY WWPFormId, WWPFormVersionNumber, WWPFormElementId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00153,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H00154", "SELECT WWPFormElementType, WWPFormVersionNumber, WWPFormId, WWPFormElementMetadata, WWPFormElementId, WWPFormElementTitle, WWPFormElementOrderIndex FROM WWP_FormElement WHERE (WWPFormId = :AV21WWPF_1Wwpformid) AND (WWPFormVersionNumber = :AV21WWPF_2Wwpformversionnumbe) AND (WWPFormElementType = 5) ORDER BY WWPFormElementOrderIndex ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00154,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
