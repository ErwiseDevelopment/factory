   ...
   public class wwp_ds_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_ds_wc"+UrlEncode(StringUtil.LTrimStr(AV5SessionId,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV14WWPFormReferenceName)) + "," + UrlEncode(StringUtil.RTrim(AV25WWPFormContainerReferenceId)) + "," + UrlEncode(StringUtil.RTrim(AV24WWPFormInstanceRecordKey)) + "," + UrlEncode(StringUtil.RTrim(Gx_mode));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_ds_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB4X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_ds_wc");
            }
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_ds_wc")), "workwithplus.dynamicforms.wwp_ds_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_ds_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void S112( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV8WWPDynamicFormMode, "DSP") == 0 ) && ( AV7WWPFormInstance.gxTpr_Wwpformid == 0 ) )
         {
            ...
            {
               A94WWPFormId = H004X2_A94WWPFormId[0];
               A95WWPFormVersionNumber = H004X2_A95WWPFormVersionNumber[0];
               A96WWPFormReferenceName = H004X2_A96WWPFormReferenceName[0];
               A293WWPFormInstanceRecordKey = H004X2_A293WWPFormInstanceRecordKey[0];
               n293WWPFormInstanceRecordKey = H004X2_n293WWPFormInstanceRecordKey[0];
               A102WWPFormInstanceId = H004X2_A102WWPFormInstanceId[0];
               A96WWPFormReferenceName = H004X2_A96WWPFormReferenceName[0];
               AV9WWPFormInstanceId = A102WWPFormInstanceId;
         ...
         else
         {
            ...
            {
               A101WWPFormElementReferenceId = H004X3_A101WWPFormElementReferenceId[0];
               A95WWPFormVersionNumber = H004X3_A95WWPFormVersionNumber[0];
               A94WWPFormId = H004X3_A94WWPFormId[0];
               A98WWPFormElementId = H004X3_A98WWPFormElementId[0];
               AV26WWPFormElementId = A98WWPFormElementId;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918383010", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_ds_wc.js", "?202551918383011", false, true);
      ...
      public override void initialize( )
      {
         ...
         H004X2_A94WWPFormId = new short[1] ;
         H004X2_A95WWPFormVersionNumber = new short[1] ;
         H004X2_A96WWPFormReferenceName = new string[] {""} ;
         H004X2_A293WWPFormInstanceRecordKey = new string[] {""} ;
         H004X2_n293WWPFormInstanceRecordKey = new bool[] {false} ;
         H004X2_A102WWPFormInstanceId = new int[1] ;
         A96WWPFormReferenceName = "";
         A293WWPFormInstanceRecordKey = "";
         H004X3_A101WWPFormElementReferenceId = new string[] {""} ;
         H004X3_A95WWPFormVersionNumber = new short[1] ;
         H004X3_A94WWPFormId = new short[1] ;
         H004X3_A98WWPFormElementId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_ds_wc__default(),
            new Object[][] {
                new Object[] {
               H004X2_A94WWPFormId, H004X2_A95WWPFormVersionNumber, H004X2_A96WWPFormReferenceName, H004X2_A293WWPFormInstanceRecordKey, H004X2_n293WWPFormInstanceRecordKey, H004X2_A102WWPFormInstanceId
               }
               , new Object[] {
               H004X3_A101WWPFormElementReferenceId, H004X3_A95WWPFormVersionNumber, H004X3_A94WWPFormId, H004X3_A98WWPFormElementId
               }
            }
         );
      ...
      private short[] H004X2_A94WWPFormId ;
      private short[] H004X2_A95WWPFormVersionNumber ;
      private string[] H004X2_A96WWPFormReferenceName ;
      private string[] H004X2_A293WWPFormInstanceRecordKey ;
      private bool[] H004X2_n293WWPFormInstanceRecordKey ;
      private int[] H004X2_A102WWPFormInstanceId ;
      private string[] H004X3_A101WWPFormElementReferenceId ;
      private short[] H004X3_A95WWPFormVersionNumber ;
      private short[] H004X3_A94WWPFormId ;
      private short[] H004X3_A98WWPFormElementId ;
