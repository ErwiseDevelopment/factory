...
namespace GeneXus.Programs {
   public class prcalculataxasnotafiscal : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSdParcelaCalculadaTaxa> aP3_Array_SdParcelaCalculadaTaxa )
      {
         ...
         this.AV10Array_SdParcelaCalculadaTaxa = new GXBaseCollection<SdtSdParcelaCalculadaTaxa>( context, "SdParcelaCalculadaTaxa", "Factory2") ;
         initialize();
         ExecuteImpl();
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV10Array_SdParcelaCalculadaTaxa = new GXBaseCollection<SdtSdParcelaCalculadaTaxa>( context, "SdParcelaCalculadaTaxa", "Factory2");
         AV28GXV1 = 1;
      ...
      {
         AV10Array_SdParcelaCalculadaTaxa = new GXBaseCollection<SdtSdParcelaCalculadaTaxa>( context, "SdParcelaCalculadaTaxa", "Factory2");
         AV9Array_SdNotaFiscal = new GXBaseCollection<SdtSdNotaFiscal>( context, "SdNotaFiscal", "Factory2");
