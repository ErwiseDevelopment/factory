...
namespace GeneXus.Programs {
   public class wcdocumentosobrigatoriosreembolso : GXWebComponent
   {
      ...
      protected void E116M2( )
      {
         ...
         S112 ();
         if (returnInSub) return;
         AV29Array_SdDocumentosReembolso = new GXBaseCollection<SdtSdDocumentosReembolso>( context, "SdDocumentosReembolso", "Factory2");
         AV29Array_SdDocumentosReembolso.FromJSonString(AV28JSON, null);
         AV17SdDocumentosReembolsos = new GXBaseCollection<SdtSdDocumentosReembolso>( context, "SdDocumentosReembolso", "Factory2");
         gx_BV12 = true;
         /* Using cursor H006M2 */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025519183805", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wcdocumentosobrigatoriosreembolso.js", "?2025519183806", false, true);
            context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
         }
