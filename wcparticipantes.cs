...
namespace GeneXus.Programs {
   public class wcparticipantes : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255221643187", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wcparticipantes.js", "?20255221643187", false, true);
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV9Array_SdParticipantes = new GXBaseCollection<SdtSdParticipantes>( context, "SdParticipantes", "Factory2");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
