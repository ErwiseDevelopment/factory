   ...
   public class wwp_df_mdatagrid_remove_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_mdatagrid_remove_wc"+UrlEncode(StringUtil.LTrimStr(AV10WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV9WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_mdatagrid_remove_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_mdatagrid_remove_wc");
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_mdatagrid_remove_wc")), "workwithplus.dynamicforms.wwp_df_mdatagrid_remove_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_mdatagrid_remove_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E111T2( )
      {
         ...
         if ( ! (0==AV6SessionId) )
         {
            ...
            {
               A98WWPFormElementId = H001T2_A98WWPFormElementId[0];
               A95WWPFormVersionNumber = H001T2_A95WWPFormVersionNumber[0];
               A94WWPFormId = H001T2_A94WWPFormId[0];
               A124WWPFormElementMetadata = H001T2_A124WWPFormElementMetadata[0];
               AV13WWP_DF_MultipleMetadata.FromJSonString(A124WWPFormElementMetadata, null);
      ...
      protected void E121T2( )
      {
         ...
         if ( ! (0==AV6SessionId) )
         {
            ...
            while ( AV8i <= AV11WWPFormElementIdToDelete.Count )
            {
               AV7j = 1;
               AV15GXV1 = 1;
               while ( AV15GXV1 <= AV5WWPFormInstance.gxTpr_Element.Count )
               {
                  AV12WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV5WWPFormInstance.gxTpr_Element.Item(AV15GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381058", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_mdatagrid_remove_wc.js", "?202551918381059", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOREMOVECHILD'","""{"handler":"E121T2","iparms":[{"av":"AV6SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV10WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV9WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("'DOREMOVECHILD'",""","oparms":[{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H001T2_A98WWPFormElementId = new short[1] ;
         H001T2_A95WWPFormVersionNumber = new short[1] ;
         H001T2_A94WWPFormId = new short[1] ;
         H001T2_A124WWPFormElementMetadata = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_mdatagrid_remove_wc__default(),
            new Object[][] {
                new Object[] {
               H001T2_A98WWPFormElementId, H001T2_A95WWPFormVersionNumber, H001T2_A94WWPFormId, H001T2_A124WWPFormElementMetadata
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H001T2_A98WWPFormElementId ;
      private short[] H001T2_A95WWPFormVersionNumber ;
      private short[] H001T2_A94WWPFormId ;
      private string[] H001T2_A124WWPFormElementMetadata ;
   ...
   public class wwp_df_mdatagrid_remove_wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001T2", "SELECT WWPFormElementId, WWPFormVersionNumber, WWPFormId, WWPFormElementMetadata FROM WWP_FormElement WHERE WWPFormId = :AV5WWPFormInstance__Wwpformid and WWPFormVersionNumber = :AV5WWPFo_1Wwpformversionnumbe and WWPFormElementId = :AV10WWPFormElementId ORDER BY WWPFormId, WWPFormVersionNumber, WWPFormElementId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001T2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
