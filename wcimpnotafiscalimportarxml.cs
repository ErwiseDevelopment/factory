...
namespace GeneXus.Programs {
   public class wcimpnotafiscalimportarxml : GXWebComponent
   {
      ...
      protected void E138P2( )
      {
         ...
         AV18Array_SdNotaFiscal = new GXBaseCollection<SdtSdNotaFiscal>( context, "SdNotaFiscal", "Factory2");
      ...
      public override void initialize( )
      {
         ...
         AV12UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV13FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
