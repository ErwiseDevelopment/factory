   ...
   public class wwp_df_numeric_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_numeric_wc"+UrlEncode(StringUtil.RTrim(AV30WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV32WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV24SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_numeric_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_numeric_wc");
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_numeric_wc")), "workwithplus.dynamicforms.wwp_df_numeric_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_numeric_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E111P2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV15HasReferenceId, context));
         AV37GXV1 = 1;
         while ( AV37GXV1 <= AV5WWPFormInstance.gxTpr_Element.Count )
         {
            AV35WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV5WWPFormInstance.gxTpr_Element.Item(AV37GXV1));
      ...
      protected void E131P2( )
      {
         ...
         returnInSub = false;
         if ( ( AV7AuxSessionId == AV24SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV36ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV32WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV6WWPFormInstanceElementId), 4, 0))+"|") )
         {
      ...
      protected void S152( )
      {
         ...
         AV38GXV2 = 1;
         while ( AV38GXV2 <= AV5WWPFormInstance.gxTpr_Element.Count )
         {
            AV35WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV5WWPFormInstance.gxTpr_Element.Item(AV38GXV2));
            if ( ( AV35WWPFormInstanceElement.gxTpr_Wwpformelementid == AV32WWPFormElementId ) && ( AV35WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV6WWPFormInstanceElementId ) )
            {
      ...
      protected void S162( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV34WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV13ElementInternalName,  "true",  ""));
            AV20IsValid = false;
         }
         else
         {
            if ( AV26Validations.Count > 0 )
            {
               ...
               AV39GXV3 = 1;
               while ( AV39GXV3 <= AV23Messages.Count )
               {
                  AV22Message = ((GeneXus.Utils.SdtMessages_Message)AV23Messages.Item(AV39GXV3));
      ...
      protected void S192( )
      {
         ...
         AV10DataCellNameClass = "DataContentCellFL";
         ...
         {
            AV10DataCellNameClass = "RequiredDataContentCellFL " + AV10DataCellNameClass;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381588", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_numeric_wc.js", "?202551918381589", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV15HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV29WWP_DF_NumericMetadata","fld":"vWWP_DF_NUMERICMETADATA","hsh":true,"type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"}]}""");
         setEventMetadata("'DOFIXCONTROLVALUECHANGED'","""{"handler":"E121P2","iparms":[{"av":"AV11DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"AV9Data","fld":"vDATA","type":"svchar"},{"av":"AV15HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV24SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV6WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV29WWP_DF_NumericMetadata","fld":"vWWP_DF_NUMERICMETADATA","hsh":true,"type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("'DOFIXCONTROLVALUECHANGED'",""","oparms":[{"av":"AV11DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"AV14ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E131P2","iparms":[{"av":"AV36ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV7AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV24SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV6WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV14ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV29WWP_DF_NumericMetadata","fld":"vWWP_DF_NUMERICMETADATA","hsh":true,"type":""},{"av":"AV9Data","fld":"vDATA","type":"svchar"},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV14ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E141P2","iparms":[{"av":"AV7AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV24SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV27VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV29WWP_DF_NumericMetadata","fld":"vWWP_DF_NUMERICMETADATA","hsh":true,"type":""},{"av":"AV6WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV27VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED","""{"handler":"E151P2","iparms":[{"av":"AV9Data","fld":"vDATA","type":"svchar"},{"av":"AV15HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV24SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV6WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV29WWP_DF_NumericMetadata","fld":"vWWP_DF_NUMERICMETADATA","hsh":true,"type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED",""","oparms":[{"av":"AV11DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"AV14ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         return  ;
      }
