   ...
   public class wwp_dfc_radiobutton_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_radiobutton_wc"+UrlEncode(StringUtil.RTrim(AV15WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV18WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV12SessionId,4,0));
      ...
      protected void WB210( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_radiobutton_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            wb_table1_17_212( true) ;
         }
         else
         {
            wb_table1_17_212( false) ;
         }
         return  ;
      }

      protected void wb_table1_17_212e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_30_212( true) ;
         }
         else
         {
            wb_table2_30_212( false) ;
         }
         return  ;
      }

      protected void wb_table2_30_212e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_35_212( true) ;
         }
         else
         {
            wb_table3_35_212( false) ;
         }
         return  ;
      }

      protected void wb_table3_35_212e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_radiobutton_wc")), "workwithplus.dynamicforms.wwp_dfc_radiobutton_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_radiobutton_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void wb_table3_35_212( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_35_212e( true) ;
         }
         else
         {
            wb_table3_35_212e( false) ;
         }
      }

      protected void wb_table2_30_212( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_30_212e( true) ;
         }
         else
         {
            wb_table2_30_212e( false) ;
         }
      }

      protected void wb_table1_17_212( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_17_212e( true) ;
         }
         else
         {
            wb_table1_17_212e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918384273", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_radiobutton_wc.js", "?202551918384274", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"radavData"},{"av":"AV5Data","fld":"vDATA","type":"svchar"},{"av":"AV9IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV10IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV19ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV14WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"}]""");
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E16212","iparms":[{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV18WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E17212","iparms":[{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV18WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E11212","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV18WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE",""","oparms":[{"av":"AV16WWPForm","fld":"vWWPFORM","type":""},{"av":"AV17WWPFormElement","fld":"vWWPFORMELEMENT","type":""}]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13212","iparms":[{"av":"AV18WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12212","iparms":[{"av":"AV17WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV18WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV11NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"AV19ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV14WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"},{"av":"AV7OldTitle","fld":"vOLDTITLE","type":"svchar"}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV7OldTitle","fld":"vOLDTITLE","type":"svchar"},{"av":"AV16WWPForm","fld":"vWWPFORM","type":""},{"av":"AV17WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV11NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"radavData"},{"av":"AV5Data","fld":"vDATA","type":"svchar"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"}]}""");
         return  ;
      }
