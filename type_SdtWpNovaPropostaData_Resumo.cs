/*
				   File: type_SdtWpNovaPropostaData_Resumo
			Description: Resumo
...
{
	[XmlRoot(ElementName="WpNovaPropostaData.Resumo")]
	[XmlType(TypeName="WpNovaPropostaData.Resumo" , Namespace="Factory21" )]
	[Serializable]
	public class SdtWpNovaPropostaData_Resumo : GxUserType
	{
		public SdtWpNovaPropostaData_Resumo( )
		{
			/* Constructor for serialization */
			gxTv_SdtWpNovaPropostaData_Resumo_Propostadescricao = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Clientepixtipo = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Clientepix = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Contaagencia = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Contanumero = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Responsavelclienterazaosocial = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Responsavelclientedocumento = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Responsavelcontatoemail = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Clienterazaosocial = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Clientedocumento = "";

			gxTv_SdtWpNovaPropostaData_Resumo_Contatoemail = "";

		}

		public SdtWpNovaPropostaData_Resumo(IGxContext context)
		{
		...
		public override void ToJSON(bool includeState)
		{
			...
			if (gxTv_SdtWpNovaPropostaData_Resumo_Griddocc != null)
			{
				AddObjectProperty("GridDocc", gxTv_SdtWpNovaPropostaData_Resumo_Griddocc, false);
			}
			return;
		}
		#endregion
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Procedimentosmedicosid; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Procedimentosmedicosid = value;
		...
		{
			get {
				return Convert.ToString(gxTv_SdtWpNovaPropostaData_Resumo_Propostavalor, System.Globalization.CultureInfo.InvariantCulture);
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Propostavalor = NumberUtil.Val(value);
			}
		}
		[XmlIgnore]
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Propostavalor; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Propostavalor = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Propostadescricao; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Propostadescricao = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Convenioid; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Convenioid = value;
				SetDirty("Convenioid");
			}
		}
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Conveniocategoriaid; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Conveniocategoriaid = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Conveniovencimentoano; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Conveniovencimentoano = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Conveniovencimentomes; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Conveniovencimentomes = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Clientepixtipo; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Clientepixtipo = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Clientepix; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Clientepix = value;
				SetDirty("Clientepix");
			}
		}
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Bancoid; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Bancoid = value;
				SetDirty("Bancoid");
			}
		}
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Contaagencia; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Contaagencia = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Contanumero; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Contanumero = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Responsavelclienterazaosocial; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Responsavelclienterazaosocial = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Responsavelclientedocumento; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Responsavelclientedocumento = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Responsavelcontatoemail; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Responsavelcontatoemail = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Clienterazaosocial; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Clienterazaosocial = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Clientedocumento; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Clientedocumento = value;
		...
		{
			get {
				return gxTv_SdtWpNovaPropostaData_Resumo_Contatoemail; 
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Contatoemail = value;
		...
		[SoapElement(ElementName="GridDocc" )]
		[XmlArray(ElementName="GridDocc"  )]
		[XmlArrayItemAttribute(ElementName="GridDoccItem" , IsNullable=false )]
		public GXBaseCollection<SdtWpNovaPropostaData_Resumo_GridDoccItem> gxTpr_Griddocc
		{
			get {
				if ( gxTv_SdtWpNovaPropostaData_Resumo_Griddocc == null )
				{
					gxTv_SdtWpNovaPropostaData_Resumo_Griddocc = new GXBaseCollection<SdtWpNovaPropostaData_Resumo_GridDoccItem>( context, "WpNovaPropostaData.Resumo.GridDoccItem", "");
				}
				SetDirty("Griddocc");
				return gxTv_SdtWpNovaPropostaData_Resumo_Griddocc;
			}
			set {
				gxTv_SdtWpNovaPropostaData_Resumo_Griddocc_N = false;
				gxTv_SdtWpNovaPropostaData_Resumo_Griddocc = value;
				SetDirty("Griddocc");
			}
		}

		public void gxTv_SdtWpNovaPropostaData_Resumo_Griddocc_SetNull()
		{
			gxTv_SdtWpNovaPropostaData_Resumo_Griddocc_N = true;
			gxTv_SdtWpNovaPropostaData_Resumo_Griddocc = null;
		}

		public bool gxTv_SdtWpNovaPropostaData_Resumo_Griddocc_IsNull()
		{
			return gxTv_SdtWpNovaPropostaData_Resumo_Griddocc == null;
		}
		public bool ShouldSerializegxTpr_Griddocc_GxSimpleCollection_Json()
		{
			return gxTv_SdtWpNovaPropostaData_Resumo_Griddocc != null && gxTv_SdtWpNovaPropostaData_Resumo_Griddocc.Count > 0;
		...
		protected int gxTv_SdtWpNovaPropostaData_Resumo_Procedimentosmedicosid;
		 

		protected decimal gxTv_SdtWpNovaPropostaData_Resumo_Propostavalor;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Propostadescricao;
		 

		protected int gxTv_SdtWpNovaPropostaData_Resumo_Convenioid;
		 

		protected int gxTv_SdtWpNovaPropostaData_Resumo_Conveniocategoriaid;
		 

		protected short gxTv_SdtWpNovaPropostaData_Resumo_Conveniovencimentoano;
		 

		protected short gxTv_SdtWpNovaPropostaData_Resumo_Conveniovencimentomes;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Clientepixtipo;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Clientepix;
		 

		protected int gxTv_SdtWpNovaPropostaData_Resumo_Bancoid;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Contaagencia;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Contanumero;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Responsavelclienterazaosocial;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Responsavelclientedocumento;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Responsavelcontatoemail;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Clienterazaosocial;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Clientedocumento;
		 

		protected string gxTv_SdtWpNovaPropostaData_Resumo_Contatoemail;
		 
		protected bool gxTv_SdtWpNovaPropostaData_Resumo_Griddocc_N;
		protected GXBaseCollection<SdtWpNovaPropostaData_Resumo_GridDoccItem> gxTv_SdtWpNovaPropostaData_Resumo_Griddocc = null; 
	...
	[DataContract(Name=@"WpNovaPropostaData.Resumo", Namespace="Factory21")]
	public class SdtWpNovaPropostaData_Resumo_RESTInterface : GxGenericCollectionItem<SdtWpNovaPropostaData_Resumo>, System.Web.SessionState.IRequiresSessionState
	{
		public SdtWpNovaPropostaData_Resumo_RESTInterface( ) : base()
		{	
		}

		public SdtWpNovaPropostaData_Resumo_RESTInterface( SdtWpNovaPropostaData_Resumo psdt ) : base(psdt)
		{	
		}
		...
		[JsonPropertyName("GridDocc")]
		[JsonPropertyOrder(18)]
		[JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
		[DataMember(Name="GridDocc", Order=18, EmitDefaultValue=false)]
		public GxGenericCollection<SdtWpNovaPropostaData_Resumo_GridDoccItem_RESTInterface> gxTpr_Griddocc
		{
			get {
				if (sdt.ShouldSerializegxTpr_Griddocc_GxSimpleCollection_Json())
					return new GxGenericCollection<SdtWpNovaPropostaData_Resumo_GridDoccItem_RESTInterface>(sdt.gxTpr_Griddocc);
				else
					return null;

			}
			set {
				value.LoadCollection(sdt.gxTpr_Griddocc);
			}
		}
		...
		#endregion
		[JsonIgnore]
		public SdtWpNovaPropostaData_Resumo sdt
		{
			get { 
				return (SdtWpNovaPropostaData_Resumo)Sdt;
			}
			set { 
				Sdt = value;
			}
		...
		void checkSdt( StreamingContext ctx )
		{
			if ( sdt == null )
			{
				sdt = new SdtWpNovaPropostaData_Resumo() ;
			}
		}
	}
	#endregion
