...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SdNotaFiscal.NFe.infNFe.detItem.imposto.PIS" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"SdNotaFiscal.NFe.infNFe.detItem.imposto.PIS", Namespace="Factory2")]
