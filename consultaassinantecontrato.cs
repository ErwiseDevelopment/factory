...
namespace GeneXus.Programs {
   public class consultaassinantecontrato : GXDataArea
   {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("consultaassinantecontrato.js", "?202551918554498", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavAssinaturaparticipante_assinaturaparticipantetipo.addItem("Contratado", "Contratado", 0);
