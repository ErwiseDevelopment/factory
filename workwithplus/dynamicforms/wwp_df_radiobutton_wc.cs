   ...
   public class wwp_df_radiobutton_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_radiobutton_wc"+UrlEncode(StringUtil.RTrim(AV27WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV28WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV33WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21SessionId,4,0));
      ...
      protected void WB1J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_radiobutton_wc");
            }
            ...
            GxWebStd.gx_label_element( context, "", radavData.Caption, "col-sm-3 AttributeFLLabel RadioWithDynamicOrientationLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Radio button */
            ClassString = "AttributeFL RadioWithDynamicOrientation";
            StyleString = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_radiobutton_wc")), "workwithplus.dynamicforms.wwp_df_radiobutton_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_radiobutton_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E111J2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV14HasReferenceId, context));
         AV35GXV1 = 1;
         while ( AV35GXV1 <= AV31WWPFormInstance.gxTpr_Element.Count )
         {
            AV32WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV31WWPFormInstance.gxTpr_Element.Item(AV35GXV1));
      ...
      protected void E131J2( )
      {
         ...
         returnInSub = false;
         if ( ( AV6AuxSessionId == AV21SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV34ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV28WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV33WWPFormInstanceElementId), 4, 0))+"|") )
         {
      ...
      protected void S152( )
      {
         ...
         AV36GXV2 = 1;
         while ( AV36GXV2 <= AV31WWPFormInstance.gxTpr_Element.Count )
         {
            AV32WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV31WWPFormInstance.gxTpr_Element.Item(AV36GXV2));
            if ( ( AV32WWPFormInstanceElement.gxTpr_Wwpformelementid == AV28WWPFormElementId ) && ( AV32WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV33WWPFormInstanceElementId ) )
            {
      ...
      protected void S162( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV30WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV12ElementInternalName,  "true",  ""));
            AV18IsValid = false;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381981", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_radiobutton_wc.js", "?202551918381981", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"radavData"},{"av":"AV8Data","fld":"vDATA","type":"svchar"},{"av":"AV14HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"}]}""");
         setEventMetadata("'DOFIXCONTROLVALUECHANGED'","""{"handler":"E121J2","iparms":[{"av":"AV10DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"radavData"},{"av":"AV8Data","fld":"vDATA","type":"svchar"},{"av":"AV14HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV31WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV28WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV33WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV32WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("'DOFIXCONTROLVALUECHANGED'",""","oparms":[{"av":"AV10DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV32WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV31WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E131J2","iparms":[{"av":"AV34ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV28WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV33WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV31WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"radavData"},{"av":"AV8Data","fld":"vDATA","type":"svchar"},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV32WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV32WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV31WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E141J2","iparms":[{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV24VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV33WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV31WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV31WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV24VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED","""{"handler":"E151J2","iparms":[{"av":"radavData"},{"av":"AV8Data","fld":"vDATA","type":"svchar"},{"av":"AV14HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV31WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV28WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV33WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV32WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED",""","oparms":[{"av":"AV10DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV32WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV31WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         return  ;
      }
