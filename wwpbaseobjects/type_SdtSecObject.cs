...
namespace GeneXus.Programs.wwpbaseobjects {
   ...
   [XmlType(TypeName =  "SecObject" , Namespace = "Factory2" )]
   [Serializable]
   public class SdtSecObject : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<GeneXus.Programs.wwpbaseobjects.SdtSecObject_Functionalities> gxTpr_Functionalities_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtSecObject_Functionalities == null )
            {
               gxTv_SdtSecObject_Functionalities = new GXBCLevelCollection<GeneXus.Programs.wwpbaseobjects.SdtSecObject_Functionalities>( context, "SecObject.Functionalities", "Factory2");
            }
   ...
   [DataContract(Name = @"WWPBaseObjects\SecObject", Namespace = "Factory2")]
