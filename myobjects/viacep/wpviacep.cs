...
namespace GeneXus.Programs.myobjects.viacep {
   public class wpviacep : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918535624", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("myobjects/viacep/wpviacep.js", "?202551918535625", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV7EnderecosCEPs = new GXBaseCollection<GeneXus.Programs.myobjects.viacep.SdtListaEndereco_EnderecoCompleto>( context, "EnderecoCompleto", "Factory2");
         GX_FocusControl = "";
         Form = new GXWebForm();
         sPrefix = "";
