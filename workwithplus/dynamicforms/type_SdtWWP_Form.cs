...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   ...
   [XmlType(TypeName =  "WWP_Form" , Namespace = "Factory21" )]
   [Serializable]
   public class SdtWWP_Form : GxSilentTrnSdt
   {
      ...
      public void Load( short AV94WWPFormId ,
                        short AV95WWPFormVersionNumber )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(short)AV94WWPFormId,(short)AV95WWPFormVersionNumber});
         return  ;
      }
      ...
      public GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element> gxTpr_Element_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtWWP_Form_Element == null )
            {
               gxTv_SdtWWP_Form_Element = new GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element>( context, "WWP_Form.Element", "Factory21");
            }
   ...
   [DataContract(Name = @"WorkWithPlus\DynamicForms\WWP_Form", Namespace = "Factory21")]
