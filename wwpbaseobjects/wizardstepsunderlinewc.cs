   ...
   public class wizardstepsunderlinewc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardstepsunderlinewc"+UrlEncode(StringUtil.RTrim(AV6CurrentStep));
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.wizardstepsunderlinewc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wwpbaseobjects.wizardstepsunderlinewc");
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.wizardstepsunderlinewc")), "wwpbaseobjects.wizardstepsunderlinewc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.wizardstepsunderlinewc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E110J2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSELECTEDSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV13SelectedStepNumber), "ZZZ9"), context));
         AV23GXV1 = 1;
         while ( AV23GXV1 <= AV18WizardSteps.Count )
         {
            AV5WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV18WizardSteps.Item(AV23GXV1));
      ...
      private void E120J2( )
      {
         ...
         returnInSub = false;
         AV24GXV2 = 1;
         while ( AV24GXV2 <= AV19WizardStepsAux.Count )
         {
            AV5WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV24GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101965530", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsunderlinewc.js", "?20256101965530", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage","type":"int"},{"av":"GRIDWIZARDSTEPS_nEOF","type":"int"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"sPrefix","type":"char"},{"av":"AV19WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true,"type":""},{"av":"AV16StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV13SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV20WizardStepsCount","fld":"vWIZARDSTEPSCOUNT","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV7FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true,"type":"boolean"},{"av":"AV8LastIsDummy","fld":"vLASTISDUMMY","hsh":true,"type":"boolean"},{"av":"AV11PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true,"type":"boolean"}]}""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E120J2","iparms":[{"av":"AV19WizardStepsAux","fld":"vWIZARDSTEPSAUX","hsh":true,"type":""},{"av":"AV16StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV13SelectedStepNumber","fld":"vSELECTEDSTEPNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV20WizardStepsCount","fld":"vWIZARDSTEPSCOUNT","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV7FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true,"type":"boolean"},{"av":"AV8LastIsDummy","fld":"vLASTISDUMMY","hsh":true,"type":"boolean"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"AV11PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true,"type":"boolean"}]""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD",""","oparms":[{"av":"AV22WizardStepTitle","fld":"vWIZARDSTEPTITLE","type":"svchar"},{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"av":"divTblcontainerstep_Class","ctrl":"TBLCONTAINERSTEP","prop":"Class"},{"av":"divTablestepitem_Class","ctrl":"TABLESTEPITEM","prop":"Class"},{"av":"divTablestepitem_Visible","ctrl":"TABLESTEPITEM","prop":"Visible"},{"av":"divUnnamedtablefsgridwizardsteps_Class","ctrl":"UNNAMEDTABLEFSGRIDWIZARDSTEPS","prop":"Class"},{"av":"divTblcontainerstep_Visible","ctrl":"TBLCONTAINERSTEP","prop":"Visible"},{"av":"AV16StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV15StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"lblStepnumber_Visible","ctrl":"STEPNUMBER","prop":"Visible"}]}""");
