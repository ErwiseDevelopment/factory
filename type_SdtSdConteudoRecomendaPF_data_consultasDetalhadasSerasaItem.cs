...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SdConteudoRecomendaPF.data.consultasDetalhadasSerasaItem" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"SdConteudoRecomendaPF.data.consultasDetalhadasSerasaItem", Namespace="Factory2")]
