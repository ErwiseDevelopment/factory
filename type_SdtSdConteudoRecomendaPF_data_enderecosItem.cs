...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SdConteudoRecomendaPF.data.enderecosItem" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"SdConteudoRecomendaPF.data.enderecosItem", Namespace="Factory2")]
