...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SdConteudoRecomendaPF.data.informacoesAdicionais" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"SdConteudoRecomendaPF.data.informacoesAdicionais", Namespace="Factory2")]
