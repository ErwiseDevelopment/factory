...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secrolefunroleactionassociationww : GXDataArea
   {
                           ...
                           long aP1_SecParentFunctionalityId )
      {
         ...
         this.AV22SecParentFunctionalityId = aP1_SecParentFunctionalityId;
         ExecuteImpl();
      }
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV27OrderedBy = (short)(Math.Round(NumberUtil.Val( GetPar( "OrderedBy"), "."), 18, MidpointRounding.ToEven));
         AV28OrderedDsc = StringUtil.StrToBool( GetPar( "OrderedDsc"));
         AV22SecParentFunctionalityId = (long)(Math.Round(NumberUtil.Val( GetPar( "SecParentFunctionalityId"), "."), 18, MidpointRounding.ToEven));
         ...
         AV9SecRoleIdParm = (short)(Math.Round(NumberUtil.Val( GetPar( "SecRoleIdParm"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid_refresh( subGrid_Rows, AV27OrderedBy, AV28OrderedDsc, AV22SecParentFunctionalityId, AV53Pgmname, AV15SecFunctionalityIdRemovedXml, AV14SecFunctionalityIdAddedXml, AV8SecRoleId, A131SecRoleId, AV20i, AV11SecFunctionalityIdRemoved, AV13SecFunctionalityIdToFind, AV10SecFunctionalityIdAdded, AV9SecRoleIdParm) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wwpbaseobjects.secrolefunroleactionassociationww"+UrlEncode(StringUtil.LTrimStr(AV8SecRoleId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV22SecParentFunctionalityId,10,0));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vSECROLEIDPARM", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9SecRoleIdParm), "ZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV27OrderedBy), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vORDEREDDSC", StringUtil.BoolToStr( AV28OrderedDsc));
         /* Send saved values. */
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vORDEREDDSC", AV28OrderedDsc);
         GxWebStd.gx_hidden_field( context, "vSECROLEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8SecRoleId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSECROLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV8SecRoleId), "ZZZ9"), context));
         ...
         GxWebStd.gx_hidden_field( context, "vSECPARENTFUNCTIONALITYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22SecParentFunctionalityId), 10, 0, ",", "")));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.secrolefunroleactionassociationww"+UrlEncode(StringUtil.LTrimStr(AV8SecRoleId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV22SecParentFunctionalityId,10,0));
         return formatLink("wwpbaseobjects.secrolefunroleactionassociationww") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB310( )
      {
         ...
         if ( wbEnd == 15 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnconfirm_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(15), 2, 0)+","+"null"+");", "Confirmar", bttBtnconfirm_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects/SecRoleFunRoleActionAssociationWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(15), 2, 0)+","+"null"+");", "Fechar", bttBtncancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects/SecRoleFunRoleActionAssociationWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                           {
                              ...
                              if ( ! wbErr )
                              {
                                 ...
                                 if ( ( context.localUtil.CToN( cgiGet( "GXH_vORDEREDBY"), ",", ".") != Convert.ToDecimal( AV27OrderedBy )) )
                                 {
                                    Rfr0gs = true;
                                 }
                                 /* Set Refresh If Ordereddsc Changed */
                                 if ( StringUtil.StrToBool( cgiGet( "GXH_vORDEREDDSC")) != AV28OrderedDsc )
                                 {
                                    Rfr0gs = true;
                                 }
                                 if ( ! Rfr0gs )
      ...
      protected void PA312( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.secrolefunroleactionassociationww")), "wwpbaseobjects.secrolefunroleactionassociationww") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.secrolefunroleactionassociationww")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
                  {
                     ...
                     {
                        AV22SecParentFunctionalityId = (long)(Math.Round(NumberUtil.Val( GetPar( "SecParentFunctionalityId"), "."), 18, MidpointRounding.ToEven));
                        AssignAttri("", false, "AV22SecParentFunctionalityId", StringUtil.LTrimStr( (decimal)(AV22SecParentFunctionalityId), 10, 0));
                     }
                  }
                  if ( toggleJsOutput )
                  {
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       short AV27OrderedBy ,
                                       bool AV28OrderedDsc ,
                                       long AV22SecParentFunctionalityId ,
                                       string AV53Pgmname ,
      ...
      {
         /* GeneXus formulas. */
         AV53Pgmname = "WWPBaseObjects.SecRoleFunRoleActionAssociationWW";
      ...
      protected void RF312( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV22SecParentFunctionalityId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.LONG
                                                 }
            });
            /* Using cursor H00312 */
            pr_default.execute(0, new Object[] {AV22SecParentFunctionalityId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A128SecFunctionalityId = H00312_A128SecFunctionalityId[0];
               A134SecFunctionalityActive = H00312_A134SecFunctionalityActive[0];
               n134SecFunctionalityActive = H00312_n134SecFunctionalityActive[0];
               A138SecParentFunctionalityDescription = H00312_A138SecParentFunctionalityDescription[0];
               n138SecParentFunctionalityDescription = H00312_n138SecParentFunctionalityDescription[0];
               A129SecParentFunctionalityId = H00312_A129SecParentFunctionalityId[0];
               n129SecParentFunctionalityId = H00312_n129SecParentFunctionalityId[0];
               A136SecFunctionalityType = H00312_A136SecFunctionalityType[0];
               n136SecFunctionalityType = H00312_n136SecFunctionalityType[0];
               A135SecFunctionalityDescription = H00312_A135SecFunctionalityDescription[0];
               n135SecFunctionalityDescription = H00312_n135SecFunctionalityDescription[0];
               A130SecFunctionalityKey = H00312_A130SecFunctionalityKey[0];
               n130SecFunctionalityKey = H00312_n130SecFunctionalityKey[0];
               A138SecParentFunctionalityDescription = H00312_A138SecParentFunctionalityDescription[0];
               n138SecParentFunctionalityDescription = H00312_n138SecParentFunctionalityDescription[0];
               /* Execute user event: Grid.Load */
               E17312 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H00313 */
         pr_default.execute(1, new Object[] {AV22SecParentFunctionalityId});
      ...
      protected void E13312( )
      {
         ...
         {
            AV27OrderedBy = (short)(Math.Round(NumberUtil.Val( Ddo_grid_Selectedvalue_get, "."), 18, MidpointRounding.ToEven));
            AssignAttri("", false, "AV27OrderedBy", StringUtil.LTrimStr( (decimal)(AV27OrderedBy), 4, 0));
            AV28OrderedDsc = ((StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#OrderDSC#>")==0) ? true : false);
            AssignAttri("", false, "AV28OrderedDsc", AV28OrderedDsc);
            /* Execute user subroutine: 'SETDDOSORTEDSTATUS' */
            S112 ();
            if ( returnInSub )
            {
      ...
      private void E17312( )
      {
         ...
         {
            A131SecRoleId = H00314_A131SecRoleId[0];
      ...
      protected void E14312( )
      {
         ...
         AV55GXV1 = 1;
         while ( AV55GXV1 <= AV11SecFunctionalityIdRemoved.Count )
         {
            AV12SecFunctionalityId = (long)(AV11SecFunctionalityIdRemoved.GetNumeric(AV55GXV1));
         ...
         AssignAttri("", false, "AV20i", StringUtil.LTrimStr( (decimal)(AV20i), 10, 0));
         AV56GXV2 = 1;
         while ( AV56GXV2 <= AV10SecFunctionalityIdAdded.Count )
         {
            AV12SecFunctionalityId = (long)(AV10SecFunctionalityIdAdded.GetNumeric(AV56GXV2));
            AV21SecFunctionalityRole = new GeneXus.Programs.wwpbaseobjects.SdtSecFunctionalityRole(context);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         Ddo_grid_Sortedstatus = StringUtil.Trim( StringUtil.Str( (decimal)(AV27OrderedBy), 4, 0))+":"+(AV28OrderedDsc ? "DSC" : "ASC");
      ...
      protected void S142( )
      {
         ...
         AssignAttri("", false, "AV20i", StringUtil.LTrimStr( (decimal)(AV20i), 10, 0));
         AV57GXV3 = 1;
         while ( AV57GXV3 <= AV10SecFunctionalityIdAdded.Count )
         {
            AV12SecFunctionalityId = (long)(AV10SecFunctionalityIdAdded.GetNumeric(AV57GXV3));
      ...
      protected void S132( )
      {
         ...
         AssignAttri("", false, "AV20i", StringUtil.LTrimStr( (decimal)(AV20i), 10, 0));
         AV58GXV4 = 1;
         while ( AV58GXV4 <= AV11SecFunctionalityIdRemoved.Count )
         {
            AV12SecFunctionalityId = (long)(AV11SecFunctionalityIdRemoved.GetNumeric(AV58GXV4));
            if ( AV12SecFunctionalityId == AV13SecFunctionalityIdToFind )
            {
               if (true) break;
            }
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         AV60GXV6 = 1;
         AV59GXV5 = AV21SecFunctionalityRole.GetMessages();
         while ( AV60GXV6 <= AV59GXV5.Count )
         {
            AV16Message = ((GeneXus.Utils.SdtMessages_Message)AV59GXV5.Item(AV60GXV6));
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV8SecRoleId", StringUtil.LTrimStr( (decimal)(AV8SecRoleId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSECROLEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV8SecRoleId), "ZZZ9"), context));
         AV22SecParentFunctionalityId = Convert.ToInt64(getParm(obj,1));
         AssignAttri("", false, "AV22SecParentFunctionalityId", StringUtil.LTrimStr( (decimal)(AV22SecParentFunctionalityId), 10, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019234838", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/secrolefunroleactionassociationww.js", "?202561019234839", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV27OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV28OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV22SecParentFunctionalityId","fld":"vSECPARENTFUNCTIONALITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A131SecRoleId","fld":"SECROLEID","pic":"ZZZ9","type":"int"},{"av":"AV20i","fld":"vI","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV11SecFunctionalityIdRemoved","fld":"vSECFUNCTIONALITYIDREMOVED","type":""},{"av":"AV13SecFunctionalityIdToFind","fld":"vSECFUNCTIONALITYIDTOFIND","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV10SecFunctionalityIdAdded","fld":"vSECFUNCTIONALITYIDADDED","type":""},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV15SecFunctionalityIdRemovedXml","fld":"vSECFUNCTIONALITYIDREMOVEDXML","type":"vchar"},{"av":"AV14SecFunctionalityIdAddedXml","fld":"vSECFUNCTIONALITYIDADDEDXML","type":"vchar"},{"av":"AV8SecRoleId","fld":"vSECROLEID","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV9SecRoleIdParm","fld":"vSECROLEIDPARM","pic":"ZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV49GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV50GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV51GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS","type":"svchar"},{"av":"AV11SecFunctionalityIdRemoved","fld":"vSECFUNCTIONALITYIDREMOVED","type":""},{"av":"AV10SecFunctionalityIdAdded","fld":"vSECFUNCTIONALITYIDADDED","type":""}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E11312","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV27OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV28OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV22SecParentFunctionalityId","fld":"vSECPARENTFUNCTIONALITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV15SecFunctionalityIdRemovedXml","fld":"vSECFUNCTIONALITYIDREMOVEDXML","type":"vchar"},{"av":"AV14SecFunctionalityIdAddedXml","fld":"vSECFUNCTIONALITYIDADDEDXML","type":"vchar"},{"av":"AV8SecRoleId","fld":"vSECROLEID","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"A131SecRoleId","fld":"SECROLEID","pic":"ZZZ9","type":"int"},{"av":"AV20i","fld":"vI","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV11SecFunctionalityIdRemoved","fld":"vSECFUNCTIONALITYIDREMOVED","type":""},{"av":"AV13SecFunctionalityIdToFind","fld":"vSECFUNCTIONALITYIDTOFIND","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV10SecFunctionalityIdAdded","fld":"vSECFUNCTIONALITYIDADDED","type":""},{"av":"AV9SecRoleIdParm","fld":"vSECROLEIDPARM","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E12312","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV27OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV28OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV22SecParentFunctionalityId","fld":"vSECPARENTFUNCTIONALITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV15SecFunctionalityIdRemovedXml","fld":"vSECFUNCTIONALITYIDREMOVEDXML","type":"vchar"},{"av":"AV14SecFunctionalityIdAddedXml","fld":"vSECFUNCTIONALITYIDADDEDXML","type":"vchar"},{"av":"AV8SecRoleId","fld":"vSECROLEID","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"A131SecRoleId","fld":"SECROLEID","pic":"ZZZ9","type":"int"},{"av":"AV20i","fld":"vI","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV11SecFunctionalityIdRemoved","fld":"vSECFUNCTIONALITYIDREMOVED","type":""},{"av":"AV13SecFunctionalityIdToFind","fld":"vSECFUNCTIONALITYIDTOFIND","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV10SecFunctionalityIdAdded","fld":"vSECFUNCTIONALITYIDADDED","type":""},{"av":"AV9SecRoleIdParm","fld":"vSECROLEIDPARM","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E13312","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV27OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV28OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV22SecParentFunctionalityId","fld":"vSECPARENTFUNCTIONALITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV15SecFunctionalityIdRemovedXml","fld":"vSECFUNCTIONALITYIDREMOVEDXML","type":"vchar"},{"av":"AV14SecFunctionalityIdAddedXml","fld":"vSECFUNCTIONALITYIDADDEDXML","type":"vchar"},{"av":"AV8SecRoleId","fld":"vSECROLEID","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"A131SecRoleId","fld":"SECROLEID","pic":"ZZZ9","type":"int"},{"av":"AV20i","fld":"vI","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV11SecFunctionalityIdRemoved","fld":"vSECFUNCTIONALITYIDREMOVED","type":""},{"av":"AV13SecFunctionalityIdToFind","fld":"vSECFUNCTIONALITYIDTOFIND","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV10SecFunctionalityIdAdded","fld":"vSECFUNCTIONALITYIDADDED","type":""},{"av":"AV9SecRoleIdParm","fld":"vSECROLEIDPARM","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV27OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV28OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E17312","iparms":[{"av":"AV8SecRoleId","fld":"vSECROLEID","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"A131SecRoleId","fld":"SECROLEID","pic":"ZZZ9","type":"int"},{"av":"A128SecFunctionalityId","fld":"SECFUNCTIONALITYID","pic":"ZZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV20i","fld":"vI","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV11SecFunctionalityIdRemoved","fld":"vSECFUNCTIONALITYIDREMOVED","type":""},{"av":"AV13SecFunctionalityIdToFind","fld":"vSECFUNCTIONALITYIDTOFIND","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV10SecFunctionalityIdAdded","fld":"vSECFUNCTIONALITYIDADDED","type":""},{"av":"AV9SecRoleIdParm","fld":"vSECROLEIDPARM","pic":"ZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV9SecRoleIdParm","fld":"vSECROLEIDPARM","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV19IsAssociatedOld","fld":"vISASSOCIATEDOLD","hsh":true,"type":"boolean"},{"av":"AV13SecFunctionalityIdToFind","fld":"vSECFUNCTIONALITYIDTOFIND","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV18IsAssociated","fld":"vISASSOCIATED","type":"boolean"},{"av":"AV20i","fld":"vI","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("ENTER","""{"handler":"E14312","iparms":[{"av":"AV11SecFunctionalityIdRemoved","fld":"vSECFUNCTIONALITYIDREMOVED","type":""},{"av":"AV8SecRoleId","fld":"vSECROLEID","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV10SecFunctionalityIdAdded","fld":"vSECFUNCTIONALITYIDADDED","type":""},{"av":"AV15SecFunctionalityIdRemovedXml","fld":"vSECFUNCTIONALITYIDREMOVEDXML","type":"vchar"},{"av":"AV14SecFunctionalityIdAddedXml","fld":"vSECFUNCTIONALITYIDADDEDXML","type":"vchar"},{"av":"AV21SecFunctionalityRole","fld":"vSECFUNCTIONALITYROLE","type":""}]""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         H00312_A128SecFunctionalityId = new long[1] ;
         H00312_A134SecFunctionalityActive = new bool[] {false} ;
         H00312_n134SecFunctionalityActive = new bool[] {false} ;
         H00312_A138SecParentFunctionalityDescription = new string[] {""} ;
         H00312_n138SecParentFunctionalityDescription = new bool[] {false} ;
         H00312_A129SecParentFunctionalityId = new long[1] ;
         H00312_n129SecParentFunctionalityId = new bool[] {false} ;
         H00312_A136SecFunctionalityType = new short[1] ;
         H00312_n136SecFunctionalityType = new bool[] {false} ;
         H00312_A135SecFunctionalityDescription = new string[] {""} ;
         H00312_n135SecFunctionalityDescription = new bool[] {false} ;
         H00312_A130SecFunctionalityKey = new string[] {""} ;
         H00312_n130SecFunctionalityKey = new bool[] {false} ;
         H00313_AGRID_nRecordCount = new long[1] ;
         GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons1 = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         GXt_char2 = "";
         H00314_A128SecFunctionalityId = new long[1] ;
         H00314_A131SecRoleId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.secrolefunroleactionassociationww__default(),
            new Object[][] {
                new Object[] {
               H00312_A128SecFunctionalityId, H00312_A134SecFunctionalityActive, H00312_n134SecFunctionalityActive, H00312_A138SecParentFunctionalityDescription, H00312_n138SecParentFunctionalityDescription, H00312_A129SecParentFunctionalityId, H00312_n129SecParentFunctionalityId, H00312_A136SecFunctionalityType, H00312_n136SecFunctionalityType, H00312_A135SecFunctionalityDescription,
               H00312_n135SecFunctionalityDescription, H00312_A130SecFunctionalityKey, H00312_n130SecFunctionalityKey
               }
               , new Object[] {
               H00313_AGRID_nRecordCount
               }
               , new Object[] {
               H00314_A128SecFunctionalityId, H00314_A131SecRoleId
               }
            }
         );
         AV53Pgmname = "WWPBaseObjects.SecRoleFunRoleActionAssociationWW";
      ...
      private long AV22SecParentFunctionalityId ;
      private long wcpOAV22SecParentFunctionalityId ;
      ...
      private long[] H00312_A128SecFunctionalityId ;
      private bool[] H00312_A134SecFunctionalityActive ;
      private bool[] H00312_n134SecFunctionalityActive ;
      private string[] H00312_A138SecParentFunctionalityDescription ;
      private bool[] H00312_n138SecParentFunctionalityDescription ;
      private long[] H00312_A129SecParentFunctionalityId ;
      private bool[] H00312_n129SecParentFunctionalityId ;
      private short[] H00312_A136SecFunctionalityType ;
      private bool[] H00312_n136SecFunctionalityType ;
      private string[] H00312_A135SecFunctionalityDescription ;
      private bool[] H00312_n135SecFunctionalityDescription ;
      private string[] H00312_A130SecFunctionalityKey ;
      private bool[] H00312_n130SecFunctionalityKey ;
      private long[] H00313_AGRID_nRecordCount ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons1 ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private long[] H00314_A128SecFunctionalityId ;
      private short[] H00314_A131SecRoleId ;
   ...
   public class secrolefunroleactionassociationww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV22SecParentFunctionalityId )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "(T1.SecParentFunctionalityId = :AV22SecParentFunctionalityId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00312(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
               case 1 :
                     return conditional_H00313(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV22SecParentFunctionalityId",GXType.Int64,10,0) ,
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00314", "SELECT SecFunctionalityId, SecRoleId FROM SecFunctionalityRole WHERE SecFunctionalityId = :SecFunctionalityId and SecRoleId = :AV9SecRoleIdParm ORDER BY SecFunctionalityId, SecRoleId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00314,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
