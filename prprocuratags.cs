...
namespace GeneXus.Programs {
   public class prprocuratags : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSdMapearTags> aP1_Array_SDMapearTags )
      {
         ...
         this.AV9Array_SDMapearTags = new GXBaseCollection<SdtSdMapearTags>( context, "SdMapearTags", "Factory2") ;
         initialize();
         ExecuteImpl();
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV9Array_SDMapearTags = new GXBaseCollection<SdtSdMapearTags>( context, "SdMapearTags", "Factory2");
