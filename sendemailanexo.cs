...
namespace GeneXus.Programs {
   public class sendemailanexo : GXProcedure
   {
      public sendemailanexo( )
      {
      ...
      public sendemailanexo( IGxContext context )
      {
                           ...
                           out string aP4_message )
      {
         ...
         this.AV23Anexo = aP3_Anexo;
         this.AV16message = "" ;
         initialize();
         ExecuteImpl();
         aP4_message=this.AV16message;
      }
      ...
      public string executeUdp( string aP0_Subject ,
                                ...
                                string aP3_Anexo )
      {
         execute(aP0_Subject, aP1_Body, aP2_RecipientTo, aP3_Anexo, out aP4_message);
         return AV16message ;
      }
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A159ServidorSMTPServer = P00BC2_A159ServidorSMTPServer[0];
            n159ServidorSMTPServer = P00BC2_n159ServidorSMTPServer[0];
            A160ServidorSMTPPorta = P00BC2_A160ServidorSMTPPorta[0];
            n160ServidorSMTPPorta = P00BC2_n160ServidorSMTPPorta[0];
            A161ServidorSMTPEmail = P00BC2_A161ServidorSMTPEmail[0];
            n161ServidorSMTPEmail = P00BC2_n161ServidorSMTPEmail[0];
            A162ServidorSMTPPass = P00BC2_A162ServidorSMTPPass[0];
            n162ServidorSMTPPass = P00BC2_n162ServidorSMTPPass[0];
            A163ServidorSMTPUsuario = P00BC2_A163ServidorSMTPUsuario[0];
            n163ServidorSMTPUsuario = P00BC2_n163ServidorSMTPUsuario[0];
            A158ServidorSMTPId = P00BC2_A158ServidorSMTPId[0];
         ...
         else
         {
            ...
            AV17MailMessage.Attachments.Add(AV23Anexo);
      ...
      {
         AV16message = "";
         P00BC2_A159ServidorSMTPServer = new string[] {""} ;
         P00BC2_n159ServidorSMTPServer = new bool[] {false} ;
         P00BC2_A160ServidorSMTPPorta = new string[] {""} ;
         P00BC2_n160ServidorSMTPPorta = new bool[] {false} ;
         P00BC2_A161ServidorSMTPEmail = new string[] {""} ;
         P00BC2_n161ServidorSMTPEmail = new bool[] {false} ;
         P00BC2_A162ServidorSMTPPass = new string[] {""} ;
         P00BC2_n162ServidorSMTPPass = new bool[] {false} ;
         P00BC2_A163ServidorSMTPUsuario = new string[] {""} ;
         P00BC2_n163ServidorSMTPUsuario = new bool[] {false} ;
         P00BC2_A158ServidorSMTPId = new short[1] ;
         ...
         AV22AuxEmail = "";
         AV18MailRecipient = new GeneXus.Mail.GXMailRecipient();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sendemailanexo__default(),
            new Object[][] {
                new Object[] {
               P00BC2_A159ServidorSMTPServer, P00BC2_n159ServidorSMTPServer, P00BC2_A160ServidorSMTPPorta, P00BC2_n160ServidorSMTPPorta, P00BC2_A161ServidorSMTPEmail, P00BC2_n161ServidorSMTPEmail, P00BC2_A162ServidorSMTPPass, P00BC2_n162ServidorSMTPPass, P00BC2_A163ServidorSMTPUsuario, P00BC2_n163ServidorSMTPUsuario,
               P00BC2_A158ServidorSMTPId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00BC2_A159ServidorSMTPServer ;
      private bool[] P00BC2_n159ServidorSMTPServer ;
      private string[] P00BC2_A160ServidorSMTPPorta ;
      private bool[] P00BC2_n160ServidorSMTPPorta ;
      private string[] P00BC2_A161ServidorSMTPEmail ;
      private bool[] P00BC2_n161ServidorSMTPEmail ;
      private string[] P00BC2_A162ServidorSMTPPass ;
      private bool[] P00BC2_n162ServidorSMTPPass ;
      private string[] P00BC2_A163ServidorSMTPUsuario ;
      private bool[] P00BC2_n163ServidorSMTPUsuario ;
      private short[] P00BC2_A158ServidorSMTPId ;
      private string aP4_message ;
   }

   public class sendemailanexo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00BC2", "SELECT ServidorSMTPServer, ServidorSMTPPorta, ServidorSMTPEmail, ServidorSMTPPass, ServidorSMTPUsuario, ServidorSMTPId FROM ServidorSMTP ORDER BY ServidorSMTPId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BC2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
