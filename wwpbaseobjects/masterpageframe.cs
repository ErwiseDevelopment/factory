...
namespace GeneXus.Programs.wwpbaseobjects {
   public class masterpageframe : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm082( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?202561019225240", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202561019225346", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/masterpageframe.js", "?202561019225347", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
