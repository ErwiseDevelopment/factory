...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_search : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wwpbaseobjects.wwp_search"+UrlEncode(StringUtil.RTrim(AV10DeafultSearchText)) + "," + UrlEncode(StringUtil.BoolToStr(AV12DefaultIsAdvancedSearch)) + "," + UrlEncode(StringUtil.RTrim(AV11DefaultAdvFilterEntitiesJson));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.wwp_search") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.wwp_search"+UrlEncode(StringUtil.RTrim(AV10DeafultSearchText)) + "," + UrlEncode(StringUtil.BoolToStr(AV12DefaultIsAdvancedSearch)) + "," + UrlEncode(StringUtil.RTrim(AV11DefaultAdvFilterEntitiesJson));
         return formatLink("wwpbaseobjects.wwp_search") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB0N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9 col-md-8 col-lg-6 DataContentCellFL", "start", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavSearchtext_Internalname, AV25SearchText, StringUtil.RTrim( context.localUtil.Format( AV25SearchText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSearchtext_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavSearchtext_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPBaseObjects/WWP_Search.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavAdvfiltertext_Internalname, AV8AdvFilterText, StringUtil.RTrim( context.localUtil.Format( AV8AdvFilterText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavAdvfiltertext_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavAdvfiltertext_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPBaseObjects/WWP_Search.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9 col-md-8 col-lg-6 DataContentCellFL ExtendedComboCell", "start", "top", "", "", "div");
            /* Div Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 23), "FSRESULTCATEGORIES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "FSRESULTS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 17), "TABLEFSCARD.CLICK") == 0 ) )
                           {
                              ...
                              AV30GXV1 = nGXsfl_50_idx;
                              if ( ( AV28WWP_SearchResults.Count >= AV30GXV1 ) && ( AV30GXV1 > 0 ) )
                              {
                                 AV28WWP_SearchResults.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.Item(AV30GXV1));
                              }
                              GXCCtl = "subFsresults_Recordcount_" + sGXsfl_50_idx;
                              subFsresults_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( GXCCtl), ",", "."), 18, MidpointRounding.ToEven));
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                              ...
                              else
                              {
                                 ...
                                 if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "FSRESULTS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 17), "TABLEFSCARD.CLICK") == 0 ) )
                                 {
                                    ...
                                    AssignProp("", false, edtavDisplaytype4_image_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV17DisplayType4_Image)) ? AV33Displaytype4_image_GXI : context.convertURL( context.PathToRelativeUrl( AV17DisplayType4_Image))), !bGXsfl_58_Refreshing);
      ...
      protected void PA0N2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.wwp_search")), "wwpbaseobjects.wwp_search") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.wwp_search")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void send_integrity_lvl_hashes0N3( )
      {
      }
      ...
      protected void STRUP0N0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            while ( nGXsfl_50_fel_idx < nRC_GXsfl_50 )
            {
               ...
               AV30GXV1 = nGXsfl_50_fel_idx;
               if ( ( AV28WWP_SearchResults.Count >= AV30GXV1 ) && ( AV30GXV1 > 0 ) )
               {
                  AV28WWP_SearchResults.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.Item(AV30GXV1));
               }
               GXCCtl = "subFsresults_Recordcount_" + sGXsfl_50_fel_idx;
               subFsresults_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( GXCCtl), ",", "."), 18, MidpointRounding.ToEven));
            }
      ...
      private void E150N2( )
      {
         ...
         returnInSub = false;
         AV30GXV1 = 1;
         while ( AV30GXV1 <= AV28WWP_SearchResults.Count )
         {
            AV28WWP_SearchResults.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.Item(AV30GXV1));
      ...
      {
         AV30GXV1 = nGXsfl_50_idx;
         if ( ( AV30GXV1 > 0 ) && ( AV28WWP_SearchResults.Count >= AV30GXV1 ) )
         {
            AV28WWP_SearchResults.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.Item(AV30GXV1));
         }
      ...
      protected void S112( )
      {
         ...
         AV34GXV4 = 1;
         while ( AV34GXV4 <= AV22EntityDescriptions.Count )
         {
            AV21EntityDescription = ((string)AV22EntityDescriptions.Item(AV34GXV4));
      ...
      protected void S122( )
      {
         ...
         {
            AV28WWP_SearchResults = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>( context, "WWP_SearchResultsItem", "Factory2");
            gx_BV50 = true;
         }
      ...
      {
         AV30GXV1 = nGXsfl_50_idx;
         if ( AV28WWP_SearchResults.Count < AV30GXV1 )
         {
            return  ;
         }
         ...
         returnInSub = false;
         AV32GXV3 = 1;
         while ( AV32GXV3 <= ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.Item(AV30GXV1)).gxTpr_Result.Count )
         {
            ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.Item(AV30GXV1)).gxTpr_Result.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)AV28WWP_SearchResults.Item(AV30GXV1)).gxTpr_Result.Item(AV32GXV3));
            ...
            else if ( StringUtil.StrCmp(((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.CurrentItem)).gxTpr_Result.CurrentItem)).gxTpr_Displaytype, "Title and image") == 0 )
            {
               ...
               else
               {
                  ...
                  AssignAttri("", false, edtavDisplaytype4_image_Internalname, AV17DisplayType4_Image);
                  AV33Displaytype4_image_GXI = GXDbFile.PathToUrl( ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem_ResultItem)(((GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem)(AV28WWP_SearchResults.CurrentItem)).gxTpr_Result.CurrentItem)).gxTpr_Description2, context);
               }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918525034", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/wwp_search.js", "?202551918525035", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void sendrow_583( )
      {
         ...
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divUnnamedtablefsfsresults_Internalname+"_"+sGXsfl_58_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"Flex",(string)"start",(string)"top",(string)" "+"data-gx-flex"+" ",(string)"",(string)"div"});
         /* Div Control */
         ...
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divTablefscard_Internalname+"_"+sGXsfl_58_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"SimpleCardTable",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         ...
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divDisplaytype1_cell_Internalname+"_"+sGXsfl_58_idx,(int)divDisplaytype1_cell_Visible,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divUnnamedtable1_Internalname+"_"+sGXsfl_58_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"Table",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 74,'',false,'" + sGXsfl_58_idx + "',58)\"";
         ...
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divDisplaytype2_cell_Internalname+"_"+sGXsfl_58_idx,(int)divDisplaytype2_cell_Visible,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Table start */
         FsresultsRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {(string)tblUnnamedtable2_Internalname+"_"+sGXsfl_58_idx,(short)1,(string)"Table",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(short)2,(string)"",(string)"",(string)"",(string)"px",(string)"px",(string)""});
         FsresultsRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         /* Text block */
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 83,'',false,'" + sGXsfl_58_idx + "',58)\"";
         ROClassString = "AttributeSearchResultTitle";
         ...
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divDisplaytype3_cell_Internalname+"_"+sGXsfl_58_idx,(int)divDisplaytype3_cell_Visible,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divUnnamedtable3_Internalname+"_"+sGXsfl_58_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"Table",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
      ...
      protected void sendrow_58330( )
      {
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 90,'',false,'" + sGXsfl_58_idx + "',58)\"";
         ROClassString = "AttributeSearchResultTitle";
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 94,'',false,'" + sGXsfl_58_idx + "',58)\"";
         ...
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divDisplaytype4_cell_Internalname+"_"+sGXsfl_58_idx,(int)divDisplaytype4_cell_Visible,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divUnnamedtable4_Internalname+"_"+sGXsfl_58_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"Flex",(string)"start",(string)"top",(string)" "+"data-gx-flex"+" ",(string)"",(string)"div"});
         /* Div Control */
         ...
         StyleString = "";
         AV17DisplayType4_Image_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV17DisplayType4_Image))&&String.IsNullOrEmpty(StringUtil.RTrim( AV33Displaytype4_image_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV17DisplayType4_Image)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV17DisplayType4_Image)) ? AV33Displaytype4_image_GXI : context.PathToRelativeUrl( AV17DisplayType4_Image));
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 103,'',false,'" + sGXsfl_58_idx + "',58)\"";
         ROClassString = "AttributeSearchResultTitle";
         ...
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divDisplaytype5_cell_Internalname+"_"+sGXsfl_58_idx,(int)divDisplaytype5_cell_Visible,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Table start */
         FsresultsRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {(string)tblUnnamedtable5_Internalname+"_"+sGXsfl_58_idx,(short)1,(string)"Table",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(short)2,(string)"",(string)"",(string)"",(string)"px",(string)"px",(string)""});
         FsresultsRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         /* Text block */
         ...
         FsresultsRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divUnnamedtable6_Internalname+"_"+sGXsfl_58_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"Table",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"row",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         FsresultsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"col-xs-12",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 115,'',false,'" + sGXsfl_58_idx + "',58)\"";
         ROClassString = "AttributeSearchResultTitle";
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 119,'',false,'" + sGXsfl_58_idx + "',58)\"";
         ROClassString = "AttributeSearchResultSubtitle";
      ...
      protected void sendrow_502( )
      {
         ...
         /* Div Control */
         FsresultcategoriesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)divUnnamedtablefsfsresultcategories_Internalname+"_"+sGXsfl_50_idx,(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"Table",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Div Control */
         ...
         GXCCtl = "subFsresults_Recordcount_" + sGXsfl_50_idx;
         GxWebStd.gx_hidden_field( context, GXCCtl, StringUtil.LTrim( StringUtil.NToC( (decimal)(subFsresults_Recordcount), 5, 0, ",", "")));
         /* End of Columns property logic. */
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"FSRESULTCATEGORIES_nFirstRecordOnPage","type":"int"},{"av":"FSRESULTCATEGORIES_nEOF","type":"int"},{"av":"FSRESULTS_nFirstRecordOnPage","type":"int"},{"av":"FSRESULTS_nEOF","type":"int"},{"av":"edtavUrl_Visible","ctrl":"vURL","prop":"Visible"},{"av":"AV28WWP_SearchResults","fld":"vWWP_SEARCHRESULTS","grid":50,"type":""},{"av":"nGXsfl_50_idx","ctrl":"GRID","prop":"GridCurrRow","grid":50},{"av":"nRC_GXsfl_50","ctrl":"FSRESULTCATEGORIES","prop":"GridRC","grid":50,"type":"int"},{"av":"AV10DeafultSearchText","fld":"vDEAFULTSEARCHTEXT","hsh":true,"type":"svchar"},{"av":"AV12DefaultIsAdvancedSearch","fld":"vDEFAULTISADVANCEDSEARCH","hsh":true,"type":"boolean"},{"av":"AV11DefaultAdvFilterEntitiesJson","fld":"vDEFAULTADVFILTERENTITIESJSON","hsh":true,"type":"svchar"}]}""");
         setEventMetadata("FSRESULTCATEGORIES.LOAD","""{"handler":"E150N2","iparms":[{"av":"AV28WWP_SearchResults","fld":"vWWP_SEARCHRESULTS","grid":50,"type":""},{"av":"nGXsfl_50_idx","ctrl":"GRID","prop":"GridCurrRow","grid":50},{"av":"FSRESULTCATEGORIES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_50","ctrl":"FSRESULTCATEGORIES","prop":"GridRC","grid":50,"type":"int"}]""");
         setEventMetadata("FSRESULTCATEGORIES.LOAD",""","oparms":[{"av":"lblTxtshowingonly_Caption","ctrl":"TXTSHOWINGONLY","prop":"Caption"}]}""");
         setEventMetadata("FSRESULTS.LOAD","""{"handler":"E160N3","iparms":[{"av":"AV28WWP_SearchResults","fld":"vWWP_SEARCHRESULTS","grid":50,"type":""},{"av":"nGXsfl_50_idx","ctrl":"GRID","prop":"GridCurrRow","grid":50},{"av":"FSRESULTCATEGORIES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_50","ctrl":"FSRESULTCATEGORIES","prop":"GridRC","grid":50,"type":"int"}]""");
         setEventMetadata("FSRESULTS.LOAD",""","oparms":[{"av":"divDisplaytype1_cell_Visible","ctrl":"DISPLAYTYPE1_CELL","prop":"Visible"},{"av":"divDisplaytype2_cell_Visible","ctrl":"DISPLAYTYPE2_CELL","prop":"Visible"},{"av":"divDisplaytype3_cell_Visible","ctrl":"DISPLAYTYPE3_CELL","prop":"Visible"},{"av":"divDisplaytype4_cell_Visible","ctrl":"DISPLAYTYPE4_CELL","prop":"Visible"},{"av":"divDisplaytype5_cell_Visible","ctrl":"DISPLAYTYPE5_CELL","prop":"Visible"},{"av":"AV13DisplayType1_Title","fld":"vDISPLAYTYPE1_TITLE","type":"svchar"},{"av":"AV14DisplayType2_Title","fld":"vDISPLAYTYPE2_TITLE","type":"svchar"},{"av":"lblDisplaytype2_icon_Caption","ctrl":"DISPLAYTYPE2_ICON","prop":"Caption"},{"av":"AV16DisplayType3_Title","fld":"vDISPLAYTYPE3_TITLE","type":"svchar"},{"av":"AV15DisplayType3_Subtitle","fld":"vDISPLAYTYPE3_SUBTITLE","type":"svchar"},{"av":"AV18DisplayType4_Title","fld":"vDISPLAYTYPE4_TITLE","type":"svchar"},{"av":"AV17DisplayType4_Image","fld":"vDISPLAYTYPE4_IMAGE","type":"bits"},{"av":"edtavDisplaytype4_image_Visible","ctrl":"vDISPLAYTYPE4_IMAGE","prop":"Visible"},{"av":"AV20DisplayType5_Title","fld":"vDISPLAYTYPE5_TITLE","type":"svchar"},{"av":"AV19DisplayType5_Subtitle","fld":"vDISPLAYTYPE5_SUBTITLE","type":"svchar"},{"av":"lblDisplaytype5_icon_Caption","ctrl":"DISPLAYTYPE5_ICON","prop":"Caption"},{"av":"AV26Url","fld":"vURL","type":"svchar"}]}""");
         setEventMetadata("'DOBTNADVSEARCH'","""{"handler":"E110N2","iparms":[{"av":"AV23IsAdvancedSearch","fld":"vISADVANCEDSEARCH","type":"boolean"},{"av":"AV8AdvFilterText","fld":"vADVFILTERTEXT","type":"svchar"},{"av":"AV25SearchText","fld":"vSEARCHTEXT","type":"svchar"},{"av":"AV5AdvFilterEntities","fld":"vADVFILTERENTITIES","type":""},{"av":"AV28WWP_SearchResults","fld":"vWWP_SEARCHRESULTS","grid":50,"type":""},{"av":"nGXsfl_50_idx","ctrl":"GRID","prop":"GridCurrRow","grid":50},{"av":"FSRESULTCATEGORIES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_50","ctrl":"FSRESULTCATEGORIES","prop":"GridRC","grid":50,"type":"int"},{"av":"FSRESULTCATEGORIES_nEOF","type":"int"},{"av":"FSRESULTS_nFirstRecordOnPage","type":"int"},{"av":"FSRESULTS_nEOF","type":"int"},{"av":"edtavUrl_Visible","ctrl":"vURL","prop":"Visible"},{"av":"AV10DeafultSearchText","fld":"vDEAFULTSEARCHTEXT","hsh":true,"type":"svchar"},{"av":"AV12DefaultIsAdvancedSearch","fld":"vDEFAULTISADVANCEDSEARCH","hsh":true,"type":"boolean"},{"av":"AV11DefaultAdvFilterEntitiesJson","fld":"vDEFAULTADVFILTERENTITIESJSON","hsh":true,"type":"svchar"}]""");
         setEventMetadata("'DOBTNADVSEARCH'",""","oparms":[{"av":"divTableadvancedsearchcell_Visible","ctrl":"TABLEADVANCEDSEARCHCELL","prop":"Visible"},{"av":"divTablesimplesearchcell_Visible","ctrl":"TABLESIMPLESEARCHCELL","prop":"Visible"},{"av":"AV25SearchText","fld":"vSEARCHTEXT","type":"svchar"},{"av":"AV5AdvFilterEntities","fld":"vADVFILTERENTITIES","type":""},{"av":"Combo_advfilterentities_Selectedvalue_set","ctrl":"COMBO_ADVFILTERENTITIES","prop":"SelectedValue_set"},{"av":"AV28WWP_SearchResults","fld":"vWWP_SEARCHRESULTS","grid":50,"type":""},{"av":"nGXsfl_50_idx","ctrl":"GRID","prop":"GridCurrRow","grid":50},{"av":"FSRESULTCATEGORIES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_50","ctrl":"FSRESULTCATEGORIES","prop":"GridRC","grid":50,"type":"int"},{"av":"lblTxtnoresults_Caption","ctrl":"TXTNORESULTS","prop":"Caption"},{"av":"divFsresultcategoriescell_Visible","ctrl":"FSRESULTCATEGORIESCELL","prop":"Visible"},{"av":"divTxtnoresultscell_Visible","ctrl":"TXTNORESULTSCELL","prop":"Visible"}]}""");
         setEventMetadata("ENTER","""{"handler":"E120N2","iparms":[{"av":"AV23IsAdvancedSearch","fld":"vISADVANCEDSEARCH","type":"boolean"},{"av":"AV8AdvFilterText","fld":"vADVFILTERTEXT","type":"svchar"},{"av":"AV25SearchText","fld":"vSEARCHTEXT","type":"svchar"},{"av":"AV5AdvFilterEntities","fld":"vADVFILTERENTITIES","type":""},{"av":"AV28WWP_SearchResults","fld":"vWWP_SEARCHRESULTS","grid":50,"type":""},{"av":"nGXsfl_50_idx","ctrl":"GRID","prop":"GridCurrRow","grid":50},{"av":"FSRESULTCATEGORIES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_50","ctrl":"FSRESULTCATEGORIES","prop":"GridRC","grid":50,"type":"int"},{"av":"FSRESULTCATEGORIES_nEOF","type":"int"},{"av":"FSRESULTS_nFirstRecordOnPage","type":"int"},{"av":"FSRESULTS_nEOF","type":"int"},{"av":"edtavUrl_Visible","ctrl":"vURL","prop":"Visible"},{"av":"AV10DeafultSearchText","fld":"vDEAFULTSEARCHTEXT","hsh":true,"type":"svchar"},{"av":"AV12DefaultIsAdvancedSearch","fld":"vDEFAULTISADVANCEDSEARCH","hsh":true,"type":"boolean"},{"av":"AV11DefaultAdvFilterEntitiesJson","fld":"vDEFAULTADVFILTERENTITIESJSON","hsh":true,"type":"svchar"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"divTableadvancedsearchcell_Visible","ctrl":"TABLEADVANCEDSEARCHCELL","prop":"Visible"},{"av":"divTablesimplesearchcell_Visible","ctrl":"TABLESIMPLESEARCHCELL","prop":"Visible"},{"av":"AV25SearchText","fld":"vSEARCHTEXT","type":"svchar"},{"av":"AV5AdvFilterEntities","fld":"vADVFILTERENTITIES","type":""},{"av":"Combo_advfilterentities_Selectedvalue_set","ctrl":"COMBO_ADVFILTERENTITIES","prop":"SelectedValue_set"},{"av":"AV28WWP_SearchResults","fld":"vWWP_SEARCHRESULTS","grid":50,"type":""},{"av":"nGXsfl_50_idx","ctrl":"GRID","prop":"GridCurrRow","grid":50},{"av":"FSRESULTCATEGORIES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_50","ctrl":"FSRESULTCATEGORIES","prop":"GridRC","grid":50,"type":"int"},{"av":"lblTxtnoresults_Caption","ctrl":"TXTNORESULTS","prop":"Caption"},{"av":"divFsresultcategoriescell_Visible","ctrl":"FSRESULTCATEGORIESCELL","prop":"Visible"},{"av":"divTxtnoresultscell_Visible","ctrl":"TXTNORESULTSCELL","prop":"Visible"}]}""");
         setEventMetadata("TABLEFSCARD.CLICK","""{"handler":"E130N2","iparms":[{"av":"AV28WWP_SearchResults","fld":"vWWP_SEARCHRESULTS","grid":50,"type":""},{"av":"nGXsfl_50_idx","ctrl":"GRID","prop":"GridCurrRow","grid":50},{"av":"FSRESULTCATEGORIES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_50","ctrl":"FSRESULTCATEGORIES","prop":"GridRC","grid":50,"type":"int"},{"av":"AV26Url","fld":"vURL","type":"svchar"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV27WWP_SearchResultAux = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>( context, "WWP_SearchResultsItem", "Factory2");
         AV21EntityDescription = "";
         AV7AdvFilterEntities_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         Combo_advfilterentities_Selectedvalue_set = "";
         GXt_objcol_SdtWWP_SearchResults_WWP_SearchResultsItem2 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>( context, "WWP_SearchResultsItem", "Factory2");
