   ...
   public class wwp_dfc_mcheckbox_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_mcheckbox_wc"+UrlEncode(StringUtil.RTrim(AV16WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV19WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV12SessionId,4,0));
      ...
      protected void WB220( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_mcheckbox_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         ...
         if ( wbEnd == 12 )
         {
            ...
            wb_table1_21_222( true) ;
         }
         else
         {
            wb_table1_21_222( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_222e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_34_222( true) ;
         }
         else
         {
            wb_table2_34_222( false) ;
         }
         return  ;
      }

      protected void wb_table2_34_222e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_39_222( true) ;
         }
         else
         {
            wb_table3_39_222( false) ;
         }
         return  ;
      }

      protected void wb_table3_39_222e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, sPrefix+"W0045"+"", StringUtil.RTrim( WebComp_Wwpaux_wc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+sPrefix+"gxHTMLWrpW0045"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( bGXsfl_12_Refreshing )
               {
                  if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
                  {
                     ...
                     {
                        context.httpAjaxContext.ajax_rspStartCmp(sPrefix+"gxHTMLWrpW0045"+"");
                     }
               ...
               if ( context.wbHandled == 0 )
               {
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 45 )
                        {
                           OldWwpaux_wc = cgiGet( sPrefix+"W0045");
                           ...
                           if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
                           {
                              WebComp_Wwpaux_wc.componentprocess(sPrefix+"W0045", "", sEvt);
                           }
                           WebComp_Wwpaux_wc_Component = OldWwpaux_wc;
                        }
                     }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_mcheckbox_wc")), "workwithplus.dynamicforms.wwp_dfc_mcheckbox_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_mcheckbox_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      private void E18222( )
      {
         ...
         while ( AV8i <= AV13WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Options.Count )
         {
            ...
            {
               AV6DataCellNameClass = "DataContentCellFL DataContentCellNoLabel";
            }
            else
            {
               AV6DataCellNameClass = "DataContentCellFL";
               if ( AV8i == 1 )
               {
                  if ( AV14WWP_DF_DateMetadata.gxTpr_Isrequired )
                  {
                     AV6DataCellNameClass = "RequiredDataContentCellFL " + AV6DataCellNameClass;
                  }
                  chkavData.Caption = AV18WWPFormElement.gxTpr_Wwpformelementtitle;
               }
            }
      ...
      protected void E13222( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)sPrefix+"W0045",(string)"",(string)"UPD",(short)0,(short)AV19WWPFormElementId,(short)AV12SessionId});
      ...
      protected void wb_table3_39_222( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_39_222e( true) ;
         }
         else
         {
            wb_table3_39_222e( false) ;
         }
      }

      protected void wb_table2_34_222( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_34_222e( true) ;
         }
         else
         {
            wb_table2_34_222e( false) ;
         }
      }

      protected void wb_table1_21_222( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_222e( true) ;
         }
         else
         {
            wb_table1_21_222e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101973542", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_mcheckbox_wc.js", "?20256101973544", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void sendrow_122( )
      {
         ...
         FsRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkavData_Internalname,StringUtil.BoolToStr( AV5Data),(string)"",chkavData.Caption,(short)1,(short)0,(string)"true",(string)"Data",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)""});
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"FS_nFirstRecordOnPage","type":"int"},{"av":"FS_nEOF","type":"int"},{"av":"AV13WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","type":""},{"av":"AV18WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"sPrefix","type":"char"},{"av":"AV9IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV10IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV14WWP_DF_DateMetadata","fld":"vWWP_DF_DATEMETADATA","hsh":true,"type":""},{"av":"AV20ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV15WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"}]""");
         ...
         setEventMetadata("FS.LOAD","""{"handler":"E18222","iparms":[{"av":"AV13WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","type":""},{"av":"AV18WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV14WWP_DF_DateMetadata","fld":"vWWP_DF_DATEMETADATA","hsh":true,"type":""}]""");
         setEventMetadata("FS.LOAD",""","oparms":[{"av":"chkavData.Caption","ctrl":"vDATA","prop":"Caption"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"}]}""");
         setEventMetadata("'DOMOVEUP'","""{"handler":"E14222","iparms":[{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E15222","iparms":[{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E11222","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE",""","oparms":[{"av":"AV17WWPForm","fld":"vWWPFORM","type":""},{"av":"AV18WWPFormElement","fld":"vWWPFORMELEMENT","type":""}]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13222","iparms":[{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12222","iparms":[{"av":"FS_nFirstRecordOnPage","type":"int"},{"av":"FS_nEOF","type":"int"},{"av":"AV9IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV10IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV13WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","type":""},{"av":"AV18WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV14WWP_DF_DateMetadata","fld":"vWWP_DF_DATEMETADATA","hsh":true,"type":""},{"av":"AV20ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV15WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"},{"av":"sPrefix","type":"char"},{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV12SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV11NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV17WWPForm","fld":"vWWPFORM","type":""},{"av":"AV18WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV11NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"AV13WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","type":""},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"},{"av":"Btnmoveup_Visible","ctrl":"BTNMOVEUP","prop":"Visible"},{"av":"Btnmovedown_Visible","ctrl":"BTNMOVEDOWN","prop":"Visible"}]}""");
