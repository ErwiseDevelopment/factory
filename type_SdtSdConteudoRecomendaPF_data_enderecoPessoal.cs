...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SdConteudoRecomendaPF.data.enderecoPessoal" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"SdConteudoRecomendaPF.data.enderecoPessoal", Namespace="Factory2")]
