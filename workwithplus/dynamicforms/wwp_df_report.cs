   ...
   public class wwp_df_report : GXWebProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         try
         {
            ...
            AV86WWPFormElements = new GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element>( context, "WWP_Form.Element", "Factory2");
            ...
            while ( AV98GXV1 <= AV86WWPFormElements.Count )
            {
               ...
               else if ( AV81WWPFormElement.gxTpr_Wwpformelementtype == 3 )
               {
                  ...
                  {
                     AV87WWPFormElementsMultiples = new GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element>( context, "WWP_Form.Element", "Factory2");
         ...
         while ( ( ToSkip > 0 ) || ( Gx_line + Inc > P_lines ) )
         {
            if ( Gx_line + Inc >= P_lines )
            {
               if ( Gx_page > 0 )
               {
                  /* Print footers */
                  Gx_line = P_lines;
                  AV96PagesFooter = StringUtil.Format( "Página: %1", StringUtil.LTrimStr( (decimal)(Gx_page), 6, 0), "", "", "", "", "", "", "", "");
