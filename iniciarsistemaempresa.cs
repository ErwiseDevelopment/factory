   ...
   public class iniciarsistemaempresa : GXWebComponent
   {
      ...
      protected void WB7K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavEmpresarazaosocial_Internalname, "Razão social", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavEmpresaagencia_Internalname, "Agência", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup2_Internalname, "Endereço", 1, 0, "px", 0, "px", "Group", "", "HLP_IniciarSistemaEmpresa.htm");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavEmpresalogradouronumero_Internalname, "Número", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
      ...
      protected void S132( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", "CNPJ", "", "", "", "", "", "", "", ""),  "error",  edtavEmpresacnpj_Internalname,  "true",  ""));
            AV37CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV37CheckRequiredFieldsResult", AV37CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV21EmpresaRazaoSocial)) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", "Razão social", "", "", "", "", "", "", "", ""),  "error",  edtavEmpresarazaosocial_Internalname,  "true",  ""));
            AV37CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV37CheckRequiredFieldsResult", AV37CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV17EmpresaEmail)) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", "E-mail", "", "", "", "", "", "", "", ""),  "error",  edtavEmpresaemail_Internalname,  "true",  ""));
            AV37CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV37CheckRequiredFieldsResult", AV37CheckRequiredFieldsResult);
         }
      }
      ...
      protected void E137K2( )
      {
         ...
         if ( ! AV23IsOK )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  "CNPJ inválido, verifique!",  "error",  edtavEmpresacnpj_Internalname,  "true",  ""));
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255191838360", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("iniciarsistemaempresa.js", "?20255191838361", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavEmpresapixtipo.addItem("ChaveAleatoria", "Chave aleatória", 0);
         if ( cmbavEmpresapixtipo.ItemCount > 0 )
         {
         }
         ...
         cmbavEmpresasede.addItem(StringUtil.BoolToStr( false), "Não", 0);
         if ( cmbavEmpresasede.ItemCount > 0 )
         {
         }
