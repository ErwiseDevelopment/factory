...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_subscriptionssettingswc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV16WWPEntityId = (long)(Math.Round(NumberUtil.Val( GetPar( "WWPEntityId"), "."), 18, MidpointRounding.ToEven));
         A31WWPNotificationDefinitionAllowUserSubscription = StringUtil.StrToBool( GetPar( "WWPNotificationDefinitionAllowUserSubscription"));
         ...
         A29WWPNotificationDefinitionDescription = GetPar( "WWPNotificationDefinitionDescription");
         ...
         A30WWPNotificationDefinitionAppliesTo = (short)(Math.Round(NumberUtil.Val( GetPar( "WWPNotificationDefinitionAppliesTo"), "."), 18, MidpointRounding.ToEven));
         A26WWPSubscriptionEntityRecordId = GetPar( "WWPSubscriptionEntityRecordId");
         A28WWPSubscriptionEntityRecordDescription = GetPar( "WWPSubscriptionEntityRecordDescription");
         AV12NotifShowOnlySubscribedEvents = StringUtil.StrToBool( GetPar( "NotifShowOnlySubscribedEvents"));
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV30Pgmname, A20WWPEntityId, AV16WWPEntityId, A31WWPNotificationDefinitionAllowUserSubscription, A23WWPNotificationDefinitionId, A29WWPNotificationDefinitionDescription, A7WWPUserExtendedId, AV29Udparg1, A27WWPSubscriptionSubscribed, A19WWPSubscriptionRoleId, A25WWPSubscriptionId, A30WWPNotificationDefinitionAppliesTo, A26WWPSubscriptionEntityRecordId, A28WWPSubscriptionEntityRecordDescription, AV12NotifShowOnlySubscribedEvents, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.subscriptions.wwp_subscriptionssettingswc"+UrlEncode(StringUtil.LTrimStr(AV16WWPEntityId,10,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV12NotifShowOnlySubscribedEvents));
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.subscriptions.wwp_subscriptionssettingswc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION", A31WWPNotificationDefinitionAllowUserSubscription);
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONDESCRIPTION", A29WWPNotificationDefinitionDescription);
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONAPPLIESTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(A30WWPNotificationDefinitionAppliesTo), 1, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPSUBSCRIPTIONENTITYRECORDID", A26WWPSubscriptionEntityRecordId);
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPSUBSCRIPTIONENTITYRECORDDESCRIPTION", A28WWPSubscriptionEntityRecordDescription);
      ...
      protected void WB0U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wwpbaseobjects.subscriptions.wwp_subscriptionssettingswc");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            }
            ...
            wb_table1_11_0U2( true) ;
         }
         else
         {
            wb_table1_11_0U2( false) ;
         }
         return  ;
      }

      protected void wb_table1_11_0U2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</div>") ;
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.subscriptions.wwp_subscriptionssettingswc")), "wwpbaseobjects.subscriptions.wwp_subscriptionssettingswc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.subscriptions.wwp_subscriptionssettingswc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool A31WWPNotificationDefinitionAllowUserSubscription ,
                                       long A23WWPNotificationDefinitionId ,
                                       string A29WWPNotificationDefinitionDescription ,
                                       string A7WWPUserExtendedId ,
                                       string AV29Udparg1 ,
                                       bool A27WWPSubscriptionSubscribed ,
                                       string A19WWPSubscriptionRoleId ,
                                       long A25WWPSubscriptionId ,
                                       short A30WWPNotificationDefinitionAppliesTo ,
                                       string A26WWPSubscriptionEntityRecordId ,
                                       string A28WWPSubscriptionEntityRecordDescription ,
      ...
      private void E140U2( )
      {
         ...
         {
            A23WWPNotificationDefinitionId = H000U2_A23WWPNotificationDefinitionId[0];
            A30WWPNotificationDefinitionAppliesTo = H000U2_A30WWPNotificationDefinitionAppliesTo[0];
            A31WWPNotificationDefinitionAllowUserSubscription = H000U2_A31WWPNotificationDefinitionAllowUserSubscription[0];
            A20WWPEntityId = H000U2_A20WWPEntityId[0];
            A29WWPNotificationDefinitionDescription = H000U2_A29WWPNotificationDefinitionDescription[0];
            AV5WWPNotificationDefinitionId = A23WWPNotificationDefinitionId;
            AssignAttri(sPrefix, false, edtavWwpnotificationdefinitionid_Internalname, StringUtil.LTrimStr( (decimal)(AV5WWPNotificationDefinitionId), 10, 0));
            AV18WWPNotificationDescriptionBase = A29WWPNotificationDefinitionDescription;
            ...
            {
               A19WWPSubscriptionRoleId = H000U3_A19WWPSubscriptionRoleId[0];
               n19WWPSubscriptionRoleId = H000U3_n19WWPSubscriptionRoleId[0];
               A27WWPSubscriptionSubscribed = H000U3_A27WWPSubscriptionSubscribed[0];
               A7WWPUserExtendedId = H000U3_A7WWPUserExtendedId[0];
               n7WWPUserExtendedId = H000U3_n7WWPUserExtendedId[0];
               A25WWPSubscriptionId = H000U3_A25WWPSubscriptionId[0];
               A26WWPSubscriptionEntityRecordId = H000U3_A26WWPSubscriptionEntityRecordId[0];
               A28WWPSubscriptionEntityRecordDescription = H000U3_A28WWPSubscriptionEntityRecordDescription[0];
               AV7WWPSubscriptionId = A25WWPSubscriptionId;
               AssignAttri(sPrefix, false, edtavWwpsubscriptionid_Internalname, StringUtil.LTrimStr( (decimal)(AV7WWPSubscriptionId), 10, 0));
               if ( A30WWPNotificationDefinitionAppliesTo != 1 )
               {
                  if ( StringUtil.StrCmp(A26WWPSubscriptionEntityRecordId, "") != 0 )
                  {
                     AV6WWPSubscriptionEntityRecordDescription = A28WWPSubscriptionEntityRecordDescription;
                     AssignAttri(sPrefix, false, edtavWwpsubscriptionentityrecorddescription_Internalname, AV6WWPSubscriptionEntityRecordDescription);
            ...
            pr_default.close(1);
            if ( ! AV14SubscriptionLoaded && ! AV11IncludeNotification && ( A30WWPNotificationDefinitionAppliesTo != 2 ) && ! AV12NotifShowOnlySubscribedEvents )
            {
               AV9GridRecordCount = (short)(AV9GridRecordCount+1);
               /* Load Method */
               if ( wbStart != -1 )
      ...
      protected void wb_table1_11_0U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 14 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_11_0U2e( true) ;
         }
         else
         {
            wb_table1_11_0U2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101965514", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/subscriptions/wwp_subscriptionssettingswc.js", "?20256101965515", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"edtavWwpnotificationdefinitionid_Visible","ctrl":"vWWPNOTIFICATIONDEFINITIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionid_Visible","ctrl":"vWWPSUBSCRIPTIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecordid_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecorddescription_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","prop":"Visible"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV16WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A26WWPSubscriptionEntityRecordId","fld":"WWPSUBSCRIPTIONENTITYRECORDID","type":"svchar"},{"av":"A28WWPSubscriptionEntityRecordDescription","fld":"WWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","type":"svchar"},{"av":"AV12NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV29Udparg1","fld":"vUDPARG1","hsh":true,"type":"char"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140U2","iparms":[{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV16WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"AV29Udparg1","fld":"vUDPARG1","hsh":true,"type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A26WWPSubscriptionEntityRecordId","fld":"WWPSUBSCRIPTIONENTITYRECORDID","type":"svchar"},{"av":"A28WWPSubscriptionEntityRecordDescription","fld":"WWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","type":"svchar"},{"av":"AV12NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV5WWPNotificationDefinitionId","fld":"vWWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV17WWPNotificationDescription","fld":"vWWPNOTIFICATIONDESCRIPTION","type":"svchar"},{"av":"AV11IncludeNotification","fld":"vINCLUDENOTIFICATION","type":"boolean"},{"av":"AV7WWPSubscriptionId","fld":"vWWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV6WWPSubscriptionEntityRecordDescription","fld":"vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","type":"svchar"},{"av":"AV19WWPSubscriptionEntityRecordId","fld":"vWWPSUBSCRIPTIONENTITYRECORDID","type":"svchar"}]}""");
         setEventMetadata("TABLESUBSCRIPTIONITEM.CLICK","""{"handler":"E110U2","iparms":[{"av":"AV11IncludeNotification","fld":"vINCLUDENOTIFICATION","grid":14,"type":"boolean"},{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_14","ctrl":"GRID","prop":"GridRC","grid":14,"type":"int"},{"av":"AV7WWPSubscriptionId","fld":"vWWPSUBSCRIPTIONID","grid":14,"pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV5WWPNotificationDefinitionId","fld":"vWWPNOTIFICATIONDEFINITIONID","grid":14,"pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV19WWPSubscriptionEntityRecordId","fld":"vWWPSUBSCRIPTIONENTITYRECORDID","grid":14,"type":"svchar"},{"av":"AV6WWPSubscriptionEntityRecordDescription","fld":"vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","grid":14,"type":"svchar"}]""");
         setEventMetadata("TABLESUBSCRIPTIONITEM.CLICK",""","oparms":[{"av":"AV11IncludeNotification","fld":"vINCLUDENOTIFICATION","type":"boolean"},{"av":"AV7WWPSubscriptionId","fld":"vWWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"edtavWwpnotificationdefinitionid_Visible","ctrl":"vWWPNOTIFICATIONDEFINITIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionid_Visible","ctrl":"vWWPSUBSCRIPTIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecordid_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecorddescription_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","prop":"Visible"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV16WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"AV29Udparg1","fld":"vUDPARG1","hsh":true,"type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A26WWPSubscriptionEntityRecordId","fld":"WWPSUBSCRIPTIONENTITYRECORDID","type":"svchar"},{"av":"A28WWPSubscriptionEntityRecordDescription","fld":"WWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","type":"svchar"},{"av":"AV12NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"edtavWwpnotificationdefinitionid_Visible","ctrl":"vWWPNOTIFICATIONDEFINITIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionid_Visible","ctrl":"vWWPSUBSCRIPTIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecordid_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecorddescription_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","prop":"Visible"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV16WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"AV29Udparg1","fld":"vUDPARG1","hsh":true,"type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A26WWPSubscriptionEntityRecordId","fld":"WWPSUBSCRIPTIONENTITYRECORDID","type":"svchar"},{"av":"A28WWPSubscriptionEntityRecordDescription","fld":"WWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","type":"svchar"},{"av":"AV12NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"edtavWwpnotificationdefinitionid_Visible","ctrl":"vWWPNOTIFICATIONDEFINITIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionid_Visible","ctrl":"vWWPSUBSCRIPTIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecordid_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecorddescription_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","prop":"Visible"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV16WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"AV29Udparg1","fld":"vUDPARG1","hsh":true,"type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A26WWPSubscriptionEntityRecordId","fld":"WWPSUBSCRIPTIONENTITYRECORDID","type":"svchar"},{"av":"A28WWPSubscriptionEntityRecordDescription","fld":"WWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","type":"svchar"},{"av":"AV12NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"edtavWwpnotificationdefinitionid_Visible","ctrl":"vWWPNOTIFICATIONDEFINITIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionid_Visible","ctrl":"vWWPSUBSCRIPTIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecordid_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDID","prop":"Visible"},{"av":"edtavWwpsubscriptionentityrecorddescription_Visible","ctrl":"vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","prop":"Visible"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV16WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"AV29Udparg1","fld":"vUDPARG1","hsh":true,"type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A26WWPSubscriptionEntityRecordId","fld":"WWPSUBSCRIPTIONENTITYRECORDID","type":"svchar"},{"av":"A28WWPSubscriptionEntityRecordDescription","fld":"WWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","type":"svchar"},{"av":"AV12NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"AV30Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"subGrid_Recordcount","type":"int"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000U2_A23WWPNotificationDefinitionId = new long[1] ;
         H000U2_A30WWPNotificationDefinitionAppliesTo = new short[1] ;
         H000U2_A31WWPNotificationDefinitionAllowUserSubscription = new bool[] {false} ;
         H000U2_A20WWPEntityId = new long[1] ;
         H000U2_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         AV18WWPNotificationDescriptionBase = "";
         H000U3_A23WWPNotificationDefinitionId = new long[1] ;
         H000U3_A19WWPSubscriptionRoleId = new string[] {""} ;
         H000U3_n19WWPSubscriptionRoleId = new bool[] {false} ;
         H000U3_A27WWPSubscriptionSubscribed = new bool[] {false} ;
         H000U3_A7WWPUserExtendedId = new string[] {""} ;
         H000U3_n7WWPUserExtendedId = new bool[] {false} ;
         H000U3_A25WWPSubscriptionId = new long[1] ;
         H000U3_A26WWPSubscriptionEntityRecordId = new string[] {""} ;
         H000U3_A28WWPSubscriptionEntityRecordDescription = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscriptionssettingswc__default(),
            new Object[][] {
                new Object[] {
               H000U2_A23WWPNotificationDefinitionId, H000U2_A30WWPNotificationDefinitionAppliesTo, H000U2_A31WWPNotificationDefinitionAllowUserSubscription, H000U2_A20WWPEntityId, H000U2_A29WWPNotificationDefinitionDescription
               }
               , new Object[] {
               H000U3_A23WWPNotificationDefinitionId, H000U3_A19WWPSubscriptionRoleId, H000U3_n19WWPSubscriptionRoleId, H000U3_A27WWPSubscriptionSubscribed, H000U3_A7WWPUserExtendedId, H000U3_n7WWPUserExtendedId, H000U3_A25WWPSubscriptionId, H000U3_A26WWPSubscriptionEntityRecordId, H000U3_A28WWPSubscriptionEntityRecordDescription
               }
            }
         );
         AV30Pgmname = "WWPBaseObjects.Subscriptions.WWP_SubscriptionsSettingsWC";
      ...
      private long[] H000U2_A23WWPNotificationDefinitionId ;
      private short[] H000U2_A30WWPNotificationDefinitionAppliesTo ;
      private bool[] H000U2_A31WWPNotificationDefinitionAllowUserSubscription ;
      private long[] H000U2_A20WWPEntityId ;
      private string[] H000U2_A29WWPNotificationDefinitionDescription ;
      private long[] H000U3_A23WWPNotificationDefinitionId ;
      private string[] H000U3_A19WWPSubscriptionRoleId ;
      private bool[] H000U3_n19WWPSubscriptionRoleId ;
      private bool[] H000U3_A27WWPSubscriptionSubscribed ;
      private string[] H000U3_A7WWPUserExtendedId ;
      private bool[] H000U3_n7WWPUserExtendedId ;
      private long[] H000U3_A25WWPSubscriptionId ;
      private string[] H000U3_A26WWPSubscriptionEntityRecordId ;
      private string[] H000U3_A28WWPSubscriptionEntityRecordDescription ;
   ...
   public class wwp_subscriptionssettingswc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_H000U3(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] , (long)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000U2", "SELECT WWPNotificationDefinitionId, WWPNotificationDefinitionAppliesTo, WWPNotificationDefinitionAllowUserSubscription, WWPEntityId, WWPNotificationDefinitionDescription FROM WWP_NotificationDefinition WHERE (WWPEntityId = :AV16WWPEntityId) AND (WWPNotificationDefinitionAllowUserSubscription) ORDER BY WWPEntityId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000U2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000U3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000U3,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
