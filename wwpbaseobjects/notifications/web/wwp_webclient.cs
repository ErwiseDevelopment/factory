...
namespace GeneXus.Programs.wwpbaseobjects.notifications.web {
   public class wwp_webclient : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPUserExtendedId_Internalname, StringUtil.RTrim( A7WWPUserExtendedId), StringUtil.RTrim( context.localUtil.Format( A7WWPUserExtendedId, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPUserExtendedId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPUserExtendedId_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPBaseObjects/Notifications/Web/WWP_WebClient.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebClientFirstRegistered_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A51WWPWebClientFirstRegistered", context.localUtil.TToC( A51WWPWebClientFirstRegistered, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebClientLastRegistered_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A52WWPWebClientLastRegistered", context.localUtil.TToC( A52WWPWebClientLastRegistered, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.notifications.web.wwp_webclient") +"\">") ;
      ...
      {
         return formatLink("wwpbaseobjects.notifications.web.wwp_webclient")  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019122816", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/notifications/web/wwp_webclient.js", "?202561019122817", false, true);
      ...
      public void Valid_Wwpwebclientid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z51WWPWebClientFirstRegistered", context.localUtil.TToC( Z51WWPWebClientFirstRegistered, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z52WWPWebClientLastRegistered", context.localUtil.TToC( Z52WWPWebClientLastRegistered, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z7WWPUserExtendedId", StringUtil.RTrim( Z7WWPUserExtendedId));
         AssignProp("", false, bttBtn_delete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtn_delete_Enabled), 5, 0), true);
         AssignProp("", false, bttBtn_enter_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtn_enter_Enabled), 5, 0), true);
         SendCloseFormHiddens( ) ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_WWPWEBCLIENTID","""{"handler":"Valid_Wwpwebclientid","iparms":[{"av":"cmbWWPWebClientBrowserId"},{"av":"A49WWPWebClientBrowserId","fld":"WWPWEBCLIENTBROWSERID","pic":"ZZZ9","type":"int"},{"av":"A48WWPWebClientId","fld":"WWPWEBCLIENTID","type":"char"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9","type":"int"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"A51WWPWebClientFirstRegistered","fld":"WWPWEBCLIENTFIRSTREGISTERED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A52WWPWebClientLastRegistered","fld":"WWPWEBCLIENTLASTREGISTERED","pic":"99/99/9999 99:99:99.999","type":"dtime"}]""");
         setEventMetadata("VALID_WWPWEBCLIENTID",""","oparms":[{"av":"cmbWWPWebClientBrowserId"},{"av":"A49WWPWebClientBrowserId","fld":"WWPWEBCLIENTBROWSERID","pic":"ZZZ9","type":"int"},{"av":"A50WWPWebClientBrowserVersion","fld":"WWPWEBCLIENTBROWSERVERSION","type":"vchar"},{"av":"A51WWPWebClientFirstRegistered","fld":"WWPWEBCLIENTFIRSTREGISTERED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A52WWPWebClientLastRegistered","fld":"WWPWEBCLIENTLASTREGISTERED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"Z48WWPWebClientId","type":"char"},{"av":"Z49WWPWebClientBrowserId","type":"int"},{"av":"Z50WWPWebClientBrowserVersion","type":"vchar"},{"av":"Z51WWPWebClientFirstRegistered","type":"dtime"},{"av":"Z52WWPWebClientLastRegistered","type":"dtime"},{"av":"Z7WWPUserExtendedId","type":"char"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
         setEventMetadata("VALID_WWPUSEREXTENDEDID","""{"handler":"Valid_Wwpuserextendedid","iparms":[{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"}]}""");
         return  ;
      }
