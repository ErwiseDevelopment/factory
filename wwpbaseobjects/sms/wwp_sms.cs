...
namespace GeneXus.Programs.wwpbaseobjects.sms {
   public class wwp_sms : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPNotificationId_Internalname, ((0==A22WWPNotificationId)&&IsIns( )||n22WWPNotificationId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A22WWPNotificationId), 10, 0, ",", ""))), ((0==A22WWPNotificationId)&&IsIns( )||n22WWPNotificationId ? "" : StringUtil.LTrim( ((edtWWPNotificationId_Enabled!=0) ? context.localUtil.Format( (decimal)(A22WWPNotificationId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A22WWPNotificationId), "ZZZZZZZZZ9")))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,79);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPNotificationId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPNotificationId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_Id", "end", false, "", "HLP_WWPBaseObjects/SMS/WWP_SMS.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPNotificationCreated_Internalname, context.localUtil.TToC( A24WWPNotificationCreated, 10, 12, 0, 3, "/", ":", " "), context.localUtil.Format( A24WWPNotificationCreated, "99/99/9999 99:99:99.999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',12,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',12,24,'por',false,0);"+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPNotificationCreated_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPNotificationCreated_Enabled, 0, "text", "", 24, "chr", 1, "row", 24, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_DateTimeMillis", "end", false, "", "HLP_WWPBaseObjects/SMS/WWP_SMS.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPSMSCreated_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A40WWPSMSCreated", context.localUtil.TToC( A40WWPSMSCreated, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPSMSScheduled_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A41WWPSMSScheduled", context.localUtil.TToC( A41WWPSMSScheduled, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPSMSProcessed_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A35WWPSMSProcessed", context.localUtil.TToC( A35WWPSMSProcessed, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.sms.wwp_sms") +"\">") ;
      ...
      {
         return formatLink("wwpbaseobjects.sms.wwp_sms")  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019123120", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/sms/wwp_sms.js", "?202561019123120", false, true);
      ...
      public void Valid_Wwpsmsid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z34WWPSMSStatus", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z34WWPSMSStatus), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z40WWPSMSCreated", context.localUtil.TToC( Z40WWPSMSCreated, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z41WWPSMSScheduled", context.localUtil.TToC( Z41WWPSMSScheduled, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z35WWPSMSProcessed", context.localUtil.TToC( Z35WWPSMSProcessed, 10, 12, 0, 3, "/", ":", " "));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_WWPSMSID","""{"handler":"Valid_Wwpsmsid","iparms":[{"av":"A33WWPSMSId","fld":"WWPSMSID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9","type":"int"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"cmbWWPSMSStatus"},{"av":"A34WWPSMSStatus","fld":"WWPSMSSTATUS","pic":"ZZZ9","type":"int"},{"av":"A40WWPSMSCreated","fld":"WWPSMSCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A41WWPSMSScheduled","fld":"WWPSMSSCHEDULED","pic":"99/99/9999 99:99:99.999","type":"dtime"}]""");
         setEventMetadata("VALID_WWPSMSID",""","oparms":[{"av":"A37WWPSMSMessage","fld":"WWPSMSMESSAGE","type":"vchar"},{"av":"A38WWPSMSSenderNumber","fld":"WWPSMSSENDERNUMBER","type":"vchar"},{"av":"A39WWPSMSRecipientNumbers","fld":"WWPSMSRECIPIENTNUMBERS","type":"vchar"},{"av":"cmbWWPSMSStatus"},{"av":"A34WWPSMSStatus","fld":"WWPSMSSTATUS","pic":"ZZZ9","type":"int"},{"av":"A40WWPSMSCreated","fld":"WWPSMSCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A41WWPSMSScheduled","fld":"WWPSMSSCHEDULED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A35WWPSMSProcessed","fld":"WWPSMSPROCESSED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A36WWPSMSDetail","fld":"WWPSMSDETAIL","type":"vchar"},{"av":"A22WWPNotificationId","fld":"WWPNOTIFICATIONID","pic":"ZZZZZZZZZ9","nullAv":"n22WWPNotificationId","type":"int"},{"av":"A24WWPNotificationCreated","fld":"WWPNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"Z33WWPSMSId","type":"int"},{"av":"Z37WWPSMSMessage","type":"vchar"},{"av":"Z38WWPSMSSenderNumber","type":"vchar"},{"av":"Z39WWPSMSRecipientNumbers","type":"vchar"},{"av":"Z34WWPSMSStatus","type":"int"},{"av":"Z40WWPSMSCreated","type":"dtime"},{"av":"Z41WWPSMSScheduled","type":"dtime"},{"av":"Z35WWPSMSProcessed","type":"dtime"},{"av":"Z36WWPSMSDetail","type":"vchar"},{"av":"Z22WWPNotificationId","type":"int"},{"av":"Z24WWPNotificationCreated","type":"dtime"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
