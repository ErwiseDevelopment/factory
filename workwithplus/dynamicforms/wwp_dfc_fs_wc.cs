   ...
   public class wwp_dfc_fs_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_fs_wc"+UrlEncode(StringUtil.RTrim(AV22WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV25WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV15SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_fs_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_fs_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void wb_table1_19_192e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_37_192( true) ;
         }
         else
         {
            wb_table2_37_192( false) ;
         }
         return  ;
      }

      protected void wb_table2_37_192e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_42_192( true) ;
         }
         else
         {
            wb_table3_42_192( false) ;
         }
         return  ;
      }

      protected void wb_table3_42_192e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_47_192( true) ;
         }
         else
         {
            wb_table4_47_192( false) ;
         }
         return  ;
      }

      protected void wb_table4_47_192e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_fs_wc")), "workwithplus.dynamicforms.wwp_dfc_fs_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_fs_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E19192( )
      {
         ...
         if ( (0==AV25WWPFormElementId) )
         {
            ...
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vALLOWDELETION", GetSecureSignedToken( sPrefix, AV5AllowDeletion, context));
            Btnsettings_Caption = "Configuração de formulário";
         ...
         else
         {
            ...
            if ( AV7CurrentElement.gxTpr_Wwpformelementtype == 2 )
            {
               ...
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vCOLUMNS", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV6Columns), "ZZZ9"), context));
               Dvelop_confirmpanel_btndeleteelement_Confirmationtext = StringUtil.Format( "Tem certeza de que deseja eliminar o %1 selecionado e todo o seu conteúdo?", "contenedor", "", "", "", "", "", "", "", "");
               ...
               Btnmoveup_Caption = StringUtil.Format( "Mover %1 para cima", "contenedor", "", "", "", "", "", "", "", "");
               ucBtnmoveup.SendProperty(context, sPrefix, false, Btnmoveup_Internalname, "Caption", Btnmoveup_Caption);
               Btnmovedown_Caption = StringUtil.Format( "Mover %1 para baixo", "contenedor", "", "", "", "", "", "", "", "");
               ucBtnmovedown.SendProperty(context, sPrefix, false, Btnmovedown_Internalname, "Caption", Btnmovedown_Caption);
               Btnsettings_Caption = StringUtil.Format( "Configuração (%1)", "contenedor", "", "", "", "", "", "", "", "");
               ucBtnsettings.SendProperty(context, sPrefix, false, Btnsettings_Internalname, "Caption", Btnsettings_Caption);
               Btndeleteelement_Caption = StringUtil.Format( "Elimine %1", "contenedor", "", "", "", "", "", "", "", "");
            ...
            else if ( AV7CurrentElement.gxTpr_Wwpformelementtype == 5 )
            {
               ...
               AssignAttri(sPrefix, false, "AV6Columns", StringUtil.LTrimStr( (decimal)(AV6Columns), 4, 0));
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vCOLUMNS", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV6Columns), "ZZZ9"), context));
               Btnmoveup_Caption = "Mover para a esquerda";
               ucBtnmoveup.SendProperty(context, sPrefix, false, Btnmoveup_Internalname, "Caption", Btnmoveup_Caption);
               ...
               Btnmovedown_Caption = "Mover para a direita";
               ucBtnmovedown.SendProperty(context, sPrefix, false, Btnmovedown_Internalname, "Caption", Btnmovedown_Caption);
               ...
               Btnsettings_Caption = StringUtil.Format( "Configuração (%1)", "passado", "", "", "", "", "", "", "", "");
               ucBtnsettings.SendProperty(context, sPrefix, false, Btnsettings_Internalname, "Caption", Btnsettings_Caption);
               Btndeleteelement_Caption = StringUtil.Format( "Elimine %1", "passado", "", "", "", "", "", "", "", "");
               ucBtndeleteelement.SendProperty(context, sPrefix, false, Btndeleteelement_Internalname, "Caption", Btndeleteelement_Caption);
               Dvelop_confirmpanel_btndeleteelement_Confirmationtext = StringUtil.Format( "Tem certeza de que deseja eliminar o %1 selecionado e todo o seu conteúdo?", "passado", "", "", "", "", "", "", "", "");
               ucDvelop_confirmpanel_btndeleteelement.SendProperty(context, sPrefix, false, Dvelop_confirmpanel_btndeleteelement_Internalname, "ConfirmationText", Dvelop_confirmpanel_btndeleteelement_Confirmationtext);
            }
      ...
      private void E21192( )
      {
         ...
         AV26GXV1 = 1;
         while ( AV26GXV1 <= AV23WWPForm.gxTpr_Element.Count )
         {
            AV24WWPFormElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV23WWPForm.gxTpr_Element.Item(AV26GXV1));
      ...
      protected void E15192( )
      {
         ...
         returnInSub = false;
         Addelement_modal_Title = "Adicionar elemento";
      ...
      protected void E12192( )
      {
         ...
         if ( StringUtil.StrCmp(Settings_modal_Result, "OK") == 0 )
         {
            if ( AV12IsStep )
            {
               ...
               AV27GXV2 = 1;
               while ( AV27GXV2 <= AV23WWPForm.gxTpr_Element.Count )
               {
                  AV9Element = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV23WWPForm.gxTpr_Element.Item(AV27GXV2));
      ...
      protected void wb_table4_47_192( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_47_192e( true) ;
         }
         else
         {
            wb_table4_47_192e( false) ;
         }
      }

      protected void wb_table3_42_192( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_42_192e( true) ;
         }
         else
         {
            wb_table3_42_192e( false) ;
         }
      }

      protected void wb_table2_37_192( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_37_192e( true) ;
         }
         else
         {
            wb_table2_37_192e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918385380", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_fs_wc.js", "?202551918385381", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV23WWPForm","fld":"vWWPFORM","type":""},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV10IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV11IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV5AllowDeletion","fld":"vALLOWDELETION","hsh":true,"type":"boolean"},{"av":"AV6Columns","fld":"vCOLUMNS","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV12IsStep","fld":"vISSTEP","hsh":true,"type":"boolean"}]""");
         ...
         setEventMetadata("FSGRID.LOAD","""{"handler":"E21192","iparms":[{"av":"AV23WWPForm","fld":"vWWPFORM","type":""},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV6Columns","fld":"vCOLUMNS","pic":"ZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("FSGRID.LOAD",""","oparms":[{"ctrl":"WCCHILDREN"}]}""");
         setEventMetadata("'DOREFRESHGRID'","""{"handler":"E16192","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV10IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV11IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV5AllowDeletion","fld":"vALLOWDELETION","hsh":true,"type":"boolean"},{"av":"AV23WWPForm","fld":"vWWPFORM","type":""},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV6Columns","fld":"vCOLUMNS","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV12IsStep","fld":"vISSTEP","hsh":true,"type":"boolean"},{"av":"sPrefix","type":"char"}]""");
         setEventMetadata("'DOREFRESHGRID'",""","oparms":[{"av":"AV23WWPForm","fld":"vWWPFORM","type":""},{"av":"Btnmoveup_Visible","ctrl":"BTNMOVEUP","prop":"Visible"},{"av":"Btnmovedown_Visible","ctrl":"BTNMOVEDOWN","prop":"Visible"},{"av":"Btndeleteelement_Visible","ctrl":"BTNDELETEELEMENT","prop":"Visible"}]}""");
         setEventMetadata("'DOMOVEUP'","""{"handler":"E17192","iparms":[{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E18192","iparms":[{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E11192","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE",""","oparms":[{"av":"AV23WWPForm","fld":"vWWPFORM","type":""}]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13192","iparms":[{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("ADDELEMENT_MODAL.ONLOADCOMPONENT","""{"handler":"E15192","iparms":[{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         ...
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12192","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV12IsStep","fld":"vISSTEP","hsh":true,"type":"boolean"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV23WWPForm","fld":"vWWPFORM","type":""},{"ctrl":"FORM","prop":"Caption"}]}""");
         setEventMetadata("ADDELEMENT_MODAL.CLOSE","""{"handler":"E14192","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV10IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV11IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV5AllowDeletion","fld":"vALLOWDELETION","hsh":true,"type":"boolean"},{"av":"AV23WWPForm","fld":"vWWPFORM","type":""},{"av":"AV25WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV15SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV6Columns","fld":"vCOLUMNS","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV12IsStep","fld":"vISSTEP","hsh":true,"type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"Addelement_modal_Result","ctrl":"ADDELEMENT_MODAL","prop":"Result"}]""");
         setEventMetadata("ADDELEMENT_MODAL.CLOSE",""","oparms":[{"av":"AV23WWPForm","fld":"vWWPFORM","type":""},{"av":"Btnmoveup_Visible","ctrl":"BTNMOVEUP","prop":"Visible"},{"av":"Btnmovedown_Visible","ctrl":"BTNMOVEDOWN","prop":"Visible"},{"av":"Btndeleteelement_Visible","ctrl":"BTNDELETEELEMENT","prop":"Visible"}]}""");
         return  ;
      }
