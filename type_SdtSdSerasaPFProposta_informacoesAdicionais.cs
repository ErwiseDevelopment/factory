...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SdSerasaPFProposta.informacoesAdicionais" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"SdSerasaPFProposta.informacoesAdicionais", Namespace="Factory2")]
