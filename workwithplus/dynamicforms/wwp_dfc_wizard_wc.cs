   ...
   public class wwp_dfc_wizard_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_wizard_wc"+UrlEncode(StringUtil.RTrim(AV13WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV9SessionId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6DefaultSelectedStepIndex,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_wizard_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB180( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_wizard_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            wb_table1_34_182( true) ;
         }
         else
         {
            wb_table1_34_182( false) ;
         }
         return  ;
      }

      protected void wb_table1_34_182e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_45_182( true) ;
         }
         else
         {
            wb_table2_45_182( false) ;
         }
         return  ;
      }

      protected void wb_table2_45_182e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_50_182( true) ;
         }
         else
         {
            wb_table3_50_182( false) ;
         }
         return  ;
      }

      protected void wb_table3_50_182e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_wizard_wc")), "workwithplus.dynamicforms.wwp_dfc_wizard_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_wizard_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E17182( )
      {
         ...
         AssignAttri(sPrefix, false, "AV8i", StringUtil.LTrimStr( (decimal)(AV8i), 4, 0));
         AV20GXV1 = 1;
         while ( AV20GXV1 <= AV12WizardSteps.Count )
         {
            AV10WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV12WizardSteps.Item(AV20GXV1));
      ...
      protected void E18182( )
      {
         ...
         AssignAttri(sPrefix, false, "AV8i", StringUtil.LTrimStr( (decimal)(AV8i), 4, 0));
         AV21GXV2 = 1;
         while ( AV21GXV2 <= AV12WizardSteps.Count )
         {
            AV10WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV12WizardSteps.Item(AV21GXV2));
            if ( StringUtil.StrCmp(AV10WizardStep.gxTpr_Code, AV5CurrentStepAux) == 0 )
            {
               if (true) break;
            }
      ...
      protected void E11182( )
      {
         ...
         if ( StringUtil.StrCmp(Settings_modal_Result, "OK_AND_REFRESH") == 0 )
         {
            ...
            AssignAttri(sPrefix, false, "AV8i", StringUtil.LTrimStr( (decimal)(AV8i), 4, 0));
            AV22GXV3 = 1;
            while ( AV22GXV3 <= AV12WizardSteps.Count )
            {
               AV10WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV12WizardSteps.Item(AV22GXV3));
               if ( StringUtil.StrCmp(AV10WizardStep.gxTpr_Code, AV5CurrentStepAux) == 0 )
               {
                  if (true) break;
               }
      ...
      protected void S142( )
      {
         ...
         AV23GXV4 = 1;
         while ( AV23GXV4 <= AV14WWPForm.gxTpr_Element.Count )
         {
            AV7Element = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV14WWPForm.gxTpr_Element.Item(AV23GXV4));
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         AV12WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Factory2");
         AV5CurrentStepAux = "";
         AssignAttri(sPrefix, false, "AV5CurrentStepAux", AV5CurrentStepAux);
         AV24GXV5 = 1;
         while ( AV24GXV5 <= AV14WWPForm.gxTpr_Element.Count )
         {
            AV7Element = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV14WWPForm.gxTpr_Element.Item(AV24GXV5));
      ...
      protected void wb_table3_50_182( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_50_182e( true) ;
         }
         else
         {
            wb_table3_50_182e( false) ;
         }
      }

      protected void wb_table2_45_182( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_45_182e( true) ;
         }
         else
         {
            wb_table2_45_182e( false) ;
         }
      }

      protected void wb_table1_34_182( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_34_182e( true) ;
         }
         else
         {
            wb_table1_34_182e( false) ;
         }
      }
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_wizard_wc.js", "?202551918385810", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Btnaddelement_Caption = "Adicione a etapa";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV14WWPForm","fld":"vWWPFORM","type":""},{"av":"AV15IsFirstElement","fld":"vISFIRSTELEMENT","type":"boolean"},{"av":"AV16IsLastElement","fld":"vISLASTELEMENT","type":"boolean"},{"av":"AV12WizardSteps","fld":"vWIZARDSTEPS","hsh":true,"type":""}]""");
         ...
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E12182","iparms":[{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("ADDELEMENT_MODAL.ONLOADCOMPONENT","""{"handler":"E14182","iparms":[{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("ADDELEMENT_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("'DOPREVIOUS'","""{"handler":"E17182","iparms":[{"av":"AV12WizardSteps","fld":"vWIZARDSTEPS","hsh":true,"type":""},{"av":"AV5CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV13WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV14WWPForm","fld":"vWWPFORM","type":""},{"av":"AV15IsFirstElement","fld":"vISFIRSTELEMENT","type":"boolean"},{"av":"AV16IsLastElement","fld":"vISLASTELEMENT","type":"boolean"}]""");
         setEventMetadata("'DOPREVIOUS'",""","oparms":[{"av":"AV8i","fld":"vI","pic":"ZZZ9","type":"int"},{"av":"AV5CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"AV14WWPForm","fld":"vWWPFORM","type":""},{"ctrl":"WIZARDHEADER"},{"av":"AV16IsLastElement","fld":"vISLASTELEMENT","type":"boolean"},{"av":"AV15IsFirstElement","fld":"vISFIRSTELEMENT","type":"boolean"},{"av":"lblStepdescription_Caption","ctrl":"STEPDESCRIPTION","prop":"Caption"},{"ctrl":"DYNAMICFORMFS_WC"},{"av":"Btnprevious_Visible","ctrl":"BTNPREVIOUS","prop":"Visible"},{"av":"Btnnext_Visible","ctrl":"BTNNEXT","prop":"Visible"}]}""");
         setEventMetadata("'DONEXT'","""{"handler":"E18182","iparms":[{"av":"AV12WizardSteps","fld":"vWIZARDSTEPS","hsh":true,"type":""},{"av":"AV5CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV13WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV14WWPForm","fld":"vWWPFORM","type":""},{"av":"AV15IsFirstElement","fld":"vISFIRSTELEMENT","type":"boolean"},{"av":"AV16IsLastElement","fld":"vISLASTELEMENT","type":"boolean"}]""");
         setEventMetadata("'DONEXT'",""","oparms":[{"av":"AV8i","fld":"vI","pic":"ZZZ9","type":"int"},{"av":"AV5CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"},{"av":"AV14WWPForm","fld":"vWWPFORM","type":""},{"ctrl":"WIZARDHEADER"},{"av":"AV16IsLastElement","fld":"vISLASTELEMENT","type":"boolean"},{"av":"AV15IsFirstElement","fld":"vISFIRSTELEMENT","type":"boolean"},{"av":"lblStepdescription_Caption","ctrl":"STEPDESCRIPTION","prop":"Caption"},{"ctrl":"DYNAMICFORMFS_WC"},{"av":"Btnprevious_Visible","ctrl":"BTNPREVIOUS","prop":"Visible"},{"av":"Btnnext_Visible","ctrl":"BTNNEXT","prop":"Visible"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E11182","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV12WizardSteps","fld":"vWIZARDSTEPS","hsh":true,"type":""},{"av":"AV5CurrentStepAux","fld":"vCURRENTSTEPAUX","type":"svchar"}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV8i","fld":"vI","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("ADDELEMENT_MODAL.CLOSE","""{"handler":"E13182","iparms":[{"av":"Addelement_modal_Result","ctrl":"ADDELEMENT_MODAL","prop":"Result"},{"av":"AV12WizardSteps","fld":"vWIZARDSTEPS","hsh":true,"type":""}]""");
         setEventMetadata("ADDELEMENT_MODAL.CLOSE",""","oparms":[{"av":"AV8i","fld":"vI","pic":"ZZZ9","type":"int"}]}""");
         return  ;
      }
