   ...
   public class wwp_df_switch_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_switch_wc"+UrlEncode(StringUtil.RTrim(AV27WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV28WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_switch_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_switch_wc");
               context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
               context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
            }
            ...
            wb_table1_17_1M2( true) ;
         }
         else
         {
            wb_table1_17_1M2( false) ;
         }
         return  ;
      }

      protected void wb_table1_17_1M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_switch_wc")), "workwithplus.dynamicforms.wwp_df_switch_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_switch_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E121M2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV15HasReferenceId, context));
         AV33GXV1 = 1;
         while ( AV33GXV1 <= AV6WWPFormInstance.gxTpr_Element.Count )
         {
            AV31WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV6WWPFormInstance.gxTpr_Element.Item(AV33GXV1));
      ...
      protected void E131M2( )
      {
         ...
         returnInSub = false;
         if ( ( AV8AuxSessionId == AV21SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV32ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV28WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV7WWPFormInstanceElementId), 4, 0))+"|") )
         {
      ...
      protected void S142( )
      {
         ...
         AV34GXV2 = 1;
         while ( AV34GXV2 <= AV6WWPFormInstance.gxTpr_Element.Count )
         {
            AV31WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV6WWPFormInstance.gxTpr_Element.Item(AV34GXV2));
            if ( ( AV31WWPFormInstanceElement.gxTpr_Wwpformelementid == AV28WWPFormElementId ) && ( AV31WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV7WWPFormInstanceElementId ) )
            {
      ...
      protected void S152( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV30WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV13ElementInternalName,  "true",  ""));
            AV18IsValid = false;
         }
         else
         {
            if ( AV23Validations.Count > 0 )
            {
               ...
               AV35GXV3 = 1;
               while ( AV35GXV3 <= AV20Messages.Count )
               {
                  AV19Message = ((GeneXus.Utils.SdtMessages_Message)AV20Messages.Item(AV35GXV3));
      ...
      protected void S182( )
      {
         ...
         AV11DataCellNameClass = "DataContentCellFL";
      ...
      protected void wb_table1_17_1M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_17_1M2e( true) ;
         }
         else
         {
            wb_table1_17_1M2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381722", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_switch_wc.js", "?202551918381722", false, true);
         context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
         context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Data_Captionclass = "gx-form-item AttributeFLLabel";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV26WWP_DF_BooleanMetadata","fld":"vWWP_DF_BOOLEANMETADATA","hsh":true,"type":""},{"av":"AV17IsRequired","fld":"vISREQUIRED","hsh":true,"type":"boolean"},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV15HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E131M2","iparms":[{"av":"AV32ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV8AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV28WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV14ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV6WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV26WWP_DF_BooleanMetadata","fld":"vWWP_DF_BOOLEANMETADATA","hsh":true,"type":""},{"av":"AV10Data","fld":"vDATA","type":"boolean"},{"av":"AV17IsRequired","fld":"vISREQUIRED","hsh":true,"type":"boolean"},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV14ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV6WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E141M2","iparms":[{"av":"AV8AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV24VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV26WWP_DF_BooleanMetadata","fld":"vWWP_DF_BOOLEANMETADATA","hsh":true,"type":""},{"av":"AV7WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV6WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV6WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV24VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED","""{"handler":"E111M2","iparms":[{"av":"AV15HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV6WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV28WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV26WWP_DF_BooleanMetadata","fld":"vWWP_DF_BOOLEANMETADATA","hsh":true,"type":""},{"av":"AV10Data","fld":"vDATA","type":"boolean"},{"av":"AV17IsRequired","fld":"vISREQUIRED","hsh":true,"type":"boolean"},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED",""","oparms":[{"av":"AV14ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV6WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         return  ;
      }
