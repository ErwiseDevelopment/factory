...
namespace GeneXus.Programs.workwithplus {
   public class wwp_editconfformattingvalues : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255191838589", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_editconfformattingvalues.js", "?20255191838589", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      {
         AV6ConfFormattingVariables = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>( context, "WWPConfFormattingVariable", "Factory2");
