...
namespace GeneXus.Programs.wwpbaseobjects {
   public class gethomesamplenamevaluedata : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         initialize();
         Gxm3rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>( context, "HomeSampleNameValueDataItem", "Factory21") ;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.Method), "get") == 0 )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.QueryString), "wsdl") == 0 )
            {
               ...
               GXSoapXMLWriter.WriteAttribute("targetNamespace", "Factory21");
               GXSoapXMLWriter.WriteAttribute("xmlns:wsdlns", "Factory21");
               ...
               GXSoapXMLWriter.WriteAttribute("xmlns:tns", "Factory21");
               ...
               GXSoapXMLWriter.WriteAttribute("soapAction", "Factory21action/"+"wwpbaseobjects.AGETHOMESAMPLENAMEVALUEDATA.Execute");
         ...
         if ( ( StringUtil.StringSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
         {
            ...
            GXSoapXMLWriter.WriteAttribute("xmlns", "Factory21");
            if ( currSoapErr == 0 )
            {
               if ( Gxm3rootcol != null )
               {
                  Gxm3rootcol.writexmlcollection(GXSoapXMLWriter, "ReturnValue", "Factory21", "HomeSampleNameValueDataItem", "Factory21");
               }
            }
            else
            {
      ...
      {
         this.Gxm3rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>( context, "HomeSampleNameValueDataItem", "Factory21") ;
         initialize();
         ExecuteImpl();
