   ...
   public class aprfinalizarcontrato : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AV11Array_SdParticipantesContrato = new GXBaseCollection<SdtSdParticipantesContrato>( context, "SdParticipantesContrato", "Factory2");
            /* Using cursor P008V4 */
      ...
      protected void S131( )
      {
         ...
         if ( AV56IsCriaTitulo )
         {
            ...
            while ( (pr_default.getStatus(10) != 101) )
            {
               ...
               if ( AV9SdErro.gxTpr_Status == 401 )
               {
                  GX_msglist.addItem(AV9SdErro.gxTpr_Msg);
                  context.RollbackDataStores("prfinalizarcontrato",pr_default);
               }
               else
               {
                  context.CommitDataStores("prfinalizarcontrato",pr_default);
