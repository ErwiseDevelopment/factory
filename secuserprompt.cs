...
namespace GeneXus.Programs {
   public class secuserprompt : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "InOutSecUserId");
            ...
            {
               AV7InOutSecUserId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV7InOutSecUserId", StringUtil.LTrimStr( (decimal)(AV7InOutSecUserId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8InOutSecUserName = GetPar( "InOutSecUserName");
                  AssignAttri("", false, "AV8InOutSecUserName", AV8InOutSecUserName);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV48FilterFullText = GetPar( "FilterFullText");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV48FilterFullText, AV50Pgmname) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("secuserprompt", new object[] {UrlEncode(StringUtil.LTrimStr(AV7InOutSecUserId,4,0)),UrlEncode(StringUtil.RTrim(AV8InOutSecUserName))}, new string[] {"InOutSecUserId","InOutSecUserName"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vFILTERFULLTEXT", AV48FilterFullText);
         /* Send saved values. */
      ...
      {
         return formatLink("secuserprompt", new object[] {UrlEncode(StringUtil.LTrimStr(AV7InOutSecUserId,4,0)),UrlEncode(StringUtil.RTrim(AV8InOutSecUserName))}, new string[] {"InOutSecUserId","InOutSecUserName"})  ;
      }

      public override string GetPgmname( )
      {
         return "SecUserPrompt" ;
      }
      ...
      protected void WB2P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_2P2( true) ;
         }
         else
         {
            wb_table1_14_2P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_2P2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START2P2( )
      {
         ...
         Form.Meta.addItem("description", "Consulta de Usuário", 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignAttri("", false, edtavSelect_Internalname, AV28Select);
                              ...
                              A148SecUserManName = StringUtil.Upper( cgiGet( edtSecUserManName_Internalname));
                              n148SecUserManName = false;
                              A149SecUserManFullName = StringUtil.Upper( cgiGet( edtSecUserManFullName_Internalname));
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vFILTERFULLTEXT"), AV48FilterFullText) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_SECUSERNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A141SecUserName, "@!")), context));
      ...
      protected void RF2P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV14OrderedDsc } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN,
                                                 TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                                 }
            });
            lV48FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV48FilterFullText), "%", "");
            lV48FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV48FilterFullText), "%", "");
            lV48FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV48FilterFullText), "%", "");
            lV48FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV48FilterFullText), "%", "");
            lV48FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV48FilterFullText), "%", "");
            ...
            lV48FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV48FilterFullText), "%", "");
            /* Using cursor H002P2 */
            pr_default.execute(0, new Object[] {lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A149SecUserManFullName = H002P2_A149SecUserManFullName[0];
               n149SecUserManFullName = H002P2_n149SecUserManFullName[0];
               A148SecUserManName = H002P2_A148SecUserManName[0];
               n148SecUserManName = H002P2_n148SecUserManName[0];
               A147SecUserUserMan = H002P2_A147SecUserUserMan[0];
               n147SecUserUserMan = H002P2_n147SecUserUserMan[0];
               A146SecUserUpdateAt = H002P2_A146SecUserUpdateAt[0];
               n146SecUserUpdateAt = H002P2_n146SecUserUpdateAt[0];
               A145SecUserCreatedAt = H002P2_A145SecUserCreatedAt[0];
               n145SecUserCreatedAt = H002P2_n145SecUserCreatedAt[0];
               A142SecUserPassword = H002P2_A142SecUserPassword[0];
               n142SecUserPassword = H002P2_n142SecUserPassword[0];
               A150SecUserStatus = H002P2_A150SecUserStatus[0];
               n150SecUserStatus = H002P2_n150SecUserStatus[0];
               A144SecUserEmail = H002P2_A144SecUserEmail[0];
               n144SecUserEmail = H002P2_n144SecUserEmail[0];
               A143SecUserFullName = H002P2_A143SecUserFullName[0];
               n143SecUserFullName = H002P2_n143SecUserFullName[0];
               A141SecUserName = H002P2_A141SecUserName[0];
               n141SecUserName = H002P2_n141SecUserName[0];
               A133SecUserId = H002P2_A133SecUserId[0];
               A149SecUserManFullName = H002P2_A149SecUserManFullName[0];
               n149SecUserManFullName = H002P2_n149SecUserManFullName[0];
               A148SecUserManName = H002P2_A148SecUserManName[0];
               n148SecUserManName = H002P2_n148SecUserManName[0];
      ...
      protected void send_integrity_lvl_hashes2P2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV50Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV50Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_SECUSERID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A133SecUserId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_SECUSERNAME"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A141SecUserName, "@!")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV48FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV48FilterFullText), "%", "");
         /* Using cursor H002P3 */
         pr_default.execute(1, new Object[] {lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText, lV48FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         edtSecUserManName_Enabled = 0;
         edtSecUserManFullName_Enabled = 0;
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP2P0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV48FilterFullText = cgiGet( edtavFilterfulltext_Internalname);
            AssignAttri("", false, "AV48FilterFullText", AV48FilterFullText);
      ...
      protected void E152P2( )
      {
         ...
         Form.Caption = "Consulta de Usuário";
      ...
      private void E172P2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         AV28Select = "<i class=\"fas fa-check\"></i>";
         AssignAttri("", false, edtavSelect_Internalname, AV28Select);
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E182P2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV7InOutSecUserId = A133SecUserId;
         AssignAttri("", false, "AV7InOutSecUserId", StringUtil.LTrimStr( (decimal)(AV7InOutSecUserId), 4, 0));
         AV8InOutSecUserName = A141SecUserName;
         AssignAttri("", false, "AV8InOutSecUserName", AV8InOutSecUserName);
      ...
      protected void wb_table1_14_2P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"CleanFiltersIcon fas fa-filter\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_SecUserPrompt.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV48FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV48FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,20);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Pesquisar", edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPFullTextFilter", "start", true, "", "HLP_SecUserPrompt.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_2P2e( true) ;
         }
         else
         {
            wb_table1_14_2P2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918534027", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("secuserprompt.js", "?202551918534028", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtSecUserId_Internalname = "SECUSERID_"+sGXsfl_26_idx;
         edtSecUserName_Internalname = "SECUSERNAME_"+sGXsfl_26_idx;
         edtSecUserFullName_Internalname = "SECUSERFULLNAME_"+sGXsfl_26_idx;
         edtSecUserEmail_Internalname = "SECUSEREMAIL_"+sGXsfl_26_idx;
         cmbSecUserStatus_Internalname = "SECUSERSTATUS_"+sGXsfl_26_idx;
         edtSecUserPassword_Internalname = "SECUSERPASSWORD_"+sGXsfl_26_idx;
         edtSecUserCreatedAt_Internalname = "SECUSERCREATEDAT_"+sGXsfl_26_idx;
         edtSecUserUpdateAt_Internalname = "SECUSERUPDATEAT_"+sGXsfl_26_idx;
         edtSecUserUserMan_Internalname = "SECUSERUSERMAN_"+sGXsfl_26_idx;
         edtSecUserManName_Internalname = "SECUSERMANNAME_"+sGXsfl_26_idx;
         edtSecUserManFullName_Internalname = "SECUSERMANFULLNAME_"+sGXsfl_26_idx;
      }

      protected void SubsflControlProps_fel_262( )
      {
         edtavSelect_Internalname = "vSELECT_"+sGXsfl_26_fel_idx;
         edtSecUserId_Internalname = "SECUSERID_"+sGXsfl_26_fel_idx;
         edtSecUserName_Internalname = "SECUSERNAME_"+sGXsfl_26_fel_idx;
         edtSecUserFullName_Internalname = "SECUSERFULLNAME_"+sGXsfl_26_fel_idx;
         edtSecUserEmail_Internalname = "SECUSEREMAIL_"+sGXsfl_26_fel_idx;
         cmbSecUserStatus_Internalname = "SECUSERSTATUS_"+sGXsfl_26_fel_idx;
         edtSecUserPassword_Internalname = "SECUSERPASSWORD_"+sGXsfl_26_fel_idx;
         edtSecUserCreatedAt_Internalname = "SECUSERCREATEDAT_"+sGXsfl_26_fel_idx;
         edtSecUserUpdateAt_Internalname = "SECUSERUPDATEAT_"+sGXsfl_26_fel_idx;
         edtSecUserUserMan_Internalname = "SECUSERUSERMAN_"+sGXsfl_26_fel_idx;
         edtSecUserManName_Internalname = "SECUSERMANNAME_"+sGXsfl_26_fel_idx;
         edtSecUserManFullName_Internalname = "SECUSERMANFULLNAME_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "SECUSERSTATUS_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbSecUserStatus_Internalname, "Values", (string)(cmbSecUserStatus.ToJavascriptSource()), !bGXsfl_26_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSecUserManName_Internalname,(string)A148SecUserManName,StringUtil.RTrim( context.localUtil.Format( A148SecUserManName, "@!")),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSecUserManName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)26,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSecUserManFullName_Internalname,(string)A149SecUserManFullName,StringUtil.RTrim( context.localUtil.Format( A149SecUserManFullName, "@!")),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSecUserManFullName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)150,(short)0,(short)0,(short)26,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      protected void StartGridControl26( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Usuário manutenção") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Nome manutenção") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV28Select)));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A148SecUserManName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A149SecUserManFullName));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void init_default_properties( )
      {
         ...
         edtSecUserManName_Internalname = "SECUSERMANNAME";
         edtSecUserManFullName_Internalname = "SECUSERMANFULLNAME";
      ...
      public override void initialize_properties( )
      {
         ...
         subGrid_Header = "";
         edtSecUserManFullName_Jsonclick = "";
         edtSecUserManName_Jsonclick = "";
         ...
         Ddo_grid_Columnids = "1:SecUserId|2:SecUserName|3:SecUserFullName|4:SecUserEmail|5:SecUserStatus|6:SecUserPassword|7:SecUserCreatedAt|8:SecUserUpdateAt|9:SecUserUserMan|10:SecUserManName|11:SecUserManFullName";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV48FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV50Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV45GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV46GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV47GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS","type":"svchar"}]}""");
         ...
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E172P2","iparms":[]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV28Select","fld":"vSELECT","type":"char"}]}""");
         setEventMetadata("ENTER","""{"handler":"E182P2","iparms":[{"av":"A133SecUserId","fld":"SECUSERID","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"A141SecUserName","fld":"SECUSERNAME","pic":"@!","hsh":true,"type":"svchar"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV7InOutSecUserId","fld":"vINOUTSECUSERID","pic":"ZZZ9","type":"int"},{"av":"AV8InOutSecUserName","fld":"vINOUTSECUSERNAME","pic":"@!","type":"svchar"}]}""");
         setEventMetadata("'DOCLEANFILTERS'","""{"handler":"E142P2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV48FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV50Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"}]""");
         setEventMetadata("'DOCLEANFILTERS'",""","oparms":[{"av":"AV48FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"}]}""");
         setEventMetadata("VALID_SECUSERUSERMAN","""{"handler":"Valid_Secuseruserman","iparms":[]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Secusermanfullname","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         A149SecUserManFullName = "";
         lV48FilterFullText = "";
         H002P2_A149SecUserManFullName = new string[] {""} ;
         H002P2_n149SecUserManFullName = new bool[] {false} ;
         H002P2_A148SecUserManName = new string[] {""} ;
         H002P2_n148SecUserManName = new bool[] {false} ;
         H002P2_A147SecUserUserMan = new short[1] ;
         H002P2_n147SecUserUserMan = new bool[] {false} ;
         H002P2_A146SecUserUpdateAt = new DateTime[] {DateTime.MinValue} ;
         H002P2_n146SecUserUpdateAt = new bool[] {false} ;
         H002P2_A145SecUserCreatedAt = new DateTime[] {DateTime.MinValue} ;
         H002P2_n145SecUserCreatedAt = new bool[] {false} ;
         H002P2_A142SecUserPassword = new string[] {""} ;
         H002P2_n142SecUserPassword = new bool[] {false} ;
         H002P2_A150SecUserStatus = new bool[] {false} ;
         H002P2_n150SecUserStatus = new bool[] {false} ;
         H002P2_A144SecUserEmail = new string[] {""} ;
         H002P2_n144SecUserEmail = new bool[] {false} ;
         H002P2_A143SecUserFullName = new string[] {""} ;
         H002P2_n143SecUserFullName = new bool[] {false} ;
         H002P2_A141SecUserName = new string[] {""} ;
         H002P2_n141SecUserName = new bool[] {false} ;
         H002P2_A133SecUserId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.secuserprompt__default(),
            new Object[][] {
                new Object[] {
               H002P2_A149SecUserManFullName, H002P2_n149SecUserManFullName, H002P2_A148SecUserManName, H002P2_n148SecUserManName, H002P2_A147SecUserUserMan, H002P2_n147SecUserUserMan, H002P2_A146SecUserUpdateAt, H002P2_n146SecUserUpdateAt, H002P2_A145SecUserCreatedAt, H002P2_n145SecUserCreatedAt,
               H002P2_A142SecUserPassword, H002P2_n142SecUserPassword, H002P2_A150SecUserStatus, H002P2_n150SecUserStatus, H002P2_A144SecUserEmail, H002P2_n144SecUserEmail, H002P2_A143SecUserFullName, H002P2_n143SecUserFullName, H002P2_A141SecUserName, H002P2_n141SecUserName,
               H002P2_A133SecUserId
               }
               , new Object[] {
      ...
      private int edtSecUserManName_Enabled ;
      private int edtSecUserManFullName_Enabled ;
      ...
      private string edtSecUserManName_Internalname ;
      private string edtSecUserManFullName_Internalname ;
      ...
      private string edtSecUserManName_Jsonclick ;
      private string edtSecUserManFullName_Jsonclick ;
      ...
      private string lV48FilterFullText ;
      ...
      private string[] H002P2_A149SecUserManFullName ;
      private bool[] H002P2_n149SecUserManFullName ;
      private string[] H002P2_A148SecUserManName ;
      private bool[] H002P2_n148SecUserManName ;
      private short[] H002P2_A147SecUserUserMan ;
      private bool[] H002P2_n147SecUserUserMan ;
      private DateTime[] H002P2_A146SecUserUpdateAt ;
      private bool[] H002P2_n146SecUserUpdateAt ;
      private DateTime[] H002P2_A145SecUserCreatedAt ;
      private bool[] H002P2_n145SecUserCreatedAt ;
      private string[] H002P2_A142SecUserPassword ;
      private bool[] H002P2_n142SecUserPassword ;
      private bool[] H002P2_A150SecUserStatus ;
      private bool[] H002P2_n150SecUserStatus ;
      private string[] H002P2_A144SecUserEmail ;
      private bool[] H002P2_n144SecUserEmail ;
      private string[] H002P2_A143SecUserFullName ;
      private bool[] H002P2_n143SecUserFullName ;
      private string[] H002P2_A141SecUserName ;
      private bool[] H002P2_n141SecUserName ;
      private short[] H002P2_A133SecUserId ;
   ...
   public class secuserprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H002P2( IGxContext context ,
                                             ...
                                             string A142SecUserPassword ,
                                             short A147SecUserUserMan ,
                                             string A148SecUserManName ,
                                             string A149SecUserManFullName ,
                                             short AV13OrderedBy ,
                                             bool AV14OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.SecUserFullName AS SecUserManFullName, T2.SecUserName AS SecUserManName, T1.SecUserUserMan AS SecUserUserMan, T1.SecUserUpdateAt, T1.SecUserCreatedAt, T1.SecUserPassword, T1.SecUserStatus, T1.SecUserEmail, T1.SecUserFullName, T1.SecUserName, T1.SecUserId";
         sFromString = " FROM (SecUser T1 LEFT JOIN SecUser T2 ON T2.SecUserId = T1.SecUserUserMan)";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV48FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.SecUserId,'9999'), 2) like '%' || :lV48FilterFullText) or ( T1.SecUserName like '%' || :lV48FilterFullText) or ( T1.SecUserFullName like '%' || :lV48FilterFullText) or ( T1.SecUserEmail like '%' || :lV48FilterFullText) or ( 'ativo' like '%' || LOWER(:lV48FilterFullText) and T1.SecUserStatus = TRUE) or ( 'inativo' like '%' || LOWER(:lV48FilterFullText) and T1.SecUserStatus = FALSE) or ( T1.SecUserPassword like '%' || :lV48FilterFullText) or ( SUBSTR(TO_CHAR(T1.SecUserUserMan,'9999'), 2) like '%' || :lV48FilterFullText) or ( T2.SecUserName like '%' || :lV48FilterFullText) or ( T2.SecUserFullName like '%' || :lV48FilterFullText))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.SecUserPassword, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 6 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SecUserPassword DESC, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 7 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.SecUserCreatedAt, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 7 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SecUserCreatedAt DESC, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 8 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.SecUserUpdateAt, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 8 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SecUserUpdateAt DESC, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 9 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.SecUserUserMan, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 9 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SecUserUserMan DESC, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 10 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T2.SecUserName, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 10 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T2.SecUserName DESC, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 11 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T2.SecUserFullName, T1.SecUserId";
         }
         else if ( ( AV13OrderedBy == 11 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T2.SecUserFullName DESC, T1.SecUserId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.SecUserId";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002P2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] );
               case 1 :
                     return conditional_H002P3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (bool)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV48FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("lV48FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("lV48FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("lV48FilterFullText",GXType.VarChar,100,0) ,
          new ParDef("lV48FilterFullText",GXType.VarChar,100,0) ,
