...
namespace GeneXus.Programs {
   public class wpropostaresponsavel : GXWebComponent
   {
      public wpropostaresponsavel( )
      {
      ...
      public wpropostaresponsavel( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WProposta Responsavel") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpropostaresponsavel"+UrlEncode(StringUtil.RTrim(AV6WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpropostaresponsavel") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WPropostaResponsavel" ;
      }

      public override string GetPgmdesc( )
      {
         return "WProposta Responsavel" ;
      }
      ...
      protected void WB6V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpropostaresponsavel");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavResponsavelclienterazaosocial_Internalname, AV17ResponsavelClienteRazaoSocial, StringUtil.RTrim( context.localUtil.Format( AV17ResponsavelClienteRazaoSocial, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,30);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResponsavelclienterazaosocial_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavResponsavelclienterazaosocial_Enabled, 1, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResponsavel.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_responsavelclientenacionalidade_Internalname, "Nacionalidade", "", "", lblTextblockcombo_responsavelclientenacionalidade_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResponsavel.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavResponsavelclienteestadocivil, cmbavResponsavelclienteestadocivil_Internalname, StringUtil.RTrim( AV20ResponsavelClienteEstadoCivil), 1, cmbavResponsavelclienteestadocivil_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavResponsavelclienteestadocivil.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,46);\"", "", true, 0, "HLP_WPropostaResponsavel.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_responsavelclienteprofissao_Internalname, "Profissão", "", "", lblTextblockcombo_responsavelclienteprofissao_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResponsavel.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup1_Internalname, "Endereço", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaResponsavel.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavResponsavelcep_Internalname, AV28ResponsavelCEP, StringUtil.RTrim( context.localUtil.Format( AV28ResponsavelCEP, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,63);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResponsavelcep_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavResponsavelcep_Enabled, 1, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResponsavel.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavResponsavelenderecologradouro_Internalname, AV30ResponsavelEnderecoLogradouro, StringUtil.RTrim( context.localUtil.Format( AV30ResponsavelEnderecoLogradouro, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,67);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResponsavelenderecologradouro_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavResponsavelenderecologradouro_Enabled, 1, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResponsavel.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavResponsavelenderecobairro_Internalname, AV33ResponsavelEnderecoBairro, StringUtil.RTrim( context.localUtil.Format( AV33ResponsavelEnderecoBairro, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,80);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResponsavelenderecobairro_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavResponsavelenderecobairro_Enabled, 1, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResponsavel.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup2_Internalname, "Contato", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaResponsavel.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockresponsavelcontatoddd_Internalname, "Celular", "", "", lblTextblockresponsavelcontatoddd_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResponsavel.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_110_6V2( true) ;
         }
         else
         {
            wb_table1_110_6V2( false) ;
         }
         return  ;
      }

      protected void wb_table1_110_6V2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockresponsavelcontatotelefoneddd_Internalname, "Telefone", "", "", lblTextblockresponsavelcontatotelefoneddd_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResponsavel.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table2_124_6V2( true) ;
         }
         else
         {
            wb_table2_124_6V2( false) ;
         }
         return  ;
      }

      protected void wb_table2_124_6V2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START6V2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WProposta Responsavel", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpropostaresponsavel")), "wpropostaresponsavel") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpropostaresponsavel")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E126V2( )
      {
         ...
         {
            A219TipoClienteFinancia = H006V2_A219TipoClienteFinancia[0];
            n219TipoClienteFinancia = H006V2_n219TipoClienteFinancia[0];
            A192TipoClienteId = H006V2_A192TipoClienteId[0];
            n192TipoClienteId = H006V2_n192TipoClienteId[0];
      ...
      protected void E136V2( )
      {
         ...
         if ( AV46ClienteBC.Success() )
         {
            ...
            if ( AV53IsCadastrado )
            {
               context.CommitDataStores("wpropostaresponsavel",pr_default);
               ...
               if ( AV38CheckRequiredFieldsResult && ! AV10HasValidationErrors )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  GXEncryptionTmp = "wproposta"+UrlEncode(StringUtil.RTrim("Responsavel")) + "," + UrlEncode(StringUtil.RTrim("Conta")) + "," + UrlEncode(StringUtil.BoolToStr(false));
            ...
            {
               context.RollbackDataStores("wpropostaresponsavel",pr_default);
            }
         }
         else
         {
      ...
      protected void E146V2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wproposta"+UrlEncode(StringUtil.RTrim("Responsavel")) + "," + UrlEncode(StringUtil.RTrim("NovoCliente")) + "," + UrlEncode(StringUtil.BoolToStr(true));
         CallWebObject(formatLink("wproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV11WizardData", AV11WizardData);
      ...
      protected void S132( )
      {
         ...
         {
            A440ProfissaoId = H006V3_A440ProfissaoId[0];
            A441ProfissaoNome = H006V3_A441ProfissaoNome[0];
            n441ProfissaoNome = H006V3_n441ProfissaoNome[0];
      ...
      protected void S122( )
      {
         ...
         {
            A434NacionalidadeId = H006V4_A434NacionalidadeId[0];
            A435NacionalidadeNome = H006V4_A435NacionalidadeNome[0];
            n435NacionalidadeNome = H006V4_n435NacionalidadeNome[0];
            AV41Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void E166V2( )
      {
         ...
         else
         {
            ...
            {
               A457EspecialidadeId = H006V5_A457EspecialidadeId[0];
               n457EspecialidadeId = H006V5_n457EspecialidadeId[0];
               A597EspecialidadeCreatedBy = H006V5_A597EspecialidadeCreatedBy[0];
               n597EspecialidadeCreatedBy = H006V5_n597EspecialidadeCreatedBy[0];
               A169ClienteDocumento = H006V5_A169ClienteDocumento[0];
               n169ClienteDocumento = H006V5_n169ClienteDocumento[0];
               A170ClienteRazaoSocial = H006V5_A170ClienteRazaoSocial[0];
               n170ClienteRazaoSocial = H006V5_n170ClienteRazaoSocial[0];
               A171ClienteNomeFantasia = H006V5_A171ClienteNomeFantasia[0];
               n171ClienteNomeFantasia = H006V5_n171ClienteNomeFantasia[0];
               A172ClienteTipoPessoa = H006V5_A172ClienteTipoPessoa[0];
               n172ClienteTipoPessoa = H006V5_n172ClienteTipoPessoa[0];
               A192TipoClienteId = H006V5_A192TipoClienteId[0];
               n192TipoClienteId = H006V5_n192TipoClienteId[0];
               A193TipoClienteDescricao = H006V5_A193TipoClienteDescricao[0];
               n193TipoClienteDescricao = H006V5_n193TipoClienteDescricao[0];
               A174ClienteStatus = H006V5_A174ClienteStatus[0];
               n174ClienteStatus = H006V5_n174ClienteStatus[0];
               A141SecUserName = H006V5_A141SecUserName[0];
               n141SecUserName = H006V5_n141SecUserName[0];
               A181EnderecoTipo = H006V5_A181EnderecoTipo[0];
               n181EnderecoTipo = H006V5_n181EnderecoTipo[0];
               A182EnderecoCEP = H006V5_A182EnderecoCEP[0];
               n182EnderecoCEP = H006V5_n182EnderecoCEP[0];
               A183EnderecoLogradouro = H006V5_A183EnderecoLogradouro[0];
               n183EnderecoLogradouro = H006V5_n183EnderecoLogradouro[0];
               A184EnderecoBairro = H006V5_A184EnderecoBairro[0];
               n184EnderecoBairro = H006V5_n184EnderecoBairro[0];
               A185EnderecoCidade = H006V5_A185EnderecoCidade[0];
               n185EnderecoCidade = H006V5_n185EnderecoCidade[0];
               A186MunicipioCodigo = H006V5_A186MunicipioCodigo[0];
               n186MunicipioCodigo = H006V5_n186MunicipioCodigo[0];
               A187MunicipioNome = H006V5_A187MunicipioNome[0];
               n187MunicipioNome = H006V5_n187MunicipioNome[0];
               A189MunicipioUF = H006V5_A189MunicipioUF[0];
               n189MunicipioUF = H006V5_n189MunicipioUF[0];
               A190EnderecoNumero = H006V5_A190EnderecoNumero[0];
               n190EnderecoNumero = H006V5_n190EnderecoNumero[0];
               A191EnderecoComplemento = H006V5_A191EnderecoComplemento[0];
               n191EnderecoComplemento = H006V5_n191EnderecoComplemento[0];
               A201ContatoEmail = H006V5_A201ContatoEmail[0];
               n201ContatoEmail = H006V5_n201ContatoEmail[0];
               A198ContatoDDD = H006V5_A198ContatoDDD[0];
               n198ContatoDDD = H006V5_n198ContatoDDD[0];
               A199ContatoDDI = H006V5_A199ContatoDDI[0];
               n199ContatoDDI = H006V5_n199ContatoDDI[0];
               A200ContatoNumero = H006V5_A200ContatoNumero[0];
               n200ContatoNumero = H006V5_n200ContatoNumero[0];
               A202ContatoTelefoneNumero = H006V5_A202ContatoTelefoneNumero[0];
               n202ContatoTelefoneNumero = H006V5_n202ContatoTelefoneNumero[0];
               A203ContatoTelefoneDDD = H006V5_A203ContatoTelefoneDDD[0];
               n203ContatoTelefoneDDD = H006V5_n203ContatoTelefoneDDD[0];
               A204ContatoTelefoneDDI = H006V5_A204ContatoTelefoneDDI[0];
               n204ContatoTelefoneDDI = H006V5_n204ContatoTelefoneDDI[0];
               A459ClienteDataNascimento = H006V5_A459ClienteDataNascimento[0];
               n459ClienteDataNascimento = H006V5_n459ClienteDataNascimento[0];
               A421ClienteRG = H006V5_A421ClienteRG[0];
               n421ClienteRG = H006V5_n421ClienteRG[0];
               A484ClienteNacionalidade = H006V5_A484ClienteNacionalidade[0];
               n484ClienteNacionalidade = H006V5_n484ClienteNacionalidade[0];
               A486ClienteEstadoCivil = H006V5_A486ClienteEstadoCivil[0];
               n486ClienteEstadoCivil = H006V5_n486ClienteEstadoCivil[0];
               A487ClienteProfissao = H006V5_A487ClienteProfissao[0];
               n487ClienteProfissao = H006V5_n487ClienteProfissao[0];
               A168ClienteId = H006V5_A168ClienteId[0];
               A597EspecialidadeCreatedBy = H006V5_A597EspecialidadeCreatedBy[0];
               n597EspecialidadeCreatedBy = H006V5_n597EspecialidadeCreatedBy[0];
               A141SecUserName = H006V5_A141SecUserName[0];
               n141SecUserName = H006V5_n141SecUserName[0];
      ...
      protected void E176V2( )
      {
         ...
         {
            A186MunicipioCodigo = H006V6_A186MunicipioCodigo[0];
            n186MunicipioCodigo = H006V6_n186MunicipioCodigo[0];
            A187MunicipioNome = H006V6_A187MunicipioNome[0];
            n187MunicipioNome = H006V6_n187MunicipioNome[0];
            A189MunicipioUF = H006V6_A189MunicipioUF[0];
            n189MunicipioUF = H006V6_n189MunicipioUF[0];
            AV36ResponsavelMunicipioNome = A187MunicipioNome;
            AssignAttri(sPrefix, false, "AV36ResponsavelMunicipioNome", AV36ResponsavelMunicipioNome);
            AV37ResponsavelMunicipioUF = A189MunicipioUF;
            AssignAttri(sPrefix, false, "AV37ResponsavelMunicipioUF", AV37ResponsavelMunicipioUF);
      ...
      protected void wb_table2_124_6V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table1_110_6V2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_110_6V2e( true) ;
         }
         else
         {
            wb_table1_110_6V2e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpropostaresponsavel", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918492586", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpropostaresponsavel.js", "?202551918492587", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H006V2_A219TipoClienteFinancia = new bool[] {false} ;
         H006V2_n219TipoClienteFinancia = new bool[] {false} ;
         H006V2_A192TipoClienteId = new short[1] ;
         H006V2_n192TipoClienteId = new bool[] {false} ;
         AV46ClienteBC = new SdtCliente(context);
         AV52ClienteResponsavel = new SdtClienteReponsavel(context);
         ...
         H006V3_A440ProfissaoId = new int[1] ;
         H006V3_A441ProfissaoNome = new string[] {""} ;
         H006V3_n441ProfissaoNome = new bool[] {false} ;
         AV41Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H006V4_A434NacionalidadeId = new int[1] ;
         H006V4_A435NacionalidadeNome = new string[] {""} ;
         H006V4_n435NacionalidadeNome = new bool[] {false} ;
         A435NacionalidadeNome = "";
         Combo_responsavelclientenacionalidade_Selectedvalue_set = "";
         GXt_dtime2 = (DateTime)(DateTime.MinValue);
         GXt_char1 = "";
         H006V5_A457EspecialidadeId = new int[1] ;
         H006V5_n457EspecialidadeId = new bool[] {false} ;
         H006V5_A597EspecialidadeCreatedBy = new short[1] ;
         H006V5_n597EspecialidadeCreatedBy = new bool[] {false} ;
         H006V5_A169ClienteDocumento = new string[] {""} ;
         H006V5_n169ClienteDocumento = new bool[] {false} ;
         H006V5_A170ClienteRazaoSocial = new string[] {""} ;
         H006V5_n170ClienteRazaoSocial = new bool[] {false} ;
         H006V5_A171ClienteNomeFantasia = new string[] {""} ;
         H006V5_n171ClienteNomeFantasia = new bool[] {false} ;
         H006V5_A172ClienteTipoPessoa = new string[] {""} ;
         H006V5_n172ClienteTipoPessoa = new bool[] {false} ;
         H006V5_A192TipoClienteId = new short[1] ;
         H006V5_n192TipoClienteId = new bool[] {false} ;
         H006V5_A193TipoClienteDescricao = new string[] {""} ;
         H006V5_n193TipoClienteDescricao = new bool[] {false} ;
         H006V5_A174ClienteStatus = new bool[] {false} ;
         H006V5_n174ClienteStatus = new bool[] {false} ;
         H006V5_A141SecUserName = new string[] {""} ;
         H006V5_n141SecUserName = new bool[] {false} ;
         H006V5_A181EnderecoTipo = new string[] {""} ;
         H006V5_n181EnderecoTipo = new bool[] {false} ;
         H006V5_A182EnderecoCEP = new string[] {""} ;
         H006V5_n182EnderecoCEP = new bool[] {false} ;
         H006V5_A183EnderecoLogradouro = new string[] {""} ;
         H006V5_n183EnderecoLogradouro = new bool[] {false} ;
         H006V5_A184EnderecoBairro = new string[] {""} ;
         H006V5_n184EnderecoBairro = new bool[] {false} ;
         H006V5_A185EnderecoCidade = new string[] {""} ;
         H006V5_n185EnderecoCidade = new bool[] {false} ;
         H006V5_A186MunicipioCodigo = new string[] {""} ;
         H006V5_n186MunicipioCodigo = new bool[] {false} ;
         H006V5_A187MunicipioNome = new string[] {""} ;
         H006V5_n187MunicipioNome = new bool[] {false} ;
         H006V5_A189MunicipioUF = new string[] {""} ;
         H006V5_n189MunicipioUF = new bool[] {false} ;
         H006V5_A190EnderecoNumero = new string[] {""} ;
         H006V5_n190EnderecoNumero = new bool[] {false} ;
         H006V5_A191EnderecoComplemento = new string[] {""} ;
         H006V5_n191EnderecoComplemento = new bool[] {false} ;
         H006V5_A201ContatoEmail = new string[] {""} ;
         H006V5_n201ContatoEmail = new bool[] {false} ;
         H006V5_A198ContatoDDD = new short[1] ;
         H006V5_n198ContatoDDD = new bool[] {false} ;
         H006V5_A199ContatoDDI = new short[1] ;
         H006V5_n199ContatoDDI = new bool[] {false} ;
         H006V5_A200ContatoNumero = new long[1] ;
         H006V5_n200ContatoNumero = new bool[] {false} ;
         H006V5_A202ContatoTelefoneNumero = new long[1] ;
         H006V5_n202ContatoTelefoneNumero = new bool[] {false} ;
         H006V5_A203ContatoTelefoneDDD = new short[1] ;
         H006V5_n203ContatoTelefoneDDD = new bool[] {false} ;
         H006V5_A204ContatoTelefoneDDI = new short[1] ;
         H006V5_n204ContatoTelefoneDDI = new bool[] {false} ;
         H006V5_A459ClienteDataNascimento = new DateTime[] {DateTime.MinValue} ;
         H006V5_n459ClienteDataNascimento = new bool[] {false} ;
         H006V5_A421ClienteRG = new long[1] ;
         H006V5_n421ClienteRG = new bool[] {false} ;
         H006V5_A484ClienteNacionalidade = new int[1] ;
         H006V5_n484ClienteNacionalidade = new bool[] {false} ;
         H006V5_A486ClienteEstadoCivil = new string[] {""} ;
         H006V5_n486ClienteEstadoCivil = new bool[] {false} ;
         H006V5_A487ClienteProfissao = new int[1] ;
         H006V5_n487ClienteProfissao = new bool[] {false} ;
         H006V5_A168ClienteId = new int[1] ;
         AV54ResponsavelTipoClienteDescricao = "";
         AV55ResponsavelSecUserName = "";
         AV57ModeloRetorno = "";
         AV58Mensagem = "";
         H006V6_A186MunicipioCodigo = new string[] {""} ;
         H006V6_n186MunicipioCodigo = new bool[] {false} ;
         H006V6_A187MunicipioNome = new string[] {""} ;
         H006V6_n187MunicipioNome = new bool[] {false} ;
         H006V6_A189MunicipioUF = new string[] {""} ;
         H006V6_n189MunicipioUF = new bool[] {false} ;
         sStyleString = "";
         ...
         sCtrlAV7GoingBack = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpropostaresponsavel__default(),
            new Object[][] {
                new Object[] {
               H006V2_A219TipoClienteFinancia, H006V2_n219TipoClienteFinancia, H006V2_A192TipoClienteId
               }
               , new Object[] {
               H006V3_A440ProfissaoId, H006V3_A441ProfissaoNome, H006V3_n441ProfissaoNome
               }
               , new Object[] {
               H006V4_A434NacionalidadeId, H006V4_A435NacionalidadeNome, H006V4_n435NacionalidadeNome
               }
               , new Object[] {
               H006V5_A457EspecialidadeId, H006V5_n457EspecialidadeId, H006V5_A597EspecialidadeCreatedBy, H006V5_n597EspecialidadeCreatedBy, H006V5_A169ClienteDocumento, H006V5_n169ClienteDocumento, H006V5_A170ClienteRazaoSocial, H006V5_n170ClienteRazaoSocial, H006V5_A171ClienteNomeFantasia, H006V5_n171ClienteNomeFantasia,
               H006V5_A172ClienteTipoPessoa, H006V5_n172ClienteTipoPessoa, H006V5_A192TipoClienteId, H006V5_n192TipoClienteId, H006V5_A193TipoClienteDescricao, H006V5_n193TipoClienteDescricao, H006V5_A174ClienteStatus, H006V5_n174ClienteStatus, H006V5_A141SecUserName, H006V5_n141SecUserName,
               H006V5_A181EnderecoTipo, H006V5_n181EnderecoTipo, H006V5_A182EnderecoCEP, H006V5_n182EnderecoCEP, H006V5_A183EnderecoLogradouro, H006V5_n183EnderecoLogradouro, H006V5_A184EnderecoBairro, H006V5_n184EnderecoBairro, H006V5_A185EnderecoCidade, H006V5_n185EnderecoCidade,
               H006V5_A186MunicipioCodigo, H006V5_n186MunicipioCodigo, H006V5_A187MunicipioNome, H006V5_n187MunicipioNome, H006V5_A189MunicipioUF, H006V5_n189MunicipioUF, H006V5_A190EnderecoNumero, H006V5_n190EnderecoNumero, H006V5_A191EnderecoComplemento, H006V5_n191EnderecoComplemento,
               H006V5_A201ContatoEmail, H006V5_n201ContatoEmail, H006V5_A198ContatoDDD, H006V5_n198ContatoDDD, H006V5_A199ContatoDDI, H006V5_n199ContatoDDI, H006V5_A200ContatoNumero, H006V5_n200ContatoNumero, H006V5_A202ContatoTelefoneNumero, H006V5_n202ContatoTelefoneNumero,
               H006V5_A203ContatoTelefoneDDD, H006V5_n203ContatoTelefoneDDD, H006V5_A204ContatoTelefoneDDI, H006V5_n204ContatoTelefoneDDI, H006V5_A459ClienteDataNascimento, H006V5_n459ClienteDataNascimento, H006V5_A421ClienteRG, H006V5_n421ClienteRG, H006V5_A484ClienteNacionalidade, H006V5_n484ClienteNacionalidade,
               H006V5_A486ClienteEstadoCivil, H006V5_n486ClienteEstadoCivil, H006V5_A487ClienteProfissao, H006V5_n487ClienteProfissao, H006V5_A168ClienteId
               }
               , new Object[] {
               H006V6_A186MunicipioCodigo, H006V6_A187MunicipioNome, H006V6_n187MunicipioNome, H006V6_A189MunicipioUF, H006V6_n189MunicipioUF
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] H006V2_A219TipoClienteFinancia ;
      private bool[] H006V2_n219TipoClienteFinancia ;
      private short[] H006V2_A192TipoClienteId ;
      private bool[] H006V2_n192TipoClienteId ;
      private SdtCliente AV46ClienteBC ;
      private SdtClienteReponsavel AV52ClienteResponsavel ;
      private int[] H006V3_A440ProfissaoId ;
      private string[] H006V3_A441ProfissaoNome ;
      private bool[] H006V3_n441ProfissaoNome ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV41Combo_DataItem ;
      private int[] H006V4_A434NacionalidadeId ;
      private string[] H006V4_A435NacionalidadeNome ;
      private bool[] H006V4_n435NacionalidadeNome ;
      private int[] H006V5_A457EspecialidadeId ;
      private bool[] H006V5_n457EspecialidadeId ;
      private short[] H006V5_A597EspecialidadeCreatedBy ;
      private bool[] H006V5_n597EspecialidadeCreatedBy ;
      private string[] H006V5_A169ClienteDocumento ;
      private bool[] H006V5_n169ClienteDocumento ;
      private string[] H006V5_A170ClienteRazaoSocial ;
      private bool[] H006V5_n170ClienteRazaoSocial ;
      private string[] H006V5_A171ClienteNomeFantasia ;
      private bool[] H006V5_n171ClienteNomeFantasia ;
      private string[] H006V5_A172ClienteTipoPessoa ;
      private bool[] H006V5_n172ClienteTipoPessoa ;
      private short[] H006V5_A192TipoClienteId ;
      private bool[] H006V5_n192TipoClienteId ;
      private string[] H006V5_A193TipoClienteDescricao ;
      private bool[] H006V5_n193TipoClienteDescricao ;
      private bool[] H006V5_A174ClienteStatus ;
      private bool[] H006V5_n174ClienteStatus ;
      private string[] H006V5_A141SecUserName ;
      private bool[] H006V5_n141SecUserName ;
      private string[] H006V5_A181EnderecoTipo ;
      private bool[] H006V5_n181EnderecoTipo ;
      private string[] H006V5_A182EnderecoCEP ;
      private bool[] H006V5_n182EnderecoCEP ;
      private string[] H006V5_A183EnderecoLogradouro ;
      private bool[] H006V5_n183EnderecoLogradouro ;
      private string[] H006V5_A184EnderecoBairro ;
      private bool[] H006V5_n184EnderecoBairro ;
      private string[] H006V5_A185EnderecoCidade ;
      private bool[] H006V5_n185EnderecoCidade ;
      private string[] H006V5_A186MunicipioCodigo ;
      private bool[] H006V5_n186MunicipioCodigo ;
      private string[] H006V5_A187MunicipioNome ;
      private bool[] H006V5_n187MunicipioNome ;
      private string[] H006V5_A189MunicipioUF ;
      private bool[] H006V5_n189MunicipioUF ;
      private string[] H006V5_A190EnderecoNumero ;
      private bool[] H006V5_n190EnderecoNumero ;
      private string[] H006V5_A191EnderecoComplemento ;
      private bool[] H006V5_n191EnderecoComplemento ;
      private string[] H006V5_A201ContatoEmail ;
      private bool[] H006V5_n201ContatoEmail ;
      private short[] H006V5_A198ContatoDDD ;
      private bool[] H006V5_n198ContatoDDD ;
      private short[] H006V5_A199ContatoDDI ;
      private bool[] H006V5_n199ContatoDDI ;
      private long[] H006V5_A200ContatoNumero ;
      private bool[] H006V5_n200ContatoNumero ;
      private long[] H006V5_A202ContatoTelefoneNumero ;
      private bool[] H006V5_n202ContatoTelefoneNumero ;
      private short[] H006V5_A203ContatoTelefoneDDD ;
      private bool[] H006V5_n203ContatoTelefoneDDD ;
      private short[] H006V5_A204ContatoTelefoneDDI ;
      private bool[] H006V5_n204ContatoTelefoneDDI ;
      private DateTime[] H006V5_A459ClienteDataNascimento ;
      private bool[] H006V5_n459ClienteDataNascimento ;
      private long[] H006V5_A421ClienteRG ;
      private bool[] H006V5_n421ClienteRG ;
      private int[] H006V5_A484ClienteNacionalidade ;
      private bool[] H006V5_n484ClienteNacionalidade ;
      private string[] H006V5_A486ClienteEstadoCivil ;
      private bool[] H006V5_n486ClienteEstadoCivil ;
      private int[] H006V5_A487ClienteProfissao ;
      private bool[] H006V5_n487ClienteProfissao ;
      private int[] H006V5_A168ClienteId ;
      private string[] H006V6_A186MunicipioCodigo ;
      private bool[] H006V6_n186MunicipioCodigo ;
      private string[] H006V6_A187MunicipioNome ;
      private bool[] H006V6_n187MunicipioNome ;
      private string[] H006V6_A189MunicipioUF ;
      private bool[] H006V6_n189MunicipioUF ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wpropostaresponsavel__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH006V4;
          prmH006V4 = new Object[] {
          };
          Object[] prmH006V5;
          prmH006V5 = new Object[] {
          new ParDef("AV12ResponsavelClienteDocumento",GXType.VarChar,20,0)
          };
          Object[] prmH006V6;
          prmH006V6 = new Object[] {
          new ParDef("AV35ResponsavelMunicipioCodigo",GXType.VarChar,40,0)
          };
          def= new CursorDef[] {
              new CursorDef("H006V2", "SELECT TipoClienteFinancia, TipoClienteId FROM TipoCliente WHERE TipoClienteFinancia ORDER BY TipoClienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006V2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006V3", "SELECT ProfissaoId, ProfissaoNome FROM Profissao ORDER BY ProfissaoNome ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006V3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006V4", "SELECT NacionalidadeId, NacionalidadeNome FROM Nacionalidade ORDER BY NacionalidadeNome ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006V4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006V5", "SELECT T1.EspecialidadeId, T2.EspecialidadeCreatedBy AS EspecialidadeCreatedBy, T1.ClienteDocumento, T1.ClienteRazaoSocial, T1.ClienteNomeFantasia, T1.ClienteTipoPessoa, T1.TipoClienteId, T4.TipoClienteDescricao, T1.ClienteStatus, T3.SecUserName, T1.EnderecoTipo, T1.EnderecoCEP, T1.EnderecoLogradouro, T1.EnderecoBairro, T1.EnderecoCidade, T1.MunicipioCodigo, T5.MunicipioNome, T5.MunicipioUF, T1.EnderecoNumero, T1.EnderecoComplemento, T1.ContatoEmail, T1.ContatoDDD, T1.ContatoDDI, T1.ContatoNumero, T1.ContatoTelefoneNumero, T1.ContatoTelefoneDDD, T1.ContatoTelefoneDDI, T1.ClienteDataNascimento, T1.ClienteRG, T1.ClienteNacionalidade, T1.ClienteEstadoCivil, T1.ClienteProfissao, T1.ClienteId FROM ((((Cliente T1 LEFT JOIN Especialidade T2 ON T2.EspecialidadeId = T1.EspecialidadeId) LEFT JOIN SecUser T3 ON T3.SecUserId = T2.EspecialidadeCreatedBy) LEFT JOIN TipoCliente T4 ON T4.TipoClienteId = T1.TipoClienteId) LEFT JOIN Municipio T5 ON T5.MunicipioCodigo = T1.MunicipioCodigo) WHERE T1.ClienteDocumento = ( :AV12ResponsavelClienteDocumento) ORDER BY T1.ClienteDocumento ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006V5,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H006V6", "SELECT MunicipioCodigo, MunicipioNome, MunicipioUF FROM Municipio WHERE MunicipioCodigo = ( :AV35ResponsavelMunicipioCodigo) ORDER BY MunicipioCodigo ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006V6,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
