...
namespace GeneXus.Programs.wwpbaseobjects {
   public class workwithplusmasterpageempty : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm062( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageempty.js", "?202561019223178", false, true);
      ...
      protected void E11062( )
      {
         ...
         {
            A249EmpresaId = H00062_A249EmpresaId[0];
            AV12GXLvl20 = 1;
            AV11EmpresaId = A249EmpresaId;
            pr_default.readNext(0);
         }
         pr_default.close(0);
         if ( AV12GXLvl20 == 0 )
         {
            CallWebObject(formatLink("iniciarsistema") );
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202561019223284", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageempty.js", "?202561019223284", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H00062_A249EmpresaId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         sDynURL = "";
         Form = new GXWebForm();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.workwithplusmasterpageempty__default(),
            new Object[][] {
                new Object[] {
               H00062_A249EmpresaId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV12GXLvl20 ;
      private short nGotPars ;
      private short nGXWrapped ;
      private int A249EmpresaId ;
      private int AV11EmpresaId ;
      private int idxLst ;
      ...
      private int[] H00062_A249EmpresaId ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class workwithplusmasterpageempty__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00062", "SELECT EmpresaId FROM Empresa ORDER BY EmpresaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00062,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
