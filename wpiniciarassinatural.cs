...
namespace GeneXus.Programs {
   public class wpiniciarassinatural : GXDataArea
   {
      public wpiniciarassinatural( )
      {
      ...
      public wpiniciarassinatural( IGxContext context )
      {
      ...
      public void execute( int aP0_ContratoId ,
                           int aP1_PropostaId ,
                           short aP2_layoutcontratoid )
      {
         this.AV5ContratoId = aP0_ContratoId;
         this.AV35PropostaId = aP1_PropostaId;
         this.AV36layoutcontratoid = aP2_layoutcontratoid;
         ExecuteImpl();
      }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wpiniciarassinatural"+UrlEncode(StringUtil.LTrimStr(AV5ContratoId,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV35PropostaId,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36layoutcontratoid,4,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpiniciarassinatural") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISSEMRESPONSAVEL", AV31IsSemResponsavel);
         GxWebStd.gx_hidden_field( context, "gxhash_vISSEMRESPONSAVEL", GetSecureSignedToken( "", AV31IsSemResponsavel, context));
         GxWebStd.gx_hidden_field( context, "vHTML", AV24HTML);
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vPROPOSTAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV35PropostaId), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vLAYOUTCONTRATOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV36layoutcontratoid), 4, 0, ",", "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vGXV2", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV41GXV2), 8, 0, ",", "")));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpiniciarassinatural"+UrlEncode(StringUtil.LTrimStr(AV5ContratoId,6,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV35PropostaId,9,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV36layoutcontratoid,4,0));
         return formatLink("wpiniciarassinatural") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "WpIniciarAssinaturaL" ;
      }
      ...
      protected void WB9I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnaddpart_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(32), 2, 0)+","+"null"+");", "Adicionar participante", bttBtnaddpart_Jsonclick, 5, "Adicionar participante", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOADDPART\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpIniciarAssinaturaL.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 32 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(32), 2, 0)+","+"null"+");", "Confirmar", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpIniciarAssinaturaL.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(32), 2, 0)+","+"null"+");", "Fechar", bttBtncancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpIniciarAssinaturaL.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START9I2( )
      {
         ...
         Form.Meta.addItem("description", "Gerar contrato", 0) ;
         context.wjLoc = "";
      ...
      protected void PA9I2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpiniciarassinatural")), "wpiniciarassinatural") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpiniciarassinatural")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
                  {
                     ...
                     {
                        AV35PropostaId = (int)(Math.Round(NumberUtil.Val( GetPar( "PropostaId"), "."), 18, MidpointRounding.ToEven));
                        AssignAttri("", false, "AV35PropostaId", StringUtil.LTrimStr( (decimal)(AV35PropostaId), 9, 0));
                        AV36layoutcontratoid = (short)(Math.Round(NumberUtil.Val( GetPar( "layoutcontratoid"), "."), 18, MidpointRounding.ToEven));
                        AssignAttri("", false, "AV36layoutcontratoid", StringUtil.LTrimStr( (decimal)(AV36layoutcontratoid), 4, 0));
                     }
                  }
                  if ( toggleJsOutput )
                  {
      ...
      protected void STRUP9I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV41GXV2 = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vGXV2"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E149I2( )
      {
         ...
         subGrid1_Rows = 10;
         GxWebStd.gx_hidden_field( context, "GRID1_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid1_Rows), 6, 0, ".", "")));
         AV14Array_SdParticipantes = new GXBaseCollection<SdtSdParticipantes>( context, "SdParticipantes", "Factory2");
         AV15SdParticipantes = new SdtSdParticipantes(context);
         /* Using cursor H009I2 */
         pr_default.execute(0);
         while ( (pr_default.getStatus(0) != 101) )
         {
            A773EmpresaUtilizaRepresentanteAssinatura = H009I2_A773EmpresaUtilizaRepresentanteAssinatura[0];
            n773EmpresaUtilizaRepresentanteAssinatura = H009I2_n773EmpresaUtilizaRepresentanteAssinatura[0];
            A771EmpresaRepresentanteNome = H009I2_A771EmpresaRepresentanteNome[0];
            n771EmpresaRepresentanteNome = H009I2_n771EmpresaRepresentanteNome[0];
            A770EmpresaRepresentanteCPF = H009I2_A770EmpresaRepresentanteCPF[0];
            n770EmpresaRepresentanteCPF = H009I2_n770EmpresaRepresentanteCPF[0];
            A772EmpresaRepresentanteEmail = H009I2_A772EmpresaRepresentanteEmail[0];
            n772EmpresaRepresentanteEmail = H009I2_n772EmpresaRepresentanteEmail[0];
         ...
         {
            A168ClienteId = H009I3_A168ClienteId[0];
            A172ClienteTipoPessoa = H009I3_A172ClienteTipoPessoa[0];
            n172ClienteTipoPessoa = H009I3_n172ClienteTipoPessoa[0];
            A436ResponsavelNome = H009I3_A436ResponsavelNome[0];
            n436ResponsavelNome = H009I3_n436ResponsavelNome[0];
            A447ResponsavelCPF = H009I3_A447ResponsavelCPF[0];
            n447ResponsavelCPF = H009I3_n447ResponsavelCPF[0];
            A456ResponsavelEmail = H009I3_A456ResponsavelEmail[0];
            n456ResponsavelEmail = H009I3_n456ResponsavelEmail[0];
            A170ClienteRazaoSocial = H009I3_A170ClienteRazaoSocial[0];
            n170ClienteRazaoSocial = H009I3_n170ClienteRazaoSocial[0];
            A169ClienteDocumento = H009I3_A169ClienteDocumento[0];
            n169ClienteDocumento = H009I3_n169ClienteDocumento[0];
            A201ContatoEmail = H009I3_A201ContatoEmail[0];
            n201ContatoEmail = H009I3_n201ContatoEmail[0];
         ...
         {
            A133SecUserId = H009I4_A133SecUserId[0];
            n133SecUserId = H009I4_n133SecUserId[0];
            A479ConfiguracoesTestemunhasNome = H009I4_A479ConfiguracoesTestemunhasNome[0];
            n479ConfiguracoesTestemunhasNome = H009I4_n479ConfiguracoesTestemunhasNome[0];
            A480ConfiguracoesTestemunhasDocumento = H009I4_A480ConfiguracoesTestemunhasDocumento[0];
            n480ConfiguracoesTestemunhasDocumento = H009I4_n480ConfiguracoesTestemunhasDocumento[0];
            A481ConfiguracoesTestemunhasEmail = H009I4_A481ConfiguracoesTestemunhasEmail[0];
            n481ConfiguracoesTestemunhasEmail = H009I4_n481ConfiguracoesTestemunhasEmail[0];
            AV15SdParticipantes = new SdtSdParticipantes(context);
      ...
      private void E159I2( )
      {
         ...
         returnInSub = false;
         AV40GXV1 = 1;
         while ( AV40GXV1 <= AV14Array_SdParticipantes.Count )
         {
            AV15SdParticipantes = ((SdtSdParticipantes)AV14Array_SdParticipantes.Item(AV40GXV1));
      ...
      protected void E169I2( )
      {
         /* Retirar_Click Routine */
         returnInSub = false;
         AV16index = 0;
         AV42GXV3 = 1;
         while ( AV42GXV3 <= AV14Array_SdParticipantes.Count )
         {
            AV15SdParticipantes = ((SdtSdParticipantes)AV14Array_SdParticipantes.Item(AV42GXV3));
      ...
      protected void E129I2( )
      {
         ...
         if ( ! AV31IsSemResponsavel )
         {
            ...
            AV24HTML = "<html><head> <meta charset=\"UTF-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"></head><body>" + AV24HTML + "</body></html>";
            AssignAttri("", false, "AV24HTML", AV24HTML);
            AV19GUID = Guid.NewGuid( );
      ...
      protected void E139I2( )
      {
         ...
         AV30IsExists = false;
         AV43GXV4 = 1;
         while ( AV43GXV4 <= AV14Array_SdParticipantes.Count )
         {
            AV15SdParticipantes = ((SdtSdParticipantes)AV14Array_SdParticipantes.Item(AV43GXV4));
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV5ContratoId", StringUtil.LTrimStr( (decimal)(AV5ContratoId), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCONTRATOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV5ContratoId), "ZZZZZ9"), context));
         AV35PropostaId = Convert.ToInt32(getParm(obj,1));
         AssignAttri("", false, "AV35PropostaId", StringUtil.LTrimStr( (decimal)(AV35PropostaId), 9, 0));
         AV36layoutcontratoid = Convert.ToInt16(getParm(obj,2));
         AssignAttri("", false, "AV36layoutcontratoid", StringUtil.LTrimStr( (decimal)(AV36layoutcontratoid), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255221662344", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpiniciarassinatural.js", "?20255221662345", false, true);
         context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
         context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID1.LOAD","""{"handler":"E159I2","iparms":[{"av":"AV14Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""}]""");
         ...
         setEventMetadata("'DOADDPART'","""{"handler":"E119I2","iparms":[{"av":"GRID1_nFirstRecordOnPage","type":"int"},{"av":"GRID1_nEOF","type":"int"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV14Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""},{"av":"AV31IsSemResponsavel","fld":"vISSEMRESPONSAVEL","hsh":true,"type":"boolean"},{"av":"AV5ContratoId","fld":"vCONTRATOID","pic":"ZZZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("VRETIRAR.CLICK","""{"handler":"E169I2","iparms":[{"av":"GRID1_nFirstRecordOnPage","type":"int"},{"av":"GRID1_nEOF","type":"int"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV14Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""},{"av":"AV31IsSemResponsavel","fld":"vISSEMRESPONSAVEL","hsh":true,"type":"boolean"},{"av":"AV5ContratoId","fld":"vCONTRATOID","pic":"ZZZZZ9","hsh":true,"type":"int"},{"av":"AV10ParticipanteDocumento","fld":"vPARTICIPANTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"cmbavAssinaturaparticipantetipo"},{"av":"AV12AssinaturaParticipanteTipo","fld":"vASSINATURAPARTICIPANTETIPO","type":"svchar"}]""");
         setEventMetadata("VRETIRAR.CLICK",""","oparms":[{"av":"AV14Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""}]}""");
         setEventMetadata("ENTER","""{"handler":"E129I2","iparms":[{"av":"AV31IsSemResponsavel","fld":"vISSEMRESPONSAVEL","hsh":true,"type":"boolean"},{"av":"AV9ContratoCorpo","fld":"vCONTRATOCORPO","type":"vchar"},{"av":"AV24HTML","fld":"vHTML","type":"vchar"},{"av":"AV6Contrato","fld":"vCONTRATO","type":""},{"av":"AV5ContratoId","fld":"vCONTRATOID","pic":"ZZZZZ9","hsh":true,"type":"int"},{"av":"AV14Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV24HTML","fld":"vHTML","type":"vchar"},{"av":"AV6Contrato","fld":"vCONTRATO","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.WPINICIARASSINATURA_NOVOPARTICIPANTE","""{"handler":"E139I2","iparms":[{"av":"AV27GlobalAssinaturaParticipanteTipo","fld":"vGLOBALASSINATURAPARTICIPANTETIPO","type":"svchar"},{"av":"AV26GlobalEmail","fld":"vGLOBALEMAIL","type":"svchar"},{"av":"AV29GlobalCPF","fld":"vGLOBALCPF","type":"svchar"},{"av":"AV28GlobalNome","fld":"vGLOBALNOME","type":"svchar"},{"av":"AV14Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""},{"av":"AV6Contrato","fld":"vCONTRATO","type":""}]""");
      ...
      public override void initialize( )
      {
         ...
         H009I2_A249EmpresaId = new int[1] ;
         H009I2_A773EmpresaUtilizaRepresentanteAssinatura = new bool[] {false} ;
         H009I2_n773EmpresaUtilizaRepresentanteAssinatura = new bool[] {false} ;
         H009I2_A771EmpresaRepresentanteNome = new string[] {""} ;
         H009I2_n771EmpresaRepresentanteNome = new bool[] {false} ;
         H009I2_A770EmpresaRepresentanteCPF = new string[] {""} ;
         H009I2_n770EmpresaRepresentanteCPF = new bool[] {false} ;
         H009I2_A772EmpresaRepresentanteEmail = new string[] {""} ;
         H009I2_n772EmpresaRepresentanteEmail = new bool[] {false} ;
         A771EmpresaRepresentanteNome = "";
         A770EmpresaRepresentanteCPF = "";
         A772EmpresaRepresentanteEmail = "";
         H009I3_A168ClienteId = new int[1] ;
         H009I3_A172ClienteTipoPessoa = new string[] {""} ;
         H009I3_n172ClienteTipoPessoa = new bool[] {false} ;
         H009I3_A436ResponsavelNome = new string[] {""} ;
         H009I3_n436ResponsavelNome = new bool[] {false} ;
         H009I3_A447ResponsavelCPF = new string[] {""} ;
         H009I3_n447ResponsavelCPF = new bool[] {false} ;
         H009I3_A456ResponsavelEmail = new string[] {""} ;
         H009I3_n456ResponsavelEmail = new bool[] {false} ;
         H009I3_A170ClienteRazaoSocial = new string[] {""} ;
         H009I3_n170ClienteRazaoSocial = new bool[] {false} ;
         H009I3_A169ClienteDocumento = new string[] {""} ;
         H009I3_n169ClienteDocumento = new bool[] {false} ;
         H009I3_A201ContatoEmail = new string[] {""} ;
         H009I3_n201ContatoEmail = new bool[] {false} ;
         ...
         A201ContatoEmail = "";
         H009I4_A478ConfiguracoesTestemunhasId = new int[1] ;
         H009I4_A133SecUserId = new short[1] ;
         H009I4_n133SecUserId = new bool[] {false} ;
         H009I4_A479ConfiguracoesTestemunhasNome = new string[] {""} ;
         H009I4_n479ConfiguracoesTestemunhasNome = new bool[] {false} ;
         H009I4_A480ConfiguracoesTestemunhasDocumento = new string[] {""} ;
         H009I4_n480ConfiguracoesTestemunhasDocumento = new bool[] {false} ;
         H009I4_A481ConfiguracoesTestemunhasEmail = new string[] {""} ;
         H009I4_n481ConfiguracoesTestemunhasEmail = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpiniciarassinatural__default(),
            new Object[][] {
                new Object[] {
               H009I2_A249EmpresaId, H009I2_A773EmpresaUtilizaRepresentanteAssinatura, H009I2_n773EmpresaUtilizaRepresentanteAssinatura, H009I2_A771EmpresaRepresentanteNome, H009I2_n771EmpresaRepresentanteNome, H009I2_A770EmpresaRepresentanteCPF, H009I2_n770EmpresaRepresentanteCPF, H009I2_A772EmpresaRepresentanteEmail, H009I2_n772EmpresaRepresentanteEmail
               }
               , new Object[] {
               H009I3_A168ClienteId, H009I3_A172ClienteTipoPessoa, H009I3_n172ClienteTipoPessoa, H009I3_A436ResponsavelNome, H009I3_n436ResponsavelNome, H009I3_A447ResponsavelCPF, H009I3_n447ResponsavelCPF, H009I3_A456ResponsavelEmail, H009I3_n456ResponsavelEmail, H009I3_A170ClienteRazaoSocial,
               H009I3_n170ClienteRazaoSocial, H009I3_A169ClienteDocumento, H009I3_n169ClienteDocumento, H009I3_A201ContatoEmail, H009I3_n201ContatoEmail
               }
               , new Object[] {
               H009I4_A478ConfiguracoesTestemunhasId, H009I4_A133SecUserId, H009I4_n133SecUserId, H009I4_A479ConfiguracoesTestemunhasNome, H009I4_n479ConfiguracoesTestemunhasNome, H009I4_A480ConfiguracoesTestemunhasDocumento, H009I4_n480ConfiguracoesTestemunhasDocumento, H009I4_A481ConfiguracoesTestemunhasEmail, H009I4_n481ConfiguracoesTestemunhasEmail
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV36layoutcontratoid ;
      private short wcpOAV36layoutcontratoid ;
      ...
      private int AV35PropostaId ;
      private int wcpOAV5ContratoId ;
      private int wcpOAV35PropostaId ;
      ...
      private int[] H009I2_A249EmpresaId ;
      private bool[] H009I2_A773EmpresaUtilizaRepresentanteAssinatura ;
      private bool[] H009I2_n773EmpresaUtilizaRepresentanteAssinatura ;
      private string[] H009I2_A771EmpresaRepresentanteNome ;
      private bool[] H009I2_n771EmpresaRepresentanteNome ;
      private string[] H009I2_A770EmpresaRepresentanteCPF ;
      private bool[] H009I2_n770EmpresaRepresentanteCPF ;
      private string[] H009I2_A772EmpresaRepresentanteEmail ;
      private bool[] H009I2_n772EmpresaRepresentanteEmail ;
      private int[] H009I3_A168ClienteId ;
      private string[] H009I3_A172ClienteTipoPessoa ;
      private bool[] H009I3_n172ClienteTipoPessoa ;
      private string[] H009I3_A436ResponsavelNome ;
      private bool[] H009I3_n436ResponsavelNome ;
      private string[] H009I3_A447ResponsavelCPF ;
      private bool[] H009I3_n447ResponsavelCPF ;
      private string[] H009I3_A456ResponsavelEmail ;
      private bool[] H009I3_n456ResponsavelEmail ;
      private string[] H009I3_A170ClienteRazaoSocial ;
      private bool[] H009I3_n170ClienteRazaoSocial ;
      private string[] H009I3_A169ClienteDocumento ;
      private bool[] H009I3_n169ClienteDocumento ;
      private string[] H009I3_A201ContatoEmail ;
      private bool[] H009I3_n201ContatoEmail ;
      private int[] H009I4_A478ConfiguracoesTestemunhasId ;
      private short[] H009I4_A133SecUserId ;
      private bool[] H009I4_n133SecUserId ;
      private string[] H009I4_A479ConfiguracoesTestemunhasNome ;
      private bool[] H009I4_n479ConfiguracoesTestemunhasNome ;
      private string[] H009I4_A480ConfiguracoesTestemunhasDocumento ;
      private bool[] H009I4_n480ConfiguracoesTestemunhasDocumento ;
      private string[] H009I4_A481ConfiguracoesTestemunhasEmail ;
      private bool[] H009I4_n481ConfiguracoesTestemunhasEmail ;
      private SdtSdErro AV17SdErro ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wpiniciarassinatural__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH009I2;
          prmH009I2 = new Object[] {
          };
          Object[] prmH009I3;
          prmH009I3 = new Object[] {
          new ParDef("AV6Contr_1Contratoclienteid",GXType.Int32,9,0)
          };
          Object[] prmH009I4;
          prmH009I4 = new Object[] {
          new ParDef("AV33WWPContext__Userid",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H009I2", "SELECT EmpresaId, EmpresaUtilizaRepresentanteAssinatura, EmpresaRepresentanteNome, EmpresaRepresentanteCPF, EmpresaRepresentanteEmail FROM Empresa WHERE EmpresaUtilizaRepresentanteAssinatura ORDER BY EmpresaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009I2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H009I3", "SELECT ClienteId, ClienteTipoPessoa, ResponsavelNome, ResponsavelCPF, ResponsavelEmail, ClienteRazaoSocial, ClienteDocumento, ContatoEmail FROM Cliente WHERE ClienteId = :AV6Contr_1Contratoclienteid ORDER BY ClienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009I3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H009I4", "SELECT ConfiguracoesTestemunhasId, SecUserId, ConfiguracoesTestemunhasNome, ConfiguracoesTestemunhasDocumento, ConfiguracoesTestemunhasEmail FROM ConfiguracoesTestemunhas WHERE SecUserId = :AV33WWPContext__Userid ORDER BY SecUserId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009I4,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
