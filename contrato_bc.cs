   ...
   public class contrato_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void E120X2( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV9TrnContext.gxTpr_Transactionname, AV16Pgmname) == 0 ) && ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) )
         {
            ...
            {
               AV12TrnContextAtt = ((GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute)AV9TrnContext.gxTpr_Attributes.Item(AV17GXV1));
      ...
      public void ScanKeyStart0X36( )
      {
         ...
         {
            RcdFound36 = 1;
            A227ContratoId = BC000X30_A227ContratoId[0];
            n227ContratoId = BC000X30_n227ContratoId[0];
            A228ContratoNome = BC000X30_A228ContratoNome[0];
            n228ContratoNome = BC000X30_n228ContratoNome[0];
            A339ContratoCorpo = BC000X30_A339ContratoCorpo[0];
            n339ContratoCorpo = BC000X30_n339ContratoCorpo[0];
            A361ContratoComVigencia = BC000X30_A361ContratoComVigencia[0];
            n361ContratoComVigencia = BC000X30_n361ContratoComVigencia[0];
            A362ContratoDataInicial = BC000X30_A362ContratoDataInicial[0];
            n362ContratoDataInicial = BC000X30_n362ContratoDataInicial[0];
            A363ContratoDataFinal = BC000X30_A363ContratoDataFinal[0];
            n363ContratoDataFinal = BC000X30_n363ContratoDataFinal[0];
            A474ContratoClienteNome = BC000X30_A474ContratoClienteNome[0];
            n474ContratoClienteNome = BC000X30_n474ContratoClienteNome[0];
            A475ContratoClienteDocumento = BC000X30_A475ContratoClienteDocumento[0];
            n475ContratoClienteDocumento = BC000X30_n475ContratoClienteDocumento[0];
            A476ContratoClienteRepresentanteNome = BC000X30_A476ContratoClienteRepresentanteNome[0];
            n476ContratoClienteRepresentanteNome = BC000X30_n476ContratoClienteRepresentanteNome[0];
            A477ContratoClienteRepresentanteCPF = BC000X30_A477ContratoClienteRepresentanteCPF[0];
            n477ContratoClienteRepresentanteCPF = BC000X30_n477ContratoClienteRepresentanteCPF[0];
            A561ContratoClienteTipoPessoa = BC000X30_A561ContratoClienteTipoPessoa[0];
            n561ContratoClienteTipoPessoa = BC000X30_n561ContratoClienteTipoPessoa[0];
            A460ContratoTaxa = BC000X30_A460ContratoTaxa[0];
            n460ContratoTaxa = BC000X30_n460ContratoTaxa[0];
            A461ContratoSLA = BC000X30_A461ContratoSLA[0];
            n461ContratoSLA = BC000X30_n461ContratoSLA[0];
            A462ContratoJurosMora = BC000X30_A462ContratoJurosMora[0];
            n462ContratoJurosMora = BC000X30_n462ContratoJurosMora[0];
            A463ContratoIOFMinimo = BC000X30_A463ContratoIOFMinimo[0];
            n463ContratoIOFMinimo = BC000X30_n463ContratoIOFMinimo[0];
            A471ContratoSituacao = BC000X30_A471ContratoSituacao[0];
            n471ContratoSituacao = BC000X30_n471ContratoSituacao[0];
            A614ContratoClienteEnderecoCEP = BC000X30_A614ContratoClienteEnderecoCEP[0];
            n614ContratoClienteEnderecoCEP = BC000X30_n614ContratoClienteEnderecoCEP[0];
            A615ContratoClienteEnderecoLograodouro = BC000X30_A615ContratoClienteEnderecoLograodouro[0];
            n615ContratoClienteEnderecoLograodouro = BC000X30_n615ContratoClienteEnderecoLograodouro[0];
            A616ContratoClienteEnderecoNumero = BC000X30_A616ContratoClienteEnderecoNumero[0];
            n616ContratoClienteEnderecoNumero = BC000X30_n616ContratoClienteEnderecoNumero[0];
            A617ContratoClienteEnderecoComplemento = BC000X30_A617ContratoClienteEnderecoComplemento[0];
            n617ContratoClienteEnderecoComplemento = BC000X30_n617ContratoClienteEnderecoComplemento[0];
            A618ContratoClienteEnderecoBairro = BC000X30_A618ContratoClienteEnderecoBairro[0];
            n618ContratoClienteEnderecoBairro = BC000X30_n618ContratoClienteEnderecoBairro[0];
            A473ContratoClienteId = BC000X30_A473ContratoClienteId[0];
            n473ContratoClienteId = BC000X30_n473ContratoClienteId[0];
            A923ContratoPropostaId = BC000X30_A923ContratoPropostaId[0];
            n923ContratoPropostaId = BC000X30_n923ContratoPropostaId[0];
            A619ContratoClienteMunicipioCodigo = BC000X30_A619ContratoClienteMunicipioCodigo[0];
            n619ContratoClienteMunicipioCodigo = BC000X30_n619ContratoClienteMunicipioCodigo[0];
            A483AssinaturaUltId_F = BC000X30_A483AssinaturaUltId_F[0];
            n483AssinaturaUltId_F = BC000X30_n483AssinaturaUltId_F[0];
            A1007ContratoCountAssinantes_F = BC000X30_A1007ContratoCountAssinantes_F[0];
            n1007ContratoCountAssinantes_F = BC000X30_n1007ContratoCountAssinantes_F[0];
            A472ContratoBlob = BC000X30_A472ContratoBlob[0];
            n472ContratoBlob = BC000X30_n472ContratoBlob[0];
         }
      ...
      public override void initialize( )
      {
         ...
         BC000X25_A323PropostaId = new int[1] ;
         BC000X26_A238AssinaturaId = new long[1] ;
         BC000X26_n238AssinaturaId = new bool[] {false} ;
         BC000X27_A237ContratoParticipanteId = new int[1] ;
         BC000X30_A227ContratoId = new int[1] ;
         BC000X30_n227ContratoId = new bool[] {false} ;
         BC000X30_A228ContratoNome = new string[] {""} ;
         BC000X30_n228ContratoNome = new bool[] {false} ;
         BC000X30_A339ContratoCorpo = new string[] {""} ;
         BC000X30_n339ContratoCorpo = new bool[] {false} ;
         BC000X30_A361ContratoComVigencia = new bool[] {false} ;
         BC000X30_n361ContratoComVigencia = new bool[] {false} ;
         BC000X30_A362ContratoDataInicial = new DateTime[] {DateTime.MinValue} ;
         BC000X30_n362ContratoDataInicial = new bool[] {false} ;
         BC000X30_A363ContratoDataFinal = new DateTime[] {DateTime.MinValue} ;
         BC000X30_n363ContratoDataFinal = new bool[] {false} ;
         BC000X30_A474ContratoClienteNome = new string[] {""} ;
         BC000X30_n474ContratoClienteNome = new bool[] {false} ;
         BC000X30_A475ContratoClienteDocumento = new string[] {""} ;
         BC000X30_n475ContratoClienteDocumento = new bool[] {false} ;
         BC000X30_A476ContratoClienteRepresentanteNome = new string[] {""} ;
         BC000X30_n476ContratoClienteRepresentanteNome = new bool[] {false} ;
         BC000X30_A477ContratoClienteRepresentanteCPF = new string[] {""} ;
         BC000X30_n477ContratoClienteRepresentanteCPF = new bool[] {false} ;
         BC000X30_A561ContratoClienteTipoPessoa = new string[] {""} ;
         BC000X30_n561ContratoClienteTipoPessoa = new bool[] {false} ;
         BC000X30_A460ContratoTaxa = new decimal[1] ;
         BC000X30_n460ContratoTaxa = new bool[] {false} ;
         BC000X30_A461ContratoSLA = new short[1] ;
         BC000X30_n461ContratoSLA = new bool[] {false} ;
         BC000X30_A462ContratoJurosMora = new decimal[1] ;
         BC000X30_n462ContratoJurosMora = new bool[] {false} ;
         BC000X30_A463ContratoIOFMinimo = new decimal[1] ;
         BC000X30_n463ContratoIOFMinimo = new bool[] {false} ;
         BC000X30_A471ContratoSituacao = new string[] {""} ;
         BC000X30_n471ContratoSituacao = new bool[] {false} ;
         BC000X30_A614ContratoClienteEnderecoCEP = new string[] {""} ;
         BC000X30_n614ContratoClienteEnderecoCEP = new bool[] {false} ;
         BC000X30_A615ContratoClienteEnderecoLograodouro = new string[] {""} ;
         BC000X30_n615ContratoClienteEnderecoLograodouro = new bool[] {false} ;
         BC000X30_A616ContratoClienteEnderecoNumero = new string[] {""} ;
         BC000X30_n616ContratoClienteEnderecoNumero = new bool[] {false} ;
         BC000X30_A617ContratoClienteEnderecoComplemento = new string[] {""} ;
         BC000X30_n617ContratoClienteEnderecoComplemento = new bool[] {false} ;
         BC000X30_A618ContratoClienteEnderecoBairro = new string[] {""} ;
         BC000X30_n618ContratoClienteEnderecoBairro = new bool[] {false} ;
         BC000X30_A473ContratoClienteId = new int[1] ;
         BC000X30_n473ContratoClienteId = new bool[] {false} ;
         BC000X30_A923ContratoPropostaId = new int[1] ;
         BC000X30_n923ContratoPropostaId = new bool[] {false} ;
         BC000X30_A619ContratoClienteMunicipioCodigo = new string[] {""} ;
         BC000X30_n619ContratoClienteMunicipioCodigo = new bool[] {false} ;
         BC000X30_A483AssinaturaUltId_F = new short[1] ;
         BC000X30_n483AssinaturaUltId_F = new bool[] {false} ;
         BC000X30_A1007ContratoCountAssinantes_F = new short[1] ;
         BC000X30_n1007ContratoCountAssinantes_F = new bool[] {false} ;
         BC000X30_A472ContratoBlob = new string[] {""} ;
         BC000X30_n472ContratoBlob = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contrato_bc__default(),
            new Object[][] {
               ...
               , new Object[] {
               BC000X25_A323PropostaId
               }
               , new Object[] {
               BC000X26_A238AssinaturaId
               }
               , new Object[] {
               BC000X27_A237ContratoParticipanteId
               }
               , new Object[] {
               BC000X30_A227ContratoId, BC000X30_A228ContratoNome, BC000X30_n228ContratoNome, BC000X30_A339ContratoCorpo, BC000X30_n339ContratoCorpo, BC000X30_A361ContratoComVigencia, BC000X30_n361ContratoComVigencia, BC000X30_A362ContratoDataInicial, BC000X30_n362ContratoDataInicial, BC000X30_A363ContratoDataFinal,
               BC000X30_n363ContratoDataFinal, BC000X30_A474ContratoClienteNome, BC000X30_n474ContratoClienteNome, BC000X30_A475ContratoClienteDocumento, BC000X30_n475ContratoClienteDocumento, BC000X30_A476ContratoClienteRepresentanteNome, BC000X30_n476ContratoClienteRepresentanteNome, BC000X30_A477ContratoClienteRepresentanteCPF, BC000X30_n477ContratoClienteRepresentanteCPF, BC000X30_A561ContratoClienteTipoPessoa,
               BC000X30_n561ContratoClienteTipoPessoa, BC000X30_A460ContratoTaxa, BC000X30_n460ContratoTaxa, BC000X30_A461ContratoSLA, BC000X30_n461ContratoSLA, BC000X30_A462ContratoJurosMora, BC000X30_n462ContratoJurosMora, BC000X30_A463ContratoIOFMinimo, BC000X30_n463ContratoIOFMinimo, BC000X30_A471ContratoSituacao,
               BC000X30_n471ContratoSituacao, BC000X30_A614ContratoClienteEnderecoCEP, BC000X30_n614ContratoClienteEnderecoCEP, BC000X30_A615ContratoClienteEnderecoLograodouro, BC000X30_n615ContratoClienteEnderecoLograodouro, BC000X30_A616ContratoClienteEnderecoNumero, BC000X30_n616ContratoClienteEnderecoNumero, BC000X30_A617ContratoClienteEnderecoComplemento, BC000X30_n617ContratoClienteEnderecoComplemento, BC000X30_A618ContratoClienteEnderecoBairro,
               BC000X30_n618ContratoClienteEnderecoBairro, BC000X30_A473ContratoClienteId, BC000X30_n473ContratoClienteId, BC000X30_A923ContratoPropostaId, BC000X30_n923ContratoPropostaId, BC000X30_A619ContratoClienteMunicipioCodigo, BC000X30_n619ContratoClienteMunicipioCodigo, BC000X30_A483AssinaturaUltId_F, BC000X30_n483AssinaturaUltId_F, BC000X30_A1007ContratoCountAssinantes_F,
               BC000X30_n1007ContratoCountAssinantes_F, BC000X30_A472ContratoBlob, BC000X30_n472ContratoBlob
               }
            }
         );
         AV16Pgmname = "Contrato_BC";
      ...
      private int[] BC000X25_A323PropostaId ;
      private long[] BC000X26_A238AssinaturaId ;
      private bool[] BC000X26_n238AssinaturaId ;
      private int[] BC000X27_A237ContratoParticipanteId ;
      private int[] BC000X30_A227ContratoId ;
      private bool[] BC000X30_n227ContratoId ;
      private string[] BC000X30_A228ContratoNome ;
      private bool[] BC000X30_n228ContratoNome ;
      private string[] BC000X30_A339ContratoCorpo ;
      private bool[] BC000X30_n339ContratoCorpo ;
      private bool[] BC000X30_A361ContratoComVigencia ;
      private bool[] BC000X30_n361ContratoComVigencia ;
      private DateTime[] BC000X30_A362ContratoDataInicial ;
      private bool[] BC000X30_n362ContratoDataInicial ;
      private DateTime[] BC000X30_A363ContratoDataFinal ;
      private bool[] BC000X30_n363ContratoDataFinal ;
      private string[] BC000X30_A474ContratoClienteNome ;
      private bool[] BC000X30_n474ContratoClienteNome ;
      private string[] BC000X30_A475ContratoClienteDocumento ;
      private bool[] BC000X30_n475ContratoClienteDocumento ;
      private string[] BC000X30_A476ContratoClienteRepresentanteNome ;
      private bool[] BC000X30_n476ContratoClienteRepresentanteNome ;
      private string[] BC000X30_A477ContratoClienteRepresentanteCPF ;
      private bool[] BC000X30_n477ContratoClienteRepresentanteCPF ;
      private string[] BC000X30_A561ContratoClienteTipoPessoa ;
      private bool[] BC000X30_n561ContratoClienteTipoPessoa ;
      private decimal[] BC000X30_A460ContratoTaxa ;
      private bool[] BC000X30_n460ContratoTaxa ;
      private short[] BC000X30_A461ContratoSLA ;
      private bool[] BC000X30_n461ContratoSLA ;
      private decimal[] BC000X30_A462ContratoJurosMora ;
      private bool[] BC000X30_n462ContratoJurosMora ;
      private decimal[] BC000X30_A463ContratoIOFMinimo ;
      private bool[] BC000X30_n463ContratoIOFMinimo ;
      private string[] BC000X30_A471ContratoSituacao ;
      private bool[] BC000X30_n471ContratoSituacao ;
      private string[] BC000X30_A614ContratoClienteEnderecoCEP ;
      private bool[] BC000X30_n614ContratoClienteEnderecoCEP ;
      private string[] BC000X30_A615ContratoClienteEnderecoLograodouro ;
      private bool[] BC000X30_n615ContratoClienteEnderecoLograodouro ;
      private string[] BC000X30_A616ContratoClienteEnderecoNumero ;
      private bool[] BC000X30_n616ContratoClienteEnderecoNumero ;
      private string[] BC000X30_A617ContratoClienteEnderecoComplemento ;
      private bool[] BC000X30_n617ContratoClienteEnderecoComplemento ;
      private string[] BC000X30_A618ContratoClienteEnderecoBairro ;
      private bool[] BC000X30_n618ContratoClienteEnderecoBairro ;
      private int[] BC000X30_A473ContratoClienteId ;
      private bool[] BC000X30_n473ContratoClienteId ;
      private int[] BC000X30_A923ContratoPropostaId ;
      private bool[] BC000X30_n923ContratoPropostaId ;
      private string[] BC000X30_A619ContratoClienteMunicipioCodigo ;
      private bool[] BC000X30_n619ContratoClienteMunicipioCodigo ;
      private short[] BC000X30_A483AssinaturaUltId_F ;
      private bool[] BC000X30_n483AssinaturaUltId_F ;
      private short[] BC000X30_A1007ContratoCountAssinantes_F ;
      private bool[] BC000X30_n1007ContratoCountAssinantes_F ;
      private string[] BC000X30_A472ContratoBlob ;
      private bool[] BC000X30_n472ContratoBlob ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("BC000X25", "SELECT PropostaId FROM Proposta WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000X25,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC000X26", "SELECT AssinaturaId FROM Assinatura WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000X26,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC000X27", "SELECT ContratoParticipanteId FROM ContratoParticipante WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000X27,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC000X30", "SELECT TM1.ContratoId, TM1.ContratoNome, TM1.ContratoCorpo, TM1.ContratoComVigencia, TM1.ContratoDataInicial, TM1.ContratoDataFinal, T3.ClienteRazaoSocial AS ContratoClienteNome, T3.ClienteDocumento AS ContratoClienteDocumento, T3.ResponsavelNome AS ContratoClienteRepresentanteNome, T3.ResponsavelCPF AS ContratoClienteRepresentanteCPF, T3.ClienteTipoPessoa AS ContratoClienteTipoPessoa, TM1.ContratoTaxa, TM1.ContratoSLA, TM1.ContratoJurosMora, TM1.ContratoIOFMinimo, TM1.ContratoSituacao, T3.EnderecoCEP AS ContratoClienteEnderecoCEP, T3.EnderecoLogradouro AS ContratoClienteEnderecoLograodouro, T3.EnderecoNumero AS ContratoClienteEnderecoNumero, T3.EnderecoComplemento AS ContratoClienteEnderecoComplemento, T3.EnderecoBairro AS ContratoClienteEnderecoBairro, TM1.ContratoClienteId AS ContratoClienteId, TM1.ContratoPropostaId AS ContratoPropostaId, T3.MunicipioCodigo AS ContratoClienteMunicipioCodigo, COALESCE( T2.AssinaturaUltId_F, 0) AS AssinaturaUltId_F, COALESCE( T4.ContratoCountAssinantes_F, 0) AS ContratoCountAssinantes_F, TM1.ContratoBlob FROM (((Contrato TM1 LEFT JOIN LATERAL (SELECT MAX(AssinaturaId) AS AssinaturaUltId_F, ContratoId FROM Assinatura WHERE TM1.ContratoId = ContratoId GROUP BY ContratoId ) T2 ON T2.ContratoId = TM1.ContratoId) LEFT JOIN Cliente T3 ON T3.ClienteId = TM1.ContratoClienteId) LEFT JOIN LATERAL (SELECT COUNT(*) AS ContratoCountAssinantes_F, T6.ContratoId, T5.ClienteId FROM (AssinaturaParticipante T5 LEFT JOIN Assinatura T6 ON T6.AssinaturaId = T5.AssinaturaId) WHERE TM1.ContratoId = T6.ContratoId and TM1.ContratoClienteId = T5.ClienteId GROUP BY T6.ContratoId, T5.ClienteId ) T4 ON T4.ContratoId = TM1.ContratoId AND T4.ClienteId = TM1.ContratoClienteId) WHERE TM1.ContratoId = :ContratoId ORDER BY TM1.ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000X30,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
