...
namespace GeneXus.Programs {
   public class wpnovapropostadocumentos : GXWebComponent
   {
      ...
      protected void S122( )
      {
         /* 'CARREGASDT' Routine */
         returnInSub = false;
         AV27Array_SdPropostaDocumento = new GXBaseCollection<SdtSdPropostaDocumento>( context, "SdPropostaDocumento", "Factory2");
         /* Using cursor H005Y2 */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255191838265", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpnovapropostadocumentos.js", "?20255191838265", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
