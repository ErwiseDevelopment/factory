   ...
   public class wwp_df_file_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_file_wc"+UrlEncode(StringUtil.RTrim(AV31WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV33WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV38WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV22SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_file_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vERRORIDS", AV41ErrorIds);
      ...
      protected void WB1R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_file_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
            }
            ...
            wb_table1_17_1R2( true) ;
         }
         else
         {
            wb_table1_17_1R2( false) ;
         }
         return  ;
      }

      protected void wb_table1_17_1R2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_file_wc")), "workwithplus.dynamicforms.wwp_df_file_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_file_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E121R2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV16HasReferenceId, context));
         AV42GXV1 = 1;
         while ( AV42GXV1 <= AV36WWPFormInstance.gxTpr_Element.Count )
         {
            AV37WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV36WWPFormInstance.gxTpr_Element.Item(AV42GXV1));
      ...
      protected void E151R2( )
      {
         ...
         returnInSub = false;
         if ( ( AV5AuxSessionId == AV22SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV41ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV33WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV38WWPFormInstanceElementId), 4, 0))+"|") )
         {
            /* Execute user subroutine: 'SAVE ELEMENT DATA TO SESSION' */
            S162 ();
            if (returnInSub) return;
      ...
      protected void S162( )
      {
         ...
         AV43GXV2 = 1;
         while ( AV43GXV2 <= AV36WWPFormInstance.gxTpr_Element.Count )
         {
            AV37WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV36WWPFormInstance.gxTpr_Element.Item(AV43GXV2));
            if ( ( AV37WWPFormInstanceElement.gxTpr_Wwpformelementid == AV33WWPFormElementId ) && ( AV37WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV38WWPFormInstanceElementId ) )
            {
      ...
      protected void S172( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV35WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV12ElementInternalName,  "true",  ""));
            AV19IsValid = false;
         }
         else
         {
            if ( AV27Validations.Count > 0 )
            {
               ...
               AV44GXV3 = 1;
               while ( AV44GXV3 <= AV21Messages.Count )
               {
                  AV20Message = ((GeneXus.Utils.SdtMessages_Message)AV21Messages.Item(AV44GXV3));
      ...
      protected void wb_table1_17_1R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_17_1R2e( true) ;
         }
         else
         {
            wb_table1_17_1R2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381332", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_file_wc.js", "?202551918381333", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         divTextblockfilereadonly_cell_Class = "col-xs-12 col-sm-3";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV14FileReadonly","fld":"vFILEREADONLY","type":"bitstr"},{"av":"AV26UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV31WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV30WWP_DF_ImageMetadata","fld":"vWWP_DF_IMAGEMETADATA","hsh":true,"type":""},{"av":"AV35WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV12ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV16HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"}]""");
         ...
         setEventMetadata("'DOREMOVEFILE'","""{"handler":"E141R2","iparms":[{"av":"AV36WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV33WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV38WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV14FileReadonly","fld":"vFILEREADONLY","type":"bitstr"},{"av":"AV26UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV31WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV15FileReadonlyAux","fld":"vFILEREADONLYAUX","type":"svchar"},{"av":"AV37WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]""");
         setEventMetadata("'DOREMOVEFILE'",""","oparms":[{"av":"AV14FileReadonly","fld":"vFILEREADONLY","type":"bitstr"},{"av":"AV26UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV15FileReadonlyAux","fld":"vFILEREADONLYAUX","type":"svchar"},{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV37WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"edtavFilereadonly_Visible","ctrl":"vFILEREADONLY","prop":"Visible"},{"av":"cellFilereadonly_cell_Class","ctrl":"FILEREADONLY_CELL","prop":"Class"},{"av":"divTextblockfilereadonly_cell_Class","ctrl":"TEXTBLOCKFILEREADONLY_CELL","prop":"Class"},{"av":"Btnremovefile_Visible","ctrl":"BTNREMOVEFILE","prop":"Visible"},{"av":"cellUcfilecell_Class","ctrl":"UCFILECELL","prop":"Class"},{"av":"AV36WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E151R2","iparms":[{"av":"AV41ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV5AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV22SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV33WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV38WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV36WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV30WWP_DF_ImageMetadata","fld":"vWWP_DF_IMAGEMETADATA","hsh":true,"type":""},{"av":"AV37WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV35WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV12ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV26UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV31WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV15FileReadonlyAux","fld":"vFILEREADONLYAUX","type":"svchar"},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV37WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV36WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E161R2","iparms":[{"av":"AV5AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV22SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV28VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV30WWP_DF_ImageMetadata","fld":"vWWP_DF_IMAGEMETADATA","hsh":true,"type":""},{"av":"AV38WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV36WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV36WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV28VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         setEventMetadata("UCFILE.UPLOADCOMPLETE","""{"handler":"E111R2","iparms":[{"av":"AV26UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV16HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV22SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV36WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV33WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV38WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV30WWP_DF_ImageMetadata","fld":"vWWP_DF_IMAGEMETADATA","hsh":true,"type":""},{"av":"AV37WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV35WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV12ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV31WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV15FileReadonlyAux","fld":"vFILEREADONLYAUX","type":"svchar"},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]""");
         setEventMetadata("UCFILE.UPLOADCOMPLETE",""","oparms":[{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV37WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV36WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV26UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV39FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         ...
         AV7Data = "";
         AV27Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory2");
         AV23ThisValueStr = "";
