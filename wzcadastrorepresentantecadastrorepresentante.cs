...
namespace GeneXus.Programs {
   public class wzcadastrorepresentantecadastrorepresentante : GXWebComponent
   {
      public wzcadastrorepresentantecadastrorepresentante( )
      {
      ...
      public wzcadastrorepresentantecadastrorepresentante( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Wz Cadastro Representante Cadastro Representante") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wzcadastrorepresentantecadastrorepresentante"+UrlEncode(StringUtil.RTrim(AV6WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wzcadastrorepresentantecadastrorepresentante") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WzCadastroRepresentanteCadastroRepresentante" ;
      }

      public override string GetPgmdesc( )
      {
         return "Wz Cadastro Representante Cadastro Representante" ;
      }
      ...
      protected void WB960( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wzcadastrorepresentantecadastrorepresentante");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavNome_Internalname, AV12Nome, StringUtil.RTrim( context.localUtil.Format( AV12Nome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,22);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavNome_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavNome_Enabled, 0, "text", "", 80, "chr", 1, "row", 120, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_WzCadastroRepresentanteCadastroRepresentante.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavCargo, cmbavCargo_Internalname, StringUtil.RTrim( AV13Cargo), 1, cmbavCargo_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavCargo.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,27);\"", "", false, 0, "HLP_WzCadastroRepresentanteCadastroRepresentante.htm");
            cmbavCargo.CurrentValue = StringUtil.RTrim( AV13Cargo);
            AssignProp(sPrefix, false, cmbavCargo_Internalname, "Values", (string)(cmbavCargo.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavEmail_Internalname, AV14Email, StringUtil.RTrim( context.localUtil.Format( AV14Email, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,32);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEmail_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavEmail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_WzCadastroRepresentanteCadastroRepresentante.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCelular_Internalname, AV15Celular, StringUtil.RTrim( context.localUtil.Format( AV15Celular, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,37);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCelular_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavCelular_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_WzCadastroRepresentanteCadastroRepresentante.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCpf_Internalname, AV16CPF, StringUtil.RTrim( context.localUtil.Format( AV16CPF, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,42);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCpf_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavCpf_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_WzCadastroRepresentanteCadastroRepresentante.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START962( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Wz Cadastro Representante Cadastro Representante", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wzcadastrorepresentantecadastrorepresentante")), "wzcadastrorepresentantecadastrorepresentante") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wzcadastrorepresentantecadastrorepresentante")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV13Cargo = cmbavCargo.getValidValue(AV13Cargo);
            AssignAttri(sPrefix, false, "AV13Cargo", AV13Cargo);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavCargo.CurrentValue = StringUtil.RTrim( AV13Cargo);
            AssignProp(sPrefix, false, cmbavCargo_Internalname, "Values", cmbavCargo.ToJavascriptSource(), true);
         }
      }
      ...
      protected void E13962( )
      {
         ...
         if ( AV22CheckRequiredFieldsResult && ! AV10HasValidationErrors )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wzcadastrorepresentante"+UrlEncode(StringUtil.RTrim("CadastroRepresentante")) + "," + UrlEncode(StringUtil.RTrim("CadastroEmpresa")) + "," + UrlEncode(StringUtil.BoolToStr(false));
      ...
      protected void S112( )
      {
         ...
         AV12Nome = AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Nome;
         AssignAttri(sPrefix, false, "AV12Nome", AV12Nome);
         AV13Cargo = AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Cargo;
         AssignAttri(sPrefix, false, "AV13Cargo", AV13Cargo);
         AV14Email = AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Email;
         AssignAttri(sPrefix, false, "AV14Email", AV14Email);
         AV15Celular = AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Celular;
         AssignAttri(sPrefix, false, "AV15Celular", AV15Celular);
         AV16CPF = AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Cpf;
         AssignAttri(sPrefix, false, "AV16CPF", AV16CPF);
      }
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         AV11WizardData.FromJSonString(AV5WebSession.Get(AV6WebSessionKey), null);
         AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Nome = AV12Nome;
         AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Cargo = AV13Cargo;
         AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Email = AV14Email;
         AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Celular = AV15Celular;
         AV11WizardData.gxTpr_Cadastrorepresentante.gxTpr_Cpf = AV16CPF;
      ...
      protected void S132( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV12Nome)) )
         {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV14Email)) )
         {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV15Celular)) )
         {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV16CPF)) )
         {
         ...
         if ( ! new prvalidaemail(context).executeUdp(  AV14Email) )
         {
            AV22CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV22CheckRequiredFieldsResult", AV22CheckRequiredFieldsResult);
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  "Email inválido. Verifique!",  "error",  edtavEmail_Internalname,  "true",  ""));
         }
         new prvalidcpf(context ).execute(  "FISICA",  new prretornadigitos(context).executeUdp(  AV16CPF), out  AV25IsCPFValid, out  AV26ErrorMessage) ;
         if ( ! AV25IsCPFValid )
         {
            AV22CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV22CheckRequiredFieldsResult", AV22CheckRequiredFieldsResult);
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  "CPF Inválido. Verifique!",  "error",  edtavCpf_Internalname,  "true",  ""));
         }
         if ( StringUtil.Len( new prretornadigitos(context).executeUdp(  AV15Celular)) < 10 )
         {
            AV22CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV22CheckRequiredFieldsResult", AV22CheckRequiredFieldsResult);
      ...
      protected void E15962( )
      {
         ...
         returnInSub = false;
         GXt_char1 = AV15Celular;
         new prformatacelular(context ).execute(  AV15Celular, out  GXt_char1) ;
         AV15Celular = GXt_char1;
         AssignAttri(sPrefix, false, "AV15Celular", AV15Celular);
         /*  Sending Event outputs  */
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wzcadastrorepresentantecadastrorepresentante", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918373587", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wzcadastrorepresentantecadastrorepresentante.js", "?202551918373587", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         cmbavCargo_Internalname = sPrefix+"vCARGO";
         edtavEmail_Internalname = sPrefix+"vEMAIL";
         edtavCelular_Internalname = sPrefix+"vCELULAR";
         edtavCpf_Internalname = sPrefix+"vCPF";
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_tableattributes_Title = "Cadastro do Representante";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV7GoingBack","fld":"vGOINGBACK","type":"boolean"},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"Btnwizardfirstprevious_Visible","ctrl":"BTNWIZARDFIRSTPREVIOUS","prop":"Visible"}]}""");
         setEventMetadata("ENTER","""{"handler":"E13962","iparms":[{"av":"AV22CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT","type":"boolean"},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV12Nome","fld":"vNOME","type":"svchar"},{"av":"AV14Email","fld":"vEMAIL","type":"svchar"},{"av":"AV15Celular","fld":"vCELULAR","type":"svchar"},{"av":"AV16CPF","fld":"vCPF","type":"svchar"},{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"cmbavCargo"},{"av":"AV13Cargo","fld":"vCARGO","type":"svchar"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV22CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT","type":"boolean"}]}""");
         setEventMetadata("'WIZARDPREVIOUS'","""{"handler":"E14962","iparms":[]}""");
         setEventMetadata("VCELULAR.CONTROLVALUECHANGED","""{"handler":"E15962","iparms":[{"av":"AV15Celular","fld":"vCELULAR","type":"svchar"}]""");
         setEventMetadata("VCELULAR.CONTROLVALUECHANGED",""","oparms":[{"av":"AV15Celular","fld":"vCELULAR","type":"svchar"}]}""");
      ...
      private string AV13Cargo ;
      private string AV14Email ;
      private string AV15Celular ;
      private string AV16CPF ;
