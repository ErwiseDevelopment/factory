...
namespace GeneXus.Programs {
   public class prcarregandosistema : GXProcedure
   {
      ...
      {
         AV8SdBanco = new GXBaseCollection<SdtSdBanco_Banco>( context, "Banco", "Factory2");
         GXt_objcol_SdtSdBanco_Banco1 = new GXBaseCollection<SdtSdBanco_Banco>( context, "Banco", "Factory2");
