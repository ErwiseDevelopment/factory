...
namespace GeneXus.Programs {
   public class wpbaixatitulo : GXDataArea
   {
      ...
      protected void S142( )
      {
         /* 'MOVIMENTOS' Routine */
         returnInSub = false;
         AV18Array_SdTituloMovimento = new GXBaseCollection<SdtSdTituloMovimento>( context, "SdTituloMovimento", "Factory2");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918553161", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpbaixatitulo.js", "?202551918553162", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
