...
namespace GeneXus.Programs {
   public class secuserlogloaddvcombo : GXProcedure
   {
      public secuserlogloaddvcombo( )
      {
      ...
      public secuserlogloaddvcombo( IGxContext context )
      {
                           ...
                           out string aP7_Combo_DataJson )
      {
         ...
         this.AV19SecUserLogId = aP3_SecUserLogId;
      ...
      public string executeUdp( string aP0_ComboName ,
                                ...
                                out string aP6_SelectedText )
      {
         execute(aP0_ComboName, aP1_TrnMode, aP2_IsDynamicCall, aP3_SecUserLogId, aP4_SearchTxtParms, out aP5_SelectedValue, out aP6_SelectedText, out aP7_Combo_DataJson);
      ...
      protected void S111( )
      {
         ...
         if ( AV18IsDynamicCall )
         {
            ...
            {
               A141SecUserName = P00AW2_A141SecUserName[0];
               n141SecUserName = P00AW2_n141SecUserName[0];
               A133SecUserId = P00AW2_A133SecUserId[0];
               n133SecUserId = P00AW2_n133SecUserId[0];
         ...
         else
         {
            if ( StringUtil.StrCmp(AV17TrnMode, "INS") != 0 )
            {
               ...
               {
                  /* Using cursor P00AW3 */
                  pr_default.execute(1, new Object[] {AV19SecUserLogId});
                  while ( (pr_default.getStatus(1) != 101) )
                  {
                     A559SecUserLogId = P00AW3_A559SecUserLogId[0];
                     A133SecUserId = P00AW3_A133SecUserId[0];
                     n133SecUserId = P00AW3_n133SecUserId[0];
                     A141SecUserName = P00AW3_A141SecUserName[0];
                     n141SecUserName = P00AW3_n141SecUserName[0];
                     A141SecUserName = P00AW3_A141SecUserName[0];
                     n141SecUserName = P00AW3_n141SecUserName[0];
               ...
               else
               {
                  ...
                  {
                     A133SecUserId = P00AW4_A133SecUserId[0];
                     n133SecUserId = P00AW4_n133SecUserId[0];
                     A141SecUserName = P00AW4_A141SecUserName[0];
                     n141SecUserName = P00AW4_n141SecUserName[0];
                     AV22SelectedText = A141SecUserName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      public override void initialize( )
      {
         ...
         lV13SearchTxt = "";
         A141SecUserName = "";
         P00AW2_A141SecUserName = new string[] {""} ;
         P00AW2_n141SecUserName = new bool[] {false} ;
         P00AW2_A133SecUserId = new short[1] ;
         P00AW2_n133SecUserId = new bool[] {false} ;
         AV15Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV14Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         P00AW3_A559SecUserLogId = new int[1] ;
         P00AW3_A133SecUserId = new short[1] ;
         P00AW3_n133SecUserId = new bool[] {false} ;
         P00AW3_A141SecUserName = new string[] {""} ;
         P00AW3_n141SecUserName = new bool[] {false} ;
         P00AW4_A133SecUserId = new short[1] ;
         P00AW4_n133SecUserId = new bool[] {false} ;
         P00AW4_A141SecUserName = new string[] {""} ;
         P00AW4_n141SecUserName = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.secuserlogloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P00AW2_A141SecUserName, P00AW2_n141SecUserName, P00AW2_A133SecUserId
               }
               , new Object[] {
               P00AW3_A559SecUserLogId, P00AW3_A133SecUserId, P00AW3_n133SecUserId, P00AW3_A141SecUserName, P00AW3_n141SecUserName
               }
               , new Object[] {
               P00AW4_A133SecUserId, P00AW4_A141SecUserName, P00AW4_n141SecUserName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00AW2_A141SecUserName ;
      private bool[] P00AW2_n141SecUserName ;
      private short[] P00AW2_A133SecUserId ;
      private bool[] P00AW2_n133SecUserId ;
      ...
      private int[] P00AW3_A559SecUserLogId ;
      private short[] P00AW3_A133SecUserId ;
      private bool[] P00AW3_n133SecUserId ;
      private string[] P00AW3_A141SecUserName ;
      private bool[] P00AW3_n141SecUserName ;
      private short[] P00AW4_A133SecUserId ;
      private bool[] P00AW4_n133SecUserId ;
      private string[] P00AW4_A141SecUserName ;
      private bool[] P00AW4_n141SecUserName ;
      private string aP5_SelectedValue ;
      private string aP6_SelectedText ;
      private string aP7_Combo_DataJson ;
   }

   public class secuserlogloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00AW2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV19SecUserLogId",GXType.Int32,9,0)
          };
          Object[] prmP00AW4;
          ...
          def= new CursorDef[] {
              new CursorDef("P00AW2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AW2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00AW3", "SELECT T1.SecUserLogId, T1.SecUserId, T2.SecUserName FROM (SecUserLog T1 LEFT JOIN SecUser T2 ON T2.SecUserId = T1.SecUserId) WHERE T1.SecUserLogId = :AV19SecUserLogId ORDER BY T1.SecUserLogId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AW3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00AW4", "SELECT SecUserId, SecUserName FROM SecUser WHERE SecUserId = :AV27SecUserId ORDER BY SecUserId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AW4,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
