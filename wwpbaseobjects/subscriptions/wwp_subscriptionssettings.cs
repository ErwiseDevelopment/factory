...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_subscriptionssettings : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV38Pgmname, AV16NotifShowOnlySubscribedEvents, AV7FilterFullText, A21WWPEntityName, A20WWPEntityId, A31WWPNotificationDefinitionAllowUserSubscription, A7WWPUserExtendedId, AV41Udparg2, A27WWPSubscriptionSubscribed, A19WWPSubscriptionRoleId, A23WWPNotificationDefinitionId, AV15Mail, AV21Sms, AV5Desktop, AV18SD) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.subscriptions.wwp_subscriptionssettings") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION", A31WWPNotificationDefinitionAllowUserSubscription);
      ...
      {
         return formatLink("wwpbaseobjects.subscriptions.wwp_subscriptionssettings")  ;
      }
      ...
      protected void E180R2( )
      {
         ...
         {
            A7WWPUserExtendedId = H000R2_A7WWPUserExtendedId[0];
            n7WWPUserExtendedId = H000R2_n7WWPUserExtendedId[0];
            A12WWPUserExtendedSMSNotif = H000R2_A12WWPUserExtendedSMSNotif[0];
            A11WWPUserExtendedEmaiNotif = H000R2_A11WWPUserExtendedEmaiNotif[0];
            A14WWPUserExtendedDesktopNotif = H000R2_A14WWPUserExtendedDesktopNotif[0];
            A13WWPUserExtendedMobileNotif = H000R2_A13WWPUserExtendedMobileNotif[0];
      ...
      private void E200R2( )
      {
         ...
         {
            A20WWPEntityId = H000R3_A20WWPEntityId[0];
            A21WWPEntityName = H000R3_A21WWPEntityName[0];
            ...
            else
            {
               ...
               pr_default.dynParam(2, new Object[]{ new Object[]{
                                                    ...
                                                    A20WWPEntityId ,
                                                    A31WWPNotificationDefinitionAllowUserSubscription ,
                                                    A7WWPUserExtendedId ,
                                                    AV41Udparg2 ,
               ...
               {
                  A19WWPSubscriptionRoleId = H000R4_A19WWPSubscriptionRoleId[0];
                  n19WWPSubscriptionRoleId = H000R4_n19WWPSubscriptionRoleId[0];
                  A27WWPSubscriptionSubscribed = H000R4_A27WWPSubscriptionSubscribed[0];
                  A7WWPUserExtendedId = H000R4_A7WWPUserExtendedId[0];
                  n7WWPUserExtendedId = H000R4_n7WWPUserExtendedId[0];
                  A31WWPNotificationDefinitionAllowUserSubscription = H000R4_A31WWPNotificationDefinitionAllowUserSubscription[0];
                  A23WWPNotificationDefinitionId = H000R4_A23WWPNotificationDefinitionId[0];
                  A31WWPNotificationDefinitionAllowUserSubscription = H000R4_A31WWPNotificationDefinitionAllowUserSubscription[0];
                  AV30EntityHasItemsToShow = true;
      ...
      protected void S122( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "FILTERFULLTEXT",  "Filtro principal",  !String.IsNullOrEmpty(StringUtil.RTrim( AV7FilterFullText)),  0,  AV7FilterFullText,  AV7FilterFullText,  false,  "",  "") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918525591", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/subscriptions/wwp_subscriptionssettings.js", "?202551918525592", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV38Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV16NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"AV7FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV41Udparg2","fld":"vUDPARG2","hsh":true,"type":"char"},{"av":"AV15Mail","fld":"vMAIL","type":"boolean"},{"av":"AV21Sms","fld":"vSMS","type":"boolean"},{"av":"AV5Desktop","fld":"vDESKTOP","type":"boolean"},{"av":"AV18SD","fld":"vSD","type":"boolean"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV8GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV35GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS","type":"svchar"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E110R2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV38Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV16NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"AV7FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"AV41Udparg2","fld":"vUDPARG2","hsh":true,"type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV15Mail","fld":"vMAIL","type":"boolean"},{"av":"AV21Sms","fld":"vSMS","type":"boolean"},{"av":"AV5Desktop","fld":"vDESKTOP","type":"boolean"},{"av":"AV18SD","fld":"vSD","type":"boolean"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E120R2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV38Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV16NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"AV7FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"AV41Udparg2","fld":"vUDPARG2","hsh":true,"type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV15Mail","fld":"vMAIL","type":"boolean"},{"av":"AV21Sms","fld":"vSMS","type":"boolean"},{"av":"AV5Desktop","fld":"vDESKTOP","type":"boolean"},{"av":"AV18SD","fld":"vSD","type":"boolean"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E200R2","iparms":[{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV16NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"A31WWPNotificationDefinitionAllowUserSubscription","fld":"WWPNOTIFICATIONDEFINITIONALLOWUSERSUBSCRIPTION","type":"boolean"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"AV41Udparg2","fld":"vUDPARG2","hsh":true,"type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV6DetailWebComponent","fld":"vDETAILWEBCOMPONENT","type":"char"},{"av":"AV29WWPEntityName","fld":"vWWPENTITYNAME","type":"svchar"},{"av":"AV28WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV9GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("VDETAILWEBCOMPONENT.CLICK","""{"handler":"E210R2","iparms":[{"av":"AV28WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV16NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"}]""");
         setEventMetadata("VDETAILWEBCOMPONENT.CLICK",""","oparms":[{"ctrl":"GRID_DWC"}]}""");
         setEventMetadata("VMAIL.CLICK","""{"handler":"E130R2","iparms":[{"av":"AV15Mail","fld":"vMAIL","type":"boolean"}]}""");
         setEventMetadata("VSMS.CLICK","""{"handler":"E140R2","iparms":[{"av":"AV21Sms","fld":"vSMS","type":"boolean"}]}""");
         setEventMetadata("VSD.CLICK","""{"handler":"E150R2","iparms":[{"av":"AV18SD","fld":"vSD","type":"boolean"}]}""");
         setEventMetadata("VDESKTOP.CLICK","""{"handler":"E160R2","iparms":[{"av":"AV5Desktop","fld":"vDESKTOP","type":"boolean"}]}""");
         setEventMetadata("VNOTIFSHOWONLYSUBSCRIBEDEVENTS.CLICK","""{"handler":"E170R2","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         AV37Udparg1 = "";
         H000R2_A7WWPUserExtendedId = new string[] {""} ;
         H000R2_n7WWPUserExtendedId = new bool[] {false} ;
         H000R2_A12WWPUserExtendedSMSNotif = new bool[] {false} ;
         H000R2_A11WWPUserExtendedEmaiNotif = new bool[] {false} ;
         H000R2_A14WWPUserExtendedDesktopNotif = new bool[] {false} ;
         H000R2_A13WWPUserExtendedMobileNotif = new bool[] {false} ;
         ...
         H000R3_A20WWPEntityId = new long[1] ;
         H000R3_A21WWPEntityName = new string[] {""} ;
         H000R4_A25WWPSubscriptionId = new long[1] ;
         H000R4_A20WWPEntityId = new long[1] ;
         H000R4_A19WWPSubscriptionRoleId = new string[] {""} ;
         H000R4_n19WWPSubscriptionRoleId = new bool[] {false} ;
         H000R4_A27WWPSubscriptionSubscribed = new bool[] {false} ;
         H000R4_A7WWPUserExtendedId = new string[] {""} ;
         H000R4_n7WWPUserExtendedId = new bool[] {false} ;
         H000R4_A31WWPNotificationDefinitionAllowUserSubscription = new bool[] {false} ;
         H000R4_A23WWPNotificationDefinitionId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscriptionssettings__default(),
            new Object[][] {
                new Object[] {
               H000R2_A7WWPUserExtendedId, H000R2_A12WWPUserExtendedSMSNotif, H000R2_A11WWPUserExtendedEmaiNotif, H000R2_A14WWPUserExtendedDesktopNotif, H000R2_A13WWPUserExtendedMobileNotif
               }
               , new Object[] {
               H000R3_A20WWPEntityId, H000R3_A21WWPEntityName
               }
               , new Object[] {
               H000R4_A25WWPSubscriptionId, H000R4_A20WWPEntityId, H000R4_A19WWPSubscriptionRoleId, H000R4_n19WWPSubscriptionRoleId, H000R4_A27WWPSubscriptionSubscribed, H000R4_A7WWPUserExtendedId, H000R4_n7WWPUserExtendedId, H000R4_A31WWPNotificationDefinitionAllowUserSubscription, H000R4_A23WWPNotificationDefinitionId
               }
            }
         );
      ...
      private string[] H000R2_A7WWPUserExtendedId ;
      private bool[] H000R2_n7WWPUserExtendedId ;
      private bool[] H000R2_A12WWPUserExtendedSMSNotif ;
      private bool[] H000R2_A11WWPUserExtendedEmaiNotif ;
      private bool[] H000R2_A14WWPUserExtendedDesktopNotif ;
      private bool[] H000R2_A13WWPUserExtendedMobileNotif ;
      ...
      private long[] H000R3_A20WWPEntityId ;
      private string[] H000R3_A21WWPEntityName ;
      private long[] H000R4_A25WWPSubscriptionId ;
      private long[] H000R4_A20WWPEntityId ;
      private string[] H000R4_A19WWPSubscriptionRoleId ;
      private bool[] H000R4_n19WWPSubscriptionRoleId ;
      private bool[] H000R4_A27WWPSubscriptionSubscribed ;
      private string[] H000R4_A7WWPUserExtendedId ;
      private bool[] H000R4_n7WWPUserExtendedId ;
      private bool[] H000R4_A31WWPNotificationDefinitionAllowUserSubscription ;
      private long[] H000R4_A23WWPNotificationDefinitionId ;
   ...
   {
      protected Object[] conditional_H000R4( IGxContext context ,
                                             string A19WWPSubscriptionRoleId ,
                                             ...
                                             bool A27WWPSubscriptionSubscribed )
      {
         ...
         AddWhere(sWhereString, "(T2.WWPNotificationDefinitionAllowUserSubscription)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 2 :
                     return conditional_H000R4(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (long)dynConstraints[2] , (bool)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (bool)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000R2", "SELECT WWPUserExtendedId, WWPUserExtendedSMSNotif, WWPUserExtendedEmaiNotif, WWPUserExtendedDesktopNotif, WWPUserExtendedMobileNotif FROM WWP_UserExtended WHERE WWPUserExtendedId = ( :AV37Udparg1) ORDER BY WWPUserExtendedId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000R3", "SELECT WWPEntityId, WWPEntityName FROM WWP_Entity ORDER BY WWPEntityId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000R4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R4,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
