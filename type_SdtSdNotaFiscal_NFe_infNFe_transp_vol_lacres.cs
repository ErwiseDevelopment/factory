...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SdNotaFiscal.NFe.infNFe.transp.vol.lacres" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"SdNotaFiscal.NFe.infNFe.transp.vol.lacres", Namespace="Factory2")]
