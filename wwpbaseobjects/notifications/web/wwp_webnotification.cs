   ...
   public class wwp_webnotification : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_6") == 0 )
         {
            ...
            AssignAttri("", false, "A22WWPNotificationId", ((0==A22WWPNotificationId)&&IsIns( )||n22WWPNotificationId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A22WWPNotificationId), 10, 0, ".", ""))));
            setAjaxCallMode();
            if ( ! IsValidAjaxCall( true) )
            {
               GxWebError = 1;
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPNotificationId_Internalname, ((0==A22WWPNotificationId)&&IsIns( )||n22WWPNotificationId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A22WWPNotificationId), 10, 0, ",", ""))), ((0==A22WWPNotificationId)&&IsIns( )||n22WWPNotificationId ? "" : StringUtil.LTrim( ((edtWWPNotificationId_Enabled!=0) ? context.localUtil.Format( (decimal)(A22WWPNotificationId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A22WWPNotificationId), "ZZZZZZZZZ9")))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPNotificationId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPNotificationId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_Id", "end", false, "", "HLP_WWPBaseObjects/Notifications/Web/WWP_WebNotification.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            n22WWPNotificationId = ((StringUtil.StrCmp(cgiGet( edtWWPNotificationId_Internalname), "")==0) ? true : false);
            if ( ( ( context.localUtil.CToN( cgiGet( edtWWPNotificationId_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtWWPNotificationId_Internalname), ",", ".") > Convert.ToDecimal( 9999999999L )) ) )
            {
               ...
               n22WWPNotificationId = false;
               AssignAttri("", false, "A22WWPNotificationId", (n22WWPNotificationId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A22WWPNotificationId), 10, 0, ".", ""))));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebNotificationCreated_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A45WWPWebNotificationCreated", context.localUtil.TToC( A45WWPWebNotificationCreated, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebNotificationScheduled_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A58WWPWebNotificationScheduled", context.localUtil.TToC( A58WWPWebNotificationScheduled, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebNotificationProcessed_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A55WWPWebNotificationProcessed", context.localUtil.TToC( A55WWPWebNotificationProcessed, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebNotificationRead_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A46WWPWebNotificationRead", context.localUtil.TToC( A46WWPWebNotificationRead, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
      ...
      protected void gxLoad_6( long A22WWPNotificationId )
      {
         ...
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A23WWPNotificationDefinitionId), 10, 0, ".", "")))+"\""+","+"\""+GXUtil.EncodeJSConstant( context.localUtil.TToC( A24WWPNotificationCreated, 10, 12, 0, 3, "/", ":", " "))+"\""+","+"\""+GXUtil.EncodeJSConstant( A60WWPNotificationMetadata)+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(5) == 101) )
         {
            AddString( ",") ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.notifications.web.wwp_webnotification") +"\">") ;
      ...
      {
         return formatLink("wwpbaseobjects.notifications.web.wwp_webnotification")  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019123125", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/notifications/web/wwp_webnotification.js", "?202561019123126", false, true);
      ...
      public void Valid_Wwpwebnotificationid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z54WWPWebNotificationStatus", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z54WWPWebNotificationStatus), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z45WWPWebNotificationCreated", context.localUtil.TToC( Z45WWPWebNotificationCreated, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z58WWPWebNotificationScheduled", context.localUtil.TToC( Z58WWPWebNotificationScheduled, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z55WWPWebNotificationProcessed", context.localUtil.TToC( Z55WWPWebNotificationProcessed, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z46WWPWebNotificationRead", context.localUtil.TToC( Z46WWPWebNotificationRead, 10, 12, 0, 3, "/", ":", " "));
      ...
      {
         setEventMetadata("ENTER","""{"handler":"UserMainFullajax","iparms":[{"postForm":true},{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]}""");
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPWEBNOTIFICATIONID","""{"handler":"Valid_Wwpwebnotificationid","iparms":[{"av":"A47WWPWebNotificationId","fld":"WWPWEBNOTIFICATIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9","type":"int"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"cmbWWPWebNotificationStatus"},{"av":"A54WWPWebNotificationStatus","fld":"WWPWEBNOTIFICATIONSTATUS","pic":"ZZZ9","type":"int"},{"av":"A45WWPWebNotificationCreated","fld":"WWPWEBNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A58WWPWebNotificationScheduled","fld":"WWPWEBNOTIFICATIONSCHEDULED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]""");
         setEventMetadata("VALID_WWPWEBNOTIFICATIONID",""","oparms":[{"av":"A42WWPWebNotificationTitle","fld":"WWPWEBNOTIFICATIONTITLE","type":"svchar"},{"av":"A22WWPNotificationId","fld":"WWPNOTIFICATIONID","pic":"ZZZZZZZZZ9","nullAv":"n22WWPNotificationId","type":"int"},{"av":"A43WWPWebNotificationText","fld":"WWPWEBNOTIFICATIONTEXT","type":"svchar"},{"av":"A44WWPWebNotificationIcon","fld":"WWPWEBNOTIFICATIONICON","type":"svchar"},{"av":"A53WWPWebNotificationClientId","fld":"WWPWEBNOTIFICATIONCLIENTID","type":"vchar"},{"av":"cmbWWPWebNotificationStatus"},{"av":"A54WWPWebNotificationStatus","fld":"WWPWEBNOTIFICATIONSTATUS","pic":"ZZZ9","type":"int"},{"av":"A45WWPWebNotificationCreated","fld":"WWPWEBNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A58WWPWebNotificationScheduled","fld":"WWPWEBNOTIFICATIONSCHEDULED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A55WWPWebNotificationProcessed","fld":"WWPWEBNOTIFICATIONPROCESSED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A46WWPWebNotificationRead","fld":"WWPWEBNOTIFICATIONREAD","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A56WWPWebNotificationDetail","fld":"WWPWEBNOTIFICATIONDETAIL","type":"vchar"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A24WWPNotificationCreated","fld":"WWPNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A60WWPNotificationMetadata","fld":"WWPNOTIFICATIONMETADATA","type":"vchar"},{"av":"A59WWPNotificationDefinitionName","fld":"WWPNOTIFICATIONDEFINITIONNAME","type":"svchar"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"Z47WWPWebNotificationId","type":"int"},{"av":"Z42WWPWebNotificationTitle","type":"svchar"},{"av":"Z22WWPNotificationId","type":"int"},{"av":"Z43WWPWebNotificationText","type":"svchar"},{"av":"Z44WWPWebNotificationIcon","type":"svchar"},{"av":"Z53WWPWebNotificationClientId","type":"vchar"},{"av":"Z54WWPWebNotificationStatus","type":"int"},{"av":"Z45WWPWebNotificationCreated","type":"dtime"},{"av":"Z58WWPWebNotificationScheduled","type":"dtime"},{"av":"Z55WWPWebNotificationProcessed","type":"dtime"},{"av":"Z46WWPWebNotificationRead","type":"dtime"},{"av":"Z56WWPWebNotificationDetail","type":"vchar"},{"av":"Z57WWPWebNotificationReceived","type":"boolean"},{"av":"Z23WWPNotificationDefinitionId","type":"int"},{"av":"Z24WWPNotificationCreated","type":"dtime"},{"av":"Z60WWPNotificationMetadata","type":"vchar"},{"av":"Z59WWPNotificationDefinitionName","type":"svchar"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"},{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPNOTIFICATIONID","""{"handler":"Valid_Wwpnotificationid","iparms":[{"av":"A22WWPNotificationId","fld":"WWPNOTIFICATIONID","pic":"ZZZZZZZZZ9","nullAv":"n22WWPNotificationId","type":"int"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A24WWPNotificationCreated","fld":"WWPNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A60WWPNotificationMetadata","fld":"WWPNOTIFICATIONMETADATA","type":"vchar"},{"av":"A59WWPNotificationDefinitionName","fld":"WWPNOTIFICATIONDEFINITIONNAME","type":"svchar"},{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]""");
         ...
         setEventMetadata("VALID_WWPWEBNOTIFICATIONSTATUS","""{"handler":"Valid_Wwpwebnotificationstatus","iparms":[{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]""");
         setEventMetadata("VALID_WWPWEBNOTIFICATIONSTATUS",""","oparms":[{"av":"A57WWPWebNotificationReceived","fld":"WWPWEBNOTIFICATIONRECEIVED","type":"boolean"}]}""");
         return  ;
      }
