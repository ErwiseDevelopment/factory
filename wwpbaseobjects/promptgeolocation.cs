...
namespace GeneXus.Programs.wwpbaseobjects {
   public class promptgeolocation : GXHttpHandler
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"FormNoBackgroundColor\" data-gx-class=\"FormNoBackgroundColor\" novalidate action=\""+formatLink("wwpbaseobjects.promptgeolocation", new object[] {UrlEncode(StringUtil.RTrim(AV7Geolocation))}, new string[] {"Geolocation"}) +"\">") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019223862", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/promptgeolocation.js", "?202561019223863", false, true);
         context.AddJavascriptSource("GXGoogleVisualizationLibrary/MAP/mapsproviders.js", "", false, true);
         context.AddJavascriptSource("https://unpkg.com/@googlemaps/markerclusterer/dist/index.min.js", "", false, true);
         context.AddJavascriptSource("GXGoogleVisualizationLibrary/MAP/Gxmap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E120G2","iparms":[{"av":"AV10Latitude","fld":"vLATITUDE","type":"svchar"},{"av":"AV7Geolocation","fld":"vGEOLOCATION","type":"svchar"},{"av":"AV11Longitude","fld":"vLONGITUDE","type":"svchar"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV7Geolocation","fld":"vGEOLOCATION","type":"svchar"}]}""");
         return  ;
      }
