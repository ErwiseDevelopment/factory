...
namespace GeneXus.Programs {
   public class wpnovapropostaconta : GXWebComponent
   {
      public wpnovapropostaconta( )
      {
      ...
      public wpnovapropostaconta( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Wp Nova Proposta Conta") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpnovapropostaconta"+UrlEncode(StringUtil.RTrim(AV6WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpnovapropostaconta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WpNovaPropostaConta" ;
      }

      public override string GetPgmdesc( )
      {
         return "Wp Nova Proposta Conta" ;
      }
      ...
      protected void WB5R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpnovapropostaconta");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavClientedepositotipo, cmbavClientedepositotipo_Internalname, StringUtil.RTrim( AV21ClienteDepositoTipo), 1, cmbavClientedepositotipo_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavClientedepositotipo.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,22);\"", "", false, 0, "HLP_WpNovaPropostaConta.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_bancoid_Internalname, "Banco", "", "", lblTextblockcombo_bancoid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WpNovaPropostaConta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavContaagencia_Internalname, AV13ContaAgencia, StringUtil.RTrim( context.localUtil.Format( AV13ContaAgencia, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,38);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContaagencia_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContaagencia_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_WpNovaPropostaConta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavClientepixtipo, cmbavClientepixtipo_Internalname, StringUtil.RTrim( AV22ClientePixTipo), 1, cmbavClientepixtipo_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavClientepixtipo.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,51);\"", "", false, 0, "HLP_WpNovaPropostaConta.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClientepix_Internalname, AV23ClientePix, StringUtil.RTrim( context.localUtil.Format( AV23ClientePix, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,56);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClientepix_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClientepix_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_WpNovaPropostaConta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START5R2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Wp Nova Proposta Conta", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpnovapropostaconta")), "wpnovapropostaconta") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpnovapropostaconta")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E125R2( )
      {
         ...
         {
            context.CommitDataStores("wpnovapropostaconta",pr_default);
            ...
            if ( AV20CheckRequiredFieldsResult && ! AV10HasValidationErrors )
            {
               ...
               GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
               GXEncryptionTmp = "wpnovaproposta"+UrlEncode(StringUtil.RTrim("Conta")) + "," + UrlEncode(StringUtil.RTrim("Proposta")) + "," + UrlEncode(StringUtil.BoolToStr(false));
      ...
      protected void E135R2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpnovaproposta"+UrlEncode(StringUtil.RTrim("Conta")) + "," + UrlEncode(StringUtil.RTrim("Responsavel")) + "," + UrlEncode(StringUtil.BoolToStr(true));
         CallWebObject(formatLink("wpnovaproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV11WizardData", AV11WizardData);
      ...
      protected void S122( )
      {
         ...
         {
            A402BancoId = H005R2_A402BancoId[0];
            A404BancoCodigo = H005R2_A404BancoCodigo[0];
            n404BancoCodigo = H005R2_n404BancoCodigo[0];
            A403BancoNome = H005R2_A403BancoNome[0];
            n403BancoNome = H005R2_n403BancoNome[0];
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpnovapropostaconta", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019132497", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpnovapropostaconta.js", "?202561019132498", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_tableattributes_Title = "Conta";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'WIZARDPREVIOUS'","""{"handler":"E135R2","iparms":[{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"cmbavClientedepositotipo"},{"av":"AV21ClienteDepositoTipo","fld":"vCLIENTEDEPOSITOTIPO","type":"svchar"},{"av":"cmbavClientepixtipo"},{"av":"AV22ClientePixTipo","fld":"vCLIENTEPIXTIPO","type":"svchar"},{"av":"AV23ClientePix","fld":"vCLIENTEPIX","type":"svchar"},{"av":"AV12BancoId","fld":"vBANCOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV13ContaAgencia","fld":"vCONTAAGENCIA","type":"svchar"},{"av":"AV14ContaNumero","fld":"vCONTANUMERO","type":"svchar"}]""");
      ...
      public override void initialize( )
      {
         ...
         H005R2_A402BancoId = new int[1] ;
         H005R2_A404BancoCodigo = new int[1] ;
         H005R2_n404BancoCodigo = new bool[] {false} ;
         H005R2_A403BancoNome = new string[] {""} ;
         H005R2_n403BancoNome = new bool[] {false} ;
         A403BancoNome = "";
         AV18Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         sCtrlAV7GoingBack = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpnovapropostaconta__default(),
            new Object[][] {
                new Object[] {
               H005R2_A402BancoId, H005R2_A404BancoCodigo, H005R2_n404BancoCodigo, H005R2_A403BancoNome, H005R2_n403BancoNome
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] H005R2_A402BancoId ;
      private int[] H005R2_A404BancoCodigo ;
      private bool[] H005R2_n404BancoCodigo ;
      private string[] H005R2_A403BancoNome ;
      private bool[] H005R2_n403BancoNome ;
   ...
   public class wpnovapropostaconta__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005R2", "SELECT BancoId, BancoCodigo, BancoNome FROM Banco ORDER BY BancoNome ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005R2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
