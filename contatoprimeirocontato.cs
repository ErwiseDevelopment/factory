...
namespace GeneXus.Programs {
   public class contatoprimeirocontato : GXWebComponent
   {
      public contatoprimeirocontato( )
      {
      ...
      public contatoprimeirocontato( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Contato Primeiro Contato") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "contatoprimeirocontato"+UrlEncode(StringUtil.RTrim(AV6WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("contatoprimeirocontato") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "ContatoPrimeiroContato" ;
      }

      public override string GetPgmdesc( )
      {
         return "Contato Primeiro Contato" ;
      }
      ...
      protected void WB8L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "contatoprimeirocontato");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            }
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablemain_Internalname, 1, 0, "px", 0, "px", "tablemain-wizard", "start", "top", " "+"data-gx-flex"+" ", "justify-content:center;align-items:center;align-content:center;", "div");
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "DataContentCellFL", "start", "top", "", "flex-grow:1;align-self:center;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "start", "top", ""+" data-gx-for=\""+radavClientetipo_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, "", "Pessoa", "gx-form-item AttributeFLLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            GxWebStd.gx_radio_ctrl( context, radavClientetipo, radavClientetipo_Internalname, StringUtil.BoolToStr( AV12ClienteTipo), "", 1, 1, 1, 1, StyleString, ClassString, "", "", 0, radavClientetipo_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", TempTags+" onclick="+"\""+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,12);\"", "HLP_ContatoPrimeiroContato.htm");
      ...
      protected void START8L2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Contato Primeiro Contato", 0) ;
            context.wjLoc = "";
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "LSCR") == 0 )
                           {
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    GX_FocusControl = radavClientetipo_Internalname;
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "contatoprimeirocontato")), "contatoprimeirocontato") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "contatoprimeirocontato")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      {
         AV12ClienteTipo = StringUtil.StrToBool( StringUtil.BoolToStr( AV12ClienteTipo));
         AssignAttri(sPrefix, false, "AV12ClienteTipo", AV12ClienteTipo);
      }
      ...
      protected void E138L2( )
      {
         ...
         if ( ! AV10HasValidationErrors )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "contato"+UrlEncode(StringUtil.RTrim("PrimeiroContato")) + "," + UrlEncode(StringUtil.RTrim("CNPJ")) + "," + UrlEncode(StringUtil.BoolToStr(false));
      ...
      protected void S112( )
      {
         ...
         AV12ClienteTipo = AV11WizardData.gxTpr_Primeirocontato.gxTpr_Clientetipo;
         AssignAttri(sPrefix, false, "AV12ClienteTipo", AV12ClienteTipo);
      }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV11WizardData.FromJSonString(AV5WebSession.Get(AV6WebSessionKey), null);
         AV11WizardData.gxTpr_Primeirocontato.gxTpr_Clientetipo = AV12ClienteTipo;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "contatoprimeirocontato", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918374641", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("contatoprimeirocontato.js", "?202551918374642", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      {
         radavClientetipo.Name = "vCLIENTETIPO";
         radavClientetipo.WebTags = "";
         radavClientetipo.addItem(StringUtil.BoolToStr( true), "Fisíca", 0);
         radavClientetipo.addItem(StringUtil.BoolToStr( false), "Jurídica", 0);
         /* End function init_web_controls */
      }

      protected void init_default_properties( )
      {
         radavClientetipo_Internalname = sPrefix+"vCLIENTETIPO";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV7GoingBack","fld":"vGOINGBACK","type":"boolean"},{"av":"radavClientetipo"},{"av":"AV12ClienteTipo","fld":"vCLIENTETIPO","type":"boolean"},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"Btnwizardfirstprevious_Visible","ctrl":"BTNWIZARDFIRSTPREVIOUS","prop":"Visible"}]}""");
         setEventMetadata("ENTER","""{"handler":"E138L2","iparms":[{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"radavClientetipo"},{"av":"AV12ClienteTipo","fld":"vCLIENTETIPO","type":"boolean"}]}""");
         setEventMetadata("'WIZARDPREVIOUS'","""{"handler":"E148L2","iparms":[]}""");
         return  ;
      }
      ...
      private string radavClientetipo_Internalname ;
      private string ClassString ;
      private string StyleString ;
      private string TempTags ;
      private string radavClientetipo_Jsonclick ;
      ...
      private GXRadio radavClientetipo ;
