...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="GxMap.Point" , Namespace="Factory21" )]
	[Serializable]
	...
	[DataContract(Name=@"GxMap.Point", Namespace="Factory21")]
	public class SdtGxMap_Point_RESTInterface : GxGenericCollectionItem<SdtGxMap_Point>, System.Web.SessionState.IRequiresSessionState
	{
		...
		[JsonPropertyName("PointDraggable")]
		[JsonPropertyOrder(3)]
		...
		[JsonPropertyName("PointClickeable")]
		[JsonPropertyOrder(5)]
		[JsonConverter(typeof(BoolStringJsonConverter))]
		...
		[JsonPropertyName("PointDeletable")]
		[JsonPropertyOrder(6)]
		[JsonConverter(typeof(BoolStringJsonConverter))]
		...
		[JsonPropertyName("PointInfowinHtml")]
		[JsonPropertyOrder(8)]
		...
		[JsonPropertyName("PointStreetNumber")]
		...
		[JsonPropertyName("PointCrossStreet")]
		...
		[JsonPropertyName("PointInfowinTit")]
		...
		[JsonPropertyName("PointInfowinDesc")]
		...
		[JsonPropertyName("PointInfowinLink")]
		...
		[JsonPropertyName("PointInfowinLinkDsc")]
		...
		[JsonPropertyName("PointInfowinImg")]
