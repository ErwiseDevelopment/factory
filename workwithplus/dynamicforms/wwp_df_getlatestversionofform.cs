...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_getlatestversionofform : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A40000GXC1 = P00363_A40000GXC1[0];
            n40000GXC1 = P00363_n40000GXC1[0];
         }
         else
         {
            A40000GXC1 = 0;
      ...
      {
         P00363_A40000GXC1 = new short[1] ;
         P00363_n40000GXC1 = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_getlatestversionofform__default(),
            new Object[][] {
                new Object[] {
               P00363_A40000GXC1, P00363_n40000GXC1
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] P00363_A40000GXC1 ;
      private bool[] P00363_n40000GXC1 ;
   ...
   public class wwp_df_getlatestversionofform__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00363", "SELECT COALESCE( T1.GXC1, 0) AS GXC1 FROM (SELECT MAX(WWPFormVersionNumber) AS GXC1 FROM WWP_Form WHERE WWPFormId = :AV9WWPFormId ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00363,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
