...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   public class wwp_notification : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 form__cell", "start", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtWWPNotificationShortDescription_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtWWPNotificationShortDescription_Internalname, A78WWPNotificationShortDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,64);\"", 0, 1, edtWWPNotificationShortDescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_WWPBaseObjects/Notifications/Common/WWP_Notification.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPUserExtendedId_Internalname, StringUtil.RTrim( A7WWPUserExtendedId), StringUtil.RTrim( context.localUtil.Format( A7WWPUserExtendedId, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,79);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPUserExtendedId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPUserExtendedId_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPBaseObjects/Notifications/Common/WWP_Notification.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Z78WWPNotificationShortDescription = cgiGet( "Z78WWPNotificationShortDescription");
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPNotificationCreated_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A24WWPNotificationCreated", context.localUtil.TToC( A24WWPNotificationCreated, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            A78WWPNotificationShortDescription = cgiGet( edtWWPNotificationShortDescription_Internalname);
            AssignAttri("", false, "A78WWPNotificationShortDescription", A78WWPNotificationShortDescription);
      ...
      protected void ZM099( short GX_JID )
      {
         if ( ( GX_JID == 4 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z78WWPNotificationShortDescription = T00093_A78WWPNotificationShortDescription[0];
            ...
            else
            {
               ...
               Z78WWPNotificationShortDescription = A78WWPNotificationShortDescription;
      ...
      protected void Load099( )
      {
         ...
         if ( (pr_default.getStatus(4) != 101) )
         {
            ...
            AssignAttri("", false, "A77WWPNotificationTitle", A77WWPNotificationTitle);
            A78WWPNotificationShortDescription = T00096_A78WWPNotificationShortDescription[0];
            AssignAttri("", false, "A78WWPNotificationShortDescription", A78WWPNotificationShortDescription);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A77WWPNotificationTitle", A77WWPNotificationTitle);
            A78WWPNotificationShortDescription = T00093_A78WWPNotificationShortDescription[0];
            AssignAttri("", false, "A78WWPNotificationShortDescription", A78WWPNotificationShortDescription);
      ...
      protected void CheckOptimisticConcurrency099( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( Z24WWPNotificationCreated != T00092_A24WWPNotificationCreated[0] ) || ( StringUtil.StrCmp(Z76WWPNotificationIcon, T00092_A76WWPNotificationIcon[0]) != 0 ) || ( StringUtil.StrCmp(Z77WWPNotificationTitle, T00092_A77WWPNotificationTitle[0]) != 0 ) || ( StringUtil.StrCmp(Z78WWPNotificationShortDescription, T00092_A78WWPNotificationShortDescription[0]) != 0 ) || ( StringUtil.StrCmp(Z79WWPNotificationLink, T00092_A79WWPNotificationLink[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z82WWPNotificationIsRead != T00092_A82WWPNotificationIsRead[0] ) || ( Z23WWPNotificationDefinitionId != T00092_A23WWPNotificationDefinitionId[0] ) || ( StringUtil.StrCmp(Z7WWPUserExtendedId, T00092_A7WWPUserExtendedId[0]) != 0 ) )
            {
               ...
               if ( StringUtil.StrCmp(Z78WWPNotificationShortDescription, T00092_A78WWPNotificationShortDescription[0]) != 0 )
               {
                  ...
                  GXUtil.WriteLogRaw("Old: ",Z78WWPNotificationShortDescription);
                  GXUtil.WriteLogRaw("Current: ",T00092_A78WWPNotificationShortDescription[0]);
               }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.notifications.common.wwp_notification") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z78WWPNotificationShortDescription", Z78WWPNotificationShortDescription);
      ...
      {
         return formatLink("wwpbaseobjects.notifications.common.wwp_notification")  ;
      }
      ...
      protected void InitializeNonKey099( )
      {
         ...
         AssignAttri("", false, "A77WWPNotificationTitle", A77WWPNotificationTitle);
         A78WWPNotificationShortDescription = "";
         AssignAttri("", false, "A78WWPNotificationShortDescription", A78WWPNotificationShortDescription);
         ...
         Z78WWPNotificationShortDescription = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019124077", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/notifications/common/wwp_notification.js", "?202561019124078", false, true);
      ...
      public void Valid_Wwpnotificationid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z22WWPNotificationId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z22WWPNotificationId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z23WWPNotificationDefinitionId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z23WWPNotificationDefinitionId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z24WWPNotificationCreated", context.localUtil.TToC( Z24WWPNotificationCreated, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z76WWPNotificationIcon", Z76WWPNotificationIcon);
         GxWebStd.gx_hidden_field( context, "Z77WWPNotificationTitle", Z77WWPNotificationTitle);
         GxWebStd.gx_hidden_field( context, "Z78WWPNotificationShortDescription", Z78WWPNotificationShortDescription);
         GxWebStd.gx_hidden_field( context, "Z79WWPNotificationLink", Z79WWPNotificationLink);
      ...
      {
         setEventMetadata("ENTER","""{"handler":"UserMainFullajax","iparms":[{"postForm":true},{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]}""");
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPNOTIFICATIONID","""{"handler":"Valid_Wwpnotificationid","iparms":[{"av":"A22WWPNotificationId","fld":"WWPNOTIFICATIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9","type":"int"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"A24WWPNotificationCreated","fld":"WWPNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]""");
         setEventMetadata("VALID_WWPNOTIFICATIONID",""","oparms":[{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A24WWPNotificationCreated","fld":"WWPNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A76WWPNotificationIcon","fld":"WWPNOTIFICATIONICON","type":"svchar"},{"av":"A77WWPNotificationTitle","fld":"WWPNOTIFICATIONTITLE","type":"svchar"},{"av":"A78WWPNotificationShortDescription","fld":"WWPNOTIFICATIONSHORTDESCRIPTION","type":"svchar"},{"av":"A79WWPNotificationLink","fld":"WWPNOTIFICATIONLINK","type":"svchar"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"A60WWPNotificationMetadata","fld":"WWPNOTIFICATIONMETADATA","type":"vchar"},{"av":"A59WWPNotificationDefinitionName","fld":"WWPNOTIFICATIONDEFINITIONNAME","type":"svchar"},{"av":"A8WWPUserExtendedFullName","fld":"WWPUSEREXTENDEDFULLNAME","type":"svchar"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"Z22WWPNotificationId","type":"int"},{"av":"Z23WWPNotificationDefinitionId","type":"int"},{"av":"Z24WWPNotificationCreated","type":"dtime"},{"av":"Z76WWPNotificationIcon","type":"svchar"},{"av":"Z77WWPNotificationTitle","type":"svchar"},{"av":"Z78WWPNotificationShortDescription","type":"svchar"},{"av":"Z79WWPNotificationLink","type":"svchar"},{"av":"Z82WWPNotificationIsRead","type":"boolean"},{"av":"Z7WWPUserExtendedId","type":"char"},{"av":"Z60WWPNotificationMetadata","type":"vchar"},{"av":"Z59WWPNotificationDefinitionName","type":"svchar"},{"av":"Z8WWPUserExtendedFullName","type":"svchar"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"},{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPNOTIFICATIONDEFINITIONID","""{"handler":"Valid_Wwpnotificationdefinitionid","iparms":[{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A59WWPNotificationDefinitionName","fld":"WWPNOTIFICATIONDEFINITIONNAME","type":"svchar"},{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]""");
         setEventMetadata("VALID_WWPNOTIFICATIONDEFINITIONID",""","oparms":[{"av":"A59WWPNotificationDefinitionName","fld":"WWPNOTIFICATIONDEFINITIONNAME","type":"svchar"},{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPNOTIFICATIONLINK","""{"handler":"Valid_Wwpnotificationlink","iparms":[{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]""");
         setEventMetadata("VALID_WWPNOTIFICATIONLINK",""","oparms":[{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPUSEREXTENDEDID","""{"handler":"Valid_Wwpuserextendedid","iparms":[{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"A8WWPUserExtendedFullName","fld":"WWPUSEREXTENDEDFULLNAME","type":"svchar"},{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]""");
         setEventMetadata("VALID_WWPUSEREXTENDEDID",""","oparms":[{"av":"A8WWPUserExtendedFullName","fld":"WWPUSEREXTENDEDFULLNAME","type":"svchar"},{"av":"A82WWPNotificationIsRead","fld":"WWPNOTIFICATIONISREAD","type":"boolean"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         T00096_A78WWPNotificationShortDescription = new string[] {""} ;
         ...
         T00093_A78WWPNotificationShortDescription = new string[] {""} ;
         ...
         T00092_A78WWPNotificationShortDescription = new string[] {""} ;
         ...
         ZZ78WWPNotificationShortDescription = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.notifications.common.wwp_notification__default(),
            new Object[][] {
                new Object[] {
               T00092_A22WWPNotificationId, T00092_A24WWPNotificationCreated, T00092_A76WWPNotificationIcon, T00092_A77WWPNotificationTitle, T00092_A78WWPNotificationShortDescription, T00092_A79WWPNotificationLink, T00092_A82WWPNotificationIsRead, T00092_A60WWPNotificationMetadata, T00092_n60WWPNotificationMetadata, T00092_A23WWPNotificationDefinitionId,
               T00092_A7WWPUserExtendedId, T00092_n7WWPUserExtendedId
               }
               , new Object[] {
               T00093_A22WWPNotificationId, T00093_A24WWPNotificationCreated, T00093_A76WWPNotificationIcon, T00093_A77WWPNotificationTitle, T00093_A78WWPNotificationShortDescription, T00093_A79WWPNotificationLink, T00093_A82WWPNotificationIsRead, T00093_A60WWPNotificationMetadata, T00093_n60WWPNotificationMetadata, T00093_A23WWPNotificationDefinitionId,
      ...
      private string Z78WWPNotificationShortDescription ;
      ...
      private string A78WWPNotificationShortDescription ;
      ...
      private string ZZ78WWPNotificationShortDescription ;
      ...
      private string[] T00096_A78WWPNotificationShortDescription ;
      ...
      private string[] T00093_A78WWPNotificationShortDescription ;
      ...
      private string[] T00092_A78WWPNotificationShortDescription ;
   ...
   public class wwp_notification__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("WWPNotificationShortDescription",GXType.VarChar,200,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("T00092", "SELECT WWPNotificationId, WWPNotificationCreated, WWPNotificationIcon, WWPNotificationTitle, WWPNotificationShortDescription, WWPNotificationLink, WWPNotificationIsRead, WWPNotificationMetadata, WWPNotificationDefinitionId, WWPUserExtendedId FROM WWP_Notification WHERE WWPNotificationId = :WWPNotificationId  FOR UPDATE OF WWP_Notification NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT00092,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00093", "SELECT WWPNotificationId, WWPNotificationCreated, WWPNotificationIcon, WWPNotificationTitle, WWPNotificationShortDescription, WWPNotificationLink, WWPNotificationIsRead, WWPNotificationMetadata, WWPNotificationDefinitionId, WWPUserExtendedId FROM WWP_Notification WHERE WWPNotificationId = :WWPNotificationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00093,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T000914", "SAVEPOINT gxupdate;UPDATE WWP_Notification SET WWPNotificationCreated=:WWPNotificationCreated, WWPNotificationIcon=:WWPNotificationIcon, WWPNotificationTitle=:WWPNotificationTitle, WWPNotificationShortDescription=:WWPNotificationShortDescription, WWPNotificationLink=:WWPNotificationLink, WWPNotificationIsRead=:WWPNotificationIsRead, WWPNotificationMetadata=:WWPNotificationMetadata, WWPNotificationDefinitionId=:WWPNotificationDefinitionId, WWPUserExtendedId=:WWPUserExtendedId  WHERE WWPNotificationId = :WWPNotificationId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000914)
