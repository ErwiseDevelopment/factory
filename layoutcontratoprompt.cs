...
namespace GeneXus.Programs {
   public class layoutcontratoprompt : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255261312047", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("layoutcontratoprompt.js", "?20255261312047", false, true);
         context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
         context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
   ...
   public class layoutcontratoprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV12OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(LayoutContratoId,'9999'), 2) like '%' || :lV13FilterFullText) or ( LayoutContratoDescricao like '%' || :lV13FilterFullText) or ( 'sim' like '%' || LOWER(:lV13FilterFullText) and LayoutContratoStatus = TRUE) or ( 'não' like '%' || LOWER(:lV13FilterFullText) and LayoutContratoStatus = FALSE) or ( LayoutContratoCorpo like '%' || :lV13FilterFullText) or ( 'contrato' like '%' || LOWER(:lV13FilterFullText) and LayoutContratoTipo = ( 'C')) or ( 'mensagem' like '%' || LOWER(:lV13FilterFullText) and LayoutContratoTipo = ( 'M')) or ( 'acoplado' like '%' || LOWER(:lV13FilterFullText) and LayoutContratoTipo = ( 'A')))");
         }
         else
         {
            GXv_int3[0] = 1;
