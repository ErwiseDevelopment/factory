   ...
   public class cliente : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_50") == 0 )
         {
            ...
            gxLoad_50( A168ClienteId, A780SerasaUltimaData_F) ;
            return  ;
         }
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_42") == 0 )
         {
            ...
            gxLoad_42( A444ResponsavelMunicipio) ;
            return  ;
         }
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_45") == 0 )
         {
            ...
            gxLoad_45( A437ResponsavelNacionalidade) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_46") == 0 )
         {
            ...
            gxLoad_46( A484ClienteNacionalidade) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_47") == 0 )
         {
            ...
            gxLoad_47( A442ResponsavelProfissao) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_48") == 0 )
         {
            ...
            gxLoad_48( A487ClienteProfissao) ;
            return  ;
         }
      ...
      protected void Load0O28( )
      {
         ...
         {
            RcdFound28 = 1;
            A175ClienteCreatedAt = T000O37_A175ClienteCreatedAt[0];
            n175ClienteCreatedAt = T000O37_n175ClienteCreatedAt[0];
            A176ClienteUpdatedAt = T000O37_A176ClienteUpdatedAt[0];
            n176ClienteUpdatedAt = T000O37_n176ClienteUpdatedAt[0];
            A169ClienteDocumento = T000O37_A169ClienteDocumento[0];
            n169ClienteDocumento = T000O37_n169ClienteDocumento[0];
            AssignAttri("", false, "A169ClienteDocumento", A169ClienteDocumento);
            A170ClienteRazaoSocial = T000O37_A170ClienteRazaoSocial[0];
            n170ClienteRazaoSocial = T000O37_n170ClienteRazaoSocial[0];
            AssignAttri("", false, "A170ClienteRazaoSocial", A170ClienteRazaoSocial);
            A171ClienteNomeFantasia = T000O37_A171ClienteNomeFantasia[0];
            n171ClienteNomeFantasia = T000O37_n171ClienteNomeFantasia[0];
            AssignAttri("", false, "A171ClienteNomeFantasia", A171ClienteNomeFantasia);
            A459ClienteDataNascimento = T000O37_A459ClienteDataNascimento[0];
            n459ClienteDataNascimento = T000O37_n459ClienteDataNascimento[0];
            A172ClienteTipoPessoa = T000O37_A172ClienteTipoPessoa[0];
            n172ClienteTipoPessoa = T000O37_n172ClienteTipoPessoa[0];
            AssignAttri("", false, "A172ClienteTipoPessoa", A172ClienteTipoPessoa);
            A193TipoClienteDescricao = T000O37_A193TipoClienteDescricao[0];
            n193TipoClienteDescricao = T000O37_n193TipoClienteDescricao[0];
            AssignAttri("", false, "A193TipoClienteDescricao", A193TipoClienteDescricao);
            A207TipoClientePortal = T000O37_A207TipoClientePortal[0];
            n207TipoClientePortal = T000O37_n207TipoClientePortal[0];
            A174ClienteStatus = T000O37_A174ClienteStatus[0];
            n174ClienteStatus = T000O37_n174ClienteStatus[0];
            AssignAttri("", false, "A174ClienteStatus", A174ClienteStatus);
            A490ClienteConvenioDescricao = T000O37_A490ClienteConvenioDescricao[0];
            n490ClienteConvenioDescricao = T000O37_n490ClienteConvenioDescricao[0];
            A177ClienteLogUser = T000O37_A177ClienteLogUser[0];
            n177ClienteLogUser = T000O37_n177ClienteLogUser[0];
            A485ClienteNacionalidadeNome = T000O37_A485ClienteNacionalidadeNome[0];
            n485ClienteNacionalidadeNome = T000O37_n485ClienteNacionalidadeNome[0];
            A488ClienteProfissaoNome = T000O37_A488ClienteProfissaoNome[0];
            n488ClienteProfissaoNome = T000O37_n488ClienteProfissaoNome[0];
            A486ClienteEstadoCivil = T000O37_A486ClienteEstadoCivil[0];
            n486ClienteEstadoCivil = T000O37_n486ClienteEstadoCivil[0];
            A181EnderecoTipo = T000O37_A181EnderecoTipo[0];
            n181EnderecoTipo = T000O37_n181EnderecoTipo[0];
            AssignAttri("", false, "A181EnderecoTipo", A181EnderecoTipo);
            A182EnderecoCEP = T000O37_A182EnderecoCEP[0];
            n182EnderecoCEP = T000O37_n182EnderecoCEP[0];
            AssignAttri("", false, "A182EnderecoCEP", A182EnderecoCEP);
            A183EnderecoLogradouro = T000O37_A183EnderecoLogradouro[0];
            n183EnderecoLogradouro = T000O37_n183EnderecoLogradouro[0];
            AssignAttri("", false, "A183EnderecoLogradouro", A183EnderecoLogradouro);
            A184EnderecoBairro = T000O37_A184EnderecoBairro[0];
            n184EnderecoBairro = T000O37_n184EnderecoBairro[0];
            AssignAttri("", false, "A184EnderecoBairro", A184EnderecoBairro);
            A185EnderecoCidade = T000O37_A185EnderecoCidade[0];
            n185EnderecoCidade = T000O37_n185EnderecoCidade[0];
            AssignAttri("", false, "A185EnderecoCidade", A185EnderecoCidade);
            A187MunicipioNome = T000O37_A187MunicipioNome[0];
            n187MunicipioNome = T000O37_n187MunicipioNome[0];
            A189MunicipioUF = T000O37_A189MunicipioUF[0];
            n189MunicipioUF = T000O37_n189MunicipioUF[0];
            AssignAttri("", false, "A189MunicipioUF", A189MunicipioUF);
            A190EnderecoNumero = T000O37_A190EnderecoNumero[0];
            n190EnderecoNumero = T000O37_n190EnderecoNumero[0];
            AssignAttri("", false, "A190EnderecoNumero", A190EnderecoNumero);
            A191EnderecoComplemento = T000O37_A191EnderecoComplemento[0];
            n191EnderecoComplemento = T000O37_n191EnderecoComplemento[0];
            AssignAttri("", false, "A191EnderecoComplemento", A191EnderecoComplemento);
            A201ContatoEmail = T000O37_A201ContatoEmail[0];
            n201ContatoEmail = T000O37_n201ContatoEmail[0];
            AssignAttri("", false, "A201ContatoEmail", A201ContatoEmail);
            A198ContatoDDD = T000O37_A198ContatoDDD[0];
            n198ContatoDDD = T000O37_n198ContatoDDD[0];
            ...
            A199ContatoDDI = T000O37_A199ContatoDDI[0];
            n199ContatoDDI = T000O37_n199ContatoDDI[0];
            ...
            A200ContatoNumero = T000O37_A200ContatoNumero[0];
            n200ContatoNumero = T000O37_n200ContatoNumero[0];
            ...
            A202ContatoTelefoneNumero = T000O37_A202ContatoTelefoneNumero[0];
            n202ContatoTelefoneNumero = T000O37_n202ContatoTelefoneNumero[0];
            ...
            A203ContatoTelefoneDDD = T000O37_A203ContatoTelefoneDDD[0];
            n203ContatoTelefoneDDD = T000O37_n203ContatoTelefoneDDD[0];
            ...
            A204ContatoTelefoneDDI = T000O37_A204ContatoTelefoneDDI[0];
            n204ContatoTelefoneDDI = T000O37_n204ContatoTelefoneDDI[0];
            ...
            A421ClienteRG = T000O37_A421ClienteRG[0];
            n421ClienteRG = T000O37_n421ClienteRG[0];
            A537ClienteDepositoTipo = T000O37_A537ClienteDepositoTipo[0];
            n537ClienteDepositoTipo = T000O37_n537ClienteDepositoTipo[0];
            A538ClientePixTipo = T000O37_A538ClientePixTipo[0];
            n538ClientePixTipo = T000O37_n538ClientePixTipo[0];
            A539ClientePix = T000O37_A539ClientePix[0];
            n539ClientePix = T000O37_n539ClientePix[0];
            A404BancoCodigo = T000O37_A404BancoCodigo[0];
            n404BancoCodigo = T000O37_n404BancoCodigo[0];
            A403BancoNome = T000O37_A403BancoNome[0];
            n403BancoNome = T000O37_n403BancoNome[0];
            A400ContaAgencia = T000O37_A400ContaAgencia[0];
            n400ContaAgencia = T000O37_n400ContaAgencia[0];
            A401ContaNumero = T000O37_A401ContaNumero[0];
            n401ContaNumero = T000O37_n401ContaNumero[0];
            A436ResponsavelNome = T000O37_A436ResponsavelNome[0];
            n436ResponsavelNome = T000O37_n436ResponsavelNome[0];
            A438ResponsavelNacionalidadeNome = T000O37_A438ResponsavelNacionalidadeNome[0];
            n438ResponsavelNacionalidadeNome = T000O37_n438ResponsavelNacionalidadeNome[0];
            A439ResponsavelEstadoCivil = T000O37_A439ResponsavelEstadoCivil[0];
            n439ResponsavelEstadoCivil = T000O37_n439ResponsavelEstadoCivil[0];
            A576ResponsavelRG = T000O37_A576ResponsavelRG[0];
            n576ResponsavelRG = T000O37_n576ResponsavelRG[0];
            A443ResponsavelProfissaoNome = T000O37_A443ResponsavelProfissaoNome[0];
            n443ResponsavelProfissaoNome = T000O37_n443ResponsavelProfissaoNome[0];
            A447ResponsavelCPF = T000O37_A447ResponsavelCPF[0];
            n447ResponsavelCPF = T000O37_n447ResponsavelCPF[0];
            A448ResponsavelCEP = T000O37_A448ResponsavelCEP[0];
            n448ResponsavelCEP = T000O37_n448ResponsavelCEP[0];
            A449ResponsavelLogradouro = T000O37_A449ResponsavelLogradouro[0];
            n449ResponsavelLogradouro = T000O37_n449ResponsavelLogradouro[0];
            A450ResponsavelBairro = T000O37_A450ResponsavelBairro[0];
            n450ResponsavelBairro = T000O37_n450ResponsavelBairro[0];
            A451ResponsavelCidade = T000O37_A451ResponsavelCidade[0];
            n451ResponsavelCidade = T000O37_n451ResponsavelCidade[0];
            A446ResponsavelMunicipioUF = T000O37_A446ResponsavelMunicipioUF[0];
            n446ResponsavelMunicipioUF = T000O37_n446ResponsavelMunicipioUF[0];
            A445ResponsavelMunicipioNome = T000O37_A445ResponsavelMunicipioNome[0];
            n445ResponsavelMunicipioNome = T000O37_n445ResponsavelMunicipioNome[0];
            A452ResponsavelLogradouroNumero = T000O37_A452ResponsavelLogradouroNumero[0];
            n452ResponsavelLogradouroNumero = T000O37_n452ResponsavelLogradouroNumero[0];
            A453ResponsavelComplemento = T000O37_A453ResponsavelComplemento[0];
            n453ResponsavelComplemento = T000O37_n453ResponsavelComplemento[0];
            A454ResponsavelDDD = T000O37_A454ResponsavelDDD[0];
            n454ResponsavelDDD = T000O37_n454ResponsavelDDD[0];
            A455ResponsavelNumero = T000O37_A455ResponsavelNumero[0];
            n455ResponsavelNumero = T000O37_n455ResponsavelNumero[0];
            A456ResponsavelEmail = T000O37_A456ResponsavelEmail[0];
            n456ResponsavelEmail = T000O37_n456ResponsavelEmail[0];
            A884ClienteSituacao = T000O37_A884ClienteSituacao[0];
            n884ClienteSituacao = T000O37_n884ClienteSituacao[0];
            A885ResponsavelCargo = T000O37_A885ResponsavelCargo[0];
            n885ResponsavelCargo = T000O37_n885ResponsavelCargo[0];
            A793TipoClientePortalPjPf = T000O37_A793TipoClientePortalPjPf[0];
            n793TipoClientePortalPjPf = T000O37_n793TipoClientePortalPjPf[0];
            A192TipoClienteId = T000O37_A192TipoClienteId[0];
            n192TipoClienteId = T000O37_n192TipoClienteId[0];
            A186MunicipioCodigo = T000O37_A186MunicipioCodigo[0];
            n186MunicipioCodigo = T000O37_n186MunicipioCodigo[0];
            AssignAttri("", false, "A186MunicipioCodigo", A186MunicipioCodigo);
            A444ResponsavelMunicipio = T000O37_A444ResponsavelMunicipio[0];
            n444ResponsavelMunicipio = T000O37_n444ResponsavelMunicipio[0];
            A402BancoId = T000O37_A402BancoId[0];
            n402BancoId = T000O37_n402BancoId[0];
            A457EspecialidadeId = T000O37_A457EspecialidadeId[0];
            n457EspecialidadeId = T000O37_n457EspecialidadeId[0];
            A437ResponsavelNacionalidade = T000O37_A437ResponsavelNacionalidade[0];
            n437ResponsavelNacionalidade = T000O37_n437ResponsavelNacionalidade[0];
            A484ClienteNacionalidade = T000O37_A484ClienteNacionalidade[0];
            n484ClienteNacionalidade = T000O37_n484ClienteNacionalidade[0];
            A442ResponsavelProfissao = T000O37_A442ResponsavelProfissao[0];
            n442ResponsavelProfissao = T000O37_n442ResponsavelProfissao[0];
            A487ClienteProfissao = T000O37_A487ClienteProfissao[0];
            n487ClienteProfissao = T000O37_n487ClienteProfissao[0];
            A489ClienteConvenio = T000O37_A489ClienteConvenio[0];
            n489ClienteConvenio = T000O37_n489ClienteConvenio[0];
            A780SerasaUltimaData_F = T000O37_A780SerasaUltimaData_F[0];
            A608SecUserId_F = T000O37_A608SecUserId_F[0];
            n608SecUserId_F = T000O37_n608SecUserId_F[0];
            A309ClienteQtdTitulos_F = T000O37_A309ClienteQtdTitulos_F[0];
            n309ClienteQtdTitulos_F = T000O37_n309ClienteQtdTitulos_F[0];
            A310ClienteValorAPagar_F = T000O37_A310ClienteValorAPagar_F[0];
            n310ClienteValorAPagar_F = T000O37_n310ClienteValorAPagar_F[0];
            A311ClienteValorAReceber_F = T000O37_A311ClienteValorAReceber_F[0];
            n311ClienteValorAReceber_F = T000O37_n311ClienteValorAReceber_F[0];
            A732SerasaConsultas_F = T000O37_A732SerasaConsultas_F[0];
            ZM0O28( -38) ;
         }
         pr_default.close(18);
         OnLoadActions0O28( ) ;
      ...
      protected void gxLoad_52( int A168ClienteId )
      {
         ...
         {
            A309ClienteQtdTitulos_F = T000O42_A309ClienteQtdTitulos_F[0];
            n309ClienteQtdTitulos_F = T000O42_n309ClienteQtdTitulos_F[0];
         }
         else
         {
            A309ClienteQtdTitulos_F = 0;
      ...
      protected void gxLoad_53( int A168ClienteId )
      {
         ...
         {
            A310ClienteValorAPagar_F = T000O46_A310ClienteValorAPagar_F[0];
            n310ClienteValorAPagar_F = T000O46_n310ClienteValorAPagar_F[0];
         }
         else
         {
            A310ClienteValorAPagar_F = 0;
      ...
      protected void gxLoad_54( int A168ClienteId )
      {
         ...
         {
            A311ClienteValorAReceber_F = T000O49_A311ClienteValorAReceber_F[0];
            n311ClienteValorAReceber_F = T000O49_n311ClienteValorAReceber_F[0];
         }
         else
         {
            A311ClienteValorAReceber_F = 0;
      ...
      protected void gxLoad_55( int A168ClienteId )
      {
         ...
         {
            A780SerasaUltimaData_F = T000O51_A780SerasaUltimaData_F[0];
            A732SerasaConsultas_F = T000O51_A732SerasaConsultas_F[0];
         }
         else
         {
            A732SerasaConsultas_F = 0;
      ...
      protected void gxLoad_50( int A168ClienteId ,
                                DateTime A780SerasaUltimaData_F )
      {
         /* Using cursor T000O53 */
         pr_default.execute(25, new Object[] {A780SerasaUltimaData_F, n168ClienteId, A168ClienteId});
         if ( (pr_default.getStatus(25) != 101) )
         {
            A781SerasaScoreUltimaData_F = T000O53_A781SerasaScoreUltimaData_F[0];
            A785SerasaUltimoValorRecomendado_F = T000O53_A785SerasaUltimoValorRecomendado_F[0];
         }
         else
         {
            A781SerasaScoreUltimaData_F = 0;
      ...
      protected void gxLoad_41( string A186MunicipioCodigo )
      {
         /* Using cursor T000O54 */
         pr_default.execute(26, new Object[] {n186MunicipioCodigo, A186MunicipioCodigo});
         ...
         A187MunicipioNome = T000O54_A187MunicipioNome[0];
         n187MunicipioNome = T000O54_n187MunicipioNome[0];
         A189MunicipioUF = T000O54_A189MunicipioUF[0];
         n189MunicipioUF = T000O54_n189MunicipioUF[0];
         AssignAttri("", false, "A189MunicipioUF", A189MunicipioUF);
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_40( short A192TipoClienteId )
      {
         /* Using cursor T000O55 */
         pr_default.execute(27, new Object[] {n192TipoClienteId, A192TipoClienteId});
         ...
         A193TipoClienteDescricao = T000O55_A193TipoClienteDescricao[0];
         n193TipoClienteDescricao = T000O55_n193TipoClienteDescricao[0];
         AssignAttri("", false, "A193TipoClienteDescricao", A193TipoClienteDescricao);
         A207TipoClientePortal = T000O55_A207TipoClientePortal[0];
         n207TipoClientePortal = T000O55_n207TipoClientePortal[0];
         A793TipoClientePortalPjPf = T000O55_A793TipoClientePortalPjPf[0];
         n793TipoClientePortalPjPf = T000O55_n793TipoClientePortalPjPf[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_42( string A444ResponsavelMunicipio )
      {
         /* Using cursor T000O56 */
         pr_default.execute(28, new Object[] {n444ResponsavelMunicipio, A444ResponsavelMunicipio});
         ...
         A446ResponsavelMunicipioUF = T000O56_A446ResponsavelMunicipioUF[0];
         n446ResponsavelMunicipioUF = T000O56_n446ResponsavelMunicipioUF[0];
         A445ResponsavelMunicipioNome = T000O56_A445ResponsavelMunicipioNome[0];
         n445ResponsavelMunicipioNome = T000O56_n445ResponsavelMunicipioNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_43( int A402BancoId )
      {
         /* Using cursor T000O57 */
         pr_default.execute(29, new Object[] {n402BancoId, A402BancoId});
         ...
         A404BancoCodigo = T000O57_A404BancoCodigo[0];
         n404BancoCodigo = T000O57_n404BancoCodigo[0];
         A403BancoNome = T000O57_A403BancoNome[0];
         n403BancoNome = T000O57_n403BancoNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_44( int A457EspecialidadeId )
      {
         /* Using cursor T000O58 */
         pr_default.execute(30, new Object[] {n457EspecialidadeId, A457EspecialidadeId});
      ...
      protected void gxLoad_45( int A437ResponsavelNacionalidade )
      {
         /* Using cursor T000O59 */
         pr_default.execute(31, new Object[] {n437ResponsavelNacionalidade, A437ResponsavelNacionalidade});
         ...
         A438ResponsavelNacionalidadeNome = T000O59_A438ResponsavelNacionalidadeNome[0];
         n438ResponsavelNacionalidadeNome = T000O59_n438ResponsavelNacionalidadeNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_46( int A484ClienteNacionalidade )
      {
         /* Using cursor T000O60 */
         pr_default.execute(32, new Object[] {n484ClienteNacionalidade, A484ClienteNacionalidade});
         ...
         A485ClienteNacionalidadeNome = T000O60_A485ClienteNacionalidadeNome[0];
         n485ClienteNacionalidadeNome = T000O60_n485ClienteNacionalidadeNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_47( int A442ResponsavelProfissao )
      {
         /* Using cursor T000O61 */
         pr_default.execute(33, new Object[] {n442ResponsavelProfissao, A442ResponsavelProfissao});
         ...
         A443ResponsavelProfissaoNome = T000O61_A443ResponsavelProfissaoNome[0];
         n443ResponsavelProfissaoNome = T000O61_n443ResponsavelProfissaoNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_48( int A487ClienteProfissao )
      {
         ...
         A488ClienteProfissaoNome = T000O62_A488ClienteProfissaoNome[0];
         n488ClienteProfissaoNome = T000O62_n488ClienteProfissaoNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_49( int A489ClienteConvenio )
      {
         /* Using cursor T000O63 */
         pr_default.execute(35, new Object[] {n489ClienteConvenio, A489ClienteConvenio});
         ...
         A490ClienteConvenioDescricao = T000O63_A490ClienteConvenioDescricao[0];
         n490ClienteConvenioDescricao = T000O63_n490ClienteConvenioDescricao[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void GetKey0O28( )
      {
         ...
         pr_default.execute(36, new Object[] {n168ClienteId, A168ClienteId});
      ...
      protected void move_next( )
      {
         ...
         pr_default.execute(37, new Object[] {n168ClienteId, A168ClienteId});
         if ( (pr_default.getStatus(37) != 101) )
         {
            while ( (pr_default.getStatus(37) != 101) && ( ( T000O65_A168ClienteId[0] < A168ClienteId ) ) )
            {
               pr_default.readNext(37);
            }
            if ( (pr_default.getStatus(37) != 101) && ( ( T000O65_A168ClienteId[0] > A168ClienteId ) ) )
            {
               A168ClienteId = T000O65_A168ClienteId[0];
               n168ClienteId = T000O65_n168ClienteId[0];
               AssignAttri("", false, "A168ClienteId", StringUtil.LTrimStr( (decimal)(A168ClienteId), 9, 0));
               RcdFound28 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(38) != 101) && ( ( T000O66_A168ClienteId[0] > A168ClienteId ) ) )
            {
               pr_default.readNext(38);
            }
            if ( (pr_default.getStatus(38) != 101) && ( ( T000O66_A168ClienteId[0] < A168ClienteId ) ) )
            {
               A168ClienteId = T000O66_A168ClienteId[0];
               n168ClienteId = T000O66_n168ClienteId[0];
               AssignAttri("", false, "A168ClienteId", StringUtil.LTrimStr( (decimal)(A168ClienteId), 9, 0));
               RcdFound28 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency0O28( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( Z192TipoClienteId != T000O2_A192TipoClienteId[0] ) || ( StringUtil.StrCmp(Z186MunicipioCodigo, T000O2_A186MunicipioCodigo[0]) != 0 ) || ( StringUtil.StrCmp(Z444ResponsavelMunicipio, T000O2_A444ResponsavelMunicipio[0]) != 0 ) || ( Z402BancoId != T000O2_A402BancoId[0] ) || ( Z457EspecialidadeId != T000O2_A457EspecialidadeId[0] ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z437ResponsavelNacionalidade != T000O2_A437ResponsavelNacionalidade[0] ) || ( Z484ClienteNacionalidade != T000O2_A484ClienteNacionalidade[0] ) || ( Z442ResponsavelProfissao != T000O2_A442ResponsavelProfissao[0] ) || ( Z487ClienteProfissao != T000O2_A487ClienteProfissao[0] ) || ( Z489ClienteConvenio != T000O2_A489ClienteConvenio[0] ) )
            {
      ...
      protected void OnDeleteControls0O28( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            {
               A608SecUserId_F = T000O72_A608SecUserId_F[0];
               n608SecUserId_F = T000O72_n608SecUserId_F[0];
            }
            else
            {
               A608SecUserId_F = 0;
            ...
            {
               A309ClienteQtdTitulos_F = T000O74_A309ClienteQtdTitulos_F[0];
               n309ClienteQtdTitulos_F = T000O74_n309ClienteQtdTitulos_F[0];
            }
            else
            {
               A309ClienteQtdTitulos_F = 0;
            ...
            pr_default.close(44);
            /* Using cursor T000O78 */
            pr_default.execute(45, new Object[] {n168ClienteId, A168ClienteId});
            if ( (pr_default.getStatus(45) != 101) )
            {
               A310ClienteValorAPagar_F = T000O78_A310ClienteValorAPagar_F[0];
               n310ClienteValorAPagar_F = T000O78_n310ClienteValorAPagar_F[0];
            }
            else
            {
               A310ClienteValorAPagar_F = 0;
            ...
            pr_default.close(45);
            /* Using cursor T000O81 */
            pr_default.execute(46, new Object[] {n168ClienteId, A168ClienteId});
            if ( (pr_default.getStatus(46) != 101) )
            {
               A311ClienteValorAReceber_F = T000O81_A311ClienteValorAReceber_F[0];
               n311ClienteValorAReceber_F = T000O81_n311ClienteValorAReceber_F[0];
            }
            else
            {
               A311ClienteValorAReceber_F = 0;
            ...
            {
               A780SerasaUltimaData_F = T000O83_A780SerasaUltimaData_F[0];
               A732SerasaConsultas_F = T000O83_A732SerasaConsultas_F[0];
            }
            else
            {
               A732SerasaConsultas_F = 0;
            ...
            pr_default.close(47);
            /* Using cursor T000O85 */
            pr_default.execute(48, new Object[] {A780SerasaUltimaData_F, n168ClienteId, A168ClienteId});
            if ( (pr_default.getStatus(48) != 101) )
            {
               A781SerasaScoreUltimaData_F = T000O85_A781SerasaScoreUltimaData_F[0];
               A785SerasaUltimoValorRecomendado_F = T000O85_A785SerasaUltimoValorRecomendado_F[0];
            }
            else
            {
               A781SerasaScoreUltimaData_F = 0;
            ...
            pr_default.execute(49, new Object[] {n186MunicipioCodigo, A186MunicipioCodigo});
            A187MunicipioNome = T000O86_A187MunicipioNome[0];
            n187MunicipioNome = T000O86_n187MunicipioNome[0];
            A189MunicipioUF = T000O86_A189MunicipioUF[0];
            n189MunicipioUF = T000O86_n189MunicipioUF[0];
            AssignAttri("", false, "A189MunicipioUF", A189MunicipioUF);
            pr_default.close(49);
            A206ClienteCelular_F = StringUtil.Format( "%1 %2-%3", StringUtil.LTrimStr( (decimal)(A198ContatoDDD), 4, 0), StringUtil.Substring( StringUtil.Trim( StringUtil.Str( (decimal)(A200ContatoNumero), 18, 0)), 1, 5), StringUtil.Substring( StringUtil.Trim( StringUtil.Str( (decimal)(A200ContatoNumero), 18, 0)), 6, 4), "", "", "", "", "", "");
            AssignAttri("", false, "A206ClienteCelular_F", A206ClienteCelular_F);
            ...
            A577ResponsavelCelular_F = GXt_char2;
            AssignAttri("", false, "A577ResponsavelCelular_F", A577ResponsavelCelular_F);
            /* Using cursor T000O87 */
            pr_default.execute(50, new Object[] {n192TipoClienteId, A192TipoClienteId});
            A193TipoClienteDescricao = T000O87_A193TipoClienteDescricao[0];
            n193TipoClienteDescricao = T000O87_n193TipoClienteDescricao[0];
            AssignAttri("", false, "A193TipoClienteDescricao", A193TipoClienteDescricao);
            A207TipoClientePortal = T000O87_A207TipoClientePortal[0];
            n207TipoClientePortal = T000O87_n207TipoClientePortal[0];
            A793TipoClientePortalPjPf = T000O87_A793TipoClientePortalPjPf[0];
            n793TipoClientePortalPjPf = T000O87_n793TipoClientePortalPjPf[0];
            pr_default.close(50);
            /* Using cursor T000O88 */
            pr_default.execute(51, new Object[] {n444ResponsavelMunicipio, A444ResponsavelMunicipio});
            A446ResponsavelMunicipioUF = T000O88_A446ResponsavelMunicipioUF[0];
            n446ResponsavelMunicipioUF = T000O88_n446ResponsavelMunicipioUF[0];
            A445ResponsavelMunicipioNome = T000O88_A445ResponsavelMunicipioNome[0];
            n445ResponsavelMunicipioNome = T000O88_n445ResponsavelMunicipioNome[0];
            pr_default.close(51);
            /* Using cursor T000O89 */
            pr_default.execute(52, new Object[] {n402BancoId, A402BancoId});
            A404BancoCodigo = T000O89_A404BancoCodigo[0];
            n404BancoCodigo = T000O89_n404BancoCodigo[0];
            A403BancoNome = T000O89_A403BancoNome[0];
            n403BancoNome = T000O89_n403BancoNome[0];
            pr_default.close(52);
            /* Using cursor T000O90 */
            pr_default.execute(53, new Object[] {n437ResponsavelNacionalidade, A437ResponsavelNacionalidade});
            A438ResponsavelNacionalidadeNome = T000O90_A438ResponsavelNacionalidadeNome[0];
            n438ResponsavelNacionalidadeNome = T000O90_n438ResponsavelNacionalidadeNome[0];
            pr_default.close(53);
            /* Using cursor T000O91 */
            pr_default.execute(54, new Object[] {n484ClienteNacionalidade, A484ClienteNacionalidade});
            A485ClienteNacionalidadeNome = T000O91_A485ClienteNacionalidadeNome[0];
            n485ClienteNacionalidadeNome = T000O91_n485ClienteNacionalidadeNome[0];
            pr_default.close(54);
            /* Using cursor T000O92 */
            pr_default.execute(55, new Object[] {n442ResponsavelProfissao, A442ResponsavelProfissao});
            A443ResponsavelProfissaoNome = T000O92_A443ResponsavelProfissaoNome[0];
            n443ResponsavelProfissaoNome = T000O92_n443ResponsavelProfissaoNome[0];
            pr_default.close(55);
            /* Using cursor T000O93 */
            pr_default.execute(56, new Object[] {n487ClienteProfissao, A487ClienteProfissao});
            A488ClienteProfissaoNome = T000O93_A488ClienteProfissaoNome[0];
            n488ClienteProfissaoNome = T000O93_n488ClienteProfissaoNome[0];
            pr_default.close(56);
            /* Using cursor T000O94 */
            pr_default.execute(57, new Object[] {n489ClienteConvenio, A489ClienteConvenio});
            A490ClienteConvenioDescricao = T000O94_A490ClienteConvenioDescricao[0];
            n490ClienteConvenioDescricao = T000O94_n490ClienteConvenioDescricao[0];
            pr_default.close(57);
         }
         if ( AnyError == 0 )
         {
      ...
      public void ScanStart0O28( )
      {
         ...
         {
            RcdFound28 = 1;
            A168ClienteId = T000O113_A168ClienteId[0];
            n168ClienteId = T000O113_n168ClienteId[0];
            AssignAttri("", false, "A168ClienteId", StringUtil.LTrimStr( (decimal)(A168ClienteId), 9, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918444485", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("cliente.js", "?202551918444486", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public void Valid_Clientedocumento( )
      {
         ...
         pr_default.execute(77, new Object[] {n169ClienteDocumento, A169ClienteDocumento, n168ClienteId, A168ClienteId});
      ...
      public override void initialize( )
      {
         ...
         T000O37_A168ClienteId = new int[1] ;
         T000O37_n168ClienteId = new bool[] {false} ;
         T000O37_A175ClienteCreatedAt = new DateTime[] {DateTime.MinValue} ;
         T000O37_n175ClienteCreatedAt = new bool[] {false} ;
         T000O37_A176ClienteUpdatedAt = new DateTime[] {DateTime.MinValue} ;
         T000O37_n176ClienteUpdatedAt = new bool[] {false} ;
         T000O37_A169ClienteDocumento = new string[] {""} ;
         T000O37_n169ClienteDocumento = new bool[] {false} ;
         T000O37_A170ClienteRazaoSocial = new string[] {""} ;
         T000O37_n170ClienteRazaoSocial = new bool[] {false} ;
         T000O37_A171ClienteNomeFantasia = new string[] {""} ;
         T000O37_n171ClienteNomeFantasia = new bool[] {false} ;
         T000O37_A459ClienteDataNascimento = new DateTime[] {DateTime.MinValue} ;
         T000O37_n459ClienteDataNascimento = new bool[] {false} ;
         T000O37_A172ClienteTipoPessoa = new string[] {""} ;
         T000O37_n172ClienteTipoPessoa = new bool[] {false} ;
         T000O37_A193TipoClienteDescricao = new string[] {""} ;
         T000O37_n193TipoClienteDescricao = new bool[] {false} ;
         T000O37_A207TipoClientePortal = new bool[] {false} ;
         T000O37_n207TipoClientePortal = new bool[] {false} ;
         T000O37_A174ClienteStatus = new bool[] {false} ;
         T000O37_n174ClienteStatus = new bool[] {false} ;
         T000O37_A490ClienteConvenioDescricao = new string[] {""} ;
         T000O37_n490ClienteConvenioDescricao = new bool[] {false} ;
         T000O37_A177ClienteLogUser = new short[1] ;
         T000O37_n177ClienteLogUser = new bool[] {false} ;
         T000O37_A485ClienteNacionalidadeNome = new string[] {""} ;
         T000O37_n485ClienteNacionalidadeNome = new bool[] {false} ;
         T000O37_A488ClienteProfissaoNome = new string[] {""} ;
         T000O37_n488ClienteProfissaoNome = new bool[] {false} ;
         T000O37_A486ClienteEstadoCivil = new string[] {""} ;
         T000O37_n486ClienteEstadoCivil = new bool[] {false} ;
         T000O37_A181EnderecoTipo = new string[] {""} ;
         T000O37_n181EnderecoTipo = new bool[] {false} ;
         T000O37_A182EnderecoCEP = new string[] {""} ;
         T000O37_n182EnderecoCEP = new bool[] {false} ;
         T000O37_A183EnderecoLogradouro = new string[] {""} ;
         T000O37_n183EnderecoLogradouro = new bool[] {false} ;
         T000O37_A184EnderecoBairro = new string[] {""} ;
         T000O37_n184EnderecoBairro = new bool[] {false} ;
         T000O37_A185EnderecoCidade = new string[] {""} ;
         T000O37_n185EnderecoCidade = new bool[] {false} ;
         T000O37_A187MunicipioNome = new string[] {""} ;
         T000O37_n187MunicipioNome = new bool[] {false} ;
         T000O37_A189MunicipioUF = new string[] {""} ;
         T000O37_n189MunicipioUF = new bool[] {false} ;
         T000O37_A190EnderecoNumero = new string[] {""} ;
         T000O37_n190EnderecoNumero = new bool[] {false} ;
         T000O37_A191EnderecoComplemento = new string[] {""} ;
         T000O37_n191EnderecoComplemento = new bool[] {false} ;
         T000O37_A201ContatoEmail = new string[] {""} ;
         T000O37_n201ContatoEmail = new bool[] {false} ;
         T000O37_A198ContatoDDD = new short[1] ;
         T000O37_n198ContatoDDD = new bool[] {false} ;
         T000O37_A199ContatoDDI = new short[1] ;
         T000O37_n199ContatoDDI = new bool[] {false} ;
         T000O37_A200ContatoNumero = new long[1] ;
         T000O37_n200ContatoNumero = new bool[] {false} ;
         T000O37_A202ContatoTelefoneNumero = new long[1] ;
         T000O37_n202ContatoTelefoneNumero = new bool[] {false} ;
         T000O37_A203ContatoTelefoneDDD = new short[1] ;
         T000O37_n203ContatoTelefoneDDD = new bool[] {false} ;
         T000O37_A204ContatoTelefoneDDI = new short[1] ;
         T000O37_n204ContatoTelefoneDDI = new bool[] {false} ;
         T000O37_A421ClienteRG = new long[1] ;
         T000O37_n421ClienteRG = new bool[] {false} ;
         T000O37_A537ClienteDepositoTipo = new string[] {""} ;
         T000O37_n537ClienteDepositoTipo = new bool[] {false} ;
         T000O37_A538ClientePixTipo = new string[] {""} ;
         T000O37_n538ClientePixTipo = new bool[] {false} ;
         T000O37_A539ClientePix = new string[] {""} ;
         T000O37_n539ClientePix = new bool[] {false} ;
         T000O37_A404BancoCodigo = new int[1] ;
         T000O37_n404BancoCodigo = new bool[] {false} ;
         T000O37_A403BancoNome = new string[] {""} ;
         T000O37_n403BancoNome = new bool[] {false} ;
         T000O37_A400ContaAgencia = new string[] {""} ;
         T000O37_n400ContaAgencia = new bool[] {false} ;
         T000O37_A401ContaNumero = new string[] {""} ;
         T000O37_n401ContaNumero = new bool[] {false} ;
         T000O37_A436ResponsavelNome = new string[] {""} ;
         T000O37_n436ResponsavelNome = new bool[] {false} ;
         T000O37_A438ResponsavelNacionalidadeNome = new string[] {""} ;
         T000O37_n438ResponsavelNacionalidadeNome = new bool[] {false} ;
         T000O37_A439ResponsavelEstadoCivil = new string[] {""} ;
         T000O37_n439ResponsavelEstadoCivil = new bool[] {false} ;
         T000O37_A576ResponsavelRG = new long[1] ;
         T000O37_n576ResponsavelRG = new bool[] {false} ;
         T000O37_A443ResponsavelProfissaoNome = new string[] {""} ;
         T000O37_n443ResponsavelProfissaoNome = new bool[] {false} ;
         T000O37_A447ResponsavelCPF = new string[] {""} ;
         T000O37_n447ResponsavelCPF = new bool[] {false} ;
         T000O37_A448ResponsavelCEP = new string[] {""} ;
         T000O37_n448ResponsavelCEP = new bool[] {false} ;
         T000O37_A449ResponsavelLogradouro = new string[] {""} ;
         T000O37_n449ResponsavelLogradouro = new bool[] {false} ;
         T000O37_A450ResponsavelBairro = new string[] {""} ;
         T000O37_n450ResponsavelBairro = new bool[] {false} ;
         T000O37_A451ResponsavelCidade = new string[] {""} ;
         T000O37_n451ResponsavelCidade = new bool[] {false} ;
         T000O37_A446ResponsavelMunicipioUF = new string[] {""} ;
         T000O37_n446ResponsavelMunicipioUF = new bool[] {false} ;
         T000O37_A445ResponsavelMunicipioNome = new string[] {""} ;
         T000O37_n445ResponsavelMunicipioNome = new bool[] {false} ;
         T000O37_A452ResponsavelLogradouroNumero = new int[1] ;
         T000O37_n452ResponsavelLogradouroNumero = new bool[] {false} ;
         T000O37_A453ResponsavelComplemento = new string[] {""} ;
         T000O37_n453ResponsavelComplemento = new bool[] {false} ;
         T000O37_A454ResponsavelDDD = new short[1] ;
         T000O37_n454ResponsavelDDD = new bool[] {false} ;
         T000O37_A455ResponsavelNumero = new int[1] ;
         T000O37_n455ResponsavelNumero = new bool[] {false} ;
         T000O37_A456ResponsavelEmail = new string[] {""} ;
         T000O37_n456ResponsavelEmail = new bool[] {false} ;
         T000O37_A884ClienteSituacao = new string[] {""} ;
         T000O37_n884ClienteSituacao = new bool[] {false} ;
         T000O37_A885ResponsavelCargo = new string[] {""} ;
         T000O37_n885ResponsavelCargo = new bool[] {false} ;
         T000O37_A793TipoClientePortalPjPf = new bool[] {false} ;
         T000O37_n793TipoClientePortalPjPf = new bool[] {false} ;
         T000O37_A192TipoClienteId = new short[1] ;
         T000O37_n192TipoClienteId = new bool[] {false} ;
         T000O37_A186MunicipioCodigo = new string[] {""} ;
         T000O37_n186MunicipioCodigo = new bool[] {false} ;
         T000O37_A444ResponsavelMunicipio = new string[] {""} ;
         T000O37_n444ResponsavelMunicipio = new bool[] {false} ;
         T000O37_A402BancoId = new int[1] ;
         T000O37_n402BancoId = new bool[] {false} ;
         T000O37_A457EspecialidadeId = new int[1] ;
         T000O37_n457EspecialidadeId = new bool[] {false} ;
         T000O37_A437ResponsavelNacionalidade = new int[1] ;
         T000O37_n437ResponsavelNacionalidade = new bool[] {false} ;
         T000O37_A484ClienteNacionalidade = new int[1] ;
         T000O37_n484ClienteNacionalidade = new bool[] {false} ;
         T000O37_A442ResponsavelProfissao = new int[1] ;
         T000O37_n442ResponsavelProfissao = new bool[] {false} ;
         T000O37_A487ClienteProfissao = new int[1] ;
         T000O37_n487ClienteProfissao = new bool[] {false} ;
         T000O37_A489ClienteConvenio = new int[1] ;
         T000O37_n489ClienteConvenio = new bool[] {false} ;
         T000O37_A780SerasaUltimaData_F = new DateTime[] {DateTime.MinValue} ;
         T000O37_A608SecUserId_F = new short[1] ;
         T000O37_n608SecUserId_F = new bool[] {false} ;
         T000O37_A309ClienteQtdTitulos_F = new int[1] ;
         T000O37_n309ClienteQtdTitulos_F = new bool[] {false} ;
         T000O37_A310ClienteValorAPagar_F = new decimal[1] ;
         T000O37_n310ClienteValorAPagar_F = new bool[] {false} ;
         T000O37_A311ClienteValorAReceber_F = new decimal[1] ;
         T000O37_n311ClienteValorAReceber_F = new bool[] {false} ;
         T000O37_A732SerasaConsultas_F = new short[1] ;
         T000O38_A169ClienteDocumento = new string[] {""} ;
         T000O38_n169ClienteDocumento = new bool[] {false} ;
         ...
         T000O42_A309ClienteQtdTitulos_F = new int[1] ;
         T000O42_n309ClienteQtdTitulos_F = new bool[] {false} ;
         T000O46_A310ClienteValorAPagar_F = new decimal[1] ;
         T000O46_n310ClienteValorAPagar_F = new bool[] {false} ;
         T000O49_A311ClienteValorAReceber_F = new decimal[1] ;
         T000O49_n311ClienteValorAReceber_F = new bool[] {false} ;
         T000O51_A780SerasaUltimaData_F = new DateTime[] {DateTime.MinValue} ;
         T000O51_A732SerasaConsultas_F = new short[1] ;
         T000O53_A781SerasaScoreUltimaData_F = new short[1] ;
         T000O53_A785SerasaUltimoValorRecomendado_F = new decimal[1] ;
         T000O54_A187MunicipioNome = new string[] {""} ;
         T000O54_n187MunicipioNome = new bool[] {false} ;
         T000O54_A189MunicipioUF = new string[] {""} ;
         T000O54_n189MunicipioUF = new bool[] {false} ;
         T000O55_A193TipoClienteDescricao = new string[] {""} ;
         T000O55_n193TipoClienteDescricao = new bool[] {false} ;
         T000O55_A207TipoClientePortal = new bool[] {false} ;
         T000O55_n207TipoClientePortal = new bool[] {false} ;
         T000O55_A793TipoClientePortalPjPf = new bool[] {false} ;
         T000O55_n793TipoClientePortalPjPf = new bool[] {false} ;
         T000O56_A446ResponsavelMunicipioUF = new string[] {""} ;
         T000O56_n446ResponsavelMunicipioUF = new bool[] {false} ;
         T000O56_A445ResponsavelMunicipioNome = new string[] {""} ;
         T000O56_n445ResponsavelMunicipioNome = new bool[] {false} ;
         T000O57_A404BancoCodigo = new int[1] ;
         T000O57_n404BancoCodigo = new bool[] {false} ;
         T000O57_A403BancoNome = new string[] {""} ;
         T000O57_n403BancoNome = new bool[] {false} ;
         T000O58_A457EspecialidadeId = new int[1] ;
         T000O58_n457EspecialidadeId = new bool[] {false} ;
         T000O59_A438ResponsavelNacionalidadeNome = new string[] {""} ;
         T000O59_n438ResponsavelNacionalidadeNome = new bool[] {false} ;
         T000O60_A485ClienteNacionalidadeNome = new string[] {""} ;
         T000O60_n485ClienteNacionalidadeNome = new bool[] {false} ;
         T000O61_A443ResponsavelProfissaoNome = new string[] {""} ;
         T000O61_n443ResponsavelProfissaoNome = new bool[] {false} ;
         T000O62_A488ClienteProfissaoNome = new string[] {""} ;
         T000O62_n488ClienteProfissaoNome = new bool[] {false} ;
         T000O63_A490ClienteConvenioDescricao = new string[] {""} ;
         T000O63_n490ClienteConvenioDescricao = new bool[] {false} ;
         T000O64_A168ClienteId = new int[1] ;
         T000O64_n168ClienteId = new bool[] {false} ;
         ...
         T000O65_A168ClienteId = new int[1] ;
         T000O65_n168ClienteId = new bool[] {false} ;
         T000O66_A168ClienteId = new int[1] ;
         T000O66_n168ClienteId = new bool[] {false} ;
         ...
         T000O68_A168ClienteId = new int[1] ;
         T000O68_n168ClienteId = new bool[] {false} ;
         T000O72_A608SecUserId_F = new short[1] ;
         T000O72_n608SecUserId_F = new bool[] {false} ;
         T000O74_A309ClienteQtdTitulos_F = new int[1] ;
         T000O74_n309ClienteQtdTitulos_F = new bool[] {false} ;
         T000O78_A310ClienteValorAPagar_F = new decimal[1] ;
         T000O78_n310ClienteValorAPagar_F = new bool[] {false} ;
         T000O81_A311ClienteValorAReceber_F = new decimal[1] ;
         T000O81_n311ClienteValorAReceber_F = new bool[] {false} ;
         T000O83_A780SerasaUltimaData_F = new DateTime[] {DateTime.MinValue} ;
         T000O83_A732SerasaConsultas_F = new short[1] ;
         T000O85_A781SerasaScoreUltimaData_F = new short[1] ;
         T000O85_A785SerasaUltimoValorRecomendado_F = new decimal[1] ;
         T000O86_A187MunicipioNome = new string[] {""} ;
         T000O86_n187MunicipioNome = new bool[] {false} ;
         T000O86_A189MunicipioUF = new string[] {""} ;
         T000O86_n189MunicipioUF = new bool[] {false} ;
         T000O87_A193TipoClienteDescricao = new string[] {""} ;
         T000O87_n193TipoClienteDescricao = new bool[] {false} ;
         T000O87_A207TipoClientePortal = new bool[] {false} ;
         T000O87_n207TipoClientePortal = new bool[] {false} ;
         T000O87_A793TipoClientePortalPjPf = new bool[] {false} ;
         T000O87_n793TipoClientePortalPjPf = new bool[] {false} ;
         T000O88_A446ResponsavelMunicipioUF = new string[] {""} ;
         T000O88_n446ResponsavelMunicipioUF = new bool[] {false} ;
         T000O88_A445ResponsavelMunicipioNome = new string[] {""} ;
         T000O88_n445ResponsavelMunicipioNome = new bool[] {false} ;
         T000O89_A404BancoCodigo = new int[1] ;
         T000O89_n404BancoCodigo = new bool[] {false} ;
         T000O89_A403BancoNome = new string[] {""} ;
         T000O89_n403BancoNome = new bool[] {false} ;
         T000O90_A438ResponsavelNacionalidadeNome = new string[] {""} ;
         T000O90_n438ResponsavelNacionalidadeNome = new bool[] {false} ;
         T000O91_A485ClienteNacionalidadeNome = new string[] {""} ;
         T000O91_n485ClienteNacionalidadeNome = new bool[] {false} ;
         T000O92_A443ResponsavelProfissaoNome = new string[] {""} ;
         T000O92_n443ResponsavelProfissaoNome = new bool[] {false} ;
         T000O93_A488ClienteProfissaoNome = new string[] {""} ;
         T000O93_n488ClienteProfissaoNome = new bool[] {false} ;
         T000O94_A490ClienteConvenioDescricao = new string[] {""} ;
         T000O94_n490ClienteConvenioDescricao = new bool[] {false} ;
         T000O95_A323PropostaId = new int[1] ;
         T000O96_A323PropostaId = new int[1] ;
         T000O97_A323PropostaId = new int[1] ;
         T000O98_A323PropostaId = new int[1] ;
         T000O99_A227ContratoId = new int[1] ;
         T000O100_A261TituloId = new int[1] ;
         T000O100_n261TituloId = new bool[] {false} ;
         T000O101_A133SecUserId = new short[1] ;
         T000O102_A978RepresentanteId = new int[1] ;
         T000O103_A856CreditoId = new int[1] ;
         T000O104_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         T000O104_n794NotaFiscalId = new bool[] {false} ;
         T000O105_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         T000O105_n794NotaFiscalId = new bool[] {false} ;
         T000O106_A662SerasaId = new int[1] ;
         T000O107_A599ClienteDocumentoId = new int[1] ;
         T000O108_A551ClienteReponsavelId = new int[1] ;
         T000O109_A551ClienteReponsavelId = new int[1] ;
         T000O110_A242AssinaturaParticipanteId = new int[1] ;
         T000O111_A223FinanciamentoId = new int[1] ;
         T000O112_A223FinanciamentoId = new int[1] ;
         T000O113_A168ClienteId = new int[1] ;
         T000O113_n168ClienteId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXEncryptionTmp = "";
         ...
         GXt_char2 = "";
         T000O114_A169ClienteDocumento = new string[] {""} ;
         T000O114_n169ClienteDocumento = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.cliente__default(),
            new Object[][] {
               ...
               T000O2_n885ResponsavelCargo, T000O2_A192TipoClienteId, T000O2_n192TipoClienteId, T000O2_A186MunicipioCodigo, T000O2_n186MunicipioCodigo, T000O2_A444ResponsavelMunicipio, T000O2_n444ResponsavelMunicipio, T000O2_A402BancoId, T000O2_n402BancoId, T000O2_A457EspecialidadeId,
               T000O2_n457EspecialidadeId, T000O2_A437ResponsavelNacionalidade, T000O2_n437ResponsavelNacionalidade, T000O2_A484ClienteNacionalidade, T000O2_n484ClienteNacionalidade, T000O2_A442ResponsavelProfissao, T000O2_n442ResponsavelProfissao, T000O2_A487ClienteProfissao, T000O2_n487ClienteProfissao, T000O2_A489ClienteConvenio,
               T000O2_n489ClienteConvenio
               }
               , new Object[] {
               ...
               T000O3_n885ResponsavelCargo, T000O3_A192TipoClienteId, T000O3_n192TipoClienteId, T000O3_A186MunicipioCodigo, T000O3_n186MunicipioCodigo, T000O3_A444ResponsavelMunicipio, T000O3_n444ResponsavelMunicipio, T000O3_A402BancoId, T000O3_n402BancoId, T000O3_A457EspecialidadeId,
               T000O3_n457EspecialidadeId, T000O3_A437ResponsavelNacionalidade, T000O3_n437ResponsavelNacionalidade, T000O3_A484ClienteNacionalidade, T000O3_n484ClienteNacionalidade, T000O3_A442ResponsavelProfissao, T000O3_n442ResponsavelProfissao, T000O3_A487ClienteProfissao, T000O3_n487ClienteProfissao, T000O3_A489ClienteConvenio,
               T000O3_n489ClienteConvenio
               }
               , new Object[] {
               ...
               , new Object[] {
               T000O37_A168ClienteId, T000O37_A175ClienteCreatedAt, T000O37_n175ClienteCreatedAt, T000O37_A176ClienteUpdatedAt, T000O37_n176ClienteUpdatedAt, T000O37_A169ClienteDocumento, T000O37_n169ClienteDocumento, T000O37_A170ClienteRazaoSocial, T000O37_n170ClienteRazaoSocial, T000O37_A171ClienteNomeFantasia,
               T000O37_n171ClienteNomeFantasia, T000O37_A459ClienteDataNascimento, T000O37_n459ClienteDataNascimento, T000O37_A172ClienteTipoPessoa, T000O37_n172ClienteTipoPessoa, T000O37_A193TipoClienteDescricao, T000O37_n193TipoClienteDescricao, T000O37_A207TipoClientePortal, T000O37_n207TipoClientePortal, T000O37_A174ClienteStatus,
               T000O37_n174ClienteStatus, T000O37_A490ClienteConvenioDescricao, T000O37_n490ClienteConvenioDescricao, T000O37_A177ClienteLogUser, T000O37_n177ClienteLogUser, T000O37_A485ClienteNacionalidadeNome, T000O37_n485ClienteNacionalidadeNome, T000O37_A488ClienteProfissaoNome, T000O37_n488ClienteProfissaoNome, T000O37_A486ClienteEstadoCivil,
               T000O37_n486ClienteEstadoCivil, T000O37_A181EnderecoTipo, T000O37_n181EnderecoTipo, T000O37_A182EnderecoCEP, T000O37_n182EnderecoCEP, T000O37_A183EnderecoLogradouro, T000O37_n183EnderecoLogradouro, T000O37_A184EnderecoBairro, T000O37_n184EnderecoBairro, T000O37_A185EnderecoCidade,
               T000O37_n185EnderecoCidade, T000O37_A187MunicipioNome, T000O37_n187MunicipioNome, T000O37_A189MunicipioUF, T000O37_n189MunicipioUF, T000O37_A190EnderecoNumero, T000O37_n190EnderecoNumero, T000O37_A191EnderecoComplemento, T000O37_n191EnderecoComplemento, T000O37_A201ContatoEmail,
               T000O37_n201ContatoEmail, T000O37_A198ContatoDDD, T000O37_n198ContatoDDD, T000O37_A199ContatoDDI, T000O37_n199ContatoDDI, T000O37_A200ContatoNumero, T000O37_n200ContatoNumero, T000O37_A202ContatoTelefoneNumero, T000O37_n202ContatoTelefoneNumero, T000O37_A203ContatoTelefoneDDD,
               T000O37_n203ContatoTelefoneDDD, T000O37_A204ContatoTelefoneDDI, T000O37_n204ContatoTelefoneDDI, T000O37_A421ClienteRG, T000O37_n421ClienteRG, T000O37_A537ClienteDepositoTipo, T000O37_n537ClienteDepositoTipo, T000O37_A538ClientePixTipo, T000O37_n538ClientePixTipo, T000O37_A539ClientePix,
               T000O37_n539ClientePix, T000O37_A404BancoCodigo, T000O37_n404BancoCodigo, T000O37_A403BancoNome, T000O37_n403BancoNome, T000O37_A400ContaAgencia, T000O37_n400ContaAgencia, T000O37_A401ContaNumero, T000O37_n401ContaNumero, T000O37_A436ResponsavelNome,
               T000O37_n436ResponsavelNome, T000O37_A438ResponsavelNacionalidadeNome, T000O37_n438ResponsavelNacionalidadeNome, T000O37_A439ResponsavelEstadoCivil, T000O37_n439ResponsavelEstadoCivil, T000O37_A576ResponsavelRG, T000O37_n576ResponsavelRG, T000O37_A443ResponsavelProfissaoNome, T000O37_n443ResponsavelProfissaoNome, T000O37_A447ResponsavelCPF,
               T000O37_n447ResponsavelCPF, T000O37_A448ResponsavelCEP, T000O37_n448ResponsavelCEP, T000O37_A449ResponsavelLogradouro, T000O37_n449ResponsavelLogradouro, T000O37_A450ResponsavelBairro, T000O37_n450ResponsavelBairro, T000O37_A451ResponsavelCidade, T000O37_n451ResponsavelCidade, T000O37_A446ResponsavelMunicipioUF,
               T000O37_n446ResponsavelMunicipioUF, T000O37_A445ResponsavelMunicipioNome, T000O37_n445ResponsavelMunicipioNome, T000O37_A452ResponsavelLogradouroNumero, T000O37_n452ResponsavelLogradouroNumero, T000O37_A453ResponsavelComplemento, T000O37_n453ResponsavelComplemento, T000O37_A454ResponsavelDDD, T000O37_n454ResponsavelDDD, T000O37_A455ResponsavelNumero,
               T000O37_n455ResponsavelNumero, T000O37_A456ResponsavelEmail, T000O37_n456ResponsavelEmail, T000O37_A884ClienteSituacao, T000O37_n884ClienteSituacao, T000O37_A885ResponsavelCargo, T000O37_n885ResponsavelCargo, T000O37_A793TipoClientePortalPjPf, T000O37_n793TipoClientePortalPjPf, T000O37_A192TipoClienteId,
               T000O37_n192TipoClienteId, T000O37_A186MunicipioCodigo, T000O37_n186MunicipioCodigo, T000O37_A444ResponsavelMunicipio, T000O37_n444ResponsavelMunicipio, T000O37_A402BancoId, T000O37_n402BancoId, T000O37_A457EspecialidadeId, T000O37_n457EspecialidadeId, T000O37_A437ResponsavelNacionalidade,
               T000O37_n437ResponsavelNacionalidade, T000O37_A484ClienteNacionalidade, T000O37_n484ClienteNacionalidade, T000O37_A442ResponsavelProfissao, T000O37_n442ResponsavelProfissao, T000O37_A487ClienteProfissao, T000O37_n487ClienteProfissao, T000O37_A489ClienteConvenio, T000O37_n489ClienteConvenio, T000O37_A780SerasaUltimaData_F,
               T000O37_A608SecUserId_F, T000O37_n608SecUserId_F, T000O37_A309ClienteQtdTitulos_F, T000O37_n309ClienteQtdTitulos_F, T000O37_A310ClienteValorAPagar_F, T000O37_n310ClienteValorAPagar_F, T000O37_A311ClienteValorAReceber_F, T000O37_n311ClienteValorAReceber_F, T000O37_A732SerasaConsultas_F
               }
               , new Object[] {
               T000O38_A169ClienteDocumento, T000O38_n169ClienteDocumento
               }
               , new Object[] {
               T000O40_A608SecUserId_F, T000O40_n608SecUserId_F
               }
               , new Object[] {
               T000O42_A309ClienteQtdTitulos_F, T000O42_n309ClienteQtdTitulos_F
               }
               , new Object[] {
               T000O46_A310ClienteValorAPagar_F, T000O46_n310ClienteValorAPagar_F
               }
               , new Object[] {
               T000O49_A311ClienteValorAReceber_F, T000O49_n311ClienteValorAReceber_F
               }
               , new Object[] {
               T000O51_A780SerasaUltimaData_F, T000O51_A732SerasaConsultas_F
               }
               , new Object[] {
               T000O53_A781SerasaScoreUltimaData_F, T000O53_A785SerasaUltimoValorRecomendado_F
               }
               , new Object[] {
               T000O54_A187MunicipioNome, T000O54_n187MunicipioNome, T000O54_A189MunicipioUF, T000O54_n189MunicipioUF
               }
               , new Object[] {
               T000O55_A193TipoClienteDescricao, T000O55_n193TipoClienteDescricao, T000O55_A207TipoClientePortal, T000O55_n207TipoClientePortal, T000O55_A793TipoClientePortalPjPf, T000O55_n793TipoClientePortalPjPf
               }
               , new Object[] {
               T000O56_A446ResponsavelMunicipioUF, T000O56_n446ResponsavelMunicipioUF, T000O56_A445ResponsavelMunicipioNome, T000O56_n445ResponsavelMunicipioNome
               }
               , new Object[] {
               T000O57_A404BancoCodigo, T000O57_n404BancoCodigo, T000O57_A403BancoNome, T000O57_n403BancoNome
               }
               , new Object[] {
               T000O58_A457EspecialidadeId
               }
               , new Object[] {
               T000O59_A438ResponsavelNacionalidadeNome, T000O59_n438ResponsavelNacionalidadeNome
               }
               , new Object[] {
               T000O60_A485ClienteNacionalidadeNome, T000O60_n485ClienteNacionalidadeNome
               }
               , new Object[] {
               T000O61_A443ResponsavelProfissaoNome, T000O61_n443ResponsavelProfissaoNome
               }
               , new Object[] {
               T000O62_A488ClienteProfissaoNome, T000O62_n488ClienteProfissaoNome
               }
               , new Object[] {
               T000O63_A490ClienteConvenioDescricao, T000O63_n490ClienteConvenioDescricao
               }
               , new Object[] {
               T000O64_A168ClienteId
               }
               , new Object[] {
               T000O65_A168ClienteId
               }
               , new Object[] {
               T000O66_A168ClienteId
               }
               , new Object[] {
               }
               , new Object[] {
               T000O68_A168ClienteId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T000O72_A608SecUserId_F, T000O72_n608SecUserId_F
               }
               , new Object[] {
               T000O74_A309ClienteQtdTitulos_F, T000O74_n309ClienteQtdTitulos_F
               }
               , new Object[] {
               T000O78_A310ClienteValorAPagar_F, T000O78_n310ClienteValorAPagar_F
               }
               , new Object[] {
               T000O81_A311ClienteValorAReceber_F, T000O81_n311ClienteValorAReceber_F
               }
               , new Object[] {
               T000O83_A780SerasaUltimaData_F, T000O83_A732SerasaConsultas_F
               }
               , new Object[] {
               T000O85_A781SerasaScoreUltimaData_F, T000O85_A785SerasaUltimoValorRecomendado_F
               }
               , new Object[] {
               T000O86_A187MunicipioNome, T000O86_n187MunicipioNome, T000O86_A189MunicipioUF, T000O86_n189MunicipioUF
               }
               , new Object[] {
               T000O87_A193TipoClienteDescricao, T000O87_n193TipoClienteDescricao, T000O87_A207TipoClientePortal, T000O87_n207TipoClientePortal, T000O87_A793TipoClientePortalPjPf, T000O87_n793TipoClientePortalPjPf
               }
               , new Object[] {
               T000O88_A446ResponsavelMunicipioUF, T000O88_n446ResponsavelMunicipioUF, T000O88_A445ResponsavelMunicipioNome, T000O88_n445ResponsavelMunicipioNome
               }
               , new Object[] {
               T000O89_A404BancoCodigo, T000O89_n404BancoCodigo, T000O89_A403BancoNome, T000O89_n403BancoNome
               }
               , new Object[] {
               T000O90_A438ResponsavelNacionalidadeNome, T000O90_n438ResponsavelNacionalidadeNome
               }
               , new Object[] {
               T000O91_A485ClienteNacionalidadeNome, T000O91_n485ClienteNacionalidadeNome
               }
               , new Object[] {
               T000O92_A443ResponsavelProfissaoNome, T000O92_n443ResponsavelProfissaoNome
               }
               , new Object[] {
               T000O93_A488ClienteProfissaoNome, T000O93_n488ClienteProfissaoNome
               }
               , new Object[] {
               T000O94_A490ClienteConvenioDescricao, T000O94_n490ClienteConvenioDescricao
               }
               , new Object[] {
               T000O95_A323PropostaId
               }
               , new Object[] {
               T000O96_A323PropostaId
               }
               , new Object[] {
               T000O97_A323PropostaId
               }
               , new Object[] {
               T000O98_A323PropostaId
               }
               , new Object[] {
               T000O99_A227ContratoId
               }
               , new Object[] {
               T000O100_A261TituloId
               }
               , new Object[] {
               T000O101_A133SecUserId
               }
               , new Object[] {
               T000O102_A978RepresentanteId
               }
               , new Object[] {
               T000O103_A856CreditoId
               }
               , new Object[] {
               T000O104_A794NotaFiscalId
               }
               , new Object[] {
               T000O105_A794NotaFiscalId
               }
               , new Object[] {
               T000O106_A662SerasaId
               }
               , new Object[] {
               T000O107_A599ClienteDocumentoId
               }
               , new Object[] {
               T000O108_A551ClienteReponsavelId
               }
               , new Object[] {
               T000O109_A551ClienteReponsavelId
               }
               , new Object[] {
               T000O110_A242AssinaturaParticipanteId
               }
               , new Object[] {
               T000O111_A223FinanciamentoId
               }
               , new Object[] {
               T000O112_A223FinanciamentoId
               }
               , new Object[] {
               T000O113_A168ClienteId
               }
               , new Object[] {
               T000O114_A169ClienteDocumento, T000O114_n169ClienteDocumento
               }
            }
         );
         AV35Pgmname = "Cliente";
      ...
      private int[] T000O37_A168ClienteId ;
      private bool[] T000O37_n168ClienteId ;
      private DateTime[] T000O37_A175ClienteCreatedAt ;
      private bool[] T000O37_n175ClienteCreatedAt ;
      private DateTime[] T000O37_A176ClienteUpdatedAt ;
      private bool[] T000O37_n176ClienteUpdatedAt ;
      private string[] T000O37_A169ClienteDocumento ;
      private bool[] T000O37_n169ClienteDocumento ;
      private string[] T000O37_A170ClienteRazaoSocial ;
      private bool[] T000O37_n170ClienteRazaoSocial ;
      private string[] T000O37_A171ClienteNomeFantasia ;
      private bool[] T000O37_n171ClienteNomeFantasia ;
      private DateTime[] T000O37_A459ClienteDataNascimento ;
      private bool[] T000O37_n459ClienteDataNascimento ;
      private string[] T000O37_A172ClienteTipoPessoa ;
      private bool[] T000O37_n172ClienteTipoPessoa ;
      private string[] T000O37_A193TipoClienteDescricao ;
      private bool[] T000O37_n193TipoClienteDescricao ;
      private bool[] T000O37_A207TipoClientePortal ;
      private bool[] T000O37_n207TipoClientePortal ;
      private bool[] T000O37_A174ClienteStatus ;
      private bool[] T000O37_n174ClienteStatus ;
      private string[] T000O37_A490ClienteConvenioDescricao ;
      private bool[] T000O37_n490ClienteConvenioDescricao ;
      private short[] T000O37_A177ClienteLogUser ;
      private bool[] T000O37_n177ClienteLogUser ;
      private string[] T000O37_A485ClienteNacionalidadeNome ;
      private bool[] T000O37_n485ClienteNacionalidadeNome ;
      private string[] T000O37_A488ClienteProfissaoNome ;
      private bool[] T000O37_n488ClienteProfissaoNome ;
      private string[] T000O37_A486ClienteEstadoCivil ;
      private bool[] T000O37_n486ClienteEstadoCivil ;
      private string[] T000O37_A181EnderecoTipo ;
      private bool[] T000O37_n181EnderecoTipo ;
      private string[] T000O37_A182EnderecoCEP ;
      private bool[] T000O37_n182EnderecoCEP ;
      private string[] T000O37_A183EnderecoLogradouro ;
      private bool[] T000O37_n183EnderecoLogradouro ;
      private string[] T000O37_A184EnderecoBairro ;
      private bool[] T000O37_n184EnderecoBairro ;
      private string[] T000O37_A185EnderecoCidade ;
      private bool[] T000O37_n185EnderecoCidade ;
      private string[] T000O37_A187MunicipioNome ;
      private bool[] T000O37_n187MunicipioNome ;
      private string[] T000O37_A189MunicipioUF ;
      private bool[] T000O37_n189MunicipioUF ;
      private string[] T000O37_A190EnderecoNumero ;
      private bool[] T000O37_n190EnderecoNumero ;
      private string[] T000O37_A191EnderecoComplemento ;
      private bool[] T000O37_n191EnderecoComplemento ;
      private string[] T000O37_A201ContatoEmail ;
      private bool[] T000O37_n201ContatoEmail ;
      private short[] T000O37_A198ContatoDDD ;
      private bool[] T000O37_n198ContatoDDD ;
      private short[] T000O37_A199ContatoDDI ;
      private bool[] T000O37_n199ContatoDDI ;
      private long[] T000O37_A200ContatoNumero ;
      private bool[] T000O37_n200ContatoNumero ;
      private long[] T000O37_A202ContatoTelefoneNumero ;
      private bool[] T000O37_n202ContatoTelefoneNumero ;
      private short[] T000O37_A203ContatoTelefoneDDD ;
      private bool[] T000O37_n203ContatoTelefoneDDD ;
      private short[] T000O37_A204ContatoTelefoneDDI ;
      private bool[] T000O37_n204ContatoTelefoneDDI ;
      private long[] T000O37_A421ClienteRG ;
      private bool[] T000O37_n421ClienteRG ;
      private string[] T000O37_A537ClienteDepositoTipo ;
      private bool[] T000O37_n537ClienteDepositoTipo ;
      private string[] T000O37_A538ClientePixTipo ;
      private bool[] T000O37_n538ClientePixTipo ;
      private string[] T000O37_A539ClientePix ;
      private bool[] T000O37_n539ClientePix ;
      private int[] T000O37_A404BancoCodigo ;
      private bool[] T000O37_n404BancoCodigo ;
      private string[] T000O37_A403BancoNome ;
      private bool[] T000O37_n403BancoNome ;
      private string[] T000O37_A400ContaAgencia ;
      private bool[] T000O37_n400ContaAgencia ;
      private string[] T000O37_A401ContaNumero ;
      private bool[] T000O37_n401ContaNumero ;
      private string[] T000O37_A436ResponsavelNome ;
      private bool[] T000O37_n436ResponsavelNome ;
      private string[] T000O37_A438ResponsavelNacionalidadeNome ;
      private bool[] T000O37_n438ResponsavelNacionalidadeNome ;
      private string[] T000O37_A439ResponsavelEstadoCivil ;
      private bool[] T000O37_n439ResponsavelEstadoCivil ;
      private long[] T000O37_A576ResponsavelRG ;
      private bool[] T000O37_n576ResponsavelRG ;
      private string[] T000O37_A443ResponsavelProfissaoNome ;
      private bool[] T000O37_n443ResponsavelProfissaoNome ;
      private string[] T000O37_A447ResponsavelCPF ;
      private bool[] T000O37_n447ResponsavelCPF ;
      private string[] T000O37_A448ResponsavelCEP ;
      private bool[] T000O37_n448ResponsavelCEP ;
      private string[] T000O37_A449ResponsavelLogradouro ;
      private bool[] T000O37_n449ResponsavelLogradouro ;
      private string[] T000O37_A450ResponsavelBairro ;
      private bool[] T000O37_n450ResponsavelBairro ;
      private string[] T000O37_A451ResponsavelCidade ;
      private bool[] T000O37_n451ResponsavelCidade ;
      private string[] T000O37_A446ResponsavelMunicipioUF ;
      private bool[] T000O37_n446ResponsavelMunicipioUF ;
      private string[] T000O37_A445ResponsavelMunicipioNome ;
      private bool[] T000O37_n445ResponsavelMunicipioNome ;
      private int[] T000O37_A452ResponsavelLogradouroNumero ;
      private bool[] T000O37_n452ResponsavelLogradouroNumero ;
      private string[] T000O37_A453ResponsavelComplemento ;
      private bool[] T000O37_n453ResponsavelComplemento ;
      private short[] T000O37_A454ResponsavelDDD ;
      private bool[] T000O37_n454ResponsavelDDD ;
      private int[] T000O37_A455ResponsavelNumero ;
      private bool[] T000O37_n455ResponsavelNumero ;
      private string[] T000O37_A456ResponsavelEmail ;
      private bool[] T000O37_n456ResponsavelEmail ;
      private string[] T000O37_A884ClienteSituacao ;
      private bool[] T000O37_n884ClienteSituacao ;
      private string[] T000O37_A885ResponsavelCargo ;
      private bool[] T000O37_n885ResponsavelCargo ;
      private bool[] T000O37_A793TipoClientePortalPjPf ;
      private bool[] T000O37_n793TipoClientePortalPjPf ;
      private short[] T000O37_A192TipoClienteId ;
      private bool[] T000O37_n192TipoClienteId ;
      private string[] T000O37_A186MunicipioCodigo ;
      private bool[] T000O37_n186MunicipioCodigo ;
      private string[] T000O37_A444ResponsavelMunicipio ;
      private bool[] T000O37_n444ResponsavelMunicipio ;
      private int[] T000O37_A402BancoId ;
      private bool[] T000O37_n402BancoId ;
      private int[] T000O37_A457EspecialidadeId ;
      private bool[] T000O37_n457EspecialidadeId ;
      private int[] T000O37_A437ResponsavelNacionalidade ;
      private bool[] T000O37_n437ResponsavelNacionalidade ;
      private int[] T000O37_A484ClienteNacionalidade ;
      private bool[] T000O37_n484ClienteNacionalidade ;
      private int[] T000O37_A442ResponsavelProfissao ;
      private bool[] T000O37_n442ResponsavelProfissao ;
      private int[] T000O37_A487ClienteProfissao ;
      private bool[] T000O37_n487ClienteProfissao ;
      private int[] T000O37_A489ClienteConvenio ;
      private bool[] T000O37_n489ClienteConvenio ;
      private DateTime[] T000O37_A780SerasaUltimaData_F ;
      private short[] T000O37_A608SecUserId_F ;
      private bool[] T000O37_n608SecUserId_F ;
      private int[] T000O37_A309ClienteQtdTitulos_F ;
      private bool[] T000O37_n309ClienteQtdTitulos_F ;
      private decimal[] T000O37_A310ClienteValorAPagar_F ;
      private bool[] T000O37_n310ClienteValorAPagar_F ;
      private decimal[] T000O37_A311ClienteValorAReceber_F ;
      private bool[] T000O37_n311ClienteValorAReceber_F ;
      private short[] T000O37_A732SerasaConsultas_F ;
      private string[] T000O38_A169ClienteDocumento ;
      private bool[] T000O38_n169ClienteDocumento ;
      ...
      private int[] T000O42_A309ClienteQtdTitulos_F ;
      private bool[] T000O42_n309ClienteQtdTitulos_F ;
      private decimal[] T000O46_A310ClienteValorAPagar_F ;
      private bool[] T000O46_n310ClienteValorAPagar_F ;
      private decimal[] T000O49_A311ClienteValorAReceber_F ;
      private bool[] T000O49_n311ClienteValorAReceber_F ;
      private DateTime[] T000O51_A780SerasaUltimaData_F ;
      private short[] T000O51_A732SerasaConsultas_F ;
      private short[] T000O53_A781SerasaScoreUltimaData_F ;
      private decimal[] T000O53_A785SerasaUltimoValorRecomendado_F ;
      private string[] T000O54_A187MunicipioNome ;
      private bool[] T000O54_n187MunicipioNome ;
      private string[] T000O54_A189MunicipioUF ;
      private bool[] T000O54_n189MunicipioUF ;
      private string[] T000O55_A193TipoClienteDescricao ;
      private bool[] T000O55_n193TipoClienteDescricao ;
      private bool[] T000O55_A207TipoClientePortal ;
      private bool[] T000O55_n207TipoClientePortal ;
      private bool[] T000O55_A793TipoClientePortalPjPf ;
      private bool[] T000O55_n793TipoClientePortalPjPf ;
      private string[] T000O56_A446ResponsavelMunicipioUF ;
      private bool[] T000O56_n446ResponsavelMunicipioUF ;
      private string[] T000O56_A445ResponsavelMunicipioNome ;
      private bool[] T000O56_n445ResponsavelMunicipioNome ;
      private int[] T000O57_A404BancoCodigo ;
      private bool[] T000O57_n404BancoCodigo ;
      private string[] T000O57_A403BancoNome ;
      private bool[] T000O57_n403BancoNome ;
      private int[] T000O58_A457EspecialidadeId ;
      private bool[] T000O58_n457EspecialidadeId ;
      private string[] T000O59_A438ResponsavelNacionalidadeNome ;
      private bool[] T000O59_n438ResponsavelNacionalidadeNome ;
      private string[] T000O60_A485ClienteNacionalidadeNome ;
      private bool[] T000O60_n485ClienteNacionalidadeNome ;
      private string[] T000O61_A443ResponsavelProfissaoNome ;
      private bool[] T000O61_n443ResponsavelProfissaoNome ;
      private string[] T000O62_A488ClienteProfissaoNome ;
      private bool[] T000O62_n488ClienteProfissaoNome ;
      private string[] T000O63_A490ClienteConvenioDescricao ;
      private bool[] T000O63_n490ClienteConvenioDescricao ;
      private int[] T000O64_A168ClienteId ;
      private bool[] T000O64_n168ClienteId ;
      ...
      private int[] T000O65_A168ClienteId ;
      private bool[] T000O65_n168ClienteId ;
      private int[] T000O66_A168ClienteId ;
      private bool[] T000O66_n168ClienteId ;
      ...
      private int[] T000O68_A168ClienteId ;
      private bool[] T000O68_n168ClienteId ;
      private short[] T000O72_A608SecUserId_F ;
      private bool[] T000O72_n608SecUserId_F ;
      private int[] T000O74_A309ClienteQtdTitulos_F ;
      private bool[] T000O74_n309ClienteQtdTitulos_F ;
      private decimal[] T000O78_A310ClienteValorAPagar_F ;
      private bool[] T000O78_n310ClienteValorAPagar_F ;
      private decimal[] T000O81_A311ClienteValorAReceber_F ;
      private bool[] T000O81_n311ClienteValorAReceber_F ;
      private DateTime[] T000O83_A780SerasaUltimaData_F ;
      private short[] T000O83_A732SerasaConsultas_F ;
      private short[] T000O85_A781SerasaScoreUltimaData_F ;
      private decimal[] T000O85_A785SerasaUltimoValorRecomendado_F ;
      private string[] T000O86_A187MunicipioNome ;
      private bool[] T000O86_n187MunicipioNome ;
      private string[] T000O86_A189MunicipioUF ;
      private bool[] T000O86_n189MunicipioUF ;
      private string[] T000O87_A193TipoClienteDescricao ;
      private bool[] T000O87_n193TipoClienteDescricao ;
      private bool[] T000O87_A207TipoClientePortal ;
      private bool[] T000O87_n207TipoClientePortal ;
      private bool[] T000O87_A793TipoClientePortalPjPf ;
      private bool[] T000O87_n793TipoClientePortalPjPf ;
      private string[] T000O88_A446ResponsavelMunicipioUF ;
      private bool[] T000O88_n446ResponsavelMunicipioUF ;
      private string[] T000O88_A445ResponsavelMunicipioNome ;
      private bool[] T000O88_n445ResponsavelMunicipioNome ;
      private int[] T000O89_A404BancoCodigo ;
      private bool[] T000O89_n404BancoCodigo ;
      private string[] T000O89_A403BancoNome ;
      private bool[] T000O89_n403BancoNome ;
      private string[] T000O90_A438ResponsavelNacionalidadeNome ;
      private bool[] T000O90_n438ResponsavelNacionalidadeNome ;
      private string[] T000O91_A485ClienteNacionalidadeNome ;
      private bool[] T000O91_n485ClienteNacionalidadeNome ;
      private string[] T000O92_A443ResponsavelProfissaoNome ;
      private bool[] T000O92_n443ResponsavelProfissaoNome ;
      private string[] T000O93_A488ClienteProfissaoNome ;
      private bool[] T000O93_n488ClienteProfissaoNome ;
      private string[] T000O94_A490ClienteConvenioDescricao ;
      private bool[] T000O94_n490ClienteConvenioDescricao ;
      private int[] T000O95_A323PropostaId ;
      private int[] T000O96_A323PropostaId ;
      private int[] T000O97_A323PropostaId ;
      private int[] T000O98_A323PropostaId ;
      private int[] T000O99_A227ContratoId ;
      private int[] T000O100_A261TituloId ;
      private bool[] T000O100_n261TituloId ;
      private short[] T000O101_A133SecUserId ;
      private int[] T000O102_A978RepresentanteId ;
      private int[] T000O103_A856CreditoId ;
      private Guid[] T000O104_A794NotaFiscalId ;
      private bool[] T000O104_n794NotaFiscalId ;
      private Guid[] T000O105_A794NotaFiscalId ;
      private bool[] T000O105_n794NotaFiscalId ;
      private int[] T000O106_A662SerasaId ;
      private int[] T000O107_A599ClienteDocumentoId ;
      private int[] T000O108_A551ClienteReponsavelId ;
      private int[] T000O109_A551ClienteReponsavelId ;
      private int[] T000O110_A242AssinaturaParticipanteId ;
      private int[] T000O111_A223FinanciamentoId ;
      private int[] T000O112_A223FinanciamentoId ;
      private int[] T000O113_A168ClienteId ;
      private bool[] T000O113_n168ClienteId ;
      private string[] T000O114_A169ClienteDocumento ;
      private bool[] T000O114_n169ClienteDocumento ;
   }
   ...
   public class cliente__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmT000O78;
          prmT000O78 = new Object[] {
          new ParDef("ClienteId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT000O81;
          prmT000O81 = new Object[] {
          new ParDef("ClienteId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT000O83;
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T000O37", cmdBufferT000O37,true, GxErrorMask.GX_NOMASK, false, this,prmT000O37,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O38", "SELECT ClienteDocumento FROM Cliente WHERE (ClienteDocumento = :ClienteDocumento) AND (Not ( ClienteId = :ClienteId)) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O38,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O40", "SELECT COALESCE( T1.SecUserId_F, 0) AS SecUserId_F FROM (SELECT MIN(SecUserId) AS SecUserId_F, SecUserOwnerId FROM SecUser WHERE SecUserOwnerId = :ClienteId GROUP BY SecUserOwnerId ) T1 WHERE T1.SecUserOwnerId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O40,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O42", "SELECT COALESCE( T1.ClienteQtdTitulos_F, 0) AS ClienteQtdTitulos_F FROM (SELECT COUNT(*) AS ClienteQtdTitulos_F, T4.ClienteId FROM ((Titulo T2 LEFT JOIN NotaFiscalParcelamento T3 ON T3.NotaFiscalParcelamentoID = T2.NotaFiscalParcelamentoID) LEFT JOIN NotaFiscal T4 ON T4.NotaFiscalId = T3.NotaFiscalId) WHERE Not T2.TituloDeleted GROUP BY T4.ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O42,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O46", "SELECT COALESCE( T1.ClienteValorAPagar_F, 0) AS ClienteValorAPagar_F FROM (SELECT SUM(COALESCE( T5.TituloSaldoDebito_F, 0)) AS ClienteValorAPagar_F, T4.ClienteId FROM (((Titulo T2 LEFT JOIN NotaFiscalParcelamento T3 ON T3.NotaFiscalParcelamentoID = T2.NotaFiscalParcelamentoID) LEFT JOIN NotaFiscal T4 ON T4.NotaFiscalId = T3.NotaFiscalId) LEFT JOIN (SELECT CASE  WHEN COALESCE( T6.TituloTipo, '') = ( 'DEBITO') THEN ( COALESCE( T6.TituloValor, 0) - COALESCE( T6.TituloDesconto, 0)) - COALESCE( T7.TituloTotalMovimento_F, 0) ELSE 0 END AS TituloSaldoDebito_F, T6.TituloId FROM (Titulo T6 LEFT JOIN LATERAL (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE (T6.TituloId = TituloId) AND (TituloMovimentoSoma) GROUP BY TituloId ) T7 ON T7.TituloId = T6.TituloId) ) T5 ON T5.TituloId = T2.TituloId) GROUP BY T4.ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O46,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O49", "SELECT COALESCE( T1.ClienteValorAReceber_F, 0) AS ClienteValorAReceber_F FROM (SELECT SUM(CASE  WHEN COALESCE( T2.TituloTipo, '') = ( 'CREDITO') THEN ( COALESCE( T2.TituloValor, 0) - COALESCE( T2.TituloDesconto, 0)) - COALESCE( T5.TituloTotalMovimento_F, 0) ELSE 0 END) AS ClienteValorAReceber_F, T4.ClienteId FROM (((Titulo T2 LEFT JOIN NotaFiscalParcelamento T3 ON T3.NotaFiscalParcelamentoID = T2.NotaFiscalParcelamentoID) LEFT JOIN NotaFiscal T4 ON T4.NotaFiscalId = T3.NotaFiscalId) LEFT JOIN LATERAL (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE (T2.TituloId = TituloId) AND (TituloMovimentoSoma) GROUP BY TituloId ) T5 ON T5.TituloId = T2.TituloId) GROUP BY T4.ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O49,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O51", "SELECT COALESCE( T1.SerasaUltimaData_F, DATE '00010101') AS SerasaUltimaData_F, COALESCE( T1.SerasaConsultas_F, 0) AS SerasaConsultas_F FROM (SELECT COUNT(*) AS SerasaConsultas_F, ClienteId, MAX(SerasaCreatedAt) AS SerasaUltimaData_F FROM Serasa GROUP BY ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O51,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O53", "SELECT COALESCE( T1.SerasaScoreUltimaData_F, 0) AS SerasaScoreUltimaData_F, COALESCE( T1.SerasaUltimoValorRecomendado_F, 0) AS SerasaUltimoValorRecomendado_F FROM (SELECT MAX(SerasaScore) AS SerasaScoreUltimaData_F, ClienteId, MAX(SerasaValorLimiteRecomendado) AS SerasaUltimoValorRecomendado_F FROM Serasa WHERE SerasaCreatedAt = :SerasaUltimaData_F GROUP BY ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O53,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O54", "SELECT MunicipioNome, MunicipioUF FROM Municipio WHERE MunicipioCodigo = :MunicipioCodigo ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O54,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O55", "SELECT TipoClienteDescricao, TipoClientePortal, TipoClientePortalPjPf FROM TipoCliente WHERE TipoClienteId = :TipoClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O55,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O56", "SELECT MunicipioUF AS ResponsavelMunicipioUF, MunicipioNome AS ResponsavelMunicipioNome FROM Municipio WHERE MunicipioCodigo = :ResponsavelMunicipio ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O56,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O57", "SELECT BancoCodigo, BancoNome FROM Banco WHERE BancoId = :BancoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O57,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O58", "SELECT EspecialidadeId FROM Especialidade WHERE EspecialidadeId = :EspecialidadeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O58,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O59", "SELECT NacionalidadeNome AS ResponsavelNacionalidadeNome FROM Nacionalidade WHERE NacionalidadeId = :ResponsavelNacionalidade ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O59,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O60", "SELECT NacionalidadeNome AS ClienteNacionalidadeNome FROM Nacionalidade WHERE NacionalidadeId = :ClienteNacionalidade ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O60,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O61", "SELECT ProfissaoNome AS ResponsavelProfissaoNome FROM Profissao WHERE ProfissaoId = :ResponsavelProfissao ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O61,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O62", "SELECT ProfissaoNome AS ClienteProfissaoNome FROM Profissao WHERE ProfissaoId = :ClienteProfissao ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O62,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O63", "SELECT ConvenioDescricao AS ClienteConvenioDescricao FROM Convenio WHERE ConvenioId = :ClienteConvenio ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O63,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O64", "SELECT ClienteId FROM Cliente WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O64,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O65", "SELECT ClienteId FROM Cliente WHERE ( ClienteId > :ClienteId) ORDER BY ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O65,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O66", "SELECT ClienteId FROM Cliente WHERE ( ClienteId < :ClienteId) ORDER BY ClienteId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O66,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O67", cmdBufferT000O67, GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000O67)
             ,new CursorDef("T000O68", "SELECT currval('ClienteId') ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O68,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O69", cmdBufferT000O69, GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000O69)
             ,new CursorDef("T000O70", "SAVEPOINT gxupdate;DELETE FROM Cliente  WHERE ClienteId = :ClienteId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000O70)
             ,new CursorDef("T000O72", "SELECT COALESCE( T1.SecUserId_F, 0) AS SecUserId_F FROM (SELECT MIN(SecUserId) AS SecUserId_F, SecUserOwnerId FROM SecUser WHERE SecUserOwnerId = :ClienteId GROUP BY SecUserOwnerId ) T1 WHERE T1.SecUserOwnerId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O72,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O74", "SELECT COALESCE( T1.ClienteQtdTitulos_F, 0) AS ClienteQtdTitulos_F FROM (SELECT COUNT(*) AS ClienteQtdTitulos_F, T4.ClienteId FROM ((Titulo T2 LEFT JOIN NotaFiscalParcelamento T3 ON T3.NotaFiscalParcelamentoID = T2.NotaFiscalParcelamentoID) LEFT JOIN NotaFiscal T4 ON T4.NotaFiscalId = T3.NotaFiscalId) WHERE Not T2.TituloDeleted GROUP BY T4.ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O74,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O78", "SELECT COALESCE( T1.ClienteValorAPagar_F, 0) AS ClienteValorAPagar_F FROM (SELECT SUM(COALESCE( T5.TituloSaldoDebito_F, 0)) AS ClienteValorAPagar_F, T4.ClienteId FROM (((Titulo T2 LEFT JOIN NotaFiscalParcelamento T3 ON T3.NotaFiscalParcelamentoID = T2.NotaFiscalParcelamentoID) LEFT JOIN NotaFiscal T4 ON T4.NotaFiscalId = T3.NotaFiscalId) LEFT JOIN (SELECT CASE  WHEN COALESCE( T6.TituloTipo, '') = ( 'DEBITO') THEN ( COALESCE( T6.TituloValor, 0) - COALESCE( T6.TituloDesconto, 0)) - COALESCE( T7.TituloTotalMovimento_F, 0) ELSE 0 END AS TituloSaldoDebito_F, T6.TituloId FROM (Titulo T6 LEFT JOIN LATERAL (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE (T6.TituloId = TituloId) AND (TituloMovimentoSoma) GROUP BY TituloId ) T7 ON T7.TituloId = T6.TituloId) ) T5 ON T5.TituloId = T2.TituloId) GROUP BY T4.ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O78,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O81", "SELECT COALESCE( T1.ClienteValorAReceber_F, 0) AS ClienteValorAReceber_F FROM (SELECT SUM(CASE  WHEN COALESCE( T2.TituloTipo, '') = ( 'CREDITO') THEN ( COALESCE( T2.TituloValor, 0) - COALESCE( T2.TituloDesconto, 0)) - COALESCE( T5.TituloTotalMovimento_F, 0) ELSE 0 END) AS ClienteValorAReceber_F, T4.ClienteId FROM (((Titulo T2 LEFT JOIN NotaFiscalParcelamento T3 ON T3.NotaFiscalParcelamentoID = T2.NotaFiscalParcelamentoID) LEFT JOIN NotaFiscal T4 ON T4.NotaFiscalId = T3.NotaFiscalId) LEFT JOIN LATERAL (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE (T2.TituloId = TituloId) AND (TituloMovimentoSoma) GROUP BY TituloId ) T5 ON T5.TituloId = T2.TituloId) GROUP BY T4.ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O81,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O83", "SELECT COALESCE( T1.SerasaUltimaData_F, DATE '00010101') AS SerasaUltimaData_F, COALESCE( T1.SerasaConsultas_F, 0) AS SerasaConsultas_F FROM (SELECT COUNT(*) AS SerasaConsultas_F, ClienteId, MAX(SerasaCreatedAt) AS SerasaUltimaData_F FROM Serasa GROUP BY ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O83,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O85", "SELECT COALESCE( T1.SerasaScoreUltimaData_F, 0) AS SerasaScoreUltimaData_F, COALESCE( T1.SerasaUltimoValorRecomendado_F, 0) AS SerasaUltimoValorRecomendado_F FROM (SELECT MAX(SerasaScore) AS SerasaScoreUltimaData_F, ClienteId, MAX(SerasaValorLimiteRecomendado) AS SerasaUltimoValorRecomendado_F FROM Serasa WHERE SerasaCreatedAt = :SerasaUltimaData_F GROUP BY ClienteId ) T1 WHERE T1.ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O85,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O86", "SELECT MunicipioNome, MunicipioUF FROM Municipio WHERE MunicipioCodigo = :MunicipioCodigo ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O86,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O87", "SELECT TipoClienteDescricao, TipoClientePortal, TipoClientePortalPjPf FROM TipoCliente WHERE TipoClienteId = :TipoClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O87,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O88", "SELECT MunicipioUF AS ResponsavelMunicipioUF, MunicipioNome AS ResponsavelMunicipioNome FROM Municipio WHERE MunicipioCodigo = :ResponsavelMunicipio ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O88,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O89", "SELECT BancoCodigo, BancoNome FROM Banco WHERE BancoId = :BancoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O89,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O90", "SELECT NacionalidadeNome AS ResponsavelNacionalidadeNome FROM Nacionalidade WHERE NacionalidadeId = :ResponsavelNacionalidade ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O90,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O91", "SELECT NacionalidadeNome AS ClienteNacionalidadeNome FROM Nacionalidade WHERE NacionalidadeId = :ClienteNacionalidade ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O91,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O92", "SELECT ProfissaoNome AS ResponsavelProfissaoNome FROM Profissao WHERE ProfissaoId = :ResponsavelProfissao ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O92,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O93", "SELECT ProfissaoNome AS ClienteProfissaoNome FROM Profissao WHERE ProfissaoId = :ClienteProfissao ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O93,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O94", "SELECT ConvenioDescricao AS ClienteConvenioDescricao FROM Convenio WHERE ConvenioId = :ClienteConvenio ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O94,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O95", "SELECT PropostaId FROM Proposta WHERE PropostaEmpresaClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O95,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O96", "SELECT PropostaId FROM Proposta WHERE PropostaClinicaId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O96,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O97", "SELECT PropostaId FROM Proposta WHERE PropostaResponsavelId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O97,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O98", "SELECT PropostaId FROM Proposta WHERE PropostaPacienteClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O98,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O99", "SELECT ContratoId FROM Contrato WHERE ContratoClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O99,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O100", "SELECT TituloId FROM Titulo WHERE TituloClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O100,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O101", "SELECT SecUserId FROM SecUser WHERE SecUserOwnerId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O101,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O102", "SELECT RepresentanteId FROM Representante WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O102,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O103", "SELECT CreditoId FROM Credito WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O103,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O104", "SELECT NotaFiscalId FROM NotaFiscal WHERE NotaFiscalDestinatarioClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O104,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O105", "SELECT NotaFiscalId FROM NotaFiscal WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O105,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O106", "SELECT SerasaId FROM Serasa WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O106,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O107", "SELECT ClienteDocumentoId FROM ClienteDocumento WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O107,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O108", "SELECT ClienteReponsavelId FROM ClienteReponsavel WHERE ReponsavelClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O108,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O109", "SELECT ClienteReponsavelId FROM ClienteReponsavel WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O109,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O110", "SELECT AssinaturaParticipanteId FROM AssinaturaParticipante WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O110,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O111", "SELECT FinanciamentoId FROM Financiamento WHERE IntermediadorClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O111,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O112", "SELECT FinanciamentoId FROM Financiamento WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O112,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000O113", "SELECT ClienteId FROM Cliente ORDER BY ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O113,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T000O114", "SELECT ClienteDocumento FROM Cliente WHERE (ClienteDocumento = :ClienteDocumento) AND (Not ( ClienteId = :ClienteId)) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000O114,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
