...
namespace GeneXus.Programs.wwpbaseobjects {
   public class promptgeolocation : GXHttpHandler
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918524515", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/promptgeolocation.js", "?202551918524516", false, true);
         context.AddJavascriptSource("GXGoogleVisualizationLibrary/MAP/mapsproviders.js", "", false, true);
         context.AddJavascriptSource("https://unpkg.com/@googlemaps/markerclusterer/dist/index.min.js", "", false, true);
         context.AddJavascriptSource("GXGoogleVisualizationLibrary/MAP/Gxmap.js", "", false, true);
