...
namespace GeneXus.Programs {
   public class tituloproposta_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      {
         /* Scan By routine */
         /* Using cursor BC001X30 */
         pr_default.execute(20, new Object[] {n261TituloId, A261TituloId});
         RcdFound44 = 0;
         if ( (pr_default.getStatus(20) != 101) )
         {
            RcdFound44 = 1;
            A890NotaFiscalParcelamentoID = BC001X30_A890NotaFiscalParcelamentoID[0];
            n890NotaFiscalParcelamentoID = BC001X30_n890NotaFiscalParcelamentoID[0];
            A794NotaFiscalId = BC001X30_A794NotaFiscalId[0];
            n794NotaFiscalId = BC001X30_n794NotaFiscalId[0];
            A261TituloId = BC001X30_A261TituloId[0];
            n261TituloId = BC001X30_n261TituloId[0];
            A170ClienteRazaoSocial = BC001X30_A170ClienteRazaoSocial[0];
            n170ClienteRazaoSocial = BC001X30_n170ClienteRazaoSocial[0];
            A262TituloValor = BC001X30_A262TituloValor[0];
            n262TituloValor = BC001X30_n262TituloValor[0];
            A276TituloDesconto = BC001X30_A276TituloDesconto[0];
            n276TituloDesconto = BC001X30_n276TituloDesconto[0];
            A284TituloDeleted = BC001X30_A284TituloDeleted[0];
            n284TituloDeleted = BC001X30_n284TituloDeleted[0];
            A314TituloArchived = BC001X30_A314TituloArchived[0];
            n314TituloArchived = BC001X30_n314TituloArchived[0];
            A263TituloVencimento = BC001X30_A263TituloVencimento[0];
            n263TituloVencimento = BC001X30_n263TituloVencimento[0];
            A286TituloCompetenciaAno = BC001X30_A286TituloCompetenciaAno[0];
            n286TituloCompetenciaAno = BC001X30_n286TituloCompetenciaAno[0];
            A287TituloCompetenciaMes = BC001X30_A287TituloCompetenciaMes[0];
            n287TituloCompetenciaMes = BC001X30_n287TituloCompetenciaMes[0];
            A264TituloProrrogacao = BC001X30_A264TituloProrrogacao[0];
            n264TituloProrrogacao = BC001X30_n264TituloProrrogacao[0];
            A265TituloCEP = BC001X30_A265TituloCEP[0];
            n265TituloCEP = BC001X30_n265TituloCEP[0];
            A266TituloLogradouro = BC001X30_A266TituloLogradouro[0];
            n266TituloLogradouro = BC001X30_n266TituloLogradouro[0];
            A294TituloNumeroEndereco = BC001X30_A294TituloNumeroEndereco[0];
            n294TituloNumeroEndereco = BC001X30_n294TituloNumeroEndereco[0];
            A267TituloComplemento = BC001X30_A267TituloComplemento[0];
            n267TituloComplemento = BC001X30_n267TituloComplemento[0];
            A268TituloBairro = BC001X30_A268TituloBairro[0];
            n268TituloBairro = BC001X30_n268TituloBairro[0];
            A269TituloMunicipio = BC001X30_A269TituloMunicipio[0];
            n269TituloMunicipio = BC001X30_n269TituloMunicipio[0];
            A498TituloJurosMora = BC001X30_A498TituloJurosMora[0];
            n498TituloJurosMora = BC001X30_n498TituloJurosMora[0];
            A283TituloTipo = BC001X30_A283TituloTipo[0];
            n283TituloTipo = BC001X30_n283TituloTipo[0];
            A501PropostaTaxaAdministrativa = BC001X30_A501PropostaTaxaAdministrativa[0];
            n501PropostaTaxaAdministrativa = BC001X30_n501PropostaTaxaAdministrativa[0];
            A500TituloCriacao = BC001X30_A500TituloCriacao[0];
            n500TituloCriacao = BC001X30_n500TituloCriacao[0];
            A422ContaId = BC001X30_A422ContaId[0];
            n422ContaId = BC001X30_n422ContaId[0];
            A426CategoriaTituloId = BC001X30_A426CategoriaTituloId[0];
            n426CategoriaTituloId = BC001X30_n426CategoriaTituloId[0];
            A419TituloPropostaId = BC001X30_A419TituloPropostaId[0];
            n419TituloPropostaId = BC001X30_n419TituloPropostaId[0];
            A168ClienteId = BC001X30_A168ClienteId[0];
            n168ClienteId = BC001X30_n168ClienteId[0];
            A273TituloTotalMovimento_F = BC001X30_A273TituloTotalMovimento_F[0];
            n273TituloTotalMovimento_F = BC001X30_n273TituloTotalMovimento_F[0];
            A301TituloTotalMultaJuros_F = BC001X30_A301TituloTotalMultaJuros_F[0];
            n301TituloTotalMultaJuros_F = BC001X30_n301TituloTotalMultaJuros_F[0];
         }
      ...
      protected decimal GetTituloTotalMovimentoDebito_F0( int E261TituloId )
      {
         ...
         pr_default.execute(21, new Object[] {nA261TituloId, E261TituloId});
         if ( (pr_default.getStatus(21) != 101) )
         {
            X271TituloMovimentoValor = BC001X31_A271TituloMovimentoValor[0];
            nX271TituloMovimentoValor = BC001X31_n271TituloMovimentoValor[0];
         }
         pr_default.close(21);
      ...
      protected decimal GetTituloTotalMovimentoCredito_F0( int E261TituloId )
      {
         ...
         pr_default.execute(22, new Object[] {nE261TituloId, E261TituloId});
      ...
      public override void initialize( )
      {
         ...
         BC001X27_A270TituloMovimentoId = new int[1] ;
         BC001X30_A890NotaFiscalParcelamentoID = new Guid[] {Guid.Empty} ;
         BC001X30_n890NotaFiscalParcelamentoID = new bool[] {false} ;
         BC001X30_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         BC001X30_n794NotaFiscalId = new bool[] {false} ;
         BC001X30_A261TituloId = new int[1] ;
         BC001X30_n261TituloId = new bool[] {false} ;
         BC001X30_A170ClienteRazaoSocial = new string[] {""} ;
         BC001X30_n170ClienteRazaoSocial = new bool[] {false} ;
         BC001X30_A262TituloValor = new decimal[1] ;
         BC001X30_n262TituloValor = new bool[] {false} ;
         BC001X30_A276TituloDesconto = new decimal[1] ;
         BC001X30_n276TituloDesconto = new bool[] {false} ;
         BC001X30_A284TituloDeleted = new bool[] {false} ;
         BC001X30_n284TituloDeleted = new bool[] {false} ;
         BC001X30_A314TituloArchived = new bool[] {false} ;
         BC001X30_n314TituloArchived = new bool[] {false} ;
         BC001X30_A263TituloVencimento = new DateTime[] {DateTime.MinValue} ;
         BC001X30_n263TituloVencimento = new bool[] {false} ;
         BC001X30_A286TituloCompetenciaAno = new short[1] ;
         BC001X30_n286TituloCompetenciaAno = new bool[] {false} ;
         BC001X30_A287TituloCompetenciaMes = new short[1] ;
         BC001X30_n287TituloCompetenciaMes = new bool[] {false} ;
         BC001X30_A264TituloProrrogacao = new DateTime[] {DateTime.MinValue} ;
         BC001X30_n264TituloProrrogacao = new bool[] {false} ;
         BC001X30_A265TituloCEP = new string[] {""} ;
         BC001X30_n265TituloCEP = new bool[] {false} ;
         BC001X30_A266TituloLogradouro = new string[] {""} ;
         BC001X30_n266TituloLogradouro = new bool[] {false} ;
         BC001X30_A294TituloNumeroEndereco = new string[] {""} ;
         BC001X30_n294TituloNumeroEndereco = new bool[] {false} ;
         BC001X30_A267TituloComplemento = new string[] {""} ;
         BC001X30_n267TituloComplemento = new bool[] {false} ;
         BC001X30_A268TituloBairro = new string[] {""} ;
         BC001X30_n268TituloBairro = new bool[] {false} ;
         BC001X30_A269TituloMunicipio = new string[] {""} ;
         BC001X30_n269TituloMunicipio = new bool[] {false} ;
         BC001X30_A498TituloJurosMora = new decimal[1] ;
         BC001X30_n498TituloJurosMora = new bool[] {false} ;
         BC001X30_A283TituloTipo = new string[] {""} ;
         BC001X30_n283TituloTipo = new bool[] {false} ;
         BC001X30_A501PropostaTaxaAdministrativa = new decimal[1] ;
         BC001X30_n501PropostaTaxaAdministrativa = new bool[] {false} ;
         BC001X30_A500TituloCriacao = new DateTime[] {DateTime.MinValue} ;
         BC001X30_n500TituloCriacao = new bool[] {false} ;
         BC001X30_A422ContaId = new int[1] ;
         BC001X30_n422ContaId = new bool[] {false} ;
         BC001X30_A426CategoriaTituloId = new int[1] ;
         BC001X30_n426CategoriaTituloId = new bool[] {false} ;
         BC001X30_A419TituloPropostaId = new int[1] ;
         BC001X30_n419TituloPropostaId = new bool[] {false} ;
         BC001X30_A168ClienteId = new int[1] ;
         BC001X30_n168ClienteId = new bool[] {false} ;
         BC001X30_A273TituloTotalMovimento_F = new decimal[1] ;
         BC001X30_n273TituloTotalMovimento_F = new bool[] {false} ;
         BC001X30_A301TituloTotalMultaJuros_F = new decimal[1] ;
         BC001X30_n301TituloTotalMultaJuros_F = new bool[] {false} ;
         i500TituloCriacao = (DateTime)(DateTime.MinValue);
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         BC001X31_A271TituloMovimentoValor = new decimal[1] ;
         BC001X31_n271TituloMovimentoValor = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tituloproposta_bc__default(),
            new Object[][] {
               ...
               , new Object[] {
               BC001X27_A270TituloMovimentoId
               }
               , new Object[] {
               BC001X30_A890NotaFiscalParcelamentoID, BC001X30_n890NotaFiscalParcelamentoID, BC001X30_A794NotaFiscalId, BC001X30_n794NotaFiscalId, BC001X30_A261TituloId, BC001X30_A170ClienteRazaoSocial, BC001X30_n170ClienteRazaoSocial, BC001X30_A262TituloValor, BC001X30_n262TituloValor, BC001X30_A276TituloDesconto,
               BC001X30_n276TituloDesconto, BC001X30_A284TituloDeleted, BC001X30_n284TituloDeleted, BC001X30_A314TituloArchived, BC001X30_n314TituloArchived, BC001X30_A263TituloVencimento, BC001X30_n263TituloVencimento, BC001X30_A286TituloCompetenciaAno, BC001X30_n286TituloCompetenciaAno, BC001X30_A287TituloCompetenciaMes,
               BC001X30_n287TituloCompetenciaMes, BC001X30_A264TituloProrrogacao, BC001X30_n264TituloProrrogacao, BC001X30_A265TituloCEP, BC001X30_n265TituloCEP, BC001X30_A266TituloLogradouro, BC001X30_n266TituloLogradouro, BC001X30_A294TituloNumeroEndereco, BC001X30_n294TituloNumeroEndereco, BC001X30_A267TituloComplemento,
               BC001X30_n267TituloComplemento, BC001X30_A268TituloBairro, BC001X30_n268TituloBairro, BC001X30_A269TituloMunicipio, BC001X30_n269TituloMunicipio, BC001X30_A498TituloJurosMora, BC001X30_n498TituloJurosMora, BC001X30_A283TituloTipo, BC001X30_n283TituloTipo, BC001X30_A501PropostaTaxaAdministrativa,
               BC001X30_n501PropostaTaxaAdministrativa, BC001X30_A500TituloCriacao, BC001X30_n500TituloCriacao, BC001X30_A422ContaId, BC001X30_n422ContaId, BC001X30_A426CategoriaTituloId, BC001X30_n426CategoriaTituloId, BC001X30_A419TituloPropostaId, BC001X30_n419TituloPropostaId, BC001X30_A168ClienteId,
               BC001X30_n168ClienteId, BC001X30_A273TituloTotalMovimento_F, BC001X30_n273TituloTotalMovimento_F, BC001X30_A301TituloTotalMultaJuros_F, BC001X30_n301TituloTotalMultaJuros_F
               }
               , new Object[] {
               BC001X31_A271TituloMovimentoValor, BC001X31_n271TituloMovimentoValor
               }
               , new Object[] {
      ...
      private int[] BC001X27_A270TituloMovimentoId ;
      private Guid[] BC001X30_A890NotaFiscalParcelamentoID ;
      private bool[] BC001X30_n890NotaFiscalParcelamentoID ;
      private Guid[] BC001X30_A794NotaFiscalId ;
      private bool[] BC001X30_n794NotaFiscalId ;
      private int[] BC001X30_A261TituloId ;
      private bool[] BC001X30_n261TituloId ;
      private string[] BC001X30_A170ClienteRazaoSocial ;
      private bool[] BC001X30_n170ClienteRazaoSocial ;
      private decimal[] BC001X30_A262TituloValor ;
      private bool[] BC001X30_n262TituloValor ;
      private decimal[] BC001X30_A276TituloDesconto ;
      private bool[] BC001X30_n276TituloDesconto ;
      private bool[] BC001X30_A284TituloDeleted ;
      private bool[] BC001X30_n284TituloDeleted ;
      private bool[] BC001X30_A314TituloArchived ;
      private bool[] BC001X30_n314TituloArchived ;
      private DateTime[] BC001X30_A263TituloVencimento ;
      private bool[] BC001X30_n263TituloVencimento ;
      private short[] BC001X30_A286TituloCompetenciaAno ;
      private bool[] BC001X30_n286TituloCompetenciaAno ;
      private short[] BC001X30_A287TituloCompetenciaMes ;
      private bool[] BC001X30_n287TituloCompetenciaMes ;
      private DateTime[] BC001X30_A264TituloProrrogacao ;
      private bool[] BC001X30_n264TituloProrrogacao ;
      private string[] BC001X30_A265TituloCEP ;
      private bool[] BC001X30_n265TituloCEP ;
      private string[] BC001X30_A266TituloLogradouro ;
      private bool[] BC001X30_n266TituloLogradouro ;
      private string[] BC001X30_A294TituloNumeroEndereco ;
      private bool[] BC001X30_n294TituloNumeroEndereco ;
      private string[] BC001X30_A267TituloComplemento ;
      private bool[] BC001X30_n267TituloComplemento ;
      private string[] BC001X30_A268TituloBairro ;
      private bool[] BC001X30_n268TituloBairro ;
      private string[] BC001X30_A269TituloMunicipio ;
      private bool[] BC001X30_n269TituloMunicipio ;
      private decimal[] BC001X30_A498TituloJurosMora ;
      private bool[] BC001X30_n498TituloJurosMora ;
      private string[] BC001X30_A283TituloTipo ;
      private bool[] BC001X30_n283TituloTipo ;
      private decimal[] BC001X30_A501PropostaTaxaAdministrativa ;
      private bool[] BC001X30_n501PropostaTaxaAdministrativa ;
      private DateTime[] BC001X30_A500TituloCriacao ;
      private bool[] BC001X30_n500TituloCriacao ;
      private int[] BC001X30_A422ContaId ;
      private bool[] BC001X30_n422ContaId ;
      private int[] BC001X30_A426CategoriaTituloId ;
      private bool[] BC001X30_n426CategoriaTituloId ;
      private int[] BC001X30_A419TituloPropostaId ;
      private bool[] BC001X30_n419TituloPropostaId ;
      private int[] BC001X30_A168ClienteId ;
      private bool[] BC001X30_n168ClienteId ;
      private decimal[] BC001X30_A273TituloTotalMovimento_F ;
      private bool[] BC001X30_n273TituloTotalMovimento_F ;
      private decimal[] BC001X30_A301TituloTotalMultaJuros_F ;
      private bool[] BC001X30_n301TituloTotalMultaJuros_F ;
      private SdtTituloProposta bcTituloProposta ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private decimal[] BC001X31_A271TituloMovimentoValor ;
      private bool[] BC001X31_n271TituloMovimentoValor ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("BC001X27", "SELECT TituloMovimentoId FROM TituloMovimento WHERE TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC001X27,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC001X30", "SELECT TM1.NotaFiscalParcelamentoID, T2.NotaFiscalId, TM1.TituloId, T4.ClienteRazaoSocial, TM1.TituloValor, TM1.TituloDesconto, TM1.TituloDeleted, TM1.TituloArchived, TM1.TituloVencimento, TM1.TituloCompetenciaAno, TM1.TituloCompetenciaMes, TM1.TituloProrrogacao, TM1.TituloCEP, TM1.TituloLogradouro, TM1.TituloNumeroEndereco, TM1.TituloComplemento, TM1.TituloBairro, TM1.TituloMunicipio, TM1.TituloJurosMora, TM1.TituloTipo, T7.PropostaTaxaAdministrativa, TM1.TituloCriacao, TM1.ContaId, TM1.CategoriaTituloId, TM1.TituloPropostaId AS TituloPropostaId, T3.ClienteId, COALESCE( T5.TituloTotalMovimento_F, 0) AS TituloTotalMovimento_F, COALESCE( T6.TituloTotalMovimento_F, 0) AS TituloTotalMultaJuros_F FROM ((((((Titulo TM1 LEFT JOIN NotaFiscalParcelamento T2 ON T2.NotaFiscalParcelamentoID = TM1.NotaFiscalParcelamentoID) LEFT JOIN NotaFiscal T3 ON T3.NotaFiscalId = T2.NotaFiscalId) LEFT JOIN Cliente T4 ON T4.ClienteId = T3.ClienteId) LEFT JOIN LATERAL (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE (TM1.TituloId = TituloId) AND (TituloMovimentoSoma) GROUP BY TituloId ) T5 ON T5.TituloId = TM1.TituloId) LEFT JOIN LATERAL (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE (TM1.TituloId = TituloId) AND (Not TituloMovimentoSoma) GROUP BY TituloId ) T6 ON T6.TituloId = TM1.TituloId) LEFT JOIN Proposta T7 ON T7.PropostaId = TM1.TituloPropostaId) WHERE TM1.TituloId = :TituloId ORDER BY TM1.TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC001X30,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("BC001X31", "SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F FROM TituloMovimento WHERE ( TituloId = :TituloId) and ( TituloMovimentoSoma) ",true, GxErrorMask.GX_NOMASK, false, this,prmBC001X31,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("BC001X33", "SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F FROM TituloMovimento WHERE ( TituloId = :TituloId) and ( Not TituloMovimentoSoma) ",true, GxErrorMask.GX_NOMASK, false, this,prmBC001X33,1, GxCacheFrequency.OFF ,true,false )
