...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   ...
   [XmlType(TypeName =  "WWP_FormInstance" , Namespace = "Factory2" )]
   [Serializable]
   public class SdtWWP_FormInstance : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element> gxTpr_Element_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtWWP_FormInstance_Element == null )
            {
               gxTv_SdtWWP_FormInstance_Element = new GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element>( context, "WWP_FormInstance.Element", "Factory2");
            }
   ...
   [DataContract(Name = @"WorkWithPlus\DynamicForms\WWP_FormInstance", Namespace = "Factory2")]
