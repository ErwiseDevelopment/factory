...
namespace GeneXus.Programs {
   public class wcontrato : GXDataArea
   {
      ...
      public override void initialize( )
      {
         ...
         AV10UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV11FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
