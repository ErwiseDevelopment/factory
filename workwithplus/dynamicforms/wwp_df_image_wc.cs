...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_image_wc : GXWebComponent
   {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_image_wc.js", "?20256101965961", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV25UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory21");
         AV38FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory21");
         AV42Imagereadonly_GXI = "";
         ...
         AV7Data = "";
         AV26Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory21");
         AV22ThisValueStr = "";
