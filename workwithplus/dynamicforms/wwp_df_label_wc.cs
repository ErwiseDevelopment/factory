   ...
   public class wwp_df_label_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_label_wc"+UrlEncode(StringUtil.LTrimStr(AV9WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_label_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_label_wc");
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_label_wc")), "workwithplus.dynamicforms.wwp_df_label_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_label_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E111B2( )
      {
         ...
         {
            A98WWPFormElementId = H001B2_A98WWPFormElementId[0];
            A95WWPFormVersionNumber = H001B2_A95WWPFormVersionNumber[0];
            A94WWPFormId = H001B2_A94WWPFormId[0];
            A117WWPFormElementTitle = H001B2_A117WWPFormElementTitle[0];
            A124WWPFormElementMetadata = H001B2_A124WWPFormElementMetadata[0];
            lblLabel_Caption = A117WWPFormElementTitle;
            AssignProp(sPrefix, false, lblLabel_Internalname, "Caption", lblLabel_Caption, true);
            AV8WWP_DF_LabelMetadata.FromJSonString(A124WWPFormElementMetadata, null);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918382346", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_label_wc.js", "?202551918382346", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV7VisibleCondition","fld":"vVISIBLECONDITION","hsh":true,"type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E121B2","iparms":[{"av":"AV5AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV6SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV7VisibleCondition","fld":"vVISIBLECONDITION","hsh":true,"type":""},{"av":"AV11WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV10WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H001B2_A98WWPFormElementId = new short[1] ;
         H001B2_A95WWPFormVersionNumber = new short[1] ;
         H001B2_A94WWPFormId = new short[1] ;
         H001B2_A117WWPFormElementTitle = new string[] {""} ;
         H001B2_A124WWPFormElementMetadata = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_label_wc__default(),
            new Object[][] {
                new Object[] {
               H001B2_A98WWPFormElementId, H001B2_A95WWPFormVersionNumber, H001B2_A94WWPFormId, H001B2_A117WWPFormElementTitle, H001B2_A124WWPFormElementMetadata
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H001B2_A98WWPFormElementId ;
      private short[] H001B2_A95WWPFormVersionNumber ;
      private short[] H001B2_A94WWPFormId ;
      private string[] H001B2_A117WWPFormElementTitle ;
      private string[] H001B2_A124WWPFormElementMetadata ;
   ...
   public class wwp_df_label_wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001B2", "SELECT WWPFormElementId, WWPFormVersionNumber, WWPFormId, WWPFormElementTitle, WWPFormElementMetadata FROM WWP_FormElement WHERE WWPFormId = :AV10WWPF_2Wwpformid and WWPFormVersionNumber = :AV10WWPF_1Wwpformversionnumbe and WWPFormElementId = :AV9WWPFormElementId ORDER BY WWPFormId, WWPFormVersionNumber, WWPFormElementId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
