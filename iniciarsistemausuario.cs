...
namespace GeneXus.Programs {
   public class iniciarsistemausuario : GXWebComponent
   {
      public iniciarsistemausuario( )
      {
      ...
      public iniciarsistemausuario( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               edtavSecusername_Enabled = 0;
               AssignProp(sPrefix, false, edtavSecusername_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSecusername_Enabled), 5, 0), true);
               WS7L2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Iniciar Sistema Usuario") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "iniciarsistemausuario"+UrlEncode(StringUtil.RTrim(AV6WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("iniciarsistemausuario") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSECUSERNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV12SecUserName, "@!")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"IniciarSistemaUsuario");
         forbiddenHiddens.Add("SecUserName", StringUtil.RTrim( context.localUtil.Format( AV12SecUserName, "@!")));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("iniciarsistemausuario:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return "IniciarSistemaUsuario" ;
      }

      public override string GetPgmdesc( )
      {
         return "Iniciar Sistema Usuario" ;
      }
      ...
      protected void WB7L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "iniciarsistemausuario");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            }
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtavSecusername_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSecusername_Internalname, "Usuário", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 17,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSecusername_Internalname, AV12SecUserName, StringUtil.RTrim( context.localUtil.Format( AV12SecUserName, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,17);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecusername_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavSecusername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_IniciarSistemaUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtavSecuserfullname_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSecuserfullname_Internalname, "Nome", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 22,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSecuserfullname_Internalname, AV13SecUserFullName, StringUtil.RTrim( context.localUtil.Format( AV13SecUserFullName, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,22);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecuserfullname_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavSecuserfullname_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_IniciarSistemaUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtavSecuseremail_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSecuseremail_Internalname, "E-mail", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 27,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSecuseremail_Internalname, AV14SecUserEmail, StringUtil.RTrim( context.localUtil.Format( AV14SecUserEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,27);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecuseremail_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavSecuseremail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, false, "", "start", true, "", "HLP_IniciarSistemaUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtavSecuserpassword_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSecuserpassword_Internalname, "Senha", "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 32,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSecuserpassword_Internalname, AV15SecUserPassword, StringUtil.RTrim( context.localUtil.Format( AV15SecUserPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,32);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecuserpassword_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavSecuserpassword_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, -1, 0, 0, 0, 0, -1, false, "", "start", true, "", "HLP_IniciarSistemaUsuario.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START7L2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Iniciar Sistema Usuario", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "iniciarsistemausuario")), "iniciarsistemausuario") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "iniciarsistemausuario")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void STRUP7L0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            forbiddenHiddens = new GXProperties();
            forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"IniciarSistemaUsuario");
            AV12SecUserName = cgiGet( edtavSecusername_Internalname);
            AssignAttri(sPrefix, false, "AV12SecUserName", AV12SecUserName);
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSECUSERNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV12SecUserName, "@!")), context));
            forbiddenHiddens.Add("SecUserName", StringUtil.RTrim( context.localUtil.Format( AV12SecUserName, "@!")));
            hsh = cgiGet( sPrefix+"hsh");
            if ( ! GXUtil.CheckEncryptedHash( forbiddenHiddens.ToString(), hsh, GXKey) )
            {
               GXUtil.WriteLogError("iniciarsistemausuario:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
               context.HttpContext.Response.StatusCode = 403;
               context.WriteHtmlText( "<title>403 Forbidden</title>") ;
               context.WriteHtmlText( "<h1>403 Forbidden</h1>") ;
      ...
      protected void E137L2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "iniciarsistema"+UrlEncode(StringUtil.RTrim("Usuario")) + "," + UrlEncode(StringUtil.RTrim("Empresa")) + "," + UrlEncode(StringUtil.BoolToStr(true));
      ...
      protected void S112( )
      {
         ...
         AV12SecUserName = AV11WizardData.gxTpr_Usuario.gxTpr_Secusername;
         AssignAttri(sPrefix, false, "AV12SecUserName", AV12SecUserName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vSECUSERNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV12SecUserName, "@!")), context));
         AV13SecUserFullName = AV11WizardData.gxTpr_Usuario.gxTpr_Secuserfullname;
         AssignAttri(sPrefix, false, "AV13SecUserFullName", AV13SecUserFullName);
         AV14SecUserEmail = AV11WizardData.gxTpr_Usuario.gxTpr_Secuseremail;
         AssignAttri(sPrefix, false, "AV14SecUserEmail", AV14SecUserEmail);
         AV15SecUserPassword = AV11WizardData.gxTpr_Usuario.gxTpr_Secuserpassword;
         AssignAttri(sPrefix, false, "AV15SecUserPassword", AV15SecUserPassword);
      }
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         AV11WizardData.FromJSonString(AV5WebSession.Get(AV6WebSessionKey), null);
         AV11WizardData.gxTpr_Usuario.gxTpr_Secusername = AV12SecUserName;
         AV11WizardData.gxTpr_Usuario.gxTpr_Secuserfullname = AV13SecUserFullName;
         AV11WizardData.gxTpr_Usuario.gxTpr_Secuseremail = AV14SecUserEmail;
         AV11WizardData.gxTpr_Usuario.gxTpr_Secuserpassword = AV15SecUserPassword;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "iniciarsistemausuario", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918444424", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("iniciarsistemausuario.js", "?202551918444425", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtavSecuserfullname_Internalname = sPrefix+"vSECUSERFULLNAME";
         edtavSecuseremail_Internalname = sPrefix+"vSECUSEREMAIL";
         edtavSecuserpassword_Internalname = sPrefix+"vSECUSERPASSWORD";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavSecuserfullname_Jsonclick = "";
         edtavSecuserfullname_Enabled = 1;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV12SecUserName","fld":"vSECUSERNAME","pic":"@!","hsh":true,"type":"svchar"}]}""");
         setEventMetadata("ENTER","""{"handler":"E127L2","iparms":[{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"AV12SecUserName","fld":"vSECUSERNAME","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV13SecUserFullName","fld":"vSECUSERFULLNAME","pic":"@!","type":"svchar"},{"av":"AV14SecUserEmail","fld":"vSECUSEREMAIL","type":"svchar"},{"av":"AV15SecUserPassword","fld":"vSECUSERPASSWORD","type":"svchar"}]}""");
         setEventMetadata("'WIZARDPREVIOUS'","""{"handler":"E137L2","iparms":[{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"AV12SecUserName","fld":"vSECUSERNAME","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV13SecUserFullName","fld":"vSECUSERFULLNAME","pic":"@!","type":"svchar"},{"av":"AV14SecUserEmail","fld":"vSECUSEREMAIL","type":"svchar"},{"av":"AV15SecUserPassword","fld":"vSECUSERPASSWORD","type":"svchar"}]}""");
      ...
      private int edtavSecuserfullname_Enabled ;
      ...
      private string edtavSecuserfullname_Internalname ;
      private string edtavSecuserfullname_Jsonclick ;
      ...
      private string AV12SecUserName ;
      private string AV13SecUserFullName ;
      private string AV14SecUserEmail ;
