...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_text_wc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025610197950", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_text_wc.js", "?2025610197951", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV23Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory21");
         AV22ThisValueStr = "";
