...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_subscriptionssettingsbyrolewc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV26Pgmname, A20WWPEntityId, AV13WWPEntityId, A30WWPNotificationDefinitionAppliesTo, A23WWPNotificationDefinitionId, A29WWPNotificationDefinitionDescription, A19WWPSubscriptionRoleId, AV16WWPSubscriptionRoleId, A25WWPSubscriptionId, AV10NotifShowOnlySubscribedEvents, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrolewc"+UrlEncode(StringUtil.LTrimStr(AV13WWPEntityId,10,0)) + "," + UrlEncode(StringUtil.BoolToStr(AV10NotifShowOnlySubscribedEvents)) + "," + UrlEncode(StringUtil.RTrim(AV16WWPSubscriptionRoleId));
      ...
      protected void WB0V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrolewc");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            }
            ...
            wb_table1_11_0V2( true) ;
         }
         else
         {
            wb_table1_11_0V2( false) ;
         }
         return  ;
      }

      protected void wb_table1_11_0V2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</div>") ;
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrolewc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      private void E140V2( )
      {
         ...
         {
            A23WWPNotificationDefinitionId = H000V2_A23WWPNotificationDefinitionId[0];
            A30WWPNotificationDefinitionAppliesTo = H000V2_A30WWPNotificationDefinitionAppliesTo[0];
            A20WWPEntityId = H000V2_A20WWPEntityId[0];
            A29WWPNotificationDefinitionDescription = H000V2_A29WWPNotificationDefinitionDescription[0];
            AV5WWPNotificationDefinitionId = A23WWPNotificationDefinitionId;
            AssignAttri(sPrefix, false, edtavWwpnotificationdefinitionid_Internalname, StringUtil.LTrimStr( (decimal)(AV5WWPNotificationDefinitionId), 10, 0));
            AV15WWPNotificationDescriptionBase = A29WWPNotificationDefinitionDescription;
            ...
            AssignAttri(sPrefix, false, edtavWwpsubscriptionid_Internalname, StringUtil.LTrimStr( (decimal)(AV6WWPSubscriptionId), 10, 0));
            /* Using cursor H000V3 */
            pr_default.execute(1, new Object[] {A23WWPNotificationDefinitionId, AV16WWPSubscriptionRoleId, A30WWPNotificationDefinitionAppliesTo});
            while ( (pr_default.getStatus(1) != 101) )
            {
               A19WWPSubscriptionRoleId = H000V3_A19WWPSubscriptionRoleId[0];
               n19WWPSubscriptionRoleId = H000V3_n19WWPSubscriptionRoleId[0];
               A25WWPSubscriptionId = H000V3_A25WWPSubscriptionId[0];
      ...
      protected void wb_table1_11_0V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 14 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_11_0V2e( true) ;
         }
         else
         {
            wb_table1_11_0V2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101965347", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/subscriptions/wwp_subscriptionssettingsbyrolewc.js", "?20256101965347", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"edtavWwpnotificationdefinitionid_Visible","ctrl":"vWWPNOTIFICATIONDEFINITIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionid_Visible","ctrl":"vWWPSUBSCRIPTIONID","prop":"Visible"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV13WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"AV16WWPSubscriptionRoleId","fld":"vWWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV10NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV26Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140V2","iparms":[{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV13WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"AV16WWPSubscriptionRoleId","fld":"vWWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV10NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV5WWPNotificationDefinitionId","fld":"vWWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV14WWPNotificationDescription","fld":"vWWPNOTIFICATIONDESCRIPTION","type":"svchar"},{"av":"AV9IncludeNotification","fld":"vINCLUDENOTIFICATION","type":"boolean"},{"av":"AV6WWPSubscriptionId","fld":"vWWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("TABLESUBSCRIPTIONITEM.CLICK","""{"handler":"E110V2","iparms":[{"av":"AV9IncludeNotification","fld":"vINCLUDENOTIFICATION","grid":14,"type":"boolean"},{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_14","ctrl":"GRID","prop":"GridRC","grid":14,"type":"int"},{"av":"AV6WWPSubscriptionId","fld":"vWWPSUBSCRIPTIONID","grid":14,"pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV5WWPNotificationDefinitionId","fld":"vWWPNOTIFICATIONDEFINITIONID","grid":14,"pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV16WWPSubscriptionRoleId","fld":"vWWPSUBSCRIPTIONROLEID","type":"char"}]""");
         setEventMetadata("TABLESUBSCRIPTIONITEM.CLICK",""","oparms":[{"av":"AV9IncludeNotification","fld":"vINCLUDENOTIFICATION","type":"boolean"},{"av":"AV6WWPSubscriptionId","fld":"vWWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"edtavWwpnotificationdefinitionid_Visible","ctrl":"vWWPNOTIFICATIONDEFINITIONID","prop":"Visible"},{"av":"edtavWwpsubscriptionid_Visible","ctrl":"vWWPSUBSCRIPTIONID","prop":"Visible"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV13WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A30WWPNotificationDefinitionAppliesTo","fld":"WWPNOTIFICATIONDEFINITIONAPPLIESTO","pic":"9","type":"int"},{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"AV16WWPSubscriptionRoleId","fld":"vWWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV10NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"AV26Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000V2_A23WWPNotificationDefinitionId = new long[1] ;
         H000V2_A30WWPNotificationDefinitionAppliesTo = new short[1] ;
         H000V2_A20WWPEntityId = new long[1] ;
         H000V2_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         AV15WWPNotificationDescriptionBase = "";
         H000V3_A23WWPNotificationDefinitionId = new long[1] ;
         H000V3_A19WWPSubscriptionRoleId = new string[] {""} ;
         H000V3_n19WWPSubscriptionRoleId = new bool[] {false} ;
         H000V3_A25WWPSubscriptionId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrolewc__default(),
            new Object[][] {
                new Object[] {
               H000V2_A23WWPNotificationDefinitionId, H000V2_A30WWPNotificationDefinitionAppliesTo, H000V2_A20WWPEntityId, H000V2_A29WWPNotificationDefinitionDescription
               }
               , new Object[] {
               H000V3_A23WWPNotificationDefinitionId, H000V3_A19WWPSubscriptionRoleId, H000V3_n19WWPSubscriptionRoleId, H000V3_A25WWPSubscriptionId
               }
            }
         );
         AV26Pgmname = "WWPBaseObjects.Subscriptions.WWP_SubscriptionsSettingsByRoleWC";
      ...
      private long[] H000V2_A23WWPNotificationDefinitionId ;
      private short[] H000V2_A30WWPNotificationDefinitionAppliesTo ;
      private long[] H000V2_A20WWPEntityId ;
      private string[] H000V2_A29WWPNotificationDefinitionDescription ;
      private long[] H000V3_A23WWPNotificationDefinitionId ;
      private string[] H000V3_A19WWPSubscriptionRoleId ;
      private bool[] H000V3_n19WWPSubscriptionRoleId ;
      private long[] H000V3_A25WWPSubscriptionId ;
