...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   public class wwp_visualizenotification : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wwpbaseobjects.notifications.common.wwp_visualizenotification"+UrlEncode(StringUtil.LTrimStr(AV7WWPNotificationId,10,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.notifications.common.wwp_visualizenotification") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.notifications.common.wwp_visualizenotification"+UrlEncode(StringUtil.LTrimStr(AV7WWPNotificationId,10,0));
         return formatLink("wwpbaseobjects.notifications.common.wwp_visualizenotification") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "CardNotificationAttributeDescription";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtWWPNotificationShortDescription_Internalname, A78WWPNotificationShortDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", 0, 1, edtWWPNotificationShortDescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_WWPBaseObjects/Notifications/Common/WWP_VisualizeNotification.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void PA0Q2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.notifications.common.wwp_visualizenotification")), "wwpbaseobjects.notifications.common.wwp_visualizenotification") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.notifications.common.wwp_visualizenotification")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void RF0Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A22WWPNotificationId = H000Q2_A22WWPNotificationId[0];
               A82WWPNotificationIsRead = H000Q2_A82WWPNotificationIsRead[0];
               A78WWPNotificationShortDescription = H000Q2_A78WWPNotificationShortDescription[0];
               AssignAttri("", false, "A78WWPNotificationShortDescription", A78WWPNotificationShortDescription);
               A24WWPNotificationCreated = H000Q2_A24WWPNotificationCreated[0];
               AssignAttri("", false, "A24WWPNotificationCreated", context.localUtil.TToC( A24WWPNotificationCreated, 10, 12, 0, 3, "/", ":", " "));
               A77WWPNotificationTitle = H000Q2_A77WWPNotificationTitle[0];
      ...
      protected void E110Q2( )
      {
         ...
         {
            A22WWPNotificationId = H000Q3_A22WWPNotificationId[0];
            A7WWPUserExtendedId = H000Q3_A7WWPUserExtendedId[0];
            n7WWPUserExtendedId = H000Q3_n7WWPUserExtendedId[0];
            A79WWPNotificationLink = H000Q3_A79WWPNotificationLink[0];
            A60WWPNotificationMetadata = H000Q3_A60WWPNotificationMetadata[0];
            n60WWPNotificationMetadata = H000Q3_n60WWPNotificationMetadata[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019224721", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/notifications/common/wwp_visualizenotification.js", "?202561019224721", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV7WWPNotificationId","fld":"vWWPNOTIFICATIONID","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMARKASREAD'","""{"handler":"E120Q2","iparms":[{"av":"AV7WWPNotificationId","fld":"vWWPNOTIFICATIONID","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H000Q2_A22WWPNotificationId = new long[1] ;
         H000Q2_A82WWPNotificationIsRead = new bool[] {false} ;
         H000Q2_A78WWPNotificationShortDescription = new string[] {""} ;
         H000Q2_A24WWPNotificationCreated = new DateTime[] {DateTime.MinValue} ;
         H000Q2_A77WWPNotificationTitle = new string[] {""} ;
         H000Q3_A22WWPNotificationId = new long[1] ;
         H000Q3_A7WWPUserExtendedId = new string[] {""} ;
         H000Q3_n7WWPUserExtendedId = new bool[] {false} ;
         H000Q3_A79WWPNotificationLink = new string[] {""} ;
         H000Q3_A60WWPNotificationMetadata = new string[] {""} ;
         H000Q3_n60WWPNotificationMetadata = new bool[] {false} ;
         A7WWPUserExtendedId = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.notifications.common.wwp_visualizenotification__default(),
            new Object[][] {
                new Object[] {
               H000Q2_A22WWPNotificationId, H000Q2_A82WWPNotificationIsRead, H000Q2_A78WWPNotificationShortDescription, H000Q2_A24WWPNotificationCreated, H000Q2_A77WWPNotificationTitle
               }
               , new Object[] {
               H000Q3_A22WWPNotificationId, H000Q3_A7WWPUserExtendedId, H000Q3_n7WWPUserExtendedId, H000Q3_A79WWPNotificationLink, H000Q3_A60WWPNotificationMetadata, H000Q3_n60WWPNotificationMetadata
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] H000Q2_A22WWPNotificationId ;
      private bool[] H000Q2_A82WWPNotificationIsRead ;
      private string[] H000Q2_A78WWPNotificationShortDescription ;
      private DateTime[] H000Q2_A24WWPNotificationCreated ;
      private string[] H000Q2_A77WWPNotificationTitle ;
      private long[] H000Q3_A22WWPNotificationId ;
      private string[] H000Q3_A7WWPUserExtendedId ;
      private bool[] H000Q3_n7WWPUserExtendedId ;
      private string[] H000Q3_A79WWPNotificationLink ;
      private string[] H000Q3_A60WWPNotificationMetadata ;
      private bool[] H000Q3_n60WWPNotificationMetadata ;
   ...
   public class wwp_visualizenotification__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000Q2", "SELECT WWPNotificationId, WWPNotificationIsRead, WWPNotificationShortDescription, WWPNotificationCreated, WWPNotificationTitle FROM WWP_Notification WHERE WWPNotificationId = :AV7WWPNotificationId ORDER BY WWPNotificationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H000Q3", "SELECT WWPNotificationId, WWPUserExtendedId, WWPNotificationLink, WWPNotificationMetadata FROM WWP_Notification WHERE WWPNotificationId = :AV7WWPNotificationId ORDER BY WWPNotificationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q3,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
