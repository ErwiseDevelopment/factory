...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_getentitybyname : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A21WWPEntityName = P002A2_A21WWPEntityName[0];
            A20WWPEntityId = P002A2_A20WWPEntityId[0];
            AV11GXLvl1 = 1;
      ...
      {
         P002A2_A21WWPEntityName = new string[] {""} ;
         P002A2_A20WWPEntityId = new long[1] ;
         A21WWPEntityName = "";
         AV10WWP_Entity = new GeneXus.Programs.wwpbaseobjects.SdtWWP_Entity(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.wwp_getentitybyname__default(),
            new Object[][] {
                new Object[] {
               P002A2_A21WWPEntityName, P002A2_A20WWPEntityId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P002A2_A21WWPEntityName ;
      private long[] P002A2_A20WWPEntityId ;
   ...
   public class wwp_getentitybyname__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P002A2", "SELECT WWPEntityName, WWPEntityId FROM WWP_Entity WHERE WWPEntityName = ( :AV8WWPEntityName) ORDER BY WWPEntityId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP002A2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
