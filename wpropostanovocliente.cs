...
namespace GeneXus.Programs {
   public class wpropostanovocliente : GXWebComponent
   {
      public wpropostanovocliente( )
      {
      ...
      public wpropostanovocliente( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WProposta Novo Cliente") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpropostanovocliente"+UrlEncode(StringUtil.RTrim(AV6WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpropostanovocliente") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WPropostaNovoCliente" ;
      }

      public override string GetPgmdesc( )
      {
         return "WProposta Novo Cliente" ;
      }
      ...
      protected void WB6U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpropostanovocliente");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavClientedatanascimento_Internalname, context.localUtil.Format(AV58ClienteDataNascimento, "99/99/9999"), context.localUtil.Format( AV58ClienteDataNascimento, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,26);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClientedatanascimento_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClientedatanascimento_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_bitmap( context, edtavClientedatanascimento_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavClientedatanascimento_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WPropostaNovoCliente.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClienterazaosocial_Internalname, AV14ClienteRazaoSocial, StringUtil.RTrim( context.localUtil.Format( AV14ClienteRazaoSocial, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,30);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClienterazaosocial_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClienterazaosocial_Enabled, 1, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_clientenacionalidade_Internalname, "Nacionalidade", "", "", lblTextblockcombo_clientenacionalidade_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_clienteprofissao_Internalname, "Profissão", "", "", lblTextblockcombo_clienteprofissao_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            ucCombo_clienteprofissao.SetProperty("IncludeAddNewOption", Combo_clienteprofissao_Includeaddnewoption);
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavPossuiresponsavel, cmbavPossuiresponsavel_Internalname, StringUtil.BoolToStr( AV59PossuiResponsavel), 1, cmbavPossuiresponsavel_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "boolean", "", 1, cmbavPossuiresponsavel.Enabled, 1, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,58);\"", "", true, 0, "HLP_WPropostaNovoCliente.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClientenomefantasia_Internalname, AV15ClienteNomeFantasia, StringUtil.RTrim( context.localUtil.Format( AV15ClienteNomeFantasia, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,65);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClientenomefantasia_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClientenomefantasia_Enabled, 1, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup1_Internalname, "Endereço", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaNovoCliente.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavCep_Internalname, AV41CEP, StringUtil.RTrim( context.localUtil.Format( AV41CEP, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,74);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCep_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavCep_Enabled, 1, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavEnderecocomplemento_Internalname, AV31EnderecoComplemento, StringUtil.RTrim( context.localUtil.Format( AV31EnderecoComplemento, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,87);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEnderecocomplemento_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavEnderecocomplemento_Enabled, 1, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavEnderecobairro_Internalname, AV25EnderecoBairro, StringUtil.RTrim( context.localUtil.Format( AV25EnderecoBairro, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,91);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEnderecobairro_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavEnderecobairro_Enabled, 1, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup2_Internalname, "Contato", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaNovoCliente.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavContatoemail_Internalname, AV33ContatoEmail, StringUtil.RTrim( context.localUtil.Format( AV33ContatoEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,113);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContatoemail_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContatoemail_Enabled, 1, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcontatoddd_Internalname, "Celular", "", "", lblTextblockcontatoddd_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_121_6U2( true) ;
         }
         else
         {
            wb_table1_121_6U2( false) ;
         }
         return  ;
      }

      protected void wb_table1_121_6U2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcontatotelefoneddd_Internalname, "Telefone", "", "", lblTextblockcontatotelefoneddd_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table2_135_6U2( true) ;
         }
         else
         {
            wb_table2_135_6U2( false) ;
         }
         return  ;
      }

      protected void wb_table2_135_6U2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClientenacionalidade_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV51ClienteNacionalidade), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV51ClienteNacionalidade), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,153);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClientenacionalidade_Jsonclick, 0, "Attribute", "", "", "", "", edtavClientenacionalidade_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaNovoCliente.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 154,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavClienteprofissao_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV53ClienteProfissao), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV53ClienteProfissao), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,154);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClienteprofissao_Jsonclick, 0, "Attribute", "", "", "", "", edtavClienteprofissao_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaNovoCliente.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 155,'" + sPrefix + "',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavClientetipopessoa, cmbavClientetipopessoa_Internalname, StringUtil.RTrim( AV16ClienteTipoPessoa), 1, cmbavClientetipopessoa_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", cmbavClientetipopessoa.Visible, cmbavClientetipopessoa.Enabled, 1, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,155);\"", "", true, 0, "HLP_WPropostaNovoCliente.htm");
      ...
      protected void START6U2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WProposta Novo Cliente", 0) ;
            context.wjLoc = "";
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "COMBO_CLIENTEPROFISSAO.ONOPTIONCLICKED") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP6U0( ) ;
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    /* Execute user event: Combo_clienteprofissao.Onoptionclicked */
                                    E116U2 ();
                                 }
                              }
                           }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpropostanovocliente")), "wpropostanovocliente") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpropostanovocliente")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void STRUP6U0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            Combo_clienteprofissao_Selectedvalue_get = cgiGet( sPrefix+"COMBO_CLIENTEPROFISSAO_Selectedvalue_get");
      ...
      protected void E126U2( )
      {
         ...
         {
            A219TipoClienteFinancia = H006U2_A219TipoClienteFinancia[0];
            n219TipoClienteFinancia = H006U2_n219TipoClienteFinancia[0];
            A192TipoClienteId = H006U2_A192TipoClienteId[0];
            n192TipoClienteId = H006U2_n192TipoClienteId[0];
      ...
      protected void E136U2( )
      {
         ...
         if ( AV12ClienteBC.Success() )
         {
            ...
            AssignAttri(sPrefix, false, "AV39ClienteId", StringUtil.LTrimStr( (decimal)(AV39ClienteId), 9, 0));
            context.CommitDataStores("wpropostanovocliente",pr_default);
            if ( AV59PossuiResponsavel )
            {
               ...
               if ( AV42CheckRequiredFieldsResult && ! AV10HasValidationErrors )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  GXEncryptionTmp = "wproposta"+UrlEncode(StringUtil.RTrim("NovoCliente")) + "," + UrlEncode(StringUtil.RTrim("Responsavel")) + "," + UrlEncode(StringUtil.BoolToStr(false));
            ...
            else
            {
               ...
               if ( AV42CheckRequiredFieldsResult && ! AV10HasValidationErrors )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  GXEncryptionTmp = "wproposta"+UrlEncode(StringUtil.RTrim("NovoCliente")) + "," + UrlEncode(StringUtil.RTrim("Conta")) + "," + UrlEncode(StringUtil.BoolToStr(false));
                  CallWebObject(formatLink("wproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
                  context.wjLocDisableFrm = 1;
               }
            }
         ...
         {
            context.RollbackDataStores("wpropostanovocliente",pr_default);
      ...
      protected void E146U2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wproposta"+UrlEncode(StringUtil.RTrim("NovoCliente")) + "," + UrlEncode(StringUtil.RTrim("Clinica")) + "," + UrlEncode(StringUtil.BoolToStr(true));
         CallWebObject(formatLink("wproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV12ClienteBC", AV12ClienteBC);
      ...
      {
         /* Combo_clienteprofissao_Onoptionclicked Routine */
         returnInSub = false;
         if ( StringUtil.StrCmp(Combo_clienteprofissao_Selectedvalue_get, "<#NEW#>") == 0 )
         {
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
         ...
         else if ( StringUtil.StrCmp(Combo_clienteprofissao_Selectedvalue_get, "<#POPUP_CLOSED#>") == 0 )
         {
            /* Execute user subroutine: 'LOADCOMBOCLIENTEPROFISSAO' */
            S132 ();
            if (returnInSub) return;
            AV45ComboSelectedValue = AV56Session.Get("PROFISSAOID");
            AV56Session.Remove("PROFISSAOID");
            Combo_clienteprofissao_Selectedvalue_set = AV45ComboSelectedValue;
            ...
            AV53ClienteProfissao = (int)(Math.Round(NumberUtil.Val( AV45ComboSelectedValue, "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV53ClienteProfissao", StringUtil.LTrimStr( (decimal)(AV53ClienteProfissao), 9, 0));
         }
         else
         {
            AV53ClienteProfissao = (int)(Math.Round(NumberUtil.Val( Combo_clienteprofissao_Selectedvalue_get, "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV53ClienteProfissao", StringUtil.LTrimStr( (decimal)(AV53ClienteProfissao), 9, 0));
            /* Execute user subroutine: 'LOADCOMBOCLIENTEPROFISSAO' */
            S132 ();
            if (returnInSub) return;
         ...
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV55ClienteProfissao_Data", AV55ClienteProfissao_Data);
      }
      ...
      protected void S132( )
      {
         ...
         {
            A440ProfissaoId = H006U3_A440ProfissaoId[0];
            A441ProfissaoNome = H006U3_A441ProfissaoNome[0];
            n441ProfissaoNome = H006U3_n441ProfissaoNome[0];
      ...
      protected void S122( )
      {
         ...
         {
            A434NacionalidadeId = H006U4_A434NacionalidadeId[0];
            A435NacionalidadeNome = H006U4_A435NacionalidadeNome[0];
            n435NacionalidadeNome = H006U4_n435NacionalidadeNome[0];
            AV46Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void E166U2( )
      {
         ...
         {
            A457EspecialidadeId = H006U5_A457EspecialidadeId[0];
            n457EspecialidadeId = H006U5_n457EspecialidadeId[0];
            A597EspecialidadeCreatedBy = H006U5_A597EspecialidadeCreatedBy[0];
            n597EspecialidadeCreatedBy = H006U5_n597EspecialidadeCreatedBy[0];
            A169ClienteDocumento = H006U5_A169ClienteDocumento[0];
            n169ClienteDocumento = H006U5_n169ClienteDocumento[0];
            A170ClienteRazaoSocial = H006U5_A170ClienteRazaoSocial[0];
            n170ClienteRazaoSocial = H006U5_n170ClienteRazaoSocial[0];
            A171ClienteNomeFantasia = H006U5_A171ClienteNomeFantasia[0];
            n171ClienteNomeFantasia = H006U5_n171ClienteNomeFantasia[0];
            A172ClienteTipoPessoa = H006U5_A172ClienteTipoPessoa[0];
            n172ClienteTipoPessoa = H006U5_n172ClienteTipoPessoa[0];
            A192TipoClienteId = H006U5_A192TipoClienteId[0];
            n192TipoClienteId = H006U5_n192TipoClienteId[0];
            A193TipoClienteDescricao = H006U5_A193TipoClienteDescricao[0];
            n193TipoClienteDescricao = H006U5_n193TipoClienteDescricao[0];
            A174ClienteStatus = H006U5_A174ClienteStatus[0];
            n174ClienteStatus = H006U5_n174ClienteStatus[0];
            A141SecUserName = H006U5_A141SecUserName[0];
            n141SecUserName = H006U5_n141SecUserName[0];
            A181EnderecoTipo = H006U5_A181EnderecoTipo[0];
            n181EnderecoTipo = H006U5_n181EnderecoTipo[0];
            A182EnderecoCEP = H006U5_A182EnderecoCEP[0];
            n182EnderecoCEP = H006U5_n182EnderecoCEP[0];
            A183EnderecoLogradouro = H006U5_A183EnderecoLogradouro[0];
            n183EnderecoLogradouro = H006U5_n183EnderecoLogradouro[0];
            A184EnderecoBairro = H006U5_A184EnderecoBairro[0];
            n184EnderecoBairro = H006U5_n184EnderecoBairro[0];
            A185EnderecoCidade = H006U5_A185EnderecoCidade[0];
            n185EnderecoCidade = H006U5_n185EnderecoCidade[0];
            A186MunicipioCodigo = H006U5_A186MunicipioCodigo[0];
            n186MunicipioCodigo = H006U5_n186MunicipioCodigo[0];
            A187MunicipioNome = H006U5_A187MunicipioNome[0];
            n187MunicipioNome = H006U5_n187MunicipioNome[0];
            A189MunicipioUF = H006U5_A189MunicipioUF[0];
            n189MunicipioUF = H006U5_n189MunicipioUF[0];
            A190EnderecoNumero = H006U5_A190EnderecoNumero[0];
            n190EnderecoNumero = H006U5_n190EnderecoNumero[0];
            A191EnderecoComplemento = H006U5_A191EnderecoComplemento[0];
            n191EnderecoComplemento = H006U5_n191EnderecoComplemento[0];
            A201ContatoEmail = H006U5_A201ContatoEmail[0];
            n201ContatoEmail = H006U5_n201ContatoEmail[0];
            A198ContatoDDD = H006U5_A198ContatoDDD[0];
            n198ContatoDDD = H006U5_n198ContatoDDD[0];
            A199ContatoDDI = H006U5_A199ContatoDDI[0];
            n199ContatoDDI = H006U5_n199ContatoDDI[0];
            A200ContatoNumero = H006U5_A200ContatoNumero[0];
            n200ContatoNumero = H006U5_n200ContatoNumero[0];
            A202ContatoTelefoneNumero = H006U5_A202ContatoTelefoneNumero[0];
            n202ContatoTelefoneNumero = H006U5_n202ContatoTelefoneNumero[0];
            A203ContatoTelefoneDDD = H006U5_A203ContatoTelefoneDDD[0];
            n203ContatoTelefoneDDD = H006U5_n203ContatoTelefoneDDD[0];
            A204ContatoTelefoneDDI = H006U5_A204ContatoTelefoneDDI[0];
            n204ContatoTelefoneDDI = H006U5_n204ContatoTelefoneDDI[0];
            A459ClienteDataNascimento = H006U5_A459ClienteDataNascimento[0];
            n459ClienteDataNascimento = H006U5_n459ClienteDataNascimento[0];
            A421ClienteRG = H006U5_A421ClienteRG[0];
            n421ClienteRG = H006U5_n421ClienteRG[0];
            A484ClienteNacionalidade = H006U5_A484ClienteNacionalidade[0];
            n484ClienteNacionalidade = H006U5_n484ClienteNacionalidade[0];
            A486ClienteEstadoCivil = H006U5_A486ClienteEstadoCivil[0];
            n486ClienteEstadoCivil = H006U5_n486ClienteEstadoCivil[0];
            A487ClienteProfissao = H006U5_A487ClienteProfissao[0];
            n487ClienteProfissao = H006U5_n487ClienteProfissao[0];
            A168ClienteId = H006U5_A168ClienteId[0];
            A597EspecialidadeCreatedBy = H006U5_A597EspecialidadeCreatedBy[0];
            n597EspecialidadeCreatedBy = H006U5_n597EspecialidadeCreatedBy[0];
            A141SecUserName = H006U5_A141SecUserName[0];
            n141SecUserName = H006U5_n141SecUserName[0];
      ...
      protected void E176U2( )
      {
         ...
         {
            A186MunicipioCodigo = H006U6_A186MunicipioCodigo[0];
            n186MunicipioCodigo = H006U6_n186MunicipioCodigo[0];
            A187MunicipioNome = H006U6_A187MunicipioNome[0];
            n187MunicipioNome = H006U6_n187MunicipioNome[0];
            A189MunicipioUF = H006U6_A189MunicipioUF[0];
            n189MunicipioUF = H006U6_n189MunicipioUF[0];
            AV28MunicipioNome = A187MunicipioNome;
            AssignAttri(sPrefix, false, "AV28MunicipioNome", AV28MunicipioNome);
            AV29MunicipioUF = A189MunicipioUF;
            AssignAttri(sPrefix, false, "AV29MunicipioUF", AV29MunicipioUF);
      ...
      protected void wb_table2_135_6U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavContatotelefoneddd_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV36ContatoTelefoneDDD), 4, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV36ContatoTelefoneDDD), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,139);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "DDD", edtavContatotelefoneddd_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavContatotelefoneddd_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavContatotelefonenumero_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV35ContatoTelefoneNumero), 18, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV35ContatoTelefoneNumero), "ZZZZZZZZZZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,142);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "Número", edtavContatotelefonenumero_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavContatotelefonenumero_Enabled, 1, "text", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_135_6U2e( true) ;
         }
         else
         {
            wb_table2_135_6U2e( false) ;
         }
      }

      protected void wb_table1_121_6U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavContatoddd_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV32ContatoDDD), 4, 0, ",", "")), StringUtil.LTrim( ((edtavContatoddd_Enabled!=0) ? context.localUtil.Format( (decimal)(AV32ContatoDDD), "ZZZ9") : context.localUtil.Format( (decimal)(AV32ContatoDDD), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,125);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "DDD", edtavContatoddd_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavContatoddd_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaNovoCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCellFL'>") ;
            /* Div Control */
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpropostanovocliente", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019181179", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpropostanovocliente.js", "?202561019181180", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         cmbavPossuiresponsavel.Enabled = 1;
         Combo_clienteprofissao_Includeaddnewoption = Convert.ToBoolean( -1);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VCEP.CONTROLVALUECHANGED","""{"handler":"E176U2","iparms":[{"av":"AV41CEP","fld":"vCEP","type":"svchar"},{"av":"A186MunicipioCodigo","fld":"MUNICIPIOCODIGO","type":"svchar"},{"av":"A187MunicipioNome","fld":"MUNICIPIONOME","pic":"@!","type":"svchar"},{"av":"A189MunicipioUF","fld":"MUNICIPIOUF","pic":"@!","type":"svchar"},{"av":"AV48EnderecoCompleto","fld":"vENDERECOCOMPLETO","type":""}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H006U2_A219TipoClienteFinancia = new bool[] {false} ;
         H006U2_n219TipoClienteFinancia = new bool[] {false} ;
         H006U2_A192TipoClienteId = new short[1] ;
         H006U2_n192TipoClienteId = new bool[] {false} ;
         ...
         H006U3_A440ProfissaoId = new int[1] ;
         H006U3_A441ProfissaoNome = new string[] {""} ;
         H006U3_n441ProfissaoNome = new bool[] {false} ;
         AV46Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H006U4_A434NacionalidadeId = new int[1] ;
         H006U4_A435NacionalidadeNome = new string[] {""} ;
         H006U4_n435NacionalidadeNome = new bool[] {false} ;
         A435NacionalidadeNome = "";
         Combo_clientenacionalidade_Selectedvalue_set = "";
         GXt_dtime1 = (DateTime)(DateTime.MinValue);
         H006U5_A457EspecialidadeId = new int[1] ;
         H006U5_n457EspecialidadeId = new bool[] {false} ;
         H006U5_A597EspecialidadeCreatedBy = new short[1] ;
         H006U5_n597EspecialidadeCreatedBy = new bool[] {false} ;
         H006U5_A169ClienteDocumento = new string[] {""} ;
         H006U5_n169ClienteDocumento = new bool[] {false} ;
         H006U5_A170ClienteRazaoSocial = new string[] {""} ;
         H006U5_n170ClienteRazaoSocial = new bool[] {false} ;
         H006U5_A171ClienteNomeFantasia = new string[] {""} ;
         H006U5_n171ClienteNomeFantasia = new bool[] {false} ;
         H006U5_A172ClienteTipoPessoa = new string[] {""} ;
         H006U5_n172ClienteTipoPessoa = new bool[] {false} ;
         H006U5_A192TipoClienteId = new short[1] ;
         H006U5_n192TipoClienteId = new bool[] {false} ;
         H006U5_A193TipoClienteDescricao = new string[] {""} ;
         H006U5_n193TipoClienteDescricao = new bool[] {false} ;
         H006U5_A174ClienteStatus = new bool[] {false} ;
         H006U5_n174ClienteStatus = new bool[] {false} ;
         H006U5_A141SecUserName = new string[] {""} ;
         H006U5_n141SecUserName = new bool[] {false} ;
         H006U5_A181EnderecoTipo = new string[] {""} ;
         H006U5_n181EnderecoTipo = new bool[] {false} ;
         H006U5_A182EnderecoCEP = new string[] {""} ;
         H006U5_n182EnderecoCEP = new bool[] {false} ;
         H006U5_A183EnderecoLogradouro = new string[] {""} ;
         H006U5_n183EnderecoLogradouro = new bool[] {false} ;
         H006U5_A184EnderecoBairro = new string[] {""} ;
         H006U5_n184EnderecoBairro = new bool[] {false} ;
         H006U5_A185EnderecoCidade = new string[] {""} ;
         H006U5_n185EnderecoCidade = new bool[] {false} ;
         H006U5_A186MunicipioCodigo = new string[] {""} ;
         H006U5_n186MunicipioCodigo = new bool[] {false} ;
         H006U5_A187MunicipioNome = new string[] {""} ;
         H006U5_n187MunicipioNome = new bool[] {false} ;
         H006U5_A189MunicipioUF = new string[] {""} ;
         H006U5_n189MunicipioUF = new bool[] {false} ;
         H006U5_A190EnderecoNumero = new string[] {""} ;
         H006U5_n190EnderecoNumero = new bool[] {false} ;
         H006U5_A191EnderecoComplemento = new string[] {""} ;
         H006U5_n191EnderecoComplemento = new bool[] {false} ;
         H006U5_A201ContatoEmail = new string[] {""} ;
         H006U5_n201ContatoEmail = new bool[] {false} ;
         H006U5_A198ContatoDDD = new short[1] ;
         H006U5_n198ContatoDDD = new bool[] {false} ;
         H006U5_A199ContatoDDI = new short[1] ;
         H006U5_n199ContatoDDI = new bool[] {false} ;
         H006U5_A200ContatoNumero = new long[1] ;
         H006U5_n200ContatoNumero = new bool[] {false} ;
         H006U5_A202ContatoTelefoneNumero = new long[1] ;
         H006U5_n202ContatoTelefoneNumero = new bool[] {false} ;
         H006U5_A203ContatoTelefoneDDD = new short[1] ;
         H006U5_n203ContatoTelefoneDDD = new bool[] {false} ;
         H006U5_A204ContatoTelefoneDDI = new short[1] ;
         H006U5_n204ContatoTelefoneDDI = new bool[] {false} ;
         H006U5_A459ClienteDataNascimento = new DateTime[] {DateTime.MinValue} ;
         H006U5_n459ClienteDataNascimento = new bool[] {false} ;
         H006U5_A421ClienteRG = new long[1] ;
         H006U5_n421ClienteRG = new bool[] {false} ;
         H006U5_A484ClienteNacionalidade = new int[1] ;
         H006U5_n484ClienteNacionalidade = new bool[] {false} ;
         H006U5_A486ClienteEstadoCivil = new string[] {""} ;
         H006U5_n486ClienteEstadoCivil = new bool[] {false} ;
         H006U5_A487ClienteProfissao = new int[1] ;
         H006U5_n487ClienteProfissao = new bool[] {false} ;
         H006U5_A168ClienteId = new int[1] ;
         AV18TipoClienteDescricao = "";
         AV20SecUserName = "";
         AV49ModeloRetorno = "";
         AV50Mensagem = "";
         H006U6_A186MunicipioCodigo = new string[] {""} ;
         H006U6_n186MunicipioCodigo = new bool[] {false} ;
         H006U6_A187MunicipioNome = new string[] {""} ;
         H006U6_n187MunicipioNome = new bool[] {false} ;
         H006U6_A189MunicipioUF = new string[] {""} ;
         H006U6_n189MunicipioUF = new bool[] {false} ;
         sStyleString = "";
         ...
         sCtrlAV7GoingBack = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpropostanovocliente__default(),
            new Object[][] {
                new Object[] {
               H006U2_A219TipoClienteFinancia, H006U2_n219TipoClienteFinancia, H006U2_A192TipoClienteId
               }
               , new Object[] {
               H006U3_A440ProfissaoId, H006U3_A441ProfissaoNome, H006U3_n441ProfissaoNome
               }
               , new Object[] {
               H006U4_A434NacionalidadeId, H006U4_A435NacionalidadeNome, H006U4_n435NacionalidadeNome
               }
               , new Object[] {
               H006U5_A457EspecialidadeId, H006U5_n457EspecialidadeId, H006U5_A597EspecialidadeCreatedBy, H006U5_n597EspecialidadeCreatedBy, H006U5_A169ClienteDocumento, H006U5_n169ClienteDocumento, H006U5_A170ClienteRazaoSocial, H006U5_n170ClienteRazaoSocial, H006U5_A171ClienteNomeFantasia, H006U5_n171ClienteNomeFantasia,
               H006U5_A172ClienteTipoPessoa, H006U5_n172ClienteTipoPessoa, H006U5_A192TipoClienteId, H006U5_n192TipoClienteId, H006U5_A193TipoClienteDescricao, H006U5_n193TipoClienteDescricao, H006U5_A174ClienteStatus, H006U5_n174ClienteStatus, H006U5_A141SecUserName, H006U5_n141SecUserName,
               H006U5_A181EnderecoTipo, H006U5_n181EnderecoTipo, H006U5_A182EnderecoCEP, H006U5_n182EnderecoCEP, H006U5_A183EnderecoLogradouro, H006U5_n183EnderecoLogradouro, H006U5_A184EnderecoBairro, H006U5_n184EnderecoBairro, H006U5_A185EnderecoCidade, H006U5_n185EnderecoCidade,
               H006U5_A186MunicipioCodigo, H006U5_n186MunicipioCodigo, H006U5_A187MunicipioNome, H006U5_n187MunicipioNome, H006U5_A189MunicipioUF, H006U5_n189MunicipioUF, H006U5_A190EnderecoNumero, H006U5_n190EnderecoNumero, H006U5_A191EnderecoComplemento, H006U5_n191EnderecoComplemento,
               H006U5_A201ContatoEmail, H006U5_n201ContatoEmail, H006U5_A198ContatoDDD, H006U5_n198ContatoDDD, H006U5_A199ContatoDDI, H006U5_n199ContatoDDI, H006U5_A200ContatoNumero, H006U5_n200ContatoNumero, H006U5_A202ContatoTelefoneNumero, H006U5_n202ContatoTelefoneNumero,
               H006U5_A203ContatoTelefoneDDD, H006U5_n203ContatoTelefoneDDD, H006U5_A204ContatoTelefoneDDI, H006U5_n204ContatoTelefoneDDI, H006U5_A459ClienteDataNascimento, H006U5_n459ClienteDataNascimento, H006U5_A421ClienteRG, H006U5_n421ClienteRG, H006U5_A484ClienteNacionalidade, H006U5_n484ClienteNacionalidade,
               H006U5_A486ClienteEstadoCivil, H006U5_n486ClienteEstadoCivil, H006U5_A487ClienteProfissao, H006U5_n487ClienteProfissao, H006U5_A168ClienteId
               }
               , new Object[] {
               H006U6_A186MunicipioCodigo, H006U6_A187MunicipioNome, H006U6_n187MunicipioNome, H006U6_A189MunicipioUF, H006U6_n189MunicipioUF
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool Combo_clienteprofissao_Includeaddnewoption ;
      ...
      private bool[] H006U2_A219TipoClienteFinancia ;
      private bool[] H006U2_n219TipoClienteFinancia ;
      private short[] H006U2_A192TipoClienteId ;
      private bool[] H006U2_n192TipoClienteId ;
      private SdtWPropostaData AV11WizardData ;
      private int[] H006U3_A440ProfissaoId ;
      private string[] H006U3_A441ProfissaoNome ;
      private bool[] H006U3_n441ProfissaoNome ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV46Combo_DataItem ;
      private int[] H006U4_A434NacionalidadeId ;
      private string[] H006U4_A435NacionalidadeNome ;
      private bool[] H006U4_n435NacionalidadeNome ;
      private int[] H006U5_A457EspecialidadeId ;
      private bool[] H006U5_n457EspecialidadeId ;
      private short[] H006U5_A597EspecialidadeCreatedBy ;
      private bool[] H006U5_n597EspecialidadeCreatedBy ;
      private string[] H006U5_A169ClienteDocumento ;
      private bool[] H006U5_n169ClienteDocumento ;
      private string[] H006U5_A170ClienteRazaoSocial ;
      private bool[] H006U5_n170ClienteRazaoSocial ;
      private string[] H006U5_A171ClienteNomeFantasia ;
      private bool[] H006U5_n171ClienteNomeFantasia ;
      private string[] H006U5_A172ClienteTipoPessoa ;
      private bool[] H006U5_n172ClienteTipoPessoa ;
      private short[] H006U5_A192TipoClienteId ;
      private bool[] H006U5_n192TipoClienteId ;
      private string[] H006U5_A193TipoClienteDescricao ;
      private bool[] H006U5_n193TipoClienteDescricao ;
      private bool[] H006U5_A174ClienteStatus ;
      private bool[] H006U5_n174ClienteStatus ;
      private string[] H006U5_A141SecUserName ;
      private bool[] H006U5_n141SecUserName ;
      private string[] H006U5_A181EnderecoTipo ;
      private bool[] H006U5_n181EnderecoTipo ;
      private string[] H006U5_A182EnderecoCEP ;
      private bool[] H006U5_n182EnderecoCEP ;
      private string[] H006U5_A183EnderecoLogradouro ;
      private bool[] H006U5_n183EnderecoLogradouro ;
      private string[] H006U5_A184EnderecoBairro ;
      private bool[] H006U5_n184EnderecoBairro ;
      private string[] H006U5_A185EnderecoCidade ;
      private bool[] H006U5_n185EnderecoCidade ;
      private string[] H006U5_A186MunicipioCodigo ;
      private bool[] H006U5_n186MunicipioCodigo ;
      private string[] H006U5_A187MunicipioNome ;
      private bool[] H006U5_n187MunicipioNome ;
      private string[] H006U5_A189MunicipioUF ;
      private bool[] H006U5_n189MunicipioUF ;
      private string[] H006U5_A190EnderecoNumero ;
      private bool[] H006U5_n190EnderecoNumero ;
      private string[] H006U5_A191EnderecoComplemento ;
      private bool[] H006U5_n191EnderecoComplemento ;
      private string[] H006U5_A201ContatoEmail ;
      private bool[] H006U5_n201ContatoEmail ;
      private short[] H006U5_A198ContatoDDD ;
      private bool[] H006U5_n198ContatoDDD ;
      private short[] H006U5_A199ContatoDDI ;
      private bool[] H006U5_n199ContatoDDI ;
      private long[] H006U5_A200ContatoNumero ;
      private bool[] H006U5_n200ContatoNumero ;
      private long[] H006U5_A202ContatoTelefoneNumero ;
      private bool[] H006U5_n202ContatoTelefoneNumero ;
      private short[] H006U5_A203ContatoTelefoneDDD ;
      private bool[] H006U5_n203ContatoTelefoneDDD ;
      private short[] H006U5_A204ContatoTelefoneDDI ;
      private bool[] H006U5_n204ContatoTelefoneDDI ;
      private DateTime[] H006U5_A459ClienteDataNascimento ;
      private bool[] H006U5_n459ClienteDataNascimento ;
      private long[] H006U5_A421ClienteRG ;
      private bool[] H006U5_n421ClienteRG ;
      private int[] H006U5_A484ClienteNacionalidade ;
      private bool[] H006U5_n484ClienteNacionalidade ;
      private string[] H006U5_A486ClienteEstadoCivil ;
      private bool[] H006U5_n486ClienteEstadoCivil ;
      private int[] H006U5_A487ClienteProfissao ;
      private bool[] H006U5_n487ClienteProfissao ;
      private int[] H006U5_A168ClienteId ;
      private string[] H006U6_A186MunicipioCodigo ;
      private bool[] H006U6_n186MunicipioCodigo ;
      private string[] H006U6_A187MunicipioNome ;
      private bool[] H006U6_n187MunicipioNome ;
      private string[] H006U6_A189MunicipioUF ;
      private bool[] H006U6_n189MunicipioUF ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wpropostanovocliente__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006U2", "SELECT TipoClienteFinancia, TipoClienteId FROM TipoCliente WHERE TipoClienteFinancia ORDER BY TipoClienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006U2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006U3", "SELECT ProfissaoId, ProfissaoNome FROM Profissao ORDER BY ProfissaoNome ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006U3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006U4", "SELECT NacionalidadeId, NacionalidadeNome FROM Nacionalidade ORDER BY NacionalidadeNome ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006U4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006U5", "SELECT T1.EspecialidadeId, T2.EspecialidadeCreatedBy AS EspecialidadeCreatedBy, T1.ClienteDocumento, T1.ClienteRazaoSocial, T1.ClienteNomeFantasia, T1.ClienteTipoPessoa, T1.TipoClienteId, T4.TipoClienteDescricao, T1.ClienteStatus, T3.SecUserName, T1.EnderecoTipo, T1.EnderecoCEP, T1.EnderecoLogradouro, T1.EnderecoBairro, T1.EnderecoCidade, T1.MunicipioCodigo, T5.MunicipioNome, T5.MunicipioUF, T1.EnderecoNumero, T1.EnderecoComplemento, T1.ContatoEmail, T1.ContatoDDD, T1.ContatoDDI, T1.ContatoNumero, T1.ContatoTelefoneNumero, T1.ContatoTelefoneDDD, T1.ContatoTelefoneDDI, T1.ClienteDataNascimento, T1.ClienteRG, T1.ClienteNacionalidade, T1.ClienteEstadoCivil, T1.ClienteProfissao, T1.ClienteId FROM ((((Cliente T1 LEFT JOIN Especialidade T2 ON T2.EspecialidadeId = T1.EspecialidadeId) LEFT JOIN SecUser T3 ON T3.SecUserId = T2.EspecialidadeCreatedBy) LEFT JOIN TipoCliente T4 ON T4.TipoClienteId = T1.TipoClienteId) LEFT JOIN Municipio T5 ON T5.MunicipioCodigo = T1.MunicipioCodigo) WHERE T1.ClienteDocumento = ( :AV13ClienteDocumento) ORDER BY T1.ClienteDocumento ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006U5,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H006U6", "SELECT MunicipioCodigo, MunicipioNome, MunicipioUF FROM Municipio WHERE MunicipioCodigo = ( :AV27MunicipioCodigo) ORDER BY MunicipioCodigo ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006U6,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
