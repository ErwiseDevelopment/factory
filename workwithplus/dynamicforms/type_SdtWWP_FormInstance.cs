...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   ...
   [XmlType(TypeName =  "WWP_FormInstance" , Namespace = "Factory21" )]
   [Serializable]
   public class SdtWWP_FormInstance : GxSilentTrnSdt
   {
      ...
      public void Load( int AV102WWPFormInstanceId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(int)AV102WWPFormInstanceId});
         return  ;
      }
      ...
      public override GXProperties GetMetadata( )
      {
         ...
         metadata.Set("FKList", "[ { \"FK\":[ \"WWPFormId\",\"WWPFormVersionNumber\" ],\"FKMap\":[  ] } ]");
      ...
      public GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element> gxTpr_Element_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtWWP_FormInstance_Element == null )
            {
               gxTv_SdtWWP_FormInstance_Element = new GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element>( context, "WWP_FormInstance.Element", "Factory21");
            }
   ...
   [DataContract(Name = @"WorkWithPlus\DynamicForms\WWP_FormInstance", Namespace = "Factory21")]
   ...
   public class SdtWWP_FormInstance_RESTInterface : GxGenericCollectionItem<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance>
   {
      ...
      [DataMember( Name = "WWPFormResume" , Order = 5 )]
      [GxSeudo()]
      ...
      [DataMember( Name = "WWPFormValidations" , Order = 6 )]
      public string gxTpr_Wwpformvalidations
      {
         get {
      ...
      [DataMember( Name = "WWPFormInstanceRecordKey" , Order = 7 )]
      public string gxTpr_Wwpforminstancerecordkey
      {
         get {
      ...
      [DataMember( Name = "Element" , Order = 8 )]
