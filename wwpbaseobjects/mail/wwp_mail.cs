...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   public class wwp_mail : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPNotificationId_Internalname, ((0==A22WWPNotificationId)&&IsIns( )||n22WWPNotificationId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A22WWPNotificationId), 10, 0, ",", ""))), ((0==A22WWPNotificationId)&&IsIns( )||n22WWPNotificationId ? "" : StringUtil.LTrim( ((edtWWPNotificationId_Enabled!=0) ? context.localUtil.Format( (decimal)(A22WWPNotificationId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A22WWPNotificationId), "ZZZZZZZZZ9")))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,99);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPNotificationId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPNotificationId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_Id", "end", false, "", "HLP_WWPBaseObjects/Mail/WWP_Mail.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPMailCreated_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A91WWPMailCreated", context.localUtil.TToC( A91WWPMailCreated, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPMailScheduled_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A92WWPMailScheduled", context.localUtil.TToC( A92WWPMailScheduled, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPMailProcessed_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A86WWPMailProcessed", context.localUtil.TToC( A86WWPMailProcessed, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
      ...
      protected void gxLoad_6( long A22WWPNotificationId )
      {
         ...
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( context.localUtil.TToC( A24WWPNotificationCreated, 10, 12, 0, 3, "/", ":", " "))+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(6) == 101) )
         {
            AddString( ",") ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.mail.wwp_mail") +"\">") ;
      ...
      {
         return formatLink("wwpbaseobjects.mail.wwp_mail")  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019125451", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/mail/wwp_mail.js", "?202561019125451", false, true);
      ...
      public void Valid_Wwpmailid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z81WWPMailStatus", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z81WWPMailStatus), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z91WWPMailCreated", context.localUtil.TToC( Z91WWPMailCreated, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z92WWPMailScheduled", context.localUtil.TToC( Z92WWPMailScheduled, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z86WWPMailProcessed", context.localUtil.TToC( Z86WWPMailProcessed, 10, 12, 0, 3, "/", ":", " "));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_WWPMAILID","""{"handler":"Valid_Wwpmailid","iparms":[{"av":"A80WWPMailId","fld":"WWPMAILID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9","type":"int"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"cmbWWPMailStatus"},{"av":"A81WWPMailStatus","fld":"WWPMAILSTATUS","pic":"ZZZ9","type":"int"},{"av":"A91WWPMailCreated","fld":"WWPMAILCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A92WWPMailScheduled","fld":"WWPMAILSCHEDULED","pic":"99/99/9999 99:99:99.999","type":"dtime"}]""");
         setEventMetadata("VALID_WWPMAILID",""","oparms":[{"av":"A69WWPMailSubject","fld":"WWPMAILSUBJECT","type":"svchar"},{"av":"A61WWPMailBody","fld":"WWPMAILBODY","type":"vchar"},{"av":"A70WWPMailTo","fld":"WWPMAILTO","type":"vchar"},{"av":"A83WWPMailCC","fld":"WWPMAILCC","type":"vchar"},{"av":"A84WWPMailBCC","fld":"WWPMAILBCC","type":"vchar"},{"av":"A71WWPMailSenderAddress","fld":"WWPMAILSENDERADDRESS","type":"vchar"},{"av":"A72WWPMailSenderName","fld":"WWPMAILSENDERNAME","type":"vchar"},{"av":"cmbWWPMailStatus"},{"av":"A81WWPMailStatus","fld":"WWPMAILSTATUS","pic":"ZZZ9","type":"int"},{"av":"A91WWPMailCreated","fld":"WWPMAILCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A92WWPMailScheduled","fld":"WWPMAILSCHEDULED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A86WWPMailProcessed","fld":"WWPMAILPROCESSED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"A87WWPMailDetail","fld":"WWPMAILDETAIL","type":"vchar"},{"av":"A22WWPNotificationId","fld":"WWPNOTIFICATIONID","pic":"ZZZZZZZZZ9","nullAv":"n22WWPNotificationId","type":"int"},{"av":"A24WWPNotificationCreated","fld":"WWPNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"Z80WWPMailId","type":"int"},{"av":"Z69WWPMailSubject","type":"svchar"},{"av":"Z61WWPMailBody","type":"vchar"},{"av":"Z70WWPMailTo","type":"vchar"},{"av":"Z83WWPMailCC","type":"vchar"},{"av":"Z84WWPMailBCC","type":"vchar"},{"av":"Z71WWPMailSenderAddress","type":"vchar"},{"av":"Z72WWPMailSenderName","type":"vchar"},{"av":"Z81WWPMailStatus","type":"int"},{"av":"Z91WWPMailCreated","type":"dtime"},{"av":"Z92WWPMailScheduled","type":"dtime"},{"av":"Z86WWPMailProcessed","type":"dtime"},{"av":"Z87WWPMailDetail","type":"vchar"},{"av":"Z22WWPNotificationId","type":"int"},{"av":"Z24WWPNotificationCreated","type":"dtime"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
         setEventMetadata("VALID_WWPMAILSTATUS","""{"handler":"Valid_Wwpmailstatus","iparms":[]}""");
         setEventMetadata("VALID_WWPNOTIFICATIONID","""{"handler":"Valid_Wwpnotificationid","iparms":[{"av":"A22WWPNotificationId","fld":"WWPNOTIFICATIONID","pic":"ZZZZZZZZZ9","nullAv":"n22WWPNotificationId","type":"int"},{"av":"A24WWPNotificationCreated","fld":"WWPNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"}]""");
         setEventMetadata("VALID_WWPNOTIFICATIONID",""","oparms":[{"av":"A24WWPNotificationCreated","fld":"WWPNOTIFICATIONCREATED","pic":"99/99/9999 99:99:99.999","type":"dtime"}]}""");
