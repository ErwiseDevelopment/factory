   ...
   public class titulo : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel9"+"_"+"TITULOTOTALMULTAJUROSCREDITO_F") == 0 )
         {
            ...
            GX9ASATITULOTOTALMULTAJUROSCREDITO_F1544( A283TituloTipo, A261TituloId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel10"+"_"+"TITULOTOTALMULTAJUROSDEBITO_F") == 0 )
         {
            ...
            GX10ASATITULOTOTALMULTAJUROSDEBITO_F1544( A283TituloTipo, A261TituloId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel11"+"_"+"TITULOTOTALMOVIMENTOCREDITO_F") == 0 )
         {
            ...
            GX11ASATITULOTOTALMOVIMENTOCREDITO_F1544( A283TituloTipo, A261TituloId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel12"+"_"+"TITULOTOTALMOVIMENTODEBITO_F") == 0 )
         {
            ...
            GX12ASATITULOTOTALMOVIMENTODEBITO_F1544( A283TituloTipo, A261TituloId) ;
            return  ;
         }
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_32") == 0 )
         {
            ...
            gxLoad_32( A426CategoriaTituloId) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_33") == 0 )
         {
            ...
            gxLoad_33( A890NotaFiscalParcelamentoID) ;
            return  ;
         }
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_35") == 0 )
         {
            ...
            gxLoad_35( A419TituloPropostaId) ;
            return  ;
         }
      ...
      protected void Load1544( )
      {
         ...
         {
            RcdFound44 = 1;
            A794NotaFiscalId = T001522_A794NotaFiscalId[0];
            n794NotaFiscalId = T001522_n794NotaFiscalId[0];
            A938AgenciaId = T001522_A938AgenciaId[0];
            n938AgenciaId = T001522_n938AgenciaId[0];
            A968AgenciaBancoId = T001522_A968AgenciaBancoId[0];
            n968AgenciaBancoId = T001522_n968AgenciaBancoId[0];
            A972TituloCLienteRazaoSocial = T001522_A972TituloCLienteRazaoSocial[0];
            n972TituloCLienteRazaoSocial = T001522_n972TituloCLienteRazaoSocial[0];
            A262TituloValor = T001522_A262TituloValor[0];
            n262TituloValor = T001522_n262TituloValor[0];
            ...
            A276TituloDesconto = T001522_A276TituloDesconto[0];
            n276TituloDesconto = T001522_n276TituloDesconto[0];
            ...
            A284TituloDeleted = T001522_A284TituloDeleted[0];
            n284TituloDeleted = T001522_n284TituloDeleted[0];
            AssignAttri("", false, "A284TituloDeleted", A284TituloDeleted);
            A314TituloArchived = T001522_A314TituloArchived[0];
            n314TituloArchived = T001522_n314TituloArchived[0];
            A263TituloVencimento = T001522_A263TituloVencimento[0];
            n263TituloVencimento = T001522_n263TituloVencimento[0];
            AssignAttri("", false, "A263TituloVencimento", context.localUtil.Format(A263TituloVencimento, "99/99/9999"));
            A286TituloCompetenciaAno = T001522_A286TituloCompetenciaAno[0];
            n286TituloCompetenciaAno = T001522_n286TituloCompetenciaAno[0];
            ...
            A287TituloCompetenciaMes = T001522_A287TituloCompetenciaMes[0];
            n287TituloCompetenciaMes = T001522_n287TituloCompetenciaMes[0];
            ...
            A264TituloProrrogacao = T001522_A264TituloProrrogacao[0];
            n264TituloProrrogacao = T001522_n264TituloProrrogacao[0];
            AssignAttri("", false, "A264TituloProrrogacao", context.localUtil.Format(A264TituloProrrogacao, "99/99/9999"));
            A265TituloCEP = T001522_A265TituloCEP[0];
            n265TituloCEP = T001522_n265TituloCEP[0];
            AssignAttri("", false, "A265TituloCEP", A265TituloCEP);
            A266TituloLogradouro = T001522_A266TituloLogradouro[0];
            n266TituloLogradouro = T001522_n266TituloLogradouro[0];
            AssignAttri("", false, "A266TituloLogradouro", A266TituloLogradouro);
            A294TituloNumeroEndereco = T001522_A294TituloNumeroEndereco[0];
            n294TituloNumeroEndereco = T001522_n294TituloNumeroEndereco[0];
            AssignAttri("", false, "A294TituloNumeroEndereco", A294TituloNumeroEndereco);
            A267TituloComplemento = T001522_A267TituloComplemento[0];
            n267TituloComplemento = T001522_n267TituloComplemento[0];
            AssignAttri("", false, "A267TituloComplemento", A267TituloComplemento);
            A268TituloBairro = T001522_A268TituloBairro[0];
            n268TituloBairro = T001522_n268TituloBairro[0];
            AssignAttri("", false, "A268TituloBairro", A268TituloBairro);
            A269TituloMunicipio = T001522_A269TituloMunicipio[0];
            n269TituloMunicipio = T001522_n269TituloMunicipio[0];
            AssignAttri("", false, "A269TituloMunicipio", A269TituloMunicipio);
            A498TituloJurosMora = T001522_A498TituloJurosMora[0];
            n498TituloJurosMora = T001522_n498TituloJurosMora[0];
            A283TituloTipo = T001522_A283TituloTipo[0];
            n283TituloTipo = T001522_n283TituloTipo[0];
            AssignAttri("", false, "A283TituloTipo", A283TituloTipo);
            A971TituloPropostaDescricao = T001522_A971TituloPropostaDescricao[0];
            n971TituloPropostaDescricao = T001522_n971TituloPropostaDescricao[0];
            A501PropostaTaxaAdministrativa = T001522_A501PropostaTaxaAdministrativa[0];
            n501PropostaTaxaAdministrativa = T001522_n501PropostaTaxaAdministrativa[0];
            A500TituloCriacao = T001522_A500TituloCriacao[0];
            n500TituloCriacao = T001522_n500TituloCriacao[0];
            A648TituloPropostaTipo = T001522_A648TituloPropostaTipo[0];
            n648TituloPropostaTipo = T001522_n648TituloPropostaTipo[0];
            A799NotaFiscalNumero = T001522_A799NotaFiscalNumero[0];
            n799NotaFiscalNumero = T001522_n799NotaFiscalNumero[0];
            A969AgenciaBancoNome = T001522_A969AgenciaBancoNome[0];
            n969AgenciaBancoNome = T001522_n969AgenciaBancoNome[0];
            A953ContaBancariaCarteira = T001522_A953ContaBancariaCarteira[0];
            n953ContaBancariaCarteira = T001522_n953ContaBancariaCarteira[0];
            A952ContaBancariaNumero = T001522_A952ContaBancariaNumero[0];
            n952ContaBancariaNumero = T001522_n952ContaBancariaNumero[0];
            A939AgenciaNumero = T001522_A939AgenciaNumero[0];
            n939AgenciaNumero = T001522_n939AgenciaNumero[0];
            A422ContaId = T001522_A422ContaId[0];
            n422ContaId = T001522_n422ContaId[0];
            A426CategoriaTituloId = T001522_A426CategoriaTituloId[0];
            n426CategoriaTituloId = T001522_n426CategoriaTituloId[0];
            A890NotaFiscalParcelamentoID = T001522_A890NotaFiscalParcelamentoID[0];
            n890NotaFiscalParcelamentoID = T001522_n890NotaFiscalParcelamentoID[0];
            A951ContaBancariaId = T001522_A951ContaBancariaId[0];
            n951ContaBancariaId = T001522_n951ContaBancariaId[0];
            A419TituloPropostaId = T001522_A419TituloPropostaId[0];
            n419TituloPropostaId = T001522_n419TituloPropostaId[0];
            A420TituloClienteId = T001522_A420TituloClienteId[0];
            n420TituloClienteId = T001522_n420TituloClienteId[0];
            A516TituloDataCredito_F = T001522_A516TituloDataCredito_F[0];
            n516TituloDataCredito_F = T001522_n516TituloDataCredito_F[0];
            A273TituloTotalMovimento_F = T001522_A273TituloTotalMovimento_F[0];
            n273TituloTotalMovimento_F = T001522_n273TituloTotalMovimento_F[0];
            AssignAttri("", false, "A273TituloTotalMovimento_F", StringUtil.LTrimStr( A273TituloTotalMovimento_F, 18, 2));
            A301TituloTotalMultaJuros_F = T001522_A301TituloTotalMultaJuros_F[0];
            n301TituloTotalMultaJuros_F = T001522_n301TituloTotalMultaJuros_F[0];
            ZM1544( -30) ;
         }
         pr_default.close(14);
         OnLoadActions1544( ) ;
      ...
      protected void gxLoad_40( int A261TituloId )
      {
         /* Using cursor T001524 */
         pr_default.execute(15, new Object[] {n261TituloId, A261TituloId});
         if ( (pr_default.getStatus(15) != 101) )
         {
            A516TituloDataCredito_F = T001524_A516TituloDataCredito_F[0];
            n516TituloDataCredito_F = T001524_n516TituloDataCredito_F[0];
         }
         else
         {
            A516TituloDataCredito_F = DateTime.MinValue;
      ...
      protected void gxLoad_41( int A261TituloId )
      {
         ...
         {
            A273TituloTotalMovimento_F = T001526_A273TituloTotalMovimento_F[0];
            n273TituloTotalMovimento_F = T001526_n273TituloTotalMovimento_F[0];
            AssignAttri("", false, "A273TituloTotalMovimento_F", StringUtil.LTrimStr( A273TituloTotalMovimento_F, 18, 2));
         }
         else
         {
      ...
      protected void gxLoad_42( int A261TituloId )
      {
         ...
         {
            A301TituloTotalMultaJuros_F = T001528_A301TituloTotalMultaJuros_F[0];
            n301TituloTotalMultaJuros_F = T001528_n301TituloTotalMultaJuros_F[0];
         }
         else
         {
            A301TituloTotalMultaJuros_F = 0;
      ...
      protected void gxLoad_31( int A422ContaId )
      {
         /* Using cursor T001529 */
         pr_default.execute(18, new Object[] {n422ContaId, A422ContaId});
      ...
      protected void gxLoad_32( int A426CategoriaTituloId )
      {
         /* Using cursor T001530 */
         pr_default.execute(19, new Object[] {n426CategoriaTituloId, A426CategoriaTituloId});
      ...
      protected void gxLoad_33( Guid A890NotaFiscalParcelamentoID )
      {
         /* Using cursor T001531 */
         pr_default.execute(20, new Object[] {n890NotaFiscalParcelamentoID, A890NotaFiscalParcelamentoID});
         ...
         A794NotaFiscalId = T001531_A794NotaFiscalId[0];
         n794NotaFiscalId = T001531_n794NotaFiscalId[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_37( Guid A794NotaFiscalId )
      {
         /* Using cursor T001532 */
         pr_default.execute(21, new Object[] {n794NotaFiscalId, A794NotaFiscalId});
         ...
         A799NotaFiscalNumero = T001532_A799NotaFiscalNumero[0];
         n799NotaFiscalNumero = T001532_n799NotaFiscalNumero[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_34( int A951ContaBancariaId )
      {
         ...
         A938AgenciaId = T001533_A938AgenciaId[0];
         n938AgenciaId = T001533_n938AgenciaId[0];
         A953ContaBancariaCarteira = T001533_A953ContaBancariaCarteira[0];
         n953ContaBancariaCarteira = T001533_n953ContaBancariaCarteira[0];
         A952ContaBancariaNumero = T001533_A952ContaBancariaNumero[0];
         n952ContaBancariaNumero = T001533_n952ContaBancariaNumero[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_38( int A938AgenciaId )
      {
         ...
         A968AgenciaBancoId = T001534_A968AgenciaBancoId[0];
         n968AgenciaBancoId = T001534_n968AgenciaBancoId[0];
         A939AgenciaNumero = T001534_A939AgenciaNumero[0];
         n939AgenciaNumero = T001534_n939AgenciaNumero[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_39( int A968AgenciaBancoId )
      {
         ...
         A969AgenciaBancoNome = T001535_A969AgenciaBancoNome[0];
         n969AgenciaBancoNome = T001535_n969AgenciaBancoNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_35( int A419TituloPropostaId )
      {
         /* Using cursor T001536 */
         pr_default.execute(25, new Object[] {n419TituloPropostaId, A419TituloPropostaId});
         ...
         A971TituloPropostaDescricao = T001536_A971TituloPropostaDescricao[0];
         n971TituloPropostaDescricao = T001536_n971TituloPropostaDescricao[0];
         A501PropostaTaxaAdministrativa = T001536_A501PropostaTaxaAdministrativa[0];
         n501PropostaTaxaAdministrativa = T001536_n501PropostaTaxaAdministrativa[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_36( int A420TituloClienteId )
      {
         /* Using cursor T001537 */
         pr_default.execute(26, new Object[] {n420TituloClienteId, A420TituloClienteId});
         ...
         A972TituloCLienteRazaoSocial = T001537_A972TituloCLienteRazaoSocial[0];
         n972TituloCLienteRazaoSocial = T001537_n972TituloCLienteRazaoSocial[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(28) != 101) && ( ( T001539_A261TituloId[0] < A261TituloId ) ) )
            {
               pr_default.readNext(28);
            }
            if ( (pr_default.getStatus(28) != 101) && ( ( T001539_A261TituloId[0] > A261TituloId ) ) )
            {
               A261TituloId = T001539_A261TituloId[0];
               n261TituloId = T001539_n261TituloId[0];
               AssignAttri("", false, "A261TituloId", StringUtil.LTrimStr( (decimal)(A261TituloId), 9, 0));
               RcdFound44 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(29) != 101) && ( ( T001540_A261TituloId[0] > A261TituloId ) ) )
            {
               pr_default.readNext(29);
            }
            if ( (pr_default.getStatus(29) != 101) && ( ( T001540_A261TituloId[0] < A261TituloId ) ) )
            {
               A261TituloId = T001540_A261TituloId[0];
               n261TituloId = T001540_n261TituloId[0];
               AssignAttri("", false, "A261TituloId", StringUtil.LTrimStr( (decimal)(A261TituloId), 9, 0));
               RcdFound44 = 1;
            }
         }
      ...
      protected void OnDeleteControls1544( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            {
               A516TituloDataCredito_F = T001546_A516TituloDataCredito_F[0];
               n516TituloDataCredito_F = T001546_n516TituloDataCredito_F[0];
            }
            else
            {
               A516TituloDataCredito_F = DateTime.MinValue;
            ...
            {
               A273TituloTotalMovimento_F = T001548_A273TituloTotalMovimento_F[0];
               n273TituloTotalMovimento_F = T001548_n273TituloTotalMovimento_F[0];
               AssignAttri("", false, "A273TituloTotalMovimento_F", StringUtil.LTrimStr( A273TituloTotalMovimento_F, 18, 2));
            }
            else
            {
            ...
            pr_default.close(35);
            /* Using cursor T001550 */
            pr_default.execute(36, new Object[] {n261TituloId, A261TituloId});
            if ( (pr_default.getStatus(36) != 101) )
            {
               A301TituloTotalMultaJuros_F = T001550_A301TituloTotalMultaJuros_F[0];
               n301TituloTotalMultaJuros_F = T001550_n301TituloTotalMultaJuros_F[0];
            }
            else
            {
               A301TituloTotalMultaJuros_F = 0;
            ...
            pr_default.execute(37, new Object[] {n890NotaFiscalParcelamentoID, A890NotaFiscalParcelamentoID});
            A794NotaFiscalId = T001551_A794NotaFiscalId[0];
            n794NotaFiscalId = T001551_n794NotaFiscalId[0];
            pr_default.close(37);
            /* Using cursor T001552 */
            pr_default.execute(38, new Object[] {n794NotaFiscalId, A794NotaFiscalId});
            A799NotaFiscalNumero = T001552_A799NotaFiscalNumero[0];
            n799NotaFiscalNumero = T001552_n799NotaFiscalNumero[0];
            pr_default.close(38);
            /* Using cursor T001553 */
            pr_default.execute(39, new Object[] {n951ContaBancariaId, A951ContaBancariaId});
            A938AgenciaId = T001553_A938AgenciaId[0];
            n938AgenciaId = T001553_n938AgenciaId[0];
            A953ContaBancariaCarteira = T001553_A953ContaBancariaCarteira[0];
            n953ContaBancariaCarteira = T001553_n953ContaBancariaCarteira[0];
            A952ContaBancariaNumero = T001553_A952ContaBancariaNumero[0];
            n952ContaBancariaNumero = T001553_n952ContaBancariaNumero[0];
            pr_default.close(39);
            /* Using cursor T001554 */
            pr_default.execute(40, new Object[] {n938AgenciaId, A938AgenciaId});
            A968AgenciaBancoId = T001554_A968AgenciaBancoId[0];
            n968AgenciaBancoId = T001554_n968AgenciaBancoId[0];
            A939AgenciaNumero = T001554_A939AgenciaNumero[0];
            n939AgenciaNumero = T001554_n939AgenciaNumero[0];
            pr_default.close(40);
            /* Using cursor T001555 */
            pr_default.execute(41, new Object[] {n968AgenciaBancoId, A968AgenciaBancoId});
            A969AgenciaBancoNome = T001555_A969AgenciaBancoNome[0];
            n969AgenciaBancoNome = T001555_n969AgenciaBancoNome[0];
            pr_default.close(41);
            /* Using cursor T001556 */
            pr_default.execute(42, new Object[] {n419TituloPropostaId, A419TituloPropostaId});
            A971TituloPropostaDescricao = T001556_A971TituloPropostaDescricao[0];
            n971TituloPropostaDescricao = T001556_n971TituloPropostaDescricao[0];
            A501PropostaTaxaAdministrativa = T001556_A501PropostaTaxaAdministrativa[0];
            n501PropostaTaxaAdministrativa = T001556_n501PropostaTaxaAdministrativa[0];
            pr_default.close(42);
            /* Using cursor T001557 */
            pr_default.execute(43, new Object[] {n420TituloClienteId, A420TituloClienteId});
            A972TituloCLienteRazaoSocial = T001557_A972TituloCLienteRazaoSocial[0];
            n972TituloCLienteRazaoSocial = T001557_n972TituloCLienteRazaoSocial[0];
            pr_default.close(43);
         }
         if ( AnyError == 0 )
         {
            /* Using cursor T001558 */
            pr_default.execute(44, new Object[] {n261TituloId, A261TituloId});
      ...
      public void ScanStart1544( )
      {
         ...
         {
            RcdFound44 = 1;
            A261TituloId = T001559_A261TituloId[0];
            n261TituloId = T001559_n261TituloId[0];
            AssignAttri("", false, "A261TituloId", StringUtil.LTrimStr( (decimal)(A261TituloId), 9, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918453228", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("titulo.js", "?202551918453230", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void GX9ASATITULOTOTALMULTAJUROSCREDITO_F1544( string A283TituloTipo ,
                                                               int A261TituloId )
      {
         A307TituloTotalMultaJurosCredito_F = ((StringUtil.StrCmp(A283TituloTipo, "CREDITO")==0) ? GetTituloTotalMultaJurosCredito_F0( A261TituloId) : (decimal)(0));
         AssignAttri("", false, "A307TituloTotalMultaJurosCredito_F", StringUtil.LTrimStr( A307TituloTotalMultaJurosCredito_F, 18, 2));
      ...
      protected void GX10ASATITULOTOTALMULTAJUROSDEBITO_F1544( string A283TituloTipo ,
                                                               int A261TituloId )
      {
         A306TituloTotalMultaJurosDebito_F = ((StringUtil.StrCmp(A283TituloTipo, "DEBITO")==0) ? GetTituloTotalMultaJurosDebito_F0( A261TituloId) : (decimal)(0));
         AssignAttri("", false, "A306TituloTotalMultaJurosDebito_F", StringUtil.LTrimStr( A306TituloTotalMultaJurosDebito_F, 18, 2));
      ...
      protected void GX11ASATITULOTOTALMOVIMENTOCREDITO_F1544( string A283TituloTipo ,
                                                               int A261TituloId )
      {
         A305TituloTotalMovimentoCredito_F = ((StringUtil.StrCmp(A283TituloTipo, "CREDITO")==0) ? GetTituloTotalMovimentoCredito_F0( A261TituloId) : (decimal)(0));
         AssignAttri("", false, "A305TituloTotalMovimentoCredito_F", StringUtil.LTrimStr( A305TituloTotalMovimentoCredito_F, 18, 2));
      ...
      protected void GX12ASATITULOTOTALMOVIMENTODEBITO_F1544( string A283TituloTipo ,
                                                              int A261TituloId )
      {
         A304TituloTotalMovimentoDebito_F = ((StringUtil.StrCmp(A283TituloTipo, "DEBITO")==0) ? GetTituloTotalMovimentoDebito_F0( A261TituloId) : (decimal)(0));
         AssignAttri("", false, "A304TituloTotalMovimentoDebito_F", StringUtil.LTrimStr( A304TituloTotalMovimentoDebito_F, 18, 2));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_TITULOID",""","oparms":[{"av":"A516TituloDataCredito_F","fld":"TITULODATACREDITO_F","type":"date"},{"av":"A273TituloTotalMovimento_F","fld":"TITULOTOTALMOVIMENTO_F","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"A301TituloTotalMultaJuros_F","fld":"TITULOTOTALMULTAJUROS_F","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"}]}""");
      ...
      protected decimal GetTituloTotalMovimentoDebito_F0( int E261TituloId )
      {
         ...
         pr_default.execute(46, new Object[] {nA261TituloId, E261TituloId});
         if ( (pr_default.getStatus(46) != 101) )
         {
            X271TituloMovimentoValor = T001560_A271TituloMovimentoValor[0];
            nX271TituloMovimentoValor = T001560_n271TituloMovimentoValor[0];
         }
         pr_default.close(46);
      ...
      protected decimal GetTituloTotalMovimentoCredito_F0( int E261TituloId )
      {
         ...
         pr_default.execute(47, new Object[] {nE261TituloId, E261TituloId});
         if ( (pr_default.getStatus(47) != 101) )
         {
            X271TituloMovimentoValor = T001561_A271TituloMovimentoValor[0];
            nX271TituloMovimentoValor = T001561_n271TituloMovimentoValor[0];
         }
         pr_default.close(47);
         return X271TituloMovimentoValor ;
      }
      ...
      protected decimal GetTituloTotalMultaJurosDebito_F0( int E261TituloId )
      {
         ...
         pr_default.execute(48, new Object[] {nE261TituloId, E261TituloId});
         if ( (pr_default.getStatus(48) != 101) )
         {
            X271TituloMovimentoValor = T001562_A271TituloMovimentoValor[0];
            nX271TituloMovimentoValor = T001562_n271TituloMovimentoValor[0];
         }
         pr_default.close(48);
         return X271TituloMovimentoValor ;
      }
      ...
      protected decimal GetTituloTotalMultaJurosCredito_F0( int E261TituloId )
      {
         ...
         pr_default.execute(49, new Object[] {nE261TituloId, E261TituloId});
         if ( (pr_default.getStatus(49) != 101) )
         {
            X271TituloMovimentoValor = T001563_A271TituloMovimentoValor[0];
            nX271TituloMovimentoValor = T001563_n271TituloMovimentoValor[0];
         }
         pr_default.close(49);
         return X271TituloMovimentoValor ;
      }
      ...
      public override void initialize( )
      {
         ...
         T001522_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         T001522_n794NotaFiscalId = new bool[] {false} ;
         T001522_A938AgenciaId = new int[1] ;
         T001522_n938AgenciaId = new bool[] {false} ;
         T001522_A968AgenciaBancoId = new int[1] ;
         T001522_n968AgenciaBancoId = new bool[] {false} ;
         T001522_A261TituloId = new int[1] ;
         T001522_n261TituloId = new bool[] {false} ;
         T001522_A972TituloCLienteRazaoSocial = new string[] {""} ;
         T001522_n972TituloCLienteRazaoSocial = new bool[] {false} ;
         T001522_A262TituloValor = new decimal[1] ;
         T001522_n262TituloValor = new bool[] {false} ;
         T001522_A276TituloDesconto = new decimal[1] ;
         T001522_n276TituloDesconto = new bool[] {false} ;
         T001522_A284TituloDeleted = new bool[] {false} ;
         T001522_n284TituloDeleted = new bool[] {false} ;
         T001522_A314TituloArchived = new bool[] {false} ;
         T001522_n314TituloArchived = new bool[] {false} ;
         T001522_A263TituloVencimento = new DateTime[] {DateTime.MinValue} ;
         T001522_n263TituloVencimento = new bool[] {false} ;
         T001522_A286TituloCompetenciaAno = new short[1] ;
         T001522_n286TituloCompetenciaAno = new bool[] {false} ;
         T001522_A287TituloCompetenciaMes = new short[1] ;
         T001522_n287TituloCompetenciaMes = new bool[] {false} ;
         T001522_A264TituloProrrogacao = new DateTime[] {DateTime.MinValue} ;
         T001522_n264TituloProrrogacao = new bool[] {false} ;
         T001522_A265TituloCEP = new string[] {""} ;
         T001522_n265TituloCEP = new bool[] {false} ;
         T001522_A266TituloLogradouro = new string[] {""} ;
         T001522_n266TituloLogradouro = new bool[] {false} ;
         T001522_A294TituloNumeroEndereco = new string[] {""} ;
         T001522_n294TituloNumeroEndereco = new bool[] {false} ;
         T001522_A267TituloComplemento = new string[] {""} ;
         T001522_n267TituloComplemento = new bool[] {false} ;
         T001522_A268TituloBairro = new string[] {""} ;
         T001522_n268TituloBairro = new bool[] {false} ;
         T001522_A269TituloMunicipio = new string[] {""} ;
         T001522_n269TituloMunicipio = new bool[] {false} ;
         T001522_A498TituloJurosMora = new decimal[1] ;
         T001522_n498TituloJurosMora = new bool[] {false} ;
         T001522_A283TituloTipo = new string[] {""} ;
         T001522_n283TituloTipo = new bool[] {false} ;
         T001522_A971TituloPropostaDescricao = new string[] {""} ;
         T001522_n971TituloPropostaDescricao = new bool[] {false} ;
         T001522_A501PropostaTaxaAdministrativa = new decimal[1] ;
         T001522_n501PropostaTaxaAdministrativa = new bool[] {false} ;
         T001522_A500TituloCriacao = new DateTime[] {DateTime.MinValue} ;
         T001522_n500TituloCriacao = new bool[] {false} ;
         T001522_A648TituloPropostaTipo = new string[] {""} ;
         T001522_n648TituloPropostaTipo = new bool[] {false} ;
         T001522_A799NotaFiscalNumero = new string[] {""} ;
         T001522_n799NotaFiscalNumero = new bool[] {false} ;
         T001522_A969AgenciaBancoNome = new string[] {""} ;
         T001522_n969AgenciaBancoNome = new bool[] {false} ;
         T001522_A953ContaBancariaCarteira = new long[1] ;
         T001522_n953ContaBancariaCarteira = new bool[] {false} ;
         T001522_A952ContaBancariaNumero = new long[1] ;
         T001522_n952ContaBancariaNumero = new bool[] {false} ;
         T001522_A939AgenciaNumero = new int[1] ;
         T001522_n939AgenciaNumero = new bool[] {false} ;
         T001522_A422ContaId = new int[1] ;
         T001522_n422ContaId = new bool[] {false} ;
         T001522_A426CategoriaTituloId = new int[1] ;
         T001522_n426CategoriaTituloId = new bool[] {false} ;
         T001522_A890NotaFiscalParcelamentoID = new Guid[] {Guid.Empty} ;
         T001522_n890NotaFiscalParcelamentoID = new bool[] {false} ;
         T001522_A951ContaBancariaId = new int[1] ;
         T001522_n951ContaBancariaId = new bool[] {false} ;
         T001522_A419TituloPropostaId = new int[1] ;
         T001522_n419TituloPropostaId = new bool[] {false} ;
         T001522_A420TituloClienteId = new int[1] ;
         T001522_n420TituloClienteId = new bool[] {false} ;
         T001522_A516TituloDataCredito_F = new DateTime[] {DateTime.MinValue} ;
         T001522_n516TituloDataCredito_F = new bool[] {false} ;
         T001522_A273TituloTotalMovimento_F = new decimal[1] ;
         T001522_n273TituloTotalMovimento_F = new bool[] {false} ;
         T001522_A301TituloTotalMultaJuros_F = new decimal[1] ;
         T001522_n301TituloTotalMultaJuros_F = new bool[] {false} ;
         ...
         T001524_A516TituloDataCredito_F = new DateTime[] {DateTime.MinValue} ;
         T001524_n516TituloDataCredito_F = new bool[] {false} ;
         T001526_A273TituloTotalMovimento_F = new decimal[1] ;
         T001526_n273TituloTotalMovimento_F = new bool[] {false} ;
         T001528_A301TituloTotalMultaJuros_F = new decimal[1] ;
         T001528_n301TituloTotalMultaJuros_F = new bool[] {false} ;
         T001529_A422ContaId = new int[1] ;
         T001529_n422ContaId = new bool[] {false} ;
         T001530_A426CategoriaTituloId = new int[1] ;
         T001530_n426CategoriaTituloId = new bool[] {false} ;
         T001531_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         T001531_n794NotaFiscalId = new bool[] {false} ;
         T001532_A799NotaFiscalNumero = new string[] {""} ;
         T001532_n799NotaFiscalNumero = new bool[] {false} ;
         T001533_A938AgenciaId = new int[1] ;
         T001533_n938AgenciaId = new bool[] {false} ;
         T001533_A953ContaBancariaCarteira = new long[1] ;
         T001533_n953ContaBancariaCarteira = new bool[] {false} ;
         T001533_A952ContaBancariaNumero = new long[1] ;
         T001533_n952ContaBancariaNumero = new bool[] {false} ;
         T001534_A968AgenciaBancoId = new int[1] ;
         T001534_n968AgenciaBancoId = new bool[] {false} ;
         T001534_A939AgenciaNumero = new int[1] ;
         T001534_n939AgenciaNumero = new bool[] {false} ;
         T001535_A969AgenciaBancoNome = new string[] {""} ;
         T001535_n969AgenciaBancoNome = new bool[] {false} ;
         T001536_A971TituloPropostaDescricao = new string[] {""} ;
         T001536_n971TituloPropostaDescricao = new bool[] {false} ;
         T001536_A501PropostaTaxaAdministrativa = new decimal[1] ;
         T001536_n501PropostaTaxaAdministrativa = new bool[] {false} ;
         T001537_A972TituloCLienteRazaoSocial = new string[] {""} ;
         T001537_n972TituloCLienteRazaoSocial = new bool[] {false} ;
         T001538_A261TituloId = new int[1] ;
         T001538_n261TituloId = new bool[] {false} ;
         ...
         T001539_A261TituloId = new int[1] ;
         T001539_n261TituloId = new bool[] {false} ;
         T001540_A261TituloId = new int[1] ;
         T001540_n261TituloId = new bool[] {false} ;
         ...
         T001542_A261TituloId = new int[1] ;
         T001542_n261TituloId = new bool[] {false} ;
         T001546_A516TituloDataCredito_F = new DateTime[] {DateTime.MinValue} ;
         T001546_n516TituloDataCredito_F = new bool[] {false} ;
         T001548_A273TituloTotalMovimento_F = new decimal[1] ;
         T001548_n273TituloTotalMovimento_F = new bool[] {false} ;
         T001550_A301TituloTotalMultaJuros_F = new decimal[1] ;
         T001550_n301TituloTotalMultaJuros_F = new bool[] {false} ;
         T001551_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         T001551_n794NotaFiscalId = new bool[] {false} ;
         T001552_A799NotaFiscalNumero = new string[] {""} ;
         T001552_n799NotaFiscalNumero = new bool[] {false} ;
         T001553_A938AgenciaId = new int[1] ;
         T001553_n938AgenciaId = new bool[] {false} ;
         T001553_A953ContaBancariaCarteira = new long[1] ;
         T001553_n953ContaBancariaCarteira = new bool[] {false} ;
         T001553_A952ContaBancariaNumero = new long[1] ;
         T001553_n952ContaBancariaNumero = new bool[] {false} ;
         T001554_A968AgenciaBancoId = new int[1] ;
         T001554_n968AgenciaBancoId = new bool[] {false} ;
         T001554_A939AgenciaNumero = new int[1] ;
         T001554_n939AgenciaNumero = new bool[] {false} ;
         T001555_A969AgenciaBancoNome = new string[] {""} ;
         T001555_n969AgenciaBancoNome = new bool[] {false} ;
         T001556_A971TituloPropostaDescricao = new string[] {""} ;
         T001556_n971TituloPropostaDescricao = new bool[] {false} ;
         T001556_A501PropostaTaxaAdministrativa = new decimal[1] ;
         T001556_n501PropostaTaxaAdministrativa = new bool[] {false} ;
         T001557_A972TituloCLienteRazaoSocial = new string[] {""} ;
         T001557_n972TituloCLienteRazaoSocial = new bool[] {false} ;
         T001558_A270TituloMovimentoId = new int[1] ;
         T001559_A261TituloId = new int[1] ;
         T001559_n261TituloId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXEncryptionTmp = "";
         i500TituloCriacao = (DateTime)(DateTime.MinValue);
         T001560_A271TituloMovimentoValor = new decimal[1] ;
         T001560_n271TituloMovimentoValor = new bool[] {false} ;
         T001561_A271TituloMovimentoValor = new decimal[1] ;
         T001561_n271TituloMovimentoValor = new bool[] {false} ;
         T001562_A271TituloMovimentoValor = new decimal[1] ;
         T001562_n271TituloMovimentoValor = new bool[] {false} ;
         T001563_A271TituloMovimentoValor = new decimal[1] ;
         T001563_n271TituloMovimentoValor = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.titulo__default(),
            new Object[][] {
               ...
               , new Object[] {
               T001522_A794NotaFiscalId, T001522_n794NotaFiscalId, T001522_A938AgenciaId, T001522_n938AgenciaId, T001522_A968AgenciaBancoId, T001522_n968AgenciaBancoId, T001522_A261TituloId, T001522_A972TituloCLienteRazaoSocial, T001522_n972TituloCLienteRazaoSocial, T001522_A262TituloValor,
               T001522_n262TituloValor, T001522_A276TituloDesconto, T001522_n276TituloDesconto, T001522_A284TituloDeleted, T001522_n284TituloDeleted, T001522_A314TituloArchived, T001522_n314TituloArchived, T001522_A263TituloVencimento, T001522_n263TituloVencimento, T001522_A286TituloCompetenciaAno,
               T001522_n286TituloCompetenciaAno, T001522_A287TituloCompetenciaMes, T001522_n287TituloCompetenciaMes, T001522_A264TituloProrrogacao, T001522_n264TituloProrrogacao, T001522_A265TituloCEP, T001522_n265TituloCEP, T001522_A266TituloLogradouro, T001522_n266TituloLogradouro, T001522_A294TituloNumeroEndereco,
               T001522_n294TituloNumeroEndereco, T001522_A267TituloComplemento, T001522_n267TituloComplemento, T001522_A268TituloBairro, T001522_n268TituloBairro, T001522_A269TituloMunicipio, T001522_n269TituloMunicipio, T001522_A498TituloJurosMora, T001522_n498TituloJurosMora, T001522_A283TituloTipo,
               T001522_n283TituloTipo, T001522_A971TituloPropostaDescricao, T001522_n971TituloPropostaDescricao, T001522_A501PropostaTaxaAdministrativa, T001522_n501PropostaTaxaAdministrativa, T001522_A500TituloCriacao, T001522_n500TituloCriacao, T001522_A648TituloPropostaTipo, T001522_n648TituloPropostaTipo, T001522_A799NotaFiscalNumero,
               T001522_n799NotaFiscalNumero, T001522_A969AgenciaBancoNome, T001522_n969AgenciaBancoNome, T001522_A953ContaBancariaCarteira, T001522_n953ContaBancariaCarteira, T001522_A952ContaBancariaNumero, T001522_n952ContaBancariaNumero, T001522_A939AgenciaNumero, T001522_n939AgenciaNumero, T001522_A422ContaId,
               T001522_n422ContaId, T001522_A426CategoriaTituloId, T001522_n426CategoriaTituloId, T001522_A890NotaFiscalParcelamentoID, T001522_n890NotaFiscalParcelamentoID, T001522_A951ContaBancariaId, T001522_n951ContaBancariaId, T001522_A419TituloPropostaId, T001522_n419TituloPropostaId, T001522_A420TituloClienteId,
               T001522_n420TituloClienteId, T001522_A516TituloDataCredito_F, T001522_n516TituloDataCredito_F, T001522_A273TituloTotalMovimento_F, T001522_n273TituloTotalMovimento_F, T001522_A301TituloTotalMultaJuros_F, T001522_n301TituloTotalMultaJuros_F
               }
               , new Object[] {
               T001524_A516TituloDataCredito_F, T001524_n516TituloDataCredito_F
               }
               , new Object[] {
               T001526_A273TituloTotalMovimento_F, T001526_n273TituloTotalMovimento_F
               }
               , new Object[] {
               T001528_A301TituloTotalMultaJuros_F, T001528_n301TituloTotalMultaJuros_F
               }
               , new Object[] {
               T001529_A422ContaId
               }
               , new Object[] {
               T001530_A426CategoriaTituloId
               }
               , new Object[] {
               T001531_A794NotaFiscalId, T001531_n794NotaFiscalId
               }
               , new Object[] {
               T001532_A799NotaFiscalNumero, T001532_n799NotaFiscalNumero
               }
               , new Object[] {
               T001533_A938AgenciaId, T001533_n938AgenciaId, T001533_A953ContaBancariaCarteira, T001533_n953ContaBancariaCarteira, T001533_A952ContaBancariaNumero, T001533_n952ContaBancariaNumero
               }
               , new Object[] {
               T001534_A968AgenciaBancoId, T001534_n968AgenciaBancoId, T001534_A939AgenciaNumero, T001534_n939AgenciaNumero
               }
               , new Object[] {
               T001535_A969AgenciaBancoNome, T001535_n969AgenciaBancoNome
               }
               , new Object[] {
               T001536_A971TituloPropostaDescricao, T001536_n971TituloPropostaDescricao, T001536_A501PropostaTaxaAdministrativa, T001536_n501PropostaTaxaAdministrativa
               }
               , new Object[] {
               T001537_A972TituloCLienteRazaoSocial, T001537_n972TituloCLienteRazaoSocial
               }
               , new Object[] {
               T001538_A261TituloId
               }
               , new Object[] {
               T001539_A261TituloId
               }
               , new Object[] {
               T001540_A261TituloId
               }
               , new Object[] {
               }
               , new Object[] {
               T001542_A261TituloId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T001546_A516TituloDataCredito_F, T001546_n516TituloDataCredito_F
               }
               , new Object[] {
               T001548_A273TituloTotalMovimento_F, T001548_n273TituloTotalMovimento_F
               }
               , new Object[] {
               T001550_A301TituloTotalMultaJuros_F, T001550_n301TituloTotalMultaJuros_F
               }
               , new Object[] {
               T001551_A794NotaFiscalId, T001551_n794NotaFiscalId
               }
               , new Object[] {
               T001552_A799NotaFiscalNumero, T001552_n799NotaFiscalNumero
               }
               , new Object[] {
               T001553_A938AgenciaId, T001553_n938AgenciaId, T001553_A953ContaBancariaCarteira, T001553_n953ContaBancariaCarteira, T001553_A952ContaBancariaNumero, T001553_n952ContaBancariaNumero
               }
               , new Object[] {
               T001554_A968AgenciaBancoId, T001554_n968AgenciaBancoId, T001554_A939AgenciaNumero, T001554_n939AgenciaNumero
               }
               , new Object[] {
               T001555_A969AgenciaBancoNome, T001555_n969AgenciaBancoNome
               }
               , new Object[] {
               T001556_A971TituloPropostaDescricao, T001556_n971TituloPropostaDescricao, T001556_A501PropostaTaxaAdministrativa, T001556_n501PropostaTaxaAdministrativa
               }
               , new Object[] {
               T001557_A972TituloCLienteRazaoSocial, T001557_n972TituloCLienteRazaoSocial
               }
               , new Object[] {
               T001558_A270TituloMovimentoId
               }
               , new Object[] {
               T001559_A261TituloId
               }
               , new Object[] {
               T001560_A271TituloMovimentoValor, T001560_n271TituloMovimentoValor
               }
               , new Object[] {
               T001561_A271TituloMovimentoValor, T001561_n271TituloMovimentoValor
               }
               , new Object[] {
               T001562_A271TituloMovimentoValor, T001562_n271TituloMovimentoValor
               }
               , new Object[] {
               T001563_A271TituloMovimentoValor, T001563_n271TituloMovimentoValor
               }
            }
         );
      ...
      private Guid[] T001522_A794NotaFiscalId ;
      private bool[] T001522_n794NotaFiscalId ;
      private int[] T001522_A938AgenciaId ;
      private bool[] T001522_n938AgenciaId ;
      private int[] T001522_A968AgenciaBancoId ;
      private bool[] T001522_n968AgenciaBancoId ;
      private int[] T001522_A261TituloId ;
      private bool[] T001522_n261TituloId ;
      private string[] T001522_A972TituloCLienteRazaoSocial ;
      private bool[] T001522_n972TituloCLienteRazaoSocial ;
      private decimal[] T001522_A262TituloValor ;
      private bool[] T001522_n262TituloValor ;
      private decimal[] T001522_A276TituloDesconto ;
      private bool[] T001522_n276TituloDesconto ;
      private bool[] T001522_A284TituloDeleted ;
      private bool[] T001522_n284TituloDeleted ;
      private bool[] T001522_A314TituloArchived ;
      private bool[] T001522_n314TituloArchived ;
      private DateTime[] T001522_A263TituloVencimento ;
      private bool[] T001522_n263TituloVencimento ;
      private short[] T001522_A286TituloCompetenciaAno ;
      private bool[] T001522_n286TituloCompetenciaAno ;
      private short[] T001522_A287TituloCompetenciaMes ;
      private bool[] T001522_n287TituloCompetenciaMes ;
      private DateTime[] T001522_A264TituloProrrogacao ;
      private bool[] T001522_n264TituloProrrogacao ;
      private string[] T001522_A265TituloCEP ;
      private bool[] T001522_n265TituloCEP ;
      private string[] T001522_A266TituloLogradouro ;
      private bool[] T001522_n266TituloLogradouro ;
      private string[] T001522_A294TituloNumeroEndereco ;
      private bool[] T001522_n294TituloNumeroEndereco ;
      private string[] T001522_A267TituloComplemento ;
      private bool[] T001522_n267TituloComplemento ;
      private string[] T001522_A268TituloBairro ;
      private bool[] T001522_n268TituloBairro ;
      private string[] T001522_A269TituloMunicipio ;
      private bool[] T001522_n269TituloMunicipio ;
      private decimal[] T001522_A498TituloJurosMora ;
      private bool[] T001522_n498TituloJurosMora ;
      private string[] T001522_A283TituloTipo ;
      private bool[] T001522_n283TituloTipo ;
      private string[] T001522_A971TituloPropostaDescricao ;
      private bool[] T001522_n971TituloPropostaDescricao ;
      private decimal[] T001522_A501PropostaTaxaAdministrativa ;
      private bool[] T001522_n501PropostaTaxaAdministrativa ;
      private DateTime[] T001522_A500TituloCriacao ;
      private bool[] T001522_n500TituloCriacao ;
      private string[] T001522_A648TituloPropostaTipo ;
      private bool[] T001522_n648TituloPropostaTipo ;
      private string[] T001522_A799NotaFiscalNumero ;
      private bool[] T001522_n799NotaFiscalNumero ;
      private string[] T001522_A969AgenciaBancoNome ;
      private bool[] T001522_n969AgenciaBancoNome ;
      private long[] T001522_A953ContaBancariaCarteira ;
      private bool[] T001522_n953ContaBancariaCarteira ;
      private long[] T001522_A952ContaBancariaNumero ;
      private bool[] T001522_n952ContaBancariaNumero ;
      private int[] T001522_A939AgenciaNumero ;
      private bool[] T001522_n939AgenciaNumero ;
      private int[] T001522_A422ContaId ;
      private bool[] T001522_n422ContaId ;
      private int[] T001522_A426CategoriaTituloId ;
      private bool[] T001522_n426CategoriaTituloId ;
      private Guid[] T001522_A890NotaFiscalParcelamentoID ;
      private bool[] T001522_n890NotaFiscalParcelamentoID ;
      private int[] T001522_A951ContaBancariaId ;
      private bool[] T001522_n951ContaBancariaId ;
      private int[] T001522_A419TituloPropostaId ;
      private bool[] T001522_n419TituloPropostaId ;
      private int[] T001522_A420TituloClienteId ;
      private bool[] T001522_n420TituloClienteId ;
      private DateTime[] T001522_A516TituloDataCredito_F ;
      private bool[] T001522_n516TituloDataCredito_F ;
      private decimal[] T001522_A273TituloTotalMovimento_F ;
      private bool[] T001522_n273TituloTotalMovimento_F ;
      private decimal[] T001522_A301TituloTotalMultaJuros_F ;
      private bool[] T001522_n301TituloTotalMultaJuros_F ;
      ...
      private DateTime[] T001524_A516TituloDataCredito_F ;
      private bool[] T001524_n516TituloDataCredito_F ;
      private decimal[] T001526_A273TituloTotalMovimento_F ;
      private bool[] T001526_n273TituloTotalMovimento_F ;
      private decimal[] T001528_A301TituloTotalMultaJuros_F ;
      private bool[] T001528_n301TituloTotalMultaJuros_F ;
      private int[] T001529_A422ContaId ;
      private bool[] T001529_n422ContaId ;
      private int[] T001530_A426CategoriaTituloId ;
      private bool[] T001530_n426CategoriaTituloId ;
      private Guid[] T001531_A794NotaFiscalId ;
      private bool[] T001531_n794NotaFiscalId ;
      private string[] T001532_A799NotaFiscalNumero ;
      private bool[] T001532_n799NotaFiscalNumero ;
      private int[] T001533_A938AgenciaId ;
      private bool[] T001533_n938AgenciaId ;
      private long[] T001533_A953ContaBancariaCarteira ;
      private bool[] T001533_n953ContaBancariaCarteira ;
      private long[] T001533_A952ContaBancariaNumero ;
      private bool[] T001533_n952ContaBancariaNumero ;
      private int[] T001534_A968AgenciaBancoId ;
      private bool[] T001534_n968AgenciaBancoId ;
      private int[] T001534_A939AgenciaNumero ;
      private bool[] T001534_n939AgenciaNumero ;
      private string[] T001535_A969AgenciaBancoNome ;
      private bool[] T001535_n969AgenciaBancoNome ;
      private string[] T001536_A971TituloPropostaDescricao ;
      private bool[] T001536_n971TituloPropostaDescricao ;
      private decimal[] T001536_A501PropostaTaxaAdministrativa ;
      private bool[] T001536_n501PropostaTaxaAdministrativa ;
      private string[] T001537_A972TituloCLienteRazaoSocial ;
      private bool[] T001537_n972TituloCLienteRazaoSocial ;
      private int[] T001538_A261TituloId ;
      private bool[] T001538_n261TituloId ;
      ...
      private int[] T001539_A261TituloId ;
      private bool[] T001539_n261TituloId ;
      private int[] T001540_A261TituloId ;
      private bool[] T001540_n261TituloId ;
      ...
      private int[] T001542_A261TituloId ;
      private bool[] T001542_n261TituloId ;
      private DateTime[] T001546_A516TituloDataCredito_F ;
      private bool[] T001546_n516TituloDataCredito_F ;
      private decimal[] T001548_A273TituloTotalMovimento_F ;
      private bool[] T001548_n273TituloTotalMovimento_F ;
      private decimal[] T001550_A301TituloTotalMultaJuros_F ;
      private bool[] T001550_n301TituloTotalMultaJuros_F ;
      private Guid[] T001551_A794NotaFiscalId ;
      private bool[] T001551_n794NotaFiscalId ;
      private string[] T001552_A799NotaFiscalNumero ;
      private bool[] T001552_n799NotaFiscalNumero ;
      private int[] T001553_A938AgenciaId ;
      private bool[] T001553_n938AgenciaId ;
      private long[] T001553_A953ContaBancariaCarteira ;
      private bool[] T001553_n953ContaBancariaCarteira ;
      private long[] T001553_A952ContaBancariaNumero ;
      private bool[] T001553_n952ContaBancariaNumero ;
      private int[] T001554_A968AgenciaBancoId ;
      private bool[] T001554_n968AgenciaBancoId ;
      private int[] T001554_A939AgenciaNumero ;
      private bool[] T001554_n939AgenciaNumero ;
      private string[] T001555_A969AgenciaBancoNome ;
      private bool[] T001555_n969AgenciaBancoNome ;
      private string[] T001556_A971TituloPropostaDescricao ;
      private bool[] T001556_n971TituloPropostaDescricao ;
      private decimal[] T001556_A501PropostaTaxaAdministrativa ;
      private bool[] T001556_n501PropostaTaxaAdministrativa ;
      private string[] T001557_A972TituloCLienteRazaoSocial ;
      private bool[] T001557_n972TituloCLienteRazaoSocial ;
      private int[] T001558_A270TituloMovimentoId ;
      private int[] T001559_A261TituloId ;
      private bool[] T001559_n261TituloId ;
      private decimal[] T001560_A271TituloMovimentoValor ;
      private bool[] T001560_n271TituloMovimentoValor ;
      private decimal[] T001561_A271TituloMovimentoValor ;
      private bool[] T001561_n271TituloMovimentoValor ;
      private decimal[] T001562_A271TituloMovimentoValor ;
      private bool[] T001562_n271TituloMovimentoValor ;
      private decimal[] T001563_A271TituloMovimentoValor ;
      private bool[] T001563_n271TituloMovimentoValor ;
   }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T001522", cmdBufferT001522,true, GxErrorMask.GX_NOMASK, false, this,prmT001522,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001524", "SELECT COALESCE( T1.TituloDataCredito_F, DATE '00010101') AS TituloDataCredito_F FROM (SELECT MAX(TituloMovimentoDataCredito) AS TituloDataCredito_F, TituloId FROM TituloMovimento GROUP BY TituloId ) T1 WHERE T1.TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001524,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001526", "SELECT COALESCE( T1.TituloTotalMovimento_F, 0) AS TituloTotalMovimento_F FROM (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE TituloMovimentoSoma GROUP BY TituloId ) T1 WHERE T1.TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001526,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001528", "SELECT COALESCE( T1.TituloTotalMovimento_F, 0) AS TituloTotalMultaJuros_F FROM (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE Not TituloMovimentoSoma GROUP BY TituloId ) T1 WHERE T1.TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001528,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001529", "SELECT ContaId FROM Conta WHERE ContaId = :ContaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001529,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001530", "SELECT CategoriaTituloId FROM CategoriaTitulo WHERE CategoriaTituloId = :CategoriaTituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001530,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001531", "SELECT NotaFiscalId FROM NotaFiscalParcelamento WHERE NotaFiscalParcelamentoID = :NotaFiscalParcelamentoID ",true, GxErrorMask.GX_NOMASK, false, this,prmT001531,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001532", "SELECT NotaFiscalNumero FROM NotaFiscal WHERE NotaFiscalId = :NotaFiscalId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001532,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001533", "SELECT AgenciaId, ContaBancariaCarteira, ContaBancariaNumero FROM ContaBancaria WHERE ContaBancariaId = :ContaBancariaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001533,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001534", "SELECT AgenciaBancoId, AgenciaNumero FROM Agencia WHERE AgenciaId = :AgenciaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001534,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001535", "SELECT BancoNome AS AgenciaBancoNome FROM Banco WHERE BancoId = :AgenciaBancoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001535,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001536", "SELECT PropostaDescricao AS TituloPropostaDescricao, PropostaTaxaAdministrativa FROM Proposta WHERE PropostaId = :TituloPropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001536,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001537", "SELECT ClienteRazaoSocial AS TituloCLienteRazaoSocial FROM Cliente WHERE ClienteId = :TituloClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001537,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001538", "SELECT TituloId FROM Titulo WHERE TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001538,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001539", "SELECT TituloId FROM Titulo WHERE ( TituloId > :TituloId) ORDER BY TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001539,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T001540", "SELECT TituloId FROM Titulo WHERE ( TituloId < :TituloId) ORDER BY TituloId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT001540,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T001541", "SAVEPOINT gxupdate;INSERT INTO Titulo(TituloValor, TituloDesconto, TituloDeleted, TituloArchived, TituloVencimento, TituloCompetenciaAno, TituloCompetenciaMes, TituloProrrogacao, TituloCEP, TituloLogradouro, TituloNumeroEndereco, TituloComplemento, TituloBairro, TituloMunicipio, TituloJurosMora, TituloTipo, TituloCriacao, TituloPropostaTipo, ContaId, CategoriaTituloId, NotaFiscalParcelamentoID, ContaBancariaId, TituloPropostaId, TituloClienteId) VALUES(:TituloValor, :TituloDesconto, :TituloDeleted, :TituloArchived, :TituloVencimento, :TituloCompetenciaAno, :TituloCompetenciaMes, :TituloProrrogacao, :TituloCEP, :TituloLogradouro, :TituloNumeroEndereco, :TituloComplemento, :TituloBairro, :TituloMunicipio, :TituloJurosMora, :TituloTipo, :TituloCriacao, :TituloPropostaTipo, :ContaId, :CategoriaTituloId, :NotaFiscalParcelamentoID, :ContaBancariaId, :TituloPropostaId, :TituloClienteId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001541)
             ,new CursorDef("T001542", "SELECT currval('TituloId') ",true, GxErrorMask.GX_NOMASK, false, this,prmT001542,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001543", "SAVEPOINT gxupdate;UPDATE Titulo SET TituloValor=:TituloValor, TituloDesconto=:TituloDesconto, TituloDeleted=:TituloDeleted, TituloArchived=:TituloArchived, TituloVencimento=:TituloVencimento, TituloCompetenciaAno=:TituloCompetenciaAno, TituloCompetenciaMes=:TituloCompetenciaMes, TituloProrrogacao=:TituloProrrogacao, TituloCEP=:TituloCEP, TituloLogradouro=:TituloLogradouro, TituloNumeroEndereco=:TituloNumeroEndereco, TituloComplemento=:TituloComplemento, TituloBairro=:TituloBairro, TituloMunicipio=:TituloMunicipio, TituloJurosMora=:TituloJurosMora, TituloTipo=:TituloTipo, TituloCriacao=:TituloCriacao, TituloPropostaTipo=:TituloPropostaTipo, ContaId=:ContaId, CategoriaTituloId=:CategoriaTituloId, NotaFiscalParcelamentoID=:NotaFiscalParcelamentoID, ContaBancariaId=:ContaBancariaId, TituloPropostaId=:TituloPropostaId, TituloClienteId=:TituloClienteId  WHERE TituloId = :TituloId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001543)
             ,new CursorDef("T001544", "SAVEPOINT gxupdate;DELETE FROM Titulo  WHERE TituloId = :TituloId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001544)
             ,new CursorDef("T001546", "SELECT COALESCE( T1.TituloDataCredito_F, DATE '00010101') AS TituloDataCredito_F FROM (SELECT MAX(TituloMovimentoDataCredito) AS TituloDataCredito_F, TituloId FROM TituloMovimento GROUP BY TituloId ) T1 WHERE T1.TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001546,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001548", "SELECT COALESCE( T1.TituloTotalMovimento_F, 0) AS TituloTotalMovimento_F FROM (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE TituloMovimentoSoma GROUP BY TituloId ) T1 WHERE T1.TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001548,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001550", "SELECT COALESCE( T1.TituloTotalMovimento_F, 0) AS TituloTotalMultaJuros_F FROM (SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F, TituloId FROM TituloMovimento WHERE Not TituloMovimentoSoma GROUP BY TituloId ) T1 WHERE T1.TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001550,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001551", "SELECT NotaFiscalId FROM NotaFiscalParcelamento WHERE NotaFiscalParcelamentoID = :NotaFiscalParcelamentoID ",true, GxErrorMask.GX_NOMASK, false, this,prmT001551,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001552", "SELECT NotaFiscalNumero FROM NotaFiscal WHERE NotaFiscalId = :NotaFiscalId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001552,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001553", "SELECT AgenciaId, ContaBancariaCarteira, ContaBancariaNumero FROM ContaBancaria WHERE ContaBancariaId = :ContaBancariaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001553,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001554", "SELECT AgenciaBancoId, AgenciaNumero FROM Agencia WHERE AgenciaId = :AgenciaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001554,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001555", "SELECT BancoNome AS AgenciaBancoNome FROM Banco WHERE BancoId = :AgenciaBancoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001555,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001556", "SELECT PropostaDescricao AS TituloPropostaDescricao, PropostaTaxaAdministrativa FROM Proposta WHERE PropostaId = :TituloPropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001556,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001557", "SELECT ClienteRazaoSocial AS TituloCLienteRazaoSocial FROM Cliente WHERE ClienteId = :TituloClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001557,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001558", "SELECT TituloMovimentoId FROM TituloMovimento WHERE TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001558,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T001559", "SELECT TituloId FROM Titulo ORDER BY TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001559,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001560", "SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F FROM TituloMovimento WHERE ( TituloId = :TituloId) and ( TituloMovimentoSoma) ",true, GxErrorMask.GX_NOMASK, false, this,prmT001560,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001561", "SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F FROM TituloMovimento WHERE ( TituloId = :TituloId) and ( TituloMovimentoSoma) ",true, GxErrorMask.GX_NOMASK, false, this,prmT001561,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001562", "SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F FROM TituloMovimento WHERE ( TituloId = :TituloId) and ( Not TituloMovimentoSoma) ",true, GxErrorMask.GX_NOMASK, false, this,prmT001562,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001563", "SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F FROM TituloMovimento WHERE ( TituloId = :TituloId) and ( Not TituloMovimentoSoma) ",true, GxErrorMask.GX_NOMASK, false, this,prmT001563,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
