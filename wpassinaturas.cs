...
namespace GeneXus.Programs {
   public class wpassinaturas : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255191857668", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpassinaturas.js", "?20255191857669", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV10Arquivo","fld":"vARQUIVO","hsh":true,"type":""},{"av":"AV8AssinaturaId","fld":"vASSINATURAID","pic":"ZZZZZZZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("'DODOWNLOAD'","""{"handler":"E126F2","iparms":[{"av":"AV10Arquivo","fld":"vARQUIVO","hsh":true,"type":""}]""");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpassinaturas__default(),
            new Object[][] {
                new Object[] {
               H006F2_A227ContratoId, H006F2_n227ContratoId, H006F2_A238AssinaturaId, H006F2_A239AssinaturaStatus, H006F2_n239AssinaturaStatus, H006F2_A231ArquivoId, H006F2_n231ArquivoId, H006F2_A228ContratoNome, H006F2_n228ContratoNome
               }
            }
         );
