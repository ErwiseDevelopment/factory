...
namespace GeneXus.Programs {
   public class popupnovodocumentonome : GXDataArea
   {
      public popupnovodocumentonome( )
      {
      ...
      public popupnovodocumentonome( IGxContext context )
      {
      ...
      public void execute( int aP0_DocumentosId ,
                           out string aP1_Blob ,
                           out string aP2_Extensao ,
                           out string aP3_Nome )
      {
         this.AV11DocumentosId = aP0_DocumentosId;
         this.AV5Blob = "" ;
         this.AV9Extensao = "" ;
         this.AV10Nome = "" ;
         ExecuteImpl();
         aP1_Blob=this.AV5Blob;
         aP2_Extensao=this.AV9Extensao;
         aP3_Nome=this.AV10Nome;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "DocumentosId");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "popupnovodocumentonome"+UrlEncode(StringUtil.LTrimStr(AV11DocumentosId,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV5Blob)) + "," + UrlEncode(StringUtil.RTrim(AV9Extensao)) + "," + UrlEncode(StringUtil.RTrim(AV10Nome));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("popupnovodocumentonome") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vNOME", AV10Nome);
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "popupnovodocumentonome"+UrlEncode(StringUtil.LTrimStr(AV11DocumentosId,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV5Blob)) + "," + UrlEncode(StringUtil.RTrim(AV9Extensao)) + "," + UrlEncode(StringUtil.RTrim(AV10Nome));
         return formatLink("popupnovodocumentonome") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "PopUpNovoDocumentoNome" ;
      }
      ...
      protected void WB6N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnconfirmar_Internalname, "", "Confirmar", bttBtnconfirmar_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOCONFIRMAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PopUpNovoDocumentoNome.htm");
      ...
      protected void PA6N2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "popupnovodocumentonome")), "popupnovodocumentonome") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "popupnovodocumentonome")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV11DocumentosId = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     ...
                     if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
                     {
                        ...
                        AV10Nome = GetPar( "Nome");
                        AssignAttri("", false, "AV10Nome", AV10Nome);
                     }
                  }
                  if ( toggleJsOutput )
                  {
      ...
      protected void E126N2( )
      {
         ...
         returnInSub = false;
         AV16GXV1 = 1;
         while ( AV16GXV1 <= AV6UploadedFiles.Count )
         {
            AV8FileUploadData = ((SdtFileUploadData)AV6UploadedFiles.Item(AV16GXV1));
         ...
         {
            this.executeExternalObjectMethod("", false, "GlobalEvents", "WcDocumentosObrigatoriosReembolso_SalvaArquivo", new Object[] {(int)AV11DocumentosId,(string)AV5Blob,(string)AV9Extensao,(string)AV10Nome}, true);
            context.setWebReturnParms(new Object[] {(string)AV5Blob,(string)AV9Extensao,(string)AV10Nome});
            context.setWebReturnParmsMetadata(new Object[] {"AV5Blob","AV9Extensao","AV10Nome"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV11DocumentosId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV11DocumentosId", StringUtil.LTrimStr( (decimal)(AV11DocumentosId), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCUMENTOSID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocumentosId), "ZZZZZZZZ9"), context));
         AV5Blob = (string)getParm(obj,1);
         AssignAttri("", false, "AV5Blob", AV5Blob);
         AV9Extensao = (string)getParm(obj,2);
         AssignAttri("", false, "AV9Extensao", AV9Extensao);
         AV10Nome = (string)getParm(obj,3);
         AssignAttri("", false, "AV10Nome", AV10Nome);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918565749", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("popupnovodocumentonome.js", "?202551918565750", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ucarquivo_Acceptedfiletypes = "any";
         Ucarquivo_Enableuploadedfilecanceling = Convert.ToBoolean( 0);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOCONFIRMAR'","""{"handler":"E126N2","iparms":[{"av":"AV6UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV11DocumentosId","fld":"vDOCUMENTOSID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("'DOCONFIRMAR'",""","oparms":[{"av":"AV5Blob","fld":"vBLOB","type":"bitstr"},{"av":"AV9Extensao","fld":"vEXTENSAO","type":"svchar"},{"av":"AV10Nome","fld":"vNOME","type":"svchar"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         GXEncryptionTmp = "";
         AV6UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV7FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         GX_FocusControl = "";
         Form = new GXWebForm();
         sPrefix = "";
         TempTags = "";
      ...
      private string aP1_Blob ;
      private string aP2_Extensao ;
