   ...
   public class wwp_df_datetime_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_datetime_wc"+UrlEncode(StringUtil.RTrim(AV26WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV27WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV6WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV20SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_datetime_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vERRORIDS", AV33ErrorIds);
      ...
      protected void WB1O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_datetime_wc");
            }
            ...
            GxWebStd.gx_single_line_edit( context, edtavData_Internalname, context.localUtil.TToC( AV9Data, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( AV9Data, "99/99/99 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'por',false,0);"+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavData_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavData_Enabled, 1, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 0, -1, 0, false, "", "end", false, "", "HLP_WorkWithPlus/DynamicForms/WWP_DF_Datetime_WC.htm");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_datetime_wc")), "workwithplus.dynamicforms.wwp_df_datetime_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_datetime_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E111O2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV14HasReferenceId, context));
         AV34GXV1 = 1;
         while ( AV34GXV1 <= AV30WWPFormInstance.gxTpr_Element.Count )
         {
            AV31WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV30WWPFormInstance.gxTpr_Element.Item(AV34GXV1));
      ...
      protected void E121O2( )
      {
         ...
         returnInSub = false;
         if ( ( AV7AuxSessionId == AV20SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV33ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV27WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV6WWPFormInstanceElementId), 4, 0))+"|") )
         {
      ...
      protected void S142( )
      {
         ...
         AV35GXV2 = 1;
         while ( AV35GXV2 <= AV30WWPFormInstance.gxTpr_Element.Count )
         {
            AV31WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV30WWPFormInstance.gxTpr_Element.Item(AV35GXV2));
            if ( ( AV31WWPFormInstanceElement.gxTpr_Wwpformelementid == AV27WWPFormElementId ) && ( AV31WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV6WWPFormInstanceElementId ) )
            {
      ...
      protected void S152( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV29WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV12ElementInternalName,  "true",  ""));
            AV17IsValid = false;
         }
         else
         {
            if ( AV22Validations.Count > 0 )
            {
               ...
               AV36GXV3 = 1;
               while ( AV36GXV3 <= AV19Messages.Count )
               {
                  AV18Message = ((GeneXus.Utils.SdtMessages_Message)AV19Messages.Item(AV36GXV3));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381497", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_datetime_wc.js", "?202551918381498", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV25WWP_DF_DateMetadata","fld":"vWWP_DF_DATEMETADATA","hsh":true,"type":""},{"av":"AV29WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV14HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E121O2","iparms":[{"av":"AV33ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV7AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV20SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV27WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV6WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV25WWP_DF_DateMetadata","fld":"vWWP_DF_DATEMETADATA","hsh":true,"type":""},{"av":"AV9Data","fld":"vDATA","pic":"99/99/99 99:99","type":"dtime"},{"av":"AV29WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E131O2","iparms":[{"av":"AV7AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV20SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV23VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV25WWP_DF_DateMetadata","fld":"vWWP_DF_DATEMETADATA","hsh":true,"type":""},{"av":"AV6WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         ...
         setEventMetadata("VDATA.CONTROLVALUECHANGED","""{"handler":"E141O2","iparms":[{"av":"AV14HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV20SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV27WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV6WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV25WWP_DF_DateMetadata","fld":"vWWP_DF_DATEMETADATA","hsh":true,"type":""},{"av":"AV9Data","fld":"vDATA","pic":"99/99/99 99:99","type":"dtime"},{"av":"AV29WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED",""","oparms":[{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         return  ;
      }
