...
namespace GeneXus.Programs {
   public class wppropostasassinaturas : GXDataArea
   {
      ...
      protected void S192( )
      {
         ...
         if ( ! AV37DynamicFiltersIgnoreFirst )
         {
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Responsavel Documento",  AV17DynamicFiltersOperator1,  AV66PropostaResponsavelDocumento1,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV17DynamicFiltersOperator1+1), 10, 0)), "Começa com"+" "+AV66PropostaResponsavelDocumento1, "Contém"+" "+AV66PropostaResponsavelDocumento1, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Cliente Documento",  AV17DynamicFiltersOperator1,  AV19PropostaPacienteClienteDocumento1,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV17DynamicFiltersOperator1+1), 10, 0)), "Começa com"+" "+AV19PropostaPacienteClienteDocumento1, "Contém"+" "+AV19PropostaPacienteClienteDocumento1, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Clinica Documento",  AV17DynamicFiltersOperator1,  AV67PropostaClinicaDocumento1,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV17DynamicFiltersOperator1+1), 10, 0)), "Começa com"+" "+AV67PropostaClinicaDocumento1, "Contém"+" "+AV67PropostaClinicaDocumento1, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Contrato Nome",  AV17DynamicFiltersOperator1,  AV20ContratoNome1,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV17DynamicFiltersOperator1+1), 10, 0)), "Começa com"+" "+AV20ContratoNome1, "Contém"+" "+AV20ContratoNome1, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Descrição",  AV17DynamicFiltersOperator1,  AV21ConvenioCategoriaDescricao1,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV17DynamicFiltersOperator1+1), 10, 0)), "Começa com"+" "+AV21ConvenioCategoriaDescricao1, "Contém"+" "+AV21ConvenioCategoriaDescricao1, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
         ...
         if ( AV22DynamicFiltersEnabled2 )
         {
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Responsavel Documento",  AV24DynamicFiltersOperator2,  AV69PropostaResponsavelDocumento2,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV24DynamicFiltersOperator2+1), 10, 0)), "Começa com"+" "+AV69PropostaResponsavelDocumento2, "Contém"+" "+AV69PropostaResponsavelDocumento2, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Proposta Paciente Cliente Razao Social",  AV24DynamicFiltersOperator2,  AV25PropostaPacienteClienteRazaoSocial2,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV24DynamicFiltersOperator2+1), 10, 0)), "Começa com"+" "+AV25PropostaPacienteClienteRazaoSocial2, "Contém"+" "+AV25PropostaPacienteClienteRazaoSocial2, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Cliente Documento",  AV24DynamicFiltersOperator2,  AV26PropostaPacienteClienteDocumento2,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV24DynamicFiltersOperator2+1), 10, 0)), "Começa com"+" "+AV26PropostaPacienteClienteDocumento2, "Contém"+" "+AV26PropostaPacienteClienteDocumento2, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Clinica Documento",  AV24DynamicFiltersOperator2,  AV70PropostaClinicaDocumento2,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV24DynamicFiltersOperator2+1), 10, 0)), "Começa com"+" "+AV70PropostaClinicaDocumento2, "Contém"+" "+AV70PropostaClinicaDocumento2, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Contrato Nome",  AV24DynamicFiltersOperator2,  AV27ContratoNome2,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV24DynamicFiltersOperator2+1), 10, 0)), "Começa com"+" "+AV27ContratoNome2, "Contém"+" "+AV27ContratoNome2, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Descrição",  AV24DynamicFiltersOperator2,  AV28ConvenioCategoriaDescricao2,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV24DynamicFiltersOperator2+1), 10, 0)), "Começa com"+" "+AV28ConvenioCategoriaDescricao2, "Contém"+" "+AV28ConvenioCategoriaDescricao2, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            if ( AV36DynamicFiltersRemoving || ! String.IsNullOrEmpty(StringUtil.RTrim( AV12GridStateDynamicFilter.gxTpr_Value)) )
            {
               AV10GridState.gxTpr_Dynamicfilters.Add(AV12GridStateDynamicFilter, 0);
         ...
         if ( AV29DynamicFiltersEnabled3 )
         {
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Responsavel Documento",  AV31DynamicFiltersOperator3,  AV72PropostaResponsavelDocumento3,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV31DynamicFiltersOperator3+1), 10, 0)), "Começa com"+" "+AV72PropostaResponsavelDocumento3, "Contém"+" "+AV72PropostaResponsavelDocumento3, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Proposta Paciente Cliente Razao Social",  AV31DynamicFiltersOperator3,  AV32PropostaPacienteClienteRazaoSocial3,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV31DynamicFiltersOperator3+1), 10, 0)), "Começa com"+" "+AV32PropostaPacienteClienteRazaoSocial3, "Contém"+" "+AV32PropostaPacienteClienteRazaoSocial3, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Cliente Documento",  AV31DynamicFiltersOperator3,  AV33PropostaPacienteClienteDocumento3,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV31DynamicFiltersOperator3+1), 10, 0)), "Começa com"+" "+AV33PropostaPacienteClienteDocumento3, "Contém"+" "+AV33PropostaPacienteClienteDocumento3, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Clinica Documento",  AV31DynamicFiltersOperator3,  AV73PropostaClinicaDocumento3,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV31DynamicFiltersOperator3+1), 10, 0)), "Começa com"+" "+AV73PropostaClinicaDocumento3, "Contém"+" "+AV73PropostaClinicaDocumento3, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Contrato Nome",  AV31DynamicFiltersOperator3,  AV34ContratoNome3,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV31DynamicFiltersOperator3+1), 10, 0)), "Começa com"+" "+AV34ContratoNome3, "Contém"+" "+AV34ContratoNome3, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            ...
            {
               new GeneXus.Programs.wwpbaseobjects.wwp_gridstateadddynfiltervalue(context ).execute( ref  AV12GridStateDynamicFilter,  "Descrição",  AV31DynamicFiltersOperator3,  AV35ConvenioCategoriaDescricao3,  StringUtil.Format( "%"+StringUtil.Trim( StringUtil.Str( (decimal)(AV31DynamicFiltersOperator3+1), 10, 0)), "Começa com"+" "+AV35ConvenioCategoriaDescricao3, "Contém"+" "+AV35ConvenioCategoriaDescricao3, "", "", "", "", "", "", ""),  false,  "",  "") ;
            }
            if ( AV36DynamicFiltersRemoving || ! String.IsNullOrEmpty(StringUtil.RTrim( AV12GridStateDynamicFilter.gxTpr_Value)) )
            {
               AV10GridState.gxTpr_Dynamicfilters.Add(AV12GridStateDynamicFilter, 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918575262", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wppropostasassinaturas.js", "?202551918575262", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public class wppropostasassinaturas__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV98Wppropostasassinaturasds_24_propostamaxreembolsoid_f3 )
      {
         ...
         {
            AddWhere(sWhereString, "(( T7.ProcedimentosMedicosNome like '%' || :lV75Wppropostasassinaturasds_1_filterfulltext) or ( SUBSTR(TO_CHAR(T1.PropostaValor,'999999999999990.99'), 2) like '%' || :lV75Wppropostasassinaturasds_1_filterfulltext) or ( T4.ClienteRazaoSocial like '%' || :lV75Wppropostasassinaturasds_1_filterfulltext) or ( T4.ClienteDocumento like '%' || :lV75Wppropostasassinaturasds_1_filterfulltext) or ( 'pendente aprovação' like '%' || LOWER(:lV75Wppropostasassinaturasds_1_filterfulltext) and T1.PropostaStatus = ( 'PENDENTE')) or ( 'em análise' like '%' || LOWER(:lV75Wppropostasassinaturasds_1_filterfulltext) and T1.PropostaStatus = ( 'EM_ANALISE')) or ( 'aprovado' like '%' || LOWER(:lV75Wppropostasassinaturasds_1_filterfulltext) and T1.PropostaStatus = ( 'APROVADO')) or ( 'rejeitado' like '%' || LOWER(:lV75Wppropostasassinaturasds_1_filterfulltext) and T1.PropostaStatus = ( 'REJEITADO')) or ( 'revisão' like '%' || LOWER(:lV75Wppropostasassinaturasds_1_filterfulltext) and T1.PropostaStatus = ( 'REVISAO')) or ( 'cancelado' like '%' || LOWER(:lV75Wppropostasassinaturasds_1_filterfulltext) and T1.PropostaStatus = ( 'CANCELADO')) or ( 'aguardando assinatura' like '%' || LOWER(:lV75Wppropostasassinaturasds_1_filterfulltext) and T1.PropostaStatus = ( 'AGUARDANDO_ASSINATURA')) or ( 'análise reprovada' like '%' || LOWER(:lV75Wppropostasassinaturasds_1_filterfulltext) and T1.PropostaStatus = ( 'AnaliseReprovada')))");
         }
         else
         {
            GXv_int7[42] = 1;
