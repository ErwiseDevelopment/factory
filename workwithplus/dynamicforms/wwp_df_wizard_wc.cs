   ...
   public class wwp_df_wizard_wc : GXWebComponent
   {
      ...
      protected void S152( )
      {
         ...
         if ( StringUtil.StrCmp(AV19WWPDynamicFormMode, "DSP") != 0 )
         {
            ...
            if ( ! AV5HasErrors )
            {
               AV22Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory2");
      ...
      protected void S112( )
      {
         ...
         if ( AV23HasConditionalSteps )
         {
            AV18WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Factory2");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918382772", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_wizard_wc.js", "?202551918382775", false, true);
