   ...
   public class wwp_selectimportfile : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wwpbaseobjects.wwp_selectimportfile"+UrlEncode(StringUtil.RTrim(AV16TransactionName)) + "," + UrlEncode(StringUtil.RTrim(AV11ImportType)) + "," + UrlEncode(StringUtil.RTrim(AV7ExtraParmsJson));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("wwpbaseobjects.wwp_selectimportfile") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wwpbaseobjects.wwp_selectimportfile");
            }
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavOverwriteexistingform_Internalname, "Overwrite Existing Form", "col-sm-3 AttributeFLLabel", 0, true, "");
            /* Check box */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnucancel_Internalname, "", "Fechar", bttBtnucancel_Jsonclick, 7, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11101_client"+"'", TempTags, "", 2, "HLP_WWPBaseObjects/WWP_SelectImportFile.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.wwp_selectimportfile")), "wwpbaseobjects.wwp_selectimportfile") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.wwp_selectimportfile")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E13102( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9FilterToUpload)) )
         {
            if ( ( StringUtil.StrCmp(StringUtil.Upper( AV10FilterToUploadExt), "JSON") == 0 ) && ( StringUtil.StrCmp(AV11ImportType, "JSON") == 0 ) )
            {
               ...
               {
                  AV12LastErrorType = 2;
                  GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Forma importada com sucesso",  "A forma dinâmica foi importada corretamente.",  "success",  "",  "na",  ""));
            ...
            else
            {
               if ( ( ( StringUtil.StrCmp(StringUtil.Upper( AV10FilterToUploadExt), "CSV") == 0 ) && ( StringUtil.StrCmp(AV11ImportType, "CSV") == 0 ) ) || ( ( StringUtil.StrCmp(StringUtil.Upper( AV10FilterToUploadExt), "XLSX") == 0 ) && ( StringUtil.StrCmp(AV11ImportType, "Excel") == 0 ) ) || ( ( StringUtil.StrCmp(StringUtil.Upper( AV10FilterToUploadExt), "JSON") == 0 ) && ( StringUtil.StrCmp(AV11ImportType, "JSON") == 0 ) ) )
               {
                  ...
                  if ( new GeneXus.Programs.wwpbaseobjects.wwp_importdata(context).executeUdp(  AV16TransactionName,  AV11ImportType,  AV22BlobPath,  AV7ExtraParmsJson, out  AV6ErrorMsgs) )
                  {
                     ...
                     GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Importação do arquivo com sucesso",  AV14ResultMsg,  "success",  "",  "na",  ""));
                     this.executeExternalObjectMethod(sPrefix, false, "WWPActions", "WCPopup_Close", new Object[] {(string)AV14ResultMsg}, false);
                  }
                  else
                  {
               ...
               else
               {
                  ...
                  AV14ResultMsg = StringUtil.Format( "O tipo de arquivo esperado é %1.", AV8ExtType, "", "", "", "", "", "", "", "");
                  AssignAttri(sPrefix, false, "AV14ResultMsg", AV14ResultMsg);
                  GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Erro ao importar arquivo",  AV14ResultMsg,  "error",  "",  "na",  ""));
               }
            }
         }
         else
      ...
      protected void S122( )
      {
         ...
         GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Erro ao importar arquivo",  AV14ResultMsg,  "error",  "",  "false",  ""));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255191838444", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/wwp_selectimportfile.js", "?20255191838444", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV5OverwriteExistingForm","fld":"vOVERWRITEEXISTINGFORM","type":"boolean"},{"av":"AV6ErrorMsgs","fld":"vERRORMSGS","hsh":true,"type":""}]}""");
         setEventMetadata("'DOUCANCEL'","""{"handler":"E11101","iparms":[]}""");
         setEventMetadata("ENTER","""{"handler":"E13102","iparms":[{"av":"edtavFiltertoupload_Filename","ctrl":"vFILTERTOUPLOAD","prop":"Filename"},{"av":"AV9FilterToUpload","fld":"vFILTERTOUPLOAD","type":"bitstr"},{"av":"AV11ImportType","fld":"vIMPORTTYPE","type":"svchar"},{"av":"AV6ErrorMsgs","fld":"vERRORMSGS","hsh":true,"type":""},{"av":"AV5OverwriteExistingForm","fld":"vOVERWRITEEXISTINGFORM","type":"boolean"},{"av":"AV14ResultMsg","fld":"vRESULTMSG","type":"svchar"},{"av":"AV7ExtraParmsJson","fld":"vEXTRAPARMSJSON","type":"svchar"},{"av":"AV16TransactionName","fld":"vTRANSACTIONNAME","type":"svchar"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV9FilterToUpload","fld":"vFILTERTOUPLOAD","type":"bitstr"},{"av":"AV14ResultMsg","fld":"vRESULTMSG","type":"svchar"}]}""");
         return  ;
      }
