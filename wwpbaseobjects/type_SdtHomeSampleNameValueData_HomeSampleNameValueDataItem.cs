...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="HomeSampleNameValueDataItem" , Namespace="Factory21" )]
	[Serializable]
	public class SdtHomeSampleNameValueData_HomeSampleNameValueDataItem : GxUserType
	{
		...
		public string gxTpr_Value_double
		{
			...
			set {
				gxTv_SdtHomeSampleNameValueData_HomeSampleNameValueDataItem_Value = NumberUtil.Val(value);
			}
		}
		[XmlIgnore]
	...
	[DataContract(Name=@"HomeSampleNameValueDataItem", Namespace="Factory21")]
