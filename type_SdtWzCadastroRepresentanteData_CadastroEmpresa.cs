...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="WzCadastroRepresentanteData.CadastroEmpresa" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"WzCadastroRepresentanteData.CadastroEmpresa", Namespace="Factory2")]
