   ...
   public class wwp_dfc_text_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_text_wc"+UrlEncode(StringUtil.RTrim(AV16WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV19WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_text_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB230( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_text_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            wb_table1_17_232( true) ;
         }
         else
         {
            wb_table1_17_232( false) ;
         }
         return  ;
      }

      protected void wb_table1_17_232e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_30_232( true) ;
         }
         else
         {
            wb_table2_30_232( false) ;
         }
         return  ;
      }

      protected void wb_table2_30_232e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_35_232( true) ;
         }
         else
         {
            wb_table3_35_232( false) ;
         }
         return  ;
      }

      protected void wb_table3_35_232e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_text_wc")), "workwithplus.dynamicforms.wwp_dfc_text_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_text_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void wb_table3_35_232( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_35_232e( true) ;
         }
         else
         {
            wb_table3_35_232e( false) ;
         }
      }

      protected void wb_table2_30_232( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_30_232e( true) ;
         }
         else
         {
            wb_table2_30_232e( false) ;
         }
      }

      protected void wb_table1_17_232( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_17_232e( true) ;
         }
         else
         {
            wb_table1_17_232e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918383823", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_text_wc.js", "?202551918383824", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E16232","iparms":[{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E17232","iparms":[{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E11232","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         ...
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13232","iparms":[{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12232","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV9NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"AV18WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV10ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV15WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"},{"av":"AV14WWP_DF_CharControlType","fld":"vWWP_DF_CHARCONTROLTYPE","pic":"ZZZ9","type":"int"},{"av":"AV12WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","type":""},{"av":"AV13WWP_DF_NumericMetadata","fld":"vWWP_DF_NUMERICMETADATA","type":""}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV17WWPForm","fld":"vWWPFORM","type":""},{"av":"AV18WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV9NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"AV12WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","type":""},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"edtavData_Caption","ctrl":"vDATA","prop":"Caption"},{"av":"AV13WWP_DF_NumericMetadata","fld":"vWWP_DF_NUMERICMETADATA","type":""},{"av":"AV14WWP_DF_CharControlType","fld":"vWWP_DF_CHARCONTROLTYPE","pic":"ZZZ9","type":"int"},{"av":"edtavData_Ispassword","ctrl":"vDATA","prop":"Ispassword"},{"av":"AV5Data","fld":"vDATA","type":"svchar"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"}]}""");
         return  ;
      }
