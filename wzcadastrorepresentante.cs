...
namespace GeneXus.Programs {
   public class wzcadastrorepresentante : GXDataArea
   {
      public wzcadastrorepresentante( )
      {
      ...
      public wzcadastrorepresentante( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wzcadastrorepresentante"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormWithFixedActions\" data-gx-class=\"form-horizontal FormWithFixedActions\" novalidate action=\""+formatLink("wzcadastrorepresentante") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wzcadastrorepresentante"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         return formatLink("wzcadastrorepresentante") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "WzCadastroRepresentante" ;
      }

      public override string GetPgmdesc( )
      {
         return "Cadastro do Representante" ;
      }
      ...
      protected void WB940( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_WzCadastroRepresentante.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      protected void START942( )
      {
         ...
         Form.Meta.addItem("description", "Cadastro do Representante", 0) ;
         context.wjLoc = "";
      ...
      protected void PA942( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wzcadastrorepresentante")), "wzcadastrorepresentante") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wzcadastrorepresentante")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      {
         /* GeneXus formulas. */
         AV14Pgmname = "WzCadastroRepresentante";
      }
      ...
      protected void E11942( )
      {
         ...
         AV12WizardStep.gxTpr_Code = "CadastroRepresentante";
         AV12WizardStep.gxTpr_Title = "Representante";
         AV12WizardStep.gxTpr_Description = "Preencha os dados do representante da empresa";
         AV11WizardSteps.Add(AV12WizardStep, 0);
         AV12WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV12WizardStep.gxTpr_Code = "CadastroEmpresa";
         AV12WizardStep.gxTpr_Title = "Empresa";
         AV12WizardStep.gxTpr_Description = "Preencha os dados da empresa";
         AV11WizardSteps.Add(AV12WizardStep, 0);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV9CurrentStep)) )
         {
            AV10CurrentStepAux = "CadastroRepresentante";
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV10CurrentStepAux, "CadastroRepresentante") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WzCadastroRepresentanteCadastroRepresentante")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wzcadastrorepresentantecadastrorepresentante", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WzCadastroRepresentanteCadastroRepresentante";
               WebComp_Wizardstepwc_Component = "WzCadastroRepresentanteCadastroRepresentante";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0015",(string)"",(string)AV14Pgmname+"_Data",(string)AV8PreviousStep,(bool)AV7GoingBack});
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "CadastroEmpresa") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WzCadastroRepresentanteCadastroEmpresa")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wzcadastrorepresentantecadastroempresa", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WzCadastroRepresentanteCadastroEmpresa";
               WebComp_Wizardstepwc_Component = "WzCadastroRepresentanteCadastroEmpresa";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918583667", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wzcadastrorepresentante.js", "?202551918583667", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Cadastro do Representante";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
