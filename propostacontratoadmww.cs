...
namespace GeneXus.Programs {
   public class propostacontratoadmww : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918574147", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("propostacontratoadmww.js", "?202551918574148", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public class propostacontratoadmww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A329PropostaStatus )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "((char_length(trim(trailing ' ' from :AV97Propostacontratoadmwwds_1_filterfulltext))=0) or ( ( T4.ProcedimentosMedicosNome like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( T1.PropostaDescricao like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( SUBSTR(TO_CHAR(T1.PropostaValor,'999999999999990.99'), 2) like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( T3.ContratoNome like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( T2.ClienteRazaoSocial like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( 'em análise' like '%' || LOWER(:lV97Propostacontratoadmwwds_1_filterfulltext) and COALESCE( T5.ReembolsoStatusAtual_F, '') = ( 'EM_ANALISE')) or ( 'finalizado' like '%' || LOWER(:lV97Propostacontratoadmwwds_1_filterfulltext) and COALESCE( T5.ReembolsoStatusAtual_F, '') = ( 'FINALIZADO')) or ( 'reanálise' like '%' || LOWER(:lV97Propostacontratoadmwwds_1_filterfulltext) and COALESCE( T5.ReembolsoStatusAtual_F, '') = ( 'REANALISE')) or ( 'não iniciado' like '%' || LOWER(:lV97Propostacontratoadmwwds_1_filterfulltext) and COALESCE( T5.ReembolsoStatusAtual_F, '') = ( ''))))");
                                              ...
                                              string A329PropostaStatus )
      {
         ...
         AddWhere(sWhereString, "((char_length(trim(trailing ' ' from :AV97Propostacontratoadmwwds_1_filterfulltext))=0) or ( ( T3.ProcedimentosMedicosNome like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( T1.PropostaDescricao like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( SUBSTR(TO_CHAR(T1.PropostaValor,'999999999999990.99'), 2) like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( T2.ContratoNome like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( T4.ClienteRazaoSocial like '%' || :lV97Propostacontratoadmwwds_1_filterfulltext) or ( 'em análise' like '%' || LOWER(:lV97Propostacontratoadmwwds_1_filterfulltext) and COALESCE( T5.ReembolsoStatusAtual_F, '') = ( 'EM_ANALISE')) or ( 'finalizado' like '%' || LOWER(:lV97Propostacontratoadmwwds_1_filterfulltext) and COALESCE( T5.ReembolsoStatusAtual_F, '') = ( 'FINALIZADO')) or ( 'reanálise' like '%' || LOWER(:lV97Propostacontratoadmwwds_1_filterfulltext) and COALESCE( T5.ReembolsoStatusAtual_F, '') = ( 'REANALISE')) or ( 'não iniciado' like '%' || LOWER(:lV97Propostacontratoadmwwds_1_filterfulltext) and COALESCE( T5.ReembolsoStatusAtual_F, '') = ( ''))))");
         AddWhere(sWhereString, "(:AV122ProCount <= 0 or ( "+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV122Propostacontratoadmwwds_26_tfreembolsostatusatual_f_sels, "COALESCE( T5.ReembolsoStatusAtual_F, '') IN (", ")")+"))");
         AddWhere(sWhereString, "(T1.PropostaCratedBy = :AV6WWPCo_2Secuserclienteid)");
         AddWhere(sWhereString, "(T1.PropostaStatus = ( 'APROVADO'))");
         if ( ( StringUtil.StrCmp(AV98Propostacontratoadmwwds_2_dynamicfiltersselector1, "PROPOSTATITULO") == 0 ) && ( AV99Propostacontratoadmwwds_3_dynamicfiltersoperator1 == 0 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV100Propostacontratoadmwwds_4_propostatitulo1)) ) )
