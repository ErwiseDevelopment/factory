...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_formww : GXDataArea
   {
      ...
      protected void START0Y2( )
      {
         ...
         Form.Meta.addItem("description", "Formulários dinâmicos", 0) ;
         context.wjLoc = "";
      ...
      protected void E220Y2( )
      {
         ...
         Form.Caption = "Formulários dinâmicos";
         ...
         if ( AV47WWPFormType == 1 )
         {
            ...
            {
               Form.Caption = "Validações dinâmicas";
               AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            }
            else
            {
      ...
      private void E240Y2( )
      {
         if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_fnc_Recordsperpage( ) ) ) )
         {
            ...
            cmbavGridactiongroup1.addItem("4", StringUtil.Format( "%1;%2", "Formulário de exportação", "fas fa-file-export", "", "", "", "", "", "", ""), 0);
            if ( AV47WWPFormType == 0 )
            {
               cmbavGridactiongroup1.addItem("5", StringUtil.Format( "%1;%2", "Preencha um formulário", "fas fa-file-circle-plus", "", "", "", "", "", "", ""), 0);
            }
            if ( ( AV47WWPFormType == 0 ) && ( AV41FilledOutForms > 0 ) )
            {
               cmbavGridactiongroup1.addItem("6", StringUtil.Format( "%1;%2", "Visualização completa dos formulários", "fab fa-wpforms", "", "", "", "", "", "", ""), 0);
            }
            cmbavGridactiongroup1.addItem("7", StringUtil.Format( "%1;%2", "Copiar formulário", "far fa-clone", "", "", "", "", "", "", ""), 0);
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
            {
      ...
      protected void S222( )
      {
         /* 'DO UDELETE' Routine */
         returnInSub = false;
         Dvelop_confirmpanel_udelete_Confirmationtext = StringUtil.Format( "Tem certeza de que deseja eliminar o formulário?", A97WWPFormTitle, "", "", "", "", "", "", "", "");
      ...
      protected void S272( )
      {
         ...
         if ( AV9NewWWPForm.Insert() )
         {
            ...
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Clonar formulário",  "O formulário foi clonado com sucesso.",  "success",  "",  "na",  ""));
            gxgrGrid_refresh( subGrid_Rows, AV17OrderedBy, AV18OrderedDsc, AV19FilterFullText, AV47WWPFormType, AV48WWPFormIsForDynamicValidations, AV29ManageFiltersExecutionStep, AV49Pgmname, AV35TFWWPFormReferenceName, AV36TFWWPFormReferenceName_Sel, AV37TFWWPFormTitle, AV38TFWWPFormTitle_Sel, AV41FilledOutForms, AV40WWPFormId, A290WWPFormType) ;
         }
         else
         {
            ...
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Formulário de fechamento de erro",  AV11ResultMsg,  "error",  "",  "false",  ""));
         }
      }
      ...
      protected void S132( )
      {
         ...
         AV45TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025519185362", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_formww.js", "?2025519185363", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbWWPFormType.addItem("0", "Forma dinâmica", 0);
         cmbWWPFormType.addItem("1", "Seção dinâmica", 0);
         if ( cmbWWPFormType.ItemCount > 0 )
         {
            A290WWPFormType = (short)(Math.Round(NumberUtil.Val( cmbWWPFormType.getValidValue(StringUtil.Trim( StringUtil.Str( (decimal)(A290WWPFormType), 1, 0))), "."), 18, MidpointRounding.ToEven));
            AssignAttri("", false, "A290WWPFormType", StringUtil.Str( (decimal)(A290WWPFormType), 1, 0));
      ...
      public override void initialize_properties( )
      {
         ...
         Dvelop_confirmpanel_udelete_Title = "Eliminar a forma dinâmica";
         Innewwindow1_Target = "";
      ...
      private GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute AV45TrnContextAtt ;
