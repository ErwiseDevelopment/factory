...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_subscriptionssettingsbyrole : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrole"+UrlEncode(StringUtil.RTrim(AV36WWPSubscriptionRoleId));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrole") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrole"+UrlEncode(StringUtil.RTrim(AV36WWPSubscriptionRoleId));
         return formatLink("wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrole") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void PA0S2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrole")), "wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrole") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrole")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      private void E160S2( )
      {
         ...
         {
            A21WWPEntityName = H000S4_A21WWPEntityName[0];
            A20WWPEntityId = H000S4_A20WWPEntityId[0];
            A40000GXC1 = H000S4_A40000GXC1[0];
            n40000GXC1 = H000S4_n40000GXC1[0];
            A40001GXC2 = H000S4_A40001GXC2[0];
            n40001GXC2 = H000S4_n40001GXC2[0];
            A40000GXC1 = H000S4_A40000GXC1[0];
            n40000GXC1 = H000S4_n40000GXC1[0];
            A40001GXC2 = H000S4_A40001GXC2[0];
            n40001GXC2 = H000S4_n40001GXC2[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101923051", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/subscriptions/wwp_subscriptionssettingsbyrole.js", "?20256101923052", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV17NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"AV7FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV36WWPSubscriptionRoleId","fld":"vWWPSUBSCRIPTIONROLEID","hsh":true,"type":"char"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV8GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV38GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS","type":"svchar"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E110S2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV39Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV17NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"AV7FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV36WWPSubscriptionRoleId","fld":"vWWPSUBSCRIPTIONROLEID","hsh":true,"type":"char"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E160S2","iparms":[{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV17NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"AV36WWPSubscriptionRoleId","fld":"vWWPSUBSCRIPTIONROLEID","hsh":true,"type":"char"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV6DetailWebComponent","fld":"vDETAILWEBCOMPONENT","type":"char"},{"av":"AV30WWPEntityName","fld":"vWWPENTITYNAME","type":"svchar"},{"av":"AV29WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","hsh":true,"type":"int"},{"av":"A40000GXC1","fld":"GXC1","pic":"999999999","type":"int"},{"av":"A40001GXC2","fld":"GXC2","pic":"999999999","type":"int"},{"av":"AV9GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("VDETAILWEBCOMPONENT.CLICK","""{"handler":"E170S2","iparms":[{"av":"AV29WWPEntityId","fld":"vWWPENTITYID","pic":"ZZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV17NotifShowOnlySubscribedEvents","fld":"vNOTIFSHOWONLYSUBSCRIBEDEVENTS","type":"boolean"},{"av":"AV36WWPSubscriptionRoleId","fld":"vWWPSUBSCRIPTIONROLEID","hsh":true,"type":"char"}]""");
         setEventMetadata("VDETAILWEBCOMPONENT.CLICK",""","oparms":[{"ctrl":"GRID_DWC"}]}""");
         setEventMetadata("VNOTIFSHOWONLYSUBSCRIBEDEVENTS.CLICK","""{"handler":"E130S2","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         GXt_char1 = "";
         H000S4_A21WWPEntityName = new string[] {""} ;
         H000S4_A20WWPEntityId = new long[1] ;
         H000S4_A40000GXC1 = new int[1] ;
         H000S4_n40000GXC1 = new bool[] {false} ;
         H000S4_A40001GXC2 = new int[1] ;
         H000S4_n40001GXC2 = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrole__default(),
            new Object[][] {
                new Object[] {
               H000S4_A21WWPEntityName, H000S4_A20WWPEntityId, H000S4_A40000GXC1, H000S4_n40000GXC1, H000S4_A40001GXC2, H000S4_n40001GXC2
               }
            }
         );
      ...
      private string[] H000S4_A21WWPEntityName ;
      private long[] H000S4_A20WWPEntityId ;
      private int[] H000S4_A40000GXC1 ;
      private bool[] H000S4_n40000GXC1 ;
      private int[] H000S4_A40001GXC2 ;
      private bool[] H000S4_n40001GXC2 ;
