...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_roleupdatesubscription : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV8Subscribe )
         {
            ...
            GXt_objcol_char1 = AV14WWPUserExtendedIdCollection;
            new GeneXus.Programs.wwpbaseobjects.wwp_getusersfromrole(context ).execute(  AV12WWPSubscriptionRoleId, out  GXt_objcol_char1) ;
            AV14WWPUserExtendedIdCollection = GXt_objcol_char1;
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 A7WWPUserExtendedId ,
                                                 AV14WWPUserExtendedIdCollection ,
            ...
            {
               A7WWPUserExtendedId = P002H2_A7WWPUserExtendedId[0];
               n7WWPUserExtendedId = P002H2_n7WWPUserExtendedId[0];
               A23WWPNotificationDefinitionId = P002H2_A23WWPNotificationDefinitionId[0];
               A25WWPSubscriptionId = P002H2_A25WWPSubscriptionId[0];
               /* Using cursor P002H3 */
      ...
      {
         AV10WWPSubscription = new GeneXus.Programs.wwpbaseobjects.subscriptions.SdtWWP_Subscription(context);
         AV14WWPUserExtendedIdCollection = new GxSimpleCollection<string>();
         GXt_objcol_char1 = new GxSimpleCollection<string>();
         A7WWPUserExtendedId = "";
         P002H2_A7WWPUserExtendedId = new string[] {""} ;
         P002H2_n7WWPUserExtendedId = new bool[] {false} ;
         P002H2_A23WWPNotificationDefinitionId = new long[1] ;
         P002H2_A25WWPSubscriptionId = new long[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_roleupdatesubscription__default(),
            new Object[][] {
                new Object[] {
               P002H2_A7WWPUserExtendedId, P002H2_n7WWPUserExtendedId, P002H2_A23WWPNotificationDefinitionId, P002H2_A25WWPSubscriptionId
               }
               , new Object[] {
               }
            }
      ...
      private GxSimpleCollection<string> AV14WWPUserExtendedIdCollection ;
      private GxSimpleCollection<string> GXt_objcol_char1 ;
      private IDataStoreProvider pr_default ;
      private string[] P002H2_A7WWPUserExtendedId ;
      private bool[] P002H2_n7WWPUserExtendedId ;
      private long[] P002H2_A23WWPNotificationDefinitionId ;
      private long[] P002H2_A25WWPSubscriptionId ;
   }
   ...
   public class wwp_roleupdatesubscription__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P002H2( IGxContext context ,
                                             ...
                                             GxSimpleCollection<string> AV14WWPUserExtendedIdCollection ,
                                             ...
                                             long A23WWPNotificationDefinitionId )
      {
         ...
         AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV14WWPUserExtendedIdCollection, "WWPUserExtendedId IN (", ")")+")");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P002H2(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P002H2", "scmdbuf",true, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP002H2,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P002H3", "SAVEPOINT gxupdate;DELETE FROM WWP_Subscription  WHERE WWPSubscriptionId = :WWPSubscriptionId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP002H3)
          };
       }
    }
