   ...
   public class wwp_dfc_label_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_label_wc"+UrlEncode(StringUtil.RTrim(AV8WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV11WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_label_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB270( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_label_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            wb_table1_12_272( true) ;
         }
         else
         {
            wb_table1_12_272( false) ;
         }
         return  ;
      }

      protected void wb_table1_12_272e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_25_272( true) ;
         }
         else
         {
            wb_table2_25_272( false) ;
         }
         return  ;
      }

      protected void wb_table2_25_272e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table3_30_272e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_label_wc")), "workwithplus.dynamicforms.wwp_dfc_label_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_label_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void wb_table3_30_272( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_25_272( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_25_272e( true) ;
         }
         else
         {
            wb_table2_25_272e( false) ;
         }
      }

      protected void wb_table1_12_272( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_12_272e( true) ;
         }
         else
         {
            wb_table1_12_272e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918383411", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_label_wc.js", "?202551918383412", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV5IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV6IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV14ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV13WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"}]""");
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E16272","iparms":[{"av":"AV7SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV11WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E17272","iparms":[{"av":"AV7SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV11WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E11272","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV7SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV11WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE",""","oparms":[{"av":"AV9WWPForm","fld":"vWWPFORM","type":""},{"av":"AV10WWPFormElement","fld":"vWWPFORMELEMENT","type":""}]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13272","iparms":[{"av":"AV11WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV7SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12272","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV7SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV11WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV12NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"AV10WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV14ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV13WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV9WWPForm","fld":"vWWPFORM","type":""},{"av":"AV10WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV12NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"lblLabel_Caption","ctrl":"LABEL","prop":"Caption"},{"av":"divLabelcell_Class","ctrl":"LABELCELL","prop":"Class"},{"av":"lblLabel_Class","ctrl":"LABEL","prop":"Class"}]}""");
         return  ;
      }
