   ...
   public class wwp_df_combobox_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_combobox_wc"+UrlEncode(StringUtil.RTrim(AV31WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV32WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV8WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV25SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_combobox_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_combobox_wc");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_combobox_wc")), "workwithplus.dynamicforms.wwp_df_combobox_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_combobox_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E121H2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV19HasReferenceId, context));
         AV37GXV1 = 1;
         while ( AV37GXV1 <= AV7WWPFormInstance.gxTpr_Element.Count )
         {
            AV35WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV7WWPFormInstance.gxTpr_Element.Item(AV37GXV1));
      ...
      protected void S142( )
      {
         ...
         AV38GXV2 = 1;
         while ( AV38GXV2 <= AV5WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Options.Count )
         {
            AV30WWP_DF_CharMetadata_Option = ((string)AV5WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Options.Item(AV38GXV2));
      ...
      protected void E131H2( )
      {
         ...
         returnInSub = false;
         if ( ( AV9AuxSessionId == AV25SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV36ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV32WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV8WWPFormInstanceElementId), 4, 0))+"|") )
         {
            /* Execute user subroutine: 'SAVE ELEMENT DATA TO SESSION' */
            S152 ();
            if (returnInSub) return;
      ...
      protected void S152( )
      {
         ...
         AV39GXV3 = 1;
         while ( AV39GXV3 <= AV7WWPFormInstance.gxTpr_Element.Count )
         {
            AV35WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV7WWPFormInstance.gxTpr_Element.Item(AV39GXV3));
            if ( ( AV35WWPFormInstanceElement.gxTpr_Wwpformelementid == AV32WWPFormElementId ) && ( AV35WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV8WWPFormInstanceElementId ) )
            {
      ...
      protected void S162( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV34WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV17ElementInternalName,  "true",  ""));
            AV22IsValid = false;
         }
         else
         {
            if ( AV27Validations.Count > 0 )
            {
               ...
               AV40GXV4 = 1;
               while ( AV40GXV4 <= AV24Messages.Count )
               {
                  AV23Message = ((GeneXus.Utils.SdtMessages_Message)AV24Messages.Item(AV40GXV4));
      ...
      protected void S192( )
      {
         ...
         AV14DataCellNameClass = "DataContentCellFL";
         ...
         {
            AV14DataCellNameClass = "RequiredDataContentCellFL " + AV14DataCellNameClass;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381985", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_combobox_wc.js", "?202551918381986", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         divDatacellname_Class = "col-xs-12 DataContentCellFL ExtendedComboCell";
         ...
         Combo_data_Cls = "ExtendedCombo AttributeFL";
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( context.isSpaRequest( ) )
            {
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV5WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV19HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"}]}""");
         setEventMetadata("COMBO_DATA.ONOPTIONCLICKED","""{"handler":"E111H2","iparms":[{"av":"AV5WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"Combo_data_Selectedvalue_get","ctrl":"COMBO_DATA","prop":"SelectedValue_get"},{"av":"AV19HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV8WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"Combo_data_Ddointernalname","ctrl":"COMBO_DATA","prop":"DDOInternalName"},{"av":"AV12Data","fld":"vDATA","type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("COMBO_DATA.ONOPTIONCLICKED",""","oparms":[{"av":"AV12Data","fld":"vDATA","type":""},{"av":"AV18ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E131H2","iparms":[{"av":"AV36ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV9AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV8WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV18ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV5WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"Combo_data_Ddointernalname","ctrl":"COMBO_DATA","prop":"DDOInternalName"},{"av":"AV12Data","fld":"vDATA","type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV18ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E141H2","iparms":[{"av":"AV9AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV28VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV5WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV8WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV28VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         return  ;
      }
