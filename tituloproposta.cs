...
namespace GeneXus.Programs {
   public class tituloproposta : GXDataArea
   {
      ...
      protected void UpdateTablesN11X44( )
      {
         ...
         pr_default.execute(34, new Object[] {n168ClienteId, A168ClienteId, n794NotaFiscalId, A794NotaFiscalId});
         pr_default.close(34);
      ...
      public void ScanStart1X44( )
      {
         ...
         {
            RcdFound44 = 1;
            A261TituloId = T001X45_A261TituloId[0];
            n261TituloId = T001X45_n261TituloId[0];
            AssignAttri("", false, "A261TituloId", StringUtil.LTrimStr( (decimal)(A261TituloId), 9, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255191849150", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("tituloproposta.js", "?20255191849151", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected decimal GetTituloTotalMovimentoDebito_F0( int E261TituloId )
      {
         ...
         pr_default.execute(36, new Object[] {nA261TituloId, E261TituloId});
         if ( (pr_default.getStatus(36) != 101) )
         {
            X271TituloMovimentoValor = T001X46_A271TituloMovimentoValor[0];
            nX271TituloMovimentoValor = T001X46_n271TituloMovimentoValor[0];
         }
         pr_default.close(36);
      ...
      public override void initialize( )
      {
         ...
         T001X43_A270TituloMovimentoId = new int[1] ;
         T001X45_A261TituloId = new int[1] ;
         T001X45_n261TituloId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         i500TituloCriacao = (DateTime)(DateTime.MinValue);
         T001X46_A271TituloMovimentoValor = new decimal[1] ;
         T001X46_n271TituloMovimentoValor = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tituloproposta__default(),
            new Object[][] {
               ...
               , new Object[] {
               T001X43_A270TituloMovimentoId
               }
               , new Object[] {
               }
               , new Object[] {
               T001X45_A261TituloId
               }
               , new Object[] {
               T001X46_A271TituloMovimentoValor, T001X46_n271TituloMovimentoValor
               }
               , new Object[] {
      ...
      private int[] T001X43_A270TituloMovimentoId ;
      private int[] T001X45_A261TituloId ;
      private bool[] T001X45_n261TituloId ;
      private decimal[] T001X46_A271TituloMovimentoValor ;
      private bool[] T001X46_n271TituloMovimentoValor ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T001X43", "SELECT TituloMovimentoId FROM TituloMovimento WHERE TituloId = :TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001X43,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T001X44", "SAVEPOINT gxupdate;UPDATE NotaFiscal SET ClienteId=:ClienteId  WHERE NotaFiscalId = :NotaFiscalId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001X44)
             ,new CursorDef("T001X45", "SELECT TituloId FROM Titulo ORDER BY TituloId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001X45,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T001X46", "SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F FROM TituloMovimento WHERE ( TituloId = :TituloId) and ( TituloMovimentoSoma) ",true, GxErrorMask.GX_NOMASK, false, this,prmT001X46,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T001X48", "SELECT SUM(TituloMovimentoValor) AS TituloTotalMovimento_F FROM TituloMovimento WHERE ( TituloId = :TituloId) and ( Not TituloMovimentoSoma) ",true, GxErrorMask.GX_NOMASK, false, this,prmT001X48,1, GxCacheFrequency.OFF ,true,false )
