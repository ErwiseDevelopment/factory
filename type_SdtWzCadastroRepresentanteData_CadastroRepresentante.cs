...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="WzCadastroRepresentanteData.CadastroRepresentante" , Namespace="Factory2" )]
	[Serializable]
	...
	[DataContract(Name=@"WzCadastroRepresentanteData.CadastroRepresentante", Namespace="Factory2")]
