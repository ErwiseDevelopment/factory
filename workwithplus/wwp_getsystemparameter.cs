   ...
   public class wwp_getsystemparameter : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.wwp_getsystemparameter__default(),
            new Object[][] {
                new Object[] {
               P00252_A1WWPParameterKey, P00252_A2WWPParameterValue
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class wwp_getsystemparameter__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00252", "SELECT WWPParameterKey, WWPParameterValue FROM WWP_Parameter WHERE WWPParameterKey = ( :AV8WWPParameterKey) ORDER BY WWPParameterKey ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00252,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
