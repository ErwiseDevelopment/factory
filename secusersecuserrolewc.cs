...
namespace GeneXus.Programs {
   public class secusersecuserrolewc : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8SecUserId = (short)(Math.Round(NumberUtil.Val( GetPar( "SecUserId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8SecUserId", StringUtil.LTrimStr( (decimal)(AV8SecUserId), 4, 0));
                  setjustcreated();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV23OrderedDsc = StringUtil.StrToBool( GetPar( "OrderedDsc"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV22OrderedBy, AV23OrderedDsc, AV60FilterFullText, AV8SecUserId, AV49ManageFiltersExecutionStep, AV64Pgmname, A133SecUserId, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV64Pgmname = "SecUserSecUserRoleWC";
               edtavDisplay_Enabled = 0;
               AssignProp(sPrefix, false, edtavDisplay_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDisplay_Enabled), 5, 0), !bGXsfl_33_Refreshing);
               edtavUpdate_Enabled = 0;
               AssignProp(sPrefix, false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_33_Refreshing);
               edtavDelete_Enabled = 0;
               AssignProp(sPrefix, false, edtavDelete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDelete_Enabled), 5, 0), !bGXsfl_33_Refreshing);
               WS2W2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "secusersecuserrolewc"+UrlEncode(StringUtil.LTrimStr(AV8SecUserId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("secusersecuserrolewc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV64Pgmname, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"SecUserSecUserRoleWC");
         forbiddenHiddens.Add("SecUserId", context.localUtil.Format( (decimal)(A133SecUserId), "ZZZ9"));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("secusersecuserrolewc:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vFILTERFULLTEXT", AV60FilterFullText);
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_33", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_33), 8, 0, ",", "")));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vMANAGEFILTERSDATA", AV53ManageFiltersData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vMANAGEFILTERSDATA", AV53ManageFiltersData);
         }
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV58GridPageCount), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDAPPLIEDFILTERS", AV59GridAppliedFilters);
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vMANAGEFILTERSEXECUTIONSTEP", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV49ManageFiltersExecutionStep), 1, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV64Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV64Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22OrderedBy), 4, 0, ",", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vORDEREDDSC", AV23OrderedDsc);
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void WB2W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "secusersecuserrolewc");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV60FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV60FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,27);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "Pesquisar", edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPFullTextFilter", "start", true, "", "HLP_SecUserSecUserRoleWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 33 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSecUserId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A133SecUserId), 4, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A133SecUserId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSecUserId_Jsonclick, 0, "Attribute", "", "", "", "", edtSecUserId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_SecUserSecUserRoleWC.htm");
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignAttri(sPrefix, false, edtavDisplay_Internalname, AV63Display);
                                    ...
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          if ( ! wbErr )
                                          {
                                             ...
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vFILTERFULLTEXT"), AV60FilterFullText) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             if ( ! Rfr0gs )
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "secusersecuserrolewc")), "secusersecuserrolewc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "secusersecuserrolewc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF2W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV60FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV60FilterFullText), "%", "");
            /* Using cursor H002W2 */
            pr_default.execute(0, new Object[] {AV8SecUserId, lV60FilterFullText, lV60FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_33_idx = 1;
            sGXsfl_33_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_33_idx), 4, 0), 4, "0");
            SubsflControlProps_332( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A647SecUserRoleActive = H002W2_A647SecUserRoleActive[0];
               A133SecUserId = H002W2_A133SecUserId[0];
               AssignAttri(sPrefix, false, "A133SecUserId", StringUtil.LTrimStr( (decimal)(A133SecUserId), 4, 0));
               A139SecRoleDescription = H002W2_A139SecRoleDescription[0];
               A140SecRoleName = H002W2_A140SecRoleName[0];
               A131SecRoleId = H002W2_A131SecRoleId[0];
               A139SecRoleDescription = H002W2_A139SecRoleDescription[0];
               A140SecRoleName = H002W2_A140SecRoleName[0];
               /* Execute user event: Grid.Load */
               E172W2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV60FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV60FilterFullText), "%", "");
         /* Using cursor H002W3 */
         pr_default.execute(1, new Object[] {AV8SecUserId, lV60FilterFullText, lV60FilterFullText});
      ...
      protected void STRUP2W0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vMANAGEFILTERSDATA"), AV53ManageFiltersData);
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vDDO_TITLESETTINGSICONS"), AV45DDO_TitleSettingsIcons);
            /* Read saved values. */
            nRC_GXsfl_33 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_33"), ",", "."), 18, MidpointRounding.ToEven));
            AV57GridCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDCURRENTPAGE"), ",", "."), 18, MidpointRounding.ToEven));
            AV58GridPageCount = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ",", "."), 18, MidpointRounding.ToEven));
            AV59GridAppliedFilters = cgiGet( sPrefix+"vGRIDAPPLIEDFILTERS");
            wcpOAV8SecUserId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8SecUserId"), ",", "."), 18, MidpointRounding.ToEven));
            ...
            AssignAttri(sPrefix, false, "AV60FilterFullText", AV60FilterFullText);
            ...
            {
               GXUtil.WriteLogError("secusersecuserrolewc:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
               context.HttpContext.Response.StatusCode = 403;
               context.WriteHtmlText( "<title>403 Forbidden</title>") ;
               context.WriteHtmlText( "<h1>403 Forbidden</h1>") ;
      ...
      protected void E162W2( )
      {
         ...
         if ( AV49ManageFiltersExecutionStep == 1 )
         {
            ...
            AssignAttri(sPrefix, false, "AV49ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV49ManageFiltersExecutionStep), 1, 0));
         }
         ...
         AssignAttri(sPrefix, false, "AV57GridCurrentPage", StringUtil.LTrimStr( (decimal)(AV57GridCurrentPage), 10, 0));
         AV58GridPageCount = subGrid_fnc_Pagecount( );
         AssignAttri(sPrefix, false, "AV58GridPageCount", StringUtil.LTrimStr( (decimal)(AV58GridPageCount), 10, 0));
         ...
         AssignAttri(sPrefix, false, "AV59GridAppliedFilters", AV59GridAppliedFilters);
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV53ManageFiltersData", AV53ManageFiltersData);
      ...
      protected void E142W2( )
      {
         ...
         if ( ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#OrderASC#>") == 0 ) || ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#OrderDSC#>") == 0 ) )
         {
            ...
            AssignAttri(sPrefix, false, "AV22OrderedBy", StringUtil.LTrimStr( (decimal)(AV22OrderedBy), 4, 0));
            AV23OrderedDsc = ((StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#OrderDSC#>")==0) ? true : false);
            AssignAttri(sPrefix, false, "AV23OrderedDsc", AV23OrderedDsc);
            /* Execute user subroutine: 'SETDDOSORTEDSTATUS' */
            S142 ();
            if ( returnInSub )
            {
      ...
      private void E172W2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.secuserrole"+UrlEncode(StringUtil.RTrim("DSP")) + "," + UrlEncode(StringUtil.LTrimStr(A133SecUserId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(A131SecRoleId,4,0));
         edtavDisplay_Link = formatLink("wwpbaseobjects.secuserrole") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.secuserrole"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(A133SecUserId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(A131SecRoleId,4,0));
         edtavUpdate_Link = formatLink("wwpbaseobjects.secuserrole") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.secuserrole"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(A133SecUserId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(A131SecRoleId,4,0));
         edtavDelete_Link = formatLink("wwpbaseobjects.secuserrole") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
            {
      ...
      protected void E112W2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras"+UrlEncode(StringUtil.RTrim("SecUserSecUserRoleWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV64Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters"+UrlEncode(StringUtil.RTrim("SecUserSecUserRoleWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "SecUserSecUserRoleWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV64Pgmname+"GridState",  AV50ManageFiltersXml) ;
               AV19GridState.FromXml(AV50ManageFiltersXml, null, "", "");
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         Ddo_grid_Sortedstatus = StringUtil.Trim( StringUtil.Str( (decimal)(AV22OrderedBy), 4, 0))+":"+(AV23OrderedDsc ? "DSC" : "ASC");
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3 = AV53ManageFiltersData;
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "SecUserSecUserRoleWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
         AV53ManageFiltersData = GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3;
      }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV14Session.Get(AV64Pgmname+"GridState"), "") == 0 )
         {
            AV19GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV64Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV19GridState.FromXml(AV14Session.Get(AV64Pgmname+"GridState"), null, "", "");
         }
         AV22OrderedBy = AV19GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV22OrderedBy", StringUtil.LTrimStr( (decimal)(AV22OrderedBy), 4, 0));
         AV23OrderedDsc = AV19GridState.gxTpr_Ordereddsc;
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV65GXV1 = 1;
         while ( AV65GXV1 <= AV19GridState.gxTpr_Filtervalues.Count )
         {
            AV20GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV19GridState.gxTpr_Filtervalues.Item(AV65GXV1));
            if ( StringUtil.StrCmp(AV20GridStateFilterValue.gxTpr_Name, "FILTERFULLTEXT") == 0 )
            {
               AV60FilterFullText = AV20GridStateFilterValue.gxTpr_Value;
               AssignAttri(sPrefix, false, "AV60FilterFullText", AV60FilterFullText);
            }
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV19GridState,  "FILTERFULLTEXT",  "Filtro principal",  !String.IsNullOrEmpty(StringUtil.RTrim( AV60FilterFullText)),  0,  AV60FilterFullText,  AV60FilterFullText,  false,  "",  "") ;
         AV19GridState.gxTpr_Pagesize = StringUtil.Str( (decimal)(subGrid_Rows), 10, 0);
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV64Pgmname+"GridState",  AV19GridState.ToXml(false, true, "", "")) ;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "secusersecuserrolewc", GetJustCreated( ));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV8SecUserId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8SecUserId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8SecUserId", StringUtil.LTrimStr( (decimal)(AV8SecUserId), 4, 0));
         }
         else
         {
            AV8SecUserId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8SecUserId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918431957", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("secusersecuserrolewc.js", "?202551918431961", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_332( )
      {
         ...
         edtSecRoleId_Internalname = sPrefix+"SECROLEID_"+sGXsfl_33_idx;
         edtSecRoleName_Internalname = sPrefix+"SECROLENAME_"+sGXsfl_33_idx;
         edtSecRoleDescription_Internalname = sPrefix+"SECROLEDESCRIPTION_"+sGXsfl_33_idx;
      }
      ...
      protected void SubsflControlProps_fel_332( )
      {
         ...
         edtSecRoleId_Internalname = sPrefix+"SECROLEID_"+sGXsfl_33_fel_idx;
         edtSecRoleName_Internalname = sPrefix+"SECROLENAME_"+sGXsfl_33_fel_idx;
         edtSecRoleDescription_Internalname = sPrefix+"SECROLEDESCRIPTION_"+sGXsfl_33_fel_idx;
      }
      ...
      protected void sendrow_332( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_33_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 34,'" + sPrefix + "',false,'" + sGXsfl_33_idx + "',33)\"";
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 35,'" + sPrefix + "',false,'" + sGXsfl_33_idx + "',33)\"";
            ROClassString = "Attribute";
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 36,'" + sPrefix + "',false,'" + sGXsfl_33_idx + "',33)\"";
            ROClassString = "Attribute";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"AV8SecUserId","fld":"vSECUSERID","pic":"ZZZ9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV49ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV23OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV60FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV64Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"A133SecUserId","fld":"SECUSERID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV49ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV57GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV58GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV59GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS","type":"svchar"},{"av":"AV53ManageFiltersData","fld":"vMANAGEFILTERSDATA","type":""},{"av":"AV19GridState","fld":"vGRIDSTATE","type":""}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E122W2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV23OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV60FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV8SecUserId","fld":"vSECUSERID","pic":"ZZZ9","type":"int"},{"av":"AV49ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV64Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"A133SecUserId","fld":"SECUSERID","pic":"ZZZ9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E132W2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV23OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV60FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV8SecUserId","fld":"vSECUSERID","pic":"ZZZ9","type":"int"},{"av":"AV49ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV64Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"A133SecUserId","fld":"SECUSERID","pic":"ZZZ9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E142W2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV23OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV60FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV8SecUserId","fld":"vSECUSERID","pic":"ZZZ9","type":"int"},{"av":"AV49ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV64Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"A133SecUserId","fld":"SECUSERID","pic":"ZZZ9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV22OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV23OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E172W2","iparms":[{"av":"A133SecUserId","fld":"SECUSERID","pic":"ZZZ9","type":"int"},{"av":"A131SecRoleId","fld":"SECROLEID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV63Display","fld":"vDISPLAY","type":"char"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV12Update","fld":"vUPDATE","type":"char"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV13Delete","fld":"vDELETE","type":"char"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtSecRoleName_Link","ctrl":"SECROLENAME","prop":"Link"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E112W2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV22OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV23OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV60FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"AV8SecUserId","fld":"vSECUSERID","pic":"ZZZ9","type":"int"},{"av":"AV49ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV64Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"A133SecUserId","fld":"SECUSERID","pic":"ZZZ9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV19GridState","fld":"vGRIDSTATE","type":""}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV49ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV19GridState","fld":"vGRIDSTATE","type":""},{"av":"AV22OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV23OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV60FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV57GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV58GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9","type":"int"},{"av":"AV59GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS","type":"svchar"},{"av":"AV53ManageFiltersData","fld":"vMANAGEFILTERSDATA","type":""}]}""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         lV60FilterFullText = "";
         H002W2_A647SecUserRoleActive = new bool[] {false} ;
         H002W2_A133SecUserId = new short[1] ;
         H002W2_A139SecRoleDescription = new string[] {""} ;
         H002W2_A140SecRoleName = new string[] {""} ;
         H002W2_A131SecRoleId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.secusersecuserrolewc__default(),
            new Object[][] {
                new Object[] {
               H002W2_A647SecUserRoleActive, H002W2_A133SecUserId, H002W2_A139SecRoleDescription, H002W2_A140SecRoleName, H002W2_A131SecRoleId
               }
               , new Object[] {
      ...
      private bool[] H002W2_A647SecUserRoleActive ;
      private short[] H002W2_A133SecUserId ;
      private string[] H002W2_A139SecRoleDescription ;
      private string[] H002W2_A140SecRoleName ;
      private short[] H002W2_A131SecRoleId ;
   ...
   public class secusersecuserrolewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A133SecUserId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.SecUserRoleActive, T1.SecUserId, T2.SecRoleDescription, T2.SecRoleName, T1.SecRoleId";
         sFromString = " FROM (SecUserRole T1 INNER JOIN SecRole T2 ON T2.SecRoleId = T1.SecRoleId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.SecUserId = :AV8SecUserId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV60FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T2.SecRoleName like '%' || :lV60FilterFullText) or ( T2.SecRoleDescription like '%' || :lV60FilterFullText))");
         }
         else
         {
            GXv_int4[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.SecUserId, T2.SecRoleName, T1.SecRoleId";
         }
         else if ( ( AV22OrderedBy == 2 ) && ( AV23OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SecUserId DESC, T2.SecRoleName DESC, T1.SecRoleId";
         }
         else if ( ( AV22OrderedBy == 3 ) && ! AV23OrderedDsc )
         {
            sOrderString += " ORDER BY T1.SecUserId, T2.SecRoleDescription, T1.SecRoleId";
         }
         else if ( ( AV22OrderedBy == 3 ) && ( AV23OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.SecUserId DESC, T2.SecRoleDescription DESC, T1.SecRoleId";
         }
         else if ( true )
         {
                                             ...
                                             short A133SecUserId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (SecUserRole T1 INNER JOIN SecRole T2 ON T2.SecRoleId = T1.SecRoleId)";
         AddWhere(sWhereString, "(T1.SecUserId = :AV8SecUserId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV60FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T2.SecRoleName like '%' || :lV60FilterFullText) or ( T2.SecRoleDescription like '%' || :lV60FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002W2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
               case 1 :
                     return conditional_H002W3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
         }
