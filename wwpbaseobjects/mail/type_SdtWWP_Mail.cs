...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   ...
   [XmlType(TypeName =  "WWP_Mail" , Namespace = "Factory2" )]
   [Serializable]
   public class SdtWWP_Mail : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<GeneXus.Programs.wwpbaseobjects.mail.SdtWWP_Mail_Attachments> gxTpr_Attachments_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtWWP_Mail_Attachments == null )
            {
               gxTv_SdtWWP_Mail_Attachments = new GXBCLevelCollection<GeneXus.Programs.wwpbaseobjects.mail.SdtWWP_Mail_Attachments>( context, "WWP_Mail.Attachments", "Factory2");
            }
   ...
   [DataContract(Name = @"WWPBaseObjects\Mail\WWP_Mail", Namespace = "Factory2")]
