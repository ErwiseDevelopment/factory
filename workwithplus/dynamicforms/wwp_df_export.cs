   ...
   public class wwp_df_export : GXWebProcedure
   {
      public override void webExecute( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_export")), "workwithplus.dynamicforms.wwp_df_export") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_export")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A94WWPFormId = P003Q2_A94WWPFormId[0];
            A96WWPFormReferenceName = P003Q2_A96WWPFormReferenceName[0];
            A95WWPFormVersionNumber = P003Q2_A95WWPFormVersionNumber[0];
            AV9WWPForm.Load(A94WWPFormId, A95WWPFormVersionNumber);
            AV14WWPFormReferenceName = A96WWPFormReferenceName;
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         gxfirstwebparm = "";
         P003Q2_A94WWPFormId = new short[1] ;
         P003Q2_A96WWPFormReferenceName = new string[] {""} ;
         P003Q2_A95WWPFormVersionNumber = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_export__default(),
            new Object[][] {
                new Object[] {
               P003Q2_A94WWPFormId, P003Q2_A96WWPFormReferenceName, P003Q2_A95WWPFormVersionNumber
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] P003Q2_A94WWPFormId ;
      private string[] P003Q2_A96WWPFormReferenceName ;
      private short[] P003Q2_A95WWPFormVersionNumber ;
   ...
   public class wwp_df_export__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P003Q2", "SELECT WWPFormId, WWPFormReferenceName, WWPFormVersionNumber FROM WWP_Form WHERE WWPFormId = :AV13WWPFormId ORDER BY WWPFormId DESC, WWPFormVersionNumber DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP003Q2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
