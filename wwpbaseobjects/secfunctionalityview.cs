...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secfunctionalityview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wwpbaseobjects.secfunctionalityview"+UrlEncode(StringUtil.LTrimStr(AV10SecFunctionalityId,10,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.secfunctionalityview") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.secfunctionalityview"+UrlEncode(StringUtil.LTrimStr(AV10SecFunctionalityId,10,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("wwpbaseobjects.secfunctionalityview") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB2M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/SecFunctionalityView.htm");
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0023"+"", StringUtil.RTrim( WebComp_Generalwc_Component));
               context.WriteHtmlText( "<div") ;
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSecfunctionalityrole_title_Internalname, "Roles", "", "", lblSecfunctionalityrole_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/SecFunctionalityView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablesecfunctionalityrole_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0031"+"", StringUtil.RTrim( WebComp_Secfunctionalityrolewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldSecfunctionalityrolewc = cgiGet( "W0031");
                           ...
                           if ( StringUtil.Len( WebComp_Secfunctionalityrolewc_Component) != 0 )
                           {
                              WebComp_Secfunctionalityrolewc.componentprocess("W0031", "", sEvt);
                           }
                           WebComp_Secfunctionalityrolewc_Component = OldSecfunctionalityrolewc;
                        }
                     }
      ...
      protected void PA2M2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.secfunctionalityview")), "wwpbaseobjects.secfunctionalityview") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.secfunctionalityview")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10SecFunctionalityId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV10SecFunctionalityId", StringUtil.LTrimStr( (decimal)(AV10SecFunctionalityId), 10, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vSECFUNCTIONALITYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SecFunctionalityId), "ZZZZZZZZZ9"), context));
      ...
      protected void E122M2( )
      {
         ...
         {
            A128SecFunctionalityId = H002M2_A128SecFunctionalityId[0];
            A135SecFunctionalityDescription = H002M2_A135SecFunctionalityDescription[0];
            n135SecFunctionalityDescription = H002M2_n135SecFunctionalityDescription[0];
            AV15GXLvl8 = 1;
            Form.Caption = A135SecFunctionalityDescription;
      ...
      protected void S112( )
      {
         ...
         if ( AV12LoadAllTabs || ( StringUtil.StrCmp(AV13SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV13SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0023",(string)"",(long)AV10SecFunctionalityId});
         ...
         if ( AV12LoadAllTabs || ( StringUtil.StrCmp(AV13SelectedTabCode, "SecFunctionalityRole") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.Len( WebComp_Secfunctionalityrolewc_Component) != 0 )
            {
               ...
               WebComp_Secfunctionalityrolewc.componentprepare(new Object[] {(string)"W0031",(string)"",(long)AV10SecFunctionalityId});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918531669", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/secfunctionalityview.js", "?202551918531669", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV10SecFunctionalityId","fld":"vSECFUNCTIONALITYID","pic":"ZZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true,"type":"char"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E112M2","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV12LoadAllTabs","fld":"vLOADALLTABS","type":"boolean"},{"av":"AV13SelectedTabCode","fld":"vSELECTEDTABCODE","type":"char"},{"av":"AV10SecFunctionalityId","fld":"vSECFUNCTIONALITYID","pic":"ZZZZZZZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV13SelectedTabCode","fld":"vSELECTEDTABCODE","type":"char"},{"av":"AV12LoadAllTabs","fld":"vLOADALLTABS","type":"boolean"},{"ctrl":"GENERALWC"},{"ctrl":"SECFUNCTIONALITYROLEWC"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H002M2_A128SecFunctionalityId = new long[1] ;
         H002M2_A135SecFunctionalityDescription = new string[] {""} ;
         H002M2_n135SecFunctionalityDescription = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.secfunctionalityview__default(),
            new Object[][] {
                new Object[] {
               H002M2_A128SecFunctionalityId, H002M2_A135SecFunctionalityDescription, H002M2_n135SecFunctionalityDescription
               }
            }
         );
      ...
      private bool bDynCreated_Secfunctionalityrolewc ;
      ...
      private long[] H002M2_A128SecFunctionalityId ;
      private string[] H002M2_A135SecFunctionalityDescription ;
      private bool[] H002M2_n135SecFunctionalityDescription ;
   ...
   public class secfunctionalityview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10SecFunctionalityId",GXType.Int64,10,0)
          };
          def= new CursorDef[] {
              new CursorDef("H002M2", "SELECT SecFunctionalityId, SecFunctionalityDescription FROM SecFunctionality WHERE SecFunctionalityId = :AV10SecFunctionalityId ORDER BY SecFunctionalityId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002M2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
