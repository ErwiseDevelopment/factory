...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_mdataplain_wc : GXWebComponent
   {
      ...
      protected void gxgrFsgrid_refresh_invoke( )
      {
         ...
         gxgrFsgrid_refresh( AV9MultipleDataRepetitions, AV12WWP_DF_ElementsRepeaterMetadata, AV13WWPDynamicFormMode, AV10MultipleDataWWPFormInstanceElementId, AV24IsGroupAsMainChild, AV14WWPFormElementId, AV11SessionId, AV5WWPFormInstance, A94WWPFormId, A95WWPFormVersionNumber, A99WWPFormElementParentId, A105WWPFormElementType, AV15WWPFormElementIdSimpleChildren, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_mdataplain_wc"+UrlEncode(StringUtil.RTrim(AV13WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV14WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV20WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_mdataplain_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_mdataplain_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            }
         ...
         if ( wbEnd == 9 )
         {
            ...
            wb_table1_28_1C2( true) ;
         }
         else
         {
            wb_table1_28_1C2( false) ;
         }
         return  ;
      }

      protected void wb_table1_28_1C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_mdataplain_wc")), "workwithplus.dynamicforms.wwp_df_mdataplain_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_mdataplain_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E131C2( )
      {
         ...
         {
            A98WWPFormElementId = H001C2_A98WWPFormElementId[0];
            A95WWPFormVersionNumber = H001C2_A95WWPFormVersionNumber[0];
            A94WWPFormId = H001C2_A94WWPFormId[0];
            A117WWPFormElementTitle = H001C2_A117WWPFormElementTitle[0];
            A124WWPFormElementMetadata = H001C2_A124WWPFormElementMetadata[0];
            AV18WWPFormElementTitle = A117WWPFormElementTitle;
            AV17WWPFormElementMetadata = A124WWPFormElementMetadata;
         ...
         AV28GXV1 = 1;
         while ( AV28GXV1 <= AV5WWPFormInstance.gxTpr_Element.Count )
         {
            AV19WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV5WWPFormInstance.gxTpr_Element.Item(AV28GXV1));
         ...
         if ( AV10MultipleDataWWPFormInstanceElementId.Count == 0 )
         {
            if ( StringUtil.StrCmp(AV13WWPDynamicFormMode, "INS") != 0 )
            {
               ...
               {
                  A98WWPFormElementId = H001C3_A98WWPFormElementId[0];
                  A102WWPFormInstanceId = H001C3_A102WWPFormInstanceId[0];
                  A103WWPFormInstanceElementId = H001C3_A103WWPFormInstanceElementId[0];
            ...
            else
            {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     AV30GXV2 = 1;
                     while ( AV30GXV2 <= AV5WWPFormInstance.gxTpr_Element.Count )
                     {
                        AV19WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV5WWPFormInstance.gxTpr_Element.Item(AV30GXV2));
            ...
            AV5WWPFormInstance = GXt_SdtWWP_FormInstance1;
            AV31GXV3 = 1;
            while ( AV31GXV3 <= AV10MultipleDataWWPFormInstanceElementId.Count )
            {
               AV7i = (short)(AV10MultipleDataWWPFormInstanceElementId.GetNumeric(AV31GXV3));
         ...
         {
            divDatacellname_Class = "DataContentCell";
            AssignProp(sPrefix, false, divDatacellname_Internalname, "Class", divDatacellname_Class, true);
         }
         else
         {
            divDatacellname_Class = "DataContentCell DataContentCellNoLabel DynamicFormAddChildren";
            AssignProp(sPrefix, false, divDatacellname_Internalname, "Class", divDatacellname_Class, true);
         }
      ...
      private void E151C2( )
      {
         ...
         if (returnInSub) return;
         AV32GXV4 = 1;
         while ( AV32GXV4 <= AV10MultipleDataWWPFormInstanceElementId.Count )
         {
            AV21WWPFormInstanceElementIdChild = (short)(AV10MultipleDataWWPFormInstanceElementId.GetNumeric(AV32GXV4));
            AssignAttri(sPrefix, false, edtavWwpforminstanceelementidchild_Internalname, StringUtil.LTrimStr( (decimal)(AV21WWPFormInstanceElementIdChild), 4, 0));
      ...
      protected void E121C2( )
      {
         ...
         if ( ( AV6AuxSessionId == AV11SessionId ) && ( AV12WWP_DF_ElementsRepeaterMetadata.gxTpr_Repetitionstype == 3 ) )
         {
            ...
            AV5WWPFormInstance = GXt_SdtWWP_FormInstance1;
            AV33GXV5 = 1;
            while ( AV33GXV5 <= AV5WWPFormInstance.gxTpr_Element.Count )
            {
               AV19WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV5WWPFormInstance.gxTpr_Element.Item(AV33GXV5));
               if ( AV19WWPFormInstanceElement.gxTpr_Wwpformelementid == AV12WWP_DF_ElementsRepeaterMetadata.gxTpr_Repetitions_variable.gxTpr_Elementid )
               {
                  AV9MultipleDataRepetitions = (short)(Math.Round(AV19WWPFormInstanceElement.gxTpr_Wwpforminstanceelemnumeric, 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV9MultipleDataRepetitions", StringUtil.LTrimStr( (decimal)(AV9MultipleDataRepetitions), 4, 0));
      ...
      protected void S122( )
      {
         ...
         {
            A99WWPFormElementParentId = H001C4_A99WWPFormElementParentId[0];
            n99WWPFormElementParentId = H001C4_n99WWPFormElementParentId[0];
            A95WWPFormVersionNumber = H001C4_A95WWPFormVersionNumber[0];
            A94WWPFormId = H001C4_A94WWPFormId[0];
            A105WWPFormElementType = H001C4_A105WWPFormElementType[0];
      ...
      protected void S142( )
      {
         ...
         while ( AV7i <= AV16WWPFormElementIdToDelete.Count )
         {
            AV8j = 1;
            AV35GXV6 = 1;
            while ( AV35GXV6 <= AV5WWPFormInstance.gxTpr_Element.Count )
            {
               AV19WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV5WWPFormInstance.gxTpr_Element.Item(AV35GXV6));
      ...
      protected void S132( )
      {
         ...
         AV36GXV7 = 1;
         while ( AV36GXV7 <= AV5WWPFormInstance.gxTpr_Element.Count )
         {
            AV19WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV5WWPFormInstance.gxTpr_Element.Item(AV36GXV7));
      ...
      protected void wb_table1_28_1C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_28_1C2e( true) ;
         }
         else
         {
            wb_table1_28_1C2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918382485", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_mdataplain_wc.js", "?202551918382486", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         divDatacellname_Class = "col-xs-12 DataContentCellFL";
         divDatacellname_Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"edtavWwpforminstanceelementidchild_Visible","ctrl":"vWWPFORMINSTANCEELEMENTIDCHILD","prop":"Visible"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV13WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV12WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV24IsGroupAsMainChild","fld":"vISGROUPASMAINCHILD","hsh":true,"type":"boolean"},{"av":"AV15WWPFormElementIdSimpleChildren","fld":"vWWPFORMELEMENTIDSIMPLECHILDREN","pic":"ZZZ9","hsh":true,"type":"int"}]""");
         ...
         setEventMetadata("FSGRID.LOAD","""{"handler":"E151C2","iparms":[{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV12WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV13WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV24IsGroupAsMainChild","fld":"vISGROUPASMAINCHILD","hsh":true,"type":"boolean"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"}]""");
         setEventMetadata("FSGRID.LOAD",""","oparms":[{"av":"AV21WWPFormInstanceElementIdChild","fld":"vWWPFORMINSTANCEELEMENTIDCHILD","pic":"ZZZ9","type":"int"},{"av":"lblRemovechild_Visible","ctrl":"REMOVECHILD","prop":"Visible"},{"av":"lblRemovechild_Class","ctrl":"REMOVECHILD","prop":"Class"},{"ctrl":"WCCHILDREN"},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV24IsGroupAsMainChild","fld":"vISGROUPASMAINCHILD","hsh":true,"type":"boolean"}]}""");
         setEventMetadata("'DOADDCHILD'","""{"handler":"E111C2","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV12WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV13WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"edtavWwpforminstanceelementidchild_Visible","ctrl":"vWWPFORMINSTANCEELEMENTIDCHILD","prop":"Visible"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV24IsGroupAsMainChild","fld":"vISGROUPASMAINCHILD","hsh":true,"type":"boolean"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"AV15WWPFormElementIdSimpleChildren","fld":"vWWPFORMELEMENTIDSIMPLECHILDREN","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV22WWPFormInstanceElementIdNew","fld":"vWWPFORMINSTANCEELEMENTIDNEW","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("'DOADDCHILD'",""","oparms":[{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstanceElementIdNew","fld":"vWWPFORMINSTANCEELEMENTIDNEW","pic":"ZZZ9","type":"int"},{"av":"Btnaddchild_Visible","ctrl":"BTNADDCHILD","prop":"Visible"},{"av":"divDatacellname_Visible","ctrl":"DATACELLNAME","prop":"Visible"}]}""");
         setEventMetadata("'DOREMOVECHILD'","""{"handler":"E161C2","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV12WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV13WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"edtavWwpforminstanceelementidchild_Visible","ctrl":"vWWPFORMINSTANCEELEMENTIDCHILD","prop":"Visible"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV24IsGroupAsMainChild","fld":"vISGROUPASMAINCHILD","hsh":true,"type":"boolean"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"AV15WWPFormElementIdSimpleChildren","fld":"vWWPFORMELEMENTIDSIMPLECHILDREN","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV21WWPFormInstanceElementIdChild","fld":"vWWPFORMINSTANCEELEMENTIDCHILD","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("'DOREMOVECHILD'",""","oparms":[{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"Btnaddchild_Visible","ctrl":"BTNADDCHILD","prop":"Visible"},{"av":"divDatacellname_Visible","ctrl":"DATACELLNAME","prop":"Visible"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E121C2","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV12WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV13WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"edtavWwpforminstanceelementidchild_Visible","ctrl":"vWWPFORMINSTANCEELEMENTIDCHILD","prop":"Visible"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV24IsGroupAsMainChild","fld":"vISGROUPASMAINCHILD","hsh":true,"type":"boolean"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"AV15WWPFormElementIdSimpleChildren","fld":"vWWPFORMELEMENTIDSIMPLECHILDREN","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstanceElementIdNew","fld":"vWWPFORMINSTANCEELEMENTIDNEW","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormInstanceElementIdChild","fld":"vWWPFORMINSTANCEELEMENTIDCHILD","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV5WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormInstanceElementIdChild","fld":"vWWPFORMINSTANCEELEMENTIDCHILD","pic":"ZZZ9","type":"int"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV22WWPFormInstanceElementIdNew","fld":"vWWPFORMINSTANCEELEMENTIDNEW","pic":"ZZZ9","type":"int"},{"av":"Btnaddchild_Visible","ctrl":"BTNADDCHILD","prop":"Visible"},{"av":"divDatacellname_Visible","ctrl":"DATACELLNAME","prop":"Visible"}]}""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         WebComp_Wcchildren_Component = "";
         H001C2_A98WWPFormElementId = new short[1] ;
         H001C2_A95WWPFormVersionNumber = new short[1] ;
         H001C2_A94WWPFormId = new short[1] ;
         H001C2_A117WWPFormElementTitle = new string[] {""} ;
         H001C2_A124WWPFormElementMetadata = new string[] {""} ;
         ...
         H001C3_A98WWPFormElementId = new short[1] ;
         H001C3_A102WWPFormInstanceId = new int[1] ;
         H001C3_A103WWPFormInstanceElementId = new short[1] ;
         ...
         H001C4_A98WWPFormElementId = new short[1] ;
         H001C4_A99WWPFormElementParentId = new short[1] ;
         H001C4_n99WWPFormElementParentId = new bool[] {false} ;
         H001C4_A95WWPFormVersionNumber = new short[1] ;
         H001C4_A94WWPFormId = new short[1] ;
         H001C4_A105WWPFormElementType = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_mdataplain_wc__default(),
            new Object[][] {
                new Object[] {
               H001C2_A98WWPFormElementId, H001C2_A95WWPFormVersionNumber, H001C2_A94WWPFormId, H001C2_A117WWPFormElementTitle, H001C2_A124WWPFormElementMetadata
               }
               , new Object[] {
               H001C3_A98WWPFormElementId, H001C3_A102WWPFormInstanceId, H001C3_A103WWPFormInstanceElementId
               }
               , new Object[] {
               H001C4_A98WWPFormElementId, H001C4_A99WWPFormElementParentId, H001C4_n99WWPFormElementParentId, H001C4_A95WWPFormVersionNumber, H001C4_A94WWPFormId, H001C4_A105WWPFormElementType
               }
            }
         );
      ...
      private short[] H001C2_A98WWPFormElementId ;
      private short[] H001C2_A95WWPFormVersionNumber ;
      private short[] H001C2_A94WWPFormId ;
      private string[] H001C2_A117WWPFormElementTitle ;
      private string[] H001C2_A124WWPFormElementMetadata ;
      private GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element AV19WWPFormInstanceElement ;
      private short[] H001C3_A98WWPFormElementId ;
      private int[] H001C3_A102WWPFormInstanceId ;
      private short[] H001C3_A103WWPFormInstanceElementId ;
      ...
      private short[] H001C4_A98WWPFormElementId ;
      private short[] H001C4_A99WWPFormElementParentId ;
      private bool[] H001C4_n99WWPFormElementParentId ;
      private short[] H001C4_A95WWPFormVersionNumber ;
      private short[] H001C4_A94WWPFormId ;
      private short[] H001C4_A105WWPFormElementType ;
