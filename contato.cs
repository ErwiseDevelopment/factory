...
namespace GeneXus.Programs {
   public class contato : GXDataArea
   {
      public contato( )
      {
      ...
      public contato( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "contato"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormWithFixedActions\" data-gx-class=\"form-horizontal FormWithFixedActions\" novalidate action=\""+formatLink("contato") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "contato"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         return formatLink("contato") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB8H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablemain_Internalname, 1, 0, "px", 0, "px", "Flex", "start", "top", " "+"data-gx-flex"+" ", "flex-direction:column;justify-content:center;align-items:center;", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTabletitles_Internalname, divTabletitles_Visible, 0, "px", 0, "px", "Table", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0011"+"", StringUtil.RTrim( WebComp_Steptitles_Component));
               context.WriteHtmlText( "<div") ;
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_Contato.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "WizardStepsPositionCell", "start", "top", "", "flex-grow:1;", "div");
            if ( ! isFullAjaxMode( ) )
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0016"+"", StringUtil.RTrim( WebComp_Wizardstepwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 11 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Steptitles_Component) != 0 )
                           {
                              WebComp_Steptitles.componentprocess("W0011", "", sEvt);
                           }
                           WebComp_Steptitles_Component = OldSteptitles;
                        }
                        else if ( nCmpId == 16 )
                        {
                           OldWizardstepwc = cgiGet( "W0016");
      ...
      protected void PA8H2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "contato")), "contato") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "contato")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E118H2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV11WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Factory2");
         AV12WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV12WizardStep.gxTpr_Code = "PrimeiroContato";
         AV12WizardStep.gxTpr_Title = "Primeiro contato";
         AV12WizardStep.gxTpr_Description = "Primeiro contato";
         AV11WizardSteps.Add(AV12WizardStep, 0);
         AV12WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV12WizardStep.gxTpr_Code = "CNPJ";
         AV12WizardStep.gxTpr_Title = "CNPJ";
         AV12WizardStep.gxTpr_Description = "CNPJ";
         AV11WizardSteps.Add(AV12WizardStep, 0);
         AV12WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV12WizardStep.gxTpr_Code = "Empresa";
         AV12WizardStep.gxTpr_Title = "Empresa";
         AV12WizardStep.gxTpr_Description = "Empresa";
         AV11WizardSteps.Add(AV12WizardStep, 0);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV9CurrentStep)) )
         {
            AV10CurrentStepAux = "PrimeiroContato";
            AssignAttri("", false, "AV10CurrentStepAux", AV10CurrentStepAux);
            GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEPAUX", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV10CurrentStepAux, "")), context));
            AV5WebSession.Remove(AV14Pgmname+"_Data");
         }
         else
         {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Steptitles_Component), StringUtil.Lower( "WWPBaseObjects.WizardWithoutSteps")) != 0 )
         {
            WebComp_Steptitles = getWebComponent(GetType(), "GeneXus.Programs", "wwpbaseobjects.wizardwithoutsteps", new Object[] {context} );
            WebComp_Steptitles.ComponentInit();
            WebComp_Steptitles.Name = "WWPBaseObjects.WizardWithoutSteps";
            WebComp_Steptitles_Component = "WWPBaseObjects.WizardWithoutSteps";
         }
         if ( StringUtil.Len( WebComp_Steptitles_Component) != 0 )
         {
            WebComp_Steptitles.setjustcreated();
            WebComp_Steptitles.componentprepare(new Object[] {(string)"W0011",(string)"",(GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)AV11WizardSteps,(string)AV10CurrentStepAux});
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV10CurrentStepAux, "PrimeiroContato") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "ContatoPrimeiroContato")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "contatoprimeirocontato", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "ContatoPrimeiroContato";
               WebComp_Wizardstepwc_Component = "ContatoPrimeiroContato";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0016",(string)"",(string)AV14Pgmname+"_Data",(string)AV8PreviousStep,(bool)AV7GoingBack});
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "CNPJ") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "ContatoCNPJ")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "contatocnpj", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "ContatoCNPJ";
               WebComp_Wizardstepwc_Component = "ContatoCNPJ";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "Empresa") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "ContatoEmpresa")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "contatoempresa", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "ContatoEmpresa";
               WebComp_Wizardstepwc_Component = "ContatoEmpresa";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         divTabletitles_Visible = (((1==2)) ? 1 : 0);
         AssignProp("", false, divTabletitles_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divTabletitles_Visible), 5, 0), true);
      }
      ...
      protected void E128H2( )
      {
         ...
         AV13StepNumber = 1;
         AV15GXV1 = 1;
         while ( AV15GXV1 <= AV11WizardSteps.Count )
         {
            AV12WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV11WizardSteps.Item(AV15GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255191858217", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contato.js", "?20255191858217", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTabletitles_Internalname = "TABLETITLES";
      ...
      private int divTabletitles_Visible ;
      ...
      private string divTabletitles_Internalname ;
