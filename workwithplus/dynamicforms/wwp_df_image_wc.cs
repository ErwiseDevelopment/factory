   ...
   public class wwp_df_image_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_image_wc"+UrlEncode(StringUtil.RTrim(AV30WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV32WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV37WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_image_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vIMAGEREADONLY_GXI", AV42Imagereadonly_GXI);
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void WB1Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_image_wc");
               context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            }
            ...
            wb_table1_17_1Q2( true) ;
         }
         else
         {
            wb_table1_17_1Q2( false) ;
         }
         return  ;
      }

      protected void wb_table1_17_1Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_image_wc")), "workwithplus.dynamicforms.wwp_df_image_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_image_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E121Q2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV14HasReferenceId, context));
         AV41GXV1 = 1;
         while ( AV41GXV1 <= AV35WWPFormInstance.gxTpr_Element.Count )
         {
            AV36WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV35WWPFormInstance.gxTpr_Element.Item(AV41GXV1));
      ...
      protected void E141Q2( )
      {
         ...
         returnInSub = false;
         AV15ImageReadonly = "";
         AssignProp(sPrefix, false, imgavImagereadonly_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV15ImageReadonly)) ? AV42Imagereadonly_GXI : context.convertURL( context.PathToRelativeUrl( AV15ImageReadonly))), true);
         AssignProp(sPrefix, false, imgavImagereadonly_Internalname, "SrcSet", context.GetImageSrcSet( AV15ImageReadonly), true);
         AV42Imagereadonly_GXI = "";
         AssignProp(sPrefix, false, imgavImagereadonly_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV15ImageReadonly)) ? AV42Imagereadonly_GXI : context.convertURL( context.PathToRelativeUrl( AV15ImageReadonly))), true);
         AssignProp(sPrefix, false, imgavImagereadonly_Internalname, "SrcSet", context.GetImageSrcSet( AV15ImageReadonly), true);
      ...
      protected void E151Q2( )
      {
         ...
         returnInSub = false;
         if ( ( AV5AuxSessionId == AV21SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV40ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV32WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV37WWPFormInstanceElementId), 4, 0))+"|") )
         {
            /* Execute user subroutine: 'SAVE ELEMENT DATA TO SESSION' */
            S162 ();
            if (returnInSub) return;
      ...
      protected void S112( )
      {
         ...
         AssignProp(sPrefix, false, imgavImagereadonly_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV15ImageReadonly)) ? AV42Imagereadonly_GXI : context.convertURL( context.PathToRelativeUrl( AV15ImageReadonly))), true);
         AssignProp(sPrefix, false, imgavImagereadonly_Internalname, "SrcSet", context.GetImageSrcSet( AV15ImageReadonly), true);
         AV42Imagereadonly_GXI = GXDbFile.GetUriFromFile( "", "", AV6CurrentWWPFormInstanceElement.gxTpr_Wwpforminstanceelemblob);
         AssignProp(sPrefix, false, imgavImagereadonly_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV15ImageReadonly)) ? AV42Imagereadonly_GXI : context.convertURL( context.PathToRelativeUrl( AV15ImageReadonly))), true);
         AssignProp(sPrefix, false, imgavImagereadonly_Internalname, "SrcSet", context.GetImageSrcSet( AV15ImageReadonly), true);
      }
      ...
      protected void S162( )
      {
         ...
         AV43GXV2 = 1;
         while ( AV43GXV2 <= AV35WWPFormInstance.gxTpr_Element.Count )
         {
            AV36WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV35WWPFormInstance.gxTpr_Element.Item(AV43GXV2));
            if ( ( AV36WWPFormInstanceElement.gxTpr_Wwpformelementid == AV32WWPFormElementId ) && ( AV36WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV37WWPFormInstanceElementId ) )
            {
      ...
      protected void S192( )
      {
         ...
         {
            if ( ( ( StringUtil.StrCmp(AV30WWPDynamicFormMode, "UPD") == 0 ) || ( StringUtil.StrCmp(AV30WWPDynamicFormMode, "INS") == 0 ) ) && ( StringUtil.StrCmp(AV42Imagereadonly_GXI, "") != 0 ) )
            {
      ...
      protected void S172( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV34WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV12ElementInternalName,  "true",  ""));
            AV18IsValid = false;
         }
         else
         {
      ...
      protected void S202( )
      {
         ...
         AV8DataCellNameClass = "DataContentCellFL";
         ...
         {
            AV8DataCellNameClass = "RequiredDataContentCellFL " + AV8DataCellNameClass;
         }
      ...
      protected void wb_table1_17_1Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_label_element( context, "", "Image Readonly", "gx-form-item AttributeFLLabel", 0, true, "width: 25%;");
            ...
            StyleString = "";
            AV15ImageReadonly_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV15ImageReadonly))&&String.IsNullOrEmpty(StringUtil.RTrim( AV42Imagereadonly_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV15ImageReadonly)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV15ImageReadonly)) ? AV42Imagereadonly_GXI : context.PathToRelativeUrl( AV15ImageReadonly));
            ...
            wb_table1_17_1Q2e( true) ;
         }
         else
         {
            wb_table1_17_1Q2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381366", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_image_wc.js", "?202551918381367", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         imgavImagereadonly_Visible = 1;
         imgavImagereadonly_Class = "AttributeFL";
         Btnremoveimage_Visible = Convert.ToBoolean( -1);
         lblTextblockimagereadonly_Caption = " ";
         divTextblockimagereadonly_cell_Class = "col-xs-12 col-sm-3";
         divDatacellname_Class = "col-xs-12 DataContentCell CellDynamicFormImage";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV15ImageReadonly","fld":"vIMAGEREADONLY","type":"bits"},{"av":"AV25UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV30WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV29WWP_DF_ImageMetadata","fld":"vWWP_DF_IMAGEMETADATA","hsh":true,"type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV12ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV14HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"}]""");
         ...
         setEventMetadata("'DOREMOVEIMAGE'","""{"handler":"E141Q2","iparms":[{"av":"AV35WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV37WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV15ImageReadonly","fld":"vIMAGEREADONLY","type":"bits"},{"av":"AV25UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV30WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV42Imagereadonly_GXI","fld":"vIMAGEREADONLY_GXI","type":"svchar"},{"av":"AV36WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]""");
         setEventMetadata("'DOREMOVEIMAGE'",""","oparms":[{"av":"AV15ImageReadonly","fld":"vIMAGEREADONLY","type":"bits"},{"av":"AV42Imagereadonly_GXI","fld":"vIMAGEREADONLY_GXI","type":"svchar"},{"av":"AV25UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV36WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"imgavImagereadonly_Visible","ctrl":"vIMAGEREADONLY","prop":"Visible"},{"av":"cellImagereadonly_cell_Class","ctrl":"IMAGEREADONLY_CELL","prop":"Class"},{"av":"divTextblockimagereadonly_cell_Class","ctrl":"TEXTBLOCKIMAGEREADONLY_CELL","prop":"Class"},{"av":"Btnremoveimage_Visible","ctrl":"BTNREMOVEIMAGE","prop":"Visible"},{"av":"cellUcimagescell_Class","ctrl":"UCIMAGESCELL","prop":"Class"},{"av":"imgavImagereadonly_Class","ctrl":"vIMAGEREADONLY","prop":"Class"},{"av":"AV35WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E151Q2","iparms":[{"av":"AV40ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV5AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV37WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV35WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV29WWP_DF_ImageMetadata","fld":"vWWP_DF_IMAGEMETADATA","hsh":true,"type":""},{"av":"AV36WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV12ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV25UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV42Imagereadonly_GXI","fld":"vIMAGEREADONLY_GXI","type":"svchar"},{"av":"AV30WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV36WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV35WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E161Q2","iparms":[{"av":"AV5AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV27VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV29WWP_DF_ImageMetadata","fld":"vWWP_DF_IMAGEMETADATA","hsh":true,"type":""},{"av":"AV37WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV35WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV35WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV27VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         setEventMetadata("UCIMAGES.UPLOADCOMPLETE","""{"handler":"E111Q2","iparms":[{"av":"AV14HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV35WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV37WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV29WWP_DF_ImageMetadata","fld":"vWWP_DF_IMAGEMETADATA","hsh":true,"type":""},{"av":"AV36WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV12ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV25UploadedFiles","fld":"vUPLOADEDFILES","type":""},{"av":"AV42Imagereadonly_GXI","fld":"vIMAGEREADONLY_GXI","type":"svchar"},{"av":"AV30WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]""");
         setEventMetadata("UCIMAGES.UPLOADCOMPLETE",""","oparms":[{"av":"AV13ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV36WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV35WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10DataExtension","fld":"vDATAEXTENSION","type":"svchar"},{"av":"AV11DataFileName","fld":"vDATAFILENAME","type":"svchar"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV25UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV38FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV42Imagereadonly_GXI = "";
         ...
         AV7Data = "";
         AV26Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory2");
         AV22ThisValueStr = "";
      ...
      private string AV42Imagereadonly_GXI ;
