...
namespace GeneXus.Programs {
   public class iniciarsistema : GXDataArea
   {
      ...
      public iniciarsistema( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            MasterPageObj = (GXMasterPage) ClassLoader.GetInstance("wwpbaseobjects.workwithplusmasterpageemptynew", "GeneXus.Programs.wwpbaseobjects.workwithplusmasterpageemptynew", new Object[] {context});
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "iniciarsistema"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormWithFixedActions\" data-gx-class=\"form-horizontal FormWithFixedActions\" novalidate action=\""+formatLink("iniciarsistema") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "iniciarsistema"+UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV9CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
         return formatLink("iniciarsistema") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB7H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 WizardStepsLinePositionCell", "start", "top", "", "", "div");
            if ( ! isFullAjaxMode( ) )
            {
               /* WebComponent */
      ...
      protected void START7H2( )
      {
         ...
         Form.Meta.addItem("description", "Iniciar Sistema", 0) ;
         context.wjLoc = "";
      ...
      protected void PA7H2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "iniciarsistema")), "iniciarsistema") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "iniciarsistema")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E117H2( )
      {
         ...
         AV12WizardStep.gxTpr_Code = "Iniciando_sistema";
         AV12WizardStep.gxTpr_Title = "Iniciando sistema";
         AV12WizardStep.gxTpr_Description = "Iniciando sistema";
         ...
         AV11WizardSteps.Add(AV12WizardStep, 0);
         AV12WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV12WizardStep.gxTpr_Code = "Usuario";
         AV12WizardStep.gxTpr_Title = "Usuário";
         AV12WizardStep.gxTpr_Description = "Usuário";
         AV11WizardSteps.Add(AV12WizardStep, 0);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV9CurrentStep)) )
         {
            AV10CurrentStepAux = "Iniciando_sistema";
            AssignAttri("", false, "AV10CurrentStepAux", AV10CurrentStepAux);
            AV5WebSession.Remove(AV13Pgmname+"_Data");
         }
         else
         {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Steptitles_Component), StringUtil.Lower( "WWPBaseObjects.WizardStepsProgressWC")) != 0 )
         {
            WebComp_Steptitles = getWebComponent(GetType(), "GeneXus.Programs", "wwpbaseobjects.wizardstepsprogresswc", new Object[] {context} );
            WebComp_Steptitles.ComponentInit();
            WebComp_Steptitles.Name = "WWPBaseObjects.WizardStepsProgressWC";
            WebComp_Steptitles_Component = "WWPBaseObjects.WizardStepsProgressWC";
         }
         if ( StringUtil.Len( WebComp_Steptitles_Component) != 0 )
         {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV10CurrentStepAux, "Iniciando_sistema") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "IniciarSistemaIniciando_sistema")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "iniciarsistemainiciando_sistema", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "IniciarSistemaIniciando_sistema";
               WebComp_Wizardstepwc_Component = "IniciarSistemaIniciando_sistema";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0012",(string)"",(string)AV13Pgmname+"_Data",(string)AV8PreviousStep,(bool)AV7GoingBack});
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "Empresa") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "IniciarSistemaEmpresa")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "iniciarsistemaempresa", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "IniciarSistemaEmpresa";
               WebComp_Wizardstepwc_Component = "IniciarSistemaEmpresa";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
         ...
         else if ( StringUtil.StrCmp(AV10CurrentStepAux, "Usuario") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "IniciarSistemaUsuario")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "iniciarsistemausuario", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "IniciarSistemaUsuario";
               WebComp_Wizardstepwc_Component = "IniciarSistemaUsuario";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918572170", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("iniciarsistema.js", "?202551918572170", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV8PreviousStep","fld":"vPREVIOUSSTEP","hsh":true,"type":"svchar"},{"av":"AV9CurrentStep","fld":"vCURRENTSTEP","hsh":true,"type":"svchar"},{"av":"AV7GoingBack","fld":"vGOINGBACK","hsh":true,"type":"boolean"}]}""");
         return  ;
      }
