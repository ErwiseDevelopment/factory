...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_subscription : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtWWPUserExtendedId_Internalname, "WWPUser Extended Id", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 54,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtWWPUserExtendedId_Internalname, StringUtil.RTrim( A7WWPUserExtendedId), StringUtil.RTrim( context.localUtil.Format( A7WWPUserExtendedId, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPUserExtendedId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPUserExtendedId_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPBaseObjects/Subscriptions/WWP_Subscription.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 form__cell", "start", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtWWPSubscriptionEntityRecordDescription_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtWWPSubscriptionEntityRecordDescription_Internalname, A28WWPSubscriptionEntityRecordDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,69);\"", 0, 1, edtWWPSubscriptionEntityRecordDescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_WWPBaseObjects/Subscriptions/WWP_Subscription.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Z28WWPSubscriptionEntityRecordDescription = cgiGet( "Z28WWPSubscriptionEntityRecordDescription");
            ...
            A28WWPSubscriptionEntityRecordDescription = cgiGet( edtWWPSubscriptionEntityRecordDescription_Internalname);
            AssignAttri("", false, "A28WWPSubscriptionEntityRecordDescription", A28WWPSubscriptionEntityRecordDescription);
      ...
      protected void ZM044( short GX_JID )
      {
         if ( ( GX_JID == 2 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z28WWPSubscriptionEntityRecordDescription = T00043_A28WWPSubscriptionEntityRecordDescription[0];
            ...
            else
            {
               ...
               Z28WWPSubscriptionEntityRecordDescription = A28WWPSubscriptionEntityRecordDescription;
      ...
      protected void Load044( )
      {
         ...
         if ( (pr_default.getStatus(5) != 101) )
         {
            ...
            A29WWPNotificationDefinitionDescription = T00047_A29WWPNotificationDefinitionDescription[0];
            AssignAttri("", false, "A29WWPNotificationDefinitionDescription", A29WWPNotificationDefinitionDescription);
            ...
            AssignAttri("", false, "A26WWPSubscriptionEntityRecordId", A26WWPSubscriptionEntityRecordId);
            A28WWPSubscriptionEntityRecordDescription = T00047_A28WWPSubscriptionEntityRecordDescription[0];
            AssignAttri("", false, "A28WWPSubscriptionEntityRecordDescription", A28WWPSubscriptionEntityRecordDescription);
      ...
      protected void CheckExtendedTable044( )
      {
         ...
         A29WWPNotificationDefinitionDescription = T00044_A29WWPNotificationDefinitionDescription[0];
         AssignAttri("", false, "A29WWPNotificationDefinitionDescription", A29WWPNotificationDefinitionDescription);
         pr_default.close(2);
         /* Using cursor T00046 */
      ...
      protected void gxLoad_3( long A23WWPNotificationDefinitionId )
      {
         ...
         A29WWPNotificationDefinitionDescription = T00048_A29WWPNotificationDefinitionDescription[0];
         AssignAttri("", false, "A29WWPNotificationDefinitionDescription", A29WWPNotificationDefinitionDescription);
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A20WWPEntityId), 10, 0, ".", "")))+"\""+","+"\""+GXUtil.EncodeJSConstant( A29WWPNotificationDefinitionDescription)+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(6) == 101) )
         {
            AddString( ",") ;
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A26WWPSubscriptionEntityRecordId", A26WWPSubscriptionEntityRecordId);
            A28WWPSubscriptionEntityRecordDescription = T00043_A28WWPSubscriptionEntityRecordDescription[0];
            AssignAttri("", false, "A28WWPSubscriptionEntityRecordDescription", A28WWPSubscriptionEntityRecordDescription);
      ...
      protected void CheckOptimisticConcurrency044( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( StringUtil.StrCmp(Z7WWPUserExtendedId, T00042_A7WWPUserExtendedId[0]) != 0 ) )
            {
               ...
               if ( StringUtil.StrCmp(Z28WWPSubscriptionEntityRecordDescription, T00042_A28WWPSubscriptionEntityRecordDescription[0]) != 0 )
               {
                  ...
                  GXUtil.WriteLogRaw("Old: ",Z28WWPSubscriptionEntityRecordDescription);
                  GXUtil.WriteLogRaw("Current: ",T00042_A28WWPSubscriptionEntityRecordDescription[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(12, new Object[] {A26WWPSubscriptionEntityRecordId, A28WWPSubscriptionEntityRecordDescription, n19WWPSubscriptionRoleId, A19WWPSubscriptionRoleId, A27WWPSubscriptionSubscribed, A23WWPNotificationDefinitionId, n7WWPUserExtendedId, A7WWPUserExtendedId});
                     pr_default.close(12);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(14, new Object[] {A26WWPSubscriptionEntityRecordId, A28WWPSubscriptionEntityRecordDescription, n19WWPSubscriptionRoleId, A19WWPSubscriptionRoleId, A27WWPSubscriptionSubscribed, A23WWPNotificationDefinitionId, n7WWPUserExtendedId, A7WWPUserExtendedId, A25WWPSubscriptionId});
                     pr_default.close(14);
                     pr_default.SmartCacheProvider.SetUpdated("WWP_Subscription");
      ...
      protected void OnDeleteControls044( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            A29WWPNotificationDefinitionDescription = T000418_A29WWPNotificationDefinitionDescription[0];
            AssignAttri("", false, "A29WWPNotificationDefinitionDescription", A29WWPNotificationDefinitionDescription);
            pr_default.close(16);
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.subscriptions.wwp_subscription") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z28WWPSubscriptionEntityRecordDescription", Z28WWPSubscriptionEntityRecordDescription);
      ...
      {
         return formatLink("wwpbaseobjects.subscriptions.wwp_subscription")  ;
      }
      ...
      protected void InitializeNonKey044( )
      {
         ...
         AssignAttri("", false, "A26WWPSubscriptionEntityRecordId", A26WWPSubscriptionEntityRecordId);
         A28WWPSubscriptionEntityRecordDescription = "";
         AssignAttri("", false, "A28WWPSubscriptionEntityRecordDescription", A28WWPSubscriptionEntityRecordDescription);
         ...
         Z28WWPSubscriptionEntityRecordDescription = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019123916", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/subscriptions/wwp_subscription.js", "?202561019123917", false, true);
      ...
      {
         setEventMetadata("ENTER","""{"handler":"UserMainFullajax","iparms":[{"postForm":true},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]}""");
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPSUBSCRIPTIONID","""{"handler":"Valid_Wwpsubscriptionid","iparms":[{"av":"A25WWPSubscriptionId","fld":"WWPSUBSCRIPTIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]""");
         setEventMetadata("VALID_WWPSUBSCRIPTIONID",""","oparms":[{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"A26WWPSubscriptionEntityRecordId","fld":"WWPSUBSCRIPTIONENTITYRECORDID","type":"svchar"},{"av":"A28WWPSubscriptionEntityRecordDescription","fld":"WWPSUBSCRIPTIONENTITYRECORDDESCRIPTION","type":"svchar"},{"av":"A19WWPSubscriptionRoleId","fld":"WWPSUBSCRIPTIONROLEID","type":"char"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A8WWPUserExtendedFullName","fld":"WWPUSEREXTENDEDFULLNAME","type":"svchar"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"Z25WWPSubscriptionId","type":"int"},{"av":"Z23WWPNotificationDefinitionId","type":"int"},{"av":"Z7WWPUserExtendedId","type":"char"},{"av":"Z26WWPSubscriptionEntityRecordId","type":"svchar"},{"av":"Z28WWPSubscriptionEntityRecordDescription","type":"svchar"},{"av":"Z19WWPSubscriptionRoleId","type":"char"},{"av":"Z27WWPSubscriptionSubscribed","type":"boolean"},{"av":"Z20WWPEntityId","type":"int"},{"av":"Z29WWPNotificationDefinitionDescription","type":"svchar"},{"av":"Z21WWPEntityName","type":"svchar"},{"av":"Z8WWPUserExtendedFullName","type":"svchar"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPNOTIFICATIONDEFINITIONID","""{"handler":"Valid_Wwpnotificationdefinitionid","iparms":[{"av":"A23WWPNotificationDefinitionId","fld":"WWPNOTIFICATIONDEFINITIONID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]""");
         setEventMetadata("VALID_WWPNOTIFICATIONDEFINITIONID",""","oparms":[{"av":"A20WWPEntityId","fld":"WWPENTITYID","pic":"ZZZZZZZZZ9","type":"int"},{"av":"A29WWPNotificationDefinitionDescription","fld":"WWPNOTIFICATIONDEFINITIONDESCRIPTION","type":"svchar"},{"av":"A21WWPEntityName","fld":"WWPENTITYNAME","type":"svchar"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPUSEREXTENDEDID","""{"handler":"Valid_Wwpuserextendedid","iparms":[{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"A8WWPUserExtendedFullName","fld":"WWPUSEREXTENDEDFULLNAME","type":"svchar"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]""");
         setEventMetadata("VALID_WWPUSEREXTENDEDID",""","oparms":[{"av":"A8WWPUserExtendedFullName","fld":"WWPUSEREXTENDEDFULLNAME","type":"svchar"},{"av":"A27WWPSubscriptionSubscribed","fld":"WWPSUBSCRIPTIONSUBSCRIBED","type":"boolean"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         T00047_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         ...
         T00047_A28WWPSubscriptionEntityRecordDescription = new string[] {""} ;
         ...
         T00044_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         T00046_A21WWPEntityName = new string[] {""} ;
         T00045_A8WWPUserExtendedFullName = new string[] {""} ;
         T00048_A20WWPEntityId = new long[1] ;
         T00048_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         ...
         T00043_A28WWPSubscriptionEntityRecordDescription = new string[] {""} ;
         ...
         T00042_A28WWPSubscriptionEntityRecordDescription = new string[] {""} ;
         ...
         T000418_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         ...
         ZZ28WWPSubscriptionEntityRecordDescription = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscription__default(),
            new Object[][] {
                new Object[] {
               T00042_A25WWPSubscriptionId, T00042_A26WWPSubscriptionEntityRecordId, T00042_A28WWPSubscriptionEntityRecordDescription, T00042_A19WWPSubscriptionRoleId, T00042_n19WWPSubscriptionRoleId, T00042_A27WWPSubscriptionSubscribed, T00042_A23WWPNotificationDefinitionId, T00042_A7WWPUserExtendedId, T00042_n7WWPUserExtendedId
               }
               , new Object[] {
               T00043_A25WWPSubscriptionId, T00043_A26WWPSubscriptionEntityRecordId, T00043_A28WWPSubscriptionEntityRecordDescription, T00043_A19WWPSubscriptionRoleId, T00043_n19WWPSubscriptionRoleId, T00043_A27WWPSubscriptionSubscribed, T00043_A23WWPNotificationDefinitionId, T00043_A7WWPUserExtendedId, T00043_n7WWPUserExtendedId
               }
               , new Object[] {
               T00044_A20WWPEntityId, T00044_A29WWPNotificationDefinitionDescription
               }
               , new Object[] {
               ...
               , new Object[] {
               T00047_A20WWPEntityId, T00047_A25WWPSubscriptionId, T00047_A29WWPNotificationDefinitionDescription, T00047_A21WWPEntityName, T00047_A8WWPUserExtendedFullName, T00047_A26WWPSubscriptionEntityRecordId, T00047_A28WWPSubscriptionEntityRecordDescription, T00047_A19WWPSubscriptionRoleId, T00047_n19WWPSubscriptionRoleId, T00047_A27WWPSubscriptionSubscribed,
               T00047_A23WWPNotificationDefinitionId, T00047_A7WWPUserExtendedId, T00047_n7WWPUserExtendedId
               }
               , new Object[] {
               T00048_A20WWPEntityId, T00048_A29WWPNotificationDefinitionDescription
               }
               , new Object[] {
               ...
               , new Object[] {
               T000418_A20WWPEntityId, T000418_A29WWPNotificationDefinitionDescription
               }
               , new Object[] {
      ...
      private string Z28WWPSubscriptionEntityRecordDescription ;
      ...
      private string A28WWPSubscriptionEntityRecordDescription ;
      ...
      private string ZZ28WWPSubscriptionEntityRecordDescription ;
      ...
      private string[] T00047_A29WWPNotificationDefinitionDescription ;
      ...
      private string[] T00047_A28WWPSubscriptionEntityRecordDescription ;
      ...
      private string[] T00044_A29WWPNotificationDefinitionDescription ;
      private string[] T00046_A21WWPEntityName ;
      private string[] T00045_A8WWPUserExtendedFullName ;
      private long[] T00048_A20WWPEntityId ;
      private string[] T00048_A29WWPNotificationDefinitionDescription ;
      ...
      private string[] T00043_A28WWPSubscriptionEntityRecordDescription ;
      ...
      private string[] T00042_A28WWPSubscriptionEntityRecordDescription ;
      ...
      private string[] T000418_A29WWPNotificationDefinitionDescription ;
   ...
   public class wwp_subscription__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("WWPSubscriptionEntityRecordDescription",GXType.VarChar,200,0) ,
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T00044", "SELECT WWPEntityId, WWPNotificationDefinitionDescription FROM WWP_NotificationDefinition WHERE WWPNotificationDefinitionId = :WWPNotificationDefinitionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00044,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T000414", "SAVEPOINT gxupdate;INSERT INTO WWP_Subscription(WWPSubscriptionEntityRecordId, WWPSubscriptionEntityRecordDescription, WWPSubscriptionRoleId, WWPSubscriptionSubscribed, WWPNotificationDefinitionId, WWPUserExtendedId) VALUES(:WWPSubscriptionEntityRecordId, :WWPSubscriptionEntityRecordDescription, :WWPSubscriptionRoleId, :WWPSubscriptionSubscribed, :WWPNotificationDefinitionId, :WWPUserExtendedId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT000414)
             ...
             ,new CursorDef("T000418", "SELECT WWPEntityId, WWPNotificationDefinitionDescription FROM WWP_NotificationDefinition WHERE WWPNotificationDefinitionId = :WWPNotificationDefinitionId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000418,1, GxCacheFrequency.OFF ,true,false )
