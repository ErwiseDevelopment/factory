   ...
   public class wwp_notificationdefinition_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void ZM088( short GX_JID )
      {
         if ( ( GX_JID == 4 ) || ( GX_JID == 0 ) )
         {
            ...
            Z68WWPNotificationDefinitionIsAuthorized = A68WWPNotificationDefinitionIsAuthorized;
         }
      ...
      protected void Load088( )
      {
         ...
         if ( (pr_default.getStatus(3) != 101) )
         {
            ...
            A30WWPNotificationDefinitionAppliesTo = BC00085_A30WWPNotificationDefinitionAppliesTo[0];
            A31WWPNotificationDefinitionAllowUserSubscription = BC00085_A31WWPNotificationDefinitionAllowUserSubscription[0];
            A29WWPNotificationDefinitionDescription = BC00085_A29WWPNotificationDefinitionDescription[0];
            ...
            A64WWPNotificationDefinitionShortDescription = BC00085_A64WWPNotificationDefinitionShortDescription[0];
            A65WWPNotificationDefinitionLongDescription = BC00085_A65WWPNotificationDefinitionLongDescription[0];
            A66WWPNotificationDefinitionLink = BC00085_A66WWPNotificationDefinitionLink[0];
            A21WWPEntityName = BC00085_A21WWPEntityName[0];
            A67WWPNotificationDefinitionSecFuncionality = BC00085_A67WWPNotificationDefinitionSecFuncionality[0];
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A30WWPNotificationDefinitionAppliesTo = BC00083_A30WWPNotificationDefinitionAppliesTo[0];
            A31WWPNotificationDefinitionAllowUserSubscription = BC00083_A31WWPNotificationDefinitionAllowUserSubscription[0];
            A29WWPNotificationDefinitionDescription = BC00083_A29WWPNotificationDefinitionDescription[0];
            ...
            A64WWPNotificationDefinitionShortDescription = BC00083_A64WWPNotificationDefinitionShortDescription[0];
            A65WWPNotificationDefinitionLongDescription = BC00083_A65WWPNotificationDefinitionLongDescription[0];
            A66WWPNotificationDefinitionLink = BC00083_A66WWPNotificationDefinitionLink[0];
            A67WWPNotificationDefinitionSecFuncionality = BC00083_A67WWPNotificationDefinitionSecFuncionality[0];
      ...
      protected void CheckOptimisticConcurrency088( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z59WWPNotificationDefinitionName, BC00082_A59WWPNotificationDefinitionName[0]) != 0 ) || ( Z30WWPNotificationDefinitionAppliesTo != BC00082_A30WWPNotificationDefinitionAppliesTo[0] ) || ( Z31WWPNotificationDefinitionAllowUserSubscription != BC00082_A31WWPNotificationDefinitionAllowUserSubscription[0] ) || ( StringUtil.StrCmp(Z29WWPNotificationDefinitionDescription, BC00082_A29WWPNotificationDefinitionDescription[0]) != 0 ) || ( StringUtil.StrCmp(Z62WWPNotificationDefinitionIcon, BC00082_A62WWPNotificationDefinitionIcon[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( StringUtil.StrCmp(Z63WWPNotificationDefinitionTitle, BC00082_A63WWPNotificationDefinitionTitle[0]) != 0 ) || ( StringUtil.StrCmp(Z64WWPNotificationDefinitionShortDescription, BC00082_A64WWPNotificationDefinitionShortDescription[0]) != 0 ) || ( StringUtil.StrCmp(Z65WWPNotificationDefinitionLongDescription, BC00082_A65WWPNotificationDefinitionLongDescription[0]) != 0 ) || ( StringUtil.StrCmp(Z66WWPNotificationDefinitionLink, BC00082_A66WWPNotificationDefinitionLink[0]) != 0 ) || ( StringUtil.StrCmp(Z67WWPNotificationDefinitionSecFuncionality, BC00082_A67WWPNotificationDefinitionSecFuncionality[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(5, new Object[] {A59WWPNotificationDefinitionName, A30WWPNotificationDefinitionAppliesTo, A31WWPNotificationDefinitionAllowUserSubscription, A29WWPNotificationDefinitionDescription, A62WWPNotificationDefinitionIcon, A63WWPNotificationDefinitionTitle, A64WWPNotificationDefinitionShortDescription, A65WWPNotificationDefinitionLongDescription, A66WWPNotificationDefinitionLink, A67WWPNotificationDefinitionSecFuncionality, A20WWPEntityId});
                     pr_default.close(5);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(7, new Object[] {A59WWPNotificationDefinitionName, A30WWPNotificationDefinitionAppliesTo, A31WWPNotificationDefinitionAllowUserSubscription, A29WWPNotificationDefinitionDescription, A62WWPNotificationDefinitionIcon, A63WWPNotificationDefinitionTitle, A64WWPNotificationDefinitionShortDescription, A65WWPNotificationDefinitionLongDescription, A66WWPNotificationDefinitionLink, A67WWPNotificationDefinitionSecFuncionality, A20WWPEntityId, A23WWPNotificationDefinitionId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("WWP_NotificationDefinition");
      ...
      public void ScanKeyStart088( )
      {
         ...
         if ( (pr_default.getStatus(12) != 101) )
         {
            ...
            A30WWPNotificationDefinitionAppliesTo = BC000814_A30WWPNotificationDefinitionAppliesTo[0];
            A31WWPNotificationDefinitionAllowUserSubscription = BC000814_A31WWPNotificationDefinitionAllowUserSubscription[0];
            A29WWPNotificationDefinitionDescription = BC000814_A29WWPNotificationDefinitionDescription[0];
            ...
            A64WWPNotificationDefinitionShortDescription = BC000814_A64WWPNotificationDefinitionShortDescription[0];
            A65WWPNotificationDefinitionLongDescription = BC000814_A65WWPNotificationDefinitionLongDescription[0];
            A66WWPNotificationDefinitionLink = BC000814_A66WWPNotificationDefinitionLink[0];
            A21WWPEntityName = BC000814_A21WWPEntityName[0];
            A67WWPNotificationDefinitionSecFuncionality = BC000814_A67WWPNotificationDefinitionSecFuncionality[0];
      ...
      public void VarsToRow8( GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_NotificationDefinition obj8 )
      {
         ...
         obj8.gxTpr_Wwpnotificationdefinitionisauthorized = A68WWPNotificationDefinitionIsAuthorized;
         obj8.gxTpr_Wwpnotificationdefinitionname = A59WWPNotificationDefinitionName;
         obj8.gxTpr_Wwpnotificationdefinitionappliesto = A30WWPNotificationDefinitionAppliesTo;
         obj8.gxTpr_Wwpnotificationdefinitionallowusersubscription = A31WWPNotificationDefinitionAllowUserSubscription;
         obj8.gxTpr_Wwpnotificationdefinitiondescription = A29WWPNotificationDefinitionDescription;
         ...
         obj8.gxTpr_Wwpnotificationdefinitionshortdescription = A64WWPNotificationDefinitionShortDescription;
         obj8.gxTpr_Wwpnotificationdefinitionlongdescription = A65WWPNotificationDefinitionLongDescription;
         ...
         obj8.gxTpr_Wwpnotificationdefinitionsecfuncionality = A67WWPNotificationDefinitionSecFuncionality;
         ...
         obj8.gxTpr_Wwpnotificationdefinitionappliesto_Z = Z30WWPNotificationDefinitionAppliesTo;
         obj8.gxTpr_Wwpnotificationdefinitionallowusersubscription_Z = Z31WWPNotificationDefinitionAllowUserSubscription;
         obj8.gxTpr_Wwpnotificationdefinitiondescription_Z = Z29WWPNotificationDefinitionDescription;
         ...
         obj8.gxTpr_Wwpnotificationdefinitionshortdescription_Z = Z64WWPNotificationDefinitionShortDescription;
         obj8.gxTpr_Wwpnotificationdefinitionlongdescription_Z = Z65WWPNotificationDefinitionLongDescription;
         ...
         obj8.gxTpr_Wwpnotificationdefinitionsecfuncionality_Z = Z67WWPNotificationDefinitionSecFuncionality;
         obj8.gxTpr_Wwpnotificationdefinitionisauthorized_Z = Z68WWPNotificationDefinitionIsAuthorized;
         obj8.gxTpr_Mode = Gx_mode;
         return  ;
      }
                              ...
                              int forceLoad )
      {
         ...
         A68WWPNotificationDefinitionIsAuthorized = obj8.gxTpr_Wwpnotificationdefinitionisauthorized;
         A59WWPNotificationDefinitionName = obj8.gxTpr_Wwpnotificationdefinitionname;
         A30WWPNotificationDefinitionAppliesTo = obj8.gxTpr_Wwpnotificationdefinitionappliesto;
         A31WWPNotificationDefinitionAllowUserSubscription = obj8.gxTpr_Wwpnotificationdefinitionallowusersubscription;
         A29WWPNotificationDefinitionDescription = obj8.gxTpr_Wwpnotificationdefinitiondescription;
         ...
         A64WWPNotificationDefinitionShortDescription = obj8.gxTpr_Wwpnotificationdefinitionshortdescription;
         A65WWPNotificationDefinitionLongDescription = obj8.gxTpr_Wwpnotificationdefinitionlongdescription;
         ...
         A67WWPNotificationDefinitionSecFuncionality = obj8.gxTpr_Wwpnotificationdefinitionsecfuncionality;
         ...
         Z30WWPNotificationDefinitionAppliesTo = obj8.gxTpr_Wwpnotificationdefinitionappliesto_Z;
         Z31WWPNotificationDefinitionAllowUserSubscription = obj8.gxTpr_Wwpnotificationdefinitionallowusersubscription_Z;
         Z29WWPNotificationDefinitionDescription = obj8.gxTpr_Wwpnotificationdefinitiondescription_Z;
         ...
         Z64WWPNotificationDefinitionShortDescription = obj8.gxTpr_Wwpnotificationdefinitionshortdescription_Z;
         Z65WWPNotificationDefinitionLongDescription = obj8.gxTpr_Wwpnotificationdefinitionlongdescription_Z;
         ...
         Z67WWPNotificationDefinitionSecFuncionality = obj8.gxTpr_Wwpnotificationdefinitionsecfuncionality_Z;
         Z68WWPNotificationDefinitionIsAuthorized = obj8.gxTpr_Wwpnotificationdefinitionisauthorized_Z;
         Gx_mode = obj8.gxTpr_Mode;
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         BC00085_A30WWPNotificationDefinitionAppliesTo = new short[1] ;
         BC00085_A31WWPNotificationDefinitionAllowUserSubscription = new bool[] {false} ;
         BC00085_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         BC00085_A62WWPNotificationDefinitionIcon = new string[] {""} ;
         BC00085_A63WWPNotificationDefinitionTitle = new string[] {""} ;
         BC00085_A64WWPNotificationDefinitionShortDescription = new string[] {""} ;
         BC00085_A65WWPNotificationDefinitionLongDescription = new string[] {""} ;
         BC00085_A66WWPNotificationDefinitionLink = new string[] {""} ;
         BC00085_A21WWPEntityName = new string[] {""} ;
         BC00085_A67WWPNotificationDefinitionSecFuncionality = new string[] {""} ;
         ...
         BC00083_A30WWPNotificationDefinitionAppliesTo = new short[1] ;
         BC00083_A31WWPNotificationDefinitionAllowUserSubscription = new bool[] {false} ;
         BC00083_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         BC00083_A62WWPNotificationDefinitionIcon = new string[] {""} ;
         BC00083_A63WWPNotificationDefinitionTitle = new string[] {""} ;
         BC00083_A64WWPNotificationDefinitionShortDescription = new string[] {""} ;
         BC00083_A65WWPNotificationDefinitionLongDescription = new string[] {""} ;
         BC00083_A66WWPNotificationDefinitionLink = new string[] {""} ;
         BC00083_A67WWPNotificationDefinitionSecFuncionality = new string[] {""} ;
         ...
         BC00082_A30WWPNotificationDefinitionAppliesTo = new short[1] ;
         BC00082_A31WWPNotificationDefinitionAllowUserSubscription = new bool[] {false} ;
         BC00082_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         BC00082_A62WWPNotificationDefinitionIcon = new string[] {""} ;
         BC00082_A63WWPNotificationDefinitionTitle = new string[] {""} ;
         BC00082_A64WWPNotificationDefinitionShortDescription = new string[] {""} ;
         BC00082_A65WWPNotificationDefinitionLongDescription = new string[] {""} ;
         BC00082_A66WWPNotificationDefinitionLink = new string[] {""} ;
         BC00082_A67WWPNotificationDefinitionSecFuncionality = new string[] {""} ;
         ...
         BC000814_A30WWPNotificationDefinitionAppliesTo = new short[1] ;
         BC000814_A31WWPNotificationDefinitionAllowUserSubscription = new bool[] {false} ;
         BC000814_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         BC000814_A62WWPNotificationDefinitionIcon = new string[] {""} ;
         BC000814_A63WWPNotificationDefinitionTitle = new string[] {""} ;
         BC000814_A64WWPNotificationDefinitionShortDescription = new string[] {""} ;
         BC000814_A65WWPNotificationDefinitionLongDescription = new string[] {""} ;
         BC000814_A66WWPNotificationDefinitionLink = new string[] {""} ;
         BC000814_A21WWPEntityName = new string[] {""} ;
         BC000814_A67WWPNotificationDefinitionSecFuncionality = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.notifications.common.wwp_notificationdefinition_bc__default(),
            new Object[][] {
                new Object[] {
               BC00082_A23WWPNotificationDefinitionId, BC00082_A59WWPNotificationDefinitionName, BC00082_A30WWPNotificationDefinitionAppliesTo, BC00082_A31WWPNotificationDefinitionAllowUserSubscription, BC00082_A29WWPNotificationDefinitionDescription, BC00082_A62WWPNotificationDefinitionIcon, BC00082_A63WWPNotificationDefinitionTitle, BC00082_A64WWPNotificationDefinitionShortDescription, BC00082_A65WWPNotificationDefinitionLongDescription, BC00082_A66WWPNotificationDefinitionLink,
               BC00082_A67WWPNotificationDefinitionSecFuncionality, BC00082_A20WWPEntityId
               }
               , new Object[] {
               BC00083_A23WWPNotificationDefinitionId, BC00083_A59WWPNotificationDefinitionName, BC00083_A30WWPNotificationDefinitionAppliesTo, BC00083_A31WWPNotificationDefinitionAllowUserSubscription, BC00083_A29WWPNotificationDefinitionDescription, BC00083_A62WWPNotificationDefinitionIcon, BC00083_A63WWPNotificationDefinitionTitle, BC00083_A64WWPNotificationDefinitionShortDescription, BC00083_A65WWPNotificationDefinitionLongDescription, BC00083_A66WWPNotificationDefinitionLink,
               BC00083_A67WWPNotificationDefinitionSecFuncionality, BC00083_A20WWPEntityId
               }
               , new Object[] {
               BC00084_A21WWPEntityName
               }
               , new Object[] {
               BC00085_A23WWPNotificationDefinitionId, BC00085_A59WWPNotificationDefinitionName, BC00085_A30WWPNotificationDefinitionAppliesTo, BC00085_A31WWPNotificationDefinitionAllowUserSubscription, BC00085_A29WWPNotificationDefinitionDescription, BC00085_A62WWPNotificationDefinitionIcon, BC00085_A63WWPNotificationDefinitionTitle, BC00085_A64WWPNotificationDefinitionShortDescription, BC00085_A65WWPNotificationDefinitionLongDescription, BC00085_A66WWPNotificationDefinitionLink,
               BC00085_A21WWPEntityName, BC00085_A67WWPNotificationDefinitionSecFuncionality, BC00085_A20WWPEntityId
               }
               , new Object[] {
               ...
               , new Object[] {
               BC000814_A23WWPNotificationDefinitionId, BC000814_A59WWPNotificationDefinitionName, BC000814_A30WWPNotificationDefinitionAppliesTo, BC000814_A31WWPNotificationDefinitionAllowUserSubscription, BC000814_A29WWPNotificationDefinitionDescription, BC000814_A62WWPNotificationDefinitionIcon, BC000814_A63WWPNotificationDefinitionTitle, BC000814_A64WWPNotificationDefinitionShortDescription, BC000814_A65WWPNotificationDefinitionLongDescription, BC000814_A66WWPNotificationDefinitionLink,
               BC000814_A21WWPEntityName, BC000814_A67WWPNotificationDefinitionSecFuncionality, BC000814_A20WWPEntityId
               }
            }
         );
         INITTRN();
      ...
      private short[] BC00085_A30WWPNotificationDefinitionAppliesTo ;
      private bool[] BC00085_A31WWPNotificationDefinitionAllowUserSubscription ;
      private string[] BC00085_A29WWPNotificationDefinitionDescription ;
      private string[] BC00085_A62WWPNotificationDefinitionIcon ;
      private string[] BC00085_A63WWPNotificationDefinitionTitle ;
      private string[] BC00085_A64WWPNotificationDefinitionShortDescription ;
      private string[] BC00085_A65WWPNotificationDefinitionLongDescription ;
      private string[] BC00085_A66WWPNotificationDefinitionLink ;
      private string[] BC00085_A21WWPEntityName ;
      private string[] BC00085_A67WWPNotificationDefinitionSecFuncionality ;
      ...
      private short[] BC00083_A30WWPNotificationDefinitionAppliesTo ;
      private bool[] BC00083_A31WWPNotificationDefinitionAllowUserSubscription ;
      private string[] BC00083_A29WWPNotificationDefinitionDescription ;
      private string[] BC00083_A62WWPNotificationDefinitionIcon ;
      private string[] BC00083_A63WWPNotificationDefinitionTitle ;
      private string[] BC00083_A64WWPNotificationDefinitionShortDescription ;
      private string[] BC00083_A65WWPNotificationDefinitionLongDescription ;
      private string[] BC00083_A66WWPNotificationDefinitionLink ;
      private string[] BC00083_A67WWPNotificationDefinitionSecFuncionality ;
      ...
      private short[] BC00082_A30WWPNotificationDefinitionAppliesTo ;
      private bool[] BC00082_A31WWPNotificationDefinitionAllowUserSubscription ;
      private string[] BC00082_A29WWPNotificationDefinitionDescription ;
      private string[] BC00082_A62WWPNotificationDefinitionIcon ;
      private string[] BC00082_A63WWPNotificationDefinitionTitle ;
      private string[] BC00082_A64WWPNotificationDefinitionShortDescription ;
      private string[] BC00082_A65WWPNotificationDefinitionLongDescription ;
      private string[] BC00082_A66WWPNotificationDefinitionLink ;
      private string[] BC00082_A67WWPNotificationDefinitionSecFuncionality ;
      ...
      private short[] BC000814_A30WWPNotificationDefinitionAppliesTo ;
      private bool[] BC000814_A31WWPNotificationDefinitionAllowUserSubscription ;
      private string[] BC000814_A29WWPNotificationDefinitionDescription ;
      private string[] BC000814_A62WWPNotificationDefinitionIcon ;
      private string[] BC000814_A63WWPNotificationDefinitionTitle ;
      private string[] BC000814_A64WWPNotificationDefinitionShortDescription ;
      private string[] BC000814_A65WWPNotificationDefinitionLongDescription ;
      private string[] BC000814_A66WWPNotificationDefinitionLink ;
      private string[] BC000814_A21WWPEntityName ;
      private string[] BC000814_A67WWPNotificationDefinitionSecFuncionality ;
   ...
   public class wwp_notificationdefinition_bc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("BC00082", "SELECT WWPNotificationDefinitionId, WWPNotificationDefinitionName, WWPNotificationDefinitionAppliesTo, WWPNotificationDefinitionAllowUserSubscription, WWPNotificationDefinitionDescription, WWPNotificationDefinitionIcon, WWPNotificationDefinitionTitle, WWPNotificationDefinitionShortDescription, WWPNotificationDefinitionLongDescription, WWPNotificationDefinitionLink, WWPNotificationDefinitionSecFuncionality, WWPEntityId FROM WWP_NotificationDefinition WHERE WWPNotificationDefinitionId = :WWPNotificationDefinitionId  FOR UPDATE OF WWP_NotificationDefinition",true, GxErrorMask.GX_NOMASK, false, this,prmBC00082,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("BC00083", "SELECT WWPNotificationDefinitionId, WWPNotificationDefinitionName, WWPNotificationDefinitionAppliesTo, WWPNotificationDefinitionAllowUserSubscription, WWPNotificationDefinitionDescription, WWPNotificationDefinitionIcon, WWPNotificationDefinitionTitle, WWPNotificationDefinitionShortDescription, WWPNotificationDefinitionLongDescription, WWPNotificationDefinitionLink, WWPNotificationDefinitionSecFuncionality, WWPEntityId FROM WWP_NotificationDefinition WHERE WWPNotificationDefinitionId = :WWPNotificationDefinitionId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC00083,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("BC00089", "SAVEPOINT gxupdate;UPDATE WWP_NotificationDefinition SET WWPNotificationDefinitionName=:WWPNotificationDefinitionName, WWPNotificationDefinitionAppliesTo=:WWPNotificationDefinitionAppliesTo, WWPNotificationDefinitionAllowUserSubscription=:WWPNotificationDefinitionAllowUserSubscription, WWPNotificationDefinitionDescription=:WWPNotificationDefinitionDescription, WWPNotificationDefinitionIcon=:WWPNotificationDefinitionIcon, WWPNotificationDefinitionTitle=:WWPNotificationDefinitionTitle, WWPNotificationDefinitionShortDescription=:WWPNotificationDefinitionShortDescription, WWPNotificationDefinitionLongDescription=:WWPNotificationDefinitionLongDescription, WWPNotificationDefinitionLink=:WWPNotificationDefinitionLink, WWPNotificationDefinitionSecFuncionality=:WWPNotificationDefinitionSecFuncionality, WWPEntityId=:WWPEntityId  WHERE WWPNotificationDefinitionId = :WWPNotificationDefinitionId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmBC00089)
