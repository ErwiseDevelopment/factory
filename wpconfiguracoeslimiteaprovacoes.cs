...
namespace GeneXus.Programs {
   public class wpconfiguracoeslimiteaprovacoes : GXDataArea
   {
      public wpconfiguracoeslimiteaprovacoes( )
      {
      ...
      public wpconfiguracoeslimiteaprovacoes( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpconfiguracoeslimiteaprovacoes") +"\">") ;
      ...
      {
         return formatLink("wpconfiguracoeslimiteaprovacoes")  ;
      }

      public override string GetPgmname( )
      {
         return "WpConfiguracoesLimiteAprovacoes" ;
      }

      public override string GetPgmdesc( )
      {
         return "Limite aprovações" ;
      }
      ...
      protected void WB8E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLimiteaprovacoes_title_Internalname, "Limite aprovações", "", "", lblLimiteaprovacoes_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WpConfiguracoesLimiteAprovacoes.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "LimiteAprovacoes") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0020"+"", StringUtil.RTrim( WebComp_Webcomponent1_Component));
               context.WriteHtmlText( "<div") ;
      ...
      protected void START8E2( )
      {
         ...
         Form.Meta.addItem("description", "Limite aprovações", 0) ;
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 20 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Webcomponent1_Component) != 0 )
                           {
                              WebComp_Webcomponent1.componentprocess("W0020", "", sEvt);
                           }
                           WebComp_Webcomponent1_Component = OldWebcomponent1;
                        }
                     }
      ...
      protected void E118E2( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent1_Component), StringUtil.Lower( "LimiteAprovacaoWW")) != 0 )
         {
            WebComp_Webcomponent1 = getWebComponent(GetType(), "GeneXus.Programs", "limiteaprovacaoww", new Object[] {context} );
            WebComp_Webcomponent1.ComponentInit();
            WebComp_Webcomponent1.Name = "LimiteAprovacaoWW";
            WebComp_Webcomponent1_Component = "LimiteAprovacaoWW";
         }
         if ( StringUtil.Len( WebComp_Webcomponent1_Component) != 0 )
         {
            WebComp_Webcomponent1.setjustcreated();
            WebComp_Webcomponent1.componentprepare(new Object[] {(string)"W0020",(string)""});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019272866", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpconfiguracoeslimiteaprovacoes.js", "?202561019272866", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         lblLimiteaprovacoes_title_Internalname = "LIMITEAPROVACOES_TITLE";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Limite aprovações";
      ...
      public override void initialize( )
      {
         ...
         lblLimiteaprovacoes_title_Jsonclick = "";
      ...
      private string lblLimiteaprovacoes_title_Internalname ;
      private string lblLimiteaprovacoes_title_Jsonclick ;
