...
namespace GeneXus.Programs.wwpbaseobjects {
   public class masterpagepfpj : GXMasterPage
   {
      public masterpagepfpj( )
      {
      ...
      public masterpagepfpj( IGxContext context )
      {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", true, "vWWPCONTEXT_MPAGE", AV39WWpContext);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vWWPCONTEXT_MPAGE", AV39WWpContext);
         }
      ...
      protected void RenderHtmlCloseForm8W2( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/masterpagepfpj.js", "?202551918583619", false, true);
      ...
      {
         return "WWPBaseObjects.MasterPagePFPJ" ;
      }
      ...
      protected void WB8W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgImageheader_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWPBaseObjects/MasterPagePFPJ.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblShowmenu_Internalname, "<i class=\"fa fa-bars ImageMenuIcon\"></i>", "", "", lblShowmenu_Jsonclick, "'"+""+"'"+",true,"+"'"+"e118w1_client"+"'", "", "TextBlock", 7, "", 1, 1, 0, 1, "HLP_WWPBaseObjects/MasterPagePFPJ.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocktitle_Internalname, lblTextblocktitle_Caption, "", "", lblTextblocktitle_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlockTitleMaster", 0, "", 1, 1, 0, 0, "HLP_WWPBaseObjects/MasterPagePFPJ.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavPickerdummyvariable_Internalname, context.localUtil.Format(AV32PickerDummyVariable, "99/99/99"), context.localUtil.Format( AV32PickerDummyVariable, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'por',false,0);"+";gx.evt.onblur(this,60);\"", "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "", "", "", edtavPickerdummyvariable_Jsonclick, 0, "Invisible", "", "", "", "", 1, 1, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WWPBaseObjects/MasterPagePFPJ.htm");
            GxWebStd.gx_bitmap( context, edtavPickerdummyvariable_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WWPBaseObjects/MasterPagePFPJ.htm");
            context.WriteHtmlTextNl( "</div>") ;
            wb_table1_61_8W2( true) ;
         }
         else
         {
            wb_table1_61_8W2( false) ;
         }
         return  ;
      }

      protected void wb_table1_61_8W2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "MPW0067"+"", StringUtil.RTrim( WebComp_Wwpaux_wc_Component));
               context.WriteHtmlText( "<div") ;
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  else if ( StringUtil.StrCmp(sEvtType, "M") == 0 )
                  {
                     ...
                     if ( nCmpId == 67 )
                     {
                        ...
                        if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
                        {
                           WebComp_Wwpaux_wc.componentprocess("MPW0067", "", sEvt);
                        }
                        WebComp_Wwpaux_wc_Component = OldWwpaux_wc;
                     }
                  }
      ...
      protected void E178W2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.menuoptionsdatapfpj(context ).execute( out  GXt_objcol_SdtDVelop_Menu_Item2) ;
         AV26DVelop_Menu = GXt_objcol_SdtDVelop_Menu_Item2;
         AV42InDVelop_Menu.FromJSonString(AV26DVelop_Menu.ToJSonString(false), null);
         AV26DVelop_Menu = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item>( context, "Item", "Factory2");
         new pfuncmenu(context ).execute(  AV42InDVelop_Menu, ref  AV26DVelop_Menu) ;
         AV44IsNotAccess = true;
         AV46GXV1 = 1;
         while ( AV46GXV1 <= AV26DVelop_Menu.Count )
         {
            AV43DVelop_MenuItem = ((GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item)AV26DVelop_Menu.Item(AV46GXV1));
            if ( StringUtil.StrCmp(AV43DVelop_MenuItem.gxTpr_Authorizationkey, "") != 0 )
            {
               AV44IsNotAccess = false;
            }
            AV46GXV1 = (int)(AV46GXV1+1);
         }
         if ( AV44IsNotAccess && ! (0==AV39WWpContext.gxTpr_Userid) )
         {
      ...
      protected void E168W2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"MPW0067",(string)"",AV31Httprequest.BaseURL+AV31Httprequest.ScriptName+(String.IsNullOrEmpty(StringUtil.RTrim( StringUtil.Trim( AV31Httprequest.QueryString))) ? "" : "?"+AV31Httprequest.QueryString),(string)AV13ProgramDescription});
      ...
      protected void E138W2( )
      {
         ...
         {
            WebComp_Wwpaux_wc.setjustcreated();
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"MPW0067",(string)""});
      ...
      protected void E208W2( )
      {
         ...
         if (returnInSub) return;
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", true, "AV39WWpContext", AV39WWpContext);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV16NotificationsCount = 0;
         /* Using cursor H008W3 */
         pr_default.execute(1, new Object[] {AV39WWpContext.gxTpr_Userid});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A381NotificationId = H008W3_A381NotificationId[0];
            n381NotificationId = H008W3_n381NotificationId[0];
            A384NotificationType = H008W3_A384NotificationType[0];
            n384NotificationType = H008W3_n384NotificationType[0];
            A389UserNotificationStatus = H008W3_A389UserNotificationStatus[0];
            n389UserNotificationStatus = H008W3_n389UserNotificationStatus[0];
            A388UserNotificationUserId = H008W3_A388UserNotificationUserId[0];
            n388UserNotificationUserId = H008W3_n388UserNotificationUserId[0];
            A387UserNotificationId = H008W3_A387UserNotificationId[0];
            A384NotificationType = H008W3_A384NotificationType[0];
            n384NotificationType = H008W3_n384NotificationType[0];
            AV41UserNotificationId = A387UserNotificationId;
            AV16NotificationsCount = (short)(AV16NotificationsCount+1);
            pr_default.readNext(1);
         }
         pr_default.close(1);
         this.executeUsercontrolMethod("", true, "DDC_NOTIFICATIONSWC_MPAGEContainer", "Update", "", new Object[] {((AV16NotificationsCount>0) ? StringUtil.Trim( StringUtil.Str( (decimal)(AV16NotificationsCount), 4, 0)) : ""),(string)Ddc_notificationswc_Icon});
      }
      ...
      protected void S132( )
      {
         ...
         AV48GXV2 = 1;
         while ( AV48GXV2 <= AV10GridStateCollection.Count )
         {
            AV11GridStateCollectionItem = ((GeneXus.Programs.wwpbaseobjects.SdtGridStateCollection_Item)AV10GridStateCollection.Item(AV48GXV2));
         ...
         if ( AV10GridStateCollection.Count > 0 )
         {
            ...
            AV7BookmarksData.Add(AV8BookmarksDataItem, 0);
            AV49GXV3 = 1;
            while ( AV49GXV3 <= AV10GridStateCollection.Count )
            {
               AV11GridStateCollectionItem = ((GeneXus.Programs.wwpbaseobjects.SdtGridStateCollection_Item)AV10GridStateCollection.Item(AV49GXV3));
               AV8BookmarksDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
      ...
      protected void E248W2( )
      {
         /* Load Routine */
         returnInSub = false;
      }

      protected void wb_table1_61_8W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_61_8W2e( true) ;
         }
         else
         {
            wb_table1_61_8W2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202551918584233", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/masterpagepfpj.js", "?202551918584234", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH_MPAGE",""","oparms":[{"av":"AV39WWpContext","fld":"vWWPCONTEXT_MPAGE","type":""},{"av":"lblTextblocktitle_Caption","ctrl":"TEXTBLOCKTITLE_MPAGE","prop":"Caption"},{"av":"AV27Breadcrumb","fld":"vBREADCRUMB_MPAGE","hsh":true,"type":"svchar"},{"av":"AV7BookmarksData","fld":"vBOOKMARKSDATA_MPAGE","type":""},{"av":"AV13ProgramDescription","fld":"vPROGRAMDESCRIPTION_MPAGE","hsh":true,"type":"svchar"},{"av":"AV12IndexToAddItems","fld":"vINDEXTOADDITEMS_MPAGE","pic":"ZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("DDO_BOOKMARKS_MPAGE.ONOPTIONCLICKED_MPAGE","""{"handler":"E128W2","iparms":[{"av":"Ddo_bookmarks_Activeeventkey","ctrl":"DDO_BOOKMARKS_MPAGE","prop":"ActiveEventKey"}]}""");
         setEventMetadata("BOOKMARK_MODAL_MPAGE.ONLOADCOMPONENT_MPAGE","""{"handler":"E168W2","iparms":[{"av":"AV31Httprequest.BaseURL","ctrl":"vHTTPREQUEST_MPAGE","prop":"Baseurl"},{"av":"AV13ProgramDescription","fld":"vPROGRAMDESCRIPTION_MPAGE","hsh":true,"type":"svchar"}]""");
         setEventMetadata("BOOKMARK_MODAL_MPAGE.ONLOADCOMPONENT_MPAGE",""","oparms":[{"ctrl":"WWPAUX_WC_MPAGE"}]}""");
         setEventMetadata("BOOKMARK_MODAL_MPAGE.CLOSE_MPAGE","""{"handler":"E158W2","iparms":[]}""");
         setEventMetadata("DDC_NOTIFICATIONSWC_MPAGE.ONLOADCOMPONENT_MPAGE","""{"handler":"E138W2","iparms":[]""");
         setEventMetadata("DDC_NOTIFICATIONSWC_MPAGE.ONLOADCOMPONENT_MPAGE",""","oparms":[{"ctrl":"WWPAUX_WC_MPAGE"}]}""");
         setEventMetadata("DDC_ADMINAG_MPAGE.ONLOADCOMPONENT_MPAGE","""{"handler":"E148W2","iparms":[]""");
         setEventMetadata("DDC_ADMINAG_MPAGE.ONLOADCOMPONENT_MPAGE",""","oparms":[{"ctrl":"WWPAUX_WC_MPAGE"}]}""");
         setEventMetadata("DOSHOWMENU_MPAGE","""{"handler":"E118W1","iparms":[]}""");
         setEventMetadata("DOACTIONSEARCH_MPAGE","""{"handler":"E188W2","iparms":[{"av":"AV18SearchAux","fld":"vSEARCHAUX_MPAGE","hsh":true,"type":"svchar"}]}""");
         setEventMetadata("GLOBALEVENTS_MPAGE.MASTER_REFRESHHEADER_MPAGE","""{"handler":"E218W2","iparms":[]}""");
         setEventMetadata("GLOBALEVENTS_MPAGE.MASTER_CHANGEIMAGE_MPAGE","""{"handler":"E228W2","iparms":[{"av":"AV38Source","fld":"vSOURCE_MPAGE","type":"svchar"}]}""");
         setEventMetadata("GLOBALEVENTS_MPAGE.MASTER_REFRESHNOTIFICATIONS_MPAGE","""{"handler":"E238W2","iparms":[{"av":"A388UserNotificationUserId","fld":"USERNOTIFICATIONUSERID_MPAGE","pic":"ZZZ9","type":"int"},{"av":"AV39WWpContext","fld":"vWWPCONTEXT_MPAGE","type":""},{"av":"A389UserNotificationStatus","fld":"USERNOTIFICATIONSTATUS_MPAGE","type":"svchar"},{"av":"A384NotificationType","fld":"NOTIFICATIONTYPE_MPAGE","type":"svchar"},{"av":"A387UserNotificationId","fld":"USERNOTIFICATIONID_MPAGE","pic":"ZZZZZZZZ9","type":"int"},{"av":"Ddc_notificationswc_Icon","ctrl":"DDC_NOTIFICATIONSWC_MPAGE","prop":"Icon"}]}""");
         setEventMetadata("ONMESSAGE_GX1_MPAGE","""{"handler":"E198W2","iparms":[{"av":"AV15NotificationInfo","fld":"vNOTIFICATIONINFO_MPAGE","type":""},{"av":"A388UserNotificationUserId","fld":"USERNOTIFICATIONUSERID_MPAGE","pic":"ZZZ9","type":"int"},{"av":"AV39WWpContext","fld":"vWWPCONTEXT_MPAGE","type":""},{"av":"A389UserNotificationStatus","fld":"USERNOTIFICATIONSTATUS_MPAGE","type":"svchar"},{"av":"A384NotificationType","fld":"NOTIFICATIONTYPE_MPAGE","type":"svchar"},{"av":"A387UserNotificationId","fld":"USERNOTIFICATIONID_MPAGE","pic":"ZZZZZZZZ9","type":"int"},{"av":"Ddc_notificationswc_Icon","ctrl":"DDC_NOTIFICATIONSWC_MPAGE","prop":"Icon"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GX_FocusControl = "";
         H008W2_A299ConfiguracoesId = new int[1] ;
         AV35Configuracoes = new SdtConfiguracoes(context);
         GXt_objcol_SdtDVelop_Menu_Item2 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item>( context, "Item", "Factory2");
         AV42InDVelop_Menu = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item>( context, "Item", "Factory2");
         AV43DVelop_MenuItem = new GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item(context);
         AV8BookmarksDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
         ...
         H008W3_A381NotificationId = new int[1] ;
         H008W3_n381NotificationId = new bool[] {false} ;
         H008W3_A384NotificationType = new string[] {""} ;
         H008W3_n384NotificationType = new bool[] {false} ;
         H008W3_A389UserNotificationStatus = new string[] {""} ;
         H008W3_n389UserNotificationStatus = new bool[] {false} ;
         H008W3_A388UserNotificationUserId = new short[1] ;
         H008W3_n388UserNotificationUserId = new bool[] {false} ;
         H008W3_A387UserNotificationId = new int[1] ;
         AV9CurrentURL = "";
         ...
         sDynURL = "";
         Form = new GXWebForm();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.masterpagepfpj__default(),
            new Object[][] {
                new Object[] {
               H008W2_A299ConfiguracoesId
               }
               , new Object[] {
               H008W3_A381NotificationId, H008W3_n381NotificationId, H008W3_A384NotificationType, H008W3_n384NotificationType, H008W3_A389UserNotificationStatus, H008W3_n389UserNotificationStatus, H008W3_A388UserNotificationUserId, H008W3_n388UserNotificationUserId, H008W3_A387UserNotificationId
               }
            }
         );
      ...
      private int AV41UserNotificationId ;
      ...
      private int[] H008W2_A299ConfiguracoesId ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item> AV42InDVelop_Menu ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item AV43DVelop_MenuItem ;
      ...
      private int[] H008W3_A381NotificationId ;
      private bool[] H008W3_n381NotificationId ;
      private string[] H008W3_A384NotificationType ;
      private bool[] H008W3_n384NotificationType ;
      private string[] H008W3_A389UserNotificationStatus ;
      private bool[] H008W3_n389UserNotificationStatus ;
      private short[] H008W3_A388UserNotificationUserId ;
      private bool[] H008W3_n388UserNotificationUserId ;
      private int[] H008W3_A387UserNotificationId ;
   ...
   public class masterpagepfpj__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV39WWpContext__Userid",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H008W2", "SELECT ConfiguracoesId FROM Configuracoes ORDER BY ConfiguracoesId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008W2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H008W3", "SELECT DISTINCT NULL AS NotificationId, NULL AS NotificationType, NULL AS UserNotificationStatus, NULL AS UserNotificationUserId, UserNotificationId FROM ( SELECT T1.NotificationId, T2.NotificationType, T1.UserNotificationStatus, T1.UserNotificationUserId, T1.UserNotificationId FROM (UserNotification T1 LEFT JOIN Notification T2 ON T2.NotificationId = T1.NotificationId) WHERE (T1.UserNotificationUserId = :AV39WWpContext__Userid) AND (T1.UserNotificationStatus = ( 'Unread')) AND (T2.NotificationType = ( 'Internal')) ORDER BY T1.UserNotificationUserId) DistinctT ORDER BY UserNotificationUserId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008W3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
