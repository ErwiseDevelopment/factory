...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   ...
   [XmlType(TypeName =  "WWP_NotificationDefinition" , Namespace = "Factory21" )]
   [Serializable]
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Common\WWP_NotificationDefinition", Namespace = "Factory21")]
