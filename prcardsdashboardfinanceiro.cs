...
namespace GeneXus.Programs {
   public class prcardsdashboardfinanceiro : GXProcedure
   {
                           ...
                           out GXBaseCollection<SdtSdDashboardFinanceiroCards_Item> aP2_SdDashboardFinanceiroCards )
      {
         ...
         this.AV12SdDashboardFinanceiroCards = new GXBaseCollection<SdtSdDashboardFinanceiroCards_Item>( context, "Item", "Factory2") ;
         initialize();
         ExecuteImpl();
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV12SdDashboardFinanceiroCards = new GXBaseCollection<SdtSdDashboardFinanceiroCards_Item>( context, "Item", "Factory2");
         AV8AuxValor = 0;
         /* Using cursor P00893 */
