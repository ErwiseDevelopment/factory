...
namespace GeneXus.Programs {
   public class wpnovapropostaproposta : GXWebComponent
   {
      public wpnovapropostaproposta( )
      {
      ...
      public wpnovapropostaproposta( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Wp Nova Proposta Proposta") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpnovapropostaproposta"+UrlEncode(StringUtil.RTrim(AV6WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpnovapropostaproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WpNovaPropostaProposta" ;
      }

      public override string GetPgmdesc( )
      {
         return "Wp Nova Proposta Proposta" ;
      }
      ...
      protected void WB5N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpnovapropostaproposta");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_procedimentosmedicosid_Internalname, "Procedimento", "", "", lblTextblockcombo_procedimentosmedicosid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WpNovaPropostaProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavPropostadescricao_Internalname, AV15PropostaDescricao, StringUtil.RTrim( context.localUtil.Format( AV15PropostaDescricao, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPropostadescricao_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavPropostadescricao_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpNovaPropostaProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_convenioid_Internalname, "Convênio", "", "", lblTextblockcombo_convenioid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WpNovaPropostaProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_conveniocategoriaid_Internalname, "Categoria do convênio", "", "", lblTextblockcombo_conveniocategoriaid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WpNovaPropostaProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavConveniovencimentoano, cmbavConveniovencimentoano_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV33ConvenioVencimentoAno), 4, 0)), 1, cmbavConveniovencimentoano_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavConveniovencimentoano.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "", true, 0, "HLP_WpNovaPropostaProposta.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavConveniovencimentomes, cmbavConveniovencimentomes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV34ConvenioVencimentoMes), 4, 0)), 1, cmbavConveniovencimentomes_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavConveniovencimentomes.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,63);\"", "", true, 0, "HLP_WpNovaPropostaProposta.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavProcedimentosmedicosid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22ProcedimentosMedicosId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV22ProcedimentosMedicosId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,74);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProcedimentosmedicosid_Jsonclick, 0, "Attribute", "", "", "", "", edtavProcedimentosmedicosid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WpNovaPropostaProposta.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 75,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavConvenioid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV29ConvenioId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV29ConvenioId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,75);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConvenioid_Jsonclick, 0, "Attribute", "", "", "", "", edtavConvenioid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WpNovaPropostaProposta.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 76,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavConveniocategoriaid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV31ConvenioCategoriaId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV31ConvenioCategoriaId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,76);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConveniocategoriaid_Jsonclick, 0, "Attribute", "", "", "", "", edtavConveniocategoriaid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WpNovaPropostaProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START5N2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Wp Nova Proposta Proposta", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpnovapropostaproposta")), "wpnovapropostaproposta") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpnovapropostaproposta")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E135N2( )
      {
         ...
         if ( AV16CheckRequiredFieldsResult && ! AV10HasValidationErrors )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wpnovaproposta"+UrlEncode(StringUtil.RTrim("Proposta")) + "," + UrlEncode(StringUtil.RTrim("Documentos")) + "," + UrlEncode(StringUtil.BoolToStr(false));
      ...
      protected void E145N2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wpnovaproposta"+UrlEncode(StringUtil.RTrim("Proposta")) + "," + UrlEncode(StringUtil.RTrim("Conta")) + "," + UrlEncode(StringUtil.BoolToStr(true));
         CallWebObject(formatLink("wpnovaproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
         /*  Sending Event outputs  */
      }
      ...
      protected void S142( )
      {
         ...
         if ( 1 == 2 )
         {
            ...
            {
               A495ConvenioCategoriaStatus = H005N2_A495ConvenioCategoriaStatus[0];
               n495ConvenioCategoriaStatus = H005N2_n495ConvenioCategoriaStatus[0];
               A493ConvenioCategoriaId = H005N2_A493ConvenioCategoriaId[0];
               A494ConvenioCategoriaDescricao = H005N2_A494ConvenioCategoriaDescricao[0];
               n494ConvenioCategoriaDescricao = H005N2_n494ConvenioCategoriaDescricao[0];
         ...
         {
            A495ConvenioCategoriaStatus = H005N3_A495ConvenioCategoriaStatus[0];
            n495ConvenioCategoriaStatus = H005N3_n495ConvenioCategoriaStatus[0];
            A410ConvenioId = H005N3_A410ConvenioId[0];
            n410ConvenioId = H005N3_n410ConvenioId[0];
            A493ConvenioCategoriaId = H005N3_A493ConvenioCategoriaId[0];
            A494ConvenioCategoriaDescricao = H005N3_A494ConvenioCategoriaDescricao[0];
            n494ConvenioCategoriaDescricao = H005N3_n494ConvenioCategoriaDescricao[0];
            AV26Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
            AV26Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A493ConvenioCategoriaId), 9, 0));
            AV26Combo_DataItem.gxTpr_Title = A494ConvenioCategoriaDescricao;
            AV32ConvenioCategoriaId_Data.Add(AV26Combo_DataItem, 0);
      ...
      protected void S132( )
      {
         ...
         {
            A412ConvenioStatus = H005N4_A412ConvenioStatus[0];
            A410ConvenioId = H005N4_A410ConvenioId[0];
            n410ConvenioId = H005N4_n410ConvenioId[0];
            A411ConvenioDescricao = H005N4_A411ConvenioDescricao[0];
            n411ConvenioDescricao = H005N4_n411ConvenioDescricao[0];
            AV26Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A376ProcedimentosMedicosId = H005N5_A376ProcedimentosMedicosId[0];
            A379ProcedimentosMedicosArea = H005N5_A379ProcedimentosMedicosArea[0];
            n379ProcedimentosMedicosArea = H005N5_n379ProcedimentosMedicosArea[0];
            A377ProcedimentosMedicosNome = H005N5_A377ProcedimentosMedicosNome[0];
            n377ProcedimentosMedicosNome = H005N5_n377ProcedimentosMedicosNome[0];
            AV26Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpnovapropostaproposta", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019154943", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpnovapropostaproposta.js", "?202561019154944", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E135N2","iparms":[{"av":"AV16CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT","type":"boolean"},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV22ProcedimentosMedicosId","fld":"vPROCEDIMENTOSMEDICOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"Combo_procedimentosmedicosid_Ddointernalname","ctrl":"COMBO_PROCEDIMENTOSMEDICOSID","prop":"DDOInternalName"},{"av":"AV14PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"AV15PropostaDescricao","fld":"vPROPOSTADESCRICAO","type":"svchar"},{"av":"AV29ConvenioId","fld":"vCONVENIOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV31ConvenioCategoriaId","fld":"vCONVENIOCATEGORIAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"cmbavConveniovencimentoano"},{"av":"AV33ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV34ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV16CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT","type":"boolean"}]}""");
         setEventMetadata("'WIZARDPREVIOUS'","""{"handler":"E145N2","iparms":[{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"AV22ProcedimentosMedicosId","fld":"vPROCEDIMENTOSMEDICOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV14PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV15PropostaDescricao","fld":"vPROPOSTADESCRICAO","type":"svchar"},{"av":"AV29ConvenioId","fld":"vCONVENIOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV31ConvenioCategoriaId","fld":"vCONVENIOCATEGORIAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"cmbavConveniovencimentoano"},{"av":"AV33ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV34ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("COMBO_CONVENIOID.ONOPTIONCLICKED","""{"handler":"E115N2","iparms":[{"av":"Combo_convenioid_Selectedvalue_get","ctrl":"COMBO_CONVENIOID","prop":"SelectedValue_get"},{"av":"A494ConvenioCategoriaDescricao","fld":"CONVENIOCATEGORIADESCRICAO","type":"svchar"},{"av":"A495ConvenioCategoriaStatus","fld":"CONVENIOCATEGORIASTATUS","type":"boolean"},{"av":"A493ConvenioCategoriaId","fld":"CONVENIOCATEGORIAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV32ConvenioCategoriaId_Data","fld":"vCONVENIOCATEGORIAID_DATA","type":""},{"av":"AV31ConvenioCategoriaId","fld":"vCONVENIOCATEGORIAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A410ConvenioId","fld":"CONVENIOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV29ConvenioId","fld":"vCONVENIOID","pic":"ZZZZZZZZ9","type":"int"}]""");
      ...
      public override void initialize( )
      {
         ...
         H005N2_A495ConvenioCategoriaStatus = new bool[] {false} ;
         H005N2_n495ConvenioCategoriaStatus = new bool[] {false} ;
         H005N2_A493ConvenioCategoriaId = new int[1] ;
         H005N2_A494ConvenioCategoriaDescricao = new string[] {""} ;
         H005N2_n494ConvenioCategoriaDescricao = new bool[] {false} ;
         AV26Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         Combo_conveniocategoriaid_Selectedvalue_set = "";
         H005N3_A495ConvenioCategoriaStatus = new bool[] {false} ;
         H005N3_n495ConvenioCategoriaStatus = new bool[] {false} ;
         H005N3_A410ConvenioId = new int[1] ;
         H005N3_n410ConvenioId = new bool[] {false} ;
         H005N3_A493ConvenioCategoriaId = new int[1] ;
         H005N3_A494ConvenioCategoriaDescricao = new string[] {""} ;
         H005N3_n494ConvenioCategoriaDescricao = new bool[] {false} ;
         H005N4_A412ConvenioStatus = new bool[] {false} ;
         H005N4_A410ConvenioId = new int[1] ;
         H005N4_n410ConvenioId = new bool[] {false} ;
         H005N4_A411ConvenioDescricao = new string[] {""} ;
         H005N4_n411ConvenioDescricao = new bool[] {false} ;
         A411ConvenioDescricao = "";
         Combo_convenioid_Selectedvalue_set = "";
         H005N5_A376ProcedimentosMedicosId = new int[1] ;
         H005N5_A379ProcedimentosMedicosArea = new string[] {""} ;
         H005N5_n379ProcedimentosMedicosArea = new bool[] {false} ;
         H005N5_A377ProcedimentosMedicosNome = new string[] {""} ;
         H005N5_n377ProcedimentosMedicosNome = new bool[] {false} ;
         ...
         sCtrlAV7GoingBack = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpnovapropostaproposta__default(),
            new Object[][] {
                new Object[] {
               H005N2_A495ConvenioCategoriaStatus, H005N2_n495ConvenioCategoriaStatus, H005N2_A493ConvenioCategoriaId, H005N2_A494ConvenioCategoriaDescricao, H005N2_n494ConvenioCategoriaDescricao
               }
               , new Object[] {
               H005N3_A495ConvenioCategoriaStatus, H005N3_n495ConvenioCategoriaStatus, H005N3_A410ConvenioId, H005N3_n410ConvenioId, H005N3_A493ConvenioCategoriaId, H005N3_A494ConvenioCategoriaDescricao, H005N3_n494ConvenioCategoriaDescricao
               }
               , new Object[] {
               H005N4_A412ConvenioStatus, H005N4_A410ConvenioId, H005N4_A411ConvenioDescricao, H005N4_n411ConvenioDescricao
               }
               , new Object[] {
               H005N5_A376ProcedimentosMedicosId, H005N5_A379ProcedimentosMedicosArea, H005N5_n379ProcedimentosMedicosArea, H005N5_A377ProcedimentosMedicosNome, H005N5_n377ProcedimentosMedicosNome
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] H005N2_A495ConvenioCategoriaStatus ;
      private bool[] H005N2_n495ConvenioCategoriaStatus ;
      private int[] H005N2_A493ConvenioCategoriaId ;
      private string[] H005N2_A494ConvenioCategoriaDescricao ;
      private bool[] H005N2_n494ConvenioCategoriaDescricao ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV26Combo_DataItem ;
      private bool[] H005N3_A495ConvenioCategoriaStatus ;
      private bool[] H005N3_n495ConvenioCategoriaStatus ;
      private int[] H005N3_A410ConvenioId ;
      private bool[] H005N3_n410ConvenioId ;
      private int[] H005N3_A493ConvenioCategoriaId ;
      private string[] H005N3_A494ConvenioCategoriaDescricao ;
      private bool[] H005N3_n494ConvenioCategoriaDescricao ;
      private bool[] H005N4_A412ConvenioStatus ;
      private int[] H005N4_A410ConvenioId ;
      private bool[] H005N4_n410ConvenioId ;
      private string[] H005N4_A411ConvenioDescricao ;
      private bool[] H005N4_n411ConvenioDescricao ;
      private int[] H005N5_A376ProcedimentosMedicosId ;
      private string[] H005N5_A379ProcedimentosMedicosArea ;
      private bool[] H005N5_n379ProcedimentosMedicosArea ;
      private string[] H005N5_A377ProcedimentosMedicosNome ;
      private bool[] H005N5_n377ProcedimentosMedicosNome ;
      private GxSimpleCollection<string> AV23ComboTitles ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wpnovapropostaproposta__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH005N4;
          prmH005N4 = new Object[] {
          };
          Object[] prmH005N5;
          prmH005N5 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H005N2", "SELECT ConvenioCategoriaStatus, ConvenioCategoriaId, ConvenioCategoriaDescricao FROM ConvenioCategoria WHERE ConvenioCategoriaStatus = TRUE ORDER BY ConvenioCategoriaDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005N2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005N3", "SELECT ConvenioCategoriaStatus, ConvenioId, ConvenioCategoriaId, ConvenioCategoriaDescricao FROM ConvenioCategoria WHERE (ConvenioCategoriaStatus = TRUE) AND (ConvenioId = :AV29ConvenioId) ORDER BY ConvenioCategoriaDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005N3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005N4", "SELECT ConvenioStatus, ConvenioId, ConvenioDescricao FROM Convenio WHERE ConvenioStatus = TRUE ORDER BY ConvenioDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005N4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005N5", "SELECT ProcedimentosMedicosId, ProcedimentosMedicosArea, ProcedimentosMedicosNome FROM ProcedimentosMedicos ORDER BY ProcedimentosMedicosNome ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005N5,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
