   ...
   public class wwp_dfc_multipledatagrid_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_multipledatagrid_wc"+UrlEncode(StringUtil.RTrim(AV18WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV21WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV13SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_multipledatagrid_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB260( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_multipledatagrid_wc");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         ...
         if ( wbEnd == 9 )
         {
            ...
            wb_table1_29_262( true) ;
         }
         else
         {
            wb_table1_29_262( false) ;
         }
         return  ;
      }

      protected void wb_table1_29_262e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "end", "top", "div");
            ...
            wb_table2_47_262( true) ;
         }
         else
         {
            wb_table2_47_262( false) ;
         }
         return  ;
      }

      protected void wb_table2_47_262e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_52_262( true) ;
         }
         else
         {
            wb_table3_52_262( false) ;
         }
         return  ;
      }

      protected void wb_table3_52_262e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_57_262( true) ;
         }
         else
         {
            wb_table4_57_262( false) ;
         }
         return  ;
      }

      protected void wb_table4_57_262e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_multipledatagrid_wc")), "workwithplus.dynamicforms.wwp_dfc_multipledatagrid_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_multipledatagrid_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E20262( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISLASTELEMENT", GetSecureSignedToken( sPrefix, AV10IsLastElement, context));
         Dvelop_confirmpanel_btndeleteelement_Confirmationtext = StringUtil.Format( "Tem certeza de que deseja eliminar o %1 selecionado e todo o seu conteúdo?", "Mult. Seção de dados", "", "", "", "", "", "", "", "");
         ...
         Btnmoveup_Caption = StringUtil.Format( "Mover %1 para cima", "Mult. Seção de dados", "", "", "", "", "", "", "", "");
         ucBtnmoveup.SendProperty(context, sPrefix, false, Btnmoveup_Internalname, "Caption", Btnmoveup_Caption);
         Btnmovedown_Caption = StringUtil.Format( "Mover %1 para baixo", "Mult. Seção de dados", "", "", "", "", "", "", "", "");
         ucBtnmovedown.SendProperty(context, sPrefix, false, Btnmovedown_Internalname, "Caption", Btnmovedown_Caption);
         Btndeleteelement_Caption = StringUtil.Format( "Elimine %1", "Mult. Seção de dados", "", "", "", "", "", "", "", "");
         ...
         {
            Btnsettings_Caption = StringUtil.Format( "Configuração (%1)", "Mult. Seção de dados", "", "", "", "", "", "", "", "");
      ...
      protected void E21262( )
      {
         ...
         AV23GXV1 = 1;
         while ( AV23GXV1 <= AV19WWPForm.gxTpr_Element.Count )
         {
            AV20WWPFormElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV19WWPForm.gxTpr_Element.Item(AV23GXV1));
      ...
      private void E22262( )
      {
         ...
         AV24GXV2 = 1;
         while ( AV24GXV2 <= AV19WWPForm.gxTpr_Element.Count )
         {
            AV20WWPFormElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV19WWPForm.gxTpr_Element.Item(AV24GXV2));
            if ( AV20WWPFormElement.gxTpr_Wwpformelementparentid == AV21WWPFormElementId )
            {
         ...
         AV25GXV3 = 1;
         while ( AV25GXV3 <= AV19WWPForm.gxTpr_Element.Count )
         {
            AV20WWPFormElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV19WWPForm.gxTpr_Element.Item(AV25GXV3));
      ...
      protected void E13262( )
      {
         ...
         if ( StringUtil.StrCmp(Settings_modal_Result, "OK") == 0 )
         {
            if ( AV11IsStep )
            {
               ...
               AV26GXV4 = 1;
               while ( AV26GXV4 <= AV19WWPForm.gxTpr_Element.Count )
               {
                  AV8Element = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV19WWPForm.gxTpr_Element.Item(AV26GXV4));
      ...
      protected void wb_table4_57_262( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_57_262e( true) ;
         }
         else
         {
            wb_table4_57_262e( false) ;
         }
      }

      protected void wb_table3_52_262( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_52_262e( true) ;
         }
         else
         {
            wb_table3_52_262e( false) ;
         }
      }

      protected void wb_table2_47_262( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_47_262e( true) ;
         }
         else
         {
            wb_table2_47_262e( false) ;
         }
      }

      protected void wb_table1_29_262( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_29_262e( true) ;
         }
         else
         {
            wb_table1_29_262e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918384484", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_multipledatagrid_wc.js", "?202551918384485", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Btnaddelement_Caption = "Adicionar elemento";
         ...
         Dvelop_confirmpanel_btndeleteelement_Title = "Eliminar";
         ...
         Btnsettings_Caption = "Configurações";
         Btndeleteelement_Caption = "Eliminar";
         Btnmovedown_Caption = "Mover para baixo";
         Btnmoveup_Caption = "Subir";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV18WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV19WWPForm","fld":"vWWPFORM","type":""},{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV17WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV9IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV10IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","hsh":true,"type":""},{"av":"AV11IsStep","fld":"vISSTEP","hsh":true,"type":"boolean"}]""");
         ...
         setEventMetadata("FSGRID.LOAD","""{"handler":"E22262","iparms":[{"av":"AV19WWPForm","fld":"vWWPFORM","type":""},{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV17WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV18WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","hsh":true,"type":""}]""");
         ...
         setEventMetadata("'DOADDCHILD'","""{"handler":"E11261","iparms":[]}""");
         setEventMetadata("'DOREFRESHGRID'","""{"handler":"E17262","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV19WWPForm","fld":"vWWPFORM","type":""},{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV17WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV9IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV10IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV18WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","hsh":true,"type":""},{"av":"AV11IsStep","fld":"vISSTEP","hsh":true,"type":"boolean"},{"av":"sPrefix","type":"char"}]""");
         setEventMetadata("'DOREFRESHGRID'",""","oparms":[{"av":"AV19WWPForm","fld":"vWWPFORM","type":""},{"av":"subFsgrid_Columns","ctrl":"FSGRID","prop":"Columns"},{"ctrl":"BTNADDCHILD","prop":"Visible"},{"av":"Btnmoveup_Visible","ctrl":"BTNMOVEUP","prop":"Visible"},{"av":"Btnmovedown_Visible","ctrl":"BTNMOVEDOWN","prop":"Visible"},{"av":"Btnsettings_Visible","ctrl":"BTNSETTINGS","prop":"Visible"}]}""");
         setEventMetadata("'DOMOVEUP'","""{"handler":"E18262","iparms":[{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E19262","iparms":[{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E12262","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE",""","oparms":[{"av":"AV19WWPForm","fld":"vWWPFORM","type":""}]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E14262","iparms":[{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("ADDELEMENT_MODAL.ONLOADCOMPONENT","""{"handler":"E16262","iparms":[{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         ...
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E13262","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV11IsStep","fld":"vISSTEP","hsh":true,"type":"boolean"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV19WWPForm","fld":"vWWPFORM","type":""}]}""");
         setEventMetadata("ADDELEMENT_MODAL.CLOSE","""{"handler":"E15262","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV19WWPForm","fld":"vWWPFORM","type":""},{"av":"AV21WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV17WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV9IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV10IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV18WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV13SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","hsh":true,"type":""},{"av":"AV11IsStep","fld":"vISSTEP","hsh":true,"type":"boolean"},{"av":"sPrefix","type":"char"},{"av":"Addelement_modal_Result","ctrl":"ADDELEMENT_MODAL","prop":"Result"}]""");
         setEventMetadata("ADDELEMENT_MODAL.CLOSE",""","oparms":[{"av":"AV19WWPForm","fld":"vWWPFORM","type":""},{"av":"subFsgrid_Columns","ctrl":"FSGRID","prop":"Columns"},{"ctrl":"BTNADDCHILD","prop":"Visible"},{"av":"Btnmoveup_Visible","ctrl":"BTNMOVEUP","prop":"Visible"},{"av":"Btnmovedown_Visible","ctrl":"BTNMOVEDOWN","prop":"Visible"},{"av":"Btnsettings_Visible","ctrl":"BTNSETTINGS","prop":"Visible"}]}""");
         return  ;
      }
