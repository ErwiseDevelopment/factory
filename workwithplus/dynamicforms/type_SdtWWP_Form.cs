...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   ...
   [XmlType(TypeName =  "WWP_Form" , Namespace = "Factory2" )]
   [Serializable]
   public class SdtWWP_Form : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element> gxTpr_Element_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtWWP_Form_Element == null )
            {
               gxTv_SdtWWP_Form_Element = new GXBCLevelCollection<GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element>( context, "WWP_Form.Element", "Factory2");
            }
   ...
   [DataContract(Name = @"WorkWithPlus\DynamicForms\WWP_Form", Namespace = "Factory2")]
