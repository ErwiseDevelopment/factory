...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="WWPGridState.DynamicFilter" , Namespace="Factory21" )]
	[Serializable]
	...
	[DataContract(Name=@"WWPGridState.DynamicFilter", Namespace="Factory21")]
