   ...
   public class wwp_editconfformattingvalues : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.wwp_editconfformattingvalues"+UrlEncode(StringUtil.RTrim(AV7VarProgramName));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.wwp_editconfformattingvalues") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB0O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.wwp_editconfformattingvalues");
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
            }
            /* Div Control */
         ...
         if ( wbEnd == 15 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuseraction1_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(15), 2, 0)+","+"null"+");", "Cancelar", bttBtnuseraction1_Jsonclick, 7, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110o1_client"+"'", TempTags, "", 2, "HLP_WorkWithPlus/WWP_EditConfFormattingValues.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(15), 2, 0)+","+"null"+");", "Confirmar", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WorkWithPlus/WWP_EditConfFormattingValues.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "GRIDS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( ( AV6ConfFormattingVariables.Count >= AV9GXV1 ) && ( AV9GXV1 > 0 ) )
                              {
                                 AV6ConfFormattingVariables.CurrentItem = ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV9GXV1));
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.wwp_editconfformattingvalues")), "workwithplus.wwp_editconfformattingvalues") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.wwp_editconfformattingvalues")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF0O2( )
      {
         ...
         GridsContainer.AddObjectProperty("Class", "GridWithBorderColor WorkWith");
      ...
      private void E150O2( )
      {
         ...
         returnInSub = false;
         AV9GXV1 = 1;
         while ( AV9GXV1 <= AV6ConfFormattingVariables.Count )
         {
            AV6ConfFormattingVariables.CurrentItem = ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV9GXV1));
      ...
      {
         AV9GXV1 = (int)(nGXsfl_15_idx+GRIDS_nFirstRecordOnPage);
         if ( ( AV9GXV1 > 0 ) && ( AV6ConfFormattingVariables.Count >= AV9GXV1 ) )
         {
            AV6ConfFormattingVariables.CurrentItem = ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV9GXV1));
         }
         ...
         returnInSub = false;
         AV11GXV3 = 1;
         while ( AV11GXV3 <= AV6ConfFormattingVariables.Count )
         {
            AV5ConfFormattingVariable = ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV11GXV3));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101965355", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_editconfformattingvalues.js", "?20256101965355", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      protected void StartGridControl15( )
      {
         if ( GridsContainer.GetWrapped() == 1 )
         {
            ...
            sStyleString = "";
            GxWebStd.gx_table_start( context, subGrids_Internalname, subGrids_Internalname, "", "GridWithBorderColor WorkWith", 0, "", "", 1, 2, sStyleString, "", "", 0);
            /* Subfile titles */
            context.WriteHtmlText( "<tr") ;
      ...
      public override void initialize_properties( )
      {
         ...
         edtavConfformattingvariables__description_Enabled = 0;
         subGrids_Class = "GridWithBorderColor WorkWith";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDS_nFirstRecordOnPage","type":"int"},{"av":"GRIDS_nEOF","type":"int"},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15,"type":"int"},{"av":"sPrefix","type":"char"}]}""");
         setEventMetadata("GRIDS.LOAD","""{"handler":"E150O2","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15,"type":"int"}]""");
         setEventMetadata("GRIDS.LOAD",""","oparms":[{"av":"AV8DefaultValue","fld":"vDEFAULTVALUE","pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E110O1","iparms":[]}""");
         setEventMetadata("'DOUSERACTIONRESET'","""{"handler":"E120O2","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15,"type":"int"},{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME","type":"svchar"}]}""");
         setEventMetadata("ENTER","""{"handler":"E130O2","iparms":[{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME","type":"svchar"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15,"type":"int"},{"av":"AV8DefaultValue","fld":"vDEFAULTVALUE","grid":15,"pic":"ZZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("GRIDS_FIRSTPAGE","""{"handler":"subgrids_firstpage","iparms":[{"av":"GRIDS_nFirstRecordOnPage","type":"int"},{"av":"GRIDS_nEOF","type":"int"},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15,"type":"int"},{"av":"sPrefix","type":"char"}]}""");
         setEventMetadata("GRIDS_PREVPAGE","""{"handler":"subgrids_previouspage","iparms":[{"av":"GRIDS_nFirstRecordOnPage","type":"int"},{"av":"GRIDS_nEOF","type":"int"},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15,"type":"int"},{"av":"sPrefix","type":"char"}]}""");
         setEventMetadata("GRIDS_NEXTPAGE","""{"handler":"subgrids_nextpage","iparms":[{"av":"GRIDS_nFirstRecordOnPage","type":"int"},{"av":"GRIDS_nEOF","type":"int"},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15,"type":"int"},{"av":"sPrefix","type":"char"}]}""");
         setEventMetadata("GRIDS_LASTPAGE","""{"handler":"subgrids_lastpage","iparms":[{"av":"GRIDS_nFirstRecordOnPage","type":"int"},{"av":"GRIDS_nEOF","type":"int"},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15,"type":"int"},{"av":"sPrefix","type":"char"}]}""");
      ...
      {
         AV6ConfFormattingVariables = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>( context, "WWPConfFormattingVariable", "Factory21");
