...
namespace GeneXus.Programs {
   public class notificacoes : GXDataArea
   {
      public notificacoes( )
      {
      ...
      public notificacoes( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("notificacoes") +"\">") ;
      ...
      {
         return formatLink("notificacoes")  ;
      }
      ...
      protected void WB4U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_12_4U2( true) ;
         }
         else
         {
            wb_table1_12_4U2( false) ;
         }
         return  ;
      }

      protected void wb_table1_12_4U2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START4U2( )
      {
         ...
         Form.Meta.addItem("description", "Notificações", 0) ;
         context.wjLoc = "";
      ...
      protected void wb_table1_12_4U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblshow_Internalname, lblLblshow_Caption, "", "", lblLblshow_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockNotAuthorized", 0, "", 1, 1, 0, 0, "HLP_Notificacoes.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblVisualizar_Internalname, "<i class='fas fa-eye-slash' title='Visualizar valores' style='font-size: 24px'></i>", "", "", lblVisualizar_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", lblVisualizar_Visible, 1, 0, 2, "HLP_Notificacoes.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblVisualizaraberto_Internalname, "<i class='fas fa-eye' title='Visualizar valores' style='font-size: 24px'></i>", "", "", lblVisualizaraberto_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", lblVisualizaraberto_Visible, 1, 0, 2, "HLP_Notificacoes.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_12_4U2e( true) ;
         }
         else
         {
            wb_table1_12_4U2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918552360", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("notificacoes.js", "?202551918552361", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
