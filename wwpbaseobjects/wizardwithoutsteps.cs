...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardwithoutsteps : GXWebComponent
   {
      public wizardwithoutsteps( )
      {
      ...
      public wizardwithoutsteps( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Wizard Without Steps") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.wizardwithoutsteps"+UrlEncode(StringUtil.RTrim(AV11SelectedStep));
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("wwpbaseobjects.wizardwithoutsteps") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WWPBaseObjects.WizardWithoutSteps" ;
      }

      public override string GetPgmdesc( )
      {
         return "Wizard Without Steps" ;
      }
      ...
      protected void WB8I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wwpbaseobjects.wizardwithoutsteps");
            }
      ...
      protected void START8I2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Wizard Without Steps", 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "GRIDWIZARDSTEPS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV20GXV1 = nGXsfl_5_idx;
                              if ( ( AV19WizardStepsAux.Count >= AV20GXV1 ) && ( AV20GXV1 > 0 ) )
                              {
                                 AV19WizardStepsAux.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV20GXV1));
                              }
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.wizardwithoutsteps")), "wwpbaseobjects.wizardwithoutsteps") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.wizardwithoutsteps")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E118I2( )
      {
         ...
         if ( AV19WizardStepsAux.Count > AV7MaxStepsToShow )
         {
            ...
            AV22GXV3 = 1;
            while ( AV22GXV3 <= AV19WizardStepsAux.Count )
            {
               AV17WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV22GXV3));
      ...
      private void E128I2( )
      {
         ...
         returnInSub = false;
         AV20GXV1 = 1;
         while ( AV20GXV1 <= AV19WizardStepsAux.Count )
         {
            AV19WizardStepsAux.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV19WizardStepsAux.Item(AV20GXV1));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wwpbaseobjects\\wizardwithoutsteps", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101963971", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardwithoutsteps.js", "?20256101963972", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage","type":"int"},{"av":"GRIDWIZARDSTEPS_nEOF","type":"int"},{"av":"AV19WizardStepsAux","fld":"vWIZARDSTEPSAUX","grid":5,"type":""},{"av":"nGXsfl_5_idx","ctrl":"GRID","prop":"GridCurrRow","grid":5},{"av":"nRC_GXsfl_5","ctrl":"GRIDWIZARDSTEPS","prop":"GridRC","grid":5,"type":"int"},{"av":"AV11SelectedStep","fld":"vSELECTEDSTEP","type":"svchar"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"sPrefix","type":"char"},{"av":"AV15StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV9PreviousSelected","fld":"vPREVIOUSSELECTED","hsh":true,"type":"boolean"},{"av":"AV14StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV5FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true,"type":"boolean"},{"av":"AV6LastIsDummy","fld":"vLASTISDUMMY","hsh":true,"type":"boolean"},{"av":"AV10SecondIsDummy","fld":"vSECONDISDUMMY","hsh":true,"type":"boolean"},{"av":"AV8PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true,"type":"boolean"}]}""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD","""{"handler":"E128I2","iparms":[{"av":"AV15StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV19WizardStepsAux","fld":"vWIZARDSTEPSAUX","grid":5,"type":""},{"av":"nGXsfl_5_idx","ctrl":"GRID","prop":"GridCurrRow","grid":5},{"av":"GRIDWIZARDSTEPS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_5","ctrl":"GRIDWIZARDSTEPS","prop":"GridRC","grid":5,"type":"int"},{"av":"AV11SelectedStep","fld":"vSELECTEDSTEP","type":"svchar"},{"av":"AV9PreviousSelected","fld":"vPREVIOUSSELECTED","hsh":true,"type":"boolean"},{"av":"AV14StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV5FirstIsDummy","fld":"vFIRSTISDUMMY","hsh":true,"type":"boolean"},{"av":"AV6LastIsDummy","fld":"vLASTISDUMMY","hsh":true,"type":"boolean"},{"av":"AV18WizardSteps","fld":"vWIZARDSTEPS","type":""},{"av":"AV10SecondIsDummy","fld":"vSECONDISDUMMY","hsh":true,"type":"boolean"},{"av":"AV8PenultimateIsDummy","fld":"vPENULTIMATEISDUMMY","hsh":true,"type":"boolean"}]""");
         setEventMetadata("GRIDWIZARDSTEPS.LOAD",""","oparms":[{"av":"lblStepnumber_Caption","ctrl":"STEPNUMBER","prop":"Caption"},{"ctrl":"WIZARDSTEPSAUX__TITLE","prop":"Class"},{"av":"imgStepimg_Class","ctrl":"STEPIMG","prop":"Class"},{"av":"lblStepnumber_Class","ctrl":"STEPNUMBER","prop":"Class"},{"av":"divTblstep_Class","ctrl":"TBLSTEP","prop":"Class"},{"av":"AV9PreviousSelected","fld":"vPREVIOUSSELECTED","hsh":true,"type":"boolean"},{"av":"imgStepimg_Visible","ctrl":"STEPIMG","prop":"Visible"},{"av":"tblTblcontainerstep_Class","ctrl":"TBLCONTAINERSTEP","prop":"Class"},{"av":"divTblstep_Visible","ctrl":"TBLSTEP","prop":"Visible"},{"av":"lblStepnumber_Visible","ctrl":"STEPNUMBER","prop":"Visible"},{"ctrl":"WIZARDSTEPSAUX__TITLE","prop":"Visible"},{"av":"AV15StepRealNumber","fld":"vSTEPREALNUMBER","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV14StepNumber","fld":"vSTEPNUMBER","pic":"ZZZ9","hsh":true,"type":"int"}]}""");
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV19WizardStepsAux = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Factory21");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
