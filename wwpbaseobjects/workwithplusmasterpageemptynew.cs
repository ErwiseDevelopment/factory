...
namespace GeneXus.Programs.wwpbaseobjects {
   public class workwithplusmasterpageemptynew : GXMasterPage
   {
      public workwithplusmasterpageemptynew( )
      {
      ...
      public workwithplusmasterpageemptynew( IGxContext context )
      {
      ...
      protected void RenderHtmlCloseForm7I2( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageemptynew.js", "?202561019264622", false, true);
      ...
      {
         return "WWPBaseObjects.WorkWithPlusMasterPageEmptyNew" ;
      }
      ...
      protected void E117I2( )
      {
         ...
         {
            A249EmpresaId = H007I2_A249EmpresaId[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202561019264693", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageemptynew.js", "?202561019264693", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H007I2_A249EmpresaId = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         sDynURL = "";
         Form = new GXWebForm();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.workwithplusmasterpageemptynew__default(),
            new Object[][] {
                new Object[] {
               H007I2_A249EmpresaId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] H007I2_A249EmpresaId ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class workwithplusmasterpageemptynew__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007I2", "SELECT EmpresaId FROM Empresa ORDER BY EmpresaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007I2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
