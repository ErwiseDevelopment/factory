...
namespace GeneXus.Programs {
   public class assinarcontrato : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vGXV6", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV56GXV6), 8, 0, ",", "")));
      ...
      protected void STRUP9R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV56GXV6 = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vGXV6"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      private void E189R2( )
      {
         ...
         returnInSub = false;
         AV49GXV1 = 1;
         while ( AV49GXV1 <= AV10Array_SdParticipantes.Count )
         {
            AV11SdParticipantes = ((SdtSdParticipantes)AV10Array_SdParticipantes.Item(AV49GXV1));
      ...
      protected void E139R2( )
      {
         ...
         AV50GXV2 = 1;
         while ( AV50GXV2 <= AV10Array_SdParticipantes.Count )
         {
            AV11SdParticipantes = ((SdtSdParticipantes)AV10Array_SdParticipantes.Item(AV50GXV2));
         ...
         if ( AV33IsHasContratado && AV32IsHasContratante && AV47IsArqOk && ! String.IsNullOrEmpty(StringUtil.RTrim( AV9NomeContrato)) )
         {
            ...
            {
               AV44AuxArray_SdParticipantes = new GXBaseCollection<SdtSdParticipantes>( context, "SdParticipantes", "Factory2");
               AV51GXV3 = 1;
               while ( AV51GXV3 <= AV10Array_SdParticipantes.Count )
               {
                  AV11SdParticipantes = ((SdtSdParticipantes)AV10Array_SdParticipantes.Item(AV51GXV3));
               ...
               {
                  GXt_char1 = AV41SdErro.gxTpr_Msg;
                  new message(context ).gxep_erro( ref  GXt_char1) ;
                  AV41SdErro.gxTpr_Msg = GXt_char1;
               }
               else
               {
      ...
      protected void E169R2( )
      {
         ...
         AV16i = 0;
         AV52GXV4 = 1;
         while ( AV52GXV4 <= AV10Array_SdParticipantes.Count )
         {
            AV11SdParticipantes = ((SdtSdParticipantes)AV10Array_SdParticipantes.Item(AV52GXV4));
            AV16i = (short)(AV16i+1);
      ...
      protected void E119R2( )
      {
         ...
         {
            /* Using cursor H009R3 */
            pr_default.execute(1, new Object[] {AV22LayoutContratoId});
            while ( (pr_default.getStatus(1) != 101) )
            {
               A154LayoutContratoId = H009R3_A154LayoutContratoId[0];
               A157LayoutContratoCorpo = H009R3_A157LayoutContratoCorpo[0];
               n157LayoutContratoCorpo = H009R3_n157LayoutContratoCorpo[0];
      ...
      protected void S112( )
      {
         ...
         {
            A906LayoutContratoTipo = H009R4_A906LayoutContratoTipo[0];
            n906LayoutContratoTipo = H009R4_n906LayoutContratoTipo[0];
            A154LayoutContratoId = H009R4_A154LayoutContratoId[0];
            A155LayoutContratoDescricao = H009R4_A155LayoutContratoDescricao[0];
            n155LayoutContratoDescricao = H009R4_n155LayoutContratoDescricao[0];
      ...
      protected void E129R2( )
      {
         ...
         AV55GXV5 = 1;
         while ( AV55GXV5 <= AV26UploadedFiles.Count )
         {
            AV28FileUploadData = ((SdtFileUploadData)AV26UploadedFiles.Item(AV55GXV5));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255221662246", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("assinarcontrato.js", "?20255221662246", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV27FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV29StringBase64 = "";
         AV37Blob = "";
         ...
         AV17InJSON = "";
         AV18Array_JSON = "";
         H009R3_A154LayoutContratoId = new short[1] ;
         H009R3_A157LayoutContratoCorpo = new string[] {""} ;
         H009R3_n157LayoutContratoCorpo = new bool[] {false} ;
         H009R4_A906LayoutContratoTipo = new string[] {""} ;
         H009R4_n906LayoutContratoTipo = new bool[] {false} ;
         H009R4_A154LayoutContratoId = new short[1] ;
         H009R4_A155LayoutContratoDescricao = new string[] {""} ;
         H009R4_n155LayoutContratoDescricao = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.assinarcontrato__default(),
            new Object[][] {
               ...
               , new Object[] {
               H009R3_A154LayoutContratoId, H009R3_A157LayoutContratoCorpo, H009R3_n157LayoutContratoCorpo
               }
               , new Object[] {
               H009R4_A906LayoutContratoTipo, H009R4_n906LayoutContratoTipo, H009R4_A154LayoutContratoId, H009R4_A155LayoutContratoDescricao, H009R4_n155LayoutContratoDescricao
               }
            }
         );
      ...
      private short[] H009R3_A154LayoutContratoId ;
      private string[] H009R3_A157LayoutContratoCorpo ;
      private bool[] H009R3_n157LayoutContratoCorpo ;
      private string[] H009R4_A906LayoutContratoTipo ;
      private bool[] H009R4_n906LayoutContratoTipo ;
      private short[] H009R4_A154LayoutContratoId ;
      private string[] H009R4_A155LayoutContratoDescricao ;
      private bool[] H009R4_n155LayoutContratoDescricao ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H009R3", "SELECT LayoutContratoId, LayoutContratoCorpo FROM LayoutContrato WHERE LayoutContratoId = :AV22LayoutContratoId ORDER BY LayoutContratoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009R3,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H009R4", "SELECT LayoutContratoTipo, LayoutContratoId, LayoutContratoDescricao FROM LayoutContrato WHERE LayoutContratoTipo = ( 'C') ORDER BY LayoutContratoDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009R4,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
