   ...
   public class wwp_subscription_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void Load044( )
      {
         ...
         if ( (pr_default.getStatus(5) != 101) )
         {
            ...
            A29WWPNotificationDefinitionDescription = BC00047_A29WWPNotificationDefinitionDescription[0];
            ...
            A28WWPSubscriptionEntityRecordDescription = BC00047_A28WWPSubscriptionEntityRecordDescription[0];
      ...
      protected void CheckExtendedTable044( )
      {
         ...
         A29WWPNotificationDefinitionDescription = BC00044_A29WWPNotificationDefinitionDescription[0];
         pr_default.close(2);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A28WWPSubscriptionEntityRecordDescription = BC00043_A28WWPSubscriptionEntityRecordDescription[0];
      ...
      protected void CheckOptimisticConcurrency044( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z26WWPSubscriptionEntityRecordId, BC00042_A26WWPSubscriptionEntityRecordId[0]) != 0 ) || ( StringUtil.StrCmp(Z28WWPSubscriptionEntityRecordDescription, BC00042_A28WWPSubscriptionEntityRecordDescription[0]) != 0 ) || ( StringUtil.StrCmp(Z19WWPSubscriptionRoleId, BC00042_A19WWPSubscriptionRoleId[0]) != 0 ) || ( Z27WWPSubscriptionSubscribed != BC00042_A27WWPSubscriptionSubscribed[0] ) || ( Z23WWPNotificationDefinitionId != BC00042_A23WWPNotificationDefinitionId[0] ) )
            {
               Gx_longc = true;
            }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(7, new Object[] {A26WWPSubscriptionEntityRecordId, A28WWPSubscriptionEntityRecordDescription, n19WWPSubscriptionRoleId, A19WWPSubscriptionRoleId, A27WWPSubscriptionSubscribed, A23WWPNotificationDefinitionId, n7WWPUserExtendedId, A7WWPUserExtendedId});
                     pr_default.close(7);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(9, new Object[] {A26WWPSubscriptionEntityRecordId, A28WWPSubscriptionEntityRecordDescription, n19WWPSubscriptionRoleId, A19WWPSubscriptionRoleId, A27WWPSubscriptionSubscribed, A23WWPNotificationDefinitionId, n7WWPUserExtendedId, A7WWPUserExtendedId, A25WWPSubscriptionId});
                     pr_default.close(9);
                     pr_default.SmartCacheProvider.SetUpdated("WWP_Subscription");
      ...
      protected void OnDeleteControls044( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            A29WWPNotificationDefinitionDescription = BC000413_A29WWPNotificationDefinitionDescription[0];
            pr_default.close(11);
      ...
      public void ScanKeyStart044( )
      {
         ...
         if ( (pr_default.getStatus(14) != 101) )
         {
            ...
            A29WWPNotificationDefinitionDescription = BC000416_A29WWPNotificationDefinitionDescription[0];
            ...
            A28WWPSubscriptionEntityRecordDescription = BC000416_A28WWPSubscriptionEntityRecordDescription[0];
      ...
      public void VarsToRow4( GeneXus.Programs.wwpbaseobjects.subscriptions.SdtWWP_Subscription obj4 )
      {
         ...
         obj4.gxTpr_Wwpnotificationdefinitiondescription = A29WWPNotificationDefinitionDescription;
         ...
         obj4.gxTpr_Wwpsubscriptionentityrecorddescription = A28WWPSubscriptionEntityRecordDescription;
         ...
         obj4.gxTpr_Wwpnotificationdefinitiondescription_Z = Z29WWPNotificationDefinitionDescription;
         ...
         obj4.gxTpr_Wwpsubscriptionentityrecorddescription_Z = Z28WWPSubscriptionEntityRecordDescription;
                              ...
                              int forceLoad )
      {
         ...
         A29WWPNotificationDefinitionDescription = obj4.gxTpr_Wwpnotificationdefinitiondescription;
         ...
         A28WWPSubscriptionEntityRecordDescription = obj4.gxTpr_Wwpsubscriptionentityrecorddescription;
         ...
         Z29WWPNotificationDefinitionDescription = obj4.gxTpr_Wwpnotificationdefinitiondescription_Z;
         ...
         Z28WWPSubscriptionEntityRecordDescription = obj4.gxTpr_Wwpsubscriptionentityrecorddescription_Z;
      ...
      public override void initialize( )
      {
         ...
         BC00047_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         ...
         BC00047_A28WWPSubscriptionEntityRecordDescription = new string[] {""} ;
         ...
         BC00044_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         ...
         BC00043_A28WWPSubscriptionEntityRecordDescription = new string[] {""} ;
         ...
         BC00042_A28WWPSubscriptionEntityRecordDescription = new string[] {""} ;
         ...
         BC000413_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         ...
         BC000416_A29WWPNotificationDefinitionDescription = new string[] {""} ;
         ...
         BC000416_A28WWPSubscriptionEntityRecordDescription = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscription_bc__default(),
            new Object[][] {
               ...
               , new Object[] {
               BC00047_A20WWPEntityId, BC00047_A25WWPSubscriptionId, BC00047_A29WWPNotificationDefinitionDescription, BC00047_A21WWPEntityName, BC00047_A8WWPUserExtendedFullName, BC00047_A26WWPSubscriptionEntityRecordId, BC00047_A28WWPSubscriptionEntityRecordDescription, BC00047_A19WWPSubscriptionRoleId, BC00047_n19WWPSubscriptionRoleId, BC00047_A27WWPSubscriptionSubscribed,
               ...
               , new Object[] {
               BC000413_A20WWPEntityId, BC000413_A29WWPNotificationDefinitionDescription
               }
               , new Object[] {
               ...
               , new Object[] {
               BC000416_A20WWPEntityId, BC000416_A25WWPSubscriptionId, BC000416_A29WWPNotificationDefinitionDescription, BC000416_A21WWPEntityName, BC000416_A8WWPUserExtendedFullName, BC000416_A26WWPSubscriptionEntityRecordId, BC000416_A28WWPSubscriptionEntityRecordDescription, BC000416_A19WWPSubscriptionRoleId, BC000416_n19WWPSubscriptionRoleId, BC000416_A27WWPSubscriptionSubscribed,
      ...
      private string[] BC00047_A29WWPNotificationDefinitionDescription ;
      ...
      private string[] BC00047_A28WWPSubscriptionEntityRecordDescription ;
      ...
      private string[] BC00044_A29WWPNotificationDefinitionDescription ;
      ...
      private string[] BC00043_A28WWPSubscriptionEntityRecordDescription ;
      ...
      private string[] BC00042_A28WWPSubscriptionEntityRecordDescription ;
      ...
      private string[] BC000413_A29WWPNotificationDefinitionDescription ;
      ...
      private string[] BC000416_A29WWPNotificationDefinitionDescription ;
      ...
      private string[] BC000416_A28WWPSubscriptionEntityRecordDescription ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("BC00044", "SELECT WWPEntityId, WWPNotificationDefinitionDescription FROM WWP_NotificationDefinition WHERE WWPNotificationDefinitionId = :WWPNotificationDefinitionId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC00044,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("BC00049", "SAVEPOINT gxupdate;INSERT INTO WWP_Subscription(WWPSubscriptionEntityRecordId, WWPSubscriptionEntityRecordDescription, WWPSubscriptionRoleId, WWPSubscriptionSubscribed, WWPNotificationDefinitionId, WWPUserExtendedId) VALUES(:WWPSubscriptionEntityRecordId, :WWPSubscriptionEntityRecordDescription, :WWPSubscriptionRoleId, :WWPSubscriptionSubscribed, :WWPNotificationDefinitionId, :WWPUserExtendedId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmBC00049)
             ...
             ,new CursorDef("BC000413", "SELECT WWPEntityId, WWPNotificationDefinitionDescription FROM WWP_NotificationDefinition WHERE WWPNotificationDefinitionId = :WWPNotificationDefinitionId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000413,1, GxCacheFrequency.OFF ,true,false )
