   ...
   public class wwp_df_textarea_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_textarea_wc"+UrlEncode(StringUtil.RTrim(AV27WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV28WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_textarea_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_textarea_wc");
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_textarea_wc")), "workwithplus.dynamicforms.wwp_df_textarea_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_textarea_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void S182( )
      {
         ...
         {
            AV11DataCellNameClass = "RequiredDataContentCellFL " + AV11DataCellNameClass;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918382313", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_textarea_wc.js", "?202551918382313", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV15HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E121F2","iparms":[{"av":"AV32ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV8AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV28WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV14ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV6WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV10Data","fld":"vDATA","type":"svchar"},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         ...
         setEventMetadata("VDATA.CONTROLVALUECHANGED","""{"handler":"E141F2","iparms":[{"av":"AV15HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV6WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV28WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV10Data","fld":"vDATA","type":"svchar"},{"av":"AV30WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
