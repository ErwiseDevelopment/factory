...
namespace GeneXus.Programs {
   public class clientenotas : GXDataArea
   {
      ...
      public void ScanStart2R28( )
      {
         ...
         {
            RcdFound28 = 1;
            A168ClienteId = T002R36_A168ClienteId[0];
            n168ClienteId = T002R36_n168ClienteId[0];
            AssignAttri("", false, "A168ClienteId", StringUtil.LTrimStr( (decimal)(A168ClienteId), 9, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918515141", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("clientenotas.js", "?202551918515142", false, true);
      ...
      public override void initialize( )
      {
         ...
         T002R18_A323PropostaId = new int[1] ;
         T002R19_A323PropostaId = new int[1] ;
         T002R20_A323PropostaId = new int[1] ;
         T002R21_A323PropostaId = new int[1] ;
         T002R22_A227ContratoId = new int[1] ;
         T002R23_A261TituloId = new int[1] ;
         T002R24_A133SecUserId = new short[1] ;
         T002R25_A978RepresentanteId = new int[1] ;
         T002R26_A856CreditoId = new int[1] ;
         T002R27_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         T002R28_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         T002R29_A662SerasaId = new int[1] ;
         T002R30_A599ClienteDocumentoId = new int[1] ;
         T002R31_A551ClienteReponsavelId = new int[1] ;
         T002R32_A551ClienteReponsavelId = new int[1] ;
         T002R33_A242AssinaturaParticipanteId = new int[1] ;
         T002R34_A223FinanciamentoId = new int[1] ;
         T002R35_A223FinanciamentoId = new int[1] ;
         T002R36_A168ClienteId = new int[1] ;
         T002R36_n168ClienteId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientenotas__default(),
            new Object[][] {
               ...
               , new Object[] {
               T002R22_A227ContratoId
               }
               , new Object[] {
               T002R23_A261TituloId
               }
               , new Object[] {
               T002R24_A133SecUserId
               }
               , new Object[] {
               T002R25_A978RepresentanteId
               }
               , new Object[] {
               T002R26_A856CreditoId
               }
               , new Object[] {
               T002R27_A794NotaFiscalId
               }
               , new Object[] {
               T002R28_A794NotaFiscalId
               }
               , new Object[] {
               T002R29_A662SerasaId
               }
               , new Object[] {
               T002R30_A599ClienteDocumentoId
               }
               , new Object[] {
               T002R31_A551ClienteReponsavelId
               }
               , new Object[] {
               T002R32_A551ClienteReponsavelId
               }
               , new Object[] {
               T002R33_A242AssinaturaParticipanteId
               }
               , new Object[] {
               T002R34_A223FinanciamentoId
               }
               , new Object[] {
               T002R35_A223FinanciamentoId
               }
               , new Object[] {
               T002R36_A168ClienteId
               }
            }
         );
      }
      ...
      private int[] T002R18_A323PropostaId ;
      private int[] T002R19_A323PropostaId ;
      private int[] T002R20_A323PropostaId ;
      private int[] T002R21_A323PropostaId ;
      private int[] T002R22_A227ContratoId ;
      private int[] T002R23_A261TituloId ;
      private short[] T002R24_A133SecUserId ;
      private int[] T002R25_A978RepresentanteId ;
      private int[] T002R26_A856CreditoId ;
      private Guid[] T002R27_A794NotaFiscalId ;
      private Guid[] T002R28_A794NotaFiscalId ;
      private int[] T002R29_A662SerasaId ;
      private int[] T002R30_A599ClienteDocumentoId ;
      private int[] T002R31_A551ClienteReponsavelId ;
      private int[] T002R32_A551ClienteReponsavelId ;
      private int[] T002R33_A242AssinaturaParticipanteId ;
      private int[] T002R34_A223FinanciamentoId ;
      private int[] T002R35_A223FinanciamentoId ;
      private int[] T002R36_A168ClienteId ;
      private bool[] T002R36_n168ClienteId ;
   }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T002R18", "SELECT PropostaId FROM Proposta WHERE PropostaEmpresaClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R18,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R19", "SELECT PropostaId FROM Proposta WHERE PropostaClinicaId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R19,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R20", "SELECT PropostaId FROM Proposta WHERE PropostaResponsavelId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R20,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R21", "SELECT PropostaId FROM Proposta WHERE PropostaPacienteClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R21,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R22", "SELECT ContratoId FROM Contrato WHERE ContratoClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R22,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R23", "SELECT TituloId FROM Titulo WHERE TituloClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R23,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R24", "SELECT SecUserId FROM SecUser WHERE SecUserOwnerId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R24,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R25", "SELECT RepresentanteId FROM Representante WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R25,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R26", "SELECT CreditoId FROM Credito WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R26,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R27", "SELECT NotaFiscalId FROM NotaFiscal WHERE NotaFiscalDestinatarioClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R27,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R28", "SELECT NotaFiscalId FROM NotaFiscal WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R28,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R29", "SELECT SerasaId FROM Serasa WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R29,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R30", "SELECT ClienteDocumentoId FROM ClienteDocumento WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R30,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R31", "SELECT ClienteReponsavelId FROM ClienteReponsavel WHERE ReponsavelClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R31,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R32", "SELECT ClienteReponsavelId FROM ClienteReponsavel WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R32,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R33", "SELECT AssinaturaParticipanteId FROM AssinaturaParticipante WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R33,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R34", "SELECT FinanciamentoId FROM Financiamento WHERE IntermediadorClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R34,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R35", "SELECT FinanciamentoId FROM Financiamento WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R35,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002R36", "SELECT ClienteId FROM Cliente ORDER BY ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002R36,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
