...
namespace GeneXus.Programs {
   public class propostacontrato : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "propostacontrato")), "propostacontrato") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "propostacontrato")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public propostacontrato( IGxContext context )
      {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaCreatedAt_Internalname, context.localUtil.TToC( A327PropostaCreatedAt, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A327PropostaCreatedAt, "99/99/99 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'por',false,0);"+";gx.evt.onblur(this,37);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaCreatedAt_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaCreatedAt_Enabled, 0, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContrato.htm");
         GxWebStd.gx_bitmap( context, edtPropostaCreatedAt_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtPropostaCreatedAt_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_PropostaContrato.htm");
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockpropostacratedby_Internalname, "Crated By", "", "", lblTextblockpropostacratedby_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( context, cmbPropostaStatus, cmbPropostaStatus_Internalname, StringUtil.RTrim( A329PropostaStatus), 1, cmbPropostaStatus_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbPropostaStatus.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,53);\"", "", true, 0, "HLP_PropostaContrato.htm");
         cmbPropostaStatus.CurrentValue = StringUtil.RTrim( A329PropostaStatus);
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockcontratoid_Internalname, "Contrato", "", "", lblTextblockcontratoid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
         /* User Defined Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtContratoId_Internalname, ((0==A227ContratoId)&&IsIns( )||n227ContratoId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A227ContratoId), 6, 0, ",", ""))), ((0==A227ContratoId)&&IsIns( )||n227ContratoId ? "" : StringUtil.LTrim( context.localUtil.Format( (decimal)(A227ContratoId), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtContratoId_Jsonclick, 0, "Attribute", "", "", "", "", edtContratoId_Visible, edtContratoId_Enabled, 1, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaQuantidadeAprovadores_Internalname, ((0==A330PropostaQuantidadeAprovadores)&&IsIns( )||n330PropostaQuantidadeAprovadores ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A330PropostaQuantidadeAprovadores), 4, 0, ",", ""))), ((0==A330PropostaQuantidadeAprovadores)&&IsIns( )||n330PropostaQuantidadeAprovadores ? "" : StringUtil.LTrim( ((edtPropostaQuantidadeAprovadores_Enabled!=0) ? context.localUtil.Format( (decimal)(A330PropostaQuantidadeAprovadores), "ZZZ9") : context.localUtil.Format( (decimal)(A330PropostaQuantidadeAprovadores), "ZZZ9")))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaQuantidadeAprovadores_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaQuantidadeAprovadores_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockprocedimentosmedicosid_Internalname, "Procedimentos Medicos", "", "", lblTextblockprocedimentosmedicosid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
         /* User Defined Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaAprovacoes_F_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A341PropostaAprovacoes_F), 4, 0, ",", "")), StringUtil.LTrim( ((edtPropostaAprovacoes_F_Enabled!=0) ? context.localUtil.Format( (decimal)(A341PropostaAprovacoes_F), "ZZZ9") : context.localUtil.Format( (decimal)(A341PropostaAprovacoes_F), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,90);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaAprovacoes_F_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaAprovacoes_F_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaReprovacoes_F_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A342PropostaReprovacoes_F), 4, 0, ",", "")), StringUtil.LTrim( ((edtPropostaReprovacoes_F_Enabled!=0) ? context.localUtil.Format( (decimal)(A342PropostaReprovacoes_F), "ZZZ9") : context.localUtil.Format( (decimal)(A342PropostaReprovacoes_F), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,95);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaReprovacoes_F_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaReprovacoes_F_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaAprovacoesRestantes_F_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A343PropostaAprovacoesRestantes_F), 4, 0, ",", "")), StringUtil.LTrim( ((edtPropostaAprovacoesRestantes_F_Enabled!=0) ? context.localUtil.Format( (decimal)(A343PropostaAprovacoesRestantes_F), "ZZZ9") : context.localUtil.Format( (decimal)(A343PropostaAprovacoesRestantes_F), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,100);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaAprovacoesRestantes_F_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaAprovacoesRestantes_F_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         ClassString = "Button";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_enter_Internalname, "", "Confirmar", bttBtntrn_enter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, bttBtntrn_enter_Visible, bttBtntrn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_cancel_Internalname, "", "Fechar", bttBtntrn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, bttBtntrn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         ClassString = "BtnDefault";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_delete_Internalname, "", "Eliminar", bttBtntrn_delete_Jsonclick, 5, "Eliminar", "", StyleString, ClassString, bttBtntrn_delete_Visible, bttBtntrn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", context.GetButtonType( ), "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtavCombopropostacratedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV19ComboPropostaCratedBy), 4, 0, ",", "")), StringUtil.LTrim( ((edtavCombopropostacratedby_Enabled!=0) ? context.localUtil.Format( (decimal)(AV19ComboPropostaCratedBy), "ZZZ9") : context.localUtil.Format( (decimal)(AV19ComboPropostaCratedBy), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,114);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCombopropostacratedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavCombopropostacratedby_Visible, edtavCombopropostacratedby_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, divSectionattribute_contratoid_Internalname, 1, 0, "px", 0, "px", "Section", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 116,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtavCombocontratoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22ComboContratoId), 6, 0, ",", "")), StringUtil.LTrim( ((edtavCombocontratoid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV22ComboContratoId), "ZZZZZ9") : context.localUtil.Format( (decimal)(AV22ComboContratoId), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,116);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCombocontratoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCombocontratoid_Visible, edtavCombocontratoid_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContrato.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               A792WorkFlowPasso_F = cgiGet( "WORKFLOWPASSO_F");
               n792WorkFlowPasso_F = false;
               A548ReembolsoStatusAtual_F = cgiGet( "REEMBOLSOSTATUSATUAL_F");
               ...
               forbiddenHiddens.Add("hshsalt", "hsh"+"PropostaContrato");
               A323PropostaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtPropostaId_Internalname), ",", "."), 18, MidpointRounding.ToEven));
               n323PropostaId = false;
               AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
               ...
               {
                  GXUtil.WriteLogError("propostacontrato:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
                  GxWebError = 1;
                  context.HttpContext.Response.StatusCode = 403;
                  context.WriteHtmlText( "<title>403 Forbidden</title>") ;
                  context.WriteHtmlText( "<h1>403 Forbidden</h1>") ;
      ...
      protected void E11222( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV9TrnContext.gxTpr_Transactionname, AV31Pgmname) == 0 ) && ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) )
         {
            ...
            {
               AV13TrnContextAtt = ((GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute)AV9TrnContext.gxTpr_Attributes.Item(AV32GXV1));
               if ( StringUtil.StrCmp(AV13TrnContextAtt.gxTpr_Attributename, "ProcedimentosMedicosId") == 0 )
               {
                  ...
                  if ( ! (0==AV24Insert_ProcedimentosMedicosId) )
                  {
                     ...
                     new propostacontratoloaddvcombo(context ).execute(  "ProcedimentosMedicosId",  "GET",  false,  AV7PropostaId,  AV13TrnContextAtt.gxTpr_Attributevalue, out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
               ...
               else if ( StringUtil.StrCmp(AV13TrnContextAtt.gxTpr_Attributename, "PropostaCratedBy") == 0 )
               {
                  ...
                  if ( ! (0==AV11Insert_PropostaCratedBy) )
                  {
                     ...
                     GXt_char2 = AV18Combo_DataJson;
                     new propostacontratoloaddvcombo(context ).execute(  "PropostaCratedBy",  "GET",  false,  AV7PropostaId,  AV13TrnContextAtt.gxTpr_Attributevalue, out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
                     AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
                     AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
                     AV18Combo_DataJson = GXt_char2;
                     AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
               ...
               else if ( StringUtil.StrCmp(AV13TrnContextAtt.gxTpr_Attributename, "ContratoId") == 0 )
               {
                  ...
                  if ( ! (0==AV12Insert_ContratoId) )
                  {
                     ...
                     GXt_char2 = AV18Combo_DataJson;
                     new propostacontratoloaddvcombo(context ).execute(  "ContratoId",  "GET",  false,  AV7PropostaId,  AV13TrnContextAtt.gxTpr_Attributevalue, out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
                     AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
                     AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
                     AV18Combo_DataJson = GXt_char2;
                     AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
      ...
      protected void E12222( )
      {
         ...
         {
            CallWebObject(formatLink("propostacontratoww") );
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         GXt_char2 = AV18Combo_DataJson;
         new propostacontratoloaddvcombo(context ).execute(  "ProcedimentosMedicosId",  Gx_mode,  false,  AV7PropostaId,  "", out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
         AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
         AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
         AV18Combo_DataJson = GXt_char2;
         AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         GXt_char2 = AV18Combo_DataJson;
         new propostacontratoloaddvcombo(context ).execute(  "ContratoId",  Gx_mode,  false,  AV7PropostaId,  "", out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
         AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
         AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
         AV18Combo_DataJson = GXt_char2;
         AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         GXt_char2 = AV18Combo_DataJson;
         new propostacontratoloaddvcombo(context ).execute(  "PropostaCratedBy",  Gx_mode,  false,  AV7PropostaId,  "", out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
         AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
         AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
         AV18Combo_DataJson = GXt_char2;
         AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
      ...
      protected void ZM2249( short GX_JID )
      {
         if ( ( GX_JID == 20 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z327PropostaCreatedAt = T00223_A327PropostaCreatedAt[0];
               Z324PropostaTitulo = T00223_A324PropostaTitulo[0];
               Z325PropostaDescricao = T00223_A325PropostaDescricao[0];
               Z326PropostaValor = T00223_A326PropostaValor[0];
               Z329PropostaStatus = T00223_A329PropostaStatus[0];
               Z330PropostaQuantidadeAprovadores = T00223_A330PropostaQuantidadeAprovadores[0];
               Z345PropostaReprovacoesPermitidas = T00223_A345PropostaReprovacoesPermitidas[0];
               Z227ContratoId = T00223_A227ContratoId[0];
               Z376ProcedimentosMedicosId = T00223_A376ProcedimentosMedicosId[0];
               Z328PropostaCratedBy = T00223_A328PropostaCratedBy[0];
               Z504PropostaPacienteClienteId = T00223_A504PropostaPacienteClienteId[0];
            }
            else
            {
      ...
      protected void standaloneModal( )
      {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ( Gx_BScreen == 0 ) )
         {
            ...
            {
               A792WorkFlowPasso_F = T00229_A792WorkFlowPasso_F[0];
               n792WorkFlowPasso_F = T00229_n792WorkFlowPasso_F[0];
            }
            else
            {
               A792WorkFlowPasso_F = "";
               n792WorkFlowPasso_F = false;
               AssignAttri("", false, "A792WorkFlowPasso_F", A792WorkFlowPasso_F);
            }
            pr_default.close(6);
            ...
            {
               A341PropostaAprovacoes_F = T002211_A341PropostaAprovacoes_F[0];
               n341PropostaAprovacoes_F = T002211_n341PropostaAprovacoes_F[0];
               AssignAttri("", false, "A341PropostaAprovacoes_F", StringUtil.LTrimStr( (decimal)(A341PropostaAprovacoes_F), 4, 0));
            }
            else
            {
            ...
            pr_default.close(7);
            /* Using cursor T002213 */
            pr_default.execute(8, new Object[] {n323PropostaId, A323PropostaId});
            if ( (pr_default.getStatus(8) != 101) )
            {
               A342PropostaReprovacoes_F = T002213_A342PropostaReprovacoes_F[0];
               n342PropostaReprovacoes_F = T002213_n342PropostaReprovacoes_F[0];
               AssignAttri("", false, "A342PropostaReprovacoes_F", StringUtil.LTrimStr( (decimal)(A342PropostaReprovacoes_F), 4, 0));
            }
            else
            {
            ...
            {
               A548ReembolsoStatusAtual_F = T002216_A548ReembolsoStatusAtual_F[0];
               n548ReembolsoStatusAtual_F = T002216_n548ReembolsoStatusAtual_F[0];
            }
            else
            {
            ...
            A505PropostaPacienteClienteRazaoSocial = T00227_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = T00227_n505PropostaPacienteClienteRazaoSocial[0];
            pr_default.close(5);
         }
      }
      ...
      {
         /* Using cursor T002222 */
         pr_default.execute(10, new Object[] {n323PropostaId, A323PropostaId});
         if ( (pr_default.getStatus(10) != 101) )
         {
            RcdFound49 = 1;
            A327PropostaCreatedAt = T002222_A327PropostaCreatedAt[0];
            n327PropostaCreatedAt = T002222_n327PropostaCreatedAt[0];
            AssignAttri("", false, "A327PropostaCreatedAt", context.localUtil.TToC( A327PropostaCreatedAt, 8, 5, 0, 3, "/", ":", " "));
            A324PropostaTitulo = T002222_A324PropostaTitulo[0];
            n324PropostaTitulo = T002222_n324PropostaTitulo[0];
            AssignAttri("", false, "A324PropostaTitulo", A324PropostaTitulo);
            A325PropostaDescricao = T002222_A325PropostaDescricao[0];
            n325PropostaDescricao = T002222_n325PropostaDescricao[0];
            AssignAttri("", false, "A325PropostaDescricao", A325PropostaDescricao);
            A326PropostaValor = T002222_A326PropostaValor[0];
            n326PropostaValor = T002222_n326PropostaValor[0];
            ...
            A329PropostaStatus = T002222_A329PropostaStatus[0];
            n329PropostaStatus = T002222_n329PropostaStatus[0];
            AssignAttri("", false, "A329PropostaStatus", A329PropostaStatus);
            A228ContratoNome = T002222_A228ContratoNome[0];
            n228ContratoNome = T002222_n228ContratoNome[0];
            A330PropostaQuantidadeAprovadores = T002222_A330PropostaQuantidadeAprovadores[0];
            n330PropostaQuantidadeAprovadores = T002222_n330PropostaQuantidadeAprovadores[0];
            ...
            A345PropostaReprovacoesPermitidas = T002222_A345PropostaReprovacoesPermitidas[0];
            n345PropostaReprovacoesPermitidas = T002222_n345PropostaReprovacoesPermitidas[0];
            ...
            A505PropostaPacienteClienteRazaoSocial = T002222_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = T002222_n505PropostaPacienteClienteRazaoSocial[0];
            A227ContratoId = T002222_A227ContratoId[0];
            n227ContratoId = T002222_n227ContratoId[0];
            AssignAttri("", false, "A227ContratoId", ((0==A227ContratoId)&&IsIns( )||n227ContratoId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A227ContratoId), 6, 0, ".", ""))));
            A376ProcedimentosMedicosId = T002222_A376ProcedimentosMedicosId[0];
            n376ProcedimentosMedicosId = T002222_n376ProcedimentosMedicosId[0];
            AssignAttri("", false, "A376ProcedimentosMedicosId", ((0==A376ProcedimentosMedicosId)&&IsIns( )||n376ProcedimentosMedicosId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A376ProcedimentosMedicosId), 9, 0, ".", ""))));
            A328PropostaCratedBy = T002222_A328PropostaCratedBy[0];
            n328PropostaCratedBy = T002222_n328PropostaCratedBy[0];
            AssignAttri("", false, "A328PropostaCratedBy", ((0==A328PropostaCratedBy)&&IsIns( )||n328PropostaCratedBy ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A328PropostaCratedBy), 4, 0, ".", ""))));
            A504PropostaPacienteClienteId = T002222_A504PropostaPacienteClienteId[0];
            n504PropostaPacienteClienteId = T002222_n504PropostaPacienteClienteId[0];
            A792WorkFlowPasso_F = T002222_A792WorkFlowPasso_F[0];
            n792WorkFlowPasso_F = T002222_n792WorkFlowPasso_F[0];
            A341PropostaAprovacoes_F = T002222_A341PropostaAprovacoes_F[0];
            n341PropostaAprovacoes_F = T002222_n341PropostaAprovacoes_F[0];
            AssignAttri("", false, "A341PropostaAprovacoes_F", StringUtil.LTrimStr( (decimal)(A341PropostaAprovacoes_F), 4, 0));
            A342PropostaReprovacoes_F = T002222_A342PropostaReprovacoes_F[0];
            n342PropostaReprovacoes_F = T002222_n342PropostaReprovacoes_F[0];
            AssignAttri("", false, "A342PropostaReprovacoes_F", StringUtil.LTrimStr( (decimal)(A342PropostaReprovacoes_F), 4, 0));
            A548ReembolsoStatusAtual_F = T002222_A548ReembolsoStatusAtual_F[0];
            n548ReembolsoStatusAtual_F = T002222_n548ReembolsoStatusAtual_F[0];
            ZM2249( -20) ;
         }
         pr_default.close(10);
         OnLoadActions2249( ) ;
      ...
      protected void CheckExtendedTable2249( )
      {
         ...
         A228ContratoNome = T00224_A228ContratoNome[0];
         n228ContratoNome = T00224_n228ContratoNome[0];
         pr_default.close(2);
         /* Using cursor T00227 */
         pr_default.execute(5, new Object[] {n504PropostaPacienteClienteId, A504PropostaPacienteClienteId});
      ...
      protected void gxLoad_25( int A323PropostaId )
      {
         ...
         {
            A792WorkFlowPasso_F = T002224_A792WorkFlowPasso_F[0];
            n792WorkFlowPasso_F = T002224_n792WorkFlowPasso_F[0];
         }
         else
         {
            A792WorkFlowPasso_F = "";
         ...
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( A792WorkFlowPasso_F)+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(11) == 101) )
         {
            AddString( ",") ;
      ...
      protected void gxLoad_26( int A323PropostaId )
      {
         ...
         {
            A341PropostaAprovacoes_F = T002226_A341PropostaAprovacoes_F[0];
            n341PropostaAprovacoes_F = T002226_n341PropostaAprovacoes_F[0];
            AssignAttri("", false, "A341PropostaAprovacoes_F", StringUtil.LTrimStr( (decimal)(A341PropostaAprovacoes_F), 4, 0));
         }
         else
         {
      ...
      protected void gxLoad_27( int A323PropostaId )
      {
         /* Using cursor T002228 */
         pr_default.execute(13, new Object[] {n323PropostaId, A323PropostaId});
         if ( (pr_default.getStatus(13) != 101) )
         {
            A342PropostaReprovacoes_F = T002228_A342PropostaReprovacoes_F[0];
            n342PropostaReprovacoes_F = T002228_n342PropostaReprovacoes_F[0];
            AssignAttri("", false, "A342PropostaReprovacoes_F", StringUtil.LTrimStr( (decimal)(A342PropostaReprovacoes_F), 4, 0));
         }
         else
         {
      ...
      protected void gxLoad_28( int A323PropostaId )
      {
         /* Using cursor T002231 */
         pr_default.execute(14, new Object[] {n323PropostaId, A323PropostaId});
         if ( (pr_default.getStatus(14) != 101) )
         {
            A548ReembolsoStatusAtual_F = T002231_A548ReembolsoStatusAtual_F[0];
            n548ReembolsoStatusAtual_F = T002231_n548ReembolsoStatusAtual_F[0];
         }
         else
         {
            A548ReembolsoStatusAtual_F = "";
         ...
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( A548ReembolsoStatusAtual_F)+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(14) == 101) )
         {
            AddString( ",") ;
      ...
      protected void gxLoad_22( int A376ProcedimentosMedicosId )
      {
         ...
         pr_default.execute(15, new Object[] {n376ProcedimentosMedicosId, A376ProcedimentosMedicosId});
      ...
      protected void gxLoad_23( short A328PropostaCratedBy )
      {
         ...
         pr_default.execute(16, new Object[] {n328PropostaCratedBy, A328PropostaCratedBy});
      ...
      protected void gxLoad_21( int A227ContratoId )
      {
         ...
         A228ContratoNome = T002234_A228ContratoNome[0];
         n228ContratoNome = T002234_n228ContratoNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_24( int A504PropostaPacienteClienteId )
      {
         ...
         A505PropostaPacienteClienteRazaoSocial = T002235_A505PropostaPacienteClienteRazaoSocial[0];
         n505PropostaPacienteClienteRazaoSocial = T002235_n505PropostaPacienteClienteRazaoSocial[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM2249( 20) ;
            RcdFound49 = 1;
            A323PropostaId = T00223_A323PropostaId[0];
            n323PropostaId = T00223_n323PropostaId[0];
            AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
            A327PropostaCreatedAt = T00223_A327PropostaCreatedAt[0];
            n327PropostaCreatedAt = T00223_n327PropostaCreatedAt[0];
            AssignAttri("", false, "A327PropostaCreatedAt", context.localUtil.TToC( A327PropostaCreatedAt, 8, 5, 0, 3, "/", ":", " "));
            A324PropostaTitulo = T00223_A324PropostaTitulo[0];
            n324PropostaTitulo = T00223_n324PropostaTitulo[0];
            AssignAttri("", false, "A324PropostaTitulo", A324PropostaTitulo);
            A325PropostaDescricao = T00223_A325PropostaDescricao[0];
            n325PropostaDescricao = T00223_n325PropostaDescricao[0];
            AssignAttri("", false, "A325PropostaDescricao", A325PropostaDescricao);
            A326PropostaValor = T00223_A326PropostaValor[0];
            n326PropostaValor = T00223_n326PropostaValor[0];
            AssignAttri("", false, "A326PropostaValor", ((Convert.ToDecimal(0)==A326PropostaValor)&&IsIns( )||n326PropostaValor ? "" : StringUtil.LTrim( StringUtil.NToC( A326PropostaValor, 18, 2, ".", ""))));
            A329PropostaStatus = T00223_A329PropostaStatus[0];
            n329PropostaStatus = T00223_n329PropostaStatus[0];
            AssignAttri("", false, "A329PropostaStatus", A329PropostaStatus);
            A330PropostaQuantidadeAprovadores = T00223_A330PropostaQuantidadeAprovadores[0];
            n330PropostaQuantidadeAprovadores = T00223_n330PropostaQuantidadeAprovadores[0];
            AssignAttri("", false, "A330PropostaQuantidadeAprovadores", ((0==A330PropostaQuantidadeAprovadores)&&IsIns( )||n330PropostaQuantidadeAprovadores ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A330PropostaQuantidadeAprovadores), 4, 0, ".", ""))));
            A345PropostaReprovacoesPermitidas = T00223_A345PropostaReprovacoesPermitidas[0];
            n345PropostaReprovacoesPermitidas = T00223_n345PropostaReprovacoesPermitidas[0];
            AssignAttri("", false, "A345PropostaReprovacoesPermitidas", ((0==A345PropostaReprovacoesPermitidas)&&IsIns( )||n345PropostaReprovacoesPermitidas ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A345PropostaReprovacoesPermitidas), 4, 0, ".", ""))));
            A227ContratoId = T00223_A227ContratoId[0];
            n227ContratoId = T00223_n227ContratoId[0];
            AssignAttri("", false, "A227ContratoId", ((0==A227ContratoId)&&IsIns( )||n227ContratoId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A227ContratoId), 6, 0, ".", ""))));
            A376ProcedimentosMedicosId = T00223_A376ProcedimentosMedicosId[0];
            n376ProcedimentosMedicosId = T00223_n376ProcedimentosMedicosId[0];
            AssignAttri("", false, "A376ProcedimentosMedicosId", ((0==A376ProcedimentosMedicosId)&&IsIns( )||n376ProcedimentosMedicosId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A376ProcedimentosMedicosId), 9, 0, ".", ""))));
            A328PropostaCratedBy = T00223_A328PropostaCratedBy[0];
            n328PropostaCratedBy = T00223_n328PropostaCratedBy[0];
            AssignAttri("", false, "A328PropostaCratedBy", ((0==A328PropostaCratedBy)&&IsIns( )||n328PropostaCratedBy ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A328PropostaCratedBy), 4, 0, ".", ""))));
            A504PropostaPacienteClienteId = T00223_A504PropostaPacienteClienteId[0];
            n504PropostaPacienteClienteId = T00223_n504PropostaPacienteClienteId[0];
            Z323PropostaId = A323PropostaId;
            sMode49 = Gx_mode;
            Gx_mode = "DSP";
            AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(20) != 101) && ( ( T002237_A323PropostaId[0] < A323PropostaId ) ) )
            {
               pr_default.readNext(20);
            }
            if ( (pr_default.getStatus(20) != 101) && ( ( T002237_A323PropostaId[0] > A323PropostaId ) ) )
            {
               A323PropostaId = T002237_A323PropostaId[0];
               n323PropostaId = T002237_n323PropostaId[0];
               AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
               RcdFound49 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(21) != 101) && ( ( T002238_A323PropostaId[0] > A323PropostaId ) ) )
            {
               pr_default.readNext(21);
            }
            if ( (pr_default.getStatus(21) != 101) && ( ( T002238_A323PropostaId[0] < A323PropostaId ) ) )
            {
               A323PropostaId = T002238_A323PropostaId[0];
               n323PropostaId = T002238_n323PropostaId[0];
               AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
               RcdFound49 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency2249( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( Z327PropostaCreatedAt != T00222_A327PropostaCreatedAt[0] ) || ( StringUtil.StrCmp(Z324PropostaTitulo, T00222_A324PropostaTitulo[0]) != 0 ) || ( StringUtil.StrCmp(Z325PropostaDescricao, T00222_A325PropostaDescricao[0]) != 0 ) || ( Z326PropostaValor != T00222_A326PropostaValor[0] ) || ( StringUtil.StrCmp(Z329PropostaStatus, T00222_A329PropostaStatus[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z330PropostaQuantidadeAprovadores != T00222_A330PropostaQuantidadeAprovadores[0] ) || ( Z345PropostaReprovacoesPermitidas != T00222_A345PropostaReprovacoesPermitidas[0] ) || ( Z227ContratoId != T00222_A227ContratoId[0] ) || ( Z376ProcedimentosMedicosId != T00222_A376ProcedimentosMedicosId[0] ) || ( Z328PropostaCratedBy != T00222_A328PropostaCratedBy[0] ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z504PropostaPacienteClienteId != T00222_A504PropostaPacienteClienteId[0] ) )
            {
               if ( Z327PropostaCreatedAt != T00222_A327PropostaCreatedAt[0] )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaCreatedAt");
                  GXUtil.WriteLogRaw("Old: ",Z327PropostaCreatedAt);
                  GXUtil.WriteLogRaw("Current: ",T00222_A327PropostaCreatedAt[0]);
               }
               if ( StringUtil.StrCmp(Z324PropostaTitulo, T00222_A324PropostaTitulo[0]) != 0 )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaTitulo");
                  GXUtil.WriteLogRaw("Old: ",Z324PropostaTitulo);
                  GXUtil.WriteLogRaw("Current: ",T00222_A324PropostaTitulo[0]);
               }
               if ( StringUtil.StrCmp(Z325PropostaDescricao, T00222_A325PropostaDescricao[0]) != 0 )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaDescricao");
                  GXUtil.WriteLogRaw("Old: ",Z325PropostaDescricao);
                  GXUtil.WriteLogRaw("Current: ",T00222_A325PropostaDescricao[0]);
               }
               if ( Z326PropostaValor != T00222_A326PropostaValor[0] )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaValor");
                  GXUtil.WriteLogRaw("Old: ",Z326PropostaValor);
                  GXUtil.WriteLogRaw("Current: ",T00222_A326PropostaValor[0]);
               }
               if ( StringUtil.StrCmp(Z329PropostaStatus, T00222_A329PropostaStatus[0]) != 0 )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaStatus");
                  GXUtil.WriteLogRaw("Old: ",Z329PropostaStatus);
                  GXUtil.WriteLogRaw("Current: ",T00222_A329PropostaStatus[0]);
               }
               if ( Z330PropostaQuantidadeAprovadores != T00222_A330PropostaQuantidadeAprovadores[0] )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaQuantidadeAprovadores");
                  GXUtil.WriteLogRaw("Old: ",Z330PropostaQuantidadeAprovadores);
                  GXUtil.WriteLogRaw("Current: ",T00222_A330PropostaQuantidadeAprovadores[0]);
               }
               if ( Z345PropostaReprovacoesPermitidas != T00222_A345PropostaReprovacoesPermitidas[0] )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaReprovacoesPermitidas");
                  GXUtil.WriteLogRaw("Old: ",Z345PropostaReprovacoesPermitidas);
                  GXUtil.WriteLogRaw("Current: ",T00222_A345PropostaReprovacoesPermitidas[0]);
               }
               if ( Z227ContratoId != T00222_A227ContratoId[0] )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"ContratoId");
                  GXUtil.WriteLogRaw("Old: ",Z227ContratoId);
                  GXUtil.WriteLogRaw("Current: ",T00222_A227ContratoId[0]);
               }
               if ( Z376ProcedimentosMedicosId != T00222_A376ProcedimentosMedicosId[0] )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"ProcedimentosMedicosId");
                  GXUtil.WriteLogRaw("Old: ",Z376ProcedimentosMedicosId);
                  GXUtil.WriteLogRaw("Current: ",T00222_A376ProcedimentosMedicosId[0]);
               }
               if ( Z328PropostaCratedBy != T00222_A328PropostaCratedBy[0] )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaCratedBy");
                  GXUtil.WriteLogRaw("Old: ",Z328PropostaCratedBy);
                  GXUtil.WriteLogRaw("Current: ",T00222_A328PropostaCratedBy[0]);
               }
               if ( Z504PropostaPacienteClienteId != T00222_A504PropostaPacienteClienteId[0] )
               {
                  GXUtil.WriteLog("propostacontrato:[seudo value changed for attri]"+"PropostaPacienteClienteId");
                  GXUtil.WriteLogRaw("Old: ",Z504PropostaPacienteClienteId);
                  GXUtil.WriteLogRaw("Current: ",T00222_A504PropostaPacienteClienteId[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(24, new Object[] {n327PropostaCreatedAt, A327PropostaCreatedAt, n324PropostaTitulo, A324PropostaTitulo, n325PropostaDescricao, A325PropostaDescricao, n326PropostaValor, A326PropostaValor, n329PropostaStatus, A329PropostaStatus, n330PropostaQuantidadeAprovadores, A330PropostaQuantidadeAprovadores, n345PropostaReprovacoesPermitidas, A345PropostaReprovacoesPermitidas, n227ContratoId, A227ContratoId, n376ProcedimentosMedicosId, A376ProcedimentosMedicosId, n328PropostaCratedBy, A328PropostaCratedBy, n504PropostaPacienteClienteId, A504PropostaPacienteClienteId, n323PropostaId, A323PropostaId});
                     pr_default.close(24);
                     pr_default.SmartCacheProvider.SetUpdated("Proposta");
      ...
      protected void OnDeleteControls2249( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            {
               A792WorkFlowPasso_F = T002244_A792WorkFlowPasso_F[0];
               n792WorkFlowPasso_F = T002244_n792WorkFlowPasso_F[0];
            }
            else
            {
               A792WorkFlowPasso_F = "";
            ...
            pr_default.close(26);
            /* Using cursor T002246 */
            pr_default.execute(27, new Object[] {n323PropostaId, A323PropostaId});
            if ( (pr_default.getStatus(27) != 101) )
            {
               A341PropostaAprovacoes_F = T002246_A341PropostaAprovacoes_F[0];
               n341PropostaAprovacoes_F = T002246_n341PropostaAprovacoes_F[0];
               AssignAttri("", false, "A341PropostaAprovacoes_F", StringUtil.LTrimStr( (decimal)(A341PropostaAprovacoes_F), 4, 0));
            }
            else
            {
            ...
            pr_default.close(27);
            /* Using cursor T002248 */
            pr_default.execute(28, new Object[] {n323PropostaId, A323PropostaId});
            if ( (pr_default.getStatus(28) != 101) )
            {
               A342PropostaReprovacoes_F = T002248_A342PropostaReprovacoes_F[0];
               n342PropostaReprovacoes_F = T002248_n342PropostaReprovacoes_F[0];
               AssignAttri("", false, "A342PropostaReprovacoes_F", StringUtil.LTrimStr( (decimal)(A342PropostaReprovacoes_F), 4, 0));
            }
            else
            {
            ...
            pr_default.close(28);
            /* Using cursor T002251 */
            pr_default.execute(29, new Object[] {n323PropostaId, A323PropostaId});
            if ( (pr_default.getStatus(29) != 101) )
            {
               A548ReembolsoStatusAtual_F = T002251_A548ReembolsoStatusAtual_F[0];
               n548ReembolsoStatusAtual_F = T002251_n548ReembolsoStatusAtual_F[0];
            }
            else
            {
               A548ReembolsoStatusAtual_F = "";
            ...
            pr_default.close(29);
            /* Using cursor T002252 */
            pr_default.execute(30, new Object[] {n227ContratoId, A227ContratoId});
            A228ContratoNome = T002252_A228ContratoNome[0];
            n228ContratoNome = T002252_n228ContratoNome[0];
            pr_default.close(30);
            A343PropostaAprovacoesRestantes_F = (short)(A330PropostaQuantidadeAprovadores-A341PropostaAprovacoes_F);
            AssignAttri("", false, "A343PropostaAprovacoesRestantes_F", StringUtil.LTrimStr( (decimal)(A343PropostaAprovacoesRestantes_F), 4, 0));
            /* Using cursor T002253 */
            pr_default.execute(31, new Object[] {n504PropostaPacienteClienteId, A504PropostaPacienteClienteId});
            A505PropostaPacienteClienteRazaoSocial = T002253_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = T002253_n505PropostaPacienteClienteRazaoSocial[0];
            pr_default.close(31);
         }
         if ( AnyError == 0 )
         {
            /* Using cursor T002254 */
            ...
            pr_default.close(33);
            /* Using cursor T002256 */
            pr_default.execute(34, new Object[] {n323PropostaId, A323PropostaId});
            ...
            pr_default.close(34);
            /* Using cursor T002257 */
            pr_default.execute(35, new Object[] {n323PropostaId, A323PropostaId});
            ...
            pr_default.close(35);
            /* Using cursor T002258 */
            pr_default.execute(36, new Object[] {n323PropostaId, A323PropostaId});
            ...
            pr_default.close(36);
            /* Using cursor T002259 */
            pr_default.execute(37, new Object[] {n323PropostaId, A323PropostaId});
            ...
            pr_default.close(37);
            /* Using cursor T002260 */
            pr_default.execute(38, new Object[] {n323PropostaId, A323PropostaId});
      ...
      protected void EndLevel2249( )
      {
         ...
         if ( AnyError == 0 )
         {
            context.CommitDataStores("propostacontrato",pr_default);
            if ( AnyError == 0 )
            {
               ConfirmValues220( ) ;
            }
         ...
         {
            context.RollbackDataStores("propostacontrato",pr_default);
         }
         IsModified = 0;
         if ( AnyError != 0 )
         {
      ...
      public void ScanStart2249( )
      {
         /* Scan By routine */
         /* Using cursor T002261 */
         pr_default.execute(39);
         RcdFound49 = 0;
         if ( (pr_default.getStatus(39) != 101) )
         {
            RcdFound49 = 1;
            A323PropostaId = T002261_A323PropostaId[0];
            n323PropostaId = T002261_n323PropostaId[0];
            AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext2249( )
      {
         /* Scan next routine */
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "propostacontrato"+UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.LTrimStr(AV7PropostaId,9,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormWithFixedActions\" data-gx-class=\"form-horizontal FormWithFixedActions\" novalidate action=\""+formatLink("propostacontrato") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLogInfo("propostacontrato:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "WORKFLOWPASSO_F", A792WorkFlowPasso_F);
         GxWebStd.gx_hidden_field( context, "REEMBOLSOSTATUSATUAL_F", A548ReembolsoStatusAtual_F);
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "propostacontrato"+UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.LTrimStr(AV7PropostaId,9,0));
         return formatLink("propostacontrato") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918491844", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("propostacontrato.js", "?202551918491844", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Combo_procedimentosmedicosid_Datalistproc = "PropostaContratoLoadDVCombo";
         ...
         Combo_contratoid_Datalistproc = "PropostaContratoLoadDVCombo";
         ...
         Combo_propostacratedby_Datalistproc = "PropostaContratoLoadDVCombo";
      ...
      public void Valid_Propostacratedby( )
      {
         ...
         /* Using cursor T002262 */
         pr_default.execute(40, new Object[] {n328PropostaCratedBy, A328PropostaCratedBy});
      ...
      public void Valid_Procedimentosmedicosid( )
      {
         ...
         /* Using cursor T002263 */
         pr_default.execute(41, new Object[] {n376ProcedimentosMedicosId, A376ProcedimentosMedicosId});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("AFTER TRN","""{"handler":"E12222","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true,"type":"char"},{"av":"AV9TrnContext","fld":"vTRNCONTEXT","hsh":true,"type":""}]}""");
         ...
         setEventMetadata("VALID_PROPOSTAID","""{"handler":"Valid_Propostaid","iparms":[{"av":"A323PropostaId","fld":"PROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A792WorkFlowPasso_F","fld":"WORKFLOWPASSO_F","type":"svchar"},{"av":"A341PropostaAprovacoes_F","fld":"PROPOSTAAPROVACOES_F","pic":"ZZZ9","type":"int"},{"av":"A342PropostaReprovacoes_F","fld":"PROPOSTAREPROVACOES_F","pic":"ZZZ9","type":"int"},{"av":"A548ReembolsoStatusAtual_F","fld":"REEMBOLSOSTATUSATUAL_F","type":"svchar"}]""");
         setEventMetadata("VALID_PROPOSTAID",""","oparms":[{"av":"A792WorkFlowPasso_F","fld":"WORKFLOWPASSO_F","type":"svchar"},{"av":"A341PropostaAprovacoes_F","fld":"PROPOSTAAPROVACOES_F","pic":"ZZZ9","type":"int"},{"av":"A342PropostaReprovacoes_F","fld":"PROPOSTAREPROVACOES_F","pic":"ZZZ9","type":"int"},{"av":"A548ReembolsoStatusAtual_F","fld":"REEMBOLSOSTATUSATUAL_F","type":"svchar"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         Z228ContratoNome = "";
         T00229_A792WorkFlowPasso_F = new string[] {""} ;
         T00229_n792WorkFlowPasso_F = new bool[] {false} ;
         T002211_A341PropostaAprovacoes_F = new short[1] ;
         T002211_n341PropostaAprovacoes_F = new bool[] {false} ;
         T002213_A342PropostaReprovacoes_F = new short[1] ;
         T002213_n342PropostaReprovacoes_F = new bool[] {false} ;
         T002216_A548ReembolsoStatusAtual_F = new string[] {""} ;
         T002216_n548ReembolsoStatusAtual_F = new bool[] {false} ;
         T00227_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         T00227_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         T002222_A323PropostaId = new int[1] ;
         T002222_n323PropostaId = new bool[] {false} ;
         T002222_A327PropostaCreatedAt = new DateTime[] {DateTime.MinValue} ;
         T002222_n327PropostaCreatedAt = new bool[] {false} ;
         T002222_A324PropostaTitulo = new string[] {""} ;
         T002222_n324PropostaTitulo = new bool[] {false} ;
         T002222_A325PropostaDescricao = new string[] {""} ;
         T002222_n325PropostaDescricao = new bool[] {false} ;
         T002222_A326PropostaValor = new decimal[1] ;
         T002222_n326PropostaValor = new bool[] {false} ;
         T002222_A329PropostaStatus = new string[] {""} ;
         T002222_n329PropostaStatus = new bool[] {false} ;
         T002222_A228ContratoNome = new string[] {""} ;
         T002222_n228ContratoNome = new bool[] {false} ;
         T002222_A330PropostaQuantidadeAprovadores = new short[1] ;
         T002222_n330PropostaQuantidadeAprovadores = new bool[] {false} ;
         T002222_A345PropostaReprovacoesPermitidas = new short[1] ;
         T002222_n345PropostaReprovacoesPermitidas = new bool[] {false} ;
         T002222_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         T002222_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         T002222_A227ContratoId = new int[1] ;
         T002222_n227ContratoId = new bool[] {false} ;
         T002222_A376ProcedimentosMedicosId = new int[1] ;
         T002222_n376ProcedimentosMedicosId = new bool[] {false} ;
         T002222_A328PropostaCratedBy = new short[1] ;
         T002222_n328PropostaCratedBy = new bool[] {false} ;
         T002222_A504PropostaPacienteClienteId = new int[1] ;
         T002222_n504PropostaPacienteClienteId = new bool[] {false} ;
         T002222_A792WorkFlowPasso_F = new string[] {""} ;
         T002222_n792WorkFlowPasso_F = new bool[] {false} ;
         T002222_A341PropostaAprovacoes_F = new short[1] ;
         T002222_n341PropostaAprovacoes_F = new bool[] {false} ;
         T002222_A342PropostaReprovacoes_F = new short[1] ;
         T002222_n342PropostaReprovacoes_F = new bool[] {false} ;
         T002222_A548ReembolsoStatusAtual_F = new string[] {""} ;
         T002222_n548ReembolsoStatusAtual_F = new bool[] {false} ;
         T00225_A376ProcedimentosMedicosId = new int[1] ;
         T00225_n376ProcedimentosMedicosId = new bool[] {false} ;
         T00226_A328PropostaCratedBy = new short[1] ;
         T00226_n328PropostaCratedBy = new bool[] {false} ;
         T00224_A228ContratoNome = new string[] {""} ;
         T00224_n228ContratoNome = new bool[] {false} ;
         T002224_A792WorkFlowPasso_F = new string[] {""} ;
         T002224_n792WorkFlowPasso_F = new bool[] {false} ;
         T002226_A341PropostaAprovacoes_F = new short[1] ;
         T002226_n341PropostaAprovacoes_F = new bool[] {false} ;
         T002228_A342PropostaReprovacoes_F = new short[1] ;
         T002228_n342PropostaReprovacoes_F = new bool[] {false} ;
         T002231_A548ReembolsoStatusAtual_F = new string[] {""} ;
         T002231_n548ReembolsoStatusAtual_F = new bool[] {false} ;
         T002232_A376ProcedimentosMedicosId = new int[1] ;
         T002232_n376ProcedimentosMedicosId = new bool[] {false} ;
         T002233_A328PropostaCratedBy = new short[1] ;
         T002233_n328PropostaCratedBy = new bool[] {false} ;
         T002234_A228ContratoNome = new string[] {""} ;
         T002234_n228ContratoNome = new bool[] {false} ;
         T002235_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         T002235_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         T002236_A323PropostaId = new int[1] ;
         T002236_n323PropostaId = new bool[] {false} ;
         T00223_A323PropostaId = new int[1] ;
         T00223_n323PropostaId = new bool[] {false} ;
         T00223_A327PropostaCreatedAt = new DateTime[] {DateTime.MinValue} ;
         T00223_n327PropostaCreatedAt = new bool[] {false} ;
         T00223_A324PropostaTitulo = new string[] {""} ;
         T00223_n324PropostaTitulo = new bool[] {false} ;
         T00223_A325PropostaDescricao = new string[] {""} ;
         T00223_n325PropostaDescricao = new bool[] {false} ;
         T00223_A326PropostaValor = new decimal[1] ;
         T00223_n326PropostaValor = new bool[] {false} ;
         T00223_A329PropostaStatus = new string[] {""} ;
         T00223_n329PropostaStatus = new bool[] {false} ;
         T00223_A330PropostaQuantidadeAprovadores = new short[1] ;
         T00223_n330PropostaQuantidadeAprovadores = new bool[] {false} ;
         T00223_A345PropostaReprovacoesPermitidas = new short[1] ;
         T00223_n345PropostaReprovacoesPermitidas = new bool[] {false} ;
         T00223_A227ContratoId = new int[1] ;
         T00223_n227ContratoId = new bool[] {false} ;
         T00223_A376ProcedimentosMedicosId = new int[1] ;
         T00223_n376ProcedimentosMedicosId = new bool[] {false} ;
         T00223_A328PropostaCratedBy = new short[1] ;
         T00223_n328PropostaCratedBy = new bool[] {false} ;
         T00223_A504PropostaPacienteClienteId = new int[1] ;
         T00223_n504PropostaPacienteClienteId = new bool[] {false} ;
         T002237_A323PropostaId = new int[1] ;
         T002237_n323PropostaId = new bool[] {false} ;
         T002238_A323PropostaId = new int[1] ;
         T002238_n323PropostaId = new bool[] {false} ;
         T00222_A323PropostaId = new int[1] ;
         T00222_n323PropostaId = new bool[] {false} ;
         T00222_A327PropostaCreatedAt = new DateTime[] {DateTime.MinValue} ;
         T00222_n327PropostaCreatedAt = new bool[] {false} ;
         T00222_A324PropostaTitulo = new string[] {""} ;
         T00222_n324PropostaTitulo = new bool[] {false} ;
         T00222_A325PropostaDescricao = new string[] {""} ;
         T00222_n325PropostaDescricao = new bool[] {false} ;
         T00222_A326PropostaValor = new decimal[1] ;
         T00222_n326PropostaValor = new bool[] {false} ;
         T00222_A329PropostaStatus = new string[] {""} ;
         T00222_n329PropostaStatus = new bool[] {false} ;
         T00222_A330PropostaQuantidadeAprovadores = new short[1] ;
         T00222_n330PropostaQuantidadeAprovadores = new bool[] {false} ;
         T00222_A345PropostaReprovacoesPermitidas = new short[1] ;
         T00222_n345PropostaReprovacoesPermitidas = new bool[] {false} ;
         T00222_A227ContratoId = new int[1] ;
         T00222_n227ContratoId = new bool[] {false} ;
         T00222_A376ProcedimentosMedicosId = new int[1] ;
         T00222_n376ProcedimentosMedicosId = new bool[] {false} ;
         T00222_A328PropostaCratedBy = new short[1] ;
         T00222_n328PropostaCratedBy = new bool[] {false} ;
         T00222_A504PropostaPacienteClienteId = new int[1] ;
         T00222_n504PropostaPacienteClienteId = new bool[] {false} ;
         T002240_A323PropostaId = new int[1] ;
         T002240_n323PropostaId = new bool[] {false} ;
         T002244_A792WorkFlowPasso_F = new string[] {""} ;
         T002244_n792WorkFlowPasso_F = new bool[] {false} ;
         T002246_A341PropostaAprovacoes_F = new short[1] ;
         T002246_n341PropostaAprovacoes_F = new bool[] {false} ;
         T002248_A342PropostaReprovacoes_F = new short[1] ;
         T002248_n342PropostaReprovacoes_F = new bool[] {false} ;
         T002251_A548ReembolsoStatusAtual_F = new string[] {""} ;
         T002251_n548ReembolsoStatusAtual_F = new bool[] {false} ;
         T002252_A228ContratoNome = new string[] {""} ;
         T002252_n228ContratoNome = new bool[] {false} ;
         T002253_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         T002253_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         T002254_A227ContratoId = new int[1] ;
         T002254_n227ContratoId = new bool[] {false} ;
         T002255_A518ReembolsoId = new int[1] ;
         T002255_n518ReembolsoId = new bool[] {false} ;
         T002256_A261TituloId = new int[1] ;
         T002257_A830NotaFiscalItemId = new Guid[] {Guid.Empty} ;
         T002258_A572PropostaContratoAssinaturaId = new int[1] ;
         T002259_A414PropostaDocumentosId = new int[1] ;
         T002260_A336AprovacaoId = new int[1] ;
         T002261_A323PropostaId = new int[1] ;
         T002261_n323PropostaId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXEncryptionTmp = "";
         i327PropostaCreatedAt = (DateTime)(DateTime.MinValue);
         T002262_A328PropostaCratedBy = new short[1] ;
         T002262_n328PropostaCratedBy = new bool[] {false} ;
         T002263_A376ProcedimentosMedicosId = new int[1] ;
         T002263_n376ProcedimentosMedicosId = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.propostacontrato__default(),
            new Object[][] {
                new Object[] {
               T00222_A323PropostaId, T00222_A327PropostaCreatedAt, T00222_n327PropostaCreatedAt, T00222_A324PropostaTitulo, T00222_n324PropostaTitulo, T00222_A325PropostaDescricao, T00222_n325PropostaDescricao, T00222_A326PropostaValor, T00222_n326PropostaValor, T00222_A329PropostaStatus,
               T00222_n329PropostaStatus, T00222_A330PropostaQuantidadeAprovadores, T00222_n330PropostaQuantidadeAprovadores, T00222_A345PropostaReprovacoesPermitidas, T00222_n345PropostaReprovacoesPermitidas, T00222_A227ContratoId, T00222_n227ContratoId, T00222_A376ProcedimentosMedicosId, T00222_n376ProcedimentosMedicosId, T00222_A328PropostaCratedBy,
               T00222_n328PropostaCratedBy, T00222_A504PropostaPacienteClienteId, T00222_n504PropostaPacienteClienteId
               }
               , new Object[] {
               T00223_A323PropostaId, T00223_A327PropostaCreatedAt, T00223_n327PropostaCreatedAt, T00223_A324PropostaTitulo, T00223_n324PropostaTitulo, T00223_A325PropostaDescricao, T00223_n325PropostaDescricao, T00223_A326PropostaValor, T00223_n326PropostaValor, T00223_A329PropostaStatus,
               T00223_n329PropostaStatus, T00223_A330PropostaQuantidadeAprovadores, T00223_n330PropostaQuantidadeAprovadores, T00223_A345PropostaReprovacoesPermitidas, T00223_n345PropostaReprovacoesPermitidas, T00223_A227ContratoId, T00223_n227ContratoId, T00223_A376ProcedimentosMedicosId, T00223_n376ProcedimentosMedicosId, T00223_A328PropostaCratedBy,
               T00223_n328PropostaCratedBy, T00223_A504PropostaPacienteClienteId, T00223_n504PropostaPacienteClienteId
               }
               , new Object[] {
               T00224_A228ContratoNome, T00224_n228ContratoNome
               }
               , new Object[] {
               T00225_A376ProcedimentosMedicosId
               }
               , new Object[] {
               T00226_A328PropostaCratedBy
               }
               , new Object[] {
               T00227_A505PropostaPacienteClienteRazaoSocial, T00227_n505PropostaPacienteClienteRazaoSocial
               }
               , new Object[] {
               T00229_A792WorkFlowPasso_F, T00229_n792WorkFlowPasso_F
               }
               , new Object[] {
               T002211_A341PropostaAprovacoes_F, T002211_n341PropostaAprovacoes_F
               }
               , new Object[] {
               T002213_A342PropostaReprovacoes_F, T002213_n342PropostaReprovacoes_F
               }
               , new Object[] {
               T002216_A548ReembolsoStatusAtual_F, T002216_n548ReembolsoStatusAtual_F
               }
               , new Object[] {
               T002222_A323PropostaId, T002222_A327PropostaCreatedAt, T002222_n327PropostaCreatedAt, T002222_A324PropostaTitulo, T002222_n324PropostaTitulo, T002222_A325PropostaDescricao, T002222_n325PropostaDescricao, T002222_A326PropostaValor, T002222_n326PropostaValor, T002222_A329PropostaStatus,
               T002222_n329PropostaStatus, T002222_A228ContratoNome, T002222_n228ContratoNome, T002222_A330PropostaQuantidadeAprovadores, T002222_n330PropostaQuantidadeAprovadores, T002222_A345PropostaReprovacoesPermitidas, T002222_n345PropostaReprovacoesPermitidas, T002222_A505PropostaPacienteClienteRazaoSocial, T002222_n505PropostaPacienteClienteRazaoSocial, T002222_A227ContratoId,
               T002222_n227ContratoId, T002222_A376ProcedimentosMedicosId, T002222_n376ProcedimentosMedicosId, T002222_A328PropostaCratedBy, T002222_n328PropostaCratedBy, T002222_A504PropostaPacienteClienteId, T002222_n504PropostaPacienteClienteId, T002222_A792WorkFlowPasso_F, T002222_n792WorkFlowPasso_F, T002222_A341PropostaAprovacoes_F,
               T002222_n341PropostaAprovacoes_F, T002222_A342PropostaReprovacoes_F, T002222_n342PropostaReprovacoes_F, T002222_A548ReembolsoStatusAtual_F, T002222_n548ReembolsoStatusAtual_F
               }
               , new Object[] {
               T002224_A792WorkFlowPasso_F, T002224_n792WorkFlowPasso_F
               }
               , new Object[] {
               T002226_A341PropostaAprovacoes_F, T002226_n341PropostaAprovacoes_F
               }
               , new Object[] {
               T002228_A342PropostaReprovacoes_F, T002228_n342PropostaReprovacoes_F
               }
               , new Object[] {
               T002231_A548ReembolsoStatusAtual_F, T002231_n548ReembolsoStatusAtual_F
               }
               , new Object[] {
               T002232_A376ProcedimentosMedicosId
               }
               , new Object[] {
               T002233_A328PropostaCratedBy
               }
               , new Object[] {
               T002234_A228ContratoNome, T002234_n228ContratoNome
               }
               , new Object[] {
               T002235_A505PropostaPacienteClienteRazaoSocial, T002235_n505PropostaPacienteClienteRazaoSocial
               }
               , new Object[] {
               T002236_A323PropostaId
               }
               , new Object[] {
               T002237_A323PropostaId
               }
               , new Object[] {
               T002238_A323PropostaId
               }
               , new Object[] {
               }
               , new Object[] {
               T002240_A323PropostaId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T002244_A792WorkFlowPasso_F, T002244_n792WorkFlowPasso_F
               }
               , new Object[] {
               T002246_A341PropostaAprovacoes_F, T002246_n341PropostaAprovacoes_F
               }
               , new Object[] {
               T002248_A342PropostaReprovacoes_F, T002248_n342PropostaReprovacoes_F
               }
               , new Object[] {
               T002251_A548ReembolsoStatusAtual_F, T002251_n548ReembolsoStatusAtual_F
               }
               , new Object[] {
               T002252_A228ContratoNome, T002252_n228ContratoNome
               }
               , new Object[] {
               T002253_A505PropostaPacienteClienteRazaoSocial, T002253_n505PropostaPacienteClienteRazaoSocial
               }
               , new Object[] {
               T002254_A227ContratoId
               }
               , new Object[] {
               T002255_A518ReembolsoId
               }
               , new Object[] {
               T002256_A261TituloId
               }
               , new Object[] {
               T002257_A830NotaFiscalItemId
               }
               , new Object[] {
               T002258_A572PropostaContratoAssinaturaId
               }
               , new Object[] {
               T002259_A414PropostaDocumentosId
               }
               , new Object[] {
               T002260_A336AprovacaoId
               }
               , new Object[] {
               T002261_A323PropostaId
               }
               , new Object[] {
               T002262_A328PropostaCratedBy
               }
               , new Object[] {
               T002263_A376ProcedimentosMedicosId
               }
            }
         );
         AV31Pgmname = "PropostaContrato";
      ...
      private string[] T00229_A792WorkFlowPasso_F ;
      private bool[] T00229_n792WorkFlowPasso_F ;
      private short[] T002211_A341PropostaAprovacoes_F ;
      private bool[] T002211_n341PropostaAprovacoes_F ;
      private short[] T002213_A342PropostaReprovacoes_F ;
      private bool[] T002213_n342PropostaReprovacoes_F ;
      private string[] T002216_A548ReembolsoStatusAtual_F ;
      private bool[] T002216_n548ReembolsoStatusAtual_F ;
      private string[] T00227_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] T00227_n505PropostaPacienteClienteRazaoSocial ;
      private int[] T002222_A323PropostaId ;
      private bool[] T002222_n323PropostaId ;
      private DateTime[] T002222_A327PropostaCreatedAt ;
      private bool[] T002222_n327PropostaCreatedAt ;
      private string[] T002222_A324PropostaTitulo ;
      private bool[] T002222_n324PropostaTitulo ;
      private string[] T002222_A325PropostaDescricao ;
      private bool[] T002222_n325PropostaDescricao ;
      private decimal[] T002222_A326PropostaValor ;
      private bool[] T002222_n326PropostaValor ;
      private string[] T002222_A329PropostaStatus ;
      private bool[] T002222_n329PropostaStatus ;
      private string[] T002222_A228ContratoNome ;
      private bool[] T002222_n228ContratoNome ;
      private short[] T002222_A330PropostaQuantidadeAprovadores ;
      private bool[] T002222_n330PropostaQuantidadeAprovadores ;
      private short[] T002222_A345PropostaReprovacoesPermitidas ;
      private bool[] T002222_n345PropostaReprovacoesPermitidas ;
      private string[] T002222_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] T002222_n505PropostaPacienteClienteRazaoSocial ;
      private int[] T002222_A227ContratoId ;
      private bool[] T002222_n227ContratoId ;
      private int[] T002222_A376ProcedimentosMedicosId ;
      private bool[] T002222_n376ProcedimentosMedicosId ;
      private short[] T002222_A328PropostaCratedBy ;
      private bool[] T002222_n328PropostaCratedBy ;
      private int[] T002222_A504PropostaPacienteClienteId ;
      private bool[] T002222_n504PropostaPacienteClienteId ;
      private string[] T002222_A792WorkFlowPasso_F ;
      private bool[] T002222_n792WorkFlowPasso_F ;
      private short[] T002222_A341PropostaAprovacoes_F ;
      private bool[] T002222_n341PropostaAprovacoes_F ;
      private short[] T002222_A342PropostaReprovacoes_F ;
      private bool[] T002222_n342PropostaReprovacoes_F ;
      private string[] T002222_A548ReembolsoStatusAtual_F ;
      private bool[] T002222_n548ReembolsoStatusAtual_F ;
      private int[] T00225_A376ProcedimentosMedicosId ;
      private bool[] T00225_n376ProcedimentosMedicosId ;
      private short[] T00226_A328PropostaCratedBy ;
      private bool[] T00226_n328PropostaCratedBy ;
      private string[] T00224_A228ContratoNome ;
      private bool[] T00224_n228ContratoNome ;
      private string[] T002224_A792WorkFlowPasso_F ;
      private bool[] T002224_n792WorkFlowPasso_F ;
      private short[] T002226_A341PropostaAprovacoes_F ;
      private bool[] T002226_n341PropostaAprovacoes_F ;
      private short[] T002228_A342PropostaReprovacoes_F ;
      private bool[] T002228_n342PropostaReprovacoes_F ;
      private string[] T002231_A548ReembolsoStatusAtual_F ;
      private bool[] T002231_n548ReembolsoStatusAtual_F ;
      private int[] T002232_A376ProcedimentosMedicosId ;
      private bool[] T002232_n376ProcedimentosMedicosId ;
      private short[] T002233_A328PropostaCratedBy ;
      private bool[] T002233_n328PropostaCratedBy ;
      private string[] T002234_A228ContratoNome ;
      private bool[] T002234_n228ContratoNome ;
      private string[] T002235_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] T002235_n505PropostaPacienteClienteRazaoSocial ;
      private int[] T002236_A323PropostaId ;
      private bool[] T002236_n323PropostaId ;
      private int[] T00223_A323PropostaId ;
      private bool[] T00223_n323PropostaId ;
      private DateTime[] T00223_A327PropostaCreatedAt ;
      private bool[] T00223_n327PropostaCreatedAt ;
      private string[] T00223_A324PropostaTitulo ;
      private bool[] T00223_n324PropostaTitulo ;
      private string[] T00223_A325PropostaDescricao ;
      private bool[] T00223_n325PropostaDescricao ;
      private decimal[] T00223_A326PropostaValor ;
      private bool[] T00223_n326PropostaValor ;
      private string[] T00223_A329PropostaStatus ;
      private bool[] T00223_n329PropostaStatus ;
      private short[] T00223_A330PropostaQuantidadeAprovadores ;
      private bool[] T00223_n330PropostaQuantidadeAprovadores ;
      private short[] T00223_A345PropostaReprovacoesPermitidas ;
      private bool[] T00223_n345PropostaReprovacoesPermitidas ;
      private int[] T00223_A227ContratoId ;
      private bool[] T00223_n227ContratoId ;
      private int[] T00223_A376ProcedimentosMedicosId ;
      private bool[] T00223_n376ProcedimentosMedicosId ;
      private short[] T00223_A328PropostaCratedBy ;
      private bool[] T00223_n328PropostaCratedBy ;
      private int[] T00223_A504PropostaPacienteClienteId ;
      private bool[] T00223_n504PropostaPacienteClienteId ;
      private int[] T002237_A323PropostaId ;
      private bool[] T002237_n323PropostaId ;
      private int[] T002238_A323PropostaId ;
      private bool[] T002238_n323PropostaId ;
      private int[] T00222_A323PropostaId ;
      private bool[] T00222_n323PropostaId ;
      private DateTime[] T00222_A327PropostaCreatedAt ;
      private bool[] T00222_n327PropostaCreatedAt ;
      private string[] T00222_A324PropostaTitulo ;
      private bool[] T00222_n324PropostaTitulo ;
      private string[] T00222_A325PropostaDescricao ;
      private bool[] T00222_n325PropostaDescricao ;
      private decimal[] T00222_A326PropostaValor ;
      private bool[] T00222_n326PropostaValor ;
      private string[] T00222_A329PropostaStatus ;
      private bool[] T00222_n329PropostaStatus ;
      private short[] T00222_A330PropostaQuantidadeAprovadores ;
      private bool[] T00222_n330PropostaQuantidadeAprovadores ;
      private short[] T00222_A345PropostaReprovacoesPermitidas ;
      private bool[] T00222_n345PropostaReprovacoesPermitidas ;
      private int[] T00222_A227ContratoId ;
      private bool[] T00222_n227ContratoId ;
      private int[] T00222_A376ProcedimentosMedicosId ;
      private bool[] T00222_n376ProcedimentosMedicosId ;
      private short[] T00222_A328PropostaCratedBy ;
      private bool[] T00222_n328PropostaCratedBy ;
      private int[] T00222_A504PropostaPacienteClienteId ;
      private bool[] T00222_n504PropostaPacienteClienteId ;
      private int[] T002240_A323PropostaId ;
      private bool[] T002240_n323PropostaId ;
      private string[] T002244_A792WorkFlowPasso_F ;
      private bool[] T002244_n792WorkFlowPasso_F ;
      private short[] T002246_A341PropostaAprovacoes_F ;
      private bool[] T002246_n341PropostaAprovacoes_F ;
      private short[] T002248_A342PropostaReprovacoes_F ;
      private bool[] T002248_n342PropostaReprovacoes_F ;
      private string[] T002251_A548ReembolsoStatusAtual_F ;
      private bool[] T002251_n548ReembolsoStatusAtual_F ;
      private string[] T002252_A228ContratoNome ;
      private bool[] T002252_n228ContratoNome ;
      private string[] T002253_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] T002253_n505PropostaPacienteClienteRazaoSocial ;
      private int[] T002254_A227ContratoId ;
      private bool[] T002254_n227ContratoId ;
      private int[] T002255_A518ReembolsoId ;
      private bool[] T002255_n518ReembolsoId ;
      private int[] T002256_A261TituloId ;
      private Guid[] T002257_A830NotaFiscalItemId ;
      private int[] T002258_A572PropostaContratoAssinaturaId ;
      private int[] T002259_A414PropostaDocumentosId ;
      private int[] T002260_A336AprovacaoId ;
      private int[] T002261_A323PropostaId ;
      private bool[] T002261_n323PropostaId ;
      private short[] T002262_A328PropostaCratedBy ;
      private bool[] T002262_n328PropostaCratedBy ;
      private int[] T002263_A376ProcedimentosMedicosId ;
      private bool[] T002263_n376ProcedimentosMedicosId ;
   }

   public class propostacontrato__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmT002213;
          prmT002213 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002216;
          prmT002216 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT00229;
          ...
          Object[] prmT002222;
          prmT002222 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          string cmdBufferT002222;
          cmdBufferT002222=" SELECT TM1.PropostaId, TM1.PropostaCreatedAt, TM1.PropostaTitulo, TM1.PropostaDescricao, TM1.PropostaValor, TM1.PropostaStatus, T7.ContratoNome, TM1.PropostaQuantidadeAprovadores, TM1.PropostaReprovacoesPermitidas, T2.ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial, TM1.ContratoId, TM1.ProcedimentosMedicosId, TM1.PropostaCratedBy AS PropostaCratedBy, TM1.PropostaPacienteClienteId AS PropostaPacienteClienteId, COALESCE( T3.WorkFlowPasso_F, '') AS WorkFlowPasso_F, COALESCE( T4.PropostaAprovacoes_F, 0) AS PropostaAprovacoes_F, COALESCE( T5.PropostaAprovacoes_F, 0) AS PropostaReprovacoes_F, COALESCE( T6.ReembolsoStatusAtual_F, '') AS ReembolsoStatusAtual_F FROM ((((((Proposta TM1 LEFT JOIN Cliente T2 ON T2.ClienteId = TM1.PropostaPacienteClienteId) LEFT JOIN LATERAL (SELECT MIN(T9.WorkflowConvenioDesc) AS WorkFlowPasso_F, T8.ReembolsoPropostaId FROM (Reembolso T8 LEFT JOIN WorkflowConvenio T9 ON T9.WorkflowConvenioId = T8.WorkflowConvenioId) WHERE (TM1.PropostaId = T8.ReembolsoPropostaId) AND (T8.ReembolsoPropostaId = :PropostaId) GROUP BY T8.ReembolsoPropostaId ) T3 ON T3.ReembolsoPropostaId = TM1.PropostaId) LEFT JOIN LATERAL (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE (TM1.PropostaId = PropostaId) AND (AprovacaoStatus = ( 'APROVADO')) GROUP BY PropostaId ) T4 ON T4.PropostaId = TM1.PropostaId) LEFT JOIN LATERAL (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE (TM1.PropostaId = PropostaId) AND (AprovacaoStatus = ( 'REPROVADO')) GROUP BY PropostaId ) T5 ON T5.PropostaId = TM1.PropostaId) LEFT JOIN LATERAL (SELECT MIN(T8.ReembolsoEtapaStatus) AS ReembolsoStatusAtual_F, COALESCE( T10.ReembolsoEtapaUltimo_F, DATE '00010101') AS ReembolsoEtapaUltimo_F, T9.ReembolsoPropostaId FROM ((ReembolsoEtapa T8 LEFT JOIN Reembolso "
          + " T9 ON T9.ReembolsoId = T8.ReembolsoId) LEFT JOIN LATERAL (SELECT MAX(ReembolsoEtapaCreatedAt) AS ReembolsoEtapaUltimo_F, ReembolsoId FROM ReembolsoEtapa WHERE T8.ReembolsoId = ReembolsoId GROUP BY ReembolsoId ) T10 ON T10.ReembolsoId = T8.ReembolsoId) WHERE (TM1.PropostaId = T9.ReembolsoPropostaId) AND (T8.ReembolsoEtapaCreatedAt = COALESCE( T10.ReembolsoEtapaUltimo_F, DATE '00010101')) GROUP BY T10.ReembolsoEtapaUltimo_F, T9.ReembolsoPropostaId ) T6 ON T6.ReembolsoPropostaId = TM1.PropostaId) LEFT JOIN Contrato T7 ON T7.ContratoId = TM1.ContratoId) WHERE TM1.PropostaId = :PropostaId ORDER BY TM1.PropostaId" ;
          Object[] prmT002224;
          prmT002224 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002226;
          prmT002226 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002228;
          prmT002228 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002231;
          prmT002231 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002232;
          prmT002232 = new Object[] {
          new ParDef("ProcedimentosMedicosId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002233;
          prmT002233 = new Object[] {
          new ParDef("PropostaCratedBy",GXType.Int16,4,0){Nullable=true}
          };
          Object[] prmT002234;
          prmT002234 = new Object[] {
          new ParDef("ContratoId",GXType.Int32,6,0){Nullable=true}
          };
          Object[] prmT002235;
          prmT002235 = new Object[] {
          new ParDef("PropostaPacienteClienteId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002236;
          prmT002236 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002237;
          prmT002237 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002238;
          prmT002238 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002239;
          prmT002239 = new Object[] {
          ...
          Object[] prmT002240;
          prmT002240 = new Object[] {
          };
          Object[] prmT002241;
          prmT002241 = new Object[] {
          new ParDef("PropostaCreatedAt",GXType.DateTime,8,5){Nullable=true} ,
          new ParDef("PropostaTitulo",GXType.VarChar,150,0){Nullable=true} ,
          new ParDef("PropostaDescricao",GXType.VarChar,150,0){Nullable=true} ,
          new ParDef("PropostaValor",GXType.Number,18,2){Nullable=true} ,
          ...
          Object[] prmT002242;
          prmT002242 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002244;
          prmT002244 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002246;
          prmT002246 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002248;
          prmT002248 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002251;
          prmT002251 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002252;
          prmT002252 = new Object[] {
          new ParDef("ContratoId",GXType.Int32,6,0){Nullable=true}
          };
          Object[] prmT002253;
          prmT002253 = new Object[] {
          new ParDef("PropostaPacienteClienteId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002254;
          prmT002254 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002255;
          prmT002255 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002256;
          prmT002256 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002257;
          prmT002257 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002258;
          prmT002258 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002259;
          prmT002259 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002260;
          prmT002260 = new Object[] {
          new ParDef("PropostaId",GXType.Int32,9,0){Nullable=true}
          };
          Object[] prmT002261;
          prmT002261 = new Object[] {
          };
          Object[] prmT002262;
          prmT002262 = new Object[] {
          new ParDef("PropostaCratedBy",GXType.Int16,4,0){Nullable=true}
          };
          Object[] prmT002263;
          prmT002263 = new Object[] {
          new ParDef("ProcedimentosMedicosId",GXType.Int32,9,0){Nullable=true}
          };
          def= new CursorDef[] {
              new CursorDef("T00222", "SELECT PropostaId, PropostaCreatedAt, PropostaTitulo, PropostaDescricao, PropostaValor, PropostaStatus, PropostaQuantidadeAprovadores, PropostaReprovacoesPermitidas, ContratoId, ProcedimentosMedicosId, PropostaCratedBy, PropostaPacienteClienteId FROM Proposta WHERE PropostaId = :PropostaId  FOR UPDATE OF Proposta NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT00222,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00223", "SELECT PropostaId, PropostaCreatedAt, PropostaTitulo, PropostaDescricao, PropostaValor, PropostaStatus, PropostaQuantidadeAprovadores, PropostaReprovacoesPermitidas, ContratoId, ProcedimentosMedicosId, PropostaCratedBy, PropostaPacienteClienteId FROM Proposta WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00223,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00224", "SELECT ContratoNome FROM Contrato WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00224,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00225", "SELECT ProcedimentosMedicosId FROM ProcedimentosMedicos WHERE ProcedimentosMedicosId = :ProcedimentosMedicosId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00225,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00226", "SELECT SecUserId AS PropostaCratedBy FROM SecUser WHERE SecUserId = :PropostaCratedBy ",true, GxErrorMask.GX_NOMASK, false, this,prmT00226,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00227", "SELECT ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial FROM Cliente WHERE ClienteId = :PropostaPacienteClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00227,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00229", "SELECT COALESCE( T1.WorkFlowPasso_F, '') AS WorkFlowPasso_F FROM (SELECT MIN(T3.WorkflowConvenioDesc) AS WorkFlowPasso_F, T2.ReembolsoPropostaId FROM (Reembolso T2 LEFT JOIN WorkflowConvenio T3 ON T3.WorkflowConvenioId = T2.WorkflowConvenioId) WHERE T2.ReembolsoPropostaId = :PropostaId GROUP BY T2.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00229,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002211", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaAprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'APROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002211,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002213", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaReprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'REPROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002213,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002216", "SELECT COALESCE( T1.ReembolsoStatusAtual_F, '') AS ReembolsoStatusAtual_F FROM (SELECT MIN(T2.ReembolsoEtapaStatus) AS ReembolsoStatusAtual_F, COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') AS ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId FROM ((ReembolsoEtapa T2 LEFT JOIN Reembolso T3 ON T3.ReembolsoId = T2.ReembolsoId) LEFT JOIN LATERAL (SELECT MAX(ReembolsoEtapaCreatedAt) AS ReembolsoEtapaUltimo_F, ReembolsoId FROM ReembolsoEtapa WHERE T2.ReembolsoId = ReembolsoId GROUP BY ReembolsoId ) T4 ON T4.ReembolsoId = T2.ReembolsoId) WHERE T2.ReembolsoEtapaCreatedAt = COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') GROUP BY T4.ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002216,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002222", cmdBufferT002222,true, GxErrorMask.GX_NOMASK, false, this,prmT002222,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002224", "SELECT COALESCE( T1.WorkFlowPasso_F, '') AS WorkFlowPasso_F FROM (SELECT MIN(T3.WorkflowConvenioDesc) AS WorkFlowPasso_F, T2.ReembolsoPropostaId FROM (Reembolso T2 LEFT JOIN WorkflowConvenio T3 ON T3.WorkflowConvenioId = T2.WorkflowConvenioId) WHERE T2.ReembolsoPropostaId = :PropostaId GROUP BY T2.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002224,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002226", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaAprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'APROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002226,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002228", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaReprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'REPROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002228,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002231", "SELECT COALESCE( T1.ReembolsoStatusAtual_F, '') AS ReembolsoStatusAtual_F FROM (SELECT MIN(T2.ReembolsoEtapaStatus) AS ReembolsoStatusAtual_F, COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') AS ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId FROM ((ReembolsoEtapa T2 LEFT JOIN Reembolso T3 ON T3.ReembolsoId = T2.ReembolsoId) LEFT JOIN LATERAL (SELECT MAX(ReembolsoEtapaCreatedAt) AS ReembolsoEtapaUltimo_F, ReembolsoId FROM ReembolsoEtapa WHERE T2.ReembolsoId = ReembolsoId GROUP BY ReembolsoId ) T4 ON T4.ReembolsoId = T2.ReembolsoId) WHERE T2.ReembolsoEtapaCreatedAt = COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') GROUP BY T4.ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002231,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002232", "SELECT ProcedimentosMedicosId FROM ProcedimentosMedicos WHERE ProcedimentosMedicosId = :ProcedimentosMedicosId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002232,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002233", "SELECT SecUserId AS PropostaCratedBy FROM SecUser WHERE SecUserId = :PropostaCratedBy ",true, GxErrorMask.GX_NOMASK, false, this,prmT002233,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002234", "SELECT ContratoNome FROM Contrato WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002234,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002235", "SELECT ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial FROM Cliente WHERE ClienteId = :PropostaPacienteClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002235,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002236", "SELECT PropostaId FROM Proposta WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002236,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002237", "SELECT PropostaId FROM Proposta WHERE ( PropostaId > :PropostaId) ORDER BY PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002237,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002238", "SELECT PropostaId FROM Proposta WHERE ( PropostaId < :PropostaId) ORDER BY PropostaId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT002238,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002239", "SAVEPOINT gxupdate;INSERT INTO Proposta(PropostaCreatedAt, PropostaTitulo, PropostaDescricao, PropostaValor, PropostaStatus, PropostaQuantidadeAprovadores, PropostaReprovacoesPermitidas, ContratoId, ProcedimentosMedicosId, PropostaCratedBy, PropostaPacienteClienteId, ConvenioVencimentoAno, ConvenioVencimentoMes, ConvenioCategoriaId, PropostaTaxaAdministrativa, PropostaSLA, PropostaJurosMora, PropostaDataCirurgia, PropostaResponsavelId, PropostaClinicaId, PropostaComentarioAnalise, PropostaProtocolo, PropostaEmpresaClienteId, PropostaTipoProposta, PropostaValorLiquido) VALUES(:PropostaCreatedAt, :PropostaTitulo, :PropostaDescricao, :PropostaValor, :PropostaStatus, :PropostaQuantidadeAprovadores, :PropostaReprovacoesPermitidas, :ContratoId, :ProcedimentosMedicosId, :PropostaCratedBy, :PropostaPacienteClienteId, 0, 0, 0, 0, 0, 0, DATE '00010101', 0, 0, '', '', 0, '', 0);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT002239)
             ,new CursorDef("T002240", "SELECT currval('PropostaId') ",true, GxErrorMask.GX_NOMASK, false, this,prmT002240,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002241", "SAVEPOINT gxupdate;UPDATE Proposta SET PropostaCreatedAt=:PropostaCreatedAt, PropostaTitulo=:PropostaTitulo, PropostaDescricao=:PropostaDescricao, PropostaValor=:PropostaValor, PropostaStatus=:PropostaStatus, PropostaQuantidadeAprovadores=:PropostaQuantidadeAprovadores, PropostaReprovacoesPermitidas=:PropostaReprovacoesPermitidas, ContratoId=:ContratoId, ProcedimentosMedicosId=:ProcedimentosMedicosId, PropostaCratedBy=:PropostaCratedBy, PropostaPacienteClienteId=:PropostaPacienteClienteId  WHERE PropostaId = :PropostaId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT002241)
             ,new CursorDef("T002242", "SAVEPOINT gxupdate;DELETE FROM Proposta  WHERE PropostaId = :PropostaId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT002242)
             ,new CursorDef("T002244", "SELECT COALESCE( T1.WorkFlowPasso_F, '') AS WorkFlowPasso_F FROM (SELECT MIN(T3.WorkflowConvenioDesc) AS WorkFlowPasso_F, T2.ReembolsoPropostaId FROM (Reembolso T2 LEFT JOIN WorkflowConvenio T3 ON T3.WorkflowConvenioId = T2.WorkflowConvenioId) WHERE T2.ReembolsoPropostaId = :PropostaId GROUP BY T2.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002244,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002246", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaAprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'APROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002246,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002248", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaReprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'REPROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002248,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002251", "SELECT COALESCE( T1.ReembolsoStatusAtual_F, '') AS ReembolsoStatusAtual_F FROM (SELECT MIN(T2.ReembolsoEtapaStatus) AS ReembolsoStatusAtual_F, COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') AS ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId FROM ((ReembolsoEtapa T2 LEFT JOIN Reembolso T3 ON T3.ReembolsoId = T2.ReembolsoId) LEFT JOIN LATERAL (SELECT MAX(ReembolsoEtapaCreatedAt) AS ReembolsoEtapaUltimo_F, ReembolsoId FROM ReembolsoEtapa WHERE T2.ReembolsoId = ReembolsoId GROUP BY ReembolsoId ) T4 ON T4.ReembolsoId = T2.ReembolsoId) WHERE T2.ReembolsoEtapaCreatedAt = COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') GROUP BY T4.ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002251,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002252", "SELECT ContratoNome FROM Contrato WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002252,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002253", "SELECT ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial FROM Cliente WHERE ClienteId = :PropostaPacienteClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002253,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002254", "SELECT ContratoId FROM Contrato WHERE ContratoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002254,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002255", "SELECT ReembolsoId FROM Reembolso WHERE ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002255,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002256", "SELECT TituloId FROM Titulo WHERE TituloPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002256,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002257", "SELECT NotaFiscalItemId FROM NotaFiscalItem WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002257,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002258", "SELECT PropostaContratoAssinaturaId FROM PropostaContratoAssinatura WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002258,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002259", "SELECT PropostaDocumentosId FROM PropostaDocumentos WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002259,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002260", "SELECT AprovacaoId FROM Aprovacao WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002260,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002261", "SELECT PropostaId FROM Proposta ORDER BY PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002261,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002262", "SELECT SecUserId AS PropostaCratedBy FROM SecUser WHERE SecUserId = :PropostaCratedBy ",true, GxErrorMask.GX_NOMASK, false, this,prmT002262,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002263", "SELECT ProcedimentosMedicosId FROM ProcedimentosMedicos WHERE ProcedimentosMedicosId = :ProcedimentosMedicosId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002263,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
