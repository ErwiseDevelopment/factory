...
namespace GeneXus.Programs {
   public class webservice_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable2D83( )
      {
         ...
         {
            GX_msglist.addItem("Campo Web Service Tipo Dm WS fora do intervalo", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("Campo Web Service Auth Tipo fora do intervalo", "OutOfRange", 1, "");
            AnyError = 1;
         }
      }
      ...
      protected void CheckOptimisticConcurrency2D83( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z657WebServiceTipoDmWS, BC002D2_A657WebServiceTipoDmWS[0]) != 0 ) || ( StringUtil.StrCmp(Z658WebServiceEndPoint, BC002D2_A658WebServiceEndPoint[0]) != 0 ) || ( StringUtil.StrCmp(Z659WebServiceAuthTipo, BC002D2_A659WebServiceAuthTipo[0]) != 0 ) || ( StringUtil.StrCmp(Z660WebServiceUsuario, BC002D2_A660WebServiceUsuario[0]) != 0 ) || ( StringUtil.StrCmp(Z661WebServiceSenha, BC002D2_A661WebServiceSenha[0]) != 0 ) )
            {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(4, new Object[] {n657WebServiceTipoDmWS, A657WebServiceTipoDmWS, n658WebServiceEndPoint, A658WebServiceEndPoint, n659WebServiceAuthTipo, A659WebServiceAuthTipo, n660WebServiceUsuario, A660WebServiceUsuario, n661WebServiceSenha, A661WebServiceSenha});
                     pr_default.close(4);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(6, new Object[] {n657WebServiceTipoDmWS, A657WebServiceTipoDmWS, n658WebServiceEndPoint, A658WebServiceEndPoint, n659WebServiceAuthTipo, A659WebServiceAuthTipo, n660WebServiceUsuario, A660WebServiceUsuario, n661WebServiceSenha, A661WebServiceSenha, A656WebServiceId});
                     pr_default.close(6);
                     pr_default.SmartCacheProvider.SetUpdated("WebService");
      ...
      public void VarsToRow83( SdtWebService obj83 )
      {
         ...
         obj83.gxTpr_Webserviceendpoint_Z = Z658WebServiceEndPoint;
         obj83.gxTpr_Webserviceauthtipo_Z = Z659WebServiceAuthTipo;
         obj83.gxTpr_Webserviceusuario_Z = Z660WebServiceUsuario;
         obj83.gxTpr_Webservicesenha_Z = Z661WebServiceSenha;
                               ...
                               int forceLoad )
      {
         ...
         Z658WebServiceEndPoint = obj83.gxTpr_Webserviceendpoint_Z;
         Z659WebServiceAuthTipo = obj83.gxTpr_Webserviceauthtipo_Z;
         Z660WebServiceUsuario = obj83.gxTpr_Webserviceusuario_Z;
         Z661WebServiceSenha = obj83.gxTpr_Webservicesenha_Z;
   ...
   public class webservice_bc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("BC002D2", "SELECT WebServiceId, WebServiceTipoDmWS, WebServiceEndPoint, WebServiceAuthTipo, WebServiceUsuario, WebServiceSenha FROM WebService WHERE WebServiceId = :WebServiceId  FOR UPDATE OF WebService",true, GxErrorMask.GX_NOMASK, false, this,prmBC002D2,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("BC002D3", "SELECT WebServiceId, WebServiceTipoDmWS, WebServiceEndPoint, WebServiceAuthTipo, WebServiceUsuario, WebServiceSenha FROM WebService WHERE WebServiceId = :WebServiceId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002D3,1, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("BC002D6", "SAVEPOINT gxupdate;INSERT INTO WebService(WebServiceTipoDmWS, WebServiceEndPoint, WebServiceAuthTipo, WebServiceUsuario, WebServiceSenha) VALUES(:WebServiceTipoDmWS, :WebServiceEndPoint, :WebServiceAuthTipo, :WebServiceUsuario, :WebServiceSenha);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmBC002D6)
             ...
             ,new CursorDef("BC002D8", "SAVEPOINT gxupdate;UPDATE WebService SET WebServiceTipoDmWS=:WebServiceTipoDmWS, WebServiceEndPoint=:WebServiceEndPoint, WebServiceAuthTipo=:WebServiceAuthTipo, WebServiceUsuario=:WebServiceUsuario, WebServiceSenha=:WebServiceSenha  WHERE WebServiceId = :WebServiceId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmBC002D8)
