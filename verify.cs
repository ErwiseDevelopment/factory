   ...
   public class verify : GXDataArea
   {
      ...
      protected void E117B2( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            AV7Array_SdParticipantesContrato = new GXBaseCollection<SdtSdParticipantesContrato>( context, "SdParticipantesContrato", "Factory2");
            /* Using cursor H007B3 */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918571844", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("verify.js", "?202551918571845", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
