...
namespace GeneXus.Programs.genexusreporting
{
	...
	public class SdtQueryViewerElements_Element_Grouping_RESTInterface : GxGenericCollectionItem<SdtQueryViewerElements_Element_Grouping>, System.Web.SessionState.IRequiresSessionState
	{
		...
		[JsonPropertyName("GroupBySemester")]
		[JsonPropertyOrder(2)]
		[JsonConverter(typeof(BoolStringJsonConverter))]
		...
		[JsonPropertyName("GroupByQuarter")]
		[JsonPropertyOrder(4)]
		[JsonConverter(typeof(BoolStringJsonConverter))]
		...
		[JsonPropertyName("GroupByDayOfWeek")]
		[JsonPropertyOrder(8)]
		[JsonConverter(typeof(BoolStringJsonConverter))]
		...
		[JsonPropertyName("DayOfWeekTitle")]
		[JsonPropertyOrder(9)]
