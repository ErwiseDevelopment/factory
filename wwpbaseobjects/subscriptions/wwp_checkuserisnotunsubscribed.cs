...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_checkuserisnotunsubscribed : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         /* Using cursor P002F2 */
         pr_default.execute(0, new Object[] {AV9WWPNotificationDefinitionId, AV12Udparg1});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A27WWPSubscriptionSubscribed = P002F2_A27WWPSubscriptionSubscribed[0];
            A7WWPUserExtendedId = P002F2_A7WWPUserExtendedId[0];
            n7WWPUserExtendedId = P002F2_n7WWPUserExtendedId[0];
            A23WWPNotificationDefinitionId = P002F2_A23WWPNotificationDefinitionId[0];
            A25WWPSubscriptionId = P002F2_A25WWPSubscriptionId[0];
      ...
      {
         AV12Udparg1 = "";
         P002F2_A27WWPSubscriptionSubscribed = new bool[] {false} ;
         P002F2_A7WWPUserExtendedId = new string[] {""} ;
         P002F2_n7WWPUserExtendedId = new bool[] {false} ;
         P002F2_A23WWPNotificationDefinitionId = new long[1] ;
         P002F2_A25WWPSubscriptionId = new long[1] ;
         A7WWPUserExtendedId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_checkuserisnotunsubscribed__default(),
            new Object[][] {
                new Object[] {
               P002F2_A27WWPSubscriptionSubscribed, P002F2_A7WWPUserExtendedId, P002F2_n7WWPUserExtendedId, P002F2_A23WWPNotificationDefinitionId, P002F2_A25WWPSubscriptionId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P002F2_A27WWPSubscriptionSubscribed ;
      private string[] P002F2_A7WWPUserExtendedId ;
      private bool[] P002F2_n7WWPUserExtendedId ;
      private long[] P002F2_A23WWPNotificationDefinitionId ;
      private long[] P002F2_A25WWPSubscriptionId ;
   }
   ...
   public class wwp_checkuserisnotunsubscribed__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P002F2", "SELECT WWPSubscriptionSubscribed, WWPUserExtendedId, WWPNotificationDefinitionId, WWPSubscriptionId FROM WWP_Subscription WHERE (WWPNotificationDefinitionId = :AV9WWPNotificationDefinitionId) AND (WWPUserExtendedId = ( :AV12Udparg1)) AND (WWPSubscriptionSubscribed = FALSE) ORDER BY WWPNotificationDefinitionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP002F2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
