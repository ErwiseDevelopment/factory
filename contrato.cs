...
namespace GeneXus.Programs {
   public class contrato : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtContratoNome_Internalname, "Nome", "col-sm-3 AttributeFLLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
      ...
      public void ScanStart0X36( )
      {
         ...
         {
            RcdFound36 = 1;
            A227ContratoId = T000X36_A227ContratoId[0];
            n227ContratoId = T000X36_n227ContratoId[0];
            AssignAttri("", false, "A227ContratoId", StringUtil.LTrimStr( (decimal)(A227ContratoId), 6, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522165733", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("contrato.js", "?2025522165733", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         T000X33_A323PropostaId = new int[1] ;
         T000X34_A238AssinaturaId = new long[1] ;
         T000X34_n238AssinaturaId = new bool[] {false} ;
         T000X35_A237ContratoParticipanteId = new int[1] ;
         T000X36_A227ContratoId = new int[1] ;
         T000X36_n227ContratoId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.contrato__default(),
            new Object[][] {
               ...
               , new Object[] {
               T000X33_A323PropostaId
               }
               , new Object[] {
               T000X34_A238AssinaturaId
               }
               , new Object[] {
               T000X35_A237ContratoParticipanteId
               }
               , new Object[] {
               T000X36_A227ContratoId
               }
            }
         );
         AV16Pgmname = "Contrato";
      ...
      private int[] T000X33_A323PropostaId ;
      private long[] T000X34_A238AssinaturaId ;
      private bool[] T000X34_n238AssinaturaId ;
      private int[] T000X35_A237ContratoParticipanteId ;
      private int[] T000X36_A227ContratoId ;
      private bool[] T000X36_n227ContratoId ;
   }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T000X33", "SELECT PropostaId FROM Proposta WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000X33,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000X34", "SELECT AssinaturaId FROM Assinatura WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000X34,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000X35", "SELECT ContratoParticipanteId FROM ContratoParticipante WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000X35,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000X36", "SELECT ContratoId FROM Contrato ORDER BY ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000X36,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
