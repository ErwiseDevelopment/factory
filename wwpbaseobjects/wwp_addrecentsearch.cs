...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_addrecentsearch : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            AV14RecentSearches = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SearchResults_WWP_SearchResultsItem>( context, "WWP_SearchResultsItem", "Factory2");
         }
         else
         {
