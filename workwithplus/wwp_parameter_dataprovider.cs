...
namespace GeneXus.Programs.workwithplus {
   public class wwp_parameter_dataprovider : GXProcedure
   {
      ...
      {
         this.AV2ReturnValue = new GXBCCollection<GeneXus.Programs.workwithplus.SdtWWP_Parameter>( context, "WWP_Parameter", "Factory2") ;
         initialize();
         ExecuteImpl();
      ...
      {
         AV2ReturnValue = new GXBCCollection<GeneXus.Programs.workwithplus.SdtWWP_Parameter>( context, "WWP_Parameter", "Factory2");
         /* GeneXus formulas. */
      }
