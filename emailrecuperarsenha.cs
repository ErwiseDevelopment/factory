...
namespace GeneXus.Programs {
   public class emailrecuperarsenha : GXProcedure
   {
      public emailrecuperarsenha( )
      {
      ...
      public emailrecuperarsenha( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV8HTML += "                      <td align=\"center\" class=\"es-m-txt-c\" style=\"padding:0;Margin:0\"><h1 style=\"Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:arial,  helvetica, sans-serif;font-size:26px;font-style:normal;font-weight:bold;color:#333333\">Código para recuperar senha</h1></td>";
         AV8HTML += "                     </tr>";
         AV8HTML += "                     <tr class=\"es-visible-simple-html-only\">";
