...
namespace GeneXus.Programs {
   public class wcimpnotafiscalrevisao : GXWebComponent
   {
      ...
      protected void E118R2( )
      {
         ...
         AV15Array_SdProdutosNotaFiscal = new GXBaseCollection<SdtSdProdutoNotaFiscal>( context, "SdProdutoNotaFiscal", "Factory2");
         AV15Array_SdProdutosNotaFiscal.FromJSonString(AV11WizardData.gxTpr_Produtosnota.gxTpr_Jsonsdprodutosnota, null);
         AV23Array_SdNotaFiscal = new GXBaseCollection<SdtSdNotaFiscal>( context, "SdNotaFiscal", "Factory2");
         AV23Array_SdNotaFiscal.FromJSonString(AV11WizardData.gxTpr_Importarxml.gxTpr_Jsonsdnotafiscal, null);
         AV33Array_SdListaNotaFiscalVenda = new GXBaseCollection<SdtSdListaNotaFiscalVenda>( context, "SdListaNotaFiscalVenda", "Factory2");
         AV40GXV1 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918374428", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wcimpnotafiscalrevisao.js", "?202551918374430", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV23Array_SdNotaFiscal = new GXBaseCollection<SdtSdNotaFiscal>( context, "SdNotaFiscal", "Factory2");
         AV15Array_SdProdutosNotaFiscal = new GXBaseCollection<SdtSdProdutoNotaFiscal>( context, "SdProdutoNotaFiscal", "Factory2");
         AV28Array_SdParcelaCalculadaTaxa = new GXBaseCollection<SdtSdParcelaCalculadaTaxa>( context, "SdParcelaCalculadaTaxa", "Factory2");
