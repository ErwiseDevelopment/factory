...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_mdatagrid_wc : GXWebComponent
   {
      ...
      protected void gxgrFsgrid_refresh_invoke( )
      {
         ...
         A117WWPFormElementTitle = GetPar( "WWPFormElementTitle");
         ...
         gxgrFsgrid_refresh( AV17WWPFormElementId, AV22WWPFormInstance, AV15WWP_DF_ElementsRepeaterMetadata, AV16WWPDynamicFormMode, AV10MultipleDataWWPFormInstanceElementId, A100WWPFormElementOrderIndex, A94WWPFormId, A95WWPFormVersionNumber, A99WWPFormElementParentId, A117WWPFormElementTitle, A105WWPFormElementType, A124WWPFormElementMetadata, AV11SessionId, A98WWPFormElementId, A106WWPFormElementDataType, AV18WWPFormElementIdSimpleChildren, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            if ( ( GxWebError == 0 ) && ! isAjaxCallMode( ) )
            {
               ...
               {
                  A40000GXC1 = H001D3_A40000GXC1[0];
                  n40000GXC1 = H001D3_n40000GXC1[0];
               }
               else
               {
                  A40000GXC1 = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_mdatagrid_wc"+UrlEncode(StringUtil.RTrim(AV16WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV17WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV28WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV11SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_mdatagrid_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPFORMELEMENTTITLE", A117WWPFormElementTitle);
      ...
      protected void WB1D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_mdatagrid_wc");
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_mdatagrid_wc")), "workwithplus.dynamicforms.wwp_df_mdatagrid_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_mdatagrid_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrFsgrid_refresh( short AV17WWPFormElementId ,
                                         ...
                                         short A100WWPFormElementOrderIndex ,
                                         short A94WWPFormId ,
                                         short A95WWPFormVersionNumber ,
                                         short A99WWPFormElementParentId ,
                                         string A117WWPFormElementTitle ,
      ...
      protected void before_start_formulas( )
      {
         ...
         {
            A40000GXC1 = H001D5_A40000GXC1[0];
            n40000GXC1 = H001D5_n40000GXC1[0];
         }
         else
         {
            A40000GXC1 = 0;
      ...
      protected void E141D2( )
      {
         ...
         {
            A98WWPFormElementId = H001D6_A98WWPFormElementId[0];
            A95WWPFormVersionNumber = H001D6_A95WWPFormVersionNumber[0];
            A94WWPFormId = H001D6_A94WWPFormId[0];
            A117WWPFormElementTitle = H001D6_A117WWPFormElementTitle[0];
            A124WWPFormElementMetadata = H001D6_A124WWPFormElementMetadata[0];
            AV21WWPFormElementTitle = A117WWPFormElementTitle;
            AV20WWPFormElementMetadata = A124WWPFormElementMetadata;
         ...
         AV30GXV1 = 1;
         while ( AV30GXV1 <= AV22WWPFormInstance.gxTpr_Element.Count )
         {
            AV23WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV22WWPFormInstance.gxTpr_Element.Item(AV30GXV1));
         ...
         if ( AV10MultipleDataWWPFormInstanceElementId.Count == 0 )
         {
            if ( StringUtil.StrCmp(AV16WWPDynamicFormMode, "INS") != 0 )
            {
               ...
               {
                  A98WWPFormElementId = H001D7_A98WWPFormElementId[0];
                  A102WWPFormInstanceId = H001D7_A102WWPFormInstanceId[0];
                  A103WWPFormInstanceElementId = H001D7_A103WWPFormInstanceElementId[0];
                  AV10MultipleDataWWPFormInstanceElementId.Add(A103WWPFormInstanceElementId, 0);
            ...
            else
            {
               ...
               else
               {
                  if ( AV15WWP_DF_ElementsRepeaterMetadata.gxTpr_Repetitionstype == 3 )
                  {
                     ...
                     AV32GXV2 = 1;
                     while ( AV32GXV2 <= AV22WWPFormInstance.gxTpr_Element.Count )
                     {
                        AV23WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV22WWPFormInstance.gxTpr_Element.Item(AV32GXV2));
            ...
            {
               AV6i = (short)(AV10MultipleDataWWPFormInstanceElementId.GetNumeric(AV33GXV3));
      ...
      protected void E151D2( )
      {
         ...
         {
            A40000GXC1 = H001D9_A40000GXC1[0];
            n40000GXC1 = H001D9_n40000GXC1[0];
         }
         else
         {
            A40000GXC1 = 0;
      ...
      private void E161D2( )
      {
         ...
         {
            A99WWPFormElementParentId = H001D10_A99WWPFormElementParentId[0];
            n99WWPFormElementParentId = H001D10_n99WWPFormElementParentId[0];
            A95WWPFormVersionNumber = H001D10_A95WWPFormVersionNumber[0];
            A94WWPFormId = H001D10_A94WWPFormId[0];
            A117WWPFormElementTitle = H001D10_A117WWPFormElementTitle[0];
            A100WWPFormElementOrderIndex = H001D10_A100WWPFormElementOrderIndex[0];
            lblTitletextblocktitle_Caption = A117WWPFormElementTitle;
            /* Load Method */
            if ( wbStart != -1 )
            {
               wbStart = 9;
         ...
         AV35GXV4 = 1;
         while ( AV35GXV4 <= AV10MultipleDataWWPFormInstanceElementId.Count )
         {
            AV25WWPFormInstanceElementIdChild = (short)(AV10MultipleDataWWPFormInstanceElementId.GetNumeric(AV35GXV4));
            ...
            {
               A99WWPFormElementParentId = H001D11_A99WWPFormElementParentId[0];
               n99WWPFormElementParentId = H001D11_n99WWPFormElementParentId[0];
               A95WWPFormVersionNumber = H001D11_A95WWPFormVersionNumber[0];
               A94WWPFormId = H001D11_A94WWPFormId[0];
               A105WWPFormElementType = H001D11_A105WWPFormElementType[0];
               A106WWPFormElementDataType = H001D11_A106WWPFormElementDataType[0];
               A124WWPFormElementMetadata = H001D11_A124WWPFormElementMetadata[0];
               A98WWPFormElementId = H001D11_A98WWPFormElementId[0];
               A100WWPFormElementOrderIndex = H001D11_A100WWPFormElementOrderIndex[0];
               if ( A105WWPFormElementType == 1 )
               {
                  ...
                  {
                     AV14WWP_DF_CharMetadata.FromJSonString(A124WWPFormElementMetadata, null);
                     if ( AV14WWP_DF_CharMetadata.gxTpr_Controltype == 1 )
                     {
                        ...
                        if ( StringUtil.Len( WebComp_Datawcchildren_Component) != 0 )
                        {
                           ...
                           WebComp_Datawcchildren.componentprepare(new Object[] {(string)sPrefix+"W0020",(string)sGXsfl_9_idx,(string)AV16WWPDynamicFormMode,(short)A98WWPFormElementId,(short)AV25WWPFormInstanceElementIdChild,(short)AV11SessionId,(GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance)AV22WWPFormInstance});
                           WebComp_Datawcchildren.componentbind(new Object[] {(string)"",(string)"",(string)"",(string)"",(string)""});
                        }
                        if ( ! bGXsfl_9_Refreshing )
                        {
                           if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Datawcchildren )
                           {
      ...
      protected void E131D2( )
      {
         ...
         if ( ( AV5AuxSessionId == AV11SessionId ) && ( AV15WWP_DF_ElementsRepeaterMetadata.gxTpr_Repetitionstype == 3 ) )
         {
            ...
            AV22WWPFormInstance = GXt_SdtWWP_FormInstance1;
            AV37GXV5 = 1;
            while ( AV37GXV5 <= AV22WWPFormInstance.gxTpr_Element.Count )
            {
               AV23WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV22WWPFormInstance.gxTpr_Element.Item(AV37GXV5));
               if ( AV23WWPFormInstanceElement.gxTpr_Wwpformelementid == AV15WWP_DF_ElementsRepeaterMetadata.gxTpr_Repetitions_variable.gxTpr_Elementid )
               {
                  AV9MultipleDataRepetitions = (short)(Math.Round(AV23WWPFormInstanceElement.gxTpr_Wwpforminstanceelemnumeric, 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV9MultipleDataRepetitions", StringUtil.LTrimStr( (decimal)(AV9MultipleDataRepetitions), 4, 0));
               ...
               if ( AV9MultipleDataRepetitions < AV10MultipleDataWWPFormInstanceElementId.Count )
               {
                  ...
                  while ( AV9MultipleDataRepetitions < AV10MultipleDataWWPFormInstanceElementId.Count )
                  {
                     ...
                     while ( AV6i <= AV19WWPFormElementIdToDelete.Count )
                     {
                        AV7j = 1;
                        AV38GXV6 = 1;
                        while ( AV38GXV6 <= AV22WWPFormInstance.gxTpr_Element.Count )
                        {
                           AV23WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV22WWPFormInstance.gxTpr_Element.Item(AV38GXV6));
      ...
      protected void S122( )
      {
         ...
         AV39GXV7 = 1;
         while ( AV39GXV7 <= AV22WWPFormInstance.gxTpr_Element.Count )
         {
            AV23WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV22WWPFormInstance.gxTpr_Element.Item(AV39GXV7));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101971749", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_mdatagrid_wc.js", "?20256101971750", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"A100WWPFormElementOrderIndex","fld":"WWPFORMELEMENTORDERINDEX","pic":"ZZZ9","type":"int"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A117WWPFormElementTitle","fld":"WWPFORMELEMENTTITLE","type":"vchar"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"A124WWPFormElementMetadata","fld":"WWPFORMELEMENTMETADATA","type":"vchar"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"A98WWPFormElementId","fld":"WWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"A106WWPFormElementDataType","fld":"WWPFORMELEMENTDATATYPE","pic":"Z9","type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV17WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV16WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV15WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV18WWPFormElementIdSimpleChildren","fld":"vWWPFORMELEMENTIDSIMPLECHILDREN","pic":"ZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"A40000GXC1","fld":"GXC1","pic":"999999999","type":"int"},{"av":"subFsgrid_Columns","ctrl":"FSGRID","prop":"Columns"},{"ctrl":"BTNADDCHILD","prop":"Visible"}]}""");
         setEventMetadata("FSGRID.LOAD","""{"handler":"E161D2","iparms":[{"av":"A100WWPFormElementOrderIndex","fld":"WWPFORMELEMENTORDERINDEX","pic":"ZZZ9","type":"int"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"AV17WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"A117WWPFormElementTitle","fld":"WWPFORMELEMENTTITLE","type":"vchar"},{"av":"AV15WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV16WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"A124WWPFormElementMetadata","fld":"WWPFORMELEMENTMETADATA","type":"vchar"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"A98WWPFormElementId","fld":"WWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"A106WWPFormElementDataType","fld":"WWPFORMELEMENTDATATYPE","pic":"Z9","type":"int"}]""");
         ...
         setEventMetadata("'DOADDCHILD'","""{"handler":"E111D2","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV17WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV15WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV16WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"A100WWPFormElementOrderIndex","fld":"WWPFORMELEMENTORDERINDEX","pic":"ZZZ9","type":"int"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A117WWPFormElementTitle","fld":"WWPFORMELEMENTTITLE","type":"vchar"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"A124WWPFormElementMetadata","fld":"WWPFORMELEMENTMETADATA","type":"vchar"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"A98WWPFormElementId","fld":"WWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"A106WWPFormElementDataType","fld":"WWPFORMELEMENTDATATYPE","pic":"Z9","type":"int"},{"av":"AV18WWPFormElementIdSimpleChildren","fld":"vWWPFORMELEMENTIDSIMPLECHILDREN","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV26WWPFormInstanceElementIdNew","fld":"vWWPFORMINSTANCEELEMENTIDNEW","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("'DOADDCHILD'",""","oparms":[{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV26WWPFormInstanceElementIdNew","fld":"vWWPFORMINSTANCEELEMENTIDNEW","pic":"ZZZ9","type":"int"},{"av":"A40000GXC1","fld":"GXC1","pic":"999999999","type":"int"},{"av":"subFsgrid_Columns","ctrl":"FSGRID","prop":"Columns"},{"ctrl":"BTNADDCHILD","prop":"Visible"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_DELETEGRIDRECORD","""{"handler":"E121D2","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV17WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV15WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV16WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"A100WWPFormElementOrderIndex","fld":"WWPFORMELEMENTORDERINDEX","pic":"ZZZ9","type":"int"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A117WWPFormElementTitle","fld":"WWPFORMELEMENTTITLE","type":"vchar"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"A124WWPFormElementMetadata","fld":"WWPFORMELEMENTMETADATA","type":"vchar"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"A98WWPFormElementId","fld":"WWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"A106WWPFormElementDataType","fld":"WWPFORMELEMENTDATATYPE","pic":"Z9","type":"int"},{"av":"AV18WWPFormElementIdSimpleChildren","fld":"vWWPFORMELEMENTIDSIMPLECHILDREN","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV24WWPFormInstanceElementIdAux","fld":"vWWPFORMINSTANCEELEMENTIDAUX","pic":"ZZZ9","type":"int"},{"av":"AV5AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_DELETEGRIDRECORD",""","oparms":[{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"ctrl":"BTNADDCHILD","prop":"Visible"},{"av":"A40000GXC1","fld":"GXC1","pic":"999999999","type":"int"},{"av":"subFsgrid_Columns","ctrl":"FSGRID","prop":"Columns"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E131D2","iparms":[{"av":"FSGRID_nFirstRecordOnPage","type":"int"},{"av":"FSGRID_nEOF","type":"int"},{"av":"AV17WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV15WWP_DF_ElementsRepeaterMetadata","fld":"vWWP_DF_ELEMENTSREPEATERMETADATA","hsh":true,"type":""},{"av":"AV16WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","type":"char"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"A100WWPFormElementOrderIndex","fld":"WWPFORMELEMENTORDERINDEX","pic":"ZZZ9","type":"int"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A99WWPFormElementParentId","fld":"WWPFORMELEMENTPARENTID","pic":"ZZZ9","type":"int"},{"av":"A117WWPFormElementTitle","fld":"WWPFORMELEMENTTITLE","type":"vchar"},{"av":"A105WWPFormElementType","fld":"WWPFORMELEMENTTYPE","pic":"9","type":"int"},{"av":"A124WWPFormElementMetadata","fld":"WWPFORMELEMENTMETADATA","type":"vchar"},{"av":"AV11SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"A98WWPFormElementId","fld":"WWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"A106WWPFormElementDataType","fld":"WWPFORMELEMENTDATATYPE","pic":"Z9","type":"int"},{"av":"AV18WWPFormElementIdSimpleChildren","fld":"vWWPFORMELEMENTIDSIMPLECHILDREN","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"sPrefix","type":"char"},{"av":"AV5AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV26WWPFormInstanceElementIdNew","fld":"vWWPFORMINSTANCEELEMENTIDNEW","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV22WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV9MultipleDataRepetitions","fld":"vMULTIPLEDATAREPETITIONS","pic":"ZZZ9","type":"int"},{"av":"AV10MultipleDataWWPFormInstanceElementId","fld":"vMULTIPLEDATAWWPFORMINSTANCEELEMENTID","type":""},{"av":"AV26WWPFormInstanceElementIdNew","fld":"vWWPFORMINSTANCEELEMENTIDNEW","pic":"ZZZ9","type":"int"},{"av":"A40000GXC1","fld":"GXC1","pic":"999999999","type":"int"},{"av":"subFsgrid_Columns","ctrl":"FSGRID","prop":"Columns"},{"ctrl":"BTNADDCHILD","prop":"Visible"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H001D3_A40000GXC1 = new int[1] ;
         H001D3_n40000GXC1 = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         ...
         GXDecQS = "";
         WebComp_Datawcchildren_Component = "";
         H001D5_A40000GXC1 = new int[1] ;
         H001D5_n40000GXC1 = new bool[] {false} ;
         H001D6_A98WWPFormElementId = new short[1] ;
         H001D6_A95WWPFormVersionNumber = new short[1] ;
         H001D6_A94WWPFormId = new short[1] ;
         H001D6_A117WWPFormElementTitle = new string[] {""} ;
         H001D6_A124WWPFormElementMetadata = new string[] {""} ;
         ...
         H001D7_A98WWPFormElementId = new short[1] ;
         H001D7_A102WWPFormInstanceId = new int[1] ;
         H001D7_A103WWPFormInstanceElementId = new short[1] ;
         H001D9_A40000GXC1 = new int[1] ;
         H001D9_n40000GXC1 = new bool[] {false} ;
         H001D10_A98WWPFormElementId = new short[1] ;
         H001D10_A99WWPFormElementParentId = new short[1] ;
         H001D10_n99WWPFormElementParentId = new bool[] {false} ;
         H001D10_A95WWPFormVersionNumber = new short[1] ;
         H001D10_A94WWPFormId = new short[1] ;
         H001D10_A117WWPFormElementTitle = new string[] {""} ;
         H001D10_A100WWPFormElementOrderIndex = new short[1] ;
         FsgridRow = new GXWebRow();
         H001D11_A99WWPFormElementParentId = new short[1] ;
         H001D11_n99WWPFormElementParentId = new bool[] {false} ;
         H001D11_A95WWPFormVersionNumber = new short[1] ;
         H001D11_A94WWPFormId = new short[1] ;
         H001D11_A105WWPFormElementType = new short[1] ;
         H001D11_A106WWPFormElementDataType = new short[1] ;
         H001D11_A124WWPFormElementMetadata = new string[] {""} ;
         H001D11_A98WWPFormElementId = new short[1] ;
         H001D11_A100WWPFormElementOrderIndex = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_df_mdatagrid_wc__default(),
            new Object[][] {
                new Object[] {
               H001D3_A40000GXC1, H001D3_n40000GXC1
               }
               , new Object[] {
               H001D5_A40000GXC1, H001D5_n40000GXC1
               }
               , new Object[] {
               H001D6_A98WWPFormElementId, H001D6_A95WWPFormVersionNumber, H001D6_A94WWPFormId, H001D6_A117WWPFormElementTitle, H001D6_A124WWPFormElementMetadata
               }
               , new Object[] {
               H001D7_A98WWPFormElementId, H001D7_A102WWPFormInstanceId, H001D7_A103WWPFormInstanceElementId
               }
               , new Object[] {
               H001D9_A40000GXC1, H001D9_n40000GXC1
               }
               , new Object[] {
               H001D10_A98WWPFormElementId, H001D10_A99WWPFormElementParentId, H001D10_n99WWPFormElementParentId, H001D10_A95WWPFormVersionNumber, H001D10_A94WWPFormId, H001D10_A117WWPFormElementTitle, H001D10_A100WWPFormElementOrderIndex
               }
               , new Object[] {
               H001D11_A99WWPFormElementParentId, H001D11_n99WWPFormElementParentId, H001D11_A95WWPFormVersionNumber, H001D11_A94WWPFormId, H001D11_A105WWPFormElementType, H001D11_A106WWPFormElementDataType, H001D11_A124WWPFormElementMetadata, H001D11_A98WWPFormElementId, H001D11_A100WWPFormElementOrderIndex
               }
            }
         );
      ...
      private int[] H001D3_A40000GXC1 ;
      private bool[] H001D3_n40000GXC1 ;
      private GXWebComponent WebComp_GX_Process ;
      private int[] H001D5_A40000GXC1 ;
      private bool[] H001D5_n40000GXC1 ;
      private short[] H001D6_A98WWPFormElementId ;
      private short[] H001D6_A95WWPFormVersionNumber ;
      private short[] H001D6_A94WWPFormId ;
      private string[] H001D6_A117WWPFormElementTitle ;
      private string[] H001D6_A124WWPFormElementMetadata ;
      private GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element AV23WWPFormInstanceElement ;
      private short[] H001D7_A98WWPFormElementId ;
      private int[] H001D7_A102WWPFormInstanceId ;
      private short[] H001D7_A103WWPFormInstanceElementId ;
      private int[] H001D9_A40000GXC1 ;
      private bool[] H001D9_n40000GXC1 ;
      private short[] H001D10_A98WWPFormElementId ;
      private short[] H001D10_A99WWPFormElementParentId ;
      private bool[] H001D10_n99WWPFormElementParentId ;
      private short[] H001D10_A95WWPFormVersionNumber ;
      private short[] H001D10_A94WWPFormId ;
      private string[] H001D10_A117WWPFormElementTitle ;
      private short[] H001D10_A100WWPFormElementOrderIndex ;
      private short[] H001D11_A99WWPFormElementParentId ;
      private bool[] H001D11_n99WWPFormElementParentId ;
      private short[] H001D11_A95WWPFormVersionNumber ;
      private short[] H001D11_A94WWPFormId ;
      private short[] H001D11_A105WWPFormElementType ;
      private short[] H001D11_A106WWPFormElementDataType ;
      private string[] H001D11_A124WWPFormElementMetadata ;
      private short[] H001D11_A98WWPFormElementId ;
      private short[] H001D11_A100WWPFormElementOrderIndex ;
   ...
   public class wwp_df_mdatagrid_wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH001D5;
          prmH001D5 = new Object[] {
          new ParDef("AV22WWPF_1Wwpformid",GXType.Int16,4,0) ,
          new ParDef("AV22WWPF_2Wwpformversionnumbe",GXType.Int16,4,0) ,
          new ParDef("AV17WWPFormElementId",GXType.Int16,4,0)
          };
          Object[] prmH001D6;
          prmH001D6 = new Object[] {
          new ParDef("AV22WWPF_1Wwpformid",GXType.Int16,4,0) ,
          new ParDef("AV22WWPF_2Wwpformversionnumbe",GXType.Int16,4,0) ,
          new ParDef("AV17WWPFormElementId",GXType.Int16,4,0)
          };
          Object[] prmH001D7;
          prmH001D7 = new Object[] {
          new ParDef("AV27WWPFormInstanceId",GXType.Int32,6,0) ,
          new ParDef("AV18WWPFormElementIdSimpleChildren",GXType.Int16,4,0)
          };
          Object[] prmH001D9;
          prmH001D9 = new Object[] {
          new ParDef("AV22WWPF_1Wwpformid",GXType.Int16,4,0) ,
          new ParDef("AV22WWPF_2Wwpformversionnumbe",GXType.Int16,4,0) ,
          new ParDef("AV17WWPFormElementId",GXType.Int16,4,0)
          };
          Object[] prmH001D10;
          prmH001D10 = new Object[] {
          new ParDef("AV22WWPF_1Wwpformid",GXType.Int16,4,0) ,
          new ParDef("AV22WWPF_2Wwpformversionnumbe",GXType.Int16,4,0) ,
          new ParDef("AV17WWPFormElementId",GXType.Int16,4,0)
          };
          Object[] prmH001D11;
          prmH001D11 = new Object[] {
          new ParDef("AV22WWPF_1Wwpformid",GXType.Int16,4,0) ,
          new ParDef("AV22WWPF_2Wwpformversionnumbe",GXType.Int16,4,0) ,
          new ParDef("AV17WWPFormElementId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H001D3", "SELECT COALESCE( T1.GXC1, 0) AS GXC1 FROM (SELECT COUNT(*) AS GXC1 FROM WWP_FormElement WHERE (WWPFormId = :AV22WWPF_1Wwpformid) AND (WWPFormVersionNumber = :AV22WWPF_2Wwpformversionnumbe) AND (WWPFormElementParentId = :AV17WWPFormElementId) AND (WWPFormElementType = 1) ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D3,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001D5", "SELECT COALESCE( T1.GXC1, 0) AS GXC1 FROM (SELECT COUNT(*) AS GXC1 FROM WWP_FormElement WHERE (WWPFormId = :AV22WWPF_1Wwpformid) AND (WWPFormVersionNumber = :AV22WWPF_2Wwpformversionnumbe) AND (WWPFormElementParentId = :AV17WWPFormElementId) AND (WWPFormElementType = 1) ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D5,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001D6", "SELECT WWPFormElementId, WWPFormVersionNumber, WWPFormId, WWPFormElementTitle, WWPFormElementMetadata FROM WWP_FormElement WHERE WWPFormId = :AV22WWPF_1Wwpformid and WWPFormVersionNumber = :AV22WWPF_2Wwpformversionnumbe and WWPFormElementId = :AV17WWPFormElementId ORDER BY WWPFormId, WWPFormVersionNumber, WWPFormElementId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D6,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001D7", "SELECT WWPFormElementId, WWPFormInstanceId, WWPFormInstanceElementId FROM WWP_FormInstanceElement WHERE WWPFormInstanceId = :AV27WWPFormInstanceId and WWPFormElementId = :AV18WWPFormElementIdSimpleChildren ORDER BY WWPFormInstanceId, WWPFormElementId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D7,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001D9", "SELECT COALESCE( T1.GXC1, 0) AS GXC1 FROM (SELECT COUNT(*) AS GXC1 FROM WWP_FormElement WHERE (WWPFormId = :AV22WWPF_1Wwpformid) AND (WWPFormVersionNumber = :AV22WWPF_2Wwpformversionnumbe) AND (WWPFormElementParentId = :AV17WWPFormElementId) AND (WWPFormElementType = 1) ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D9,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001D10", "SELECT WWPFormElementId, WWPFormElementParentId, WWPFormVersionNumber, WWPFormId, WWPFormElementTitle, WWPFormElementOrderIndex FROM WWP_FormElement WHERE (WWPFormId = :AV22WWPF_1Wwpformid) AND (WWPFormVersionNumber = :AV22WWPF_2Wwpformversionnumbe) AND (WWPFormElementParentId = :AV17WWPFormElementId) ORDER BY WWPFormElementOrderIndex ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D10,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001D11", "SELECT WWPFormElementParentId, WWPFormVersionNumber, WWPFormId, WWPFormElementType, WWPFormElementDataType, WWPFormElementMetadata, WWPFormElementId, WWPFormElementOrderIndex FROM WWP_FormElement WHERE (WWPFormId = :AV22WWPF_1Wwpformid) AND (WWPFormVersionNumber = :AV22WWPF_2Wwpformversionnumbe) AND (WWPFormElementParentId = :AV17WWPFormElementId) ORDER BY WWPFormElementOrderIndex ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D11,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
