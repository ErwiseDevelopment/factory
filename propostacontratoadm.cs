...
namespace GeneXus.Programs {
   public class propostacontratoadm : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "propostacontratoadm")), "propostacontratoadm") == 0 ) )
            {
               SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "propostacontratoadm")))) ;
            }
            else
            {
               GxWebError = 1;
      ...
      public propostacontratoadm( IGxContext context )
      {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaCreatedAt_Internalname, context.localUtil.TToC( A327PropostaCreatedAt, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A327PropostaCreatedAt, "99/99/99 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'por',false,0);"+";gx.evt.onblur(this,37);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaCreatedAt_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaCreatedAt_Enabled, 0, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_bitmap( context, edtPropostaCreatedAt_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtPropostaCreatedAt_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_PropostaContratoAdm.htm");
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockpropostacratedby_Internalname, "Crated By", "", "", lblTextblockpropostacratedby_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( context, cmbPropostaStatus, cmbPropostaStatus_Internalname, StringUtil.RTrim( A329PropostaStatus), 1, cmbPropostaStatus_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbPropostaStatus.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,53);\"", "", true, 0, "HLP_PropostaContratoAdm.htm");
         cmbPropostaStatus.CurrentValue = StringUtil.RTrim( A329PropostaStatus);
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockcontratoid_Internalname, "Contrato", "", "", lblTextblockcontratoid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
         /* User Defined Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtContratoId_Internalname, ((0==A227ContratoId)&&IsIns( )||n227ContratoId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A227ContratoId), 6, 0, ",", ""))), ((0==A227ContratoId)&&IsIns( )||n227ContratoId ? "" : StringUtil.LTrim( context.localUtil.Format( (decimal)(A227ContratoId), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtContratoId_Jsonclick, 0, "Attribute", "", "", "", "", edtContratoId_Visible, edtContratoId_Enabled, 1, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaQuantidadeAprovadores_Internalname, ((0==A330PropostaQuantidadeAprovadores)&&IsIns( )||n330PropostaQuantidadeAprovadores ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A330PropostaQuantidadeAprovadores), 4, 0, ",", ""))), ((0==A330PropostaQuantidadeAprovadores)&&IsIns( )||n330PropostaQuantidadeAprovadores ? "" : StringUtil.LTrim( ((edtPropostaQuantidadeAprovadores_Enabled!=0) ? context.localUtil.Format( (decimal)(A330PropostaQuantidadeAprovadores), "ZZZ9") : context.localUtil.Format( (decimal)(A330PropostaQuantidadeAprovadores), "ZZZ9")))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaQuantidadeAprovadores_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaQuantidadeAprovadores_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblockprocedimentosmedicosid_Internalname, "Procedimentos Medicos", "", "", lblTextblockprocedimentosmedicosid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
         /* User Defined Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaAprovacoes_F_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A341PropostaAprovacoes_F), 4, 0, ",", "")), StringUtil.LTrim( ((edtPropostaAprovacoes_F_Enabled!=0) ? context.localUtil.Format( (decimal)(A341PropostaAprovacoes_F), "ZZZ9") : context.localUtil.Format( (decimal)(A341PropostaAprovacoes_F), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,90);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaAprovacoes_F_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaAprovacoes_F_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaReprovacoes_F_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A342PropostaReprovacoes_F), 4, 0, ",", "")), StringUtil.LTrim( ((edtPropostaReprovacoes_F_Enabled!=0) ? context.localUtil.Format( (decimal)(A342PropostaReprovacoes_F), "ZZZ9") : context.localUtil.Format( (decimal)(A342PropostaReprovacoes_F), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,95);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaReprovacoes_F_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaReprovacoes_F_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPropostaAprovacoesRestantes_F_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A343PropostaAprovacoesRestantes_F), 4, 0, ",", "")), StringUtil.LTrim( ((edtPropostaAprovacoesRestantes_F_Enabled!=0) ? context.localUtil.Format( (decimal)(A343PropostaAprovacoesRestantes_F), "ZZZ9") : context.localUtil.Format( (decimal)(A343PropostaAprovacoesRestantes_F), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,100);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPropostaAprovacoesRestantes_F_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtPropostaAprovacoesRestantes_F_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         ClassString = "Button";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_enter_Internalname, "", "Confirmar", bttBtntrn_enter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, bttBtntrn_enter_Visible, bttBtntrn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_cancel_Internalname, "", "Fechar", bttBtntrn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, bttBtntrn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         ClassString = "BtnDefault";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_delete_Internalname, "", "Eliminar", bttBtntrn_delete_Jsonclick, 5, "Eliminar", "", StyleString, ClassString, bttBtntrn_delete_Visible, bttBtntrn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", context.GetButtonType( ), "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtavCombopropostacratedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV19ComboPropostaCratedBy), 4, 0, ",", "")), StringUtil.LTrim( ((edtavCombopropostacratedby_Enabled!=0) ? context.localUtil.Format( (decimal)(AV19ComboPropostaCratedBy), "ZZZ9") : context.localUtil.Format( (decimal)(AV19ComboPropostaCratedBy), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,114);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCombopropostacratedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavCombopropostacratedby_Visible, edtavCombopropostacratedby_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, divSectionattribute_contratoid_Internalname, 1, 0, "px", 0, "px", "Section", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 116,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtavCombocontratoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22ComboContratoId), 6, 0, ",", "")), StringUtil.LTrim( ((edtavCombocontratoid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV22ComboContratoId), "ZZZZZ9") : context.localUtil.Format( (decimal)(AV22ComboContratoId), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,116);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCombocontratoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCombocontratoid_Visible, edtavCombocontratoid_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PropostaContratoAdm.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               forbiddenHiddens.Add("hshsalt", "hsh"+"PropostaContratoAdm");
               A323PropostaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtPropostaId_Internalname), ",", "."), 18, MidpointRounding.ToEven));
               n323PropostaId = false;
               AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
               ...
               {
                  GXUtil.WriteLogError("propostacontratoadm:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
                  GxWebError = 1;
                  context.HttpContext.Response.StatusCode = 403;
                  context.WriteHtmlText( "<title>403 Forbidden</title>") ;
                  context.WriteHtmlText( "<h1>403 Forbidden</h1>") ;
      ...
      protected void E11292( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV9TrnContext.gxTpr_Transactionname, AV30Pgmname) == 0 ) && ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) )
         {
            ...
            {
               AV13TrnContextAtt = ((GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute)AV9TrnContext.gxTpr_Attributes.Item(AV31GXV1));
               if ( StringUtil.StrCmp(AV13TrnContextAtt.gxTpr_Attributename, "ProcedimentosMedicosId") == 0 )
               {
                  ...
                  if ( ! (0==AV24Insert_ProcedimentosMedicosId) )
                  {
                     ...
                     new propostacontratoadmloaddvcombo(context ).execute(  "ProcedimentosMedicosId",  "GET",  false,  AV7PropostaId,  AV13TrnContextAtt.gxTpr_Attributevalue, out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
               ...
               else if ( StringUtil.StrCmp(AV13TrnContextAtt.gxTpr_Attributename, "PropostaCratedBy") == 0 )
               {
                  ...
                  if ( ! (0==AV11Insert_PropostaCratedBy) )
                  {
                     ...
                     GXt_char2 = AV18Combo_DataJson;
                     new propostacontratoadmloaddvcombo(context ).execute(  "PropostaCratedBy",  "GET",  false,  AV7PropostaId,  AV13TrnContextAtt.gxTpr_Attributevalue, out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
                     AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
                     AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
                     AV18Combo_DataJson = GXt_char2;
                     AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
               ...
               else if ( StringUtil.StrCmp(AV13TrnContextAtt.gxTpr_Attributename, "ContratoId") == 0 )
               {
                  ...
                  if ( ! (0==AV12Insert_ContratoId) )
                  {
                     ...
                     GXt_char2 = AV18Combo_DataJson;
                     new propostacontratoadmloaddvcombo(context ).execute(  "ContratoId",  "GET",  false,  AV7PropostaId,  AV13TrnContextAtt.gxTpr_Attributevalue, out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
                     AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
                     AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
                     AV18Combo_DataJson = GXt_char2;
                     AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
      ...
      protected void E12292( )
      {
         ...
         {
            CallWebObject(formatLink("propostacontratoadmww") );
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         GXt_char2 = AV18Combo_DataJson;
         new propostacontratoadmloaddvcombo(context ).execute(  "ProcedimentosMedicosId",  Gx_mode,  false,  AV7PropostaId,  "", out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
         AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
         AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
         AV18Combo_DataJson = GXt_char2;
         AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         GXt_char2 = AV18Combo_DataJson;
         new propostacontratoadmloaddvcombo(context ).execute(  "ContratoId",  Gx_mode,  false,  AV7PropostaId,  "", out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
         AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
         AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
         AV18Combo_DataJson = GXt_char2;
         AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         GXt_char2 = AV18Combo_DataJson;
         new propostacontratoadmloaddvcombo(context ).execute(  "PropostaCratedBy",  Gx_mode,  false,  AV7PropostaId,  "", out  AV16ComboSelectedValue, out  AV17ComboSelectedText, out  GXt_char2) ;
         AssignAttri("", false, "AV16ComboSelectedValue", AV16ComboSelectedValue);
         AssignAttri("", false, "AV17ComboSelectedText", AV17ComboSelectedText);
         AV18Combo_DataJson = GXt_char2;
         AssignAttri("", false, "AV18Combo_DataJson", AV18Combo_DataJson);
      ...
      protected void ZM2949( short GX_JID )
      {
         if ( ( GX_JID == 20 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z327PropostaCreatedAt = T00293_A327PropostaCreatedAt[0];
               Z324PropostaTitulo = T00293_A324PropostaTitulo[0];
               Z325PropostaDescricao = T00293_A325PropostaDescricao[0];
               Z326PropostaValor = T00293_A326PropostaValor[0];
               Z329PropostaStatus = T00293_A329PropostaStatus[0];
               Z330PropostaQuantidadeAprovadores = T00293_A330PropostaQuantidadeAprovadores[0];
               Z345PropostaReprovacoesPermitidas = T00293_A345PropostaReprovacoesPermitidas[0];
               Z227ContratoId = T00293_A227ContratoId[0];
               Z376ProcedimentosMedicosId = T00293_A376ProcedimentosMedicosId[0];
               Z328PropostaCratedBy = T00293_A328PropostaCratedBy[0];
               Z504PropostaPacienteClienteId = T00293_A504PropostaPacienteClienteId[0];
            }
            else
            {
      ...
      protected void standaloneNotModal( )
      {
         ...
         AV30Pgmname = "PropostaContratoAdm";
      ...
      protected void standaloneModal( )
      {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ( Gx_BScreen == 0 ) )
         {
            ...
            {
               A341PropostaAprovacoes_F = T00299_A341PropostaAprovacoes_F[0];
               n341PropostaAprovacoes_F = T00299_n341PropostaAprovacoes_F[0];
               AssignAttri("", false, "A341PropostaAprovacoes_F", StringUtil.LTrimStr( (decimal)(A341PropostaAprovacoes_F), 4, 0));
            }
            else
            {
            ...
            {
               A342PropostaReprovacoes_F = T002911_A342PropostaReprovacoes_F[0];
               n342PropostaReprovacoes_F = T002911_n342PropostaReprovacoes_F[0];
               AssignAttri("", false, "A342PropostaReprovacoes_F", StringUtil.LTrimStr( (decimal)(A342PropostaReprovacoes_F), 4, 0));
            }
            else
            {
            ...
            {
               A548ReembolsoStatusAtual_F = T002914_A548ReembolsoStatusAtual_F[0];
               n548ReembolsoStatusAtual_F = T002914_n548ReembolsoStatusAtual_F[0];
            }
            else
            {
            ...
            A505PropostaPacienteClienteRazaoSocial = T00297_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = T00297_n505PropostaPacienteClienteRazaoSocial[0];
            pr_default.close(5);
         }
      }
      ...
      protected void Load2949( )
      {
         ...
         {
            RcdFound49 = 1;
            A327PropostaCreatedAt = T002919_A327PropostaCreatedAt[0];
            n327PropostaCreatedAt = T002919_n327PropostaCreatedAt[0];
            AssignAttri("", false, "A327PropostaCreatedAt", context.localUtil.TToC( A327PropostaCreatedAt, 8, 5, 0, 3, "/", ":", " "));
            A324PropostaTitulo = T002919_A324PropostaTitulo[0];
            n324PropostaTitulo = T002919_n324PropostaTitulo[0];
            AssignAttri("", false, "A324PropostaTitulo", A324PropostaTitulo);
            A325PropostaDescricao = T002919_A325PropostaDescricao[0];
            n325PropostaDescricao = T002919_n325PropostaDescricao[0];
            AssignAttri("", false, "A325PropostaDescricao", A325PropostaDescricao);
            A326PropostaValor = T002919_A326PropostaValor[0];
            n326PropostaValor = T002919_n326PropostaValor[0];
            ...
            A329PropostaStatus = T002919_A329PropostaStatus[0];
            n329PropostaStatus = T002919_n329PropostaStatus[0];
            AssignAttri("", false, "A329PropostaStatus", A329PropostaStatus);
            A228ContratoNome = T002919_A228ContratoNome[0];
            n228ContratoNome = T002919_n228ContratoNome[0];
            A330PropostaQuantidadeAprovadores = T002919_A330PropostaQuantidadeAprovadores[0];
            n330PropostaQuantidadeAprovadores = T002919_n330PropostaQuantidadeAprovadores[0];
            ...
            A345PropostaReprovacoesPermitidas = T002919_A345PropostaReprovacoesPermitidas[0];
            n345PropostaReprovacoesPermitidas = T002919_n345PropostaReprovacoesPermitidas[0];
            ...
            A505PropostaPacienteClienteRazaoSocial = T002919_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = T002919_n505PropostaPacienteClienteRazaoSocial[0];
            A227ContratoId = T002919_A227ContratoId[0];
            n227ContratoId = T002919_n227ContratoId[0];
            AssignAttri("", false, "A227ContratoId", ((0==A227ContratoId)&&IsIns( )||n227ContratoId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A227ContratoId), 6, 0, ".", ""))));
            A376ProcedimentosMedicosId = T002919_A376ProcedimentosMedicosId[0];
            n376ProcedimentosMedicosId = T002919_n376ProcedimentosMedicosId[0];
            AssignAttri("", false, "A376ProcedimentosMedicosId", ((0==A376ProcedimentosMedicosId)&&IsIns( )||n376ProcedimentosMedicosId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A376ProcedimentosMedicosId), 9, 0, ".", ""))));
            A328PropostaCratedBy = T002919_A328PropostaCratedBy[0];
            n328PropostaCratedBy = T002919_n328PropostaCratedBy[0];
            AssignAttri("", false, "A328PropostaCratedBy", ((0==A328PropostaCratedBy)&&IsIns( )||n328PropostaCratedBy ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A328PropostaCratedBy), 4, 0, ".", ""))));
            A504PropostaPacienteClienteId = T002919_A504PropostaPacienteClienteId[0];
            n504PropostaPacienteClienteId = T002919_n504PropostaPacienteClienteId[0];
            A341PropostaAprovacoes_F = T002919_A341PropostaAprovacoes_F[0];
            n341PropostaAprovacoes_F = T002919_n341PropostaAprovacoes_F[0];
            AssignAttri("", false, "A341PropostaAprovacoes_F", StringUtil.LTrimStr( (decimal)(A341PropostaAprovacoes_F), 4, 0));
            A342PropostaReprovacoes_F = T002919_A342PropostaReprovacoes_F[0];
            n342PropostaReprovacoes_F = T002919_n342PropostaReprovacoes_F[0];
            AssignAttri("", false, "A342PropostaReprovacoes_F", StringUtil.LTrimStr( (decimal)(A342PropostaReprovacoes_F), 4, 0));
            A548ReembolsoStatusAtual_F = T002919_A548ReembolsoStatusAtual_F[0];
            n548ReembolsoStatusAtual_F = T002919_n548ReembolsoStatusAtual_F[0];
            ZM2949( -20) ;
         }
         pr_default.close(9);
         OnLoadActions2949( ) ;
      ...
      protected void CheckExtendedTable2949( )
      {
         ...
         A228ContratoNome = T00294_A228ContratoNome[0];
         n228ContratoNome = T00294_n228ContratoNome[0];
         pr_default.close(2);
         /* Using cursor T00297 */
         pr_default.execute(5, new Object[] {n504PropostaPacienteClienteId, A504PropostaPacienteClienteId});
      ...
      protected void gxLoad_25( int A323PropostaId )
      {
         ...
         {
            A341PropostaAprovacoes_F = T002921_A341PropostaAprovacoes_F[0];
            n341PropostaAprovacoes_F = T002921_n341PropostaAprovacoes_F[0];
            AssignAttri("", false, "A341PropostaAprovacoes_F", StringUtil.LTrimStr( (decimal)(A341PropostaAprovacoes_F), 4, 0));
         }
         else
         {
      ...
      protected void gxLoad_26( int A323PropostaId )
      {
         ...
         {
            A342PropostaReprovacoes_F = T002923_A342PropostaReprovacoes_F[0];
            n342PropostaReprovacoes_F = T002923_n342PropostaReprovacoes_F[0];
            AssignAttri("", false, "A342PropostaReprovacoes_F", StringUtil.LTrimStr( (decimal)(A342PropostaReprovacoes_F), 4, 0));
         }
         else
         {
      ...
      protected void gxLoad_27( int A323PropostaId )
      {
         ...
         {
            A548ReembolsoStatusAtual_F = T002926_A548ReembolsoStatusAtual_F[0];
            n548ReembolsoStatusAtual_F = T002926_n548ReembolsoStatusAtual_F[0];
         }
         else
         {
            A548ReembolsoStatusAtual_F = "";
      ...
      protected void gxLoad_22( int A376ProcedimentosMedicosId )
      {
         ...
         pr_default.execute(13, new Object[] {n376ProcedimentosMedicosId, A376ProcedimentosMedicosId});
      ...
      protected void gxLoad_23( short A328PropostaCratedBy )
      {
         ...
         pr_default.execute(14, new Object[] {n328PropostaCratedBy, A328PropostaCratedBy});
      ...
      protected void gxLoad_21( int A227ContratoId )
      {
         ...
         A228ContratoNome = T002929_A228ContratoNome[0];
         n228ContratoNome = T002929_n228ContratoNome[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void gxLoad_24( int A504PropostaPacienteClienteId )
      {
         ...
         pr_default.execute(16, new Object[] {n504PropostaPacienteClienteId, A504PropostaPacienteClienteId});
         ...
         A505PropostaPacienteClienteRazaoSocial = T002930_A505PropostaPacienteClienteRazaoSocial[0];
         n505PropostaPacienteClienteRazaoSocial = T002930_n505PropostaPacienteClienteRazaoSocial[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM2949( 20) ;
            RcdFound49 = 1;
            A323PropostaId = T00293_A323PropostaId[0];
            n323PropostaId = T00293_n323PropostaId[0];
            AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
            A327PropostaCreatedAt = T00293_A327PropostaCreatedAt[0];
            n327PropostaCreatedAt = T00293_n327PropostaCreatedAt[0];
            AssignAttri("", false, "A327PropostaCreatedAt", context.localUtil.TToC( A327PropostaCreatedAt, 8, 5, 0, 3, "/", ":", " "));
            A324PropostaTitulo = T00293_A324PropostaTitulo[0];
            n324PropostaTitulo = T00293_n324PropostaTitulo[0];
            AssignAttri("", false, "A324PropostaTitulo", A324PropostaTitulo);
            A325PropostaDescricao = T00293_A325PropostaDescricao[0];
            n325PropostaDescricao = T00293_n325PropostaDescricao[0];
            AssignAttri("", false, "A325PropostaDescricao", A325PropostaDescricao);
            A326PropostaValor = T00293_A326PropostaValor[0];
            n326PropostaValor = T00293_n326PropostaValor[0];
            AssignAttri("", false, "A326PropostaValor", ((Convert.ToDecimal(0)==A326PropostaValor)&&IsIns( )||n326PropostaValor ? "" : StringUtil.LTrim( StringUtil.NToC( A326PropostaValor, 18, 2, ".", ""))));
            A329PropostaStatus = T00293_A329PropostaStatus[0];
            n329PropostaStatus = T00293_n329PropostaStatus[0];
            AssignAttri("", false, "A329PropostaStatus", A329PropostaStatus);
            A330PropostaQuantidadeAprovadores = T00293_A330PropostaQuantidadeAprovadores[0];
            n330PropostaQuantidadeAprovadores = T00293_n330PropostaQuantidadeAprovadores[0];
            AssignAttri("", false, "A330PropostaQuantidadeAprovadores", ((0==A330PropostaQuantidadeAprovadores)&&IsIns( )||n330PropostaQuantidadeAprovadores ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A330PropostaQuantidadeAprovadores), 4, 0, ".", ""))));
            A345PropostaReprovacoesPermitidas = T00293_A345PropostaReprovacoesPermitidas[0];
            n345PropostaReprovacoesPermitidas = T00293_n345PropostaReprovacoesPermitidas[0];
            AssignAttri("", false, "A345PropostaReprovacoesPermitidas", ((0==A345PropostaReprovacoesPermitidas)&&IsIns( )||n345PropostaReprovacoesPermitidas ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A345PropostaReprovacoesPermitidas), 4, 0, ".", ""))));
            A227ContratoId = T00293_A227ContratoId[0];
            n227ContratoId = T00293_n227ContratoId[0];
            AssignAttri("", false, "A227ContratoId", ((0==A227ContratoId)&&IsIns( )||n227ContratoId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A227ContratoId), 6, 0, ".", ""))));
            A376ProcedimentosMedicosId = T00293_A376ProcedimentosMedicosId[0];
            n376ProcedimentosMedicosId = T00293_n376ProcedimentosMedicosId[0];
            AssignAttri("", false, "A376ProcedimentosMedicosId", ((0==A376ProcedimentosMedicosId)&&IsIns( )||n376ProcedimentosMedicosId ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A376ProcedimentosMedicosId), 9, 0, ".", ""))));
            A328PropostaCratedBy = T00293_A328PropostaCratedBy[0];
            n328PropostaCratedBy = T00293_n328PropostaCratedBy[0];
            AssignAttri("", false, "A328PropostaCratedBy", ((0==A328PropostaCratedBy)&&IsIns( )||n328PropostaCratedBy ? "" : StringUtil.LTrim( StringUtil.NToC( (decimal)(A328PropostaCratedBy), 4, 0, ".", ""))));
            A504PropostaPacienteClienteId = T00293_A504PropostaPacienteClienteId[0];
            n504PropostaPacienteClienteId = T00293_n504PropostaPacienteClienteId[0];
            Z323PropostaId = A323PropostaId;
            sMode49 = Gx_mode;
            Gx_mode = "DSP";
            AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(18) != 101) && ( ( T002932_A323PropostaId[0] < A323PropostaId ) ) )
            {
               pr_default.readNext(18);
            }
            if ( (pr_default.getStatus(18) != 101) && ( ( T002932_A323PropostaId[0] > A323PropostaId ) ) )
            {
               A323PropostaId = T002932_A323PropostaId[0];
               n323PropostaId = T002932_n323PropostaId[0];
               AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
               RcdFound49 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(19) != 101) && ( ( T002933_A323PropostaId[0] > A323PropostaId ) ) )
            {
               pr_default.readNext(19);
            }
            if ( (pr_default.getStatus(19) != 101) && ( ( T002933_A323PropostaId[0] < A323PropostaId ) ) )
            {
               A323PropostaId = T002933_A323PropostaId[0];
               n323PropostaId = T002933_n323PropostaId[0];
               AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
               RcdFound49 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency2949( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( Z327PropostaCreatedAt != T00292_A327PropostaCreatedAt[0] ) || ( StringUtil.StrCmp(Z324PropostaTitulo, T00292_A324PropostaTitulo[0]) != 0 ) || ( StringUtil.StrCmp(Z325PropostaDescricao, T00292_A325PropostaDescricao[0]) != 0 ) || ( Z326PropostaValor != T00292_A326PropostaValor[0] ) || ( StringUtil.StrCmp(Z329PropostaStatus, T00292_A329PropostaStatus[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z330PropostaQuantidadeAprovadores != T00292_A330PropostaQuantidadeAprovadores[0] ) || ( Z345PropostaReprovacoesPermitidas != T00292_A345PropostaReprovacoesPermitidas[0] ) || ( Z227ContratoId != T00292_A227ContratoId[0] ) || ( Z376ProcedimentosMedicosId != T00292_A376ProcedimentosMedicosId[0] ) || ( Z328PropostaCratedBy != T00292_A328PropostaCratedBy[0] ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z504PropostaPacienteClienteId != T00292_A504PropostaPacienteClienteId[0] ) )
            {
               if ( Z327PropostaCreatedAt != T00292_A327PropostaCreatedAt[0] )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaCreatedAt");
                  GXUtil.WriteLogRaw("Old: ",Z327PropostaCreatedAt);
                  GXUtil.WriteLogRaw("Current: ",T00292_A327PropostaCreatedAt[0]);
               }
               if ( StringUtil.StrCmp(Z324PropostaTitulo, T00292_A324PropostaTitulo[0]) != 0 )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaTitulo");
                  GXUtil.WriteLogRaw("Old: ",Z324PropostaTitulo);
                  GXUtil.WriteLogRaw("Current: ",T00292_A324PropostaTitulo[0]);
               }
               if ( StringUtil.StrCmp(Z325PropostaDescricao, T00292_A325PropostaDescricao[0]) != 0 )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaDescricao");
                  GXUtil.WriteLogRaw("Old: ",Z325PropostaDescricao);
                  GXUtil.WriteLogRaw("Current: ",T00292_A325PropostaDescricao[0]);
               }
               if ( Z326PropostaValor != T00292_A326PropostaValor[0] )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaValor");
                  GXUtil.WriteLogRaw("Old: ",Z326PropostaValor);
                  GXUtil.WriteLogRaw("Current: ",T00292_A326PropostaValor[0]);
               }
               if ( StringUtil.StrCmp(Z329PropostaStatus, T00292_A329PropostaStatus[0]) != 0 )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaStatus");
                  GXUtil.WriteLogRaw("Old: ",Z329PropostaStatus);
                  GXUtil.WriteLogRaw("Current: ",T00292_A329PropostaStatus[0]);
               }
               if ( Z330PropostaQuantidadeAprovadores != T00292_A330PropostaQuantidadeAprovadores[0] )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaQuantidadeAprovadores");
                  GXUtil.WriteLogRaw("Old: ",Z330PropostaQuantidadeAprovadores);
                  GXUtil.WriteLogRaw("Current: ",T00292_A330PropostaQuantidadeAprovadores[0]);
               }
               if ( Z345PropostaReprovacoesPermitidas != T00292_A345PropostaReprovacoesPermitidas[0] )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaReprovacoesPermitidas");
                  GXUtil.WriteLogRaw("Old: ",Z345PropostaReprovacoesPermitidas);
                  GXUtil.WriteLogRaw("Current: ",T00292_A345PropostaReprovacoesPermitidas[0]);
               }
               if ( Z227ContratoId != T00292_A227ContratoId[0] )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"ContratoId");
                  GXUtil.WriteLogRaw("Old: ",Z227ContratoId);
                  GXUtil.WriteLogRaw("Current: ",T00292_A227ContratoId[0]);
               }
               if ( Z376ProcedimentosMedicosId != T00292_A376ProcedimentosMedicosId[0] )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"ProcedimentosMedicosId");
                  GXUtil.WriteLogRaw("Old: ",Z376ProcedimentosMedicosId);
                  GXUtil.WriteLogRaw("Current: ",T00292_A376ProcedimentosMedicosId[0]);
               }
               if ( Z328PropostaCratedBy != T00292_A328PropostaCratedBy[0] )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaCratedBy");
                  GXUtil.WriteLogRaw("Old: ",Z328PropostaCratedBy);
                  GXUtil.WriteLogRaw("Current: ",T00292_A328PropostaCratedBy[0]);
               }
               if ( Z504PropostaPacienteClienteId != T00292_A504PropostaPacienteClienteId[0] )
               {
                  GXUtil.WriteLog("propostacontratoadm:[seudo value changed for attri]"+"PropostaPacienteClienteId");
                  GXUtil.WriteLogRaw("Old: ",Z504PropostaPacienteClienteId);
                  GXUtil.WriteLogRaw("Current: ",T00292_A504PropostaPacienteClienteId[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     A323PropostaId = T002935_A323PropostaId[0];
                     n323PropostaId = T002935_n323PropostaId[0];
                     AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
                     pr_default.close(21);
      ...
      protected void OnDeleteControls2949( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            {
               A341PropostaAprovacoes_F = T002939_A341PropostaAprovacoes_F[0];
               n341PropostaAprovacoes_F = T002939_n341PropostaAprovacoes_F[0];
               AssignAttri("", false, "A341PropostaAprovacoes_F", StringUtil.LTrimStr( (decimal)(A341PropostaAprovacoes_F), 4, 0));
            }
            else
            {
            ...
            {
               A342PropostaReprovacoes_F = T002941_A342PropostaReprovacoes_F[0];
               n342PropostaReprovacoes_F = T002941_n342PropostaReprovacoes_F[0];
               AssignAttri("", false, "A342PropostaReprovacoes_F", StringUtil.LTrimStr( (decimal)(A342PropostaReprovacoes_F), 4, 0));
            }
            else
            {
            ...
            {
               A548ReembolsoStatusAtual_F = T002944_A548ReembolsoStatusAtual_F[0];
               n548ReembolsoStatusAtual_F = T002944_n548ReembolsoStatusAtual_F[0];
            }
            else
            {
               A548ReembolsoStatusAtual_F = "";
            ...
            pr_default.execute(27, new Object[] {n227ContratoId, A227ContratoId});
            A228ContratoNome = T002945_A228ContratoNome[0];
            n228ContratoNome = T002945_n228ContratoNome[0];
            pr_default.close(27);
            A343PropostaAprovacoesRestantes_F = (short)(A330PropostaQuantidadeAprovadores-A341PropostaAprovacoes_F);
            AssignAttri("", false, "A343PropostaAprovacoesRestantes_F", StringUtil.LTrimStr( (decimal)(A343PropostaAprovacoesRestantes_F), 4, 0));
            /* Using cursor T002946 */
            pr_default.execute(28, new Object[] {n504PropostaPacienteClienteId, A504PropostaPacienteClienteId});
            A505PropostaPacienteClienteRazaoSocial = T002946_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = T002946_n505PropostaPacienteClienteRazaoSocial[0];
            pr_default.close(28);
         }
         if ( AnyError == 0 )
         {
      ...
      protected void EndLevel2949( )
      {
         ...
         if ( AnyError == 0 )
         {
            context.CommitDataStores("propostacontratoadm",pr_default);
            if ( AnyError == 0 )
            {
               ConfirmValues290( ) ;
            }
         ...
         {
            context.RollbackDataStores("propostacontratoadm",pr_default);
         }
         IsModified = 0;
         if ( AnyError != 0 )
         {
      ...
      public void ScanStart2949( )
      {
         ...
         {
            RcdFound49 = 1;
            A323PropostaId = T002954_A323PropostaId[0];
            n323PropostaId = T002954_n323PropostaId[0];
            AssignAttri("", false, "A323PropostaId", StringUtil.LTrimStr( (decimal)(A323PropostaId), 9, 0));
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext2949( )
      {
         /* Scan next routine */
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "propostacontratoadm"+UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.LTrimStr(AV7PropostaId,9,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormWithFixedActions\" data-gx-class=\"form-horizontal FormWithFixedActions\" novalidate action=\""+formatLink("propostacontratoadm") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLogInfo("propostacontratoadm:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "propostacontratoadm"+UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.LTrimStr(AV7PropostaId,9,0));
         return formatLink("propostacontratoadm") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "PropostaContratoAdm" ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918501186", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("propostacontratoadm.js", "?202551918501187", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Combo_procedimentosmedicosid_Datalistproc = "PropostaContratoAdmLoadDVCombo";
         ...
         Combo_contratoid_Datalistproc = "PropostaContratoAdmLoadDVCombo";
         ...
         Combo_propostacratedby_Datalistproc = "PropostaContratoAdmLoadDVCombo";
      ...
      public void Valid_Propostacratedby( )
      {
         ...
         pr_default.execute(37, new Object[] {n328PropostaCratedBy, A328PropostaCratedBy});
      ...
      public void Valid_Procedimentosmedicosid( )
      {
         ...
         pr_default.execute(38, new Object[] {n376ProcedimentosMedicosId, A376ProcedimentosMedicosId});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("AFTER TRN","""{"handler":"E12292","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true,"type":"char"},{"av":"AV9TrnContext","fld":"vTRNCONTEXT","hsh":true,"type":""}]}""");
         ...
         setEventMetadata("VALID_PROPOSTAID","""{"handler":"Valid_Propostaid","iparms":[{"av":"A323PropostaId","fld":"PROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A341PropostaAprovacoes_F","fld":"PROPOSTAAPROVACOES_F","pic":"ZZZ9","type":"int"},{"av":"A342PropostaReprovacoes_F","fld":"PROPOSTAREPROVACOES_F","pic":"ZZZ9","type":"int"},{"av":"A548ReembolsoStatusAtual_F","fld":"REEMBOLSOSTATUSATUAL_F","type":"svchar"}]""");
         setEventMetadata("VALID_PROPOSTAID",""","oparms":[{"av":"A341PropostaAprovacoes_F","fld":"PROPOSTAAPROVACOES_F","pic":"ZZZ9","type":"int"},{"av":"A342PropostaReprovacoes_F","fld":"PROPOSTAREPROVACOES_F","pic":"ZZZ9","type":"int"},{"av":"A548ReembolsoStatusAtual_F","fld":"REEMBOLSOSTATUSATUAL_F","type":"svchar"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         Z228ContratoNome = "";
         T00299_A341PropostaAprovacoes_F = new short[1] ;
         T00299_n341PropostaAprovacoes_F = new bool[] {false} ;
         T002911_A342PropostaReprovacoes_F = new short[1] ;
         T002911_n342PropostaReprovacoes_F = new bool[] {false} ;
         T002914_A548ReembolsoStatusAtual_F = new string[] {""} ;
         T002914_n548ReembolsoStatusAtual_F = new bool[] {false} ;
         T00297_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         T00297_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         T002919_A323PropostaId = new int[1] ;
         T002919_n323PropostaId = new bool[] {false} ;
         T002919_A327PropostaCreatedAt = new DateTime[] {DateTime.MinValue} ;
         T002919_n327PropostaCreatedAt = new bool[] {false} ;
         T002919_A324PropostaTitulo = new string[] {""} ;
         T002919_n324PropostaTitulo = new bool[] {false} ;
         T002919_A325PropostaDescricao = new string[] {""} ;
         T002919_n325PropostaDescricao = new bool[] {false} ;
         T002919_A326PropostaValor = new decimal[1] ;
         T002919_n326PropostaValor = new bool[] {false} ;
         T002919_A329PropostaStatus = new string[] {""} ;
         T002919_n329PropostaStatus = new bool[] {false} ;
         T002919_A228ContratoNome = new string[] {""} ;
         T002919_n228ContratoNome = new bool[] {false} ;
         T002919_A330PropostaQuantidadeAprovadores = new short[1] ;
         T002919_n330PropostaQuantidadeAprovadores = new bool[] {false} ;
         T002919_A345PropostaReprovacoesPermitidas = new short[1] ;
         T002919_n345PropostaReprovacoesPermitidas = new bool[] {false} ;
         T002919_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         T002919_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         T002919_A227ContratoId = new int[1] ;
         T002919_n227ContratoId = new bool[] {false} ;
         T002919_A376ProcedimentosMedicosId = new int[1] ;
         T002919_n376ProcedimentosMedicosId = new bool[] {false} ;
         T002919_A328PropostaCratedBy = new short[1] ;
         T002919_n328PropostaCratedBy = new bool[] {false} ;
         T002919_A504PropostaPacienteClienteId = new int[1] ;
         T002919_n504PropostaPacienteClienteId = new bool[] {false} ;
         T002919_A341PropostaAprovacoes_F = new short[1] ;
         T002919_n341PropostaAprovacoes_F = new bool[] {false} ;
         T002919_A342PropostaReprovacoes_F = new short[1] ;
         T002919_n342PropostaReprovacoes_F = new bool[] {false} ;
         T002919_A548ReembolsoStatusAtual_F = new string[] {""} ;
         T002919_n548ReembolsoStatusAtual_F = new bool[] {false} ;
         T00295_A376ProcedimentosMedicosId = new int[1] ;
         T00295_n376ProcedimentosMedicosId = new bool[] {false} ;
         T00296_A328PropostaCratedBy = new short[1] ;
         T00296_n328PropostaCratedBy = new bool[] {false} ;
         T00294_A228ContratoNome = new string[] {""} ;
         T00294_n228ContratoNome = new bool[] {false} ;
         T002921_A341PropostaAprovacoes_F = new short[1] ;
         T002921_n341PropostaAprovacoes_F = new bool[] {false} ;
         T002923_A342PropostaReprovacoes_F = new short[1] ;
         T002923_n342PropostaReprovacoes_F = new bool[] {false} ;
         T002926_A548ReembolsoStatusAtual_F = new string[] {""} ;
         T002926_n548ReembolsoStatusAtual_F = new bool[] {false} ;
         T002927_A376ProcedimentosMedicosId = new int[1] ;
         T002927_n376ProcedimentosMedicosId = new bool[] {false} ;
         T002928_A328PropostaCratedBy = new short[1] ;
         T002928_n328PropostaCratedBy = new bool[] {false} ;
         T002929_A228ContratoNome = new string[] {""} ;
         T002929_n228ContratoNome = new bool[] {false} ;
         T002930_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         T002930_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         T002931_A323PropostaId = new int[1] ;
         T002931_n323PropostaId = new bool[] {false} ;
         T00293_A323PropostaId = new int[1] ;
         T00293_n323PropostaId = new bool[] {false} ;
         T00293_A327PropostaCreatedAt = new DateTime[] {DateTime.MinValue} ;
         T00293_n327PropostaCreatedAt = new bool[] {false} ;
         T00293_A324PropostaTitulo = new string[] {""} ;
         T00293_n324PropostaTitulo = new bool[] {false} ;
         T00293_A325PropostaDescricao = new string[] {""} ;
         T00293_n325PropostaDescricao = new bool[] {false} ;
         T00293_A326PropostaValor = new decimal[1] ;
         T00293_n326PropostaValor = new bool[] {false} ;
         T00293_A329PropostaStatus = new string[] {""} ;
         T00293_n329PropostaStatus = new bool[] {false} ;
         T00293_A330PropostaQuantidadeAprovadores = new short[1] ;
         T00293_n330PropostaQuantidadeAprovadores = new bool[] {false} ;
         T00293_A345PropostaReprovacoesPermitidas = new short[1] ;
         T00293_n345PropostaReprovacoesPermitidas = new bool[] {false} ;
         T00293_A227ContratoId = new int[1] ;
         T00293_n227ContratoId = new bool[] {false} ;
         T00293_A376ProcedimentosMedicosId = new int[1] ;
         T00293_n376ProcedimentosMedicosId = new bool[] {false} ;
         T00293_A328PropostaCratedBy = new short[1] ;
         T00293_n328PropostaCratedBy = new bool[] {false} ;
         T00293_A504PropostaPacienteClienteId = new int[1] ;
         T00293_n504PropostaPacienteClienteId = new bool[] {false} ;
         T002932_A323PropostaId = new int[1] ;
         T002932_n323PropostaId = new bool[] {false} ;
         T002933_A323PropostaId = new int[1] ;
         T002933_n323PropostaId = new bool[] {false} ;
         T00292_A323PropostaId = new int[1] ;
         T00292_n323PropostaId = new bool[] {false} ;
         T00292_A327PropostaCreatedAt = new DateTime[] {DateTime.MinValue} ;
         T00292_n327PropostaCreatedAt = new bool[] {false} ;
         T00292_A324PropostaTitulo = new string[] {""} ;
         T00292_n324PropostaTitulo = new bool[] {false} ;
         T00292_A325PropostaDescricao = new string[] {""} ;
         T00292_n325PropostaDescricao = new bool[] {false} ;
         T00292_A326PropostaValor = new decimal[1] ;
         T00292_n326PropostaValor = new bool[] {false} ;
         T00292_A329PropostaStatus = new string[] {""} ;
         T00292_n329PropostaStatus = new bool[] {false} ;
         T00292_A330PropostaQuantidadeAprovadores = new short[1] ;
         T00292_n330PropostaQuantidadeAprovadores = new bool[] {false} ;
         T00292_A345PropostaReprovacoesPermitidas = new short[1] ;
         T00292_n345PropostaReprovacoesPermitidas = new bool[] {false} ;
         T00292_A227ContratoId = new int[1] ;
         T00292_n227ContratoId = new bool[] {false} ;
         T00292_A376ProcedimentosMedicosId = new int[1] ;
         T00292_n376ProcedimentosMedicosId = new bool[] {false} ;
         T00292_A328PropostaCratedBy = new short[1] ;
         T00292_n328PropostaCratedBy = new bool[] {false} ;
         T00292_A504PropostaPacienteClienteId = new int[1] ;
         T00292_n504PropostaPacienteClienteId = new bool[] {false} ;
         T002935_A323PropostaId = new int[1] ;
         T002935_n323PropostaId = new bool[] {false} ;
         T002939_A341PropostaAprovacoes_F = new short[1] ;
         T002939_n341PropostaAprovacoes_F = new bool[] {false} ;
         T002941_A342PropostaReprovacoes_F = new short[1] ;
         T002941_n342PropostaReprovacoes_F = new bool[] {false} ;
         T002944_A548ReembolsoStatusAtual_F = new string[] {""} ;
         T002944_n548ReembolsoStatusAtual_F = new bool[] {false} ;
         T002945_A228ContratoNome = new string[] {""} ;
         T002945_n228ContratoNome = new bool[] {false} ;
         T002946_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         T002946_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         T002947_A227ContratoId = new int[1] ;
         T002947_n227ContratoId = new bool[] {false} ;
         T002948_A518ReembolsoId = new int[1] ;
         T002948_n518ReembolsoId = new bool[] {false} ;
         T002949_A261TituloId = new int[1] ;
         T002950_A830NotaFiscalItemId = new Guid[] {Guid.Empty} ;
         T002951_A572PropostaContratoAssinaturaId = new int[1] ;
         T002952_A414PropostaDocumentosId = new int[1] ;
         T002953_A336AprovacaoId = new int[1] ;
         T002954_A323PropostaId = new int[1] ;
         T002954_n323PropostaId = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXEncryptionTmp = "";
         i327PropostaCreatedAt = (DateTime)(DateTime.MinValue);
         T002955_A328PropostaCratedBy = new short[1] ;
         T002955_n328PropostaCratedBy = new bool[] {false} ;
         T002956_A376ProcedimentosMedicosId = new int[1] ;
         T002956_n376ProcedimentosMedicosId = new bool[] {false} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.propostacontratoadm__default(),
            new Object[][] {
                new Object[] {
               T00292_A323PropostaId, T00292_A327PropostaCreatedAt, T00292_n327PropostaCreatedAt, T00292_A324PropostaTitulo, T00292_n324PropostaTitulo, T00292_A325PropostaDescricao, T00292_n325PropostaDescricao, T00292_A326PropostaValor, T00292_n326PropostaValor, T00292_A329PropostaStatus,
               T00292_n329PropostaStatus, T00292_A330PropostaQuantidadeAprovadores, T00292_n330PropostaQuantidadeAprovadores, T00292_A345PropostaReprovacoesPermitidas, T00292_n345PropostaReprovacoesPermitidas, T00292_A227ContratoId, T00292_n227ContratoId, T00292_A376ProcedimentosMedicosId, T00292_n376ProcedimentosMedicosId, T00292_A328PropostaCratedBy,
               T00292_n328PropostaCratedBy, T00292_A504PropostaPacienteClienteId, T00292_n504PropostaPacienteClienteId
               }
               , new Object[] {
               T00293_A323PropostaId, T00293_A327PropostaCreatedAt, T00293_n327PropostaCreatedAt, T00293_A324PropostaTitulo, T00293_n324PropostaTitulo, T00293_A325PropostaDescricao, T00293_n325PropostaDescricao, T00293_A326PropostaValor, T00293_n326PropostaValor, T00293_A329PropostaStatus,
               T00293_n329PropostaStatus, T00293_A330PropostaQuantidadeAprovadores, T00293_n330PropostaQuantidadeAprovadores, T00293_A345PropostaReprovacoesPermitidas, T00293_n345PropostaReprovacoesPermitidas, T00293_A227ContratoId, T00293_n227ContratoId, T00293_A376ProcedimentosMedicosId, T00293_n376ProcedimentosMedicosId, T00293_A328PropostaCratedBy,
               T00293_n328PropostaCratedBy, T00293_A504PropostaPacienteClienteId, T00293_n504PropostaPacienteClienteId
               }
               , new Object[] {
               T00294_A228ContratoNome, T00294_n228ContratoNome
               }
               , new Object[] {
               T00295_A376ProcedimentosMedicosId
               }
               , new Object[] {
               T00296_A328PropostaCratedBy
               }
               , new Object[] {
               T00297_A505PropostaPacienteClienteRazaoSocial, T00297_n505PropostaPacienteClienteRazaoSocial
               }
               , new Object[] {
               T00299_A341PropostaAprovacoes_F, T00299_n341PropostaAprovacoes_F
               }
               , new Object[] {
               T002911_A342PropostaReprovacoes_F, T002911_n342PropostaReprovacoes_F
               }
               , new Object[] {
               T002914_A548ReembolsoStatusAtual_F, T002914_n548ReembolsoStatusAtual_F
               }
               , new Object[] {
               T002919_A323PropostaId, T002919_A327PropostaCreatedAt, T002919_n327PropostaCreatedAt, T002919_A324PropostaTitulo, T002919_n324PropostaTitulo, T002919_A325PropostaDescricao, T002919_n325PropostaDescricao, T002919_A326PropostaValor, T002919_n326PropostaValor, T002919_A329PropostaStatus,
               T002919_n329PropostaStatus, T002919_A228ContratoNome, T002919_n228ContratoNome, T002919_A330PropostaQuantidadeAprovadores, T002919_n330PropostaQuantidadeAprovadores, T002919_A345PropostaReprovacoesPermitidas, T002919_n345PropostaReprovacoesPermitidas, T002919_A505PropostaPacienteClienteRazaoSocial, T002919_n505PropostaPacienteClienteRazaoSocial, T002919_A227ContratoId,
               T002919_n227ContratoId, T002919_A376ProcedimentosMedicosId, T002919_n376ProcedimentosMedicosId, T002919_A328PropostaCratedBy, T002919_n328PropostaCratedBy, T002919_A504PropostaPacienteClienteId, T002919_n504PropostaPacienteClienteId, T002919_A341PropostaAprovacoes_F, T002919_n341PropostaAprovacoes_F, T002919_A342PropostaReprovacoes_F,
               T002919_n342PropostaReprovacoes_F, T002919_A548ReembolsoStatusAtual_F, T002919_n548ReembolsoStatusAtual_F
               }
               , new Object[] {
               T002921_A341PropostaAprovacoes_F, T002921_n341PropostaAprovacoes_F
               }
               , new Object[] {
               T002923_A342PropostaReprovacoes_F, T002923_n342PropostaReprovacoes_F
               }
               , new Object[] {
               T002926_A548ReembolsoStatusAtual_F, T002926_n548ReembolsoStatusAtual_F
               }
               , new Object[] {
               T002927_A376ProcedimentosMedicosId
               }
               , new Object[] {
               T002928_A328PropostaCratedBy
               }
               , new Object[] {
               T002929_A228ContratoNome, T002929_n228ContratoNome
               }
               , new Object[] {
               T002930_A505PropostaPacienteClienteRazaoSocial, T002930_n505PropostaPacienteClienteRazaoSocial
               }
               , new Object[] {
               T002931_A323PropostaId
               }
               , new Object[] {
               T002932_A323PropostaId
               }
               , new Object[] {
               T002933_A323PropostaId
               }
               , new Object[] {
               }
               , new Object[] {
               T002935_A323PropostaId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T002939_A341PropostaAprovacoes_F, T002939_n341PropostaAprovacoes_F
               }
               , new Object[] {
               T002941_A342PropostaReprovacoes_F, T002941_n342PropostaReprovacoes_F
               }
               , new Object[] {
               T002944_A548ReembolsoStatusAtual_F, T002944_n548ReembolsoStatusAtual_F
               }
               , new Object[] {
               T002945_A228ContratoNome, T002945_n228ContratoNome
               }
               , new Object[] {
               T002946_A505PropostaPacienteClienteRazaoSocial, T002946_n505PropostaPacienteClienteRazaoSocial
               }
               , new Object[] {
               T002947_A227ContratoId
               }
               , new Object[] {
               T002948_A518ReembolsoId
               }
               , new Object[] {
               T002949_A261TituloId
               }
               , new Object[] {
               T002950_A830NotaFiscalItemId
               }
               , new Object[] {
               T002951_A572PropostaContratoAssinaturaId
               }
               , new Object[] {
               T002952_A414PropostaDocumentosId
               }
               , new Object[] {
               T002953_A336AprovacaoId
               }
               , new Object[] {
               T002954_A323PropostaId
               }
               , new Object[] {
               T002955_A328PropostaCratedBy
               }
               , new Object[] {
               T002956_A376ProcedimentosMedicosId
               }
            }
         );
         AV30Pgmname = "PropostaContratoAdm";
      ...
      private short[] T00299_A341PropostaAprovacoes_F ;
      private bool[] T00299_n341PropostaAprovacoes_F ;
      private short[] T002911_A342PropostaReprovacoes_F ;
      private bool[] T002911_n342PropostaReprovacoes_F ;
      private string[] T002914_A548ReembolsoStatusAtual_F ;
      private bool[] T002914_n548ReembolsoStatusAtual_F ;
      private string[] T00297_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] T00297_n505PropostaPacienteClienteRazaoSocial ;
      private int[] T002919_A323PropostaId ;
      private bool[] T002919_n323PropostaId ;
      private DateTime[] T002919_A327PropostaCreatedAt ;
      private bool[] T002919_n327PropostaCreatedAt ;
      private string[] T002919_A324PropostaTitulo ;
      private bool[] T002919_n324PropostaTitulo ;
      private string[] T002919_A325PropostaDescricao ;
      private bool[] T002919_n325PropostaDescricao ;
      private decimal[] T002919_A326PropostaValor ;
      private bool[] T002919_n326PropostaValor ;
      private string[] T002919_A329PropostaStatus ;
      private bool[] T002919_n329PropostaStatus ;
      private string[] T002919_A228ContratoNome ;
      private bool[] T002919_n228ContratoNome ;
      private short[] T002919_A330PropostaQuantidadeAprovadores ;
      private bool[] T002919_n330PropostaQuantidadeAprovadores ;
      private short[] T002919_A345PropostaReprovacoesPermitidas ;
      private bool[] T002919_n345PropostaReprovacoesPermitidas ;
      private string[] T002919_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] T002919_n505PropostaPacienteClienteRazaoSocial ;
      private int[] T002919_A227ContratoId ;
      private bool[] T002919_n227ContratoId ;
      private int[] T002919_A376ProcedimentosMedicosId ;
      private bool[] T002919_n376ProcedimentosMedicosId ;
      private short[] T002919_A328PropostaCratedBy ;
      private bool[] T002919_n328PropostaCratedBy ;
      private int[] T002919_A504PropostaPacienteClienteId ;
      private bool[] T002919_n504PropostaPacienteClienteId ;
      private short[] T002919_A341PropostaAprovacoes_F ;
      private bool[] T002919_n341PropostaAprovacoes_F ;
      private short[] T002919_A342PropostaReprovacoes_F ;
      private bool[] T002919_n342PropostaReprovacoes_F ;
      private string[] T002919_A548ReembolsoStatusAtual_F ;
      private bool[] T002919_n548ReembolsoStatusAtual_F ;
      private int[] T00295_A376ProcedimentosMedicosId ;
      private bool[] T00295_n376ProcedimentosMedicosId ;
      private short[] T00296_A328PropostaCratedBy ;
      private bool[] T00296_n328PropostaCratedBy ;
      private string[] T00294_A228ContratoNome ;
      private bool[] T00294_n228ContratoNome ;
      private short[] T002921_A341PropostaAprovacoes_F ;
      private bool[] T002921_n341PropostaAprovacoes_F ;
      private short[] T002923_A342PropostaReprovacoes_F ;
      private bool[] T002923_n342PropostaReprovacoes_F ;
      private string[] T002926_A548ReembolsoStatusAtual_F ;
      private bool[] T002926_n548ReembolsoStatusAtual_F ;
      private int[] T002927_A376ProcedimentosMedicosId ;
      private bool[] T002927_n376ProcedimentosMedicosId ;
      private short[] T002928_A328PropostaCratedBy ;
      private bool[] T002928_n328PropostaCratedBy ;
      private string[] T002929_A228ContratoNome ;
      private bool[] T002929_n228ContratoNome ;
      private string[] T002930_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] T002930_n505PropostaPacienteClienteRazaoSocial ;
      private int[] T002931_A323PropostaId ;
      private bool[] T002931_n323PropostaId ;
      private int[] T00293_A323PropostaId ;
      private bool[] T00293_n323PropostaId ;
      private DateTime[] T00293_A327PropostaCreatedAt ;
      private bool[] T00293_n327PropostaCreatedAt ;
      private string[] T00293_A324PropostaTitulo ;
      private bool[] T00293_n324PropostaTitulo ;
      private string[] T00293_A325PropostaDescricao ;
      private bool[] T00293_n325PropostaDescricao ;
      private decimal[] T00293_A326PropostaValor ;
      private bool[] T00293_n326PropostaValor ;
      private string[] T00293_A329PropostaStatus ;
      private bool[] T00293_n329PropostaStatus ;
      private short[] T00293_A330PropostaQuantidadeAprovadores ;
      private bool[] T00293_n330PropostaQuantidadeAprovadores ;
      private short[] T00293_A345PropostaReprovacoesPermitidas ;
      private bool[] T00293_n345PropostaReprovacoesPermitidas ;
      private int[] T00293_A227ContratoId ;
      private bool[] T00293_n227ContratoId ;
      private int[] T00293_A376ProcedimentosMedicosId ;
      private bool[] T00293_n376ProcedimentosMedicosId ;
      private short[] T00293_A328PropostaCratedBy ;
      private bool[] T00293_n328PropostaCratedBy ;
      private int[] T00293_A504PropostaPacienteClienteId ;
      private bool[] T00293_n504PropostaPacienteClienteId ;
      private int[] T002932_A323PropostaId ;
      private bool[] T002932_n323PropostaId ;
      private int[] T002933_A323PropostaId ;
      private bool[] T002933_n323PropostaId ;
      private int[] T00292_A323PropostaId ;
      private bool[] T00292_n323PropostaId ;
      private DateTime[] T00292_A327PropostaCreatedAt ;
      private bool[] T00292_n327PropostaCreatedAt ;
      private string[] T00292_A324PropostaTitulo ;
      private bool[] T00292_n324PropostaTitulo ;
      private string[] T00292_A325PropostaDescricao ;
      private bool[] T00292_n325PropostaDescricao ;
      private decimal[] T00292_A326PropostaValor ;
      private bool[] T00292_n326PropostaValor ;
      private string[] T00292_A329PropostaStatus ;
      private bool[] T00292_n329PropostaStatus ;
      private short[] T00292_A330PropostaQuantidadeAprovadores ;
      private bool[] T00292_n330PropostaQuantidadeAprovadores ;
      private short[] T00292_A345PropostaReprovacoesPermitidas ;
      private bool[] T00292_n345PropostaReprovacoesPermitidas ;
      private int[] T00292_A227ContratoId ;
      private bool[] T00292_n227ContratoId ;
      private int[] T00292_A376ProcedimentosMedicosId ;
      private bool[] T00292_n376ProcedimentosMedicosId ;
      private short[] T00292_A328PropostaCratedBy ;
      private bool[] T00292_n328PropostaCratedBy ;
      private int[] T00292_A504PropostaPacienteClienteId ;
      private bool[] T00292_n504PropostaPacienteClienteId ;
      private int[] T002935_A323PropostaId ;
      private bool[] T002935_n323PropostaId ;
      private short[] T002939_A341PropostaAprovacoes_F ;
      private bool[] T002939_n341PropostaAprovacoes_F ;
      private short[] T002941_A342PropostaReprovacoes_F ;
      private bool[] T002941_n342PropostaReprovacoes_F ;
      private string[] T002944_A548ReembolsoStatusAtual_F ;
      private bool[] T002944_n548ReembolsoStatusAtual_F ;
      private string[] T002945_A228ContratoNome ;
      private bool[] T002945_n228ContratoNome ;
      private string[] T002946_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] T002946_n505PropostaPacienteClienteRazaoSocial ;
      private int[] T002947_A227ContratoId ;
      private bool[] T002947_n227ContratoId ;
      private int[] T002948_A518ReembolsoId ;
      private bool[] T002948_n518ReembolsoId ;
      private int[] T002949_A261TituloId ;
      private Guid[] T002950_A830NotaFiscalItemId ;
      private int[] T002951_A572PropostaContratoAssinaturaId ;
      private int[] T002952_A414PropostaDocumentosId ;
      private int[] T002953_A336AprovacaoId ;
      private int[] T002954_A323PropostaId ;
      private bool[] T002954_n323PropostaId ;
      private short[] T002955_A328PropostaCratedBy ;
      private bool[] T002955_n328PropostaCratedBy ;
      private int[] T002956_A376ProcedimentosMedicosId ;
      private bool[] T002956_n376ProcedimentosMedicosId ;
   }

   public class propostacontratoadm__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          string cmdBufferT002919;
          cmdBufferT002919=" SELECT TM1.PropostaId, TM1.PropostaCreatedAt, TM1.PropostaTitulo, TM1.PropostaDescricao, TM1.PropostaValor, TM1.PropostaStatus, T6.ContratoNome, TM1.PropostaQuantidadeAprovadores, TM1.PropostaReprovacoesPermitidas, T2.ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial, TM1.ContratoId, TM1.ProcedimentosMedicosId, TM1.PropostaCratedBy AS PropostaCratedBy, TM1.PropostaPacienteClienteId AS PropostaPacienteClienteId, COALESCE( T3.PropostaAprovacoes_F, 0) AS PropostaAprovacoes_F, COALESCE( T4.PropostaAprovacoes_F, 0) AS PropostaReprovacoes_F, COALESCE( T5.ReembolsoStatusAtual_F, '') AS ReembolsoStatusAtual_F FROM (((((Proposta TM1 LEFT JOIN Cliente T2 ON T2.ClienteId = TM1.PropostaPacienteClienteId) LEFT JOIN LATERAL (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE (TM1.PropostaId = PropostaId) AND (AprovacaoStatus = ( 'APROVADO')) GROUP BY PropostaId ) T3 ON T3.PropostaId = TM1.PropostaId) LEFT JOIN LATERAL (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE (TM1.PropostaId = PropostaId) AND (AprovacaoStatus = ( 'REPROVADO')) GROUP BY PropostaId ) T4 ON T4.PropostaId = TM1.PropostaId) LEFT JOIN LATERAL (SELECT MIN(T7.ReembolsoEtapaStatus) AS ReembolsoStatusAtual_F, COALESCE( T9.ReembolsoEtapaUltimo_F, DATE '00010101') AS ReembolsoEtapaUltimo_F, T8.ReembolsoPropostaId FROM ((ReembolsoEtapa T7 LEFT JOIN Reembolso T8 ON T8.ReembolsoId = T7.ReembolsoId) LEFT JOIN LATERAL (SELECT MAX(ReembolsoEtapaCreatedAt) AS ReembolsoEtapaUltimo_F, ReembolsoId FROM ReembolsoEtapa WHERE T7.ReembolsoId = ReembolsoId GROUP BY ReembolsoId ) T9 ON T9.ReembolsoId = T7.ReembolsoId) WHERE (TM1.PropostaId = T8.ReembolsoPropostaId) AND (T7.ReembolsoEtapaCreatedAt = COALESCE( T9.ReembolsoEtapaUltimo_F, DATE '00010101')) GROUP BY T9.ReembolsoEtapaUltimo_F, "
          + " T8.ReembolsoPropostaId ) T5 ON T5.ReembolsoPropostaId = TM1.PropostaId) LEFT JOIN Contrato T6 ON T6.ContratoId = TM1.ContratoId) WHERE TM1.PropostaId = :PropostaId ORDER BY TM1.PropostaId" ;
          Object[] prmT002921;
          ...
          def= new CursorDef[] {
              new CursorDef("T00292", "SELECT PropostaId, PropostaCreatedAt, PropostaTitulo, PropostaDescricao, PropostaValor, PropostaStatus, PropostaQuantidadeAprovadores, PropostaReprovacoesPermitidas, ContratoId, ProcedimentosMedicosId, PropostaCratedBy, PropostaPacienteClienteId FROM Proposta WHERE PropostaId = :PropostaId  FOR UPDATE OF Proposta NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT00292,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00293", "SELECT PropostaId, PropostaCreatedAt, PropostaTitulo, PropostaDescricao, PropostaValor, PropostaStatus, PropostaQuantidadeAprovadores, PropostaReprovacoesPermitidas, ContratoId, ProcedimentosMedicosId, PropostaCratedBy, PropostaPacienteClienteId FROM Proposta WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00293,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00294", "SELECT ContratoNome FROM Contrato WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00294,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00295", "SELECT ProcedimentosMedicosId FROM ProcedimentosMedicos WHERE ProcedimentosMedicosId = :ProcedimentosMedicosId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00295,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00296", "SELECT SecUserId AS PropostaCratedBy FROM SecUser WHERE SecUserId = :PropostaCratedBy ",true, GxErrorMask.GX_NOMASK, false, this,prmT00296,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00297", "SELECT ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial FROM Cliente WHERE ClienteId = :PropostaPacienteClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00297,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00299", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaAprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'APROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00299,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002911", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaReprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'REPROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002911,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002914", "SELECT COALESCE( T1.ReembolsoStatusAtual_F, '') AS ReembolsoStatusAtual_F FROM (SELECT MIN(T2.ReembolsoEtapaStatus) AS ReembolsoStatusAtual_F, COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') AS ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId FROM ((ReembolsoEtapa T2 LEFT JOIN Reembolso T3 ON T3.ReembolsoId = T2.ReembolsoId) LEFT JOIN LATERAL (SELECT MAX(ReembolsoEtapaCreatedAt) AS ReembolsoEtapaUltimo_F, ReembolsoId FROM ReembolsoEtapa WHERE T2.ReembolsoId = ReembolsoId GROUP BY ReembolsoId ) T4 ON T4.ReembolsoId = T2.ReembolsoId) WHERE T2.ReembolsoEtapaCreatedAt = COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') GROUP BY T4.ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002914,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002919", cmdBufferT002919,true, GxErrorMask.GX_NOMASK, false, this,prmT002919,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002921", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaAprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'APROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002921,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002923", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaReprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'REPROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002923,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002926", "SELECT COALESCE( T1.ReembolsoStatusAtual_F, '') AS ReembolsoStatusAtual_F FROM (SELECT MIN(T2.ReembolsoEtapaStatus) AS ReembolsoStatusAtual_F, COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') AS ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId FROM ((ReembolsoEtapa T2 LEFT JOIN Reembolso T3 ON T3.ReembolsoId = T2.ReembolsoId) LEFT JOIN LATERAL (SELECT MAX(ReembolsoEtapaCreatedAt) AS ReembolsoEtapaUltimo_F, ReembolsoId FROM ReembolsoEtapa WHERE T2.ReembolsoId = ReembolsoId GROUP BY ReembolsoId ) T4 ON T4.ReembolsoId = T2.ReembolsoId) WHERE T2.ReembolsoEtapaCreatedAt = COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') GROUP BY T4.ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002926,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002927", "SELECT ProcedimentosMedicosId FROM ProcedimentosMedicos WHERE ProcedimentosMedicosId = :ProcedimentosMedicosId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002927,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002928", "SELECT SecUserId AS PropostaCratedBy FROM SecUser WHERE SecUserId = :PropostaCratedBy ",true, GxErrorMask.GX_NOMASK, false, this,prmT002928,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002929", "SELECT ContratoNome FROM Contrato WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002929,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002930", "SELECT ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial FROM Cliente WHERE ClienteId = :PropostaPacienteClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002930,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002931", "SELECT PropostaId FROM Proposta WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002931,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002932", "SELECT PropostaId FROM Proposta WHERE ( PropostaId > :PropostaId) ORDER BY PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002932,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002933", "SELECT PropostaId FROM Proposta WHERE ( PropostaId < :PropostaId) ORDER BY PropostaId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT002933,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002934", "SAVEPOINT gxupdate;INSERT INTO Proposta(PropostaCreatedAt, PropostaTitulo, PropostaDescricao, PropostaValor, PropostaStatus, PropostaQuantidadeAprovadores, PropostaReprovacoesPermitidas, ContratoId, ProcedimentosMedicosId, PropostaCratedBy, PropostaPacienteClienteId, ConvenioVencimentoAno, ConvenioVencimentoMes, ConvenioCategoriaId, PropostaTaxaAdministrativa, PropostaSLA, PropostaJurosMora, PropostaDataCirurgia, PropostaResponsavelId, PropostaClinicaId, PropostaComentarioAnalise, PropostaProtocolo, PropostaEmpresaClienteId, PropostaTipoProposta, PropostaValorLiquido) VALUES(:PropostaCreatedAt, :PropostaTitulo, :PropostaDescricao, :PropostaValor, :PropostaStatus, :PropostaQuantidadeAprovadores, :PropostaReprovacoesPermitidas, :ContratoId, :ProcedimentosMedicosId, :PropostaCratedBy, :PropostaPacienteClienteId, 0, 0, 0, 0, 0, 0, DATE '00010101', 0, 0, '', '', 0, '', 0);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT002934)
             ,new CursorDef("T002935", "SELECT currval('PropostaId') ",true, GxErrorMask.GX_NOMASK, false, this,prmT002935,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002936", "SAVEPOINT gxupdate;UPDATE Proposta SET PropostaCreatedAt=:PropostaCreatedAt, PropostaTitulo=:PropostaTitulo, PropostaDescricao=:PropostaDescricao, PropostaValor=:PropostaValor, PropostaStatus=:PropostaStatus, PropostaQuantidadeAprovadores=:PropostaQuantidadeAprovadores, PropostaReprovacoesPermitidas=:PropostaReprovacoesPermitidas, ContratoId=:ContratoId, ProcedimentosMedicosId=:ProcedimentosMedicosId, PropostaCratedBy=:PropostaCratedBy, PropostaPacienteClienteId=:PropostaPacienteClienteId  WHERE PropostaId = :PropostaId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT002936)
             ,new CursorDef("T002937", "SAVEPOINT gxupdate;DELETE FROM Proposta  WHERE PropostaId = :PropostaId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT002937)
             ,new CursorDef("T002939", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaAprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'APROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002939,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002941", "SELECT COALESCE( T1.PropostaAprovacoes_F, 0) AS PropostaReprovacoes_F FROM (SELECT COUNT(*) AS PropostaAprovacoes_F, PropostaId FROM Aprovacao WHERE AprovacaoStatus = ( 'REPROVADO') GROUP BY PropostaId ) T1 WHERE T1.PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002941,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002944", "SELECT COALESCE( T1.ReembolsoStatusAtual_F, '') AS ReembolsoStatusAtual_F FROM (SELECT MIN(T2.ReembolsoEtapaStatus) AS ReembolsoStatusAtual_F, COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') AS ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId FROM ((ReembolsoEtapa T2 LEFT JOIN Reembolso T3 ON T3.ReembolsoId = T2.ReembolsoId) LEFT JOIN LATERAL (SELECT MAX(ReembolsoEtapaCreatedAt) AS ReembolsoEtapaUltimo_F, ReembolsoId FROM ReembolsoEtapa WHERE T2.ReembolsoId = ReembolsoId GROUP BY ReembolsoId ) T4 ON T4.ReembolsoId = T2.ReembolsoId) WHERE T2.ReembolsoEtapaCreatedAt = COALESCE( T4.ReembolsoEtapaUltimo_F, DATE '00010101') GROUP BY T4.ReembolsoEtapaUltimo_F, T3.ReembolsoPropostaId ) T1 WHERE T1.ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002944,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002945", "SELECT ContratoNome FROM Contrato WHERE ContratoId = :ContratoId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002945,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002946", "SELECT ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial FROM Cliente WHERE ClienteId = :PropostaPacienteClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002946,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002947", "SELECT ContratoId FROM Contrato WHERE ContratoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002947,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002948", "SELECT ReembolsoId FROM Reembolso WHERE ReembolsoPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002948,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002949", "SELECT TituloId FROM Titulo WHERE TituloPropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002949,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002950", "SELECT NotaFiscalItemId FROM NotaFiscalItem WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002950,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002951", "SELECT PropostaContratoAssinaturaId FROM PropostaContratoAssinatura WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002951,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002952", "SELECT PropostaDocumentosId FROM PropostaDocumentos WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002952,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002953", "SELECT AprovacaoId FROM Aprovacao WHERE PropostaId = :PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002953,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T002954", "SELECT PropostaId FROM Proposta ORDER BY PropostaId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002954,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002955", "SELECT SecUserId AS PropostaCratedBy FROM SecUser WHERE SecUserId = :PropostaCratedBy ",true, GxErrorMask.GX_NOMASK, false, this,prmT002955,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T002956", "SELECT ProcedimentosMedicosId FROM ProcedimentosMedicos WHERE ProcedimentosMedicosId = :ProcedimentosMedicosId ",true, GxErrorMask.GX_NOMASK, false, this,prmT002956,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
