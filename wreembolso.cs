...
namespace GeneXus.Programs {
   public class wreembolso : GXDataArea
   {
      ...
      protected void E11722( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vISUPDATE", GetSecureSignedToken( "", AV17IsUpdate, context));
         AV8Array_SdDocumentosReembolso = new GXBaseCollection<SdtSdDocumentosReembolso>( context, "SdDocumentosReembolso", "Factory2");
         AV35GXLvl8 = 0;
         /* Using cursor H00723 */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918571269", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wreembolso.js", "?202551918571270", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
