   ...
   public class wwp_df_suggest_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_suggest_wc"+UrlEncode(StringUtil.RTrim(AV31WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV32WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV8WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV25SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_suggest_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_suggest_wc");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_suggest_wc")), "workwithplus.dynamicforms.wwp_df_suggest_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_suggest_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918382390", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_suggest_wc.js", "?202551918382393", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV19HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV5WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"}]}""");
         setEventMetadata("COMBO_DATA.ONOPTIONCLICKED","""{"handler":"E111I2","iparms":[{"av":"Combo_data_Selectedvalue_get","ctrl":"COMBO_DATA","prop":"SelectedValue_get"},{"av":"AV19HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV8WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV5WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"Combo_data_Ddointernalname","ctrl":"COMBO_DATA","prop":"DDOInternalName"},{"av":"AV12Data","fld":"vDATA","type":"svchar"},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("COMBO_DATA.ONOPTIONCLICKED",""","oparms":[{"av":"AV12Data","fld":"vDATA","type":"svchar"},{"av":"AV18ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E131I2","iparms":[{"av":"AV36ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV9AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV25SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV32WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV8WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV18ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV5WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"Combo_data_Ddointernalname","ctrl":"COMBO_DATA","prop":"DDOInternalName"},{"av":"AV12Data","fld":"vDATA","type":"svchar"},{"av":"AV34WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV35WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
