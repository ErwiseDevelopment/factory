...
namespace GeneXus.Programs {
   public class wcboletos : GXWebComponent
   {
      public wcboletos( )
      {
      ...
      public wcboletos( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV91CarteiraDeCobrancaId", StringUtil.LTrimStr( (decimal)(AV91CarteiraDeCobrancaId), 9, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV91CarteiraDeCobrancaId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wcboletos"+UrlEncode(StringUtil.LTrimStr(AV91CarteiraDeCobrancaId,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wcboletos") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV92Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV92Pgmname, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vBOLETOSNOSSONUMERO1", AV18BoletosNossoNumero1);
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vBOLETOSNOSSONUMERO2", AV22BoletosNossoNumero2);
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GXH_vBOLETOSNOSSONUMERO3", AV26BoletosNossoNumero3);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDCURRENTPAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV86GridCurrentPage), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV87GridPageCount), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDAPPLIEDFILTERS", AV88GridAppliedFilters);
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vDDO_TITLESETTINGSICONS", AV84DDO_TitleSettingsIcons);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vDDO_TITLESETTINGSICONS", AV84DDO_TitleSettingsIcons);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATAEMISSAOAUXDATE", context.localUtil.DToC( AV45DDO_BoletosDataEmissaoAuxDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATAEMISSAOAUXDATETO", context.localUtil.DToC( AV46DDO_BoletosDataEmissaoAuxDateTo, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATAVENCIMENTOAUXDATE", context.localUtil.DToC( AV50DDO_BoletosDataVencimentoAuxDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATAVENCIMENTOAUXDATETO", context.localUtil.DToC( AV51DDO_BoletosDataVencimentoAuxDateTo, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATAREGISTROAUXDATE", context.localUtil.DToC( AV55DDO_BoletosDataRegistroAuxDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATAREGISTROAUXDATETO", context.localUtil.DToC( AV56DDO_BoletosDataRegistroAuxDateTo, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATAPAGAMENTOAUXDATE", context.localUtil.DToC( AV60DDO_BoletosDataPagamentoAuxDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATAPAGAMENTOAUXDATETO", context.localUtil.DToC( AV61DDO_BoletosDataPagamentoAuxDateTo, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATABAIXAAUXDATE", context.localUtil.DToC( AV65DDO_BoletosDataBaixaAuxDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vDDO_BOLETOSDATABAIXAAUXDATETO", context.localUtil.DToC( AV66DDO_BoletosDataBaixaAuxDateTo, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV91CarteiraDeCobrancaId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV91CarteiraDeCobrancaId), 9, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV92Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV92Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCARTEIRADECOBRANCAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV91CarteiraDeCobrancaId), 9, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSNOSSONUMERO", AV35TFBoletosNossoNumero);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSNOSSONUMERO_SEL", AV36TFBoletosNossoNumero_Sel);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSSEUNUMERO", AV37TFBoletosSeuNumero);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSSEUNUMERO_SEL", AV38TFBoletosSeuNumero_Sel);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSNUMERO", AV39TFBoletosNumero);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSNUMERO_SEL", AV40TFBoletosNumero_Sel);
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vTFBOLETOSSTATUS_SELS", AV42TFBoletosStatus_Sels);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vTFBOLETOSSTATUS_SELS", AV42TFBoletosStatus_Sels);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATAEMISSAO", context.localUtil.DToC( AV43TFBoletosDataEmissao, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATAEMISSAO_TO", context.localUtil.DToC( AV44TFBoletosDataEmissao_To, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATAVENCIMENTO", context.localUtil.DToC( AV48TFBoletosDataVencimento, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATAVENCIMENTO_TO", context.localUtil.DToC( AV49TFBoletosDataVencimento_To, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATAREGISTRO", context.localUtil.TToC( AV53TFBoletosDataRegistro, 10, 8, 0, 0, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATAREGISTRO_TO", context.localUtil.TToC( AV54TFBoletosDataRegistro_To, 10, 8, 0, 0, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATAPAGAMENTO", context.localUtil.DToC( AV58TFBoletosDataPagamento, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATAPAGAMENTO_TO", context.localUtil.DToC( AV59TFBoletosDataPagamento_To, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATABAIXA", context.localUtil.DToC( AV63TFBoletosDataBaixa, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSDATABAIXA_TO", context.localUtil.DToC( AV64TFBoletosDataBaixa_To, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORNOMINAL", StringUtil.LTrim( StringUtil.NToC( AV68TFBoletosValorNominal, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORNOMINAL_TO", StringUtil.LTrim( StringUtil.NToC( AV69TFBoletosValorNominal_To, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORPAGO", StringUtil.LTrim( StringUtil.NToC( AV70TFBoletosValorPago, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORPAGO_TO", StringUtil.LTrim( StringUtil.NToC( AV71TFBoletosValorPago_To, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORDESCONTO", StringUtil.LTrim( StringUtil.NToC( AV72TFBoletosValorDesconto, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORDESCONTO_TO", StringUtil.LTrim( StringUtil.NToC( AV73TFBoletosValorDesconto_To, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORJUROS", StringUtil.LTrim( StringUtil.NToC( AV74TFBoletosValorJuros, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORJUROS_TO", StringUtil.LTrim( StringUtil.NToC( AV75TFBoletosValorJuros_To, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORMULTA", StringUtil.LTrim( StringUtil.NToC( AV76TFBoletosValorMulta, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSVALORMULTA_TO", StringUtil.LTrim( StringUtil.NToC( AV77TFBoletosValorMulta_To, 18, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSSACADONOME", AV78TFBoletosSacadoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSSACADONOME_SEL", AV79TFBoletosSacadoNome_Sel);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSSACADODOCUMENTO", AV80TFBoletosSacadoDocumento);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSSACADODOCUMENTO_SEL", AV81TFBoletosSacadoDocumento_Sel);
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vTFBOLETOSSACADOTIPODOCUMENTO_SELS", AV83TFBoletosSacadoTipoDocumento_Sels);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vTFBOLETOSSACADOTIPODOCUMENTO_SELS", AV83TFBoletosSacadoTipoDocumento_Sels);
         }
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSSTATUS_SELSJSON", AV41TFBoletosStatus_SelsJson);
         GxWebStd.gx_hidden_field( context, sPrefix+"vTFBOLETOSSACADOTIPODOCUMENTO_SELSJSON", AV82TFBoletosSacadoTipoDocumento_SelsJson);
      ...
      protected void RenderHtmlCloseFormAA2( )
      {
      ...
      protected void WBAA0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wcboletos");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(107), 3, 0)+","+"null"+");", "Inserir", bttBtninsert_Jsonclick, 5, "Inserir", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WcBoletos.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(107), 3, 0)+","+"null"+");", "Excel", bttBtnexport_Jsonclick, 5, "Exportar para Excel", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOEXPORT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDynamicfiltersprefix1_Internalname, "Filtrar por", "", "", lblDynamicfiltersprefix1_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DataFilterDescriptionPrefix", 0, "", 1, 1, 0, 0, "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavDynamicfiltersselector1, cmbavDynamicfiltersselector1_Internalname, StringUtil.RTrim( AV16DynamicFiltersSelector1), 1, cmbavDynamicfiltersselector1_Jsonclick, 5, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVDYNAMICFILTERSSELECTOR1.CLICK."+"'", "svchar", "", 1, cmbavDynamicfiltersselector1.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,41);\"", "", true, 0, "HLP_WcBoletos.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDynamicfiltersmiddle1_Internalname, "valor", "", "", lblDynamicfiltersmiddle1_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DataFilterDescription", 0, "", 1, 1, 0, 0, "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            wb_table1_45_AA2( true) ;
         }
         else
         {
            wb_table1_45_AA2( false) ;
         }
         return  ;
      }

      protected void wb_table1_45_AA2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDynamicfiltersprefix2_Internalname, "Filtrar por", "", "", lblDynamicfiltersprefix2_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DataFilterDescriptionPrefix", 0, "", 1, 1, 0, 0, "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavDynamicfiltersselector2, cmbavDynamicfiltersselector2_Internalname, StringUtil.RTrim( AV20DynamicFiltersSelector2), 1, cmbavDynamicfiltersselector2_Jsonclick, 5, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVDYNAMICFILTERSSELECTOR2.CLICK."+"'", "svchar", "", 1, cmbavDynamicfiltersselector2.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,63);\"", "", true, 0, "HLP_WcBoletos.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDynamicfiltersmiddle2_Internalname, "valor", "", "", lblDynamicfiltersmiddle2_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DataFilterDescription", 0, "", 1, 1, 0, 0, "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "flex-grow:1;", "div");
            wb_table2_67_AA2( true) ;
         }
         else
         {
            wb_table2_67_AA2( false) ;
         }
         return  ;
      }

      protected void wb_table2_67_AA2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDynamicfiltersprefix3_Internalname, "Filtrar por", "", "", lblDynamicfiltersprefix3_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DataFilterDescriptionPrefix", 0, "", 1, 1, 0, 0, "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "flex-grow:1;", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "flex-grow:1;", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDynamicfiltersmiddle3_Internalname, "valor", "", "", lblDynamicfiltersmiddle3_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DataFilterDescription", 0, "", 1, 1, 0, 0, "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "flex-grow:1;", "div");
            wb_table3_89_AA2( true) ;
         }
         else
         {
            wb_table3_89_AA2( false) ;
         }
         return  ;
      }

      protected void wb_table3_89_AA2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 107 )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblJsdynamicfilters_Internalname, lblJsdynamicfilters_Caption, "", "", lblJsdynamicfilters_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 1, "HLP_WcBoletos.htm");
            /* User Defined Control */
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 141,'" + sPrefix + "',false,'" + sGXsfl_107_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavDdo_boletosdataemissaoauxdatetext_Internalname, AV47DDO_BoletosDataEmissaoAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV47DDO_BoletosDataEmissaoAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,141);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_boletosdataemissaoauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WcBoletos.htm");
            /* User Defined Control */
            ...
            ucTfboletosdataemissao_rangepicker.Render(context, "wwp.daterangepicker", Tfboletosdataemissao_rangepicker_Internalname, sPrefix+"TFBOLETOSDATAEMISSAO_RANGEPICKERContainer");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDdo_boletosdatavencimentoauxdates_Internalname, 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 144,'" + sPrefix + "',false,'" + sGXsfl_107_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavDdo_boletosdatavencimentoauxdatetext_Internalname, AV52DDO_BoletosDataVencimentoAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV52DDO_BoletosDataVencimentoAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,144);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_boletosdatavencimentoauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WcBoletos.htm");
            /* User Defined Control */
            ...
            ucTfboletosdatavencimento_rangepicker.Render(context, "wwp.daterangepicker", Tfboletosdatavencimento_rangepicker_Internalname, sPrefix+"TFBOLETOSDATAVENCIMENTO_RANGEPICKERContainer");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDdo_boletosdataregistroauxdates_Internalname, 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 147,'" + sPrefix + "',false,'" + sGXsfl_107_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavDdo_boletosdataregistroauxdatetext_Internalname, AV57DDO_BoletosDataRegistroAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV57DDO_BoletosDataRegistroAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,147);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_boletosdataregistroauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WcBoletos.htm");
            /* User Defined Control */
            ...
            ucTfboletosdataregistro_rangepicker.Render(context, "wwp.daterangepicker", Tfboletosdataregistro_rangepicker_Internalname, sPrefix+"TFBOLETOSDATAREGISTRO_RANGEPICKERContainer");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDdo_boletosdatapagamentoauxdates_Internalname, 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 150,'" + sPrefix + "',false,'" + sGXsfl_107_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavDdo_boletosdatapagamentoauxdatetext_Internalname, AV62DDO_BoletosDataPagamentoAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV62DDO_BoletosDataPagamentoAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,150);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_boletosdatapagamentoauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WcBoletos.htm");
            /* User Defined Control */
            ...
            ucTfboletosdatapagamento_rangepicker.Render(context, "wwp.daterangepicker", Tfboletosdatapagamento_rangepicker_Internalname, sPrefix+"TFBOLETOSDATAPAGAMENTO_RANGEPICKERContainer");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divDdo_boletosdatabaixaauxdates_Internalname, 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 153,'" + sPrefix + "',false,'" + sGXsfl_107_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavDdo_boletosdatabaixaauxdatetext_Internalname, AV67DDO_BoletosDataBaixaAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV67DDO_BoletosDataBaixaAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,153);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_boletosdatabaixaauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WcBoletos.htm");
            /* User Defined Control */
            ...
            ucTfboletosdatabaixa_rangepicker.Render(context, "wwp.daterangepicker", Tfboletosdatabaixa_rangepicker_Internalname, sPrefix+"TFBOLETOSDATABAIXA_RANGEPICKERContainer");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 23), "VGRIDACTIONGROUP1.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 23), "VGRIDACTIONGROUP1.CLICK") == 0 ) )
                           {
                              ...
                              AssignAttri(sPrefix, false, cmbavGridactiongroup1_Internalname, StringUtil.LTrimStr( (decimal)(AV89GridActionGroup1), 4, 0));
                                    ...
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       ...
                                       if ( ! wbErr )
                                       {
                                          if ( ! wbErr )
                                          {
                                             ...
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vBOLETOSNOSSONUMERO1"), AV18BoletosNossoNumero1) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             ...
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vBOLETOSNOSSONUMERO2"), AV22BoletosNossoNumero2) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             ...
                                             if ( StringUtil.StrCmp(cgiGet( sPrefix+"GXH_vBOLETOSNOSSONUMERO3"), AV26BoletosNossoNumero3) != 0 )
                                             {
                                                Rfr0gs = true;
                                             }
                                             if ( ! Rfr0gs )
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wcboletos")), "wcboletos") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wcboletos")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BOLETOSID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A1077BoletosId), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"BOLETOSID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1077BoletosId), 9, 0, ".", "")));
      }
      ...
      protected void RFAA2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 A1083BoletosStatus ,
                                                 AV112Wcboletosds_20_tfboletosstatus_sels ,
                                                 A1096BoletosSacadoTipoDocumento ,
                                                 AV137Wcboletosds_45_tfboletossacadotipodocumento_sels ,
                                                 AV94Wcboletosds_2_filterfulltext ,
                                                 AV95Wcboletosds_3_dynamicfiltersselector1 ,
                                                 AV96Wcboletosds_4_dynamicfiltersoperator1 ,
                                                 AV97Wcboletosds_5_boletosnossonumero1 ,
                                                 AV98Wcboletosds_6_dynamicfiltersenabled2 ,
                                                 AV99Wcboletosds_7_dynamicfiltersselector2 ,
                                                 AV100Wcboletosds_8_dynamicfiltersoperator2 ,
                                                 AV101Wcboletosds_9_boletosnossonumero2 ,
                                                 AV102Wcboletosds_10_dynamicfiltersenabled3 ,
                                                 AV103Wcboletosds_11_dynamicfiltersselector3 ,
                                                 AV104Wcboletosds_12_dynamicfiltersoperator3 ,
                                                 AV105Wcboletosds_13_boletosnossonumero3 ,
                                                 AV107Wcboletosds_15_tfboletosnossonumero_sel ,
                                                 AV106Wcboletosds_14_tfboletosnossonumero ,
                                                 AV109Wcboletosds_17_tfboletosseunumero_sel ,
                                                 AV108Wcboletosds_16_tfboletosseunumero ,
                                                 AV111Wcboletosds_19_tfboletosnumero_sel ,
                                                 AV110Wcboletosds_18_tfboletosnumero ,
                                                 AV112Wcboletosds_20_tfboletosstatus_sels.Count ,
                                                 AV113Wcboletosds_21_tfboletosdataemissao ,
                                                 AV114Wcboletosds_22_tfboletosdataemissao_to ,
                                                 AV115Wcboletosds_23_tfboletosdatavencimento ,
                                                 AV116Wcboletosds_24_tfboletosdatavencimento_to ,
                                                 AV117Wcboletosds_25_tfboletosdataregistro ,
                                                 AV118Wcboletosds_26_tfboletosdataregistro_to ,
                                                 AV119Wcboletosds_27_tfboletosdatapagamento ,
                                                 AV120Wcboletosds_28_tfboletosdatapagamento_to ,
                                                 AV121Wcboletosds_29_tfboletosdatabaixa ,
                                                 AV122Wcboletosds_30_tfboletosdatabaixa_to ,
                                                 AV123Wcboletosds_31_tfboletosvalornominal ,
                                                 AV124Wcboletosds_32_tfboletosvalornominal_to ,
                                                 AV125Wcboletosds_33_tfboletosvalorpago ,
                                                 AV126Wcboletosds_34_tfboletosvalorpago_to ,
                                                 AV127Wcboletosds_35_tfboletosvalordesconto ,
                                                 AV128Wcboletosds_36_tfboletosvalordesconto_to ,
                                                 AV129Wcboletosds_37_tfboletosvalorjuros ,
                                                 AV130Wcboletosds_38_tfboletosvalorjuros_to ,
                                                 AV131Wcboletosds_39_tfboletosvalormulta ,
                                                 AV132Wcboletosds_40_tfboletosvalormulta_to ,
                                                 AV134Wcboletosds_42_tfboletossacadonome_sel ,
                                                 AV133Wcboletosds_41_tfboletossacadonome ,
                                                 AV136Wcboletosds_44_tfboletossacadodocumento_sel ,
                                                 AV135Wcboletosds_43_tfboletossacadodocumento ,
                                                 AV137Wcboletosds_45_tfboletossacadotipodocumento_sels.Count ,
                                                 ...
                                                 AV93Wcboletosds_1_carteiradecobrancaid } ,
                                                 new int[]{
            ...
            lV94Wcboletosds_2_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV94Wcboletosds_2_filterfulltext), "%", "");
            lV94Wcboletosds_2_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV94Wcboletosds_2_filterfulltext), "%", "");
            lV94Wcboletosds_2_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV94Wcboletosds_2_filterfulltext), "%", "");
            lV94Wcboletosds_2_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV94Wcboletosds_2_filterfulltext), "%", "");
            lV94Wcboletosds_2_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV94Wcboletosds_2_filterfulltext), "%", "");
            ...
            lV94Wcboletosds_2_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV94Wcboletosds_2_filterfulltext), "%", "");
            lV94Wcboletosds_2_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV94Wcboletosds_2_filterfulltext), "%", "");
            lV97Wcboletosds_5_boletosnossonumero1 = StringUtil.Concat( StringUtil.RTrim( AV97Wcboletosds_5_boletosnossonumero1), "%", "");
            lV97Wcboletosds_5_boletosnossonumero1 = StringUtil.Concat( StringUtil.RTrim( AV97Wcboletosds_5_boletosnossonumero1), "%", "");
            lV101Wcboletosds_9_boletosnossonumero2 = StringUtil.Concat( StringUtil.RTrim( AV101Wcboletosds_9_boletosnossonumero2), "%", "");
            lV101Wcboletosds_9_boletosnossonumero2 = StringUtil.Concat( StringUtil.RTrim( AV101Wcboletosds_9_boletosnossonumero2), "%", "");
            lV105Wcboletosds_13_boletosnossonumero3 = StringUtil.Concat( StringUtil.RTrim( AV105Wcboletosds_13_boletosnossonumero3), "%", "");
            lV105Wcboletosds_13_boletosnossonumero3 = StringUtil.Concat( StringUtil.RTrim( AV105Wcboletosds_13_boletosnossonumero3), "%", "");
            lV106Wcboletosds_14_tfboletosnossonumero = StringUtil.Concat( StringUtil.RTrim( AV106Wcboletosds_14_tfboletosnossonumero), "%", "");
            lV108Wcboletosds_16_tfboletosseunumero = StringUtil.Concat( StringUtil.RTrim( AV108Wcboletosds_16_tfboletosseunumero), "%", "");
            lV110Wcboletosds_18_tfboletosnumero = StringUtil.Concat( StringUtil.RTrim( AV110Wcboletosds_18_tfboletosnumero), "%", "");
            lV133Wcboletosds_41_tfboletossacadonome = StringUtil.Concat( StringUtil.RTrim( AV133Wcboletosds_41_tfboletossacadonome), "%", "");
            lV135Wcboletosds_43_tfboletossacadodocumento = StringUtil.Concat( StringUtil.RTrim( AV135Wcboletosds_43_tfboletossacadodocumento), "%", "");
            /* Using cursor H00AA2 */
            pr_default.execute(0, new Object[] {AV93Wcboletosds_1_carteiradecobrancaid, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV97Wcboletosds_5_boletosnossonumero1, lV97Wcboletosds_5_boletosnossonumero1, lV101Wcboletosds_9_boletosnossonumero2, lV101Wcboletosds_9_boletosnossonumero2, lV105Wcboletosds_13_boletosnossonumero3, lV105Wcboletosds_13_boletosnossonumero3, lV106Wcboletosds_14_tfboletosnossonumero, AV107Wcboletosds_15_tfboletosnossonumero_sel, lV108Wcboletosds_16_tfboletosseunumero, AV109Wcboletosds_17_tfboletosseunumero_sel, lV110Wcboletosds_18_tfboletosnumero, AV111Wcboletosds_19_tfboletosnumero_sel, AV113Wcboletosds_21_tfboletosdataemissao, AV114Wcboletosds_22_tfboletosdataemissao_to, AV115Wcboletosds_23_tfboletosdatavencimento, AV116Wcboletosds_24_tfboletosdatavencimento_to, AV117Wcboletosds_25_tfboletosdataregistro, AV118Wcboletosds_26_tfboletosdataregistro_to, AV119Wcboletosds_27_tfboletosdatapagamento, AV120Wcboletosds_28_tfboletosdatapagamento_to, AV121Wcboletosds_29_tfboletosdatabaixa, AV122Wcboletosds_30_tfboletosdatabaixa_to, AV123Wcboletosds_31_tfboletosvalornominal, AV124Wcboletosds_32_tfboletosvalornominal_to, AV125Wcboletosds_33_tfboletosvalorpago, AV126Wcboletosds_34_tfboletosvalorpago_to, AV127Wcboletosds_35_tfboletosvalordesconto, AV128Wcboletosds_36_tfboletosvalordesconto_to, AV129Wcboletosds_37_tfboletosvalorjuros, AV130Wcboletosds_38_tfboletosvalorjuros_to, AV131Wcboletosds_39_tfboletosvalormulta, AV132Wcboletosds_40_tfboletosvalormulta_to, lV133Wcboletosds_41_tfboletossacadonome, AV134Wcboletosds_42_tfboletossacadonome_sel, lV135Wcboletosds_43_tfboletossacadodocumento, AV136Wcboletosds_44_tfboletossacadodocumento_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_107_idx = 1;
            sGXsfl_107_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_107_idx), 4, 0), 4, "0");
            SubsflControlProps_1072( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A1096BoletosSacadoTipoDocumento = H00AA2_A1096BoletosSacadoTipoDocumento[0];
               n1096BoletosSacadoTipoDocumento = H00AA2_n1096BoletosSacadoTipoDocumento[0];
               A1095BoletosSacadoDocumento = H00AA2_A1095BoletosSacadoDocumento[0];
               n1095BoletosSacadoDocumento = H00AA2_n1095BoletosSacadoDocumento[0];
               A1094BoletosSacadoNome = H00AA2_A1094BoletosSacadoNome[0];
               n1094BoletosSacadoNome = H00AA2_n1094BoletosSacadoNome[0];
               A1093BoletosValorMulta = H00AA2_A1093BoletosValorMulta[0];
               n1093BoletosValorMulta = H00AA2_n1093BoletosValorMulta[0];
               A1092BoletosValorJuros = H00AA2_A1092BoletosValorJuros[0];
               n1092BoletosValorJuros = H00AA2_n1092BoletosValorJuros[0];
               A1091BoletosValorDesconto = H00AA2_A1091BoletosValorDesconto[0];
               n1091BoletosValorDesconto = H00AA2_n1091BoletosValorDesconto[0];
               A1090BoletosValorPago = H00AA2_A1090BoletosValorPago[0];
               n1090BoletosValorPago = H00AA2_n1090BoletosValorPago[0];
               A1089BoletosValorNominal = H00AA2_A1089BoletosValorNominal[0];
               n1089BoletosValorNominal = H00AA2_n1089BoletosValorNominal[0];
               A1088BoletosDataBaixa = H00AA2_A1088BoletosDataBaixa[0];
               n1088BoletosDataBaixa = H00AA2_n1088BoletosDataBaixa[0];
               A1087BoletosDataPagamento = H00AA2_A1087BoletosDataPagamento[0];
               n1087BoletosDataPagamento = H00AA2_n1087BoletosDataPagamento[0];
               A1086BoletosDataRegistro = H00AA2_A1086BoletosDataRegistro[0];
               n1086BoletosDataRegistro = H00AA2_n1086BoletosDataRegistro[0];
               A1085BoletosDataVencimento = H00AA2_A1085BoletosDataVencimento[0];
               n1085BoletosDataVencimento = H00AA2_n1085BoletosDataVencimento[0];
               A1084BoletosDataEmissao = H00AA2_A1084BoletosDataEmissao[0];
               n1084BoletosDataEmissao = H00AA2_n1084BoletosDataEmissao[0];
               A1083BoletosStatus = H00AA2_A1083BoletosStatus[0];
               n1083BoletosStatus = H00AA2_n1083BoletosStatus[0];
               A1082BoletosCodigoDeBarras = H00AA2_A1082BoletosCodigoDeBarras[0];
               n1082BoletosCodigoDeBarras = H00AA2_n1082BoletosCodigoDeBarras[0];
               A1081BoletosLinhaDigitavel = H00AA2_A1081BoletosLinhaDigitavel[0];
               n1081BoletosLinhaDigitavel = H00AA2_n1081BoletosLinhaDigitavel[0];
               A1080BoletosNumero = H00AA2_A1080BoletosNumero[0];
               n1080BoletosNumero = H00AA2_n1080BoletosNumero[0];
               A1079BoletosSeuNumero = H00AA2_A1079BoletosSeuNumero[0];
               n1079BoletosSeuNumero = H00AA2_n1079BoletosSeuNumero[0];
               A1078BoletosNossoNumero = H00AA2_A1078BoletosNossoNumero[0];
               n1078BoletosNossoNumero = H00AA2_n1078BoletosNossoNumero[0];
               A261TituloId = H00AA2_A261TituloId[0];
               n261TituloId = H00AA2_n261TituloId[0];
               A1069CarteiraDeCobrancaId = H00AA2_A1069CarteiraDeCobrancaId[0];
               n1069CarteiraDeCobrancaId = H00AA2_n1069CarteiraDeCobrancaId[0];
               A1077BoletosId = H00AA2_A1077BoletosId[0];
               /* Execute user event: Grid.Load */
               E27AA2 ();
      ...
      protected void send_integrity_lvl_hashesAA2( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV92Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV92Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BOLETOSID"+"_"+sGXsfl_107_idx, GetSecureSignedToken( sPrefix+sGXsfl_107_idx, context.localUtil.Format( (decimal)(A1077BoletosId), "ZZZZZZZZ9"), context));
      }
      ...
      {
         AV93Wcboletosds_1_carteiradecobrancaid = AV91CarteiraDeCobrancaId;
         AV94Wcboletosds_2_filterfulltext = AV15FilterFullText;
         AV95Wcboletosds_3_dynamicfiltersselector1 = AV16DynamicFiltersSelector1;
         AV96Wcboletosds_4_dynamicfiltersoperator1 = AV17DynamicFiltersOperator1;
         AV97Wcboletosds_5_boletosnossonumero1 = AV18BoletosNossoNumero1;
         AV98Wcboletosds_6_dynamicfiltersenabled2 = AV19DynamicFiltersEnabled2;
         AV99Wcboletosds_7_dynamicfiltersselector2 = AV20DynamicFiltersSelector2;
         AV100Wcboletosds_8_dynamicfiltersoperator2 = AV21DynamicFiltersOperator2;
         AV101Wcboletosds_9_boletosnossonumero2 = AV22BoletosNossoNumero2;
         AV102Wcboletosds_10_dynamicfiltersenabled3 = AV23DynamicFiltersEnabled3;
         AV103Wcboletosds_11_dynamicfiltersselector3 = AV24DynamicFiltersSelector3;
         AV104Wcboletosds_12_dynamicfiltersoperator3 = AV25DynamicFiltersOperator3;
         AV105Wcboletosds_13_boletosnossonumero3 = AV26BoletosNossoNumero3;
         AV106Wcboletosds_14_tfboletosnossonumero = AV35TFBoletosNossoNumero;
         AV107Wcboletosds_15_tfboletosnossonumero_sel = AV36TFBoletosNossoNumero_Sel;
         AV108Wcboletosds_16_tfboletosseunumero = AV37TFBoletosSeuNumero;
         AV109Wcboletosds_17_tfboletosseunumero_sel = AV38TFBoletosSeuNumero_Sel;
         AV110Wcboletosds_18_tfboletosnumero = AV39TFBoletosNumero;
         AV111Wcboletosds_19_tfboletosnumero_sel = AV40TFBoletosNumero_Sel;
         AV112Wcboletosds_20_tfboletosstatus_sels = AV42TFBoletosStatus_Sels;
         AV113Wcboletosds_21_tfboletosdataemissao = AV43TFBoletosDataEmissao;
         AV114Wcboletosds_22_tfboletosdataemissao_to = AV44TFBoletosDataEmissao_To;
         AV115Wcboletosds_23_tfboletosdatavencimento = AV48TFBoletosDataVencimento;
         AV116Wcboletosds_24_tfboletosdatavencimento_to = AV49TFBoletosDataVencimento_To;
         AV117Wcboletosds_25_tfboletosdataregistro = AV53TFBoletosDataRegistro;
         AV118Wcboletosds_26_tfboletosdataregistro_to = AV54TFBoletosDataRegistro_To;
         AV119Wcboletosds_27_tfboletosdatapagamento = AV58TFBoletosDataPagamento;
         AV120Wcboletosds_28_tfboletosdatapagamento_to = AV59TFBoletosDataPagamento_To;
         AV121Wcboletosds_29_tfboletosdatabaixa = AV63TFBoletosDataBaixa;
         AV122Wcboletosds_30_tfboletosdatabaixa_to = AV64TFBoletosDataBaixa_To;
         AV123Wcboletosds_31_tfboletosvalornominal = AV68TFBoletosValorNominal;
         AV124Wcboletosds_32_tfboletosvalornominal_to = AV69TFBoletosValorNominal_To;
         AV125Wcboletosds_33_tfboletosvalorpago = AV70TFBoletosValorPago;
         AV126Wcboletosds_34_tfboletosvalorpago_to = AV71TFBoletosValorPago_To;
         AV127Wcboletosds_35_tfboletosvalordesconto = AV72TFBoletosValorDesconto;
         AV128Wcboletosds_36_tfboletosvalordesconto_to = AV73TFBoletosValorDesconto_To;
         AV129Wcboletosds_37_tfboletosvalorjuros = AV74TFBoletosValorJuros;
         AV130Wcboletosds_38_tfboletosvalorjuros_to = AV75TFBoletosValorJuros_To;
         AV131Wcboletosds_39_tfboletosvalormulta = AV76TFBoletosValorMulta;
         AV132Wcboletosds_40_tfboletosvalormulta_to = AV77TFBoletosValorMulta_To;
         AV133Wcboletosds_41_tfboletossacadonome = AV78TFBoletosSacadoNome;
         AV134Wcboletosds_42_tfboletossacadonome_sel = AV79TFBoletosSacadoNome_Sel;
         AV135Wcboletosds_43_tfboletossacadodocumento = AV80TFBoletosSacadoDocumento;
         AV136Wcboletosds_44_tfboletossacadodocumento_sel = AV81TFBoletosSacadoDocumento_Sel;
         AV137Wcboletosds_45_tfboletossacadotipodocumento_sels = AV83TFBoletosSacadoTipoDocumento_Sels;
         ...
         lV135Wcboletosds_43_tfboletossacadodocumento = StringUtil.Concat( StringUtil.RTrim( AV135Wcboletosds_43_tfboletossacadodocumento), "%", "");
         /* Using cursor H00AA3 */
         pr_default.execute(1, new Object[] {AV93Wcboletosds_1_carteiradecobrancaid, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV94Wcboletosds_2_filterfulltext, lV97Wcboletosds_5_boletosnossonumero1, lV97Wcboletosds_5_boletosnossonumero1, lV101Wcboletosds_9_boletosnossonumero2, lV101Wcboletosds_9_boletosnossonumero2, lV105Wcboletosds_13_boletosnossonumero3, lV105Wcboletosds_13_boletosnossonumero3, lV106Wcboletosds_14_tfboletosnossonumero, AV107Wcboletosds_15_tfboletosnossonumero_sel, lV108Wcboletosds_16_tfboletosseunumero, AV109Wcboletosds_17_tfboletosseunumero_sel, lV110Wcboletosds_18_tfboletosnumero, AV111Wcboletosds_19_tfboletosnumero_sel, AV113Wcboletosds_21_tfboletosdataemissao, AV114Wcboletosds_22_tfboletosdataemissao_to, AV115Wcboletosds_23_tfboletosdatavencimento, AV116Wcboletosds_24_tfboletosdatavencimento_to, AV117Wcboletosds_25_tfboletosdataregistro, AV118Wcboletosds_26_tfboletosdataregistro_to, AV119Wcboletosds_27_tfboletosdatapagamento, AV120Wcboletosds_28_tfboletosdatapagamento_to, AV121Wcboletosds_29_tfboletosdatabaixa, AV122Wcboletosds_30_tfboletosdatabaixa_to, AV123Wcboletosds_31_tfboletosvalornominal, AV124Wcboletosds_32_tfboletosvalornominal_to, AV125Wcboletosds_33_tfboletosvalorpago, AV126Wcboletosds_34_tfboletosvalorpago_to, AV127Wcboletosds_35_tfboletosvalordesconto, AV128Wcboletosds_36_tfboletosvalordesconto_to, AV129Wcboletosds_37_tfboletosvalorjuros, AV130Wcboletosds_38_tfboletosvalorjuros_to, AV131Wcboletosds_39_tfboletosvalormulta, AV132Wcboletosds_40_tfboletosvalormulta_to, lV133Wcboletosds_41_tfboletossacadonome, AV134Wcboletosds_42_tfboletossacadonome_sel, lV135Wcboletosds_43_tfboletossacadodocumento, AV136Wcboletosds_44_tfboletossacadodocumento_sel});
      ...
      protected void STRUPAA0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vDDO_TITLESETTINGSICONS"), AV84DDO_TitleSettingsIcons);
            /* Read saved values. */
            nRC_GXsfl_107 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_107"), ",", "."), 18, MidpointRounding.ToEven));
            AV86GridCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDCURRENTPAGE"), ",", "."), 18, MidpointRounding.ToEven));
            AV87GridPageCount = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ",", "."), 18, MidpointRounding.ToEven));
            AV88GridAppliedFilters = cgiGet( sPrefix+"vGRIDAPPLIEDFILTERS");
            AV45DDO_BoletosDataEmissaoAuxDate = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATAEMISSAOAUXDATE"), 0);
            AV46DDO_BoletosDataEmissaoAuxDateTo = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATAEMISSAOAUXDATETO"), 0);
            AV50DDO_BoletosDataVencimentoAuxDate = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATAVENCIMENTOAUXDATE"), 0);
            AV51DDO_BoletosDataVencimentoAuxDateTo = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATAVENCIMENTOAUXDATETO"), 0);
            AV55DDO_BoletosDataRegistroAuxDate = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATAREGISTROAUXDATE"), 0);
            AssignAttri(sPrefix, false, "AV55DDO_BoletosDataRegistroAuxDate", context.localUtil.Format(AV55DDO_BoletosDataRegistroAuxDate, "99/99/99"));
            AV56DDO_BoletosDataRegistroAuxDateTo = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATAREGISTROAUXDATETO"), 0);
            AssignAttri(sPrefix, false, "AV56DDO_BoletosDataRegistroAuxDateTo", context.localUtil.Format(AV56DDO_BoletosDataRegistroAuxDateTo, "99/99/99"));
            AV60DDO_BoletosDataPagamentoAuxDate = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATAPAGAMENTOAUXDATE"), 0);
            AV61DDO_BoletosDataPagamentoAuxDateTo = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATAPAGAMENTOAUXDATETO"), 0);
            AV65DDO_BoletosDataBaixaAuxDate = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATABAIXAAUXDATE"), 0);
            AV66DDO_BoletosDataBaixaAuxDateTo = context.localUtil.CToD( cgiGet( sPrefix+"vDDO_BOLETOSDATABAIXAAUXDATETO"), 0);
            wcpOAV91CarteiraDeCobrancaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV91CarteiraDeCobrancaId"), ",", "."), 18, MidpointRounding.ToEven));
            ...
            AssignAttri(sPrefix, false, "AV18BoletosNossoNumero1", AV18BoletosNossoNumero1);
            ...
            AssignAttri(sPrefix, false, "AV22BoletosNossoNumero2", AV22BoletosNossoNumero2);
            ...
            AssignAttri(sPrefix, false, "AV26BoletosNossoNumero3", AV26BoletosNossoNumero3);
            AV47DDO_BoletosDataEmissaoAuxDateText = cgiGet( edtavDdo_boletosdataemissaoauxdatetext_Internalname);
            AssignAttri(sPrefix, false, "AV47DDO_BoletosDataEmissaoAuxDateText", AV47DDO_BoletosDataEmissaoAuxDateText);
            AV52DDO_BoletosDataVencimentoAuxDateText = cgiGet( edtavDdo_boletosdatavencimentoauxdatetext_Internalname);
            AssignAttri(sPrefix, false, "AV52DDO_BoletosDataVencimentoAuxDateText", AV52DDO_BoletosDataVencimentoAuxDateText);
            AV57DDO_BoletosDataRegistroAuxDateText = cgiGet( edtavDdo_boletosdataregistroauxdatetext_Internalname);
            AssignAttri(sPrefix, false, "AV57DDO_BoletosDataRegistroAuxDateText", AV57DDO_BoletosDataRegistroAuxDateText);
            AV62DDO_BoletosDataPagamentoAuxDateText = cgiGet( edtavDdo_boletosdatapagamentoauxdatetext_Internalname);
            AssignAttri(sPrefix, false, "AV62DDO_BoletosDataPagamentoAuxDateText", AV62DDO_BoletosDataPagamentoAuxDateText);
            AV67DDO_BoletosDataBaixaAuxDateText = cgiGet( edtavDdo_boletosdatabaixaauxdatetext_Internalname);
            AssignAttri(sPrefix, false, "AV67DDO_BoletosDataBaixaAuxDateText", AV67DDO_BoletosDataBaixaAuxDateText);
      ...
      protected void E25AA2( )
      {
         /* Start Routine */
         returnInSub = false;
         this.executeUsercontrolMethod(sPrefix, false, "TFBOLETOSDATABAIXA_RANGEPICKERContainer", "Attach", "", new Object[] {(string)edtavDdo_boletosdatabaixaauxdatetext_Internalname});
         this.executeUsercontrolMethod(sPrefix, false, "TFBOLETOSDATAPAGAMENTO_RANGEPICKERContainer", "Attach", "", new Object[] {(string)edtavDdo_boletosdatapagamentoauxdatetext_Internalname});
         this.executeUsercontrolMethod(sPrefix, false, "TFBOLETOSDATAREGISTRO_RANGEPICKERContainer", "Attach", "", new Object[] {(string)edtavDdo_boletosdataregistroauxdatetext_Internalname});
         this.executeUsercontrolMethod(sPrefix, false, "TFBOLETOSDATAVENCIMENTO_RANGEPICKERContainer", "Attach", "", new Object[] {(string)edtavDdo_boletosdatavencimentoauxdatetext_Internalname});
         this.executeUsercontrolMethod(sPrefix, false, "TFBOLETOSDATAEMISSAO_RANGEPICKERContainer", "Attach", "", new Object[] {(string)edtavDdo_boletosdataemissaoauxdatetext_Internalname});
         subGrid_Rows = 10;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
      ...
      protected void E26AA2( )
      {
         ...
         AssignAttri(sPrefix, false, "AV86GridCurrentPage", StringUtil.LTrimStr( (decimal)(AV86GridCurrentPage), 10, 0));
         AV87GridPageCount = subGrid_fnc_Pagecount( );
         AssignAttri(sPrefix, false, "AV87GridPageCount", StringUtil.LTrimStr( (decimal)(AV87GridPageCount), 10, 0));
         ...
         AssignAttri(sPrefix, false, "AV88GridAppliedFilters", AV88GridAppliedFilters);
         AV93Wcboletosds_1_carteiradecobrancaid = AV91CarteiraDeCobrancaId;
         AV94Wcboletosds_2_filterfulltext = AV15FilterFullText;
         AV95Wcboletosds_3_dynamicfiltersselector1 = AV16DynamicFiltersSelector1;
         AV96Wcboletosds_4_dynamicfiltersoperator1 = AV17DynamicFiltersOperator1;
      ...
      protected void E14AA2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
         {
            if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosNossoNumero") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV35TFBoletosNossoNumero", AV35TFBoletosNossoNumero);
               AV36TFBoletosNossoNumero_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri(sPrefix, false, "AV36TFBoletosNossoNumero_Sel", AV36TFBoletosNossoNumero_Sel);
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosSeuNumero") == 0 )
            {
               AV37TFBoletosSeuNumero = Ddo_grid_Filteredtext_get;
               AssignAttri(sPrefix, false, "AV37TFBoletosSeuNumero", AV37TFBoletosSeuNumero);
               AV38TFBoletosSeuNumero_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri(sPrefix, false, "AV38TFBoletosSeuNumero_Sel", AV38TFBoletosSeuNumero_Sel);
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosNumero") == 0 )
            {
               AV39TFBoletosNumero = Ddo_grid_Filteredtext_get;
               AssignAttri(sPrefix, false, "AV39TFBoletosNumero", AV39TFBoletosNumero);
               AV40TFBoletosNumero_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri(sPrefix, false, "AV40TFBoletosNumero_Sel", AV40TFBoletosNumero_Sel);
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosStatus") == 0 )
            {
               AV41TFBoletosStatus_SelsJson = Ddo_grid_Selectedvalue_get;
               AssignAttri(sPrefix, false, "AV41TFBoletosStatus_SelsJson", AV41TFBoletosStatus_SelsJson);
            ...
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosDataEmissao") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV43TFBoletosDataEmissao", context.localUtil.Format(AV43TFBoletosDataEmissao, "99/99/99"));
               AV44TFBoletosDataEmissao_To = context.localUtil.CToD( Ddo_grid_Filteredtextto_get, 4);
               AssignAttri(sPrefix, false, "AV44TFBoletosDataEmissao_To", context.localUtil.Format(AV44TFBoletosDataEmissao_To, "99/99/99"));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosDataVencimento") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV48TFBoletosDataVencimento", context.localUtil.Format(AV48TFBoletosDataVencimento, "99/99/99"));
               AV49TFBoletosDataVencimento_To = context.localUtil.CToD( Ddo_grid_Filteredtextto_get, 4);
               AssignAttri(sPrefix, false, "AV49TFBoletosDataVencimento_To", context.localUtil.Format(AV49TFBoletosDataVencimento_To, "99/99/99"));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosDataRegistro") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV53TFBoletosDataRegistro", context.localUtil.TToC( AV53TFBoletosDataRegistro, 8, 5, 0, 3, "/", ":", " "));
               AV54TFBoletosDataRegistro_To = context.localUtil.CToT( Ddo_grid_Filteredtextto_get, 4);
               AssignAttri(sPrefix, false, "AV54TFBoletosDataRegistro_To", context.localUtil.TToC( AV54TFBoletosDataRegistro_To, 8, 5, 0, 3, "/", ":", " "));
            ...
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosDataPagamento") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV58TFBoletosDataPagamento", context.localUtil.Format(AV58TFBoletosDataPagamento, "99/99/99"));
               AV59TFBoletosDataPagamento_To = context.localUtil.CToD( Ddo_grid_Filteredtextto_get, 4);
               AssignAttri(sPrefix, false, "AV59TFBoletosDataPagamento_To", context.localUtil.Format(AV59TFBoletosDataPagamento_To, "99/99/99"));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosDataBaixa") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV63TFBoletosDataBaixa", context.localUtil.Format(AV63TFBoletosDataBaixa, "99/99/99"));
               AV64TFBoletosDataBaixa_To = context.localUtil.CToD( Ddo_grid_Filteredtextto_get, 4);
               AssignAttri(sPrefix, false, "AV64TFBoletosDataBaixa_To", context.localUtil.Format(AV64TFBoletosDataBaixa_To, "99/99/99"));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosValorNominal") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV68TFBoletosValorNominal", StringUtil.LTrimStr( AV68TFBoletosValorNominal, 18, 2));
               AV69TFBoletosValorNominal_To = NumberUtil.Val( Ddo_grid_Filteredtextto_get, ".");
               AssignAttri(sPrefix, false, "AV69TFBoletosValorNominal_To", StringUtil.LTrimStr( AV69TFBoletosValorNominal_To, 18, 2));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosValorPago") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV70TFBoletosValorPago", StringUtil.LTrimStr( AV70TFBoletosValorPago, 18, 2));
               AV71TFBoletosValorPago_To = NumberUtil.Val( Ddo_grid_Filteredtextto_get, ".");
               AssignAttri(sPrefix, false, "AV71TFBoletosValorPago_To", StringUtil.LTrimStr( AV71TFBoletosValorPago_To, 18, 2));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosValorDesconto") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV72TFBoletosValorDesconto", StringUtil.LTrimStr( AV72TFBoletosValorDesconto, 18, 2));
               AV73TFBoletosValorDesconto_To = NumberUtil.Val( Ddo_grid_Filteredtextto_get, ".");
               AssignAttri(sPrefix, false, "AV73TFBoletosValorDesconto_To", StringUtil.LTrimStr( AV73TFBoletosValorDesconto_To, 18, 2));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosValorJuros") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV74TFBoletosValorJuros", StringUtil.LTrimStr( AV74TFBoletosValorJuros, 18, 2));
               AV75TFBoletosValorJuros_To = NumberUtil.Val( Ddo_grid_Filteredtextto_get, ".");
               AssignAttri(sPrefix, false, "AV75TFBoletosValorJuros_To", StringUtil.LTrimStr( AV75TFBoletosValorJuros_To, 18, 2));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosValorMulta") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV76TFBoletosValorMulta", StringUtil.LTrimStr( AV76TFBoletosValorMulta, 18, 2));
               AV77TFBoletosValorMulta_To = NumberUtil.Val( Ddo_grid_Filteredtextto_get, ".");
               AssignAttri(sPrefix, false, "AV77TFBoletosValorMulta_To", StringUtil.LTrimStr( AV77TFBoletosValorMulta_To, 18, 2));
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosSacadoNome") == 0 )
            {
               AV78TFBoletosSacadoNome = Ddo_grid_Filteredtext_get;
               AssignAttri(sPrefix, false, "AV78TFBoletosSacadoNome", AV78TFBoletosSacadoNome);
               AV79TFBoletosSacadoNome_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri(sPrefix, false, "AV79TFBoletosSacadoNome_Sel", AV79TFBoletosSacadoNome_Sel);
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosSacadoDocumento") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV80TFBoletosSacadoDocumento", AV80TFBoletosSacadoDocumento);
               AV81TFBoletosSacadoDocumento_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri(sPrefix, false, "AV81TFBoletosSacadoDocumento_Sel", AV81TFBoletosSacadoDocumento_Sel);
            }
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "BoletosSacadoTipoDocumento") == 0 )
            {
               ...
               AssignAttri(sPrefix, false, "AV82TFBoletosSacadoTipoDocumento_SelsJson", AV82TFBoletosSacadoTipoDocumento_SelsJson);
               AV83TFBoletosSacadoTipoDocumento_Sels.FromJSonString(AV82TFBoletosSacadoTipoDocumento_SelsJson, null);
            }
            subgrid_firstpage( ) ;
         }
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV83TFBoletosSacadoTipoDocumento_Sels", AV83TFBoletosSacadoTipoDocumento_Sels);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV42TFBoletosStatus_Sels", AV42TFBoletosStatus_Sels);
      }
      ...
      protected void E11AA2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras"+UrlEncode(StringUtil.RTrim("WcBoletosFilters")) + "," + UrlEncode(StringUtil.RTrim(AV92Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters"+UrlEncode(StringUtil.RTrim("WcBoletosFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "WcBoletosFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E18AA2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "selecionartitulos"+UrlEncode(StringUtil.LTrimStr(AV91CarteiraDeCobrancaId,9,0));
         CallWebObject(formatLink("selecionartitulos") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
      ...
      protected void E19AA2( )
      {
         /* 'DoExport' Routine */
         returnInSub = false;
         new wcboletosexport(context ).execute( out  AV29ExcelFilename, out  AV30ErrorMessage) ;
      ...
      protected void S122( )
      {
         ...
         AssignProp(sPrefix, false, edtavBoletosnossonumero1_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavBoletosnossonumero1_Visible), 5, 0), true);
      ...
      protected void S132( )
      {
         ...
         AssignProp(sPrefix, false, edtavBoletosnossonumero2_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavBoletosnossonumero2_Visible), 5, 0), true);
      ...
      protected void S142( )
      {
         ...
         AssignProp(sPrefix, false, edtavBoletosnossonumero3_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavBoletosnossonumero3_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "WcBoletosFilters",  "WWPDynFilterHideAll_AL('%1', 3, 0)",  divTabledynamicfilters_Internalname,  true, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void wb_table3_89_AA2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavDynamicfiltersoperator3, cmbavDynamicfiltersoperator3_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV25DynamicFiltersOperator3), 4, 0)), 1, cmbavDynamicfiltersoperator3_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbavDynamicfiltersoperator3.Visible, cmbavDynamicfiltersoperator3.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,93);\"", "", true, 0, "HLP_WcBoletos.htm");
            cmbavDynamicfiltersoperator3.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV25DynamicFiltersOperator3), 4, 0));
            ...
            GxWebStd.gx_single_line_edit( context, edtavBoletosnossonumero3_Internalname, AV26BoletosNossoNumero3, StringUtil.RTrim( context.localUtil.Format( AV26BoletosNossoNumero3, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,96);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBoletosnossonumero3_Jsonclick, 0, "Attribute", "", "", "", "", edtavBoletosnossonumero3_Visible, edtavBoletosnossonumero3_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_bitmap( context, imgRemovedynamicfilters3_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "Remover filtro", 0, 0, 0, "px", 0, "px", 0, 0, 5, imgRemovedynamicfilters3_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'REMOVEDYNAMICFILTERS3\\'."+"'", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" "+TempTags, "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WcBoletos.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_89_AA2e( true) ;
         }
         else
         {
            wb_table3_89_AA2e( false) ;
         }
      }

      protected void wb_table2_67_AA2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavDynamicfiltersoperator2, cmbavDynamicfiltersoperator2_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV21DynamicFiltersOperator2), 4, 0)), 1, cmbavDynamicfiltersoperator2_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", cmbavDynamicfiltersoperator2.Visible, cmbavDynamicfiltersoperator2.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,71);\"", "", true, 0, "HLP_WcBoletos.htm");
            cmbavDynamicfiltersoperator2.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV21DynamicFiltersOperator2), 4, 0));
            ...
            GxWebStd.gx_single_line_edit( context, edtavBoletosnossonumero2_Internalname, AV22BoletosNossoNumero2, StringUtil.RTrim( context.localUtil.Format( AV22BoletosNossoNumero2, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,74);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBoletosnossonumero2_Jsonclick, 0, "Attribute", "", "", "", "", edtavBoletosnossonumero2_Visible, edtavBoletosnossonumero2_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_67_AA2e( true) ;
         }
         else
         {
            wb_table2_67_AA2e( false) ;
         }
      }

      protected void wb_table1_45_AA2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBoletosnossonumero1_Internalname, AV18BoletosNossoNumero1, StringUtil.RTrim( context.localUtil.Format( AV18BoletosNossoNumero1, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,52);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBoletosnossonumero1_Jsonclick, 0, "Attribute", "", "", "", "", edtavBoletosnossonumero1_Visible, edtavBoletosnossonumero1_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WcBoletos.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_45_AA2e( true) ;
         }
         else
         {
            wb_table1_45_AA2e( false) ;
         }
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV91CarteiraDeCobrancaId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wcboletos", GetJustCreated( ));
         ...
         {
            AV91CarteiraDeCobrancaId = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV91CarteiraDeCobrancaId", StringUtil.LTrimStr( (decimal)(AV91CarteiraDeCobrancaId), 9, 0));
         }
         wcpOAV91CarteiraDeCobrancaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV91CarteiraDeCobrancaId"), ",", "."), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV91CarteiraDeCobrancaId != wcpOAV91CarteiraDeCobrancaId ) ) )
         {
            setjustcreated();
         }
         wcpOAV91CarteiraDeCobrancaId = AV91CarteiraDeCobrancaId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV91CarteiraDeCobrancaId = cgiGet( sPrefix+"AV91CarteiraDeCobrancaId_CTRL");
         if ( StringUtil.Len( sCtrlAV91CarteiraDeCobrancaId) > 0 )
         {
            AV91CarteiraDeCobrancaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV91CarteiraDeCobrancaId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV91CarteiraDeCobrancaId", StringUtil.LTrimStr( (decimal)(AV91CarteiraDeCobrancaId), 9, 0));
         }
         else
         {
            AV91CarteiraDeCobrancaId = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV91CarteiraDeCobrancaId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV91CarteiraDeCobrancaId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV91CarteiraDeCobrancaId), 9, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV91CarteiraDeCobrancaId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV91CarteiraDeCobrancaId_CTRL", StringUtil.RTrim( sCtrlAV91CarteiraDeCobrancaId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019225272", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wcboletos.js", "?202561019225273", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         cmbavGridactiongroup1_Internalname = sPrefix+"vGRIDACTIONGROUP1_"+sGXsfl_107_idx;
         edtBoletosId_Internalname = sPrefix+"BOLETOSID_"+sGXsfl_107_idx;
         edtCarteiraDeCobrancaId_Internalname = sPrefix+"CARTEIRADECOBRANCAID_"+sGXsfl_107_idx;
         edtTituloId_Internalname = sPrefix+"TITULOID_"+sGXsfl_107_idx;
         edtBoletosNossoNumero_Internalname = sPrefix+"BOLETOSNOSSONUMERO_"+sGXsfl_107_idx;
         edtBoletosSeuNumero_Internalname = sPrefix+"BOLETOSSEUNUMERO_"+sGXsfl_107_idx;
         edtBoletosNumero_Internalname = sPrefix+"BOLETOSNUMERO_"+sGXsfl_107_idx;
         edtBoletosLinhaDigitavel_Internalname = sPrefix+"BOLETOSLINHADIGITAVEL_"+sGXsfl_107_idx;
         edtBoletosCodigoDeBarras_Internalname = sPrefix+"BOLETOSCODIGODEBARRAS_"+sGXsfl_107_idx;
         cmbBoletosStatus_Internalname = sPrefix+"BOLETOSSTATUS_"+sGXsfl_107_idx;
         edtBoletosDataEmissao_Internalname = sPrefix+"BOLETOSDATAEMISSAO_"+sGXsfl_107_idx;
         edtBoletosDataVencimento_Internalname = sPrefix+"BOLETOSDATAVENCIMENTO_"+sGXsfl_107_idx;
         edtBoletosDataRegistro_Internalname = sPrefix+"BOLETOSDATAREGISTRO_"+sGXsfl_107_idx;
         edtBoletosDataPagamento_Internalname = sPrefix+"BOLETOSDATAPAGAMENTO_"+sGXsfl_107_idx;
         edtBoletosDataBaixa_Internalname = sPrefix+"BOLETOSDATABAIXA_"+sGXsfl_107_idx;
         edtBoletosValorNominal_Internalname = sPrefix+"BOLETOSVALORNOMINAL_"+sGXsfl_107_idx;
         edtBoletosValorPago_Internalname = sPrefix+"BOLETOSVALORPAGO_"+sGXsfl_107_idx;
         edtBoletosValorDesconto_Internalname = sPrefix+"BOLETOSVALORDESCONTO_"+sGXsfl_107_idx;
         edtBoletosValorJuros_Internalname = sPrefix+"BOLETOSVALORJUROS_"+sGXsfl_107_idx;
         edtBoletosValorMulta_Internalname = sPrefix+"BOLETOSVALORMULTA_"+sGXsfl_107_idx;
         edtBoletosSacadoNome_Internalname = sPrefix+"BOLETOSSACADONOME_"+sGXsfl_107_idx;
         edtBoletosSacadoDocumento_Internalname = sPrefix+"BOLETOSSACADODOCUMENTO_"+sGXsfl_107_idx;
         cmbBoletosSacadoTipoDocumento_Internalname = sPrefix+"BOLETOSSACADOTIPODOCUMENTO_"+sGXsfl_107_idx;
      }

      protected void SubsflControlProps_fel_1072( )
      {
         cmbavGridactiongroup1_Internalname = sPrefix+"vGRIDACTIONGROUP1_"+sGXsfl_107_fel_idx;
         edtBoletosId_Internalname = sPrefix+"BOLETOSID_"+sGXsfl_107_fel_idx;
         edtCarteiraDeCobrancaId_Internalname = sPrefix+"CARTEIRADECOBRANCAID_"+sGXsfl_107_fel_idx;
         edtTituloId_Internalname = sPrefix+"TITULOID_"+sGXsfl_107_fel_idx;
         edtBoletosNossoNumero_Internalname = sPrefix+"BOLETOSNOSSONUMERO_"+sGXsfl_107_fel_idx;
         edtBoletosSeuNumero_Internalname = sPrefix+"BOLETOSSEUNUMERO_"+sGXsfl_107_fel_idx;
         edtBoletosNumero_Internalname = sPrefix+"BOLETOSNUMERO_"+sGXsfl_107_fel_idx;
         edtBoletosLinhaDigitavel_Internalname = sPrefix+"BOLETOSLINHADIGITAVEL_"+sGXsfl_107_fel_idx;
         edtBoletosCodigoDeBarras_Internalname = sPrefix+"BOLETOSCODIGODEBARRAS_"+sGXsfl_107_fel_idx;
         cmbBoletosStatus_Internalname = sPrefix+"BOLETOSSTATUS_"+sGXsfl_107_fel_idx;
         edtBoletosDataEmissao_Internalname = sPrefix+"BOLETOSDATAEMISSAO_"+sGXsfl_107_fel_idx;
         edtBoletosDataVencimento_Internalname = sPrefix+"BOLETOSDATAVENCIMENTO_"+sGXsfl_107_fel_idx;
         edtBoletosDataRegistro_Internalname = sPrefix+"BOLETOSDATAREGISTRO_"+sGXsfl_107_fel_idx;
         edtBoletosDataPagamento_Internalname = sPrefix+"BOLETOSDATAPAGAMENTO_"+sGXsfl_107_fel_idx;
         edtBoletosDataBaixa_Internalname = sPrefix+"BOLETOSDATABAIXA_"+sGXsfl_107_fel_idx;
         edtBoletosValorNominal_Internalname = sPrefix+"BOLETOSVALORNOMINAL_"+sGXsfl_107_fel_idx;
         edtBoletosValorPago_Internalname = sPrefix+"BOLETOSVALORPAGO_"+sGXsfl_107_fel_idx;
         edtBoletosValorDesconto_Internalname = sPrefix+"BOLETOSVALORDESCONTO_"+sGXsfl_107_fel_idx;
         edtBoletosValorJuros_Internalname = sPrefix+"BOLETOSVALORJUROS_"+sGXsfl_107_fel_idx;
         edtBoletosValorMulta_Internalname = sPrefix+"BOLETOSVALORMULTA_"+sGXsfl_107_fel_idx;
         edtBoletosSacadoNome_Internalname = sPrefix+"BOLETOSSACADONOME_"+sGXsfl_107_fel_idx;
         edtBoletosSacadoDocumento_Internalname = sPrefix+"BOLETOSSACADODOCUMENTO_"+sGXsfl_107_fel_idx;
         cmbBoletosSacadoTipoDocumento_Internalname = sPrefix+"BOLETOSSACADOTIPODOCUMENTO_"+sGXsfl_107_fel_idx;
      }
      ...
      protected void sendrow_1072( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_107_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtBoletosId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1077BoletosId), 9, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1077BoletosId), "ZZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtBoletosId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCarteiraDeCobrancaId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1069CarteiraDeCobrancaId), 9, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1069CarteiraDeCobrancaId), "ZZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCarteiraDeCobrancaId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtBoletosNumero_Internalname,(string)A1080BoletosNumero,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtBoletosNumero_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)50,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            AssignProp(sPrefix, false, cmbBoletosStatus_Internalname, "Values", (string)(cmbBoletosStatus.ToJavascriptSource()), !bGXsfl_107_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtBoletosDataRegistro_Internalname,context.localUtil.TToC( A1086BoletosDataRegistro, 10, 8, 0, 3, "/", ":", " "),context.localUtil.Format( A1086BoletosDataRegistro, "99/99/99 99:99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtBoletosDataRegistro_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)14,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtBoletosDataPagamento_Internalname,context.localUtil.Format(A1087BoletosDataPagamento, "99/99/99"),context.localUtil.Format( A1087BoletosDataPagamento, "99/99/99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtBoletosDataPagamento_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtBoletosDataBaixa_Internalname,context.localUtil.Format(A1088BoletosDataBaixa, "99/99/99"),context.localUtil.Format( A1088BoletosDataBaixa, "99/99/99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtBoletosDataBaixa_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtBoletosValorPago_Internalname,StringUtil.LTrim( StringUtil.NToC( A1090BoletosValorPago, 18, 2, ",", "")),StringUtil.LTrim( context.localUtil.Format( A1090BoletosValorPago, "ZZZ,ZZZ,ZZZ,ZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtBoletosValorPago_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)18,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)0,(bool)true,(string)"Valor",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtBoletosValorJuros_Internalname,StringUtil.LTrim( StringUtil.NToC( A1092BoletosValorJuros, 18, 2, ",", "")),StringUtil.LTrim( context.localUtil.Format( A1092BoletosValorJuros, "ZZZ,ZZZ,ZZZ,ZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtBoletosValorJuros_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)18,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)0,(bool)true,(string)"Valor",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtBoletosValorMulta_Internalname,StringUtil.LTrim( StringUtil.NToC( A1093BoletosValorMulta, 18, 2, ",", "")),StringUtil.LTrim( context.localUtil.Format( A1093BoletosValorMulta, "ZZZ,ZZZ,ZZZ,ZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtBoletosValorMulta_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)18,(short)0,(short)0,(short)107,(short)0,(short)-1,(short)0,(bool)true,(string)"Valor",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            AssignProp(sPrefix, false, cmbBoletosSacadoTipoDocumento_Internalname, "Values", (string)(cmbBoletosSacadoTipoDocumento.ToJavascriptSource()), !bGXsfl_107_Refreshing);
      ...
      protected void init_default_properties( )
      {
         ...
         edtavBoletosnossonumero1_Internalname = sPrefix+"vBOLETOSNOSSONUMERO1";
         cellFilter_boletosnossonumero1_cell_Internalname = sPrefix+"FILTER_BOLETOSNOSSONUMERO1_CELL";
         ...
         edtavBoletosnossonumero2_Internalname = sPrefix+"vBOLETOSNOSSONUMERO2";
         cellFilter_boletosnossonumero2_cell_Internalname = sPrefix+"FILTER_BOLETOSNOSSONUMERO2_CELL";
         ...
         edtavBoletosnossonumero3_Internalname = sPrefix+"vBOLETOSNOSSONUMERO3";
         cellFilter_boletosnossonumero3_cell_Internalname = sPrefix+"FILTER_BOLETOSNOSSONUMERO3_CELL";
         ...
         edtBoletosId_Internalname = sPrefix+"BOLETOSID";
         edtCarteiraDeCobrancaId_Internalname = sPrefix+"CARTEIRADECOBRANCAID";
         edtTituloId_Internalname = sPrefix+"TITULOID";
         edtBoletosNossoNumero_Internalname = sPrefix+"BOLETOSNOSSONUMERO";
         edtBoletosSeuNumero_Internalname = sPrefix+"BOLETOSSEUNUMERO";
         edtBoletosNumero_Internalname = sPrefix+"BOLETOSNUMERO";
         edtBoletosLinhaDigitavel_Internalname = sPrefix+"BOLETOSLINHADIGITAVEL";
         edtBoletosCodigoDeBarras_Internalname = sPrefix+"BOLETOSCODIGODEBARRAS";
         cmbBoletosStatus_Internalname = sPrefix+"BOLETOSSTATUS";
         edtBoletosDataEmissao_Internalname = sPrefix+"BOLETOSDATAEMISSAO";
         edtBoletosDataVencimento_Internalname = sPrefix+"BOLETOSDATAVENCIMENTO";
         edtBoletosDataRegistro_Internalname = sPrefix+"BOLETOSDATAREGISTRO";
         edtBoletosDataPagamento_Internalname = sPrefix+"BOLETOSDATAPAGAMENTO";
         edtBoletosDataBaixa_Internalname = sPrefix+"BOLETOSDATABAIXA";
         edtBoletosValorNominal_Internalname = sPrefix+"BOLETOSVALORNOMINAL";
         edtBoletosValorPago_Internalname = sPrefix+"BOLETOSVALORPAGO";
         edtBoletosValorDesconto_Internalname = sPrefix+"BOLETOSVALORDESCONTO";
         edtBoletosValorJuros_Internalname = sPrefix+"BOLETOSVALORJUROS";
         edtBoletosValorMulta_Internalname = sPrefix+"BOLETOSVALORMULTA";
         edtBoletosSacadoNome_Internalname = sPrefix+"BOLETOSSACADONOME";
         edtBoletosSacadoDocumento_Internalname = sPrefix+"BOLETOSSACADODOCUMENTO";
         cmbBoletosSacadoTipoDocumento_Internalname = sPrefix+"BOLETOSSACADOTIPODOCUMENTO";
         ...
         edtavDdo_boletosdataemissaoauxdatetext_Internalname = sPrefix+"vDDO_BOLETOSDATAEMISSAOAUXDATETEXT";
         Tfboletosdataemissao_rangepicker_Internalname = sPrefix+"TFBOLETOSDATAEMISSAO_RANGEPICKER";
         divDdo_boletosdataemissaoauxdates_Internalname = sPrefix+"DDO_BOLETOSDATAEMISSAOAUXDATES";
         edtavDdo_boletosdatavencimentoauxdatetext_Internalname = sPrefix+"vDDO_BOLETOSDATAVENCIMENTOAUXDATETEXT";
         Tfboletosdatavencimento_rangepicker_Internalname = sPrefix+"TFBOLETOSDATAVENCIMENTO_RANGEPICKER";
         divDdo_boletosdatavencimentoauxdates_Internalname = sPrefix+"DDO_BOLETOSDATAVENCIMENTOAUXDATES";
         edtavDdo_boletosdataregistroauxdatetext_Internalname = sPrefix+"vDDO_BOLETOSDATAREGISTROAUXDATETEXT";
         Tfboletosdataregistro_rangepicker_Internalname = sPrefix+"TFBOLETOSDATAREGISTRO_RANGEPICKER";
         divDdo_boletosdataregistroauxdates_Internalname = sPrefix+"DDO_BOLETOSDATAREGISTROAUXDATES";
         edtavDdo_boletosdatapagamentoauxdatetext_Internalname = sPrefix+"vDDO_BOLETOSDATAPAGAMENTOAUXDATETEXT";
         Tfboletosdatapagamento_rangepicker_Internalname = sPrefix+"TFBOLETOSDATAPAGAMENTO_RANGEPICKER";
         divDdo_boletosdatapagamentoauxdates_Internalname = sPrefix+"DDO_BOLETOSDATAPAGAMENTOAUXDATES";
         edtavDdo_boletosdatabaixaauxdatetext_Internalname = sPrefix+"vDDO_BOLETOSDATABAIXAAUXDATETEXT";
         Tfboletosdatabaixa_rangepicker_Internalname = sPrefix+"TFBOLETOSDATABAIXA_RANGEPICKER";
         divDdo_boletosdatabaixaauxdates_Internalname = sPrefix+"DDO_BOLETOSDATABAIXAAUXDATES";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Datalistproc = "WcBoletosGetFilterData";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E27AA2","iparms":[{"av":"A1077BoletosId","fld":"BOLETOSID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]""");
         ...
         setEventMetadata("'ADDDYNAMICFILTERS1'","""{"handler":"E20AA2","iparms":[]""");
         ...
         setEventMetadata("'REMOVEDYNAMICFILTERS1'","""{"handler":"E15AA2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"cmbavDynamicfiltersselector1"},{"av":"AV16DynamicFiltersSelector1","fld":"vDYNAMICFILTERSSELECTOR1","type":"svchar"},{"av":"cmbavDynamicfiltersoperator1"},{"av":"AV17DynamicFiltersOperator1","fld":"vDYNAMICFILTERSOPERATOR1","pic":"ZZZ9","type":"int"},{"av":"AV18BoletosNossoNumero1","fld":"vBOLETOSNOSSONUMERO1","type":"svchar"},{"av":"cmbavDynamicfiltersselector2"},{"av":"AV20DynamicFiltersSelector2","fld":"vDYNAMICFILTERSSELECTOR2","type":"svchar"},{"av":"cmbavDynamicfiltersoperator2"},{"av":"AV21DynamicFiltersOperator2","fld":"vDYNAMICFILTERSOPERATOR2","pic":"ZZZ9","type":"int"},{"av":"AV22BoletosNossoNumero2","fld":"vBOLETOSNOSSONUMERO2","type":"svchar"},{"av":"cmbavDynamicfiltersselector3"},{"av":"AV24DynamicFiltersSelector3","fld":"vDYNAMICFILTERSSELECTOR3","type":"svchar"},{"av":"cmbavDynamicfiltersoperator3"},{"av":"AV25DynamicFiltersOperator3","fld":"vDYNAMICFILTERSOPERATOR3","pic":"ZZZ9","type":"int"},{"av":"AV26BoletosNossoNumero3","fld":"vBOLETOSNOSSONUMERO3","type":"svchar"},{"av":"AV34ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV92Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV91CarteiraDeCobrancaId","fld":"vCARTEIRADECOBRANCAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV19DynamicFiltersEnabled2","fld":"vDYNAMICFILTERSENABLED2","type":"boolean"},{"av":"AV23DynamicFiltersEnabled3","fld":"vDYNAMICFILTERSENABLED3","type":"boolean"},{"av":"AV35TFBoletosNossoNumero","fld":"vTFBOLETOSNOSSONUMERO","type":"svchar"},{"av":"AV36TFBoletosNossoNumero_Sel","fld":"vTFBOLETOSNOSSONUMERO_SEL","type":"svchar"},{"av":"AV37TFBoletosSeuNumero","fld":"vTFBOLETOSSEUNUMERO","type":"svchar"},{"av":"AV38TFBoletosSeuNumero_Sel","fld":"vTFBOLETOSSEUNUMERO_SEL","type":"svchar"},{"av":"AV39TFBoletosNumero","fld":"vTFBOLETOSNUMERO","type":"svchar"},{"av":"AV40TFBoletosNumero_Sel","fld":"vTFBOLETOSNUMERO_SEL","type":"svchar"},{"av":"AV42TFBoletosStatus_Sels","fld":"vTFBOLETOSSTATUS_SELS","type":""},{"av":"AV43TFBoletosDataEmissao","fld":"vTFBOLETOSDATAEMISSAO","type":"date"},{"av":"AV44TFBoletosDataEmissao_To","fld":"vTFBOLETOSDATAEMISSAO_TO","type":"date"},{"av":"AV48TFBoletosDataVencimento","fld":"vTFBOLETOSDATAVENCIMENTO","type":"date"},{"av":"AV49TFBoletosDataVencimento_To","fld":"vTFBOLETOSDATAVENCIMENTO_TO","type":"date"},{"av":"AV53TFBoletosDataRegistro","fld":"vTFBOLETOSDATAREGISTRO","pic":"99/99/99 99:99","type":"dtime"},{"av":"AV54TFBoletosDataRegistro_To","fld":"vTFBOLETOSDATAREGISTRO_TO","pic":"99/99/99 99:99","type":"dtime"},{"av":"AV58TFBoletosDataPagamento","fld":"vTFBOLETOSDATAPAGAMENTO","type":"date"},{"av":"AV59TFBoletosDataPagamento_To","fld":"vTFBOLETOSDATAPAGAMENTO_TO","type":"date"},{"av":"AV63TFBoletosDataBaixa","fld":"vTFBOLETOSDATABAIXA","type":"date"},{"av":"AV64TFBoletosDataBaixa_To","fld":"vTFBOLETOSDATABAIXA_TO","type":"date"},{"av":"AV68TFBoletosValorNominal","fld":"vTFBOLETOSVALORNOMINAL","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV69TFBoletosValorNominal_To","fld":"vTFBOLETOSVALORNOMINAL_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV70TFBoletosValorPago","fld":"vTFBOLETOSVALORPAGO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV71TFBoletosValorPago_To","fld":"vTFBOLETOSVALORPAGO_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV72TFBoletosValorDesconto","fld":"vTFBOLETOSVALORDESCONTO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV73TFBoletosValorDesconto_To","fld":"vTFBOLETOSVALORDESCONTO_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV74TFBoletosValorJuros","fld":"vTFBOLETOSVALORJUROS","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV75TFBoletosValorJuros_To","fld":"vTFBOLETOSVALORJUROS_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV76TFBoletosValorMulta","fld":"vTFBOLETOSVALORMULTA","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV77TFBoletosValorMulta_To","fld":"vTFBOLETOSVALORMULTA_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV78TFBoletosSacadoNome","fld":"vTFBOLETOSSACADONOME","type":"svchar"},{"av":"AV79TFBoletosSacadoNome_Sel","fld":"vTFBOLETOSSACADONOME_SEL","type":"svchar"},{"av":"AV80TFBoletosSacadoDocumento","fld":"vTFBOLETOSSACADODOCUMENTO","type":"svchar"},{"av":"AV81TFBoletosSacadoDocumento_Sel","fld":"vTFBOLETOSSACADODOCUMENTO_SEL","type":"svchar"},{"av":"AV83TFBoletosSacadoTipoDocumento_Sels","fld":"vTFBOLETOSSACADOTIPODOCUMENTO_SELS","type":""},{"av":"AV10GridState","fld":"vGRIDSTATE","type":""},{"av":"AV28DynamicFiltersIgnoreFirst","fld":"vDYNAMICFILTERSIGNOREFIRST","type":"boolean"},{"av":"AV27DynamicFiltersRemoving","fld":"vDYNAMICFILTERSREMOVING","type":"boolean"},{"av":"sPrefix","type":"char"}]""");
         ...
         setEventMetadata("VDYNAMICFILTERSSELECTOR1.CLICK","""{"handler":"E21AA2","iparms":[{"av":"cmbavDynamicfiltersselector1"},{"av":"AV16DynamicFiltersSelector1","fld":"vDYNAMICFILTERSSELECTOR1","type":"svchar"}]""");
         ...
         setEventMetadata("'ADDDYNAMICFILTERS2'","""{"handler":"E22AA2","iparms":[]""");
         ...
         setEventMetadata("'REMOVEDYNAMICFILTERS2'","""{"handler":"E16AA2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"cmbavDynamicfiltersselector1"},{"av":"AV16DynamicFiltersSelector1","fld":"vDYNAMICFILTERSSELECTOR1","type":"svchar"},{"av":"cmbavDynamicfiltersoperator1"},{"av":"AV17DynamicFiltersOperator1","fld":"vDYNAMICFILTERSOPERATOR1","pic":"ZZZ9","type":"int"},{"av":"AV18BoletosNossoNumero1","fld":"vBOLETOSNOSSONUMERO1","type":"svchar"},{"av":"cmbavDynamicfiltersselector2"},{"av":"AV20DynamicFiltersSelector2","fld":"vDYNAMICFILTERSSELECTOR2","type":"svchar"},{"av":"cmbavDynamicfiltersoperator2"},{"av":"AV21DynamicFiltersOperator2","fld":"vDYNAMICFILTERSOPERATOR2","pic":"ZZZ9","type":"int"},{"av":"AV22BoletosNossoNumero2","fld":"vBOLETOSNOSSONUMERO2","type":"svchar"},{"av":"cmbavDynamicfiltersselector3"},{"av":"AV24DynamicFiltersSelector3","fld":"vDYNAMICFILTERSSELECTOR3","type":"svchar"},{"av":"cmbavDynamicfiltersoperator3"},{"av":"AV25DynamicFiltersOperator3","fld":"vDYNAMICFILTERSOPERATOR3","pic":"ZZZ9","type":"int"},{"av":"AV26BoletosNossoNumero3","fld":"vBOLETOSNOSSONUMERO3","type":"svchar"},{"av":"AV34ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV92Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV91CarteiraDeCobrancaId","fld":"vCARTEIRADECOBRANCAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV19DynamicFiltersEnabled2","fld":"vDYNAMICFILTERSENABLED2","type":"boolean"},{"av":"AV23DynamicFiltersEnabled3","fld":"vDYNAMICFILTERSENABLED3","type":"boolean"},{"av":"AV35TFBoletosNossoNumero","fld":"vTFBOLETOSNOSSONUMERO","type":"svchar"},{"av":"AV36TFBoletosNossoNumero_Sel","fld":"vTFBOLETOSNOSSONUMERO_SEL","type":"svchar"},{"av":"AV37TFBoletosSeuNumero","fld":"vTFBOLETOSSEUNUMERO","type":"svchar"},{"av":"AV38TFBoletosSeuNumero_Sel","fld":"vTFBOLETOSSEUNUMERO_SEL","type":"svchar"},{"av":"AV39TFBoletosNumero","fld":"vTFBOLETOSNUMERO","type":"svchar"},{"av":"AV40TFBoletosNumero_Sel","fld":"vTFBOLETOSNUMERO_SEL","type":"svchar"},{"av":"AV42TFBoletosStatus_Sels","fld":"vTFBOLETOSSTATUS_SELS","type":""},{"av":"AV43TFBoletosDataEmissao","fld":"vTFBOLETOSDATAEMISSAO","type":"date"},{"av":"AV44TFBoletosDataEmissao_To","fld":"vTFBOLETOSDATAEMISSAO_TO","type":"date"},{"av":"AV48TFBoletosDataVencimento","fld":"vTFBOLETOSDATAVENCIMENTO","type":"date"},{"av":"AV49TFBoletosDataVencimento_To","fld":"vTFBOLETOSDATAVENCIMENTO_TO","type":"date"},{"av":"AV53TFBoletosDataRegistro","fld":"vTFBOLETOSDATAREGISTRO","pic":"99/99/99 99:99","type":"dtime"},{"av":"AV54TFBoletosDataRegistro_To","fld":"vTFBOLETOSDATAREGISTRO_TO","pic":"99/99/99 99:99","type":"dtime"},{"av":"AV58TFBoletosDataPagamento","fld":"vTFBOLETOSDATAPAGAMENTO","type":"date"},{"av":"AV59TFBoletosDataPagamento_To","fld":"vTFBOLETOSDATAPAGAMENTO_TO","type":"date"},{"av":"AV63TFBoletosDataBaixa","fld":"vTFBOLETOSDATABAIXA","type":"date"},{"av":"AV64TFBoletosDataBaixa_To","fld":"vTFBOLETOSDATABAIXA_TO","type":"date"},{"av":"AV68TFBoletosValorNominal","fld":"vTFBOLETOSVALORNOMINAL","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV69TFBoletosValorNominal_To","fld":"vTFBOLETOSVALORNOMINAL_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV70TFBoletosValorPago","fld":"vTFBOLETOSVALORPAGO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV71TFBoletosValorPago_To","fld":"vTFBOLETOSVALORPAGO_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV72TFBoletosValorDesconto","fld":"vTFBOLETOSVALORDESCONTO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV73TFBoletosValorDesconto_To","fld":"vTFBOLETOSVALORDESCONTO_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV74TFBoletosValorJuros","fld":"vTFBOLETOSVALORJUROS","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV75TFBoletosValorJuros_To","fld":"vTFBOLETOSVALORJUROS_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV76TFBoletosValorMulta","fld":"vTFBOLETOSVALORMULTA","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV77TFBoletosValorMulta_To","fld":"vTFBOLETOSVALORMULTA_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV78TFBoletosSacadoNome","fld":"vTFBOLETOSSACADONOME","type":"svchar"},{"av":"AV79TFBoletosSacadoNome_Sel","fld":"vTFBOLETOSSACADONOME_SEL","type":"svchar"},{"av":"AV80TFBoletosSacadoDocumento","fld":"vTFBOLETOSSACADODOCUMENTO","type":"svchar"},{"av":"AV81TFBoletosSacadoDocumento_Sel","fld":"vTFBOLETOSSACADODOCUMENTO_SEL","type":"svchar"},{"av":"AV83TFBoletosSacadoTipoDocumento_Sels","fld":"vTFBOLETOSSACADOTIPODOCUMENTO_SELS","type":""},{"av":"AV10GridState","fld":"vGRIDSTATE","type":""},{"av":"AV28DynamicFiltersIgnoreFirst","fld":"vDYNAMICFILTERSIGNOREFIRST","type":"boolean"},{"av":"AV27DynamicFiltersRemoving","fld":"vDYNAMICFILTERSREMOVING","type":"boolean"},{"av":"sPrefix","type":"char"}]""");
         ...
         setEventMetadata("VDYNAMICFILTERSSELECTOR2.CLICK","""{"handler":"E23AA2","iparms":[{"av":"cmbavDynamicfiltersselector2"},{"av":"AV20DynamicFiltersSelector2","fld":"vDYNAMICFILTERSSELECTOR2","type":"svchar"}]""");
         ...
         setEventMetadata("'REMOVEDYNAMICFILTERS3'","""{"handler":"E17AA2","iparms":[{"av":"GRID_nFirstRecordOnPage","type":"int"},{"av":"GRID_nEOF","type":"int"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9","type":"int"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC","type":"boolean"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT","type":"svchar"},{"av":"cmbavDynamicfiltersselector1"},{"av":"AV16DynamicFiltersSelector1","fld":"vDYNAMICFILTERSSELECTOR1","type":"svchar"},{"av":"cmbavDynamicfiltersoperator1"},{"av":"AV17DynamicFiltersOperator1","fld":"vDYNAMICFILTERSOPERATOR1","pic":"ZZZ9","type":"int"},{"av":"AV18BoletosNossoNumero1","fld":"vBOLETOSNOSSONUMERO1","type":"svchar"},{"av":"cmbavDynamicfiltersselector2"},{"av":"AV20DynamicFiltersSelector2","fld":"vDYNAMICFILTERSSELECTOR2","type":"svchar"},{"av":"cmbavDynamicfiltersoperator2"},{"av":"AV21DynamicFiltersOperator2","fld":"vDYNAMICFILTERSOPERATOR2","pic":"ZZZ9","type":"int"},{"av":"AV22BoletosNossoNumero2","fld":"vBOLETOSNOSSONUMERO2","type":"svchar"},{"av":"cmbavDynamicfiltersselector3"},{"av":"AV24DynamicFiltersSelector3","fld":"vDYNAMICFILTERSSELECTOR3","type":"svchar"},{"av":"cmbavDynamicfiltersoperator3"},{"av":"AV25DynamicFiltersOperator3","fld":"vDYNAMICFILTERSOPERATOR3","pic":"ZZZ9","type":"int"},{"av":"AV26BoletosNossoNumero3","fld":"vBOLETOSNOSSONUMERO3","type":"svchar"},{"av":"AV34ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9","type":"int"},{"av":"AV92Pgmname","fld":"vPGMNAME","hsh":true,"type":"char"},{"av":"AV91CarteiraDeCobrancaId","fld":"vCARTEIRADECOBRANCAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV19DynamicFiltersEnabled2","fld":"vDYNAMICFILTERSENABLED2","type":"boolean"},{"av":"AV23DynamicFiltersEnabled3","fld":"vDYNAMICFILTERSENABLED3","type":"boolean"},{"av":"AV35TFBoletosNossoNumero","fld":"vTFBOLETOSNOSSONUMERO","type":"svchar"},{"av":"AV36TFBoletosNossoNumero_Sel","fld":"vTFBOLETOSNOSSONUMERO_SEL","type":"svchar"},{"av":"AV37TFBoletosSeuNumero","fld":"vTFBOLETOSSEUNUMERO","type":"svchar"},{"av":"AV38TFBoletosSeuNumero_Sel","fld":"vTFBOLETOSSEUNUMERO_SEL","type":"svchar"},{"av":"AV39TFBoletosNumero","fld":"vTFBOLETOSNUMERO","type":"svchar"},{"av":"AV40TFBoletosNumero_Sel","fld":"vTFBOLETOSNUMERO_SEL","type":"svchar"},{"av":"AV42TFBoletosStatus_Sels","fld":"vTFBOLETOSSTATUS_SELS","type":""},{"av":"AV43TFBoletosDataEmissao","fld":"vTFBOLETOSDATAEMISSAO","type":"date"},{"av":"AV44TFBoletosDataEmissao_To","fld":"vTFBOLETOSDATAEMISSAO_TO","type":"date"},{"av":"AV48TFBoletosDataVencimento","fld":"vTFBOLETOSDATAVENCIMENTO","type":"date"},{"av":"AV49TFBoletosDataVencimento_To","fld":"vTFBOLETOSDATAVENCIMENTO_TO","type":"date"},{"av":"AV53TFBoletosDataRegistro","fld":"vTFBOLETOSDATAREGISTRO","pic":"99/99/99 99:99","type":"dtime"},{"av":"AV54TFBoletosDataRegistro_To","fld":"vTFBOLETOSDATAREGISTRO_TO","pic":"99/99/99 99:99","type":"dtime"},{"av":"AV58TFBoletosDataPagamento","fld":"vTFBOLETOSDATAPAGAMENTO","type":"date"},{"av":"AV59TFBoletosDataPagamento_To","fld":"vTFBOLETOSDATAPAGAMENTO_TO","type":"date"},{"av":"AV63TFBoletosDataBaixa","fld":"vTFBOLETOSDATABAIXA","type":"date"},{"av":"AV64TFBoletosDataBaixa_To","fld":"vTFBOLETOSDATABAIXA_TO","type":"date"},{"av":"AV68TFBoletosValorNominal","fld":"vTFBOLETOSVALORNOMINAL","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV69TFBoletosValorNominal_To","fld":"vTFBOLETOSVALORNOMINAL_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV70TFBoletosValorPago","fld":"vTFBOLETOSVALORPAGO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV71TFBoletosValorPago_To","fld":"vTFBOLETOSVALORPAGO_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV72TFBoletosValorDesconto","fld":"vTFBOLETOSVALORDESCONTO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV73TFBoletosValorDesconto_To","fld":"vTFBOLETOSVALORDESCONTO_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV74TFBoletosValorJuros","fld":"vTFBOLETOSVALORJUROS","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV75TFBoletosValorJuros_To","fld":"vTFBOLETOSVALORJUROS_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV76TFBoletosValorMulta","fld":"vTFBOLETOSVALORMULTA","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV77TFBoletosValorMulta_To","fld":"vTFBOLETOSVALORMULTA_TO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV78TFBoletosSacadoNome","fld":"vTFBOLETOSSACADONOME","type":"svchar"},{"av":"AV79TFBoletosSacadoNome_Sel","fld":"vTFBOLETOSSACADONOME_SEL","type":"svchar"},{"av":"AV80TFBoletosSacadoDocumento","fld":"vTFBOLETOSSACADODOCUMENTO","type":"svchar"},{"av":"AV81TFBoletosSacadoDocumento_Sel","fld":"vTFBOLETOSSACADODOCUMENTO_SEL","type":"svchar"},{"av":"AV83TFBoletosSacadoTipoDocumento_Sels","fld":"vTFBOLETOSSACADOTIPODOCUMENTO_SELS","type":""},{"av":"AV10GridState","fld":"vGRIDSTATE","type":""},{"av":"AV28DynamicFiltersIgnoreFirst","fld":"vDYNAMICFILTERSIGNOREFIRST","type":"boolean"},{"av":"AV27DynamicFiltersRemoving","fld":"vDYNAMICFILTERSREMOVING","type":"boolean"},{"av":"sPrefix","type":"char"}]""");
         ...
         setEventMetadata("VDYNAMICFILTERSSELECTOR3.CLICK","""{"handler":"E24AA2","iparms":[{"av":"cmbavDynamicfiltersselector3"},{"av":"AV24DynamicFiltersSelector3","fld":"vDYNAMICFILTERSSELECTOR3","type":"svchar"}]""");
         ...
         setEventMetadata("VGRIDACTIONGROUP1.CLICK","""{"handler":"E28AA2","iparms":[{"av":"cmbavGridactiongroup1"},{"av":"AV89GridActionGroup1","fld":"vGRIDACTIONGROUP1","pic":"ZZZ9","type":"int"},{"av":"A1077BoletosId","fld":"BOLETOSID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E18AA2","iparms":[{"av":"AV91CarteiraDeCobrancaId","fld":"vCARTEIRADECOBRANCAID","pic":"ZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("'DOEXPORT'","""{"handler":"E19AA2","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         A1096BoletosSacadoTipoDocumento = "";
         GXDecQS = "";
         AV112Wcboletosds_20_tfboletosstatus_sels = new GxSimpleCollection<string>();
         AV137Wcboletosds_45_tfboletossacadotipodocumento_sels = new GxSimpleCollection<string>();
         lV94Wcboletosds_2_filterfulltext = "";
         lV97Wcboletosds_5_boletosnossonumero1 = "";
         lV101Wcboletosds_9_boletosnossonumero2 = "";
         lV105Wcboletosds_13_boletosnossonumero3 = "";
         lV106Wcboletosds_14_tfboletosnossonumero = "";
         lV108Wcboletosds_16_tfboletosseunumero = "";
         lV110Wcboletosds_18_tfboletosnumero = "";
         lV133Wcboletosds_41_tfboletossacadonome = "";
         lV135Wcboletosds_43_tfboletossacadodocumento = "";
         AV94Wcboletosds_2_filterfulltext = "";
         AV95Wcboletosds_3_dynamicfiltersselector1 = "";
         AV97Wcboletosds_5_boletosnossonumero1 = "";
         AV99Wcboletosds_7_dynamicfiltersselector2 = "";
         ...
         AV111Wcboletosds_19_tfboletosnumero_sel = "";
         AV110Wcboletosds_18_tfboletosnumero = "";
         AV113Wcboletosds_21_tfboletosdataemissao = DateTime.MinValue;
         AV114Wcboletosds_22_tfboletosdataemissao_to = DateTime.MinValue;
         AV115Wcboletosds_23_tfboletosdatavencimento = DateTime.MinValue;
         AV116Wcboletosds_24_tfboletosdatavencimento_to = DateTime.MinValue;
         AV117Wcboletosds_25_tfboletosdataregistro = (DateTime)(DateTime.MinValue);
         AV118Wcboletosds_26_tfboletosdataregistro_to = (DateTime)(DateTime.MinValue);
         AV119Wcboletosds_27_tfboletosdatapagamento = DateTime.MinValue;
         AV120Wcboletosds_28_tfboletosdatapagamento_to = DateTime.MinValue;
         AV121Wcboletosds_29_tfboletosdatabaixa = DateTime.MinValue;
         AV122Wcboletosds_30_tfboletosdatabaixa_to = DateTime.MinValue;
         AV134Wcboletosds_42_tfboletossacadonome_sel = "";
         AV133Wcboletosds_41_tfboletossacadonome = "";
         AV136Wcboletosds_44_tfboletossacadodocumento_sel = "";
         AV135Wcboletosds_43_tfboletossacadodocumento = "";
         H00AA2_A1096BoletosSacadoTipoDocumento = new string[] {""} ;
         H00AA2_n1096BoletosSacadoTipoDocumento = new bool[] {false} ;
         H00AA2_A1095BoletosSacadoDocumento = new string[] {""} ;
         H00AA2_n1095BoletosSacadoDocumento = new bool[] {false} ;
         H00AA2_A1094BoletosSacadoNome = new string[] {""} ;
         H00AA2_n1094BoletosSacadoNome = new bool[] {false} ;
         H00AA2_A1093BoletosValorMulta = new decimal[1] ;
         H00AA2_n1093BoletosValorMulta = new bool[] {false} ;
         H00AA2_A1092BoletosValorJuros = new decimal[1] ;
         H00AA2_n1092BoletosValorJuros = new bool[] {false} ;
         H00AA2_A1091BoletosValorDesconto = new decimal[1] ;
         H00AA2_n1091BoletosValorDesconto = new bool[] {false} ;
         H00AA2_A1090BoletosValorPago = new decimal[1] ;
         H00AA2_n1090BoletosValorPago = new bool[] {false} ;
         H00AA2_A1089BoletosValorNominal = new decimal[1] ;
         H00AA2_n1089BoletosValorNominal = new bool[] {false} ;
         H00AA2_A1088BoletosDataBaixa = new DateTime[] {DateTime.MinValue} ;
         H00AA2_n1088BoletosDataBaixa = new bool[] {false} ;
         H00AA2_A1087BoletosDataPagamento = new DateTime[] {DateTime.MinValue} ;
         H00AA2_n1087BoletosDataPagamento = new bool[] {false} ;
         H00AA2_A1086BoletosDataRegistro = new DateTime[] {DateTime.MinValue} ;
         H00AA2_n1086BoletosDataRegistro = new bool[] {false} ;
         H00AA2_A1085BoletosDataVencimento = new DateTime[] {DateTime.MinValue} ;
         H00AA2_n1085BoletosDataVencimento = new bool[] {false} ;
         H00AA2_A1084BoletosDataEmissao = new DateTime[] {DateTime.MinValue} ;
         H00AA2_n1084BoletosDataEmissao = new bool[] {false} ;
         H00AA2_A1083BoletosStatus = new string[] {""} ;
         H00AA2_n1083BoletosStatus = new bool[] {false} ;
         H00AA2_A1082BoletosCodigoDeBarras = new string[] {""} ;
         H00AA2_n1082BoletosCodigoDeBarras = new bool[] {false} ;
         H00AA2_A1081BoletosLinhaDigitavel = new string[] {""} ;
         H00AA2_n1081BoletosLinhaDigitavel = new bool[] {false} ;
         H00AA2_A1080BoletosNumero = new string[] {""} ;
         H00AA2_n1080BoletosNumero = new bool[] {false} ;
         H00AA2_A1079BoletosSeuNumero = new string[] {""} ;
         H00AA2_n1079BoletosSeuNumero = new bool[] {false} ;
         H00AA2_A1078BoletosNossoNumero = new string[] {""} ;
         H00AA2_n1078BoletosNossoNumero = new bool[] {false} ;
         H00AA2_A261TituloId = new int[1] ;
         H00AA2_n261TituloId = new bool[] {false} ;
         H00AA2_A1069CarteiraDeCobrancaId = new int[1] ;
         H00AA2_n1069CarteiraDeCobrancaId = new bool[] {false} ;
         H00AA2_A1077BoletosId = new int[1] ;
         ...
         sCtrlAV91CarteiraDeCobrancaId = "";
         subGrid_Linesclass = "";
         GXCCtl = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wcboletos__default(),
            new Object[][] {
                new Object[] {
               H00AA2_A1096BoletosSacadoTipoDocumento, H00AA2_n1096BoletosSacadoTipoDocumento, H00AA2_A1095BoletosSacadoDocumento, H00AA2_n1095BoletosSacadoDocumento, H00AA2_A1094BoletosSacadoNome, H00AA2_n1094BoletosSacadoNome, H00AA2_A1093BoletosValorMulta, H00AA2_n1093BoletosValorMulta, H00AA2_A1092BoletosValorJuros, H00AA2_n1092BoletosValorJuros,
               H00AA2_A1091BoletosValorDesconto, H00AA2_n1091BoletosValorDesconto, H00AA2_A1090BoletosValorPago, H00AA2_n1090BoletosValorPago, H00AA2_A1089BoletosValorNominal, H00AA2_n1089BoletosValorNominal, H00AA2_A1088BoletosDataBaixa, H00AA2_n1088BoletosDataBaixa, H00AA2_A1087BoletosDataPagamento, H00AA2_n1087BoletosDataPagamento,
               H00AA2_A1086BoletosDataRegistro, H00AA2_n1086BoletosDataRegistro, H00AA2_A1085BoletosDataVencimento, H00AA2_n1085BoletosDataVencimento, H00AA2_A1084BoletosDataEmissao, H00AA2_n1084BoletosDataEmissao, H00AA2_A1083BoletosStatus, H00AA2_n1083BoletosStatus, H00AA2_A1082BoletosCodigoDeBarras, H00AA2_n1082BoletosCodigoDeBarras,
               H00AA2_A1081BoletosLinhaDigitavel, H00AA2_n1081BoletosLinhaDigitavel, H00AA2_A1080BoletosNumero, H00AA2_n1080BoletosNumero, H00AA2_A1079BoletosSeuNumero, H00AA2_n1079BoletosSeuNumero, H00AA2_A1078BoletosNossoNumero, H00AA2_n1078BoletosNossoNumero, H00AA2_A261TituloId, H00AA2_n261TituloId,
               H00AA2_A1069CarteiraDeCobrancaId, H00AA2_n1069CarteiraDeCobrancaId, H00AA2_A1077BoletosId
               }
               , new Object[] {
      ...
      private short AV96Wcboletosds_4_dynamicfiltersoperator1 ;
      private short AV100Wcboletosds_8_dynamicfiltersoperator2 ;
      private short AV104Wcboletosds_12_dynamicfiltersoperator3 ;
      ...
      private int AV112Wcboletosds_20_tfboletosstatus_sels_Count ;
      private int AV137Wcboletosds_45_tfboletossacadotipodocumento_sels_Count ;
      private int AV93Wcboletosds_1_carteiradecobrancaid ;
      ...
      private decimal AV123Wcboletosds_31_tfboletosvalornominal ;
      private decimal AV124Wcboletosds_32_tfboletosvalornominal_to ;
      private decimal AV125Wcboletosds_33_tfboletosvalorpago ;
      private decimal AV126Wcboletosds_34_tfboletosvalorpago_to ;
      private decimal AV127Wcboletosds_35_tfboletosvalordesconto ;
      private decimal AV128Wcboletosds_36_tfboletosvalordesconto_to ;
      private decimal AV129Wcboletosds_37_tfboletosvalorjuros ;
      private decimal AV130Wcboletosds_38_tfboletosvalorjuros_to ;
      private decimal AV131Wcboletosds_39_tfboletosvalormulta ;
      private decimal AV132Wcboletosds_40_tfboletosvalormulta_to ;
      ...
      private string sCtrlAV91CarteiraDeCobrancaId ;
      ...
      private DateTime AV117Wcboletosds_25_tfboletosdataregistro ;
      private DateTime AV118Wcboletosds_26_tfboletosdataregistro_to ;
      ...
      private DateTime AV113Wcboletosds_21_tfboletosdataemissao ;
      private DateTime AV114Wcboletosds_22_tfboletosdataemissao_to ;
      private DateTime AV115Wcboletosds_23_tfboletosdatavencimento ;
      private DateTime AV116Wcboletosds_24_tfboletosdatavencimento_to ;
      private DateTime AV119Wcboletosds_27_tfboletosdatapagamento ;
      private DateTime AV120Wcboletosds_28_tfboletosdatapagamento_to ;
      private DateTime AV121Wcboletosds_29_tfboletosdatabaixa ;
      private DateTime AV122Wcboletosds_30_tfboletosdatabaixa_to ;
      ...
      private bool AV98Wcboletosds_6_dynamicfiltersenabled2 ;
      private bool AV102Wcboletosds_10_dynamicfiltersenabled3 ;
      ...
      private string lV94Wcboletosds_2_filterfulltext ;
      private string lV97Wcboletosds_5_boletosnossonumero1 ;
      private string lV101Wcboletosds_9_boletosnossonumero2 ;
      private string lV105Wcboletosds_13_boletosnossonumero3 ;
      private string lV106Wcboletosds_14_tfboletosnossonumero ;
      private string lV108Wcboletosds_16_tfboletosseunumero ;
      private string lV110Wcboletosds_18_tfboletosnumero ;
      private string lV133Wcboletosds_41_tfboletossacadonome ;
      private string lV135Wcboletosds_43_tfboletossacadodocumento ;
      private string AV94Wcboletosds_2_filterfulltext ;
      private string AV95Wcboletosds_3_dynamicfiltersselector1 ;
      private string AV97Wcboletosds_5_boletosnossonumero1 ;
      private string AV99Wcboletosds_7_dynamicfiltersselector2 ;
      private string AV101Wcboletosds_9_boletosnossonumero2 ;
      private string AV103Wcboletosds_11_dynamicfiltersselector3 ;
      private string AV105Wcboletosds_13_boletosnossonumero3 ;
      private string AV107Wcboletosds_15_tfboletosnossonumero_sel ;
      private string AV106Wcboletosds_14_tfboletosnossonumero ;
      private string AV109Wcboletosds_17_tfboletosseunumero_sel ;
      private string AV108Wcboletosds_16_tfboletosseunumero ;
      private string AV111Wcboletosds_19_tfboletosnumero_sel ;
      private string AV110Wcboletosds_18_tfboletosnumero ;
      private string AV134Wcboletosds_42_tfboletossacadonome_sel ;
      private string AV133Wcboletosds_41_tfboletossacadonome ;
      private string AV136Wcboletosds_44_tfboletossacadodocumento_sel ;
      private string AV135Wcboletosds_43_tfboletossacadodocumento ;
      ...
      private GxSimpleCollection<string> AV112Wcboletosds_20_tfboletosstatus_sels ;
      private GxSimpleCollection<string> AV137Wcboletosds_45_tfboletossacadotipodocumento_sels ;
      private IDataStoreProvider pr_default ;
      private string[] H00AA2_A1096BoletosSacadoTipoDocumento ;
      private bool[] H00AA2_n1096BoletosSacadoTipoDocumento ;
      private string[] H00AA2_A1095BoletosSacadoDocumento ;
      private bool[] H00AA2_n1095BoletosSacadoDocumento ;
      private string[] H00AA2_A1094BoletosSacadoNome ;
      private bool[] H00AA2_n1094BoletosSacadoNome ;
      private decimal[] H00AA2_A1093BoletosValorMulta ;
      private bool[] H00AA2_n1093BoletosValorMulta ;
      private decimal[] H00AA2_A1092BoletosValorJuros ;
      private bool[] H00AA2_n1092BoletosValorJuros ;
      private decimal[] H00AA2_A1091BoletosValorDesconto ;
      private bool[] H00AA2_n1091BoletosValorDesconto ;
      private decimal[] H00AA2_A1090BoletosValorPago ;
      private bool[] H00AA2_n1090BoletosValorPago ;
      private decimal[] H00AA2_A1089BoletosValorNominal ;
      private bool[] H00AA2_n1089BoletosValorNominal ;
      private DateTime[] H00AA2_A1088BoletosDataBaixa ;
      private bool[] H00AA2_n1088BoletosDataBaixa ;
      private DateTime[] H00AA2_A1087BoletosDataPagamento ;
      private bool[] H00AA2_n1087BoletosDataPagamento ;
      private DateTime[] H00AA2_A1086BoletosDataRegistro ;
      private bool[] H00AA2_n1086BoletosDataRegistro ;
      private DateTime[] H00AA2_A1085BoletosDataVencimento ;
      private bool[] H00AA2_n1085BoletosDataVencimento ;
      private DateTime[] H00AA2_A1084BoletosDataEmissao ;
      private bool[] H00AA2_n1084BoletosDataEmissao ;
      private string[] H00AA2_A1083BoletosStatus ;
      private bool[] H00AA2_n1083BoletosStatus ;
      private string[] H00AA2_A1082BoletosCodigoDeBarras ;
      private bool[] H00AA2_n1082BoletosCodigoDeBarras ;
      private string[] H00AA2_A1081BoletosLinhaDigitavel ;
      private bool[] H00AA2_n1081BoletosLinhaDigitavel ;
      private string[] H00AA2_A1080BoletosNumero ;
      private bool[] H00AA2_n1080BoletosNumero ;
      private string[] H00AA2_A1079BoletosSeuNumero ;
      private bool[] H00AA2_n1079BoletosSeuNumero ;
      private string[] H00AA2_A1078BoletosNossoNumero ;
      private bool[] H00AA2_n1078BoletosNossoNumero ;
      private int[] H00AA2_A261TituloId ;
      private bool[] H00AA2_n261TituloId ;
      private int[] H00AA2_A1069CarteiraDeCobrancaId ;
      private bool[] H00AA2_n1069CarteiraDeCobrancaId ;
      private int[] H00AA2_A1077BoletosId ;
   ...
   public class wcboletos__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00AA2( IGxContext context ,
                                             string A1083BoletosStatus ,
                                             GxSimpleCollection<string> AV112Wcboletosds_20_tfboletosstatus_sels ,
                                             string A1096BoletosSacadoTipoDocumento ,
                                             GxSimpleCollection<string> AV137Wcboletosds_45_tfboletossacadotipodocumento_sels ,
                                             string AV94Wcboletosds_2_filterfulltext ,
                                             string AV95Wcboletosds_3_dynamicfiltersselector1 ,
                                             short AV96Wcboletosds_4_dynamicfiltersoperator1 ,
                                             string AV97Wcboletosds_5_boletosnossonumero1 ,
                                             bool AV98Wcboletosds_6_dynamicfiltersenabled2 ,
                                             string AV99Wcboletosds_7_dynamicfiltersselector2 ,
                                             short AV100Wcboletosds_8_dynamicfiltersoperator2 ,
                                             string AV101Wcboletosds_9_boletosnossonumero2 ,
                                             bool AV102Wcboletosds_10_dynamicfiltersenabled3 ,
                                             string AV103Wcboletosds_11_dynamicfiltersselector3 ,
                                             short AV104Wcboletosds_12_dynamicfiltersoperator3 ,
                                             string AV105Wcboletosds_13_boletosnossonumero3 ,
                                             string AV107Wcboletosds_15_tfboletosnossonumero_sel ,
                                             string AV106Wcboletosds_14_tfboletosnossonumero ,
                                             string AV109Wcboletosds_17_tfboletosseunumero_sel ,
                                             string AV108Wcboletosds_16_tfboletosseunumero ,
                                             string AV111Wcboletosds_19_tfboletosnumero_sel ,
                                             string AV110Wcboletosds_18_tfboletosnumero ,
                                             int AV112Wcboletosds_20_tfboletosstatus_sels_Count ,
                                             DateTime AV113Wcboletosds_21_tfboletosdataemissao ,
                                             DateTime AV114Wcboletosds_22_tfboletosdataemissao_to ,
                                             DateTime AV115Wcboletosds_23_tfboletosdatavencimento ,
                                             DateTime AV116Wcboletosds_24_tfboletosdatavencimento_to ,
                                             DateTime AV117Wcboletosds_25_tfboletosdataregistro ,
                                             DateTime AV118Wcboletosds_26_tfboletosdataregistro_to ,
                                             DateTime AV119Wcboletosds_27_tfboletosdatapagamento ,
                                             DateTime AV120Wcboletosds_28_tfboletosdatapagamento_to ,
                                             DateTime AV121Wcboletosds_29_tfboletosdatabaixa ,
                                             DateTime AV122Wcboletosds_30_tfboletosdatabaixa_to ,
                                             decimal AV123Wcboletosds_31_tfboletosvalornominal ,
                                             decimal AV124Wcboletosds_32_tfboletosvalornominal_to ,
                                             decimal AV125Wcboletosds_33_tfboletosvalorpago ,
                                             decimal AV126Wcboletosds_34_tfboletosvalorpago_to ,
                                             decimal AV127Wcboletosds_35_tfboletosvalordesconto ,
                                             decimal AV128Wcboletosds_36_tfboletosvalordesconto_to ,
                                             decimal AV129Wcboletosds_37_tfboletosvalorjuros ,
                                             decimal AV130Wcboletosds_38_tfboletosvalorjuros_to ,
                                             decimal AV131Wcboletosds_39_tfboletosvalormulta ,
                                             decimal AV132Wcboletosds_40_tfboletosvalormulta_to ,
                                             string AV134Wcboletosds_42_tfboletossacadonome_sel ,
                                             string AV133Wcboletosds_41_tfboletossacadonome ,
                                             string AV136Wcboletosds_44_tfboletossacadodocumento_sel ,
                                             string AV135Wcboletosds_43_tfboletossacadodocumento ,
                                             int AV137Wcboletosds_45_tfboletossacadotipodocumento_sels_Count ,
                                             ...
                                             int AV93Wcboletosds_1_carteiradecobrancaid )
      {
         ...
         sOrderString = "";
         AddWhere(sWhereString, "(CarteiraDeCobrancaId = :AV93Wcboletosds_1_carteiradecobrancaid)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV94Wcboletosds_2_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( BoletosNossoNumero like '%' || :lV94Wcboletosds_2_filterfulltext) or ( BoletosSeuNumero like '%' || :lV94Wcboletosds_2_filterfulltext) or ( BoletosNumero like '%' || :lV94Wcboletosds_2_filterfulltext) or ( 'rascunho' like '%' || LOWER(:lV94Wcboletosds_2_filterfulltext) and BoletosStatus = ( 'RASCUNHO')) or ( 'registrado' like '%' || LOWER(:lV94Wcboletosds_2_filterfulltext) and BoletosStatus = ( 'REGISTRADO')) or ( 'liquidado' like '%' || LOWER(:lV94Wcboletosds_2_filterfulltext) and BoletosStatus = ( 'LIQUIDADO')) or ( 'baixado' like '%' || LOWER(:lV94Wcboletosds_2_filterfulltext) and BoletosStatus = ( 'BAIXADO')) or ( 'vencido' like '%' || LOWER(:lV94Wcboletosds_2_filterfulltext) and BoletosStatus = ( 'VENCIDO')) or ( 'erro' like '%' || LOWER(:lV94Wcboletosds_2_filterfulltext) and BoletosStatus = ( 'ERRO')) or ( SUBSTR(TO_CHAR(BoletosValorNominal,'999999999999990.99'), 2) like '%' || :lV94Wcboletosds_2_filterfulltext) or ( SUBSTR(TO_CHAR(BoletosValorPago,'999999999999990.99'), 2) like '%' || :lV94Wcboletosds_2_filterfulltext) or ( SUBSTR(TO_CHAR(BoletosValorDesconto,'999999999999990.99'), 2) like '%' || :lV94Wcboletosds_2_filterfulltext) or ( SUBSTR(TO_CHAR(BoletosValorJuros,'999999999999990.99'), 2) like '%' || :lV94Wcboletosds_2_filterfulltext) or ( SUBSTR(TO_CHAR(BoletosValorMulta,'999999999999990.99'), 2) like '%' || :lV94Wcboletosds_2_filterfulltext) or ( BoletosSacadoNome like '%' || :lV94Wcboletosds_2_filterfulltext) or ( BoletosSacadoDocumento like '%' || :lV94Wcboletosds_2_filterfulltext) or ( 'cpf' like '%' || LOWER(:lV94Wcboletosds_2_filterfulltext) and BoletosSacadoTipoDocumento = ( 'CPF')) or ( 'cnpj' like '%' || LOWER(:lV94Wcboletosds_2_filterfulltext) and BoletosSacadoTipoDocumento = ( 'CNPJ')))");
         }
         else
         {
            GXv_int10[1] = 1;
         ...
         if ( ( StringUtil.StrCmp(AV95Wcboletosds_3_dynamicfiltersselector1, "BOLETOSNOSSONUMERO") == 0 ) && ( AV96Wcboletosds_4_dynamicfiltersoperator1 == 0 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV97Wcboletosds_5_boletosnossonumero1)) ) )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero like :lV97Wcboletosds_5_boletosnossonumero1)");
         }
         else
         {
            GXv_int10[19] = 1;
         }
         if ( ( StringUtil.StrCmp(AV95Wcboletosds_3_dynamicfiltersselector1, "BOLETOSNOSSONUMERO") == 0 ) && ( AV96Wcboletosds_4_dynamicfiltersoperator1 == 1 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV97Wcboletosds_5_boletosnossonumero1)) ) )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero like '%' || :lV97Wcboletosds_5_boletosnossonumero1)");
         }
         else
         ...
         if ( AV98Wcboletosds_6_dynamicfiltersenabled2 && ( StringUtil.StrCmp(AV99Wcboletosds_7_dynamicfiltersselector2, "BOLETOSNOSSONUMERO") == 0 ) && ( AV100Wcboletosds_8_dynamicfiltersoperator2 == 0 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV101Wcboletosds_9_boletosnossonumero2)) ) )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero like :lV101Wcboletosds_9_boletosnossonumero2)");
         }
         else
         {
            GXv_int10[21] = 1;
         }
         if ( AV98Wcboletosds_6_dynamicfiltersenabled2 && ( StringUtil.StrCmp(AV99Wcboletosds_7_dynamicfiltersselector2, "BOLETOSNOSSONUMERO") == 0 ) && ( AV100Wcboletosds_8_dynamicfiltersoperator2 == 1 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV101Wcboletosds_9_boletosnossonumero2)) ) )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero like '%' || :lV101Wcboletosds_9_boletosnossonumero2)");
         }
         else
         ...
         if ( AV102Wcboletosds_10_dynamicfiltersenabled3 && ( StringUtil.StrCmp(AV103Wcboletosds_11_dynamicfiltersselector3, "BOLETOSNOSSONUMERO") == 0 ) && ( AV104Wcboletosds_12_dynamicfiltersoperator3 == 0 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV105Wcboletosds_13_boletosnossonumero3)) ) )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero like :lV105Wcboletosds_13_boletosnossonumero3)");
         }
         else
         {
            GXv_int10[23] = 1;
         }
         if ( AV102Wcboletosds_10_dynamicfiltersenabled3 && ( StringUtil.StrCmp(AV103Wcboletosds_11_dynamicfiltersselector3, "BOLETOSNOSSONUMERO") == 0 ) && ( AV104Wcboletosds_12_dynamicfiltersoperator3 == 1 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV105Wcboletosds_13_boletosnossonumero3)) ) )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero like '%' || :lV105Wcboletosds_13_boletosnossonumero3)");
         }
         else
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV107Wcboletosds_15_tfboletosnossonumero_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV106Wcboletosds_14_tfboletosnossonumero)) ) )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero like :lV106Wcboletosds_14_tfboletosnossonumero)");
         }
         else
         {
            GXv_int10[25] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV107Wcboletosds_15_tfboletosnossonumero_sel)) && ! ( StringUtil.StrCmp(AV107Wcboletosds_15_tfboletosnossonumero_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero = ( :AV107Wcboletosds_15_tfboletosnossonumero_sel))");
         }
         else
         {
            GXv_int10[26] = 1;
         }
         if ( StringUtil.StrCmp(AV107Wcboletosds_15_tfboletosnossonumero_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "(BoletosNossoNumero IS NULL or (char_length(trim(trailing ' ' from BoletosNossoNumero))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV109Wcboletosds_17_tfboletosseunumero_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV108Wcboletosds_16_tfboletosseunumero)) ) )
         {
            AddWhere(sWhereString, "(BoletosSeuNumero like :lV108Wcboletosds_16_tfboletosseunumero)");
         }
         else
         {
            GXv_int10[27] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV109Wcboletosds_17_tfboletosseunumero_sel)) && ! ( StringUtil.StrCmp(AV109Wcboletosds_17_tfboletosseunumero_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(BoletosSeuNumero = ( :AV109Wcboletosds_17_tfboletosseunumero_sel))");
         }
         else
         {
            GXv_int10[28] = 1;
         }
         if ( StringUtil.StrCmp(AV109Wcboletosds_17_tfboletosseunumero_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "(BoletosSeuNumero IS NULL or (char_length(trim(trailing ' ' from BoletosSeuNumero))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV111Wcboletosds_19_tfboletosnumero_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV110Wcboletosds_18_tfboletosnumero)) ) )
         {
            AddWhere(sWhereString, "(BoletosNumero like :lV110Wcboletosds_18_tfboletosnumero)");
         }
         else
         {
            GXv_int10[29] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV111Wcboletosds_19_tfboletosnumero_sel)) && ! ( StringUtil.StrCmp(AV111Wcboletosds_19_tfboletosnumero_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(BoletosNumero = ( :AV111Wcboletosds_19_tfboletosnumero_sel))");
         }
         else
         {
            GXv_int10[30] = 1;
         }
         if ( StringUtil.StrCmp(AV111Wcboletosds_19_tfboletosnumero_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "(BoletosNumero IS NULL or (char_length(trim(trailing ' ' from BoletosNumero))=0))");
         }
         if ( AV112Wcboletosds_20_tfboletosstatus_sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV112Wcboletosds_20_tfboletosstatus_sels, "BoletosStatus IN (", ")")+")");
         }
         if ( ! (DateTime.MinValue==AV113Wcboletosds_21_tfboletosdataemissao) )
         {
            AddWhere(sWhereString, "(BoletosDataEmissao >= :AV113Wcboletosds_21_tfboletosdataemissao)");
         }
         else
         {
            GXv_int10[31] = 1;
         }
         if ( ! (DateTime.MinValue==AV114Wcboletosds_22_tfboletosdataemissao_to) )
         {
            AddWhere(sWhereString, "(BoletosDataEmissao <= :AV114Wcboletosds_22_tfboletosdataemissao_to)");
         }
         else
         {
            GXv_int10[32] = 1;
         }
         if ( ! (DateTime.MinValue==AV115Wcboletosds_23_tfboletosdatavencimento) )
         {
            AddWhere(sWhereString, "(BoletosDataVencimento >= :AV115Wcboletosds_23_tfboletosdatavencimento)");
         }
         else
         {
            GXv_int10[33] = 1;
         }
         if ( ! (DateTime.MinValue==AV116Wcboletosds_24_tfboletosdatavencimento_to) )
         {
            AddWhere(sWhereString, "(BoletosDataVencimento <= :AV116Wcboletosds_24_tfboletosdatavencimento_to)");
         }
         else
         {
            GXv_int10[34] = 1;
         }
         if ( ! (DateTime.MinValue==AV117Wcboletosds_25_tfboletosdataregistro) )
         {
            AddWhere(sWhereString, "(BoletosDataRegistro >= :AV117Wcboletosds_25_tfboletosdataregistro)");
         }
         else
         {
            GXv_int10[35] = 1;
         }
         if ( ! (DateTime.MinValue==AV118Wcboletosds_26_tfboletosdataregistro_to) )
         {
            AddWhere(sWhereString, "(BoletosDataRegistro <= :AV118Wcboletosds_26_tfboletosdataregistro_to)");
         }
         else
         {
            GXv_int10[36] = 1;
         }
         if ( ! (DateTime.MinValue==AV119Wcboletosds_27_tfboletosdatapagamento) )
         {
            AddWhere(sWhereString, "(BoletosDataPagamento >= :AV119Wcboletosds_27_tfboletosdatapagamento)");
         }
         else
         {
            GXv_int10[37] = 1;
         }
         if ( ! (DateTime.MinValue==AV120Wcboletosds_28_tfboletosdatapagamento_to) )
         {
            AddWhere(sWhereString, "(BoletosDataPagamento <= :AV120Wcboletosds_28_tfboletosdatapagamento_to)");
         }
         else
         {
            GXv_int10[38] = 1;
         }
         if ( ! (DateTime.MinValue==AV121Wcboletosds_29_tfboletosdatabaixa) )
         {
            AddWhere(sWhereString, "(BoletosDataBaixa >= :AV121Wcboletosds_29_tfboletosdatabaixa)");
         }
         else
         {
            GXv_int10[39] = 1;
         }
         if ( ! (DateTime.MinValue==AV122Wcboletosds_30_tfboletosdatabaixa_to) )
         {
            AddWhere(sWhereString, "(BoletosDataBaixa <= :AV122Wcboletosds_30_tfboletosdatabaixa_to)");
         }
         else
         {
            GXv_int10[40] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV123Wcboletosds_31_tfboletosvalornominal) )
         {
            AddWhere(sWhereString, "(BoletosValorNominal >= :AV123Wcboletosds_31_tfboletosvalornominal)");
         }
         else
         {
            GXv_int10[41] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV124Wcboletosds_32_tfboletosvalornominal_to) )
         {
            AddWhere(sWhereString, "(BoletosValorNominal <= :AV124Wcboletosds_32_tfboletosvalornominal_to)");
         }
         else
         {
            GXv_int10[42] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV125Wcboletosds_33_tfboletosvalorpago) )
         {
            AddWhere(sWhereString, "(BoletosValorPago >= :AV125Wcboletosds_33_tfboletosvalorpago)");
         }
         else
         {
            GXv_int10[43] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV126Wcboletosds_34_tfboletosvalorpago_to) )
         {
            AddWhere(sWhereString, "(BoletosValorPago <= :AV126Wcboletosds_34_tfboletosvalorpago_to)");
         }
         else
         {
            GXv_int10[44] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV127Wcboletosds_35_tfboletosvalordesconto) )
         {
            AddWhere(sWhereString, "(BoletosValorDesconto >= :AV127Wcboletosds_35_tfboletosvalordesconto)");
         }
         else
         {
            GXv_int10[45] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV128Wcboletosds_36_tfboletosvalordesconto_to) )
         {
            AddWhere(sWhereString, "(BoletosValorDesconto <= :AV128Wcboletosds_36_tfboletosvalordesconto_to)");
         }
         else
         {
            GXv_int10[46] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV129Wcboletosds_37_tfboletosvalorjuros) )
         {
            AddWhere(sWhereString, "(BoletosValorJuros >= :AV129Wcboletosds_37_tfboletosvalorjuros)");
         }
         else
         {
            GXv_int10[47] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV130Wcboletosds_38_tfboletosvalorjuros_to) )
         {
            AddWhere(sWhereString, "(BoletosValorJuros <= :AV130Wcboletosds_38_tfboletosvalorjuros_to)");
         }
         else
         {
            GXv_int10[48] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV131Wcboletosds_39_tfboletosvalormulta) )
         {
            AddWhere(sWhereString, "(BoletosValorMulta >= :AV131Wcboletosds_39_tfboletosvalormulta)");
         }
         else
         {
            GXv_int10[49] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV132Wcboletosds_40_tfboletosvalormulta_to) )
         {
            AddWhere(sWhereString, "(BoletosValorMulta <= :AV132Wcboletosds_40_tfboletosvalormulta_to)");
         }
         else
         {
            GXv_int10[50] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV134Wcboletosds_42_tfboletossacadonome_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV133Wcboletosds_41_tfboletossacadonome)) ) )
         {
            AddWhere(sWhereString, "(BoletosSacadoNome like :lV133Wcboletosds_41_tfboletossacadonome)");
         }
         else
         {
            GXv_int10[51] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV134Wcboletosds_42_tfboletossacadonome_sel)) && ! ( StringUtil.StrCmp(AV134Wcboletosds_42_tfboletossacadonome_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(BoletosSacadoNome = ( :AV134Wcboletosds_42_tfboletossacadonome_sel))");
         }
         else
         {
            GXv_int10[52] = 1;
         }
         if ( StringUtil.StrCmp(AV134Wcboletosds_42_tfboletossacadonome_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "(BoletosSacadoNome IS NULL or (char_length(trim(trailing ' ' from BoletosSacadoNome))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV136Wcboletosds_44_tfboletossacadodocumento_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV135Wcboletosds_43_tfboletossacadodocumento)) ) )
         {
            AddWhere(sWhereString, "(BoletosSacadoDocumento like :lV135Wcboletosds_43_tfboletossacadodocumento)");
         }
         else
         {
            GXv_int10[53] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV136Wcboletosds_44_tfboletossacadodocumento_sel)) && ! ( StringUtil.StrCmp(AV136Wcboletosds_44_tfboletossacadodocumento_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(BoletosSacadoDocumento = ( :AV136Wcboletosds_44_tfboletossacadodocumento_sel))");
         }
         else
         {
            GXv_int10[54] = 1;
         }
         if ( StringUtil.StrCmp(AV136Wcboletosds_44_tfboletossacadodocumento_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "(BoletosSacadoDocumento IS NULL or (char_length(trim(trailing ' ' from BoletosSacadoDocumento))=0))");
         }
         if ( AV137Wcboletosds_45_tfboletossacadotipodocumento_sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV137Wcboletosds_45_tfboletossacadotipodocumento_sels, "BoletosSacadoTipoDocumento IN (", ")")+")");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV93Wcboletosds_1_carteiradecobrancaid",GXType.Int32,9,0) ,
          new ParDef("lV94Wcboletosds_2_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV94Wcboletosds_2_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV94Wcboletosds_2_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV94Wcboletosds_2_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV94Wcboletosds_2_filterfulltext",GXType.VarChar,100,0) ,
          ...
          new ParDef("lV94Wcboletosds_2_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV94Wcboletosds_2_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV97Wcboletosds_5_boletosnossonumero1",GXType.VarChar,50,0) ,
          new ParDef("lV97Wcboletosds_5_boletosnossonumero1",GXType.VarChar,50,0) ,
          new ParDef("lV101Wcboletosds_9_boletosnossonumero2",GXType.VarChar,50,0) ,
          new ParDef("lV101Wcboletosds_9_boletosnossonumero2",GXType.VarChar,50,0) ,
          new ParDef("lV105Wcboletosds_13_boletosnossonumero3",GXType.VarChar,50,0) ,
          new ParDef("lV105Wcboletosds_13_boletosnossonumero3",GXType.VarChar,50,0) ,
          new ParDef("lV106Wcboletosds_14_tfboletosnossonumero",GXType.VarChar,50,0) ,
          new ParDef("AV107Wcboletosds_15_tfboletosnossonumero_sel",GXType.VarChar,50,0) ,
          new ParDef("lV108Wcboletosds_16_tfboletosseunumero",GXType.VarChar,50,0) ,
          new ParDef("AV109Wcboletosds_17_tfboletosseunumero_sel",GXType.VarChar,50,0) ,
          new ParDef("lV110Wcboletosds_18_tfboletosnumero",GXType.VarChar,50,0) ,
          new ParDef("AV111Wcboletosds_19_tfboletosnumero_sel",GXType.VarChar,50,0) ,
          new ParDef("AV113Wcboletosds_21_tfboletosdataemissao",GXType.Date,8,0) ,
          new ParDef("AV114Wcboletosds_22_tfboletosdataemissao_to",GXType.Date,8,0) ,
          new ParDef("AV115Wcboletosds_23_tfboletosdatavencimento",GXType.Date,8,0) ,
          new ParDef("AV116Wcboletosds_24_tfboletosdatavencimento_to",GXType.Date,8,0) ,
          new ParDef("AV117Wcboletosds_25_tfboletosdataregistro",GXType.DateTime,8,5) ,
          new ParDef("AV118Wcboletosds_26_tfboletosdataregistro_to",GXType.DateTime,8,5) ,
          new ParDef("AV119Wcboletosds_27_tfboletosdatapagamento",GXType.Date,8,0) ,
          new ParDef("AV120Wcboletosds_28_tfboletosdatapagamento_to",GXType.Date,8,0) ,
          new ParDef("AV121Wcboletosds_29_tfboletosdatabaixa",GXType.Date,8,0) ,
          new ParDef("AV122Wcboletosds_30_tfboletosdatabaixa_to",GXType.Date,8,0) ,
          new ParDef("AV123Wcboletosds_31_tfboletosvalornominal",GXType.Number,18,2) ,
          new ParDef("AV124Wcboletosds_32_tfboletosvalornominal_to",GXType.Number,18,2) ,
          new ParDef("AV125Wcboletosds_33_tfboletosvalorpago",GXType.Number,18,2) ,
          new ParDef("AV126Wcboletosds_34_tfboletosvalorpago_to",GXType.Number,18,2) ,
          new ParDef("AV127Wcboletosds_35_tfboletosvalordesconto",GXType.Number,18,2) ,
          new ParDef("AV128Wcboletosds_36_tfboletosvalordesconto_to",GXType.Number,18,2) ,
          new ParDef("AV129Wcboletosds_37_tfboletosvalorjuros",GXType.Number,18,2) ,
          new ParDef("AV130Wcboletosds_38_tfboletosvalorjuros_to",GXType.Number,18,2) ,
          new ParDef("AV131Wcboletosds_39_tfboletosvalormulta",GXType.Number,18,2) ,
          new ParDef("AV132Wcboletosds_40_tfboletosvalormulta_to",GXType.Number,18,2) ,
          new ParDef("lV133Wcboletosds_41_tfboletossacadonome",GXType.VarChar,100,0) ,
          new ParDef("AV134Wcboletosds_42_tfboletossacadonome_sel",GXType.VarChar,100,0) ,
          new ParDef("lV135Wcboletosds_43_tfboletossacadodocumento",GXType.VarChar,20,0) ,
          new ParDef("AV136Wcboletosds_44_tfboletossacadodocumento_sel",GXType.VarChar,20,0) ,
