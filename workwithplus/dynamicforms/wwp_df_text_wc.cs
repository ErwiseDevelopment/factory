   ...
   public class wwp_df_text_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_text_wc"+UrlEncode(StringUtil.RTrim(AV27WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV29WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV34WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_text_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vERRORIDS", AV37ErrorIds);
      ...
      protected void WB1E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_text_wc");
            }
            ...
            GxWebStd.gx_label_element( context, edtavData_Internalname, edtavData_Caption, "col-sm-3 AttributeFLLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 14,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavData_Internalname, AV8Data, StringUtil.RTrim( context.localUtil.Format( AV8Data, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtavData_Link, edtavData_Linktarget, "", "", edtavData_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavData_Enabled, 1, "text", "", 80, "chr", 1, "row", 150, edtavData_Ispassword, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WorkWithPlus/DynamicForms/WWP_DF_Text_WC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnfixcontrolvaluechanged_Internalname, "", "Atualizar", bttBtnfixcontrolvaluechanged_Jsonclick, 5, "Atualizar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOFIXCONTROLVALUECHANGED\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WorkWithPlus/DynamicForms/WWP_DF_Text_WC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_text_wc")), "workwithplus.dynamicforms.wwp_df_text_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_text_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E111E2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV13HasReferenceId, context));
         AV38GXV1 = 1;
         while ( AV38GXV1 <= AV32WWPFormInstance.gxTpr_Element.Count )
         {
            AV33WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV32WWPFormInstance.gxTpr_Element.Item(AV38GXV1));
      ...
      protected void E131E2( )
      {
         ...
         returnInSub = false;
         if ( ( AV6AuxSessionId == AV21SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV37ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV29WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV34WWPFormInstanceElementId), 4, 0))+"|") )
         {
      ...
      protected void S152( )
      {
         ...
         AV39GXV2 = 1;
         while ( AV39GXV2 <= AV32WWPFormInstance.gxTpr_Element.Count )
         {
            AV33WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV32WWPFormInstance.gxTpr_Element.Item(AV39GXV2));
            if ( ( AV33WWPFormInstanceElement.gxTpr_Wwpformelementid == AV29WWPFormElementId ) && ( AV33WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV34WWPFormInstanceElementId ) )
            {
      ...
      protected void S162( )
      {
         ...
         if ( new WorkWithPlus.workwithplus_dynamicforms.wwp_df_validatetextvalue(context).executeUdp(  AV28WWPFormElementDataType,  AV8Data, out  AV35ErrorMessage) )
         {
            ...
            {
               GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV31WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV11ElementInternalName,  "true",  ""));
               AV17IsValid = false;
            }
            else
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255191838222", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_text_wc.js", "?20255191838222", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV13HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV35ErrorMessage","fld":"vERRORMESSAGE","hsh":true,"type":"svchar"},{"av":"AV28WWPFormElementDataType","fld":"vWWPFORMELEMENTDATATYPE","pic":"Z9","hsh":true,"type":"int"},{"av":"AV31WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"}]}""");
         setEventMetadata("'DOFIXCONTROLVALUECHANGED'","""{"handler":"E121E2","iparms":[{"av":"AV36DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"AV8Data","fld":"vDATA","type":"svchar"},{"av":"AV13HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV32WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV29WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV34WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV35ErrorMessage","fld":"vERRORMESSAGE","hsh":true,"type":"svchar"},{"av":"AV28WWPFormElementDataType","fld":"vWWPFORMELEMENTDATATYPE","pic":"Z9","hsh":true,"type":"int"},{"av":"AV31WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV33WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("'DOFIXCONTROLVALUECHANGED'",""","oparms":[{"av":"AV36DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV33WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV32WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E131E2","iparms":[{"av":"AV37ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV29WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV34WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV32WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV8Data","fld":"vDATA","type":"svchar"},{"av":"AV35ErrorMessage","fld":"vERRORMESSAGE","hsh":true,"type":"svchar"},{"av":"AV28WWPFormElementDataType","fld":"vWWPFORMELEMENTDATATYPE","pic":"Z9","hsh":true,"type":"int"},{"av":"AV31WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV33WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV33WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV32WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E141E2","iparms":[{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV24VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV34WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV32WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV32WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV24VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED","""{"handler":"E151E2","iparms":[{"av":"AV8Data","fld":"vDATA","type":"svchar"},{"av":"AV13HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV21SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV32WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV29WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV34WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV26WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV35ErrorMessage","fld":"vERRORMESSAGE","hsh":true,"type":"svchar"},{"av":"AV28WWPFormElementDataType","fld":"vWWPFORMELEMENTDATATYPE","pic":"Z9","hsh":true,"type":"int"},{"av":"AV31WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV33WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("VDATA.CONTROLVALUECHANGED",""","oparms":[{"av":"AV36DataControlValueChanged","fld":"vDATACONTROLVALUECHANGED","type":"svchar"},{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV33WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV32WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV23Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory2");
         AV22ThisValueStr = "";
