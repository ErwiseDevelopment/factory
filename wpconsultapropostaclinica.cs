...
namespace GeneXus.Programs {
   public class wpconsultapropostaclinica : GXDataArea
   {
      public wpconsultapropostaclinica( )
      {
      ...
      public wpconsultapropostaclinica( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wpconsultapropostaclinica"+UrlEncode(StringUtil.LTrimStr(AV5PropostaId,9,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpconsultapropostaclinica") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "wpconsultapropostaclinica"+UrlEncode(StringUtil.LTrimStr(AV5PropostaId,9,0));
         return formatLink("wpconsultapropostaclinica") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "WpConsultaPropostaClinica" ;
      }

      public override string GetPgmdesc( )
      {
         return "Consultra da proposta" ;
      }
      ...
      protected void WB8G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTab1_title_Internalname, "Proposta", "", "", lblTab1_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WpConsultaPropostaClinica.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup3_Internalname, "Clinica", 1, 0, "px", 0, "px", "Group", "", "HLP_WpConsultaPropostaClinica.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblConsultarclinica_Internalname, "<i class=\"fas fa-magnifying-glass\"></i>", "", "", lblConsultarclinica_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCONSULTARCLINICA\\'."+"'", "", "TextBlock", 5, "", 1, 1, 0, 1, "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClinicacontatoemail_Internalname, AV57ClinicaContatoEmail, StringUtil.RTrim( context.localUtil.Format( AV57ClinicaContatoEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,41);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClinicacontatoemail_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClinicacontatoemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup4_Internalname, "Paciente", 1, 0, "px", 0, "px", "Group", "", "HLP_WpConsultaPropostaClinica.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblConsultarcliente_Internalname, "<i class=\"fas fa-magnifying-glass\"></i>", "", "", lblConsultarcliente_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCONSULTARCLIENTE\\'."+"'", "", "TextBlock", 5, "", 1, 1, 0, 1, "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClienterazaosocial_Internalname, AV26ClienteRazaoSocial, StringUtil.RTrim( context.localUtil.Format( AV26ClienteRazaoSocial, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClienterazaosocial_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClienterazaosocial_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavContatoemail_Internalname, AV28ContatoEmail, StringUtil.RTrim( context.localUtil.Format( AV28ContatoEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,62);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContatoemail_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContatoemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup8_Internalname, "Responsável", 1, 0, "px", 0, "px", "Group", "", "HLP_WpConsultaPropostaClinica.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblConsultarresponsavel_Internalname, "<i class=\"fas fa-magnifying-glass\"></i>", "", "", lblConsultarresponsavel_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCONSULTARRESPONSAVEL\\'."+"'", "", "TextBlock", 5, "", 1, 1, 0, 1, "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavResponsavelclienterazaosocial_Internalname, AV23ResponsavelClienteRazaoSocial, StringUtil.RTrim( context.localUtil.Format( AV23ResponsavelClienteRazaoSocial, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,77);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResponsavelclienterazaosocial_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavResponsavelclienterazaosocial_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup5_Internalname, "Conta / PIX", 1, 0, "px", 0, "px", "Group", "", "HLP_WpConsultaPropostaClinica.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBanconome_Internalname, AV42BancoNome, StringUtil.RTrim( context.localUtil.Format( AV42BancoNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,97);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBanconome_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavBanconome_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavContaagencia_Internalname, AV21ContaAgencia, StringUtil.RTrim( context.localUtil.Format( AV21ContaAgencia, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,101);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContaagencia_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContaagencia_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavClientepixtipo, cmbavClientepixtipo_Internalname, StringUtil.RTrim( AV18ClientePixTipo), 1, cmbavClientepixtipo_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavClientepixtipo.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,113);\"", "", true, 0, "HLP_WpConsultaPropostaClinica.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClientepix_Internalname, AV19ClientePix, StringUtil.RTrim( context.localUtil.Format( AV19ClientePix, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,117);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClientepix_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClientepix_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup6_Internalname, "Proposta", 1, 0, "px", 0, "px", "Group", "", "HLP_WpConsultaPropostaClinica.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavPropostadescricao_Internalname, AV13PropostaDescricao, StringUtil.RTrim( context.localUtil.Format( AV13PropostaDescricao, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,135);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPropostadescricao_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavPropostadescricao_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavConveniodescricao_Internalname, AV44ConvenioDescricao, StringUtil.RTrim( context.localUtil.Format( AV44ConvenioDescricao, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,139);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConveniodescricao_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavConveniodescricao_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockconveniovencimentoano_Internalname, "Ano vencimento carteira", "", "", lblTextblockconveniovencimentoano_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            wb_table1_151_8G2( true) ;
         }
         else
         {
            wb_table1_151_8G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_151_8G2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup7_Internalname, "Documentos", 1, 0, "px", 0, "px", "Group", "", "HLP_WpConsultaPropostaClinica.htm");
            /* Div Control */
         ...
         if ( wbEnd == 166 )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTab2_title_Internalname, "Títulos", "", "", lblTab2_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WpConsultaPropostaClinica.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(166), 3, 0)+","+"null"+");", "Fechar", bttBtncancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpConsultaPropostaClinica.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START8G2( )
      {
         ...
         Form.Meta.addItem("description", "Consultra da proposta", 0) ;
         context.wjLoc = "";
      ...
      protected void PA8G2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpconsultapropostaclinica")), "wpconsultapropostaclinica") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpconsultapropostaclinica")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E148G2( )
      {
         ...
         {
            A227ContratoId = H008G2_A227ContratoId[0];
            n227ContratoId = H008G2_n227ContratoId[0];
            A473ContratoClienteId = H008G2_A473ContratoClienteId[0];
            n473ContratoClienteId = H008G2_n473ContratoClienteId[0];
            A376ProcedimentosMedicosId = H008G2_A376ProcedimentosMedicosId[0];
            n376ProcedimentosMedicosId = H008G2_n376ProcedimentosMedicosId[0];
            A410ConvenioId = H008G2_A410ConvenioId[0];
            n410ConvenioId = H008G2_n410ConvenioId[0];
            A402BancoId = H008G2_A402BancoId[0];
            n402BancoId = H008G2_n402BancoId[0];
            A403BancoNome = H008G2_A403BancoNome[0];
            n403BancoNome = H008G2_n403BancoNome[0];
            A323PropostaId = H008G2_A323PropostaId[0];
            n323PropostaId = H008G2_n323PropostaId[0];
            A652PropostaClinicaDocumento = H008G2_A652PropostaClinicaDocumento[0];
            n652PropostaClinicaDocumento = H008G2_n652PropostaClinicaDocumento[0];
            A643PropostaClinicaNome = H008G2_A643PropostaClinicaNome[0];
            n643PropostaClinicaNome = H008G2_n643PropostaClinicaNome[0];
            A653PropostaClinicaEmail = H008G2_A653PropostaClinicaEmail[0];
            n653PropostaClinicaEmail = H008G2_n653PropostaClinicaEmail[0];
            A642PropostaClinicaId = H008G2_A642PropostaClinicaId[0];
            n642PropostaClinicaId = H008G2_n642PropostaClinicaId[0];
            A553PropostaResponsavelId = H008G2_A553PropostaResponsavelId[0];
            n553PropostaResponsavelId = H008G2_n553PropostaResponsavelId[0];
            A504PropostaPacienteClienteId = H008G2_A504PropostaPacienteClienteId[0];
            n504PropostaPacienteClienteId = H008G2_n504PropostaPacienteClienteId[0];
            A590PropostaResponsavelConta = H008G2_A590PropostaResponsavelConta[0];
            n590PropostaResponsavelConta = H008G2_n590PropostaResponsavelConta[0];
            A591PropostaResponsavelAgencia = H008G2_A591PropostaResponsavelAgencia[0];
            n591PropostaResponsavelAgencia = H008G2_n591PropostaResponsavelAgencia[0];
            A592PropostaResponsavelTipoPix = H008G2_A592PropostaResponsavelTipoPix[0];
            n592PropostaResponsavelTipoPix = H008G2_n592PropostaResponsavelTipoPix[0];
            A593PropostaResponsavelPIX = H008G2_A593PropostaResponsavelPIX[0];
            n593PropostaResponsavelPIX = H008G2_n593PropostaResponsavelPIX[0];
            A594PropostaResponsavelDepositoTipo = H008G2_A594PropostaResponsavelDepositoTipo[0];
            n594PropostaResponsavelDepositoTipo = H008G2_n594PropostaResponsavelDepositoTipo[0];
            A584PropostaPacienteConta = H008G2_A584PropostaPacienteConta[0];
            n584PropostaPacienteConta = H008G2_n584PropostaPacienteConta[0];
            A585PropostaPacienteAgencia = H008G2_A585PropostaPacienteAgencia[0];
            n585PropostaPacienteAgencia = H008G2_n585PropostaPacienteAgencia[0];
            A586PropostaPacienteTipoPix = H008G2_A586PropostaPacienteTipoPix[0];
            n586PropostaPacienteTipoPix = H008G2_n586PropostaPacienteTipoPix[0];
            A587PropostaPacientePIX = H008G2_A587PropostaPacientePIX[0];
            n587PropostaPacientePIX = H008G2_n587PropostaPacientePIX[0];
            A588PropostaPacienteDepositoTipo = H008G2_A588PropostaPacienteDepositoTipo[0];
            n588PropostaPacienteDepositoTipo = H008G2_n588PropostaPacienteDepositoTipo[0];
            A505PropostaPacienteClienteRazaoSocial = H008G2_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = H008G2_n505PropostaPacienteClienteRazaoSocial[0];
            A540PropostaPacienteClienteDocumento = H008G2_A540PropostaPacienteClienteDocumento[0];
            n540PropostaPacienteClienteDocumento = H008G2_n540PropostaPacienteClienteDocumento[0];
            A541PropostaPacienteContatoEmail = H008G2_A541PropostaPacienteContatoEmail[0];
            n541PropostaPacienteContatoEmail = H008G2_n541PropostaPacienteContatoEmail[0];
            A580PropostaResponsavelDocumento = H008G2_A580PropostaResponsavelDocumento[0];
            n580PropostaResponsavelDocumento = H008G2_n580PropostaResponsavelDocumento[0];
            A581PropostaResponsavelRazaoSocial = H008G2_A581PropostaResponsavelRazaoSocial[0];
            n581PropostaResponsavelRazaoSocial = H008G2_n581PropostaResponsavelRazaoSocial[0];
            A582PropostaResponsavelEmail = H008G2_A582PropostaResponsavelEmail[0];
            n582PropostaResponsavelEmail = H008G2_n582PropostaResponsavelEmail[0];
            A378ProcedimentosMedicosDescricao = H008G2_A378ProcedimentosMedicosDescricao[0];
            n378ProcedimentosMedicosDescricao = H008G2_n378ProcedimentosMedicosDescricao[0];
            A326PropostaValor = H008G2_A326PropostaValor[0];
            n326PropostaValor = H008G2_n326PropostaValor[0];
            A325PropostaDescricao = H008G2_A325PropostaDescricao[0];
            n325PropostaDescricao = H008G2_n325PropostaDescricao[0];
            A494ConvenioCategoriaDescricao = H008G2_A494ConvenioCategoriaDescricao[0];
            n494ConvenioCategoriaDescricao = H008G2_n494ConvenioCategoriaDescricao[0];
            A493ConvenioCategoriaId = H008G2_A493ConvenioCategoriaId[0];
            n493ConvenioCategoriaId = H008G2_n493ConvenioCategoriaId[0];
            A411ConvenioDescricao = H008G2_A411ConvenioDescricao[0];
            n411ConvenioDescricao = H008G2_n411ConvenioDescricao[0];
            A496ConvenioVencimentoAno = H008G2_A496ConvenioVencimentoAno[0];
            n496ConvenioVencimentoAno = H008G2_n496ConvenioVencimentoAno[0];
            A497ConvenioVencimentoMes = H008G2_A497ConvenioVencimentoMes[0];
            n497ConvenioVencimentoMes = H008G2_n497ConvenioVencimentoMes[0];
            A473ContratoClienteId = H008G2_A473ContratoClienteId[0];
            n473ContratoClienteId = H008G2_n473ContratoClienteId[0];
            A402BancoId = H008G2_A402BancoId[0];
            n402BancoId = H008G2_n402BancoId[0];
            ...
            GxWebStd.gx_hidden_field( context, "gxhash_vPROPOSTACLINICAID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV58PropostaClinicaId), "ZZZZZZZZ9"), context));
            if ( ( A504PropostaPacienteClienteId == A553PropostaResponsavelId ) || H008G2_n553PropostaResponsavelId[0] || (0==A553PropostaResponsavelId) )
            {
      ...
      private void E168G2( )
      {
         ...
         {
            A323PropostaId = H008G3_A323PropostaId[0];
            n323PropostaId = H008G3_n323PropostaId[0];
            A406DocumentosDescricao = H008G3_A406DocumentosDescricao[0];
            n406DocumentosDescricao = H008G3_n406DocumentosDescricao[0];
            A405DocumentosId = H008G3_A405DocumentosId[0];
            n405DocumentosId = H008G3_n405DocumentosId[0];
            A417PropostaDocumentosAnexoFileType = H008G3_A417PropostaDocumentosAnexoFileType[0];
            n417PropostaDocumentosAnexoFileType = H008G3_n417PropostaDocumentosAnexoFileType[0];
            A579PropostaDocumentosStatus = H008G3_A579PropostaDocumentosStatus[0];
            n579PropostaDocumentosStatus = H008G3_n579PropostaDocumentosStatus[0];
            A416PropostaDocumentosAnexoName = H008G3_A416PropostaDocumentosAnexoName[0];
            n416PropostaDocumentosAnexoName = H008G3_n416PropostaDocumentosAnexoName[0];
            A414PropostaDocumentosId = H008G3_A414PropostaDocumentosId[0];
            A415PropostaDocumentosAnexo = H008G3_A415PropostaDocumentosAnexo[0];
            n415PropostaDocumentosAnexo = H008G3_n415PropostaDocumentosAnexo[0];
            A406DocumentosDescricao = H008G3_A406DocumentosDescricao[0];
            n406DocumentosDescricao = H008G3_n406DocumentosDescricao[0];
      ...
      protected void wb_table1_151_8G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavConveniovencimentoano, cmbavConveniovencimentoano_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV16ConvenioVencimentoAno), 4, 0)), 1, cmbavConveniovencimentoano_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavConveniovencimentoano.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,155);\"", "", true, 0, "HLP_WpConsultaPropostaClinica.htm");
            cmbavConveniovencimentoano.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV16ConvenioVencimentoAno), 4, 0));
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavConveniovencimentomes, cmbavConveniovencimentomes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV17ConvenioVencimentoMes), 4, 0)), 1, cmbavConveniovencimentomes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavConveniovencimentomes.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,159);\"", "", true, 0, "HLP_WpConsultaPropostaClinica.htm");
            cmbavConveniovencimentomes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV17ConvenioVencimentoMes), 4, 0));
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_151_8G2e( true) ;
         }
         else
         {
            wb_table1_151_8G2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918585146", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpconsultapropostaclinica.js", "?202551918585147", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Consultra da proposta";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOCONSULTARRESPONSAVEL'","""{"handler":"E118G2","iparms":[{"av":"AV47PropostaResponsavelId","fld":"vPROPOSTARESPONSAVELID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("'DOCONSULTARCLIENTE'","""{"handler":"E128G2","iparms":[{"av":"AV46PropostaPacienteClienteId","fld":"vPROPOSTAPACIENTECLIENTEID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("'DOCONSULTARCLINICA'","""{"handler":"E138G2","iparms":[{"av":"AV58PropostaClinicaId","fld":"vPROPOSTACLINICAID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("VADICIONARANEXO.CLICK","""{"handler":"E178G2","iparms":[{"av":"AV54PropostaDocumentosId","fld":"vPROPOSTADOCUMENTOSID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         H008G2_A227ContratoId = new int[1] ;
         H008G2_n227ContratoId = new bool[] {false} ;
         H008G2_A473ContratoClienteId = new int[1] ;
         H008G2_n473ContratoClienteId = new bool[] {false} ;
         H008G2_A376ProcedimentosMedicosId = new int[1] ;
         H008G2_n376ProcedimentosMedicosId = new bool[] {false} ;
         H008G2_A410ConvenioId = new int[1] ;
         H008G2_n410ConvenioId = new bool[] {false} ;
         H008G2_A402BancoId = new int[1] ;
         H008G2_n402BancoId = new bool[] {false} ;
         H008G2_A403BancoNome = new string[] {""} ;
         H008G2_n403BancoNome = new bool[] {false} ;
         H008G2_A323PropostaId = new int[1] ;
         H008G2_n323PropostaId = new bool[] {false} ;
         H008G2_A652PropostaClinicaDocumento = new string[] {""} ;
         H008G2_n652PropostaClinicaDocumento = new bool[] {false} ;
         H008G2_A643PropostaClinicaNome = new string[] {""} ;
         H008G2_n643PropostaClinicaNome = new bool[] {false} ;
         H008G2_A653PropostaClinicaEmail = new string[] {""} ;
         H008G2_n653PropostaClinicaEmail = new bool[] {false} ;
         H008G2_A642PropostaClinicaId = new int[1] ;
         H008G2_n642PropostaClinicaId = new bool[] {false} ;
         H008G2_A553PropostaResponsavelId = new int[1] ;
         H008G2_n553PropostaResponsavelId = new bool[] {false} ;
         H008G2_A504PropostaPacienteClienteId = new int[1] ;
         H008G2_n504PropostaPacienteClienteId = new bool[] {false} ;
         H008G2_A590PropostaResponsavelConta = new string[] {""} ;
         H008G2_n590PropostaResponsavelConta = new bool[] {false} ;
         H008G2_A591PropostaResponsavelAgencia = new string[] {""} ;
         H008G2_n591PropostaResponsavelAgencia = new bool[] {false} ;
         H008G2_A592PropostaResponsavelTipoPix = new string[] {""} ;
         H008G2_n592PropostaResponsavelTipoPix = new bool[] {false} ;
         H008G2_A593PropostaResponsavelPIX = new string[] {""} ;
         H008G2_n593PropostaResponsavelPIX = new bool[] {false} ;
         H008G2_A594PropostaResponsavelDepositoTipo = new string[] {""} ;
         H008G2_n594PropostaResponsavelDepositoTipo = new bool[] {false} ;
         H008G2_A584PropostaPacienteConta = new string[] {""} ;
         H008G2_n584PropostaPacienteConta = new bool[] {false} ;
         H008G2_A585PropostaPacienteAgencia = new string[] {""} ;
         H008G2_n585PropostaPacienteAgencia = new bool[] {false} ;
         H008G2_A586PropostaPacienteTipoPix = new string[] {""} ;
         H008G2_n586PropostaPacienteTipoPix = new bool[] {false} ;
         H008G2_A587PropostaPacientePIX = new string[] {""} ;
         H008G2_n587PropostaPacientePIX = new bool[] {false} ;
         H008G2_A588PropostaPacienteDepositoTipo = new string[] {""} ;
         H008G2_n588PropostaPacienteDepositoTipo = new bool[] {false} ;
         H008G2_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         H008G2_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         H008G2_A540PropostaPacienteClienteDocumento = new string[] {""} ;
         H008G2_n540PropostaPacienteClienteDocumento = new bool[] {false} ;
         H008G2_A541PropostaPacienteContatoEmail = new string[] {""} ;
         H008G2_n541PropostaPacienteContatoEmail = new bool[] {false} ;
         H008G2_A580PropostaResponsavelDocumento = new string[] {""} ;
         H008G2_n580PropostaResponsavelDocumento = new bool[] {false} ;
         H008G2_A581PropostaResponsavelRazaoSocial = new string[] {""} ;
         H008G2_n581PropostaResponsavelRazaoSocial = new bool[] {false} ;
         H008G2_A582PropostaResponsavelEmail = new string[] {""} ;
         H008G2_n582PropostaResponsavelEmail = new bool[] {false} ;
         H008G2_A378ProcedimentosMedicosDescricao = new string[] {""} ;
         H008G2_n378ProcedimentosMedicosDescricao = new bool[] {false} ;
         H008G2_A326PropostaValor = new decimal[1] ;
         H008G2_n326PropostaValor = new bool[] {false} ;
         H008G2_A325PropostaDescricao = new string[] {""} ;
         H008G2_n325PropostaDescricao = new bool[] {false} ;
         H008G2_A494ConvenioCategoriaDescricao = new string[] {""} ;
         H008G2_n494ConvenioCategoriaDescricao = new bool[] {false} ;
         H008G2_A493ConvenioCategoriaId = new int[1] ;
         H008G2_n493ConvenioCategoriaId = new bool[] {false} ;
         H008G2_A411ConvenioDescricao = new string[] {""} ;
         H008G2_n411ConvenioDescricao = new bool[] {false} ;
         H008G2_A496ConvenioVencimentoAno = new short[1] ;
         H008G2_n496ConvenioVencimentoAno = new bool[] {false} ;
         H008G2_A497ConvenioVencimentoMes = new short[1] ;
         H008G2_n497ConvenioVencimentoMes = new bool[] {false} ;
         A403BancoNome = "";
         ...
         H008G3_A323PropostaId = new int[1] ;
         H008G3_n323PropostaId = new bool[] {false} ;
         H008G3_A406DocumentosDescricao = new string[] {""} ;
         H008G3_n406DocumentosDescricao = new bool[] {false} ;
         H008G3_A405DocumentosId = new int[1] ;
         H008G3_n405DocumentosId = new bool[] {false} ;
         H008G3_A417PropostaDocumentosAnexoFileType = new string[] {""} ;
         H008G3_n417PropostaDocumentosAnexoFileType = new bool[] {false} ;
         H008G3_A579PropostaDocumentosStatus = new string[] {""} ;
         H008G3_n579PropostaDocumentosStatus = new bool[] {false} ;
         H008G3_A416PropostaDocumentosAnexoName = new string[] {""} ;
         H008G3_n416PropostaDocumentosAnexoName = new bool[] {false} ;
         H008G3_A414PropostaDocumentosId = new int[1] ;
         H008G3_A415PropostaDocumentosAnexo = new string[] {""} ;
         H008G3_n415PropostaDocumentosAnexo = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpconsultapropostaclinica__default(),
            new Object[][] {
                new Object[] {
               H008G2_A227ContratoId, H008G2_n227ContratoId, H008G2_A473ContratoClienteId, H008G2_n473ContratoClienteId, H008G2_A376ProcedimentosMedicosId, H008G2_n376ProcedimentosMedicosId, H008G2_A410ConvenioId, H008G2_n410ConvenioId, H008G2_A402BancoId, H008G2_n402BancoId,
               H008G2_A403BancoNome, H008G2_n403BancoNome, H008G2_A323PropostaId, H008G2_A652PropostaClinicaDocumento, H008G2_n652PropostaClinicaDocumento, H008G2_A643PropostaClinicaNome, H008G2_n643PropostaClinicaNome, H008G2_A653PropostaClinicaEmail, H008G2_n653PropostaClinicaEmail, H008G2_A642PropostaClinicaId,
               H008G2_n642PropostaClinicaId, H008G2_A553PropostaResponsavelId, H008G2_n553PropostaResponsavelId, H008G2_A504PropostaPacienteClienteId, H008G2_n504PropostaPacienteClienteId, H008G2_A590PropostaResponsavelConta, H008G2_n590PropostaResponsavelConta, H008G2_A591PropostaResponsavelAgencia, H008G2_n591PropostaResponsavelAgencia, H008G2_A592PropostaResponsavelTipoPix,
               H008G2_n592PropostaResponsavelTipoPix, H008G2_A593PropostaResponsavelPIX, H008G2_n593PropostaResponsavelPIX, H008G2_A594PropostaResponsavelDepositoTipo, H008G2_n594PropostaResponsavelDepositoTipo, H008G2_A584PropostaPacienteConta, H008G2_n584PropostaPacienteConta, H008G2_A585PropostaPacienteAgencia, H008G2_n585PropostaPacienteAgencia, H008G2_A586PropostaPacienteTipoPix,
               H008G2_n586PropostaPacienteTipoPix, H008G2_A587PropostaPacientePIX, H008G2_n587PropostaPacientePIX, H008G2_A588PropostaPacienteDepositoTipo, H008G2_n588PropostaPacienteDepositoTipo, H008G2_A505PropostaPacienteClienteRazaoSocial, H008G2_n505PropostaPacienteClienteRazaoSocial, H008G2_A540PropostaPacienteClienteDocumento, H008G2_n540PropostaPacienteClienteDocumento, H008G2_A541PropostaPacienteContatoEmail,
               H008G2_n541PropostaPacienteContatoEmail, H008G2_A580PropostaResponsavelDocumento, H008G2_n580PropostaResponsavelDocumento, H008G2_A581PropostaResponsavelRazaoSocial, H008G2_n581PropostaResponsavelRazaoSocial, H008G2_A582PropostaResponsavelEmail, H008G2_n582PropostaResponsavelEmail, H008G2_A378ProcedimentosMedicosDescricao, H008G2_n378ProcedimentosMedicosDescricao, H008G2_A326PropostaValor,
               H008G2_n326PropostaValor, H008G2_A325PropostaDescricao, H008G2_n325PropostaDescricao, H008G2_A494ConvenioCategoriaDescricao, H008G2_n494ConvenioCategoriaDescricao, H008G2_A493ConvenioCategoriaId, H008G2_n493ConvenioCategoriaId, H008G2_A411ConvenioDescricao, H008G2_n411ConvenioDescricao, H008G2_A496ConvenioVencimentoAno,
               H008G2_n496ConvenioVencimentoAno, H008G2_A497ConvenioVencimentoMes, H008G2_n497ConvenioVencimentoMes
               }
               , new Object[] {
               H008G3_A323PropostaId, H008G3_n323PropostaId, H008G3_A406DocumentosDescricao, H008G3_n406DocumentosDescricao, H008G3_A405DocumentosId, H008G3_n405DocumentosId, H008G3_A417PropostaDocumentosAnexoFileType, H008G3_n417PropostaDocumentosAnexoFileType, H008G3_A579PropostaDocumentosStatus, H008G3_n579PropostaDocumentosStatus,
               H008G3_A416PropostaDocumentosAnexoName, H008G3_n416PropostaDocumentosAnexoName, H008G3_A414PropostaDocumentosId, H008G3_A415PropostaDocumentosAnexo, H008G3_n415PropostaDocumentosAnexo
               }
            }
         );
      ...
      private int[] H008G2_A227ContratoId ;
      private bool[] H008G2_n227ContratoId ;
      private int[] H008G2_A473ContratoClienteId ;
      private bool[] H008G2_n473ContratoClienteId ;
      private int[] H008G2_A376ProcedimentosMedicosId ;
      private bool[] H008G2_n376ProcedimentosMedicosId ;
      private int[] H008G2_A410ConvenioId ;
      private bool[] H008G2_n410ConvenioId ;
      private int[] H008G2_A402BancoId ;
      private bool[] H008G2_n402BancoId ;
      private string[] H008G2_A403BancoNome ;
      private bool[] H008G2_n403BancoNome ;
      private int[] H008G2_A323PropostaId ;
      private bool[] H008G2_n323PropostaId ;
      private string[] H008G2_A652PropostaClinicaDocumento ;
      private bool[] H008G2_n652PropostaClinicaDocumento ;
      private string[] H008G2_A643PropostaClinicaNome ;
      private bool[] H008G2_n643PropostaClinicaNome ;
      private string[] H008G2_A653PropostaClinicaEmail ;
      private bool[] H008G2_n653PropostaClinicaEmail ;
      private int[] H008G2_A642PropostaClinicaId ;
      private bool[] H008G2_n642PropostaClinicaId ;
      private int[] H008G2_A553PropostaResponsavelId ;
      private bool[] H008G2_n553PropostaResponsavelId ;
      private int[] H008G2_A504PropostaPacienteClienteId ;
      private bool[] H008G2_n504PropostaPacienteClienteId ;
      private string[] H008G2_A590PropostaResponsavelConta ;
      private bool[] H008G2_n590PropostaResponsavelConta ;
      private string[] H008G2_A591PropostaResponsavelAgencia ;
      private bool[] H008G2_n591PropostaResponsavelAgencia ;
      private string[] H008G2_A592PropostaResponsavelTipoPix ;
      private bool[] H008G2_n592PropostaResponsavelTipoPix ;
      private string[] H008G2_A593PropostaResponsavelPIX ;
      private bool[] H008G2_n593PropostaResponsavelPIX ;
      private string[] H008G2_A594PropostaResponsavelDepositoTipo ;
      private bool[] H008G2_n594PropostaResponsavelDepositoTipo ;
      private string[] H008G2_A584PropostaPacienteConta ;
      private bool[] H008G2_n584PropostaPacienteConta ;
      private string[] H008G2_A585PropostaPacienteAgencia ;
      private bool[] H008G2_n585PropostaPacienteAgencia ;
      private string[] H008G2_A586PropostaPacienteTipoPix ;
      private bool[] H008G2_n586PropostaPacienteTipoPix ;
      private string[] H008G2_A587PropostaPacientePIX ;
      private bool[] H008G2_n587PropostaPacientePIX ;
      private string[] H008G2_A588PropostaPacienteDepositoTipo ;
      private bool[] H008G2_n588PropostaPacienteDepositoTipo ;
      private string[] H008G2_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] H008G2_n505PropostaPacienteClienteRazaoSocial ;
      private string[] H008G2_A540PropostaPacienteClienteDocumento ;
      private bool[] H008G2_n540PropostaPacienteClienteDocumento ;
      private string[] H008G2_A541PropostaPacienteContatoEmail ;
      private bool[] H008G2_n541PropostaPacienteContatoEmail ;
      private string[] H008G2_A580PropostaResponsavelDocumento ;
      private bool[] H008G2_n580PropostaResponsavelDocumento ;
      private string[] H008G2_A581PropostaResponsavelRazaoSocial ;
      private bool[] H008G2_n581PropostaResponsavelRazaoSocial ;
      private string[] H008G2_A582PropostaResponsavelEmail ;
      private bool[] H008G2_n582PropostaResponsavelEmail ;
      private string[] H008G2_A378ProcedimentosMedicosDescricao ;
      private bool[] H008G2_n378ProcedimentosMedicosDescricao ;
      private decimal[] H008G2_A326PropostaValor ;
      private bool[] H008G2_n326PropostaValor ;
      private string[] H008G2_A325PropostaDescricao ;
      private bool[] H008G2_n325PropostaDescricao ;
      private string[] H008G2_A494ConvenioCategoriaDescricao ;
      private bool[] H008G2_n494ConvenioCategoriaDescricao ;
      private int[] H008G2_A493ConvenioCategoriaId ;
      private bool[] H008G2_n493ConvenioCategoriaId ;
      private string[] H008G2_A411ConvenioDescricao ;
      private bool[] H008G2_n411ConvenioDescricao ;
      private short[] H008G2_A496ConvenioVencimentoAno ;
      private bool[] H008G2_n496ConvenioVencimentoAno ;
      private short[] H008G2_A497ConvenioVencimentoMes ;
      private bool[] H008G2_n497ConvenioVencimentoMes ;
      private int[] H008G3_A323PropostaId ;
      private bool[] H008G3_n323PropostaId ;
      private string[] H008G3_A406DocumentosDescricao ;
      private bool[] H008G3_n406DocumentosDescricao ;
      private int[] H008G3_A405DocumentosId ;
      private bool[] H008G3_n405DocumentosId ;
      private string[] H008G3_A417PropostaDocumentosAnexoFileType ;
      private bool[] H008G3_n417PropostaDocumentosAnexoFileType ;
      private string[] H008G3_A579PropostaDocumentosStatus ;
      private bool[] H008G3_n579PropostaDocumentosStatus ;
      private string[] H008G3_A416PropostaDocumentosAnexoName ;
      private bool[] H008G3_n416PropostaDocumentosAnexoName ;
      private int[] H008G3_A414PropostaDocumentosId ;
      private string[] H008G3_A415PropostaDocumentosAnexo ;
      private bool[] H008G3_n415PropostaDocumentosAnexo ;
      private SdtPropostaDocumentos AV53PropostaDocumentos ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wpconsultapropostaclinica__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H008G2", cmdBufferH008G2,false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008G2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H008G3", "SELECT T1.PropostaId, T2.DocumentosDescricao, T1.DocumentosId, T1.PropostaDocumentosAnexoFileType, T1.PropostaDocumentosStatus, T1.PropostaDocumentosAnexoName, T1.PropostaDocumentosId, T1.PropostaDocumentosAnexo FROM (PropostaDocumentos T1 LEFT JOIN Documentos T2 ON T2.DocumentosId = T1.DocumentosId) WHERE (T1.PropostaId = :AV5PropostaId) AND (Not (T1.PropostaDocumentosAnexo = '') and Not T1.PropostaDocumentosAnexo IS NULL) ORDER BY T1.PropostaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008G3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
