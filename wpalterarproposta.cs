...
namespace GeneXus.Programs {
   public class wpalterarproposta : GXDataArea
   {
      ...
      {
         nRC_GXsfl_169 = (int)(Math.Round(NumberUtil.Val( GetPar( "nRC_GXsfl_169"), "."), 18, MidpointRounding.ToEven));
         nGXsfl_169_idx = (int)(Math.Round(NumberUtil.Val( GetPar( "nGXsfl_169_idx"), "."), 18, MidpointRounding.ToEven));
         sGXsfl_169_idx = GetPar( "sGXsfl_169_idx");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
      ...
      protected void gxgrGriddocumentos_refresh_invoke( )
      {
         ...
         AV82ConfiguracoesCategoriaTitulo = (int)(Math.Round(NumberUtil.Val( GetPar( "ConfiguracoesCategoriaTitulo"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCONFIGURACOESCATEGORIATITULO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV82ConfiguracoesCategoriaTitulo), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCONFIGURACOESCATEGORIATITULO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV82ConfiguracoesCategoriaTitulo), "ZZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_169", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_169), 8, 0, ",", "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "CONTAPROPOSTA", A499ContaProposta);
         GxWebStd.gx_hidden_field( context, "CONTAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A422ContaId), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "PROPOSTAVALOR", StringUtil.LTrim( StringUtil.NToC( A326PropostaValor, 18, 2, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_GERAR_TITULO_Title", StringUtil.RTrim( Dvelop_confirmpanel_gerar_titulo_Title));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_GERAR_TITULO_Confirmationtext", StringUtil.RTrim( Dvelop_confirmpanel_gerar_titulo_Confirmationtext));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_GERAR_TITULO_Yesbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_gerar_titulo_Yesbuttoncaption));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_GERAR_TITULO_Nobuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_gerar_titulo_Nobuttoncaption));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_GERAR_TITULO_Cancelbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_gerar_titulo_Cancelbuttoncaption));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_GERAR_TITULO_Yesbuttonposition", StringUtil.RTrim( Dvelop_confirmpanel_gerar_titulo_Yesbuttonposition));
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_GERAR_TITULO_Confirmtype", StringUtil.RTrim( Dvelop_confirmpanel_gerar_titulo_Confirmtype));
         ...
         GxWebStd.gx_hidden_field( context, "DVELOP_CONFIRMPANEL_GERAR_TITULO_Result", StringUtil.RTrim( Dvelop_confirmpanel_gerar_titulo_Result));
      ...
      protected void WB7U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngerar_titulo_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(169), 3, 0)+","+"null"+");", "Gerar Titulo", bttBtngerar_titulo_Jsonclick, 7, "Gerar Titulo", "", StyleString, ClassString, bttBtngerar_titulo_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e137u1_client"+"'", TempTags, "", 2, "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 34,'',false,'" + sGXsfl_169_idx + "',0)\"";
            ClassString = "AttributeFL";
            StyleString = "";
            ClassString = "AttributeFL";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavPropostacomentarioanalise_Internalname, AV71PropostaComentarioAnalise, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", 0, edtavPropostacomentarioanalise_Visible, edtavPropostacomentarioanalise_Enabled, 0, 80, "chr", 4, "row", 0, StyleString, ClassString, "", "", "255", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(169), 3, 0)+","+"null"+");", "Confirmar", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(169), 3, 0)+","+"null"+");", "Fechar", bttBtncancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 52,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavClienterazaosocial_Internalname, AV26ClienteRazaoSocial, StringUtil.RTrim( context.localUtil.Format( AV26ClienteRazaoSocial, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,52);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClienterazaosocial_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClienterazaosocial_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 56,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavClientedocumento_Internalname, AV27ClienteDocumento, StringUtil.RTrim( context.localUtil.Format( AV27ClienteDocumento, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClientedocumento_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClientedocumento_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 61,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavContatoemail_Internalname, AV28ContatoEmail, StringUtil.RTrim( context.localUtil.Format( AV28ContatoEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,61);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContatoemail_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContatoemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            wb_table1_71_7U2( true) ;
         }
         else
         {
            wb_table1_71_7U2( false) ;
         }
         return  ;
      }

      protected void wb_table1_71_7U2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 88,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBanconome_Internalname, AV42BancoNome, StringUtil.RTrim( context.localUtil.Format( AV42BancoNome, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,88);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBanconome_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavBanconome_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 92,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavContaagencia_Internalname, AV21ContaAgencia, StringUtil.RTrim( context.localUtil.Format( AV21ContaAgencia, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,92);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContaagencia_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContaagencia_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 97,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavContanumero_Internalname, AV22ContaNumero, StringUtil.RTrim( context.localUtil.Format( AV22ContaNumero, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,97);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContanumero_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContanumero_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 104,'',false,'" + sGXsfl_169_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavClientepixtipo, cmbavClientepixtipo_Internalname, StringUtil.RTrim( AV18ClientePixTipo), 1, cmbavClientepixtipo_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavClientepixtipo.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,104);\"", "", true, 0, "HLP_WpAlterarProposta.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 108,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavClientepix_Internalname, AV19ClientePix, StringUtil.RTrim( context.localUtil.Format( AV19ClientePix, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,108);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClientepix_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClientepix_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 123,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPropostavalor_Internalname, StringUtil.LTrim( StringUtil.NToC( AV12PropostaValor, 18, 2, ",", "")), StringUtil.LTrim( context.localUtil.Format( AV12PropostaValor, "ZZZ,ZZZ,ZZZ,ZZ9.99")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,123);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPropostavalor_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavPropostavalor_Enabled, 1, "text", "", 18, "chr", 1, "row", 18, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 128,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPropostadescricao_Internalname, AV13PropostaDescricao, StringUtil.RTrim( context.localUtil.Format( AV13PropostaDescricao, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,128);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPropostadescricao_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavPropostadescricao_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            wb_table2_151_7U2( true) ;
         }
         else
         {
            wb_table2_151_7U2( false) ;
         }
         return  ;
      }

      protected void wb_table2_151_7U2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnnovodocumento_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(169), 3, 0)+","+"null"+");", "Novo documento", bttBtnnovodocumento_Jsonclick, 5, "Novo documento", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DONOVODOCUMENTO\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 169 )
         {
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0190"+"", StringUtil.RTrim( WebComp_Wcserasaww_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0190"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( bGXsfl_169_Refreshing )
               {
                  if ( StringUtil.Len( WebComp_Wcserasaww_Component) != 0 )
                  {
                     ...
                     {
                        context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0190"+"");
                     }
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 197,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavPropostaresponsavelid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV47PropostaResponsavelId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV47PropostaResponsavelId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,197);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPropostaresponsavelid_Jsonclick, 0, "Attribute", "", "", "", "", edtavPropostaresponsavelid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WpAlterarProposta.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 198,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavProcedimentosmedicosid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11ProcedimentosMedicosId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV11ProcedimentosMedicosId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,198);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProcedimentosmedicosid_Jsonclick, 0, "Attribute", "", "", "", "", edtavProcedimentosmedicosid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WpAlterarProposta.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 199,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavConvenioid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14ConvenioId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV14ConvenioId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,199);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConvenioid_Jsonclick, 0, "Attribute", "", "", "", "", edtavConvenioid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WpAlterarProposta.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 200,'',false,'" + sGXsfl_169_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavConveniocategoriaid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15ConvenioCategoriaId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV15ConvenioCategoriaId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,200);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConveniocategoriaid_Jsonclick, 0, "Attribute", "", "", "", "", edtavConveniocategoriaid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WpAlterarProposta.htm");
            wb_table3_201_7U2( true) ;
         }
         else
         {
            wb_table3_201_7U2( false) ;
         }
         return  ;
      }

      protected void wb_table3_201_7U2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 207,'',false,'" + sGXsfl_169_idx + "',0)\"";
            ClassString = "ConfirmComment";
            StyleString = "";
            ClassString = "ConfirmComment";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDvelop_confirmpanel_aprovar_proposta_comment_Internalname, AV69DVelop_ConfirmPanel_Aprovar_Proposta_Comment, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,207);\"", 0, 1, 1, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "Descrição da aprovação", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            wb_table4_208_7U2( true) ;
         }
         else
         {
            wb_table4_208_7U2( false) ;
         }
         return  ;
      }

      protected void wb_table4_208_7U2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 214,'',false,'" + sGXsfl_169_idx + "',0)\"";
            ClassString = "ConfirmComment";
            StyleString = "";
            ClassString = "ConfirmComment";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDvelop_confirmpanel_finalizar_analise_comment_Internalname, AV70DVelop_ConfirmPanel_Finalizar_analise_Comment, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,214);\"", 0, 1, 1, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "Digite o por que você tomou essa decisão", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_WpAlterarProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            wb_table5_215_7U2( true) ;
         }
         else
         {
            wb_table5_215_7U2( false) ;
         }
         return  ;
      }

      protected void wb_table5_215_7U2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table6_220_7U2( true) ;
         }
         else
         {
            wb_table6_220_7U2( false) ;
         }
         return  ;
      }

      protected void wb_table6_220_7U2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "DVELOP_CONFIRMPANEL_GERAR_TITULO.CLOSE") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              /* Execute user event: Dvelop_confirmpanel_gerar_titulo.Close */
                              E177U2 ();
                           }
                        ...
                        else
                        {
                           ...
                           {
                              nGXsfl_169_idx = (int)(Math.Round(NumberUtil.Val( sEvtType, "."), 18, MidpointRounding.ToEven));
                              sGXsfl_169_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_169_idx), 4, 0), 4, "0");
                              ...
                              AssignProp("", false, edtavDocumento_Internalname, "URL", context.PathToRelativeUrl( AV39Documento), !bGXsfl_169_Refreshing);
                              ...
                              if ( ( ( context.localUtil.CToN( cgiGet( edtavPropostadocumentosid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavPropostadocumentosid_Internalname), ",", ".") > Convert.ToDecimal( 999999999 )) ) )
                              {
                                 ...
                                 GxWebStd.gx_hidden_field( context, "gxhash_vPROPOSTADOCUMENTOSID"+"_"+sGXsfl_169_idx, GetSecureSignedToken( sGXsfl_169_idx, context.localUtil.Format( (decimal)(AV54PropostaDocumentosId), "ZZZZZZZZ9"), context));
                              }
                              else
                              {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 190 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Wcserasaww_Component) != 0 )
                           {
                              WebComp_Wcserasaww.componentprocess("W0190", "", sEvt);
                           }
                           WebComp_Wcserasaww_Component = OldWcserasaww;
                        }
                     }
      ...
      protected void gxnrGriddocumentos_newrow( )
      {
         ...
         {
            sendrow_1692( ) ;
            nGXsfl_169_idx = ((subGriddocumentos_Islastpage==1)&&(nGXsfl_169_idx+1>subGriddocumentos_fnc_Recordsperpage( )) ? 1 : nGXsfl_169_idx+1);
            sGXsfl_169_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_169_idx), 4, 0), 4, "0");
            SubsflControlProps_1692( ) ;
         }
      ...
      protected void gxgrGriddocumentos_refresh( int subGriddocumentos_Rows ,
                                                 ...
                                                 int AV82ConfiguracoesCategoriaTitulo ,
      ...
      protected void RF7U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Execute user event: Griddocumentos.Load */
            E267U2 ();
            if ( ( subGriddocumentos_Islastpage == 0 ) && ( GRIDDOCUMENTOS_nCurrentRecord > 0 ) && ( GRIDDOCUMENTOS_nGridOutOfScope == 0 ) && ( nGXsfl_169_idx == 1 ) )
            {
               GRIDDOCUMENTOS_nCurrentRecord = 0;
      ...
      protected void STRUP7U0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            nRC_GXsfl_169 = (int)(Math.Round(context.localUtil.CToN( cgiGet( "nRC_GXsfl_169"), ",", "."), 18, MidpointRounding.ToEven));
            ...
            Dvelop_confirmpanel_gerar_titulo_Title = cgiGet( "DVELOP_CONFIRMPANEL_GERAR_TITULO_Title");
            Dvelop_confirmpanel_gerar_titulo_Confirmationtext = cgiGet( "DVELOP_CONFIRMPANEL_GERAR_TITULO_Confirmationtext");
            Dvelop_confirmpanel_gerar_titulo_Yesbuttoncaption = cgiGet( "DVELOP_CONFIRMPANEL_GERAR_TITULO_Yesbuttoncaption");
            Dvelop_confirmpanel_gerar_titulo_Nobuttoncaption = cgiGet( "DVELOP_CONFIRMPANEL_GERAR_TITULO_Nobuttoncaption");
            Dvelop_confirmpanel_gerar_titulo_Cancelbuttoncaption = cgiGet( "DVELOP_CONFIRMPANEL_GERAR_TITULO_Cancelbuttoncaption");
            Dvelop_confirmpanel_gerar_titulo_Yesbuttonposition = cgiGet( "DVELOP_CONFIRMPANEL_GERAR_TITULO_Yesbuttonposition");
            Dvelop_confirmpanel_gerar_titulo_Confirmtype = cgiGet( "DVELOP_CONFIRMPANEL_GERAR_TITULO_Confirmtype");
            ...
            Dvelop_confirmpanel_gerar_titulo_Result = cgiGet( "DVELOP_CONFIRMPANEL_GERAR_TITULO_Result");
      ...
      protected void E247U2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wcserasaww_Component) != 0 )
         {
            ...
            WebComp_Wcserasaww.componentprepare(new Object[] {(string)"W0190",(string)"",AV63Array_ClienteId.ToJSonString(false),(int)AV5PropostaId});
      ...
      protected void E257U2( )
      {
         ...
         AssignProp("", false, cmbavPropostadocumentosstatus_Internalname, "Columnheaderclass", cmbavPropostadocumentosstatus_Columnheaderclass, !bGXsfl_169_Refreshing);
      ...
      private void E267U2( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            {
               DoAjaxLoad(169, GriddocumentosRow);
            }
      ...
      {
         /* Dvelop_confirmpanel_gerar_titulo_Close Routine */
         returnInSub = false;
         if ( StringUtil.StrCmp(Dvelop_confirmpanel_gerar_titulo_Result, "Yes") == 0 )
         {
            /* Execute user subroutine: 'DO ACTION GERAR_TITULO' */
            S202 ();
            if (returnInSub) return;
         }
         /*  Sending Event outputs  */
      ...
      protected void S162( )
      {
         ...
         if ( ! ( ( StringUtil.StrCmp(AV68PropostaStatus, "APROVADO") == 0 ) ) )
         {
            bttBtngerar_titulo_Visible = 0;
            AssignProp("", false, bttBtngerar_titulo_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(bttBtngerar_titulo_Visible), 5, 0), true);
         }
      }
      ...
      protected void S202( )
      {
         /* 'DO ACTION GERAR_TITULO' Routine */
         returnInSub = false;
         /* Using cursor H007U5 */
         pr_default.execute(2);
         while ( (pr_default.getStatus(2) != 101) )
         {
            A499ContaProposta = H007U5_A499ContaProposta[0];
            n499ContaProposta = H007U5_n499ContaProposta[0];
            A422ContaId = H007U5_A422ContaId[0];
            AV83ContaId = A422ContaId;
         ...
         if ( (0==AV83ContaId) )
         {
            ...
            {
               A422ContaId = H007U6_A422ContaId[0];
               AV83ContaId = A422ContaId;
         ...
         /* Using cursor H007U7 */
         pr_default.execute(4, new Object[] {AV5PropostaId});
         while ( (pr_default.getStatus(4) != 101) )
         {
            A323PropostaId = H007U7_A323PropostaId[0];
            n323PropostaId = H007U7_n323PropostaId[0];
            A326PropostaValor = H007U7_A326PropostaValor[0];
            n326PropostaValor = H007U7_n326PropostaValor[0];
            A328PropostaCratedBy = H007U7_A328PropostaCratedBy[0];
            n328PropostaCratedBy = H007U7_n328PropostaCratedBy[0];
            A504PropostaPacienteClienteId = H007U7_A504PropostaPacienteClienteId[0];
            n504PropostaPacienteClienteId = H007U7_n504PropostaPacienteClienteId[0];
            A620PropostaPacienteEnderecoCEP = H007U7_A620PropostaPacienteEnderecoCEP[0];
            n620PropostaPacienteEnderecoCEP = H007U7_n620PropostaPacienteEnderecoCEP[0];
            A621PropostaPacienteEnderecoLogradouro = H007U7_A621PropostaPacienteEnderecoLogradouro[0];
            n621PropostaPacienteEnderecoLogradouro = H007U7_n621PropostaPacienteEnderecoLogradouro[0];
            A622PropostaPacienteEnderecoNumero = H007U7_A622PropostaPacienteEnderecoNumero[0];
            n622PropostaPacienteEnderecoNumero = H007U7_n622PropostaPacienteEnderecoNumero[0];
            A623PropostaPacienteEnderecoComplemento = H007U7_A623PropostaPacienteEnderecoComplemento[0];
            n623PropostaPacienteEnderecoComplemento = H007U7_n623PropostaPacienteEnderecoComplemento[0];
            A624PropostaPacienteEnderecoBairro = H007U7_A624PropostaPacienteEnderecoBairro[0];
            n624PropostaPacienteEnderecoBairro = H007U7_n624PropostaPacienteEnderecoBairro[0];
            A625PropostaPacienteMunicipioCodigo = H007U7_A625PropostaPacienteMunicipioCodigo[0];
            n625PropostaPacienteMunicipioCodigo = H007U7_n625PropostaPacienteMunicipioCodigo[0];
            A620PropostaPacienteEnderecoCEP = H007U7_A620PropostaPacienteEnderecoCEP[0];
            n620PropostaPacienteEnderecoCEP = H007U7_n620PropostaPacienteEnderecoCEP[0];
            A621PropostaPacienteEnderecoLogradouro = H007U7_A621PropostaPacienteEnderecoLogradouro[0];
            n621PropostaPacienteEnderecoLogradouro = H007U7_n621PropostaPacienteEnderecoLogradouro[0];
            ...
            AV12PropostaValor = A326PropostaValor;
            AssignAttri("", false, "AV12PropostaValor", StringUtil.LTrimStr( AV12PropostaValor, 18, 2));
            new getclinicatax(context ).execute(  A328PropostaCratedBy, out  AV76ContratoTaxa, out  AV77ContratoSLA, out  AV78ContratoJurosMora, out  AV79ContratoIOFMinimo) ;
            if ( ( AV76ContratoTaxa > Convert.ToDecimal( 0 )) )
            {
               AV76ContratoTaxa = (decimal)(AV76ContratoTaxa*100);
            }
            AV80Date = DateTimeUtil.ServerDate( context, pr_default);
            AV80Date = DateTimeUtil.DAdd( AV80Date, (AV77ContratoSLA));
            AV80Date = DateTimeUtil.ServerDate( context, pr_default);
            AV81SdTitulo = new SdtSdTitulo(context);
            AV81SdTitulo.gxTpr_Clienteid = A504PropostaPacienteClienteId;
            AV81SdTitulo.gxTpr_Titulovalor = AV12PropostaValor;
            AV81SdTitulo.gxTpr_Titulodesconto = (decimal)(0);
            AV81SdTitulo.gxTpr_Titulodeleted = false;
            AV81SdTitulo.gxTpr_Titulovencimento = AV80Date;
            AV81SdTitulo.gxTpr_Tituloprorrogacao = AV80Date;
            AV81SdTitulo.gxTpr_Titulocep = A620PropostaPacienteEnderecoCEP;
            AV81SdTitulo.gxTpr_Titulologradouro = A621PropostaPacienteEnderecoLogradouro;
            AV81SdTitulo.gxTpr_Titulonumeroendereco = A622PropostaPacienteEnderecoNumero;
            AV81SdTitulo.gxTpr_Titulocomplemento = A623PropostaPacienteEnderecoComplemento;
            AV81SdTitulo.gxTpr_Titulobairro = A624PropostaPacienteEnderecoBairro;
            AV81SdTitulo.gxTpr_Titulomunicipio = A625PropostaPacienteMunicipioCodigo;
            AV81SdTitulo.gxTpr_Titulotipo = "DEBITO";
            AV81SdTitulo.gxTpr_Contaid = AV83ContaId;
            AV81SdTitulo.gxTpr_Titulocompetenciaano = (short)(DateTimeUtil.Year( AV80Date));
            AV81SdTitulo.gxTpr_Titulocompetenciames = (short)(DateTimeUtil.Month( AV80Date));
            AV81SdTitulo.gxTpr_Propostaid = AV5PropostaId;
            AV81SdTitulo.gxTpr_Categoriatituloid = AV82ConfiguracoesCategoriaTitulo;
            new prcriartitulo(context ).execute( ref  AV81SdTitulo, out  AV65sdERro) ;
            if ( AV65sdERro.gxTpr_Status == 401 )
            {
               GX_msglist.addItem(AV65sdERro.gxTpr_Msg);
               context.RollbackDataStores("wpalterarproposta",pr_default);
            ...
            {
               GXt_char3 = "Titulo gerado com sucesso!";
      ...
      protected void S142( )
      {
         ...
         if ( 1 == 2 )
         {
            ...
            {
               A495ConvenioCategoriaStatus = H007U8_A495ConvenioCategoriaStatus[0];
               n495ConvenioCategoriaStatus = H007U8_n495ConvenioCategoriaStatus[0];
               A493ConvenioCategoriaId = H007U8_A493ConvenioCategoriaId[0];
               n493ConvenioCategoriaId = H007U8_n493ConvenioCategoriaId[0];
               A494ConvenioCategoriaDescricao = H007U8_A494ConvenioCategoriaDescricao[0];
               n494ConvenioCategoriaDescricao = H007U8_n494ConvenioCategoriaDescricao[0];
         ...
         {
            /* Using cursor H007U9 */
            pr_default.execute(6, new Object[] {AV14ConvenioId});
            while ( (pr_default.getStatus(6) != 101) )
            {
               A410ConvenioId = H007U9_A410ConvenioId[0];
               n410ConvenioId = H007U9_n410ConvenioId[0];
               A495ConvenioCategoriaStatus = H007U9_A495ConvenioCategoriaStatus[0];
               n495ConvenioCategoriaStatus = H007U9_n495ConvenioCategoriaStatus[0];
               A493ConvenioCategoriaId = H007U9_A493ConvenioCategoriaId[0];
               n493ConvenioCategoriaId = H007U9_n493ConvenioCategoriaId[0];
               A494ConvenioCategoriaDescricao = H007U9_A494ConvenioCategoriaDescricao[0];
               n494ConvenioCategoriaDescricao = H007U9_n494ConvenioCategoriaDescricao[0];
               AV32Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
               AV32Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A493ConvenioCategoriaId), 9, 0));
               AV32Combo_DataItem.gxTpr_Title = A494ConvenioCategoriaDescricao;
               AV34ConvenioCategoriaId_Data.Add(AV32Combo_DataItem, 0);
      ...
      protected void S132( )
      {
         ...
         {
            A412ConvenioStatus = H007U10_A412ConvenioStatus[0];
            A410ConvenioId = H007U10_A410ConvenioId[0];
            n410ConvenioId = H007U10_n410ConvenioId[0];
            A411ConvenioDescricao = H007U10_A411ConvenioDescricao[0];
            n411ConvenioDescricao = H007U10_n411ConvenioDescricao[0];
            AV32Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A376ProcedimentosMedicosId = H007U11_A376ProcedimentosMedicosId[0];
            n376ProcedimentosMedicosId = H007U11_n376ProcedimentosMedicosId[0];
            A378ProcedimentosMedicosDescricao = H007U11_A378ProcedimentosMedicosDescricao[0];
            n378ProcedimentosMedicosDescricao = H007U11_n378ProcedimentosMedicosDescricao[0];
            AV32Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S112( )
      {
         ...
         if ( 1 == 2 )
         {
            ...
            pr_default.execute(9, new Object[] {AV46PropostaPacienteClienteId});
            while ( (pr_default.getStatus(9) != 101) )
            {
               A172ClienteTipoPessoa = H007U12_A172ClienteTipoPessoa[0];
               n172ClienteTipoPessoa = H007U12_n172ClienteTipoPessoa[0];
               A174ClienteStatus = H007U12_A174ClienteStatus[0];
               n174ClienteStatus = H007U12_n174ClienteStatus[0];
               A168ClienteId = H007U12_A168ClienteId[0];
               A201ContatoEmail = H007U12_A201ContatoEmail[0];
               n201ContatoEmail = H007U12_n201ContatoEmail[0];
               A170ClienteRazaoSocial = H007U12_A170ClienteRazaoSocial[0];
               n170ClienteRazaoSocial = H007U12_n170ClienteRazaoSocial[0];
               AV32Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         else
         {
            ...
            pr_default.execute(10, new Object[] {AV46PropostaPacienteClienteId});
            while ( (pr_default.getStatus(10) != 101) )
            {
               A172ClienteTipoPessoa = H007U13_A172ClienteTipoPessoa[0];
               n172ClienteTipoPessoa = H007U13_n172ClienteTipoPessoa[0];
               A174ClienteStatus = H007U13_A174ClienteStatus[0];
               n174ClienteStatus = H007U13_n174ClienteStatus[0];
               A168ClienteId = H007U13_A168ClienteId[0];
               A169ClienteDocumento = H007U13_A169ClienteDocumento[0];
               n169ClienteDocumento = H007U13_n169ClienteDocumento[0];
               A201ContatoEmail = H007U13_A201ContatoEmail[0];
               n201ContatoEmail = H007U13_n201ContatoEmail[0];
               A170ClienteRazaoSocial = H007U13_A170ClienteRazaoSocial[0];
               n170ClienteRazaoSocial = H007U13_n170ClienteRazaoSocial[0];
               AV32Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
               AV32Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A168ClienteId), 9, 0));
               AV30ComboTitles = (GxSimpleCollection<string>)(new GxSimpleCollection<string>());
      ...
      protected void wb_table6_220_7U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table6_220_7U2e( true) ;
         }
         else
         {
            wb_table6_220_7U2e( false) ;
         }
      }

      protected void wb_table5_215_7U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTabledvelop_confirmpanel_gerar_titulo_Internalname, tblTabledvelop_confirmpanel_gerar_titulo_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tbody>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td data-align=\"center\"  style=\""+CSSHelper.Prettify( "text-align:-khtml-center;text-align:-moz-center;text-align:-webkit-center")+"\">") ;
            /* User Defined Control */
            ucDvelop_confirmpanel_gerar_titulo.SetProperty("Title", Dvelop_confirmpanel_gerar_titulo_Title);
            ucDvelop_confirmpanel_gerar_titulo.SetProperty("ConfirmationText", Dvelop_confirmpanel_gerar_titulo_Confirmationtext);
            ucDvelop_confirmpanel_gerar_titulo.SetProperty("YesButtonCaption", Dvelop_confirmpanel_gerar_titulo_Yesbuttoncaption);
            ucDvelop_confirmpanel_gerar_titulo.SetProperty("NoButtonCaption", Dvelop_confirmpanel_gerar_titulo_Nobuttoncaption);
            ucDvelop_confirmpanel_gerar_titulo.SetProperty("CancelButtonCaption", Dvelop_confirmpanel_gerar_titulo_Cancelbuttoncaption);
            ucDvelop_confirmpanel_gerar_titulo.SetProperty("YesButtonPosition", Dvelop_confirmpanel_gerar_titulo_Yesbuttonposition);
            ucDvelop_confirmpanel_gerar_titulo.SetProperty("ConfirmType", Dvelop_confirmpanel_gerar_titulo_Confirmtype);
            ucDvelop_confirmpanel_gerar_titulo.Render(context, "dvelop.gxbootstrap.confirmpanel", Dvelop_confirmpanel_gerar_titulo_Internalname, "DVELOP_CONFIRMPANEL_GERAR_TITULOContainer");
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"DVELOP_CONFIRMPANEL_GERAR_TITULOContainer"+"Body"+"\" style=\"display:none;\">") ;
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_215_7U2e( true) ;
         }
         else
         {
            wb_table5_215_7U2e( false) ;
         }
      }

      protected void wb_table4_208_7U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_208_7U2e( true) ;
         }
         else
         {
            wb_table4_208_7U2e( false) ;
         }
      }

      protected void wb_table3_201_7U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_201_7U2e( true) ;
         }
         else
         {
            wb_table3_201_7U2e( false) ;
         }
      }

      protected void wb_table2_151_7U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 155,'',false,'" + sGXsfl_169_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavConveniovencimentoano, cmbavConveniovencimentoano_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV16ConvenioVencimentoAno), 4, 0)), 1, cmbavConveniovencimentoano_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavConveniovencimentoano.Enabled, 1, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,155);\"", "", true, 0, "HLP_WpAlterarProposta.htm");
            cmbavConveniovencimentoano.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV16ConvenioVencimentoAno), 4, 0));
            ...
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 159,'',false,'" + sGXsfl_169_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavConveniovencimentomes, cmbavConveniovencimentomes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV17ConvenioVencimentoMes), 4, 0)), 1, cmbavConveniovencimentomes_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavConveniovencimentomes.Enabled, 1, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,159);\"", "", true, 0, "HLP_WpAlterarProposta.htm");
            cmbavConveniovencimentomes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV17ConvenioVencimentoMes), 4, 0));
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_151_7U2e( true) ;
         }
         else
         {
            wb_table2_151_7U2e( false) ;
         }
      }

      protected void wb_table1_71_7U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_71_7U2e( true) ;
         }
         else
         {
            wb_table1_71_7U2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202552621584530", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpalterarproposta.js", "?202552621584530", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void SubsflControlProps_1692( )
      {
         edtavAprovar_Internalname = "vAPROVAR_"+sGXsfl_169_idx;
         edtavReprovar_Internalname = "vREPROVAR_"+sGXsfl_169_idx;
         edtavAdicionaranexo_Internalname = "vADICIONARANEXO_"+sGXsfl_169_idx;
         edtavExcluir_Internalname = "vEXCLUIR_"+sGXsfl_169_idx;
         edtavDocumentosid_Internalname = "vDOCUMENTOSID_"+sGXsfl_169_idx;
         edtavDocumentosdescricao_Internalname = "vDOCUMENTOSDESCRICAO_"+sGXsfl_169_idx;
         cmbavDocumentoobrigatorio_Internalname = "vDOCUMENTOOBRIGATORIO_"+sGXsfl_169_idx;
         edtavPropostadocumentosanexoname_Internalname = "vPROPOSTADOCUMENTOSANEXONAME_"+sGXsfl_169_idx;
         edtavDocumento_Internalname = "vDOCUMENTO_"+sGXsfl_169_idx;
         edtavExtensao_Internalname = "vEXTENSAO_"+sGXsfl_169_idx;
         cmbavPropostadocumentosstatus_Internalname = "vPROPOSTADOCUMENTOSSTATUS_"+sGXsfl_169_idx;
         edtavPropostadocumentosid_Internalname = "vPROPOSTADOCUMENTOSID_"+sGXsfl_169_idx;
         chkavPropostadocumentosadm_Internalname = "vPROPOSTADOCUMENTOSADM_"+sGXsfl_169_idx;
      }

      protected void SubsflControlProps_fel_1692( )
      {
         edtavAprovar_Internalname = "vAPROVAR_"+sGXsfl_169_fel_idx;
         edtavReprovar_Internalname = "vREPROVAR_"+sGXsfl_169_fel_idx;
         edtavAdicionaranexo_Internalname = "vADICIONARANEXO_"+sGXsfl_169_fel_idx;
         edtavExcluir_Internalname = "vEXCLUIR_"+sGXsfl_169_fel_idx;
         edtavDocumentosid_Internalname = "vDOCUMENTOSID_"+sGXsfl_169_fel_idx;
         edtavDocumentosdescricao_Internalname = "vDOCUMENTOSDESCRICAO_"+sGXsfl_169_fel_idx;
         cmbavDocumentoobrigatorio_Internalname = "vDOCUMENTOOBRIGATORIO_"+sGXsfl_169_fel_idx;
         edtavPropostadocumentosanexoname_Internalname = "vPROPOSTADOCUMENTOSANEXONAME_"+sGXsfl_169_fel_idx;
         edtavDocumento_Internalname = "vDOCUMENTO_"+sGXsfl_169_fel_idx;
         edtavExtensao_Internalname = "vEXTENSAO_"+sGXsfl_169_fel_idx;
         cmbavPropostadocumentosstatus_Internalname = "vPROPOSTADOCUMENTOSSTATUS_"+sGXsfl_169_fel_idx;
         edtavPropostadocumentosid_Internalname = "vPROPOSTADOCUMENTOSID_"+sGXsfl_169_fel_idx;
         chkavPropostadocumentosadm_Internalname = "vPROPOSTADOCUMENTOSADM_"+sGXsfl_169_fel_idx;
      }

      protected void sendrow_1692( )
      {
         sGXsfl_169_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_169_idx), 4, 0), 4, "0");
         SubsflControlProps_1692( ) ;
         WB7U0( ) ;
         if ( ( subGriddocumentos_Rows * 1 == 0 ) || ( nGXsfl_169_idx <= subGriddocumentos_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( GriddocumentosContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlText( " gxrow=\""+sGXsfl_169_idx+"\">") ;
            }
            /* Subfile cell */
            if ( GriddocumentosContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 170,'',false,'" + sGXsfl_169_idx + "',169)\"";
            ROClassString = edtavAprovar_Class;
            GriddocumentosRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavAprovar_Internalname,StringUtil.RTrim( AV61Aprovar),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,170);\"","'"+""+"'"+",false,"+"'"+"EVAPROVAR.CLICK."+sGXsfl_169_idx+"'",(string)"",(string)"",(string)"Aprovar",(string)"",(string)edtavAprovar_Jsonclick,(short)5,(string)edtavAprovar_Class,(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(short)-1,(int)edtavAprovar_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)169,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GriddocumentosContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 172,'',false,'" + sGXsfl_169_idx + "',169)\"";
            ROClassString = "Attribute";
            GriddocumentosRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavAdicionaranexo_Internalname,StringUtil.RTrim( AV29AdicionarAnexo),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,172);\"","'"+""+"'"+",false,"+"'"+"EVADICIONARANEXO.CLICK."+sGXsfl_169_idx+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavAdicionaranexo_Jsonclick,(short)5,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(short)-1,(int)edtavAdicionaranexo_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)169,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GriddocumentosContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 173,'',false,'" + sGXsfl_169_idx + "',169)\"";
            ROClassString = edtavExcluir_Class;
            GriddocumentosRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavExcluir_Internalname,StringUtil.RTrim( AV59Excluir),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,173);\"",(string)"'"+""+"'"+",false,"+"'"+"e307u2_client"+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavExcluir_Jsonclick,(short)7,(string)edtavExcluir_Class,(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(short)-1,(int)edtavExcluir_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)169,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GriddocumentosContainer.GetWrapped() == 1 )
            {
            ...
            {
               GXCCtl = "vDOCUMENTOOBRIGATORIO_" + sGXsfl_169_idx;
            ...
            AssignProp("", false, cmbavDocumentoobrigatorio_Internalname, "Values", (string)(cmbavDocumentoobrigatorio.ToJavascriptSource()), !bGXsfl_169_Refreshing);
            /* Subfile cell */
            if ( GriddocumentosContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            StyleString = "";
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 178,'',false,'" + sGXsfl_169_idx + "',169)\"";
            edtavDocumento_Filetype = "tmp";
            AssignProp("", false, edtavDocumento_Internalname, "Filetype", edtavDocumento_Filetype, !bGXsfl_169_Refreshing);
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 179,'',false,'" + sGXsfl_169_idx + "',169)\"";
            ROClassString = "Attribute";
            ...
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 180,'',false,'" + sGXsfl_169_idx + "',169)\"";
            if ( ( cmbavPropostadocumentosstatus.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "vPROPOSTADOCUMENTOSSTATUS_" + sGXsfl_169_idx;
            ...
            ClassString = "Attribute";
            StyleString = "";
            GXCCtl = "vPROPOSTADOCUMENTOSADM_" + sGXsfl_169_idx;
            chkavPropostadocumentosadm.Name = GXCCtl;
            chkavPropostadocumentosadm.WebTags = "";
            chkavPropostadocumentosadm.Caption = "";
            AssignProp("", false, chkavPropostadocumentosadm_Internalname, "TitleCaption", chkavPropostadocumentosadm.Caption, !bGXsfl_169_Refreshing);
      ...
      protected void StartGridControl169( )
      {
         if ( GriddocumentosContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<div id=\""+"GriddocumentosContainer"+"DivS\" data-gxgridid=\"169\">") ;
            sStyleString = "";
      ...
      protected void init_default_properties( )
      {
         ...
         bttBtngerar_titulo_Internalname = "BTNGERAR_TITULO";
         ...
         Dvelop_confirmpanel_gerar_titulo_Internalname = "DVELOP_CONFIRMPANEL_GERAR_TITULO";
         tblTabledvelop_confirmpanel_gerar_titulo_Internalname = "TABLEDVELOP_CONFIRMPANEL_GERAR_TITULO";
      ...
      public override void initialize_properties( )
      {
         ...
         Dvelop_confirmpanel_gerar_titulo_Confirmtype = "2";
         Dvelop_confirmpanel_gerar_titulo_Yesbuttonposition = "left";
         Dvelop_confirmpanel_gerar_titulo_Cancelbuttoncaption = "WWP_ConfirmTextCancel";
         Dvelop_confirmpanel_gerar_titulo_Nobuttoncaption = "WWP_ConfirmTextNo";
         Dvelop_confirmpanel_gerar_titulo_Yesbuttoncaption = "WWP_ConfirmTextYes";
         Dvelop_confirmpanel_gerar_titulo_Confirmationtext = "Deseja criar o titulo para realizar o pagamento ?";
         Dvelop_confirmpanel_gerar_titulo_Title = "Gerar Titulo";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DVELOP_CONFIRMPANEL_FINALIZAR_ANALISE.CLOSE","""{"handler":"E167U2","iparms":[{"av":"Dvelop_confirmpanel_finalizar_analise_Result","ctrl":"DVELOP_CONFIRMPANEL_FINALIZAR_ANALISE","prop":"Result"},{"av":"AV70DVelop_ConfirmPanel_Finalizar_analise_Comment","fld":"vDVELOP_CONFIRMPANEL_FINALIZAR_ANALISE_COMMENT","type":"vchar"},{"av":"AV5PropostaId","fld":"vPROPOSTAID","pic":"ZZZZZZZZ9","type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_FINALIZAR_ANALISE.CLOSE",""","oparms":[{"ctrl":"BTNFINALIZAR_ANALISE","prop":"Visible"}]}""");
         setEventMetadata("'DOGERAR_TITULO'","""{"handler":"E137U1","iparms":[]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_GERAR_TITULO.CLOSE","""{"handler":"E177U2","iparms":[{"av":"Dvelop_confirmpanel_gerar_titulo_Result","ctrl":"DVELOP_CONFIRMPANEL_GERAR_TITULO","prop":"Result"},{"av":"A499ContaProposta","fld":"CONTAPROPOSTA","type":"boolean"},{"av":"A422ContaId","fld":"CONTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A323PropostaId","fld":"PROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV5PropostaId","fld":"vPROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A326PropostaValor","fld":"PROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"A328PropostaCratedBy","fld":"PROPOSTACRATEDBY","pic":"ZZZ9","type":"int"},{"av":"A504PropostaPacienteClienteId","fld":"PROPOSTAPACIENTECLIENTEID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A620PropostaPacienteEnderecoCEP","fld":"PROPOSTAPACIENTEENDERECOCEP","type":"svchar"},{"av":"A621PropostaPacienteEnderecoLogradouro","fld":"PROPOSTAPACIENTEENDERECOLOGRADOURO","pic":"@!","type":"svchar"},{"av":"A622PropostaPacienteEnderecoNumero","fld":"PROPOSTAPACIENTEENDERECONUMERO","type":"svchar"},{"av":"A623PropostaPacienteEnderecoComplemento","fld":"PROPOSTAPACIENTEENDERECOCOMPLEMENTO","type":"svchar"},{"av":"A624PropostaPacienteEnderecoBairro","fld":"PROPOSTAPACIENTEENDERECOBAIRRO","pic":"@!","type":"svchar"},{"av":"A625PropostaPacienteMunicipioCodigo","fld":"PROPOSTAPACIENTEMUNICIPIOCODIGO","type":"svchar"},{"av":"AV82ConfiguracoesCategoriaTitulo","fld":"vCONFIGURACOESCATEGORIATITULO","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_GERAR_TITULO.CLOSE",""","oparms":[{"av":"AV12PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"ctrl":"BTNGERAR_TITULO","prop":"Visible"}]}""");
         setEventMetadata("'DONOVODOCUMENTO'","""{"handler":"E197U2","iparms":[{"av":"GRIDDOCUMENTOS_nFirstRecordOnPage","type":"int"},{"av":"GRIDDOCUMENTOS_nEOF","type":"int"},{"av":"subGriddocumentos_Rows","ctrl":"GRIDDOCUMENTOS","prop":"Rows"},{"av":"AV66Aprovados","fld":"vAPROVADOS","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV67Context","fld":"vCONTEXT","hsh":true,"type":""},{"av":"AV68PropostaStatus","fld":"vPROPOSTASTATUS","hsh":true,"type":"svchar"},{"av":"A323PropostaId","fld":"PROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV5PropostaId","fld":"vPROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A415PropostaDocumentosAnexo","fld":"PROPOSTADOCUMENTOSANEXO","type":"bitstr"},{"av":"A406DocumentosDescricao","fld":"DOCUMENTOSDESCRICAO","type":"svchar"},{"av":"A405DocumentosId","fld":"DOCUMENTOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A417PropostaDocumentosAnexoFileType","fld":"PROPOSTADOCUMENTOSANEXOFILETYPE","type":"svchar"},{"av":"A579PropostaDocumentosStatus","fld":"PROPOSTADOCUMENTOSSTATUS","type":"svchar"},{"av":"A416PropostaDocumentosAnexoName","fld":"PROPOSTADOCUMENTOSANEXONAME","type":"svchar"},{"av":"A414PropostaDocumentosId","fld":"PROPOSTADOCUMENTOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A651PropostaDocumentosAdm","fld":"PROPOSTADOCUMENTOSADM","type":"boolean"},{"av":"AV82ConfiguracoesCategoriaTitulo","fld":"vCONFIGURACOESCATEGORIATITULO","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV46PropostaPacienteClienteId","fld":"vPROPOSTAPACIENTECLIENTEID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV71PropostaComentarioAnalise","fld":"vPROPOSTACOMENTARIOANALISE","type":"svchar"}]""");
         setEventMetadata("'DONOVODOCUMENTO'",""","oparms":[{"av":"cmbavPropostadocumentosstatus"},{"ctrl":"BTNAPROVAR_PROPOSTA","prop":"Visible"},{"ctrl":"BTNFINALIZAR_ANALISE","prop":"Visible"},{"ctrl":"BTNGERAR_TITULO","prop":"Visible"}]}""");
         setEventMetadata("VEXCLUIR.CLICK","""{"handler":"E307U2","iparms":[]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_EXCLUIR.CLOSE","""{"handler":"E187U2","iparms":[{"av":"Dvelop_confirmpanel_excluir_Result","ctrl":"DVELOP_CONFIRMPANEL_EXCLUIR","prop":"Result"},{"av":"GRIDDOCUMENTOS_nFirstRecordOnPage","type":"int"},{"av":"GRIDDOCUMENTOS_nEOF","type":"int"},{"av":"subGriddocumentos_Rows","ctrl":"GRIDDOCUMENTOS","prop":"Rows"},{"av":"AV66Aprovados","fld":"vAPROVADOS","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV67Context","fld":"vCONTEXT","hsh":true,"type":""},{"av":"AV68PropostaStatus","fld":"vPROPOSTASTATUS","hsh":true,"type":"svchar"},{"av":"A323PropostaId","fld":"PROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV5PropostaId","fld":"vPROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A415PropostaDocumentosAnexo","fld":"PROPOSTADOCUMENTOSANEXO","type":"bitstr"},{"av":"A406DocumentosDescricao","fld":"DOCUMENTOSDESCRICAO","type":"svchar"},{"av":"A405DocumentosId","fld":"DOCUMENTOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A417PropostaDocumentosAnexoFileType","fld":"PROPOSTADOCUMENTOSANEXOFILETYPE","type":"svchar"},{"av":"A579PropostaDocumentosStatus","fld":"PROPOSTADOCUMENTOSSTATUS","type":"svchar"},{"av":"A416PropostaDocumentosAnexoName","fld":"PROPOSTADOCUMENTOSANEXONAME","type":"svchar"},{"av":"A414PropostaDocumentosId","fld":"PROPOSTADOCUMENTOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A651PropostaDocumentosAdm","fld":"PROPOSTADOCUMENTOSADM","type":"boolean"},{"av":"AV82ConfiguracoesCategoriaTitulo","fld":"vCONFIGURACOESCATEGORIATITULO","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV46PropostaPacienteClienteId","fld":"vPROPOSTAPACIENTECLIENTEID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV71PropostaComentarioAnalise","fld":"vPROPOSTACOMENTARIOANALISE","type":"svchar"},{"av":"AV54PropostaDocumentosId","fld":"vPROPOSTADOCUMENTOSID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_EXCLUIR.CLOSE",""","oparms":[{"av":"cmbavPropostadocumentosstatus"},{"ctrl":"BTNAPROVAR_PROPOSTA","prop":"Visible"},{"ctrl":"BTNFINALIZAR_ANALISE","prop":"Visible"},{"ctrl":"BTNGERAR_TITULO","prop":"Visible"}]}""");
         setEventMetadata("'DOCONSULTARCLIENTE'","""{"handler":"E207U2","iparms":[{"av":"AV46PropostaPacienteClienteId","fld":"vPROPOSTAPACIENTECLIENTEID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("'DOCONSULTARRESPONSAVEL'","""{"handler":"E217U2","iparms":[{"av":"AV47PropostaResponsavelId","fld":"vPROPOSTARESPONSAVELID","pic":"ZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("'DOADICIONARRESPONSAVEL'","""{"handler":"E227U2","iparms":[{"av":"A168ClienteId","fld":"CLIENTEID","pic":"ZZZZZZZZ9","type":"int"}]}""");
         setEventMetadata("COMBO_CONVENIOID.ONOPTIONCLICKED","""{"handler":"E147U2","iparms":[{"av":"Combo_convenioid_Selectedvalue_get","ctrl":"COMBO_CONVENIOID","prop":"SelectedValue_get"},{"av":"A494ConvenioCategoriaDescricao","fld":"CONVENIOCATEGORIADESCRICAO","type":"svchar"},{"av":"A495ConvenioCategoriaStatus","fld":"CONVENIOCATEGORIASTATUS","type":"boolean"},{"av":"A493ConvenioCategoriaId","fld":"CONVENIOCATEGORIAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV34ConvenioCategoriaId_Data","fld":"vCONVENIOCATEGORIAID_DATA","type":""},{"av":"AV15ConvenioCategoriaId","fld":"vCONVENIOCATEGORIAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A410ConvenioId","fld":"CONVENIOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV14ConvenioId","fld":"vCONVENIOID","pic":"ZZZZZZZZ9","type":"int"}]""");
         ...
         setEventMetadata("GRIDDOCUMENTOS_FIRSTPAGE",""","oparms":[{"av":"cmbavPropostadocumentosstatus"},{"ctrl":"BTNAPROVAR_PROPOSTA","prop":"Visible"},{"ctrl":"BTNFINALIZAR_ANALISE","prop":"Visible"},{"ctrl":"BTNGERAR_TITULO","prop":"Visible"}]}""");
         ...
         setEventMetadata("GRIDDOCUMENTOS_PREVPAGE",""","oparms":[{"av":"cmbavPropostadocumentosstatus"},{"ctrl":"BTNAPROVAR_PROPOSTA","prop":"Visible"},{"ctrl":"BTNFINALIZAR_ANALISE","prop":"Visible"},{"ctrl":"BTNGERAR_TITULO","prop":"Visible"}]}""");
         setEventMetadata("GRIDDOCUMENTOS_NEXTPAGE","""{"handler":"subgriddocumentos_nextpage","iparms":[{"av":"GRIDDOCUMENTOS_nFirstRecordOnPage","type":"int"},{"av":"GRIDDOCUMENTOS_nEOF","type":"int"},{"av":"subGriddocumentos_Rows","ctrl":"GRIDDOCUMENTOS","prop":"Rows"},{"av":"A323PropostaId","fld":"PROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV5PropostaId","fld":"vPROPOSTAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A415PropostaDocumentosAnexo","fld":"PROPOSTADOCUMENTOSANEXO","type":"bitstr"},{"av":"A406DocumentosDescricao","fld":"DOCUMENTOSDESCRICAO","type":"svchar"},{"av":"A405DocumentosId","fld":"DOCUMENTOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A417PropostaDocumentosAnexoFileType","fld":"PROPOSTADOCUMENTOSANEXOFILETYPE","type":"svchar"},{"av":"A579PropostaDocumentosStatus","fld":"PROPOSTADOCUMENTOSSTATUS","type":"svchar"},{"av":"A416PropostaDocumentosAnexoName","fld":"PROPOSTADOCUMENTOSANEXONAME","type":"svchar"},{"av":"A414PropostaDocumentosId","fld":"PROPOSTADOCUMENTOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A651PropostaDocumentosAdm","fld":"PROPOSTADOCUMENTOSADM","type":"boolean"},{"av":"AV82ConfiguracoesCategoriaTitulo","fld":"vCONFIGURACOESCATEGORIATITULO","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV46PropostaPacienteClienteId","fld":"vPROPOSTAPACIENTECLIENTEID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV71PropostaComentarioAnalise","fld":"vPROPOSTACOMENTARIOANALISE","type":"svchar"},{"av":"AV66Aprovados","fld":"vAPROVADOS","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"AV67Context","fld":"vCONTEXT","hsh":true,"type":""},{"av":"AV68PropostaStatus","fld":"vPROPOSTASTATUS","hsh":true,"type":"svchar"}]""");
         setEventMetadata("GRIDDOCUMENTOS_NEXTPAGE",""","oparms":[{"av":"cmbavPropostadocumentosstatus"},{"ctrl":"BTNAPROVAR_PROPOSTA","prop":"Visible"},{"ctrl":"BTNFINALIZAR_ANALISE","prop":"Visible"},{"ctrl":"BTNGERAR_TITULO","prop":"Visible"}]}""");
         ...
         setEventMetadata("GRIDDOCUMENTOS_LASTPAGE",""","oparms":[{"av":"cmbavPropostadocumentosstatus"},{"ctrl":"BTNAPROVAR_PROPOSTA","prop":"Visible"},{"ctrl":"BTNFINALIZAR_ANALISE","prop":"Visible"},{"ctrl":"BTNGERAR_TITULO","prop":"Visible"}]}""");
      ...
      public override void initialize( )
      {
         ...
         Dvelop_confirmpanel_gerar_titulo_Result = "";
         ...
         H007U5_A499ContaProposta = new bool[] {false} ;
         H007U5_n499ContaProposta = new bool[] {false} ;
         H007U5_A422ContaId = new int[1] ;
         H007U6_A422ContaId = new int[1] ;
         H007U7_A323PropostaId = new int[1] ;
         H007U7_n323PropostaId = new bool[] {false} ;
         H007U7_A326PropostaValor = new decimal[1] ;
         H007U7_n326PropostaValor = new bool[] {false} ;
         H007U7_A328PropostaCratedBy = new short[1] ;
         H007U7_n328PropostaCratedBy = new bool[] {false} ;
         H007U7_A504PropostaPacienteClienteId = new int[1] ;
         H007U7_n504PropostaPacienteClienteId = new bool[] {false} ;
         H007U7_A620PropostaPacienteEnderecoCEP = new string[] {""} ;
         H007U7_n620PropostaPacienteEnderecoCEP = new bool[] {false} ;
         H007U7_A621PropostaPacienteEnderecoLogradouro = new string[] {""} ;
         H007U7_n621PropostaPacienteEnderecoLogradouro = new bool[] {false} ;
         H007U7_A622PropostaPacienteEnderecoNumero = new string[] {""} ;
         H007U7_n622PropostaPacienteEnderecoNumero = new bool[] {false} ;
         H007U7_A623PropostaPacienteEnderecoComplemento = new string[] {""} ;
         H007U7_n623PropostaPacienteEnderecoComplemento = new bool[] {false} ;
         H007U7_A624PropostaPacienteEnderecoBairro = new string[] {""} ;
         H007U7_n624PropostaPacienteEnderecoBairro = new bool[] {false} ;
         H007U7_A625PropostaPacienteMunicipioCodigo = new string[] {""} ;
         H007U7_n625PropostaPacienteMunicipioCodigo = new bool[] {false} ;
         AV80Date = DateTime.MinValue;
         AV81SdTitulo = new SdtSdTitulo(context);
         AV53PropostaDocumentos = new SdtPropostaDocumentos(context);
         H007U8_A495ConvenioCategoriaStatus = new bool[] {false} ;
         H007U8_n495ConvenioCategoriaStatus = new bool[] {false} ;
         H007U8_A493ConvenioCategoriaId = new int[1] ;
         H007U8_n493ConvenioCategoriaId = new bool[] {false} ;
         H007U8_A494ConvenioCategoriaDescricao = new string[] {""} ;
         H007U8_n494ConvenioCategoriaDescricao = new bool[] {false} ;
         AV32Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         H007U9_A410ConvenioId = new int[1] ;
         H007U9_n410ConvenioId = new bool[] {false} ;
         H007U9_A495ConvenioCategoriaStatus = new bool[] {false} ;
         H007U9_n495ConvenioCategoriaStatus = new bool[] {false} ;
         H007U9_A493ConvenioCategoriaId = new int[1] ;
         H007U9_n493ConvenioCategoriaId = new bool[] {false} ;
         H007U9_A494ConvenioCategoriaDescricao = new string[] {""} ;
         H007U9_n494ConvenioCategoriaDescricao = new bool[] {false} ;
         H007U10_A412ConvenioStatus = new bool[] {false} ;
         H007U10_A410ConvenioId = new int[1] ;
         H007U10_n410ConvenioId = new bool[] {false} ;
         H007U10_A411ConvenioDescricao = new string[] {""} ;
         H007U10_n411ConvenioDescricao = new bool[] {false} ;
         H007U11_A376ProcedimentosMedicosId = new int[1] ;
         H007U11_n376ProcedimentosMedicosId = new bool[] {false} ;
         H007U11_A378ProcedimentosMedicosDescricao = new string[] {""} ;
         H007U11_n378ProcedimentosMedicosDescricao = new bool[] {false} ;
         H007U12_A172ClienteTipoPessoa = new string[] {""} ;
         H007U12_n172ClienteTipoPessoa = new bool[] {false} ;
         H007U12_A174ClienteStatus = new bool[] {false} ;
         H007U12_n174ClienteStatus = new bool[] {false} ;
         H007U12_A168ClienteId = new int[1] ;
         H007U12_A201ContatoEmail = new string[] {""} ;
         H007U12_n201ContatoEmail = new bool[] {false} ;
         H007U12_A170ClienteRazaoSocial = new string[] {""} ;
         H007U12_n170ClienteRazaoSocial = new bool[] {false} ;
         A172ClienteTipoPessoa = "";
         A201ContatoEmail = "";
         A170ClienteRazaoSocial = "";
         AV30ComboTitles = new GxSimpleCollection<string>();
         H007U13_A172ClienteTipoPessoa = new string[] {""} ;
         H007U13_n172ClienteTipoPessoa = new bool[] {false} ;
         H007U13_A174ClienteStatus = new bool[] {false} ;
         H007U13_n174ClienteStatus = new bool[] {false} ;
         H007U13_A168ClienteId = new int[1] ;
         H007U13_A169ClienteDocumento = new string[] {""} ;
         H007U13_n169ClienteDocumento = new bool[] {false} ;
         H007U13_A201ContatoEmail = new string[] {""} ;
         H007U13_n201ContatoEmail = new bool[] {false} ;
         H007U13_A170ClienteRazaoSocial = new string[] {""} ;
         H007U13_n170ClienteRazaoSocial = new bool[] {false} ;
         ...
         ucDvelop_confirmpanel_gerar_titulo = new GXUserControl();
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpalterarproposta__default(),
            new Object[][] {
               ...
               , new Object[] {
               H007U5_A499ContaProposta, H007U5_n499ContaProposta, H007U5_A422ContaId
               }
               , new Object[] {
               H007U6_A422ContaId
               }
               , new Object[] {
               H007U7_A323PropostaId, H007U7_A326PropostaValor, H007U7_n326PropostaValor, H007U7_A328PropostaCratedBy, H007U7_n328PropostaCratedBy, H007U7_A504PropostaPacienteClienteId, H007U7_n504PropostaPacienteClienteId, H007U7_A620PropostaPacienteEnderecoCEP, H007U7_n620PropostaPacienteEnderecoCEP, H007U7_A621PropostaPacienteEnderecoLogradouro,
               H007U7_n621PropostaPacienteEnderecoLogradouro, H007U7_A622PropostaPacienteEnderecoNumero, H007U7_n622PropostaPacienteEnderecoNumero, H007U7_A623PropostaPacienteEnderecoComplemento, H007U7_n623PropostaPacienteEnderecoComplemento, H007U7_A624PropostaPacienteEnderecoBairro, H007U7_n624PropostaPacienteEnderecoBairro, H007U7_A625PropostaPacienteMunicipioCodigo, H007U7_n625PropostaPacienteMunicipioCodigo
               }
               , new Object[] {
               H007U8_A495ConvenioCategoriaStatus, H007U8_n495ConvenioCategoriaStatus, H007U8_A493ConvenioCategoriaId, H007U8_A494ConvenioCategoriaDescricao, H007U8_n494ConvenioCategoriaDescricao
               }
               , new Object[] {
               H007U9_A410ConvenioId, H007U9_n410ConvenioId, H007U9_A495ConvenioCategoriaStatus, H007U9_n495ConvenioCategoriaStatus, H007U9_A493ConvenioCategoriaId, H007U9_A494ConvenioCategoriaDescricao, H007U9_n494ConvenioCategoriaDescricao
               }
               , new Object[] {
               H007U10_A412ConvenioStatus, H007U10_A410ConvenioId, H007U10_A411ConvenioDescricao, H007U10_n411ConvenioDescricao
               }
               , new Object[] {
               H007U11_A376ProcedimentosMedicosId, H007U11_A378ProcedimentosMedicosDescricao, H007U11_n378ProcedimentosMedicosDescricao
               }
               , new Object[] {
               H007U12_A172ClienteTipoPessoa, H007U12_n172ClienteTipoPessoa, H007U12_A174ClienteStatus, H007U12_n174ClienteStatus, H007U12_A168ClienteId, H007U12_A201ContatoEmail, H007U12_n201ContatoEmail, H007U12_A170ClienteRazaoSocial, H007U12_n170ClienteRazaoSocial
               }
               , new Object[] {
               H007U13_A172ClienteTipoPessoa, H007U13_n172ClienteTipoPessoa, H007U13_A174ClienteStatus, H007U13_n174ClienteStatus, H007U13_A168ClienteId, H007U13_A169ClienteDocumento, H007U13_n169ClienteDocumento, H007U13_A201ContatoEmail, H007U13_n201ContatoEmail, H007U13_A170ClienteRazaoSocial,
               H007U13_n170ClienteRazaoSocial
               }
            }
         );
      ...
      private int AV82ConfiguracoesCategoriaTitulo ;
      ...
      private int bttBtngerar_titulo_Visible ;
      ...
      private decimal AV76ContratoTaxa ;
      private decimal AV78ContratoJurosMora ;
      private decimal AV79ContratoIOFMinimo ;
      private string Dvelop_confirmpanel_aprovar_proposta_Result ;
      private string Dvelop_confirmpanel_finalizar_analise_Result ;
      private string Dvelop_confirmpanel_gerar_titulo_Result ;
      ...
      private string Dvelop_confirmpanel_gerar_titulo_Title ;
      private string Dvelop_confirmpanel_gerar_titulo_Confirmationtext ;
      private string Dvelop_confirmpanel_gerar_titulo_Yesbuttoncaption ;
      private string Dvelop_confirmpanel_gerar_titulo_Nobuttoncaption ;
      private string Dvelop_confirmpanel_gerar_titulo_Cancelbuttoncaption ;
      private string Dvelop_confirmpanel_gerar_titulo_Yesbuttonposition ;
      private string Dvelop_confirmpanel_gerar_titulo_Confirmtype ;
      ...
      private string bttBtngerar_titulo_Internalname ;
      private string bttBtngerar_titulo_Jsonclick ;
      ...
      private string tblTabledvelop_confirmpanel_gerar_titulo_Internalname ;
      private string Dvelop_confirmpanel_gerar_titulo_Internalname ;
      ...
      private bool wbLoad ;
      private bool bGXsfl_169_Refreshing=false ;
      private bool Rfr0gs ;
      private bool wbErr ;
      ...
      private GXUserControl ucDvelop_confirmpanel_gerar_titulo ;
      ...
      private bool[] H007U5_A499ContaProposta ;
      private bool[] H007U5_n499ContaProposta ;
      private int[] H007U5_A422ContaId ;
      private int[] H007U6_A422ContaId ;
      private int[] H007U7_A323PropostaId ;
      private bool[] H007U7_n323PropostaId ;
      private decimal[] H007U7_A326PropostaValor ;
      private bool[] H007U7_n326PropostaValor ;
      private short[] H007U7_A328PropostaCratedBy ;
      private bool[] H007U7_n328PropostaCratedBy ;
      private int[] H007U7_A504PropostaPacienteClienteId ;
      private bool[] H007U7_n504PropostaPacienteClienteId ;
      private string[] H007U7_A620PropostaPacienteEnderecoCEP ;
      private bool[] H007U7_n620PropostaPacienteEnderecoCEP ;
      private string[] H007U7_A621PropostaPacienteEnderecoLogradouro ;
      private bool[] H007U7_n621PropostaPacienteEnderecoLogradouro ;
      private string[] H007U7_A622PropostaPacienteEnderecoNumero ;
      private bool[] H007U7_n622PropostaPacienteEnderecoNumero ;
      private string[] H007U7_A623PropostaPacienteEnderecoComplemento ;
      private bool[] H007U7_n623PropostaPacienteEnderecoComplemento ;
      private string[] H007U7_A624PropostaPacienteEnderecoBairro ;
      private bool[] H007U7_n624PropostaPacienteEnderecoBairro ;
      private string[] H007U7_A625PropostaPacienteMunicipioCodigo ;
      private bool[] H007U7_n625PropostaPacienteMunicipioCodigo ;
      private SdtSdTitulo AV81SdTitulo ;
      private SdtPropostaDocumentos AV53PropostaDocumentos ;
      private bool[] H007U8_A495ConvenioCategoriaStatus ;
      private bool[] H007U8_n495ConvenioCategoriaStatus ;
      private int[] H007U8_A493ConvenioCategoriaId ;
      private bool[] H007U8_n493ConvenioCategoriaId ;
      private string[] H007U8_A494ConvenioCategoriaDescricao ;
      private bool[] H007U8_n494ConvenioCategoriaDescricao ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV32Combo_DataItem ;
      private int[] H007U9_A410ConvenioId ;
      private bool[] H007U9_n410ConvenioId ;
      private bool[] H007U9_A495ConvenioCategoriaStatus ;
      private bool[] H007U9_n495ConvenioCategoriaStatus ;
      private int[] H007U9_A493ConvenioCategoriaId ;
      private bool[] H007U9_n493ConvenioCategoriaId ;
      private string[] H007U9_A494ConvenioCategoriaDescricao ;
      private bool[] H007U9_n494ConvenioCategoriaDescricao ;
      private bool[] H007U10_A412ConvenioStatus ;
      private int[] H007U10_A410ConvenioId ;
      private bool[] H007U10_n410ConvenioId ;
      private string[] H007U10_A411ConvenioDescricao ;
      private bool[] H007U10_n411ConvenioDescricao ;
      private int[] H007U11_A376ProcedimentosMedicosId ;
      private bool[] H007U11_n376ProcedimentosMedicosId ;
      private string[] H007U11_A378ProcedimentosMedicosDescricao ;
      private bool[] H007U11_n378ProcedimentosMedicosDescricao ;
      private string[] H007U12_A172ClienteTipoPessoa ;
      private bool[] H007U12_n172ClienteTipoPessoa ;
      private bool[] H007U12_A174ClienteStatus ;
      private bool[] H007U12_n174ClienteStatus ;
      private int[] H007U12_A168ClienteId ;
      private string[] H007U12_A201ContatoEmail ;
      private bool[] H007U12_n201ContatoEmail ;
      private string[] H007U12_A170ClienteRazaoSocial ;
      private bool[] H007U12_n170ClienteRazaoSocial ;
      private GxSimpleCollection<string> AV30ComboTitles ;
      private string[] H007U13_A172ClienteTipoPessoa ;
      private bool[] H007U13_n172ClienteTipoPessoa ;
      private bool[] H007U13_A174ClienteStatus ;
      private bool[] H007U13_n174ClienteStatus ;
      private int[] H007U13_A168ClienteId ;
      private string[] H007U13_A169ClienteDocumento ;
      private bool[] H007U13_n169ClienteDocumento ;
      private string[] H007U13_A201ContatoEmail ;
      private bool[] H007U13_n201ContatoEmail ;
      private string[] H007U13_A170ClienteRazaoSocial ;
      private bool[] H007U13_n170ClienteRazaoSocial ;
   ...
   public class wpalterarproposta__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH007U11;
          prmH007U11 = new Object[] {
          };
          Object[] prmH007U12;
          prmH007U12 = new Object[] {
          new ParDef("AV46PropostaPacienteClienteId",GXType.Int32,9,0)
          };
          Object[] prmH007U13;
          prmH007U13 = new Object[] {
          new ParDef("AV46PropostaPacienteClienteId",GXType.Int32,9,0)
          };
          def= new CursorDef[] {
             ...
             ,new CursorDef("H007U5", "SELECT ContaProposta, ContaId FROM Conta WHERE ContaProposta ORDER BY ContaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U5,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007U6", "SELECT ContaId FROM Conta ORDER BY ContaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U6,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H007U7", "SELECT T1.PropostaId, T1.PropostaValor, T1.PropostaCratedBy, T1.PropostaPacienteClienteId AS PropostaPacienteClienteId, T2.EnderecoCEP AS PropostaPacienteEnderecoCEP, T2.EnderecoLogradouro AS PropostaPacienteEnderecoLogradouro, T2.EnderecoNumero AS PropostaPacienteEnderecoNumero, T2.EnderecoComplemento AS PropostaPacienteEnderecoComplemento, T2.EnderecoBairro AS PropostaPacienteEnderecoBairro, T2.MunicipioCodigo AS PropostaPacienteMunicipioCodigo FROM (Proposta T1 LEFT JOIN Cliente T2 ON T2.ClienteId = T1.PropostaPacienteClienteId) WHERE T1.PropostaId = :AV5PropostaId ORDER BY T1.PropostaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U7,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H007U8", "SELECT ConvenioCategoriaStatus, ConvenioCategoriaId, ConvenioCategoriaDescricao FROM ConvenioCategoria WHERE ConvenioCategoriaStatus ORDER BY ConvenioCategoriaDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U8,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007U9", "SELECT ConvenioId, ConvenioCategoriaStatus, ConvenioCategoriaId, ConvenioCategoriaDescricao FROM ConvenioCategoria WHERE (ConvenioCategoriaStatus) AND (ConvenioId = :AV14ConvenioId) ORDER BY ConvenioCategoriaDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U9,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007U10", "SELECT ConvenioStatus, ConvenioId, ConvenioDescricao FROM Convenio WHERE ConvenioStatus ORDER BY ConvenioDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U10,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007U11", "SELECT ProcedimentosMedicosId, ProcedimentosMedicosDescricao FROM ProcedimentosMedicos ORDER BY ProcedimentosMedicosDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U11,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007U12", "SELECT ClienteTipoPessoa, ClienteStatus, ClienteId, ContatoEmail, ClienteRazaoSocial FROM Cliente WHERE (ClienteId <> :AV46PropostaPacienteClienteId) AND (ClienteStatus) AND (ClienteTipoPessoa = ( 'FISICA')) ORDER BY ClienteRazaoSocial ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U12,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H007U13", "SELECT ClienteTipoPessoa, ClienteStatus, ClienteId, ClienteDocumento, ContatoEmail, ClienteRazaoSocial FROM Cliente WHERE (ClienteId <> :AV46PropostaPacienteClienteId and ClienteStatus) AND (ClienteTipoPessoa = ( 'FISICA')) ORDER BY ClienteRazaoSocial ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007U13,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
