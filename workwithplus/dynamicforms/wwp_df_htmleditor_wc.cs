   ...
   public class wwp_df_htmleditor_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_htmleditor_wc"+UrlEncode(StringUtil.RTrim(AV25WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV26WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV31WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV19SessionId,4,0));
      ...
      protected void WB1G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_htmleditor_wc");
               context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
               context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_htmleditor_wc")), "workwithplus.dynamicforms.wwp_df_htmleditor_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_htmleditor_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E121G2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASREFERENCEID", GetSecureSignedToken( sPrefix, AV13HasReferenceId, context));
         AV33GXV1 = 1;
         while ( AV33GXV1 <= AV29WWPFormInstance.gxTpr_Element.Count )
         {
            AV30WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV29WWPFormInstance.gxTpr_Element.Item(AV33GXV1));
      ...
      protected void E131G2( )
      {
         ...
         returnInSub = false;
         if ( ( AV6AuxSessionId == AV19SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV32ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV26WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV31WWPFormInstanceElementId), 4, 0))+"|") )
         {
      ...
      protected void S142( )
      {
         ...
         AV34GXV2 = 1;
         while ( AV34GXV2 <= AV29WWPFormInstance.gxTpr_Element.Count )
         {
            AV30WWPFormInstanceElement = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_FormInstance_Element)AV29WWPFormInstance.gxTpr_Element.Item(AV34GXV2));
            if ( ( AV30WWPFormInstanceElement.gxTpr_Wwpformelementid == AV26WWPFormElementId ) && ( AV30WWPFormInstanceElement.gxTpr_Wwpforminstanceelementid == AV31WWPFormInstanceElementId ) )
            {
      ...
      protected void S152( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV28WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV11ElementInternalName,  "true",  ""));
            AV16IsValid = false;
         }
         else
         {
            if ( AV21Validations.Count > 0 )
            {
               ...
               AV35GXV3 = 1;
               while ( AV35GXV3 <= AV18Messages.Count )
               {
                  AV17Message = ((GeneXus.Utils.SdtMessages_Message)AV18Messages.Item(AV35GXV3));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918382123", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_htmleditor_wc.js", "?202551918382123", false, true);
         context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
         context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV24WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV28WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV11ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV13HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E131G2","iparms":[{"av":"AV32ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV26WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV31WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV29WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV24WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV8Data","fld":"vDATA","type":"vchar"},{"av":"AV28WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV11ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV30WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV30WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV29WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E141G2","iparms":[{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV19SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV22VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV24WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV31WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV29WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV29WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV22VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         setEventMetadata("VDATA.KEYUP","""{"handler":"E111G2","iparms":[{"av":"AV13HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV19SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV29WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV26WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV31WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV24WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV8Data","fld":"vDATA","type":"vchar"},{"av":"AV28WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV11ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV30WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("VDATA.KEYUP",""","oparms":[{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV30WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV29WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV21Validations = new GXBaseCollection<WorkWithPlus.workwithplus_dynamicforms.SdtWWP_DF_Validation>( context, "WWP_DF_Validation", "Factory2");
         AV20ThisValueStr = "";
