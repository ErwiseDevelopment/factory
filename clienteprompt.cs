...
namespace GeneXus.Programs {
   public class clienteprompt : GXDataArea
   {
      ...
      public clienteprompt( IGxContext context )
      {
      ...
      public void execute( ref int aP0_InOutClienteId ,
                           ref string aP1_InOutClienteDocumento )
      {
         this.AV9InOutClienteId = aP0_InOutClienteId;
         this.AV10InOutClienteDocumento = aP1_InOutClienteDocumento;
         ExecuteImpl();
         aP0_InOutClienteId=this.AV9InOutClienteId;
         aP1_InOutClienteDocumento=this.AV10InOutClienteDocumento;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV9InOutClienteId = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV9InOutClienteId", StringUtil.LTrimStr( (decimal)(AV9InOutClienteId), 9, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV10InOutClienteDocumento = GetPar( "InOutClienteDocumento");
                  AssignAttri("", false, "AV10InOutClienteDocumento", AV10InOutClienteDocumento);
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("clienteprompt", new object[] {UrlEncode(StringUtil.LTrimStr(AV9InOutClienteId,9,0)),UrlEncode(StringUtil.RTrim(AV10InOutClienteDocumento))}, new string[] {"InOutClienteId","InOutClienteDocumento"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vINOUTCLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9InOutClienteId), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTCLIENTEDOCUMENTO", AV10InOutClienteDocumento);
      ...
      {
         return formatLink("clienteprompt", new object[] {UrlEncode(StringUtil.LTrimStr(AV9InOutClienteId,9,0)),UrlEncode(StringUtil.RTrim(AV10InOutClienteDocumento))}, new string[] {"InOutClienteId","InOutClienteDocumento"})  ;
      }
      ...
      protected void WB3U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_3U2( true) ;
         }
         else
         {
            wb_table1_14_3U2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_3U2e( bool wbgen )
      {
         if ( wbgen )
         {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              cmbEnderecoTipo.Name = cmbEnderecoTipo_Internalname;
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_CLIENTEDOCUMENTO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A169ClienteDocumento, "")), context));
      ...
      protected void RF3U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV13OrderedDsc } ,
                                                 new int[]{
                                                 TypeConstants.INT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT,
            ...
            lV14FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV14FilterFullText), "%", "");
            /* Using cursor H003U2 */
            pr_default.execute(0, new Object[] {lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_26_idx = 1;
            sGXsfl_26_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_26_idx), 4, 0), 4, "0");
            SubsflControlProps_262( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A182EnderecoCEP = H003U2_A182EnderecoCEP[0];
               n182EnderecoCEP = H003U2_n182EnderecoCEP[0];
               A181EnderecoTipo = H003U2_A181EnderecoTipo[0];
               n181EnderecoTipo = H003U2_n181EnderecoTipo[0];
               A177ClienteLogUser = H003U2_A177ClienteLogUser[0];
               n177ClienteLogUser = H003U2_n177ClienteLogUser[0];
               A176ClienteUpdatedAt = H003U2_A176ClienteUpdatedAt[0];
               n176ClienteUpdatedAt = H003U2_n176ClienteUpdatedAt[0];
               A175ClienteCreatedAt = H003U2_A175ClienteCreatedAt[0];
               n175ClienteCreatedAt = H003U2_n175ClienteCreatedAt[0];
               A174ClienteStatus = H003U2_A174ClienteStatus[0];
               n174ClienteStatus = H003U2_n174ClienteStatus[0];
               A192TipoClienteId = H003U2_A192TipoClienteId[0];
               n192TipoClienteId = H003U2_n192TipoClienteId[0];
               A172ClienteTipoPessoa = H003U2_A172ClienteTipoPessoa[0];
               n172ClienteTipoPessoa = H003U2_n172ClienteTipoPessoa[0];
               A171ClienteNomeFantasia = H003U2_A171ClienteNomeFantasia[0];
               n171ClienteNomeFantasia = H003U2_n171ClienteNomeFantasia[0];
               A170ClienteRazaoSocial = H003U2_A170ClienteRazaoSocial[0];
               n170ClienteRazaoSocial = H003U2_n170ClienteRazaoSocial[0];
               A169ClienteDocumento = H003U2_A169ClienteDocumento[0];
               n169ClienteDocumento = H003U2_n169ClienteDocumento[0];
               A168ClienteId = H003U2_A168ClienteId[0];
               /* Execute user event: Grid.Load */
               E173U2 ();
      ...
      protected void send_integrity_lvl_hashes3U2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV21Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV21Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CLIENTEID"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, context.localUtil.Format( (decimal)(A168ClienteId), "ZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CLIENTEDOCUMENTO"+"_"+sGXsfl_26_idx, GetSecureSignedToken( sGXsfl_26_idx, StringUtil.RTrim( context.localUtil.Format( A169ClienteDocumento, "")), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV14FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV14FilterFullText), "%", "");
         /* Using cursor H003U3 */
         pr_default.execute(1, new Object[] {lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText, lV14FilterFullText});
      ...
      protected void E183U2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9InOutClienteId = A168ClienteId;
         AssignAttri("", false, "AV9InOutClienteId", StringUtil.LTrimStr( (decimal)(AV9InOutClienteId), 9, 0));
         AV10InOutClienteDocumento = A169ClienteDocumento;
         AssignAttri("", false, "AV10InOutClienteDocumento", AV10InOutClienteDocumento);
         context.setWebReturnParms(new Object[] {(int)AV9InOutClienteId,(string)AV10InOutClienteDocumento});
         context.setWebReturnParmsMetadata(new Object[] {"AV9InOutClienteId","AV10InOutClienteDocumento"});
      ...
      protected void wb_table1_14_3U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCleanfilters_Internalname, "<i class=\"CleanFiltersIcon fas fa-filter\"></i>", "", "", lblCleanfilters_Jsonclick, "'"+""+"'"+",false,"+"'"+"E\\'DOCLEANFILTERS\\'."+"'", "", "TextBlock", 5, "Limpar filtros", 1, 1, 0, 1, "HLP_ClientePrompt.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9InOutClienteId = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV9InOutClienteId", StringUtil.LTrimStr( (decimal)(AV9InOutClienteId), 9, 0));
         AV10InOutClienteDocumento = (string)getParm(obj,1);
         AssignAttri("", false, "AV10InOutClienteDocumento", AV10InOutClienteDocumento);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019241352", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("clienteprompt.js", "?202561019241352", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_262( )
      {
         ...
         edtClienteDocumento_Internalname = "CLIENTEDOCUMENTO_"+sGXsfl_26_idx;
         edtClienteRazaoSocial_Internalname = "CLIENTERAZAOSOCIAL_"+sGXsfl_26_idx;
         edtClienteNomeFantasia_Internalname = "CLIENTENOMEFANTASIA_"+sGXsfl_26_idx;
         cmbClienteTipoPessoa_Internalname = "CLIENTETIPOPESSOA_"+sGXsfl_26_idx;
         edtTipoClienteId_Internalname = "TIPOCLIENTEID_"+sGXsfl_26_idx;
         cmbClienteStatus_Internalname = "CLIENTESTATUS_"+sGXsfl_26_idx;
         edtClienteCreatedAt_Internalname = "CLIENTECREATEDAT_"+sGXsfl_26_idx;
         edtClienteUpdatedAt_Internalname = "CLIENTEUPDATEDAT_"+sGXsfl_26_idx;
         edtClienteLogUser_Internalname = "CLIENTELOGUSER_"+sGXsfl_26_idx;
         cmbEnderecoTipo_Internalname = "ENDERECOTIPO_"+sGXsfl_26_idx;
         edtEnderecoCEP_Internalname = "ENDERECOCEP_"+sGXsfl_26_idx;
      }
      ...
      protected void SubsflControlProps_fel_262( )
      {
         ...
         edtClienteDocumento_Internalname = "CLIENTEDOCUMENTO_"+sGXsfl_26_fel_idx;
         edtClienteRazaoSocial_Internalname = "CLIENTERAZAOSOCIAL_"+sGXsfl_26_fel_idx;
         edtClienteNomeFantasia_Internalname = "CLIENTENOMEFANTASIA_"+sGXsfl_26_fel_idx;
         cmbClienteTipoPessoa_Internalname = "CLIENTETIPOPESSOA_"+sGXsfl_26_fel_idx;
         edtTipoClienteId_Internalname = "TIPOCLIENTEID_"+sGXsfl_26_fel_idx;
         cmbClienteStatus_Internalname = "CLIENTESTATUS_"+sGXsfl_26_fel_idx;
         edtClienteCreatedAt_Internalname = "CLIENTECREATEDAT_"+sGXsfl_26_fel_idx;
         edtClienteUpdatedAt_Internalname = "CLIENTEUPDATEDAT_"+sGXsfl_26_fel_idx;
         edtClienteLogUser_Internalname = "CLIENTELOGUSER_"+sGXsfl_26_fel_idx;
         cmbEnderecoTipo_Internalname = "ENDERECOTIPO_"+sGXsfl_26_fel_idx;
         edtEnderecoCEP_Internalname = "ENDERECOCEP_"+sGXsfl_26_fel_idx;
      }
      ...
      protected void sendrow_262( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_26_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "CLIENTETIPOPESSOA_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbClienteTipoPessoa_Internalname, "Values", (string)(cmbClienteTipoPessoa.ToJavascriptSource()), !bGXsfl_26_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            {
               GXCCtl = "CLIENTESTATUS_" + sGXsfl_26_idx;
            ...
            AssignProp("", false, cmbClienteStatus_Internalname, "Values", (string)(cmbClienteStatus.ToJavascriptSource()), !bGXsfl_26_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            if ( ( cmbEnderecoTipo.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               GXCCtl = "ENDERECOTIPO_" + sGXsfl_26_idx;
               cmbEnderecoTipo.Name = GXCCtl;
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbEnderecoTipo,(string)cmbEnderecoTipo_Internalname,StringUtil.RTrim( A181EnderecoTipo),(short)1,(string)cmbEnderecoTipo_Jsonclick,(short)0,(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",(short)-1,(short)0,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn hidden-xs",(string)"",(string)"",(string)"",(bool)true,(short)0});
            cmbEnderecoTipo.CurrentValue = StringUtil.RTrim( A181EnderecoTipo);
            AssignProp("", false, cmbEnderecoTipo_Internalname, "Values", (string)(cmbEnderecoTipo.ToJavascriptSource()), !bGXsfl_26_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEnderecoCEP_Internalname,(string)A182EnderecoCEP,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEnderecoCEP_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)26,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      protected void StartGridControl26( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Tipo Cliente Id") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A181EnderecoTipo));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A182EnderecoCEP));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:ClienteId|2:ClienteDocumento|3:ClienteRazaoSocial|4:ClienteNomeFantasia|5:ClienteTipoPessoa|6:TipoClienteId|7:ClienteStatus|8:ClienteCreatedAt|9:ClienteUpdatedAt|10:ClienteLogUser|11:EnderecoTipo|12:EnderecoCEP";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E173U2","iparms":[]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV20Select","fld":"vSELECT","type":"char"}]}""");
         setEventMetadata("ENTER","""{"handler":"E183U2","iparms":[{"av":"A168ClienteId","fld":"CLIENTEID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"A169ClienteDocumento","fld":"CLIENTEDOCUMENTO","hsh":true,"type":"svchar"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV9InOutClienteId","fld":"vINOUTCLIENTEID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV10InOutClienteDocumento","fld":"vINOUTCLIENTEDOCUMENTO","type":"svchar"}]}""");
         ...
         setEventMetadata("NULL","""{"handler":"Valid_Enderecocep","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         A182EnderecoCEP = "";
         lV14FilterFullText = "";
         H003U2_A182EnderecoCEP = new string[] {""} ;
         H003U2_n182EnderecoCEP = new bool[] {false} ;
         H003U2_A181EnderecoTipo = new string[] {""} ;
         H003U2_n181EnderecoTipo = new bool[] {false} ;
         H003U2_A177ClienteLogUser = new short[1] ;
         H003U2_n177ClienteLogUser = new bool[] {false} ;
         H003U2_A176ClienteUpdatedAt = new DateTime[] {DateTime.MinValue} ;
         H003U2_n176ClienteUpdatedAt = new bool[] {false} ;
         H003U2_A175ClienteCreatedAt = new DateTime[] {DateTime.MinValue} ;
         H003U2_n175ClienteCreatedAt = new bool[] {false} ;
         H003U2_A174ClienteStatus = new bool[] {false} ;
         H003U2_n174ClienteStatus = new bool[] {false} ;
         H003U2_A192TipoClienteId = new short[1] ;
         H003U2_n192TipoClienteId = new bool[] {false} ;
         H003U2_A172ClienteTipoPessoa = new string[] {""} ;
         H003U2_n172ClienteTipoPessoa = new bool[] {false} ;
         H003U2_A171ClienteNomeFantasia = new string[] {""} ;
         H003U2_n171ClienteNomeFantasia = new bool[] {false} ;
         H003U2_A170ClienteRazaoSocial = new string[] {""} ;
         H003U2_n170ClienteRazaoSocial = new bool[] {false} ;
         H003U2_A169ClienteDocumento = new string[] {""} ;
         H003U2_n169ClienteDocumento = new bool[] {false} ;
         H003U2_A168ClienteId = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clienteprompt__default(),
            new Object[][] {
                new Object[] {
               H003U2_A182EnderecoCEP, H003U2_n182EnderecoCEP, H003U2_A181EnderecoTipo, H003U2_n181EnderecoTipo, H003U2_A177ClienteLogUser, H003U2_n177ClienteLogUser, H003U2_A176ClienteUpdatedAt, H003U2_n176ClienteUpdatedAt, H003U2_A175ClienteCreatedAt, H003U2_n175ClienteCreatedAt,
               H003U2_A174ClienteStatus, H003U2_n174ClienteStatus, H003U2_A192TipoClienteId, H003U2_n192TipoClienteId, H003U2_A172ClienteTipoPessoa, H003U2_n172ClienteTipoPessoa, H003U2_A171ClienteNomeFantasia, H003U2_n171ClienteNomeFantasia, H003U2_A170ClienteRazaoSocial, H003U2_n170ClienteRazaoSocial,
               H003U2_A169ClienteDocumento, H003U2_n169ClienteDocumento, H003U2_A168ClienteId
               }
               , new Object[] {
      ...
      private int AV9InOutClienteId ;
      private int wcpOAV9InOutClienteId ;
      ...
      private string AV10InOutClienteDocumento ;
      private string wcpOAV10InOutClienteDocumento ;
      ...
      private string aP1_InOutClienteDocumento ;
      ...
      private string[] H003U2_A182EnderecoCEP ;
      private bool[] H003U2_n182EnderecoCEP ;
      private string[] H003U2_A181EnderecoTipo ;
      private bool[] H003U2_n181EnderecoTipo ;
      private short[] H003U2_A177ClienteLogUser ;
      private bool[] H003U2_n177ClienteLogUser ;
      private DateTime[] H003U2_A176ClienteUpdatedAt ;
      private bool[] H003U2_n176ClienteUpdatedAt ;
      private DateTime[] H003U2_A175ClienteCreatedAt ;
      private bool[] H003U2_n175ClienteCreatedAt ;
      private bool[] H003U2_A174ClienteStatus ;
      private bool[] H003U2_n174ClienteStatus ;
      private short[] H003U2_A192TipoClienteId ;
      private bool[] H003U2_n192TipoClienteId ;
      private string[] H003U2_A172ClienteTipoPessoa ;
      private bool[] H003U2_n172ClienteTipoPessoa ;
      private string[] H003U2_A171ClienteNomeFantasia ;
      private bool[] H003U2_n171ClienteNomeFantasia ;
      private string[] H003U2_A170ClienteRazaoSocial ;
      private bool[] H003U2_n170ClienteRazaoSocial ;
      private string[] H003U2_A169ClienteDocumento ;
      private bool[] H003U2_n169ClienteDocumento ;
      private int[] H003U2_A168ClienteId ;
   ...
   public class clienteprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003U2( IGxContext context ,
                                             ...
                                             short A177ClienteLogUser ,
                                             string A181EnderecoTipo ,
                                             string A182EnderecoCEP ,
                                             short AV12OrderedBy ,
                                             bool AV13OrderedDsc )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " EnderecoCEP, EnderecoTipo, ClienteLogUser, ClienteUpdatedAt, ClienteCreatedAt, ClienteStatus, TipoClienteId, ClienteTipoPessoa, ClienteNomeFantasia, ClienteRazaoSocial, ClienteDocumento, ClienteId";
         sFromString = " FROM Cliente";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV14FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(ClienteId,'999999999'), 2) like '%' || :lV14FilterFullText) or ( ClienteDocumento like '%' || :lV14FilterFullText) or ( ClienteRazaoSocial like '%' || :lV14FilterFullText) or ( ClienteNomeFantasia like '%' || :lV14FilterFullText) or ( 'física' like '%' || LOWER(:lV14FilterFullText) and ClienteTipoPessoa = ( 'FISICA')) or ( 'jurídica' like '%' || LOWER(:lV14FilterFullText) and ClienteTipoPessoa = ( 'JURIDICA')) or ( SUBSTR(TO_CHAR(TipoClienteId,'9999'), 2) like '%' || :lV14FilterFullText) or ( 'ativo' like '%' || LOWER(:lV14FilterFullText) and ClienteStatus = TRUE) or ( 'inativo' like '%' || LOWER(:lV14FilterFullText) and ClienteStatus = FALSE) or ( SUBSTR(TO_CHAR(ClienteLogUser,'9999'), 2) like '%' || :lV14FilterFullText) or ( 'cobrança' like '%' || LOWER(:lV14FilterFullText) and EnderecoTipo = ( 'COBRANCA')) or ( 'entrega' like '%' || LOWER(:lV14FilterFullText) and EnderecoTipo = ( 'ENTREGA')) or ( EnderecoCEP like '%' || :lV14FilterFullText))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            sOrderString += " ORDER BY ClienteDocumento DESC";
         }
         ...
         {
            sOrderString += " ORDER BY ClienteId DESC";
         }
         else if ( ( AV12OrderedBy == 3 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY ClienteRazaoSocial, ClienteId";
         }
         else if ( ( AV12OrderedBy == 3 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY ClienteRazaoSocial DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 4 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY ClienteNomeFantasia, ClienteId";
         }
         else if ( ( AV12OrderedBy == 4 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY ClienteNomeFantasia DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 5 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY ClienteTipoPessoa, ClienteId";
         }
         else if ( ( AV12OrderedBy == 5 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY ClienteTipoPessoa DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 6 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY TipoClienteId, ClienteId";
         }
         else if ( ( AV12OrderedBy == 6 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY TipoClienteId DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 7 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY ClienteStatus, ClienteId";
         }
         else if ( ( AV12OrderedBy == 7 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY ClienteStatus DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 8 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY ClienteCreatedAt, ClienteId";
         }
         else if ( ( AV12OrderedBy == 8 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY ClienteCreatedAt DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 9 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY ClienteUpdatedAt, ClienteId";
         }
         else if ( ( AV12OrderedBy == 9 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY ClienteUpdatedAt DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 10 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY ClienteLogUser, ClienteId";
         }
         else if ( ( AV12OrderedBy == 10 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY ClienteLogUser DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 11 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY EnderecoTipo, ClienteId";
         }
         else if ( ( AV12OrderedBy == 11 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY EnderecoTipo DESC, ClienteId";
         }
         else if ( ( AV12OrderedBy == 12 ) && ! AV13OrderedDsc )
         {
            sOrderString += " ORDER BY EnderecoCEP, ClienteId";
         }
         else if ( ( AV12OrderedBy == 12 ) && ( AV13OrderedDsc ) )
         {
            sOrderString += " ORDER BY EnderecoCEP DESC, ClienteId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY ClienteId";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003U2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] , (short)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (short)dynConstraints[11] , (bool)dynConstraints[12] );
               case 1 :
                     return conditional_H003U3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] , (short)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (short)dynConstraints[11] , (bool)dynConstraints[12] );
         }
