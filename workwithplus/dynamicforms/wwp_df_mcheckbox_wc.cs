   ...
   public class wwp_df_mcheckbox_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_mcheckbox_wc"+UrlEncode(StringUtil.RTrim(AV26WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV27WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV32WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV20SessionId,4,0));
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_mcheckbox_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_mcheckbox_wc");
            }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_mcheckbox_wc")), "workwithplus.dynamicforms.wwp_df_mcheckbox_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_mcheckbox_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      private void E141K2( )
      {
         ...
         while ( AV14i <= AV25WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Options.Count )
         {
            ...
            {
               AV9DataCellNameClass = "DataContentCellFL DataContentCellNoLabel";
            }
            else
            {
               AV9DataCellNameClass = "DataContentCellFL";
               if ( AV14i == 1 )
               {
                  if ( AV25WWP_DF_CharMetadata.gxTpr_Isrequired )
                  {
                     AV9DataCellNameClass = "RequiredDataContentCellFL " + AV9DataCellNameClass;
                  }
                  chkavData.Caption = AV29WWPFormElementTitle;
               }
            }
      ...
      protected void E111K2( )
      {
         ...
         returnInSub = false;
         if ( ( AV6AuxSessionId == AV20SessionId ) && ( StringUtil.StrCmp(divLayoutmaintable_Class, "Invisible") != 0 ) && StringUtil.Contains( AV36ErrorIds, "|"+StringUtil.Trim( StringUtil.Str( (decimal)(AV27WWPFormElementId), 4, 0))+"."+StringUtil.Trim( StringUtil.Str( (decimal)(AV32WWPFormInstanceElementId), 4, 0))+"|") )
         {
      ...
      protected void S152( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 é obrigatório.", AV29WWPFormElementTitle, "", "", "", "", "", "", "", ""),  "error",  AV11ElementInternalName,  "true",  ""));
            AV17IsValid = false;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918381839", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_mcheckbox_wc.js", "?202551918381839", false, true);
         }
      ...
      protected void sendrow_122( )
      {
         ...
         /* Div Control */
         FsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"form-group gx-form-group",(string)"start",(string)"top",(string)""+" data-gx-for=\""+chkavData_Internalname+"\"",(string)"",(string)"div"});
         /* Attribute/Variable Label */
         FsRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)chkavData_Internalname,chkavData.Caption,(string)"col-sm-3 AttributeFLLabel",(short)1,(bool)true,(string)""});
         /* Div Control */
         FsRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)"col-sm-9 gx-attribute",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
         /* Check box */
         ...
         FsRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkavData_Internalname,StringUtil.BoolToStr( AV8Data),(string)"",chkavData.Caption,(short)1,chkavData.Enabled,(string)"true",(string)"Data",(string)StyleString,(string)ClassString,(string)"",(string)"",TempTags+" onblur=\""+""+";gx.evt.onblur(this,18);\""});
         ...
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 25,'" + sPrefix + "',false,'" + sGXsfl_12_idx + "',12)\"";
      ...
      protected void StartGridControl12( )
      {
         ...
         else
         {
            ...
            FsColumn.AddObjectProperty("Caption", StringUtil.RTrim( chkavData.Caption));
            FsContainer.AddColumnProperties(FsColumn);
            FsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            FsContainer.AddColumnProperties(FsColumn);
            FsColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"FS_nFirstRecordOnPage","type":"int"},{"av":"FS_nEOF","type":"int"},{"av":"edtavDataname_Visible","ctrl":"vDATANAME","prop":"Visible"},{"av":"AV34DataCollection","fld":"vDATACOLLECTION","type":""},{"av":"sPrefix","type":"char"},{"av":"AV25WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV5WWPFormElementCaption","fld":"vWWPFORMELEMENTCAPTION","pic":"9","hsh":true,"type":"int"},{"av":"AV29WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV10DataEnabled","fld":"vDATAENABLED","hsh":true,"type":"boolean"},{"av":"AV11ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV13HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"}]}""");
         setEventMetadata("FS.LOAD","""{"handler":"E141K2","iparms":[{"av":"AV25WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV34DataCollection","fld":"vDATACOLLECTION","type":""},{"av":"AV5WWPFormElementCaption","fld":"vWWPFORMELEMENTCAPTION","pic":"9","hsh":true,"type":"int"},{"av":"AV29WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV10DataEnabled","fld":"vDATAENABLED","hsh":true,"type":"boolean"}]""");
         setEventMetadata("FS.LOAD",""","oparms":[{"av":"AV33DataName","fld":"vDATANAME","type":"svchar"},{"av":"AV8Data","fld":"vDATA","type":"boolean"},{"av":"chkavData.Caption","ctrl":"vDATA","prop":"Caption"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"},{"av":"chkavData.Enabled","ctrl":"vDATA","prop":"Enabled"}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE","""{"handler":"E111K2","iparms":[{"av":"AV36ErrorIds","fld":"vERRORIDS","type":"svchar"},{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV20SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"},{"av":"AV27WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV32WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV25WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV34DataCollection","fld":"vDATACOLLECTION","type":""},{"av":"AV29WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV11ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_VALIDATE",""","oparms":[{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES","""{"handler":"E121K2","iparms":[{"av":"AV6AuxSessionId","fld":"vAUXSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV20SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV23VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"AV25WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV32WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]""");
         setEventMetadata("GLOBALEVENTS.DYNAMICFORM_UPDATEVISIBILITIES",""","oparms":[{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV23VisibleCondition","fld":"vVISIBLECONDITION","type":""},{"av":"divLayoutmaintable_Class","ctrl":"LAYOUTMAINTABLE","prop":"Class"}]}""");
         setEventMetadata("VDATA.CLICK","""{"handler":"E151K2","iparms":[{"av":"AV8Data","fld":"vDATA","type":"boolean"},{"av":"AV33DataName","fld":"vDATANAME","type":"svchar"},{"av":"AV34DataCollection","fld":"vDATACOLLECTION","type":""},{"av":"AV13HasReferenceId","fld":"vHASREFERENCEID","hsh":true,"type":"boolean"},{"av":"AV20SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV27WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV32WWPFormInstanceElementId","fld":"vWWPFORMINSTANCEELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV25WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","hsh":true,"type":""},{"av":"AV29WWPFormElementTitle","fld":"vWWPFORMELEMENTTITLE","hsh":true,"type":"vchar"},{"av":"AV11ElementInternalName","fld":"vELEMENTINTERNALNAME","hsh":true,"type":"svchar"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""}]""");
         setEventMetadata("VDATA.CLICK",""","oparms":[{"av":"AV34DataCollection","fld":"vDATACOLLECTION","type":""},{"av":"AV12ExistElement","fld":"vEXISTELEMENT","type":"boolean"},{"av":"AV31WWPFormInstanceElement","fld":"vWWPFORMINSTANCEELEMENT","type":""},{"av":"AV30WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""}]}""");
