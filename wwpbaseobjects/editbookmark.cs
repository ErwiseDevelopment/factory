   ...
   public class editbookmark : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wwpbaseobjects.editbookmark"+UrlEncode(StringUtil.RTrim(AV16InBookmarkURL)) + "," + UrlEncode(StringUtil.RTrim(AV9BookmarkPageDescription));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("wwpbaseobjects.editbookmark") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB290( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wwpbaseobjects.editbookmark");
            }
            /* Div Control */
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnusercancel_Internalname, "", "Fechar", bttBtnusercancel_Jsonclick, 7, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11291_client"+"'", TempTags, "", 2, "HLP_WWPBaseObjects/EditBookmark.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.editbookmark")), "wwpbaseobjects.editbookmark") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.editbookmark")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20256101965210", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/editbookmark.js", "?20256101965211", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV29i","fld":"vI","pic":"ZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("'DODEL'","""{"handler":"E13292","iparms":[{"av":"AV29i","fld":"vI","pic":"ZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("'DOUSERCANCEL'","""{"handler":"E11291","iparms":[]}""");
         setEventMetadata("ENTER","""{"handler":"E14292","iparms":[{"av":"AV5BookmarkName","fld":"vBOOKMARKNAME","type":"svchar"},{"av":"AV10BookmarkURL","fld":"vBOOKMARKURL","type":"svchar"},{"av":"AV18IsEdit","fld":"vISEDIT","type":"boolean"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV5BookmarkName","fld":"vBOOKMARKNAME","type":"svchar"},{"av":"AV18IsEdit","fld":"vISEDIT","type":"boolean"}]}""");
