...
namespace GeneXus.Programs {
   public class assinarcontratoproposta : GXDataArea
   {
      public assinarcontratoproposta( )
      {
      ...
      public assinarcontratoproposta( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            ...
            GXEncryptionTmp = "assinarcontratoproposta"+UrlEncode(StringUtil.LTrimStr(AV46PropostaId,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV47PropostaContratoAssinaturaTipo)) + "," + UrlEncode(StringUtil.LTrimStr(AV50ReembolsoId,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("assinarcontratoproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vGXV5", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV72GXV5), 8, 0, ",", "")));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "assinarcontratoproposta"+UrlEncode(StringUtil.LTrimStr(AV46PropostaId,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV47PropostaContratoAssinaturaTipo)) + "," + UrlEncode(StringUtil.LTrimStr(AV50ReembolsoId,9,0));
         return formatLink("assinarcontratoproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "AssinarContratoProposta" ;
      }
      ...
      protected void WB9W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_9_9W2( true) ;
         }
         else
         {
            wb_table1_9_9W2( false) ;
         }
         return  ;
      }

      protected void wb_table1_9_9W2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_layoutcontratoid_Internalname, "Layout de contrato (Modelo)", "", "", lblTextblockcombo_layoutcontratoid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_AssinarContratoProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbl_Internalname, "Participantes", "", "", lblLbl_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_AssinarContratoProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 64 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavLayoutcontratoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22LayoutContratoId), 4, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV22LayoutContratoId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,95);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLayoutcontratoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavLayoutcontratoid_Visible, 1, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_AssinarContratoProposta.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void PA9W2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "assinarcontratoproposta")), "assinarcontratoproposta") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "assinarcontratoproposta")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void STRUP9W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV72GXV5 = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vGXV5"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E169W2( )
      {
         ...
         {
            A773EmpresaUtilizaRepresentanteAssinatura = H009W2_A773EmpresaUtilizaRepresentanteAssinatura[0];
            n773EmpresaUtilizaRepresentanteAssinatura = H009W2_n773EmpresaUtilizaRepresentanteAssinatura[0];
            A252EmpresaCNPJ = H009W2_A252EmpresaCNPJ[0];
            n252EmpresaCNPJ = H009W2_n252EmpresaCNPJ[0];
            A470EmpresaEmail = H009W2_A470EmpresaEmail[0];
            n470EmpresaEmail = H009W2_n470EmpresaEmail[0];
            A251EmpresaRazaoSocial = H009W2_A251EmpresaRazaoSocial[0];
            n251EmpresaRazaoSocial = H009W2_n251EmpresaRazaoSocial[0];
            A770EmpresaRepresentanteCPF = H009W2_A770EmpresaRepresentanteCPF[0];
            n770EmpresaRepresentanteCPF = H009W2_n770EmpresaRepresentanteCPF[0];
            A772EmpresaRepresentanteEmail = H009W2_A772EmpresaRepresentanteEmail[0];
            n772EmpresaRepresentanteEmail = H009W2_n772EmpresaRepresentanteEmail[0];
            A771EmpresaRepresentanteNome = H009W2_A771EmpresaRepresentanteNome[0];
            n771EmpresaRepresentanteNome = H009W2_n771EmpresaRepresentanteNome[0];
         ...
         {
            A323PropostaId = H009W3_A323PropostaId[0];
            n323PropostaId = H009W3_n323PropostaId[0];
            A504PropostaPacienteClienteId = H009W3_A504PropostaPacienteClienteId[0];
            n504PropostaPacienteClienteId = H009W3_n504PropostaPacienteClienteId[0];
            A553PropostaResponsavelId = H009W3_A553PropostaResponsavelId[0];
            n553PropostaResponsavelId = H009W3_n553PropostaResponsavelId[0];
            A505PropostaPacienteClienteRazaoSocial = H009W3_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = H009W3_n505PropostaPacienteClienteRazaoSocial[0];
            A328PropostaCratedBy = H009W3_A328PropostaCratedBy[0];
            n328PropostaCratedBy = H009W3_n328PropostaCratedBy[0];
            A505PropostaPacienteClienteRazaoSocial = H009W3_A505PropostaPacienteClienteRazaoSocial[0];
            n505PropostaPacienteClienteRazaoSocial = H009W3_n505PropostaPacienteClienteRazaoSocial[0];
         ...
         if ( ! ( StringUtil.StrCmp(AV47PropostaContratoAssinaturaTipo, "Documento") == 0 ) )
         {
            ...
            {
               A398ConfiguracoesLayoutProposta = H009W4_A398ConfiguracoesLayoutProposta[0];
               n398ConfiguracoesLayoutProposta = H009W4_n398ConfiguracoesLayoutProposta[0];
               A564ConfigLayoutPromissoriaClinicaEmprestimo = H009W4_A564ConfigLayoutPromissoriaClinicaEmprestimo[0];
               n564ConfigLayoutPromissoriaClinicaEmprestimo = H009W4_n564ConfigLayoutPromissoriaClinicaEmprestimo[0];
               A565ConfigLayoutPromissoriaClinicaTaxa = H009W4_A565ConfigLayoutPromissoriaClinicaTaxa[0];
               n565ConfigLayoutPromissoriaClinicaTaxa = H009W4_n565ConfigLayoutPromissoriaClinicaTaxa[0];
               A566ConfigLayoutPromissoriaPaciente = H009W4_A566ConfigLayoutPromissoriaPaciente[0];
               n566ConfigLayoutPromissoriaPaciente = H009W4_n566ConfigLayoutPromissoriaPaciente[0];
               A418ConfiguracoesLayoutContratoCorpo = H009W4_A418ConfiguracoesLayoutContratoCorpo[0];
               n418ConfiguracoesLayoutContratoCorpo = H009W4_n418ConfiguracoesLayoutContratoCorpo[0];
               A569ConfigLayoutCorpoPromissoriaPaciente = H009W4_A569ConfigLayoutCorpoPromissoriaPaciente[0];
               n569ConfigLayoutCorpoPromissoriaPaciente = H009W4_n569ConfigLayoutCorpoPromissoriaPaciente[0];
               A567ConfigLayoutCorpoPromissoriaClinicaEmprestimo = H009W4_A567ConfigLayoutCorpoPromissoriaClinicaEmprestimo[0];
               n567ConfigLayoutCorpoPromissoriaClinicaEmprestimo = H009W4_n567ConfigLayoutCorpoPromissoriaClinicaEmprestimo[0];
               A568ConfigLayoutCorpoPromissoriaClinicaTaxa = H009W4_A568ConfigLayoutCorpoPromissoriaClinicaTaxa[0];
               n568ConfigLayoutCorpoPromissoriaClinicaTaxa = H009W4_n568ConfigLayoutCorpoPromissoriaClinicaTaxa[0];
               A418ConfiguracoesLayoutContratoCorpo = H009W4_A418ConfiguracoesLayoutContratoCorpo[0];
               n418ConfiguracoesLayoutContratoCorpo = H009W4_n418ConfiguracoesLayoutContratoCorpo[0];
               A567ConfigLayoutCorpoPromissoriaClinicaEmprestimo = H009W4_A567ConfigLayoutCorpoPromissoriaClinicaEmprestimo[0];
               n567ConfigLayoutCorpoPromissoriaClinicaEmprestimo = H009W4_n567ConfigLayoutCorpoPromissoriaClinicaEmprestimo[0];
            ...
            if ( ( StringUtil.StrCmp(AV47PropostaContratoAssinaturaTipo, "Contrato") == 0 ) || ( StringUtil.StrCmp(AV47PropostaContratoAssinaturaTipo, "Nota_promissoria") == 0 ) )
            {
               ...
               {
                  A168ClienteId = H009W5_A168ClienteId[0];
                  A172ClienteTipoPessoa = H009W5_A172ClienteTipoPessoa[0];
                  n172ClienteTipoPessoa = H009W5_n172ClienteTipoPessoa[0];
                  A169ClienteDocumento = H009W5_A169ClienteDocumento[0];
                  n169ClienteDocumento = H009W5_n169ClienteDocumento[0];
                  A201ContatoEmail = H009W5_A201ContatoEmail[0];
                  n201ContatoEmail = H009W5_n201ContatoEmail[0];
                  A170ClienteRazaoSocial = H009W5_A170ClienteRazaoSocial[0];
                  n170ClienteRazaoSocial = H009W5_n170ClienteRazaoSocial[0];
                  A447ResponsavelCPF = H009W5_A447ResponsavelCPF[0];
                  n447ResponsavelCPF = H009W5_n447ResponsavelCPF[0];
                  A456ResponsavelEmail = H009W5_A456ResponsavelEmail[0];
                  n456ResponsavelEmail = H009W5_n456ResponsavelEmail[0];
                  A436ResponsavelNome = H009W5_A436ResponsavelNome[0];
                  n436ResponsavelNome = H009W5_n436ResponsavelNome[0];
            ...
            if ( ( StringUtil.StrCmp(AV47PropostaContratoAssinaturaTipo, "Contrato") == 0 ) || ( StringUtil.StrCmp(AV47PropostaContratoAssinaturaTipo, "Nota_promissoria_clinica_taxa") == 0 ) || ( StringUtil.StrCmp(AV47PropostaContratoAssinaturaTipo, "Nota_promissoria_clinica") == 0 ) )
            {
               ...
               {
                  A133SecUserId = H009W6_A133SecUserId[0];
                  n133SecUserId = H009W6_n133SecUserId[0];
                  A226SecUserOwnerId = H009W6_A226SecUserOwnerId[0];
                  n226SecUserOwnerId = H009W6_n226SecUserOwnerId[0];
               ...
               {
                  A168ClienteId = H009W7_A168ClienteId[0];
                  A169ClienteDocumento = H009W7_A169ClienteDocumento[0];
                  n169ClienteDocumento = H009W7_n169ClienteDocumento[0];
                  A201ContatoEmail = H009W7_A201ContatoEmail[0];
                  n201ContatoEmail = H009W7_n201ContatoEmail[0];
                  A170ClienteRazaoSocial = H009W7_A170ClienteRazaoSocial[0];
                  n170ClienteRazaoSocial = H009W7_n170ClienteRazaoSocial[0];
                  A447ResponsavelCPF = H009W7_A447ResponsavelCPF[0];
                  n447ResponsavelCPF = H009W7_n447ResponsavelCPF[0];
                  A456ResponsavelEmail = H009W7_A456ResponsavelEmail[0];
                  n456ResponsavelEmail = H009W7_n456ResponsavelEmail[0];
                  A436ResponsavelNome = H009W7_A436ResponsavelNome[0];
                  n436ResponsavelNome = H009W7_n436ResponsavelNome[0];
                  AV11SdParticipantes = new SdtSdParticipantes(context);
         ...
         /* Using cursor H009W8 */
         pr_default.execute(6, new Object[] {AV57WWPContext.gxTpr_Userid});
         while ( (pr_default.getStatus(6) != 101) )
         {
            A133SecUserId = H009W8_A133SecUserId[0];
            n133SecUserId = H009W8_n133SecUserId[0];
            A479ConfiguracoesTestemunhasNome = H009W8_A479ConfiguracoesTestemunhasNome[0];
            n479ConfiguracoesTestemunhasNome = H009W8_n479ConfiguracoesTestemunhasNome[0];
            A480ConfiguracoesTestemunhasDocumento = H009W8_A480ConfiguracoesTestemunhasDocumento[0];
            n480ConfiguracoesTestemunhasDocumento = H009W8_n480ConfiguracoesTestemunhasDocumento[0];
            A481ConfiguracoesTestemunhasEmail = H009W8_A481ConfiguracoesTestemunhasEmail[0];
            n481ConfiguracoesTestemunhasEmail = H009W8_n481ConfiguracoesTestemunhasEmail[0];
            AV11SdParticipantes = new SdtSdParticipantes(context);
      ...
      private void E179W2( )
      {
         ...
         returnInSub = false;
         AV65GXV1 = 1;
         while ( AV65GXV1 <= AV10Array_SdParticipantes.Count )
         {
            AV11SdParticipantes = ((SdtSdParticipantes)AV10Array_SdParticipantes.Item(AV65GXV1));
            AV5NomeParticipante = AV11SdParticipantes.gxTpr_Participantenome;
            AssignAttri("", false, edtavNomeparticipante_Internalname, AV5NomeParticipante);
            AV13HTMLLine = StringUtil.Format( "<div class=\"participant-detail\"><span class=\"participant-label\">Função:</span> %1%2</div>", AV11SdParticipantes.gxTpr_Assinaturaparticipantetipo, (String.IsNullOrEmpty(StringUtil.RTrim( AV11SdParticipantes.gxTpr_Descricao)) ? "" : StringUtil.Format( "(%1)", AV11SdParticipantes.gxTpr_Descricao, "", "", "", "", "", "", "", "")), "", "", "", "", "", "", "");
      ...
      protected void E129W2( )
      {
         ...
         AV66GXV2 = 1;
         while ( AV66GXV2 <= AV10Array_SdParticipantes.Count )
         {
            AV11SdParticipantes = ((SdtSdParticipantes)AV10Array_SdParticipantes.Item(AV66GXV2));
         ...
         if ( AV33IsHasContratado && AV32IsHasContratante && AV44IsArqOk && ! String.IsNullOrEmpty(StringUtil.RTrim( AV9NomeContrato)) )
         {
            ...
            if ( AV38Contrato.Success() )
            {
               ...
               AV67GXV3 = 1;
               while ( AV67GXV3 <= AV10Array_SdParticipantes.Count )
               {
                  AV11SdParticipantes = ((SdtSdParticipantes)AV10Array_SdParticipantes.Item(AV67GXV3));
               ...
               {
                  GXt_char2 = AV40SdErro.gxTpr_Msg;
                  new message(context ).gxep_erro( ref  GXt_char2) ;
                  AV40SdErro.gxTpr_Msg = GXt_char2;
               }
               else
               {
                  if ( ! ( StringUtil.StrCmp(AV47PropostaContratoAssinaturaTipo, "Documento") == 0 ) )
                  {
                     /* Using cursor H009W9 */
                     pr_default.execute(7, new Object[] {AV46PropostaId, AV47PropostaContratoAssinaturaTipo});
                     while ( (pr_default.getStatus(7) != 101) )
                     {
                        A573PropostaContratoAssinaturaTipo = H009W9_A573PropostaContratoAssinaturaTipo[0];
                        n573PropostaContratoAssinaturaTipo = H009W9_n573PropostaContratoAssinaturaTipo[0];
                        A323PropostaId = H009W9_A323PropostaId[0];
                        n323PropostaId = H009W9_n323PropostaId[0];
                        A571PropostaAssinatura = H009W9_A571PropostaAssinatura[0];
                        n571PropostaAssinatura = H009W9_n571PropostaAssinatura[0];
                        if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
                        {
                  ...
                  else
                  {
                     ...
                     {
                        context.CommitDataStores("assinarcontratoproposta",pr_default);
                     }
                  }
      ...
      protected void E159W2( )
      {
         ...
         AV16i = 0;
         AV69GXV4 = 1;
         while ( AV69GXV4 <= AV10Array_SdParticipantes.Count )
         {
            AV11SdParticipantes = ((SdtSdParticipantes)AV10Array_SdParticipantes.Item(AV69GXV4));
            AV16i = (short)(AV16i+1);
      ...
      protected void E119W2( )
      {
         ...
         {
            /* Using cursor H009W10 */
            pr_default.execute(8, new Object[] {AV22LayoutContratoId});
            while ( (pr_default.getStatus(8) != 101) )
            {
               A154LayoutContratoId = H009W10_A154LayoutContratoId[0];
               A157LayoutContratoCorpo = H009W10_A157LayoutContratoCorpo[0];
               n157LayoutContratoCorpo = H009W10_n157LayoutContratoCorpo[0];
               AV43HTML = A157LayoutContratoCorpo;
               new prtrocataghtml(context ).execute(  AV46PropostaId,  0, ref  AV43HTML) ;
               AV8Corpo = AV43HTML;
               AssignAttri("", false, "AV8Corpo", AV8Corpo);
               /* Exiting from a For First loop. */
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         /* Using cursor H009W11 */
         pr_default.execute(9);
         while ( (pr_default.getStatus(9) != 101) )
         {
            A906LayoutContratoTipo = H009W11_A906LayoutContratoTipo[0];
            n906LayoutContratoTipo = H009W11_n906LayoutContratoTipo[0];
            A156LayoutContratoStatus = H009W11_A156LayoutContratoStatus[0];
            n156LayoutContratoStatus = H009W11_n156LayoutContratoStatus[0];
            A154LayoutContratoId = H009W11_A154LayoutContratoId[0];
            A155LayoutContratoDescricao = H009W11_A155LayoutContratoDescricao[0];
            n155LayoutContratoDescricao = H009W11_n155LayoutContratoDescricao[0];
      ...
      protected void wb_table1_9_9W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "Fechar", bttBtn_cancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_AssinarContratoProposta.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 14,'',false,'',0)\"";
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenviarparaassinatura_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "Enviar para assinatura", bttBtnenviarparaassinatura_Jsonclick, 5, "Enviar para assinatura", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOENVIARPARAASSINATURA\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AssinarContratoProposta.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_9_9W2e( true) ;
         }
         else
         {
            wb_table1_9_9W2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019285715", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("assinarcontratoproposta.js", "?202561019285716", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FREEGRID.LOAD","""{"handler":"E179W2","iparms":[{"av":"AV10Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""}]""");
         ...
         setEventMetadata("'DOEDITAR'","""{"handler":"E149W2","iparms":[{"av":"AV10Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""},{"av":"AV14GRIDJSON","fld":"vGRIDJSON","type":"vchar"}]}""");
         ...
         setEventMetadata("'DOADICIONARPARTICIPANTE'","""{"handler":"E139W2","iparms":[{"av":"FREEGRID_nFirstRecordOnPage","type":"int"},{"av":"FREEGRID_nEOF","type":"int"},{"av":"edtavGridjson_Visible","ctrl":"vGRIDJSON","prop":"Visible"},{"av":"AV10Array_SdParticipantes","fld":"vARRAY_SDPARTICIPANTES","type":""},{"av":"AV30Tipo","fld":"vTIPO","hsh":true,"type":"boolean"},{"av":"AV29StringBase64","fld":"vSTRINGBASE64","hsh":true,"type":"vchar"},{"av":"AV39ContratoId","fld":"vCONTRATOID","pic":"ZZZZZ9","hsh":true,"type":"int"},{"av":"AV25ClienteId","fld":"vCLIENTEID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV46PropostaId","fld":"vPROPOSTAID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV47PropostaContratoAssinaturaTipo","fld":"vPROPOSTACONTRATOASSINATURATIPO","hsh":true,"type":"svchar"},{"av":"AV50ReembolsoId","fld":"vREEMBOLSOID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]}""");
         setEventMetadata("COMBO_LAYOUTCONTRATOID.ONOPTIONCLICKED","""{"handler":"E119W2","iparms":[{"av":"Combo_layoutcontratoid_Selectedvalue_get","ctrl":"COMBO_LAYOUTCONTRATOID","prop":"SelectedValue_get"},{"av":"A154LayoutContratoId","fld":"LAYOUTCONTRATOID","pic":"ZZZ9","type":"int"},{"av":"A157LayoutContratoCorpo","fld":"LAYOUTCONTRATOCORPO","type":"vchar"},{"av":"AV46PropostaId","fld":"vPROPOSTAID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"}]""");
      ...
      public override void initialize( )
      {
         ...
         H009W2_A249EmpresaId = new int[1] ;
         H009W2_A773EmpresaUtilizaRepresentanteAssinatura = new bool[] {false} ;
         H009W2_n773EmpresaUtilizaRepresentanteAssinatura = new bool[] {false} ;
         H009W2_A252EmpresaCNPJ = new string[] {""} ;
         H009W2_n252EmpresaCNPJ = new bool[] {false} ;
         H009W2_A470EmpresaEmail = new string[] {""} ;
         H009W2_n470EmpresaEmail = new bool[] {false} ;
         H009W2_A251EmpresaRazaoSocial = new string[] {""} ;
         H009W2_n251EmpresaRazaoSocial = new bool[] {false} ;
         H009W2_A770EmpresaRepresentanteCPF = new string[] {""} ;
         H009W2_n770EmpresaRepresentanteCPF = new bool[] {false} ;
         H009W2_A772EmpresaRepresentanteEmail = new string[] {""} ;
         H009W2_n772EmpresaRepresentanteEmail = new bool[] {false} ;
         H009W2_A771EmpresaRepresentanteNome = new string[] {""} ;
         H009W2_n771EmpresaRepresentanteNome = new bool[] {false} ;
         A252EmpresaCNPJ = "";
         A470EmpresaEmail = "";
         ...
         H009W3_A323PropostaId = new int[1] ;
         H009W3_n323PropostaId = new bool[] {false} ;
         H009W3_A504PropostaPacienteClienteId = new int[1] ;
         H009W3_n504PropostaPacienteClienteId = new bool[] {false} ;
         H009W3_A553PropostaResponsavelId = new int[1] ;
         H009W3_n553PropostaResponsavelId = new bool[] {false} ;
         H009W3_A505PropostaPacienteClienteRazaoSocial = new string[] {""} ;
         H009W3_n505PropostaPacienteClienteRazaoSocial = new bool[] {false} ;
         H009W3_A328PropostaCratedBy = new short[1] ;
         H009W3_n328PropostaCratedBy = new bool[] {false} ;
         A505PropostaPacienteClienteRazaoSocial = "";
         AV56PropostaPacienteClienteRazaoSocial = "";
         H009W4_A299ConfiguracoesId = new int[1] ;
         H009W4_A398ConfiguracoesLayoutProposta = new short[1] ;
         H009W4_n398ConfiguracoesLayoutProposta = new bool[] {false} ;
         H009W4_A564ConfigLayoutPromissoriaClinicaEmprestimo = new short[1] ;
         H009W4_n564ConfigLayoutPromissoriaClinicaEmprestimo = new bool[] {false} ;
         H009W4_A565ConfigLayoutPromissoriaClinicaTaxa = new short[1] ;
         H009W4_n565ConfigLayoutPromissoriaClinicaTaxa = new bool[] {false} ;
         H009W4_A566ConfigLayoutPromissoriaPaciente = new short[1] ;
         H009W4_n566ConfigLayoutPromissoriaPaciente = new bool[] {false} ;
         H009W4_A418ConfiguracoesLayoutContratoCorpo = new string[] {""} ;
         H009W4_n418ConfiguracoesLayoutContratoCorpo = new bool[] {false} ;
         H009W4_A569ConfigLayoutCorpoPromissoriaPaciente = new string[] {""} ;
         H009W4_n569ConfigLayoutCorpoPromissoriaPaciente = new bool[] {false} ;
         H009W4_A567ConfigLayoutCorpoPromissoriaClinicaEmprestimo = new string[] {""} ;
         H009W4_n567ConfigLayoutCorpoPromissoriaClinicaEmprestimo = new bool[] {false} ;
         H009W4_A568ConfigLayoutCorpoPromissoriaClinicaTaxa = new string[] {""} ;
         H009W4_n568ConfigLayoutCorpoPromissoriaClinicaTaxa = new bool[] {false} ;
         ...
         AV43HTML = "";
         H009W5_A168ClienteId = new int[1] ;
         H009W5_A172ClienteTipoPessoa = new string[] {""} ;
         H009W5_n172ClienteTipoPessoa = new bool[] {false} ;
         H009W5_A169ClienteDocumento = new string[] {""} ;
         H009W5_n169ClienteDocumento = new bool[] {false} ;
         H009W5_A201ContatoEmail = new string[] {""} ;
         H009W5_n201ContatoEmail = new bool[] {false} ;
         H009W5_A170ClienteRazaoSocial = new string[] {""} ;
         H009W5_n170ClienteRazaoSocial = new bool[] {false} ;
         H009W5_A447ResponsavelCPF = new string[] {""} ;
         H009W5_n447ResponsavelCPF = new bool[] {false} ;
         H009W5_A456ResponsavelEmail = new string[] {""} ;
         H009W5_n456ResponsavelEmail = new bool[] {false} ;
         H009W5_A436ResponsavelNome = new string[] {""} ;
         H009W5_n436ResponsavelNome = new bool[] {false} ;
         ...
         A436ResponsavelNome = "";
         H009W6_A133SecUserId = new short[1] ;
         H009W6_n133SecUserId = new bool[] {false} ;
         H009W6_A226SecUserOwnerId = new int[1] ;
         H009W6_n226SecUserOwnerId = new bool[] {false} ;
         H009W7_A168ClienteId = new int[1] ;
         H009W7_A169ClienteDocumento = new string[] {""} ;
         H009W7_n169ClienteDocumento = new bool[] {false} ;
         H009W7_A201ContatoEmail = new string[] {""} ;
         H009W7_n201ContatoEmail = new bool[] {false} ;
         H009W7_A170ClienteRazaoSocial = new string[] {""} ;
         H009W7_n170ClienteRazaoSocial = new bool[] {false} ;
         H009W7_A447ResponsavelCPF = new string[] {""} ;
         H009W7_n447ResponsavelCPF = new bool[] {false} ;
         H009W7_A456ResponsavelEmail = new string[] {""} ;
         H009W7_n456ResponsavelEmail = new bool[] {false} ;
         H009W7_A436ResponsavelNome = new string[] {""} ;
         H009W7_n436ResponsavelNome = new bool[] {false} ;
         H009W8_A478ConfiguracoesTestemunhasId = new int[1] ;
         H009W8_A133SecUserId = new short[1] ;
         H009W8_n133SecUserId = new bool[] {false} ;
         H009W8_A479ConfiguracoesTestemunhasNome = new string[] {""} ;
         H009W8_n479ConfiguracoesTestemunhasNome = new bool[] {false} ;
         H009W8_A480ConfiguracoesTestemunhasDocumento = new string[] {""} ;
         H009W8_n480ConfiguracoesTestemunhasDocumento = new bool[] {false} ;
         H009W8_A481ConfiguracoesTestemunhasEmail = new string[] {""} ;
         H009W8_n481ConfiguracoesTestemunhasEmail = new bool[] {false} ;
         ...
         H009W9_A572PropostaContratoAssinaturaId = new int[1] ;
         H009W9_A573PropostaContratoAssinaturaTipo = new string[] {""} ;
         H009W9_n573PropostaContratoAssinaturaTipo = new bool[] {false} ;
         H009W9_A323PropostaId = new int[1] ;
         H009W9_n323PropostaId = new bool[] {false} ;
         H009W9_A571PropostaAssinatura = new long[1] ;
         H009W9_n571PropostaAssinatura = new bool[] {false} ;
         AV49ReembolsoAssinaturas = new SdtReembolsoAssinaturas(context);
         GXt_char2 = "";
         AV20WEBSESSIon = context.GetSession();
         AV17InJSON = "";
         AV18Array_JSON = "";
         H009W10_A154LayoutContratoId = new short[1] ;
         H009W10_A157LayoutContratoCorpo = new string[] {""} ;
         H009W10_n157LayoutContratoCorpo = new bool[] {false} ;
         H009W11_A906LayoutContratoTipo = new string[] {""} ;
         H009W11_n906LayoutContratoTipo = new bool[] {false} ;
         H009W11_A156LayoutContratoStatus = new bool[] {false} ;
         H009W11_n156LayoutContratoStatus = new bool[] {false} ;
         H009W11_A154LayoutContratoId = new short[1] ;
         H009W11_A155LayoutContratoDescricao = new string[] {""} ;
         H009W11_n155LayoutContratoDescricao = new bool[] {false} ;
         ...
         subFreegrid_Header = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.assinarcontratoproposta__default(),
            new Object[][] {
                new Object[] {
               H009W2_A249EmpresaId, H009W2_A773EmpresaUtilizaRepresentanteAssinatura, H009W2_n773EmpresaUtilizaRepresentanteAssinatura, H009W2_A252EmpresaCNPJ, H009W2_n252EmpresaCNPJ, H009W2_A470EmpresaEmail, H009W2_n470EmpresaEmail, H009W2_A251EmpresaRazaoSocial, H009W2_n251EmpresaRazaoSocial, H009W2_A770EmpresaRepresentanteCPF,
               H009W2_n770EmpresaRepresentanteCPF, H009W2_A772EmpresaRepresentanteEmail, H009W2_n772EmpresaRepresentanteEmail, H009W2_A771EmpresaRepresentanteNome, H009W2_n771EmpresaRepresentanteNome
               }
               , new Object[] {
               H009W3_A323PropostaId, H009W3_A504PropostaPacienteClienteId, H009W3_n504PropostaPacienteClienteId, H009W3_A553PropostaResponsavelId, H009W3_n553PropostaResponsavelId, H009W3_A505PropostaPacienteClienteRazaoSocial, H009W3_n505PropostaPacienteClienteRazaoSocial, H009W3_A328PropostaCratedBy, H009W3_n328PropostaCratedBy
               }
               , new Object[] {
               H009W4_A299ConfiguracoesId, H009W4_A398ConfiguracoesLayoutProposta, H009W4_n398ConfiguracoesLayoutProposta, H009W4_A564ConfigLayoutPromissoriaClinicaEmprestimo, H009W4_n564ConfigLayoutPromissoriaClinicaEmprestimo, H009W4_A565ConfigLayoutPromissoriaClinicaTaxa, H009W4_n565ConfigLayoutPromissoriaClinicaTaxa, H009W4_A566ConfigLayoutPromissoriaPaciente, H009W4_n566ConfigLayoutPromissoriaPaciente, H009W4_A418ConfiguracoesLayoutContratoCorpo,
               H009W4_n418ConfiguracoesLayoutContratoCorpo, H009W4_A569ConfigLayoutCorpoPromissoriaPaciente, H009W4_n569ConfigLayoutCorpoPromissoriaPaciente, H009W4_A567ConfigLayoutCorpoPromissoriaClinicaEmprestimo, H009W4_n567ConfigLayoutCorpoPromissoriaClinicaEmprestimo, H009W4_A568ConfigLayoutCorpoPromissoriaClinicaTaxa, H009W4_n568ConfigLayoutCorpoPromissoriaClinicaTaxa
               }
               , new Object[] {
               H009W5_A168ClienteId, H009W5_A172ClienteTipoPessoa, H009W5_n172ClienteTipoPessoa, H009W5_A169ClienteDocumento, H009W5_n169ClienteDocumento, H009W5_A201ContatoEmail, H009W5_n201ContatoEmail, H009W5_A170ClienteRazaoSocial, H009W5_n170ClienteRazaoSocial, H009W5_A447ResponsavelCPF,
               H009W5_n447ResponsavelCPF, H009W5_A456ResponsavelEmail, H009W5_n456ResponsavelEmail, H009W5_A436ResponsavelNome, H009W5_n436ResponsavelNome
               }
               , new Object[] {
               H009W6_A133SecUserId, H009W6_A226SecUserOwnerId, H009W6_n226SecUserOwnerId
               }
               , new Object[] {
               H009W7_A168ClienteId, H009W7_A169ClienteDocumento, H009W7_n169ClienteDocumento, H009W7_A201ContatoEmail, H009W7_n201ContatoEmail, H009W7_A170ClienteRazaoSocial, H009W7_n170ClienteRazaoSocial, H009W7_A447ResponsavelCPF, H009W7_n447ResponsavelCPF, H009W7_A456ResponsavelEmail,
               H009W7_n456ResponsavelEmail, H009W7_A436ResponsavelNome, H009W7_n436ResponsavelNome
               }
               , new Object[] {
               H009W8_A478ConfiguracoesTestemunhasId, H009W8_A133SecUserId, H009W8_n133SecUserId, H009W8_A479ConfiguracoesTestemunhasNome, H009W8_n479ConfiguracoesTestemunhasNome, H009W8_A480ConfiguracoesTestemunhasDocumento, H009W8_n480ConfiguracoesTestemunhasDocumento, H009W8_A481ConfiguracoesTestemunhasEmail, H009W8_n481ConfiguracoesTestemunhasEmail
               }
               , new Object[] {
               H009W9_A572PropostaContratoAssinaturaId, H009W9_A573PropostaContratoAssinaturaTipo, H009W9_n573PropostaContratoAssinaturaTipo, H009W9_A323PropostaId, H009W9_n323PropostaId, H009W9_A571PropostaAssinatura, H009W9_n571PropostaAssinatura
               }
               , new Object[] {
               H009W10_A154LayoutContratoId, H009W10_A157LayoutContratoCorpo, H009W10_n157LayoutContratoCorpo
               }
               , new Object[] {
               H009W11_A906LayoutContratoTipo, H009W11_n906LayoutContratoTipo, H009W11_A156LayoutContratoStatus, H009W11_n156LayoutContratoStatus, H009W11_A154LayoutContratoId, H009W11_A155LayoutContratoDescricao, H009W11_n155LayoutContratoDescricao
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] H009W2_A249EmpresaId ;
      private bool[] H009W2_A773EmpresaUtilizaRepresentanteAssinatura ;
      private bool[] H009W2_n773EmpresaUtilizaRepresentanteAssinatura ;
      private string[] H009W2_A252EmpresaCNPJ ;
      private bool[] H009W2_n252EmpresaCNPJ ;
      private string[] H009W2_A470EmpresaEmail ;
      private bool[] H009W2_n470EmpresaEmail ;
      private string[] H009W2_A251EmpresaRazaoSocial ;
      private bool[] H009W2_n251EmpresaRazaoSocial ;
      private string[] H009W2_A770EmpresaRepresentanteCPF ;
      private bool[] H009W2_n770EmpresaRepresentanteCPF ;
      private string[] H009W2_A772EmpresaRepresentanteEmail ;
      private bool[] H009W2_n772EmpresaRepresentanteEmail ;
      private string[] H009W2_A771EmpresaRepresentanteNome ;
      private bool[] H009W2_n771EmpresaRepresentanteNome ;
      private int[] H009W3_A323PropostaId ;
      private bool[] H009W3_n323PropostaId ;
      private int[] H009W3_A504PropostaPacienteClienteId ;
      private bool[] H009W3_n504PropostaPacienteClienteId ;
      private int[] H009W3_A553PropostaResponsavelId ;
      private bool[] H009W3_n553PropostaResponsavelId ;
      private string[] H009W3_A505PropostaPacienteClienteRazaoSocial ;
      private bool[] H009W3_n505PropostaPacienteClienteRazaoSocial ;
      private short[] H009W3_A328PropostaCratedBy ;
      private bool[] H009W3_n328PropostaCratedBy ;
      private int[] H009W4_A299ConfiguracoesId ;
      private short[] H009W4_A398ConfiguracoesLayoutProposta ;
      private bool[] H009W4_n398ConfiguracoesLayoutProposta ;
      private short[] H009W4_A564ConfigLayoutPromissoriaClinicaEmprestimo ;
      private bool[] H009W4_n564ConfigLayoutPromissoriaClinicaEmprestimo ;
      private short[] H009W4_A565ConfigLayoutPromissoriaClinicaTaxa ;
      private bool[] H009W4_n565ConfigLayoutPromissoriaClinicaTaxa ;
      private short[] H009W4_A566ConfigLayoutPromissoriaPaciente ;
      private bool[] H009W4_n566ConfigLayoutPromissoriaPaciente ;
      private string[] H009W4_A418ConfiguracoesLayoutContratoCorpo ;
      private bool[] H009W4_n418ConfiguracoesLayoutContratoCorpo ;
      private string[] H009W4_A569ConfigLayoutCorpoPromissoriaPaciente ;
      private bool[] H009W4_n569ConfigLayoutCorpoPromissoriaPaciente ;
      private string[] H009W4_A567ConfigLayoutCorpoPromissoriaClinicaEmprestimo ;
      private bool[] H009W4_n567ConfigLayoutCorpoPromissoriaClinicaEmprestimo ;
      private string[] H009W4_A568ConfigLayoutCorpoPromissoriaClinicaTaxa ;
      private bool[] H009W4_n568ConfigLayoutCorpoPromissoriaClinicaTaxa ;
      private int[] H009W5_A168ClienteId ;
      private string[] H009W5_A172ClienteTipoPessoa ;
      private bool[] H009W5_n172ClienteTipoPessoa ;
      private string[] H009W5_A169ClienteDocumento ;
      private bool[] H009W5_n169ClienteDocumento ;
      private string[] H009W5_A201ContatoEmail ;
      private bool[] H009W5_n201ContatoEmail ;
      private string[] H009W5_A170ClienteRazaoSocial ;
      private bool[] H009W5_n170ClienteRazaoSocial ;
      private string[] H009W5_A447ResponsavelCPF ;
      private bool[] H009W5_n447ResponsavelCPF ;
      private string[] H009W5_A456ResponsavelEmail ;
      private bool[] H009W5_n456ResponsavelEmail ;
      private string[] H009W5_A436ResponsavelNome ;
      private bool[] H009W5_n436ResponsavelNome ;
      private short[] H009W6_A133SecUserId ;
      private bool[] H009W6_n133SecUserId ;
      private int[] H009W6_A226SecUserOwnerId ;
      private bool[] H009W6_n226SecUserOwnerId ;
      private int[] H009W7_A168ClienteId ;
      private string[] H009W7_A169ClienteDocumento ;
      private bool[] H009W7_n169ClienteDocumento ;
      private string[] H009W7_A201ContatoEmail ;
      private bool[] H009W7_n201ContatoEmail ;
      private string[] H009W7_A170ClienteRazaoSocial ;
      private bool[] H009W7_n170ClienteRazaoSocial ;
      private string[] H009W7_A447ResponsavelCPF ;
      private bool[] H009W7_n447ResponsavelCPF ;
      private string[] H009W7_A456ResponsavelEmail ;
      private bool[] H009W7_n456ResponsavelEmail ;
      private string[] H009W7_A436ResponsavelNome ;
      private bool[] H009W7_n436ResponsavelNome ;
      private int[] H009W8_A478ConfiguracoesTestemunhasId ;
      private short[] H009W8_A133SecUserId ;
      private bool[] H009W8_n133SecUserId ;
      private string[] H009W8_A479ConfiguracoesTestemunhasNome ;
      private bool[] H009W8_n479ConfiguracoesTestemunhasNome ;
      private string[] H009W8_A480ConfiguracoesTestemunhasDocumento ;
      private bool[] H009W8_n480ConfiguracoesTestemunhasDocumento ;
      private string[] H009W8_A481ConfiguracoesTestemunhasEmail ;
      private bool[] H009W8_n481ConfiguracoesTestemunhasEmail ;
      ...
      private int[] H009W9_A572PropostaContratoAssinaturaId ;
      private string[] H009W9_A573PropostaContratoAssinaturaTipo ;
      private bool[] H009W9_n573PropostaContratoAssinaturaTipo ;
      private int[] H009W9_A323PropostaId ;
      private bool[] H009W9_n323PropostaId ;
      private long[] H009W9_A571PropostaAssinatura ;
      private bool[] H009W9_n571PropostaAssinatura ;
      private SdtReembolsoAssinaturas AV49ReembolsoAssinaturas ;
      private short[] H009W10_A154LayoutContratoId ;
      private string[] H009W10_A157LayoutContratoCorpo ;
      private bool[] H009W10_n157LayoutContratoCorpo ;
      private string[] H009W11_A906LayoutContratoTipo ;
      private bool[] H009W11_n906LayoutContratoTipo ;
      private bool[] H009W11_A156LayoutContratoStatus ;
      private bool[] H009W11_n156LayoutContratoStatus ;
      private short[] H009W11_A154LayoutContratoId ;
      private string[] H009W11_A155LayoutContratoDescricao ;
      private bool[] H009W11_n155LayoutContratoDescricao ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV24Combo_DataItem ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class assinarcontratoproposta__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH009W4;
          prmH009W4 = new Object[] {
          };
          Object[] prmH009W5;
          prmH009W5 = new Object[] {
          new ParDef("AV52ResponsavelClienteId",GXType.Int32,9,0)
          };
          Object[] prmH009W6;
          prmH009W6 = new Object[] {
          new ParDef("AV53ClinicaClienteId",GXType.Int32,9,0)
          };
          Object[] prmH009W7;
          prmH009W7 = new Object[] {
          new ParDef("AV54secuserownerid",GXType.Int32,9,0)
          };
          Object[] prmH009W8;
          prmH009W8 = new Object[] {
          new ParDef("AV57WWPContext__Userid",GXType.Int16,4,0)
          };
          Object[] prmH009W9;
          prmH009W9 = new Object[] {
          new ParDef("AV46PropostaId",GXType.Int32,9,0) ,
          new ParDef("AV47PropostaContratoAssinaturaTipo",GXType.VarChar,60,0)
          };
          Object[] prmH009W10;
          prmH009W10 = new Object[] {
          new ParDef("AV22LayoutContratoId",GXType.Int16,4,0)
          };
          Object[] prmH009W11;
          prmH009W11 = new Object[] {
          };
          def= new CursorDef[] {
              new CursorDef("H009W2", "SELECT EmpresaId, EmpresaUtilizaRepresentanteAssinatura, EmpresaCNPJ, EmpresaEmail, EmpresaRazaoSocial, EmpresaRepresentanteCPF, EmpresaRepresentanteEmail, EmpresaRepresentanteNome FROM Empresa WHERE EmpresaUtilizaRepresentanteAssinatura ORDER BY EmpresaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H009W3", "SELECT T1.PropostaId, T1.PropostaPacienteClienteId AS PropostaPacienteClienteId, T1.PropostaResponsavelId, T2.ClienteRazaoSocial AS PropostaPacienteClienteRazaoSocial, T1.PropostaCratedBy FROM (Proposta T1 LEFT JOIN Cliente T2 ON T2.ClienteId = T1.PropostaPacienteClienteId) WHERE T1.PropostaId = :AV46PropostaId ORDER BY T1.PropostaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H009W4", "SELECT T1.ConfiguracoesId, T1.ConfiguracoesLayoutProposta AS ConfiguracoesLayoutProposta, T1.ConfigLayoutPromissoriaClinicaEmprestimo AS ConfigLayoutPromissoriaClinicaEmprestimo, T1.ConfigLayoutPromissoriaClinicaTaxa AS ConfigLayoutPromissoriaClinicaTaxa, T1.ConfigLayoutPromissoriaPaciente AS ConfigLayoutPromissoriaPaciente, T2.LayoutContratoCorpo AS ConfiguracoesLayoutContratoCorpo, T5.LayoutContratoCorpo AS ConfigLayoutCorpoPromissoriaPaciente, T3.LayoutContratoCorpo AS ConfigLayoutCorpoPromissoriaClinicaEmprestimo, T4.LayoutContratoCorpo AS ConfigLayoutCorpoPromissoriaClinicaTaxa FROM ((((Configuracoes T1 LEFT JOIN LayoutContrato T2 ON T2.LayoutContratoId = T1.ConfiguracoesLayoutProposta) LEFT JOIN LayoutContrato T3 ON T3.LayoutContratoId = T1.ConfigLayoutPromissoriaClinicaEmprestimo) LEFT JOIN LayoutContrato T4 ON T4.LayoutContratoId = T1.ConfigLayoutPromissoriaClinicaTaxa) LEFT JOIN LayoutContrato T5 ON T5.LayoutContratoId = T1.ConfigLayoutPromissoriaPaciente) ORDER BY T1.ConfiguracoesId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H009W5", "SELECT ClienteId, ClienteTipoPessoa, ClienteDocumento, ContatoEmail, ClienteRazaoSocial, ResponsavelCPF, ResponsavelEmail, ResponsavelNome FROM Cliente WHERE ClienteId = :AV52ResponsavelClienteId ORDER BY ClienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W5,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H009W6", "SELECT SecUserId, SecUserOwnerId FROM SecUser WHERE SecUserId = :AV53ClinicaClienteId ORDER BY SecUserId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W6,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H009W7", "SELECT ClienteId, ClienteDocumento, ContatoEmail, ClienteRazaoSocial, ResponsavelCPF, ResponsavelEmail, ResponsavelNome FROM Cliente WHERE ClienteId = :AV54secuserownerid ORDER BY ClienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W7,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H009W8", "SELECT ConfiguracoesTestemunhasId, SecUserId, ConfiguracoesTestemunhasNome, ConfiguracoesTestemunhasDocumento, ConfiguracoesTestemunhasEmail FROM ConfiguracoesTestemunhas WHERE SecUserId = :AV57WWPContext__Userid ORDER BY SecUserId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W8,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H009W9", "SELECT PropostaContratoAssinaturaId, PropostaContratoAssinaturaTipo, PropostaId, PropostaAssinatura FROM PropostaContratoAssinatura WHERE (PropostaId = :AV46PropostaId) AND (PropostaContratoAssinaturaTipo = ( :AV47PropostaContratoAssinaturaTipo)) ORDER BY PropostaId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W9,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H009W10", "SELECT LayoutContratoId, LayoutContratoCorpo FROM LayoutContrato WHERE LayoutContratoId = :AV22LayoutContratoId ORDER BY LayoutContratoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W10,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H009W11", "SELECT LayoutContratoTipo, LayoutContratoStatus, LayoutContratoId, LayoutContratoDescricao FROM LayoutContrato WHERE (LayoutContratoStatus) AND (LayoutContratoTipo = ( 'C')) ORDER BY LayoutContratoDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009W11,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
