...
namespace GeneXus.Programs.wwpbaseobjects {
   public class managefilters : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wwpbaseobjects.managefilters"+UrlEncode(StringUtil.RTrim(AV14UserKey));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormNoBackgroundColor\" data-gx-class=\"form-horizontal FormNoBackgroundColor\" novalidate action=\""+formatLink("wwpbaseobjects.managefilters") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.managefilters"+UrlEncode(StringUtil.RTrim(AV14UserKey));
         return formatLink("wwpbaseobjects.managefilters") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 29), "GRIDGRIDSTATECOLLECTIONS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "VUDELETE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VMOVEUP.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "VMOVEDOWN.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "VUDELETE.CLICK") == 0 ) )
                           {
                              ...
                              {
                                 AV6GridStateCollection.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.Item(AV15GXV1));
      ...
      protected void PA0F2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.managefilters")), "wwpbaseobjects.managefilters") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.managefilters")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E110F2( )
      {
         ...
         {
            AV7GridStateCollectionItem = ((GeneXus.Programs.wwpbaseobjects.SdtGridStateCollection_Item)AV6GridStateCollection.Item(AV18GXV4));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019223491", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/managefilters.js", "?202561019223491", false, true);
         context.AddJavascriptSource("shared/jquery/jquery1.9.1.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/bootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"GRIDGRIDSTATECOLLECTIONS_nEOF","type":"int"},{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"subGridgridstatecollections_Rows","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"Rows"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"},{"av":"AV14UserKey","fld":"vUSERKEY","hsh":true,"type":"svchar"}]""");
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS.LOAD",""","oparms":[{"av":"AV12MoveUp","fld":"vMOVEUP","type":"char"},{"av":"AV11MoveDown","fld":"vMOVEDOWN","type":"char"},{"av":"AV13UDelete","fld":"vUDELETE","type":"char"}]}""");
         setEventMetadata("ENTER","""{"handler":"E110F2","iparms":[{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"},{"av":"AV14UserKey","fld":"vUSERKEY","hsh":true,"type":"svchar"},{"av":"GRIDGRIDSTATECOLLECTIONS_nEOF","type":"int"},{"av":"subGridgridstatecollections_Rows","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"Rows"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"}]}""");
         setEventMetadata("VMOVEUP.CLICK","""{"handler":"E150F2","iparms":[{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"GRIDGRIDSTATECOLLECTIONS_nEOF","type":"int"},{"av":"subGridgridstatecollections_Rows","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"Rows"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"},{"av":"AV14UserKey","fld":"vUSERKEY","hsh":true,"type":"svchar"}]""");
         setEventMetadata("VMOVEUP.CLICK",""","oparms":[{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"}]}""");
         setEventMetadata("VMOVEDOWN.CLICK","""{"handler":"E160F2","iparms":[{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"GRIDGRIDSTATECOLLECTIONS_nEOF","type":"int"},{"av":"subGridgridstatecollections_Rows","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"Rows"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"},{"av":"AV14UserKey","fld":"vUSERKEY","hsh":true,"type":"svchar"}]""");
         setEventMetadata("VMOVEDOWN.CLICK",""","oparms":[{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"}]}""");
         setEventMetadata("VUDELETE.CLICK","""{"handler":"E170F2","iparms":[{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"GRIDGRIDSTATECOLLECTIONS_nEOF","type":"int"},{"av":"subGridgridstatecollections_Rows","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"Rows"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"},{"av":"AV14UserKey","fld":"vUSERKEY","hsh":true,"type":"svchar"}]""");
         setEventMetadata("VUDELETE.CLICK",""","oparms":[{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"}]}""");
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS_FIRSTPAGE","""{"handler":"subgridgridstatecollections_firstpage","iparms":[{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"GRIDGRIDSTATECOLLECTIONS_nEOF","type":"int"},{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"subGridgridstatecollections_Rows","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"Rows"},{"av":"AV14UserKey","fld":"vUSERKEY","hsh":true,"type":"svchar"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"}]""");
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS_PREVPAGE","""{"handler":"subgridgridstatecollections_previouspage","iparms":[{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"GRIDGRIDSTATECOLLECTIONS_nEOF","type":"int"},{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"subGridgridstatecollections_Rows","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"Rows"},{"av":"AV14UserKey","fld":"vUSERKEY","hsh":true,"type":"svchar"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"}]""");
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS_NEXTPAGE","""{"handler":"subgridgridstatecollections_nextpage","iparms":[{"av":"GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage","type":"int"},{"av":"GRIDGRIDSTATECOLLECTIONS_nEOF","type":"int"},{"av":"AV6GridStateCollection","fld":"vGRIDSTATECOLLECTION","grid":15,"type":""},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"nRC_GXsfl_15","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"GridRC","grid":15,"type":"int"},{"av":"subGridgridstatecollections_Rows","ctrl":"GRIDGRIDSTATECOLLECTIONS","prop":"Rows"},{"av":"AV14UserKey","fld":"vUSERKEY","hsh":true,"type":"svchar"},{"av":"AV5CollectionIsEmpty","fld":"vCOLLECTIONISEMPTY","type":"boolean"}]""");
