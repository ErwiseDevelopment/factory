...
namespace GeneXus.Programs {
   public class wpropostaresumo : GXWebComponent
   {
      public wpropostaresumo( )
      {
      ...
      public wpropostaresumo( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxNewRow_"+"Griddocres") == 0 )
               {
                  gxnrGriddocres_newrow_invoke( ) ;
                  return  ;
               }
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Griddocres") == 0 )
               {
                  gxgrGriddocres_refresh_invoke( ) ;
                  return  ;
               }
               else
               {
      ...
      protected void gxnrGriddocres_newrow_invoke( )
      {
         ...
         gxnrGriddocres_newrow( ) ;
         /* End function gxnrGriddocres_newrow_invoke */
      }

      protected void gxgrGriddocres_refresh_invoke( )
      {
         subGriddocres_Rows = (int)(Math.Round(NumberUtil.Val( GetPar( "subGriddocres_Rows"), "."), 18, MidpointRounding.ToEven));
         ...
         gxgrGriddocres_refresh( subGriddocres_Rows, AV11WizardData, AV10HasValidationErrors, AV35PropostaValor, AV36PropostaDescricao, AV39ConvenioVencimentoAno, AV40ConvenioVencimentoMes, AV41ClientePixTipo, AV42ClientePix, AV44ContaAgencia, AV45ContaNumero, AV46ResponsavelClienteRazaoSocial, AV47ResponsavelClienteDocumento, AV48ResponsavelContatoEmail, AV49ClienteRazaoSocial, AV50ClienteDocumento, AV51ContatoEmail, sPrefix) ;
         AddString( context.getJSONResponse( )) ;
         /* End function gxgrGriddocres_refresh_invoke */
      }
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WProposta Resumo") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "wpropostaresumo"+UrlEncode(StringUtil.RTrim(AV6WebSessionKey)) + "," + UrlEncode(StringUtil.RTrim(AV8PreviousStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV7GoingBack));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpropostaresumo") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"WPropostaResumo");
         ...
         GXUtil.WriteLogInfo("wpropostaresumo:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"SECUSEROWNERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A226SecUserOwnerId), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"SECUSERCLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A210SecUserClienteId), 4, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_nFirstRecordOnPage", StringUtil.LTrim( StringUtil.NToC( (decimal)(GRIDDOCRES_nFirstRecordOnPage), 15, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_nEOF", StringUtil.LTrim( StringUtil.NToC( (decimal)(GRIDDOCRES_nEOF), 1, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"subGriddocres_Recordcount", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Recordcount), 5, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Rows), 6, 0, ".", "")));
      ...
      {
         return "WPropostaResumo" ;
      }

      public override string GetPgmdesc( )
      {
         return "WProposta Resumo" ;
      }
      ...
      protected void WB6Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wpropostaresumo");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup1_Internalname, "Paciente", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaResumo.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavClienterazaosocial_Internalname, AV49ClienteRazaoSocial, StringUtil.RTrim( context.localUtil.Format( AV49ClienteRazaoSocial, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,20);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClienterazaosocial_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClienterazaosocial_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavContatoemail_Internalname, AV51ContatoEmail, StringUtil.RTrim( context.localUtil.Format( AV51ContatoEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContatoemail_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContatoemail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup5_Internalname, "Responsável", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaResumo.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavResponsavelclienterazaosocial_Internalname, AV46ResponsavelClienteRazaoSocial, StringUtil.RTrim( context.localUtil.Format( AV46ResponsavelClienteRazaoSocial, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onblur(this,40);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResponsavelclienterazaosocial_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavResponsavelclienterazaosocial_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup2_Internalname, "Conta / PIX", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaResumo.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_bancoid_Internalname, "Banco", "", "", lblTextblockcombo_bancoid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavContaagencia_Internalname, AV44ContaAgencia, StringUtil.RTrim( context.localUtil.Format( AV44ContaAgencia, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavContaagencia_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavContaagencia_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavClientepixtipo, cmbavClientepixtipo_Internalname, StringUtil.RTrim( AV41ClientePixTipo), 1, cmbavClientepixtipo_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavClientepixtipo.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,78);\"", "", true, 0, "HLP_WPropostaResumo.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavClientepix_Internalname, AV42ClientePix, StringUtil.RTrim( context.localUtil.Format( AV42ClientePix, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,82);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavClientepix_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavClientepix_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup3_Internalname, "Proposta", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaResumo.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_procedimentosmedicosid_Internalname, "Procedimento", "", "", lblTextblockcombo_procedimentosmedicosid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavPropostadescricao_Internalname, AV36PropostaDescricao, StringUtil.RTrim( context.localUtil.Format( AV36PropostaDescricao, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,102);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavPropostadescricao_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavPropostadescricao_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_convenioid_Internalname, "Convênio", "", "", lblTextblockcombo_convenioid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_conveniocategoriaid_Internalname, "Categoria do convênio", "", "", lblTextblockcombo_conveniocategoriaid_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockconveniovencimentoano_Internalname, "Ano vencimento carteira", "", "", lblTextblockconveniovencimentoano_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WPropostaResumo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            wb_table1_124_6Z2( true) ;
         }
         else
         {
            wb_table1_124_6Z2( false) ;
         }
         return  ;
      }

      protected void wb_table1_124_6Z2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "flex-grow:1;", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup4_Internalname, "Documentos", 1, 0, "px", 0, "px", "Group", "", "HLP_WPropostaResumo.htm");
            /* Div Control */
            ...
            /*  Grid Control  */
            GriddocresContainer.SetWrapped(nGXWrapped);
            StartGridControl138( ) ;
         }
         if ( wbEnd == 138 )
         {
            ...
            if ( GriddocresContainer.GetWrapped() == 1 )
            {
            ...
            {
               GriddocresContainer.AddObjectProperty("GRIDDOCRES_nEOF", GRIDDOCRES_nEOF);
               GriddocresContainer.AddObjectProperty("GRIDDOCRES_nFirstRecordOnPage", GRIDDOCRES_nFirstRecordOnPage);
               sStyleString = "";
               context.WriteHtmlText( "<div id=\""+sPrefix+"GriddocresContainer"+"Div\" "+sStyleString+">"+"</div>") ;
               context.httpAjaxContext.ajax_rsp_assign_grid(sPrefix+"_"+"Griddocres", GriddocresContainer, subGriddocres_Internalname);
               if ( ! isAjaxCallMode( ) && ! context.isSpaRequest( ) )
               {
                  GxWebStd.gx_hidden_field( context, sPrefix+"GriddocresContainerData", GriddocresContainer.ToJavascriptSource());
               }
               if ( context.isAjaxRequest( ) || context.isSpaRequest( ) )
               {
                  GxWebStd.gx_hidden_field( context, sPrefix+"GriddocresContainerData"+"V", GriddocresContainer.GridValuesHidden());
               }
               else
               {
                  context.WriteHtmlText( "<input type=\"hidden\" "+"name=\""+sPrefix+"GriddocresContainerData"+"V"+"\" value='"+GriddocresContainer.GridValuesHidden()+"'/>") ;
               }
            }
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBancoid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV43BancoId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV43BancoId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,160);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBancoid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBancoid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaResumo.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 161,'" + sPrefix + "',false,'" + sGXsfl_138_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavProcedimentosmedicosid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV34ProcedimentosMedicosId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV34ProcedimentosMedicosId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,161);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavProcedimentosmedicosid_Jsonclick, 0, "Attribute", "", "", "", "", edtavProcedimentosmedicosid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaResumo.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 162,'" + sPrefix + "',false,'" + sGXsfl_138_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavConvenioid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV37ConvenioId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV37ConvenioId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,162);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConvenioid_Jsonclick, 0, "Attribute", "", "", "", "", edtavConvenioid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaResumo.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 163,'" + sPrefix + "',false,'" + sGXsfl_138_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavConveniocategoriaid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV38ConvenioCategoriaId), 9, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV38ConvenioCategoriaId), "ZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,163);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavConveniocategoriaid_Jsonclick, 0, "Attribute", "", "", "", "", edtavConveniocategoriaid_Visible, 1, 0, "text", "1", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WPropostaResumo.htm");
            /* User Defined Control */
            ucGriddocres_empowerer.Render(context, "wwp.gridempowerer", Griddocres_empowerer_Internalname, sPrefix+"GRIDDOCRES_EMPOWERERContainer");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START6Z2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WProposta Resumo", 0) ;
            context.wjLoc = "";
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "GRIDDOCRESPAGING") == 0 )
                           {
                              context.wbHandled = 1;
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                              ...
                              sEvt = cgiGet( sPrefix+"GRIDDOCRESPAGING");
                              if ( StringUtil.StrCmp(sEvt, "FIRST") == 0 )
                              {
                                 subgriddocres_firstpage( ) ;
                              }
                              else if ( StringUtil.StrCmp(sEvt, "PREV") == 0 )
                              {
                                 subgriddocres_previouspage( ) ;
                              }
                              else if ( StringUtil.StrCmp(sEvt, "NEXT") == 0 )
                              {
                                 subgriddocres_nextpage( ) ;
                              }
                              else if ( StringUtil.StrCmp(sEvt, "LAST") == 0 )
                              {
                                 subgriddocres_lastpage( ) ;
                              }
                              dynload_actions( ) ;
                           }
                        }
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 15), "GRIDDOCRES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 21), "VADICIONARANEXO.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 21), "VADICIONARANEXO.CLICK") == 0 ) )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP6Z0( ) ;
                              ...
                              AV75Nome = cgiGet( edtavNome_Internalname);
                              AssignAttri(sPrefix, false, edtavNome_Internalname, AV75Nome);
                              GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vNOME"+"_"+sGXsfl_138_idx, GetSecureSignedToken( sPrefix+sGXsfl_138_idx, StringUtil.RTrim( context.localUtil.Format( AV75Nome, "")), context));
                              AV76NomeArquivo = cgiGet( edtavNomearquivo_Internalname);
                              AssignAttri(sPrefix, false, edtavNomearquivo_Internalname, AV76NomeArquivo);
                              GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vNOMEARQUIVO"+"_"+sGXsfl_138_idx, GetSecureSignedToken( sPrefix+sGXsfl_138_idx, StringUtil.RTrim( context.localUtil.Format( AV76NomeArquivo, "")), context));
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "GRIDDOCRES.LOAD") == 0 )
                                 {
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       context.wbHandled = 1;
                                       if ( ! wbErr )
                                       {
                                          ...
                                          GX_FocusControl = edtavAdicionaranexo_Internalname;
                                          AssignAttri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
                                          /* Execute user event: Griddocres.Load */
                                          E146Z2 ();
                                       }
                                    }
                                 }
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wpropostaresumo")), "wpropostaresumo") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wpropostaresumo")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxnrGriddocres_newrow( )
      {
         ...
         {
            sendrow_1382( ) ;
            nGXsfl_138_idx = ((subGriddocres_Islastpage==1)&&(nGXsfl_138_idx+1>subGriddocres_fnc_Recordsperpage( )) ? 1 : nGXsfl_138_idx+1);
            sGXsfl_138_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_138_idx), 4, 0), 4, "0");
            SubsflControlProps_1382( ) ;
         }
         AddString( context.httpAjaxContext.getJSONContainerResponse( GriddocresContainer)) ;
         /* End function gxnrGriddocres_newrow */
      }

      protected void gxgrGriddocres_refresh( int subGriddocres_Rows ,
                                             SdtWPropostaData AV11WizardData ,
                                             ...
                                             string sPrefix )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("wpropostaresumo:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
         /* End function gxgrGriddocres_refresh */
      }
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vNOME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV75Nome, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vNOME", AV75Nome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vNOMEARQUIVO", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV76NomeArquivo, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vNOMEARQUIVO", AV76NomeArquivo);
      }
      ...
      protected void RF6Z2( )
      {
         ...
         GriddocresContainer.AddObjectProperty("GridName", "Griddocres");
         GriddocresContainer.AddObjectProperty("CmpContext", sPrefix);
         GriddocresContainer.AddObjectProperty("InMasterPage", "false");
         GriddocresContainer.AddObjectProperty("Class", "GridWithBorderColor WorkWith");
         GriddocresContainer.AddObjectProperty("Cellpadding", StringUtil.LTrim( StringUtil.NToC( (decimal)(1), 4, 0, ".", "")));
         GriddocresContainer.AddObjectProperty("Cellspacing", StringUtil.LTrim( StringUtil.NToC( (decimal)(2), 4, 0, ".", "")));
         GriddocresContainer.AddObjectProperty("Backcolorstyle", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Backcolorstyle), 1, 0, ".", "")));
         GriddocresContainer.PageSize = subGriddocres_fnc_Recordsperpage( );
         if ( subGriddocres_Islastpage != 0 )
         {
            GRIDDOCRES_nFirstRecordOnPage = (long)(subGriddocres_fnc_Recordcount( )-subGriddocres_fnc_Recordsperpage( ));
            GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_nFirstRecordOnPage", StringUtil.LTrim( StringUtil.NToC( (decimal)(GRIDDOCRES_nFirstRecordOnPage), 15, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("GRIDDOCRES_nFirstRecordOnPage", GRIDDOCRES_nFirstRecordOnPage);
         }
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Execute user event: Griddocres.Load */
            E146Z2 ();
            if ( ( subGriddocres_Islastpage == 0 ) && ( GRIDDOCRES_nCurrentRecord > 0 ) && ( GRIDDOCRES_nGridOutOfScope == 0 ) && ( nGXsfl_138_idx == 1 ) )
            {
               GRIDDOCRES_nCurrentRecord = 0;
               GRIDDOCRES_nGridOutOfScope = 1;
               subgriddocres_firstpage( ) ;
               /* Execute user event: Griddocres.Load */
               E146Z2 ();
            }
      ...
      protected int subGriddocres_fnc_Pagecount( )
      {
         return (int)(-1) ;
      }

      protected int subGriddocres_fnc_Recordcount( )
      {
         return (int)(((subGriddocres_Recordcount==0) ? GRIDDOCRES_nFirstRecordOnPage+1 : subGriddocres_Recordcount)) ;
      }

      protected int subGriddocres_fnc_Recordsperpage( )
      {
         if ( subGriddocres_Rows > 0 )
         {
            return subGriddocres_Rows*1 ;
         }
         else
         {
            return (int)(-1) ;
      ...
      protected int subGriddocres_fnc_Currentpage( )
      {
         return (int)(((subGriddocres_Islastpage==1) ? NumberUtil.Int( (long)(Math.Round(subGriddocres_fnc_Recordcount( )/ (decimal)(subGriddocres_fnc_Recordsperpage( )), 18, MidpointRounding.ToEven)))+((((int)((subGriddocres_fnc_Recordcount( )) % (subGriddocres_fnc_Recordsperpage( ))))==0) ? 0 : 1) : NumberUtil.Int( (long)(Math.Round(GRIDDOCRES_nFirstRecordOnPage/ (decimal)(subGriddocres_fnc_Recordsperpage( )), 18, MidpointRounding.ToEven)))+1)) ;
      }

      protected short subgriddocres_firstpage( )
      {
         GRIDDOCRES_nFirstRecordOnPage = 0;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_nFirstRecordOnPage", StringUtil.LTrim( StringUtil.NToC( (decimal)(GRIDDOCRES_nFirstRecordOnPage), 15, 0, ".", "")));
         if ( isFullAjaxMode( ) )
         {
            gxgrGriddocres_refresh( subGriddocres_Rows, AV11WizardData, AV10HasValidationErrors, AV35PropostaValor, AV36PropostaDescricao, AV39ConvenioVencimentoAno, AV40ConvenioVencimentoMes, AV41ClientePixTipo, AV42ClientePix, AV44ContaAgencia, AV45ContaNumero, AV46ResponsavelClienteRazaoSocial, AV47ResponsavelClienteDocumento, AV48ResponsavelContatoEmail, AV49ClienteRazaoSocial, AV50ClienteDocumento, AV51ContatoEmail, sPrefix) ;
      ...
      protected short subgriddocres_nextpage( )
      {
         if ( GRIDDOCRES_nEOF == 0 )
         {
            GRIDDOCRES_nFirstRecordOnPage = (long)(GRIDDOCRES_nFirstRecordOnPage+subGriddocres_fnc_Recordsperpage( ));
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_nFirstRecordOnPage", StringUtil.LTrim( StringUtil.NToC( (decimal)(GRIDDOCRES_nFirstRecordOnPage), 15, 0, ".", "")));
         GriddocresContainer.AddObjectProperty("GRIDDOCRES_nFirstRecordOnPage", GRIDDOCRES_nFirstRecordOnPage);
         if ( isFullAjaxMode( ) )
         ...
         send_integrity_footer_hashes( ) ;
         return (short)(((GRIDDOCRES_nEOF==0) ? 0 : 2)) ;
      }

      protected short subgriddocres_previouspage( )
      {
         if ( GRIDDOCRES_nFirstRecordOnPage >= subGriddocres_fnc_Recordsperpage( ) )
         {
            GRIDDOCRES_nFirstRecordOnPage = (long)(GRIDDOCRES_nFirstRecordOnPage-subGriddocres_fnc_Recordsperpage( ));
         }
         else
      ...
      protected short subgriddocres_lastpage( )
      {
         subGriddocres_Islastpage = 1;
         if ( isFullAjaxMode( ) )
         {
            gxgrGriddocres_refresh( subGriddocres_Rows, AV11WizardData, AV10HasValidationErrors, AV35PropostaValor, AV36PropostaDescricao, AV39ConvenioVencimentoAno, AV40ConvenioVencimentoMes, AV41ClientePixTipo, AV42ClientePix, AV44ContaAgencia, AV45ContaNumero, AV46ResponsavelClienteRazaoSocial, AV47ResponsavelClienteDocumento, AV48ResponsavelContatoEmail, AV49ClienteRazaoSocial, AV50ClienteDocumento, AV51ContatoEmail, sPrefix) ;
         }
      ...
      protected int subgriddocres_gotopage( int nPageNo )
      {
         if ( nPageNo > 0 )
         {
            GRIDDOCRES_nFirstRecordOnPage = (long)(subGriddocres_fnc_Recordsperpage( )*(nPageNo-1));
         }
         else
         {
            GRIDDOCRES_nFirstRecordOnPage = 0;
      ...
      protected void STRUP6Z0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            GRIDDOCRES_nFirstRecordOnPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"GRIDDOCRES_nFirstRecordOnPage"), ",", "."), 18, MidpointRounding.ToEven));
            GRIDDOCRES_nEOF = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"GRIDDOCRES_nEOF"), ",", "."), 18, MidpointRounding.ToEven));
            subGriddocres_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"subGriddocres_Recordcount"), ",", "."), 18, MidpointRounding.ToEven));
            subGriddocres_Rows = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"GRIDDOCRES_Rows"), ",", "."), 18, MidpointRounding.ToEven));
            GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Rows), 6, 0, ".", "")));
            ...
            {
               GXUtil.WriteLogError("wpropostaresumo:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
               context.HttpContext.Response.StatusCode = 403;
               context.WriteHtmlText( "<title>403 Forbidden</title>") ;
               context.WriteHtmlText( "<h1>403 Forbidden</h1>") ;
      ...
      protected void E136Z2( )
      {
         ...
         S152 ();
         if (returnInSub) return;
         Griddocres_empowerer_Gridinternalname = subGriddocres_Internalname;
         ucGriddocres_empowerer.SendProperty(context, sPrefix, false, Griddocres_empowerer_Internalname, "GridInternalName", Griddocres_empowerer_Gridinternalname);
         subGriddocres_Rows = 10;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Rows), 6, 0, ".", "")));
      }

      private void E146Z2( )
      {
         /* Griddocres_Load Routine */
         returnInSub = false;
         AV78GXV1 = 1;
         while ( AV78GXV1 <= AV11WizardData.gxTpr_Documentos.gxTpr_Griddoc.Count )
         {
            AV74Grid = ((SdtWPropostaData_Documentos_GridDocItem)AV11WizardData.gxTpr_Documentos.gxTpr_Griddoc.Item(AV78GXV1));
            AV30ResumoDocumento = AV74Grid.gxTpr_Documento;
            AssignAttri(sPrefix, false, edtavResumodocumento_Internalname, AV30ResumoDocumento);
            AV28ResumoDocumentosDescricao = AV74Grid.gxTpr_Documentosdescricao;
            AssignAttri(sPrefix, false, edtavResumodocumentosdescricao_Internalname, AV28ResumoDocumentosDescricao);
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vRESUMODOCUMENTOSDESCRICAO"+"_"+sGXsfl_138_idx, GetSecureSignedToken( sPrefix+sGXsfl_138_idx, StringUtil.RTrim( context.localUtil.Format( AV28ResumoDocumentosDescricao, "")), context));
            AV27ResumoDocumentosId = AV74Grid.gxTpr_Documentosid;
            AssignAttri(sPrefix, false, edtavResumodocumentosid_Internalname, StringUtil.LTrimStr( (decimal)(AV27ResumoDocumentosId), 9, 0));
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vRESUMODOCUMENTOSID"+"_"+sGXsfl_138_idx, GetSecureSignedToken( sPrefix+sGXsfl_138_idx, context.localUtil.Format( (decimal)(AV27ResumoDocumentosId), "ZZZZZZZZ9"), context));
            AV31ResumoExtensao = AV74Grid.gxTpr_Extensao;
            AssignAttri(sPrefix, false, edtavResumoextensao_Internalname, AV31ResumoExtensao);
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vRESUMOEXTENSAO"+"_"+sGXsfl_138_idx, GetSecureSignedToken( sPrefix+sGXsfl_138_idx, StringUtil.RTrim( context.localUtil.Format( AV31ResumoExtensao, "")), context));
            AV76NomeArquivo = AV74Grid.gxTpr_Nomearquivo;
            AssignAttri(sPrefix, false, edtavNomearquivo_Internalname, AV76NomeArquivo);
            GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vNOMEARQUIVO"+"_"+sGXsfl_138_idx, GetSecureSignedToken( sPrefix+sGXsfl_138_idx, StringUtil.RTrim( context.localUtil.Format( AV76NomeArquivo, "")), context));
            ...
            if ( ( subGriddocres_Islastpage == 1 ) || ( subGriddocres_Rows == 0 ) || ( ( GRIDDOCRES_nCurrentRecord >= GRIDDOCRES_nFirstRecordOnPage ) && ( GRIDDOCRES_nCurrentRecord < GRIDDOCRES_nFirstRecordOnPage + subGriddocres_fnc_Recordsperpage( ) ) ) )
            {
               sendrow_1382( ) ;
            }
            GRIDDOCRES_nEOF = (short)(((GRIDDOCRES_nCurrentRecord<GRIDDOCRES_nFirstRecordOnPage+subGriddocres_fnc_Recordsperpage( )) ? 1 : 0));
            GxWebStd.gx_hidden_field( context, sPrefix+"GRIDDOCRES_nEOF", StringUtil.LTrim( StringUtil.NToC( (decimal)(GRIDDOCRES_nEOF), 1, 0, ".", "")));
            GRIDDOCRES_nCurrentRecord = (long)(GRIDDOCRES_nCurrentRecord+1);
            subGriddocres_Recordcount = (int)(GRIDDOCRES_nCurrentRecord);
            if ( isFullAjaxMode( ) && ! bGXsfl_138_Refreshing )
            {
               DoAjaxLoad(138, GriddocresRow);
            }
      ...
      protected void E116Z2( )
      {
         ...
         {
            A332LimiteAprovacaoValorMinimo = H006Z2_A332LimiteAprovacaoValorMinimo[0];
            n332LimiteAprovacaoValorMinimo = H006Z2_n332LimiteAprovacaoValorMinimo[0];
            A334LimiteAprovacaoAprovacoes = H006Z2_A334LimiteAprovacaoAprovacoes[0];
            n334LimiteAprovacaoAprovacoes = H006Z2_n334LimiteAprovacaoAprovacoes[0];
         ...
         AV58Proposta.gxTpr_Propostastatus = "EM_ANALISE";
         ...
         AV58Proposta.gxTpr_Propostaclinicaid = AV11WizardData.gxTpr_Clinica.gxTpr_Clienteid;
         ...
         AV71ClinicaClienteId = AV11WizardData.gxTpr_Clinica.gxTpr_Clienteid;
         AssignAttri(sPrefix, false, "AV71ClinicaClienteId", StringUtil.LTrimStr( (decimal)(AV71ClinicaClienteId), 9, 0));
         /* Using cursor H006Z3 */
         pr_default.execute(1, new Object[] {AV71ClinicaClienteId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A210SecUserClienteId = H006Z3_A210SecUserClienteId[0];
            n210SecUserClienteId = H006Z3_n210SecUserClienteId[0];
            A226SecUserOwnerId = H006Z3_A226SecUserOwnerId[0];
            n226SecUserOwnerId = H006Z3_n226SecUserOwnerId[0];
            A133SecUserId = H006Z3_A133SecUserId[0];
            AV72SecUserId = A133SecUserId;
            pr_default.readNext(1);
         }
         pr_default.close(1);
         AV58Proposta.gxTpr_Propostacratedby = AV72SecUserId;
         new getclinicataxbyclienteid(context ).execute(  AV71ClinicaClienteId, out  AV59ContratoTaxa, out  AV60ContratoSLA, out  AV61ContratoJurosMora, out  AV62ContratoIOFMinimo) ;
         ...
         if ( (0==AV63Messages.Count) )
         {
            AV64IsContinue = true;
            AV81GXV2 = 1;
            while ( AV81GXV2 <= AV11WizardData.gxTpr_Documentos.gxTpr_Griddoc.Count )
            {
               AV74Grid = ((SdtWPropostaData_Documentos_GridDocItem)AV11WizardData.gxTpr_Documentos.gxTpr_Griddoc.Item(AV81GXV2));
               ...
               AV66PropostaDocumentos.gxTpr_Documentosid = AV74Grid.gxTpr_Documentosid;
               AV66PropostaDocumentos.gxTpr_Propostadocumentosanexo = AV74Grid.gxTpr_Documento;
               AV66PropostaDocumentos.gxTpr_Propostadocumentosanexoname = AV74Grid.gxTpr_Documentosdescricao;
               ...
               if ( AV66PropostaDocumentos.Fail() )
               {
                  ...
                  context.RollbackDataStores("wpropostaresumo",pr_default);
            ...
            if ( AV64IsContinue )
            {
               ...
               context.CommitDataStores("wpropostaresumo",pr_default);
            }
         }
         else
         {
         ...
         if ( ! AV10HasValidationErrors )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wproposta"+UrlEncode(StringUtil.RTrim("Resumo")) + "," + UrlEncode(StringUtil.RTrim("Proposta_Criada")) + "," + UrlEncode(StringUtil.BoolToStr(false));
      ...
      protected void E126Z2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wproposta"+UrlEncode(StringUtil.RTrim("Resumo")) + "," + UrlEncode(StringUtil.RTrim("Documentos")) + "," + UrlEncode(StringUtil.BoolToStr(true));
         CallWebObject(formatLink("wproposta") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
         context.wjLocDisableFrm = 1;
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV11WizardData", AV11WizardData);
      ...
      protected void S162( )
      {
         ...
         AV11WizardData.gxTpr_Resumo.gxTpr_Griddocres.Clear();
         /* Start For Each Line in Griddocres */
         nRC_GXsfl_138 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_138"), ",", "."), 18, MidpointRounding.ToEven));
         nGXsfl_138_fel_idx = 0;
         while ( nGXsfl_138_fel_idx < nRC_GXsfl_138 )
         {
            nGXsfl_138_fel_idx = ((subGriddocres_Islastpage==1)&&(nGXsfl_138_fel_idx+1>subGriddocres_fnc_Recordsperpage( )) ? 1 : nGXsfl_138_fel_idx+1);
            ...
            AV75Nome = cgiGet( edtavNome_Internalname);
            AV76NomeArquivo = cgiGet( edtavNomearquivo_Internalname);
            AV73GridDocResItem = new SdtWPropostaData_Resumo_GridDocResItem(context);
            AV73GridDocResItem.gxTpr_Resumodocumentosid = AV27ResumoDocumentosId;
            AV73GridDocResItem.gxTpr_Resumodocumentosdescricao = AV28ResumoDocumentosDescricao;
            AV73GridDocResItem.gxTpr_Resumodocumentoobrigatorio = AV29ResumoDocumentoObrigatorio;
            AV73GridDocResItem.gxTpr_Resumodocumento = AV30ResumoDocumento;
            AV73GridDocResItem.gxTpr_Resumoextensao = AV31ResumoExtensao;
            AV73GridDocResItem.gxTpr_Nome = AV75Nome;
            AV73GridDocResItem.gxTpr_Nomearquivo = AV76NomeArquivo;
            AV11WizardData.gxTpr_Resumo.gxTpr_Griddocres.Add(AV73GridDocResItem, 0);
            /* End For Each Line */
         }
      ...
      protected void S152( )
      {
         ...
         {
            A495ConvenioCategoriaStatus = H006Z4_A495ConvenioCategoriaStatus[0];
            n495ConvenioCategoriaStatus = H006Z4_n495ConvenioCategoriaStatus[0];
            A493ConvenioCategoriaId = H006Z4_A493ConvenioCategoriaId[0];
            A494ConvenioCategoriaDescricao = H006Z4_A494ConvenioCategoriaDescricao[0];
            n494ConvenioCategoriaDescricao = H006Z4_n494ConvenioCategoriaDescricao[0];
      ...
      protected void S142( )
      {
         ...
         {
            A412ConvenioStatus = H006Z5_A412ConvenioStatus[0];
            A410ConvenioId = H006Z5_A410ConvenioId[0];
            A411ConvenioDescricao = H006Z5_A411ConvenioDescricao[0];
            n411ConvenioDescricao = H006Z5_n411ConvenioDescricao[0];
            AV26Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S132( )
      {
         ...
         {
            A376ProcedimentosMedicosId = H006Z6_A376ProcedimentosMedicosId[0];
            A379ProcedimentosMedicosArea = H006Z6_A379ProcedimentosMedicosArea[0];
            n379ProcedimentosMedicosArea = H006Z6_n379ProcedimentosMedicosArea[0];
            A377ProcedimentosMedicosNome = H006Z6_A377ProcedimentosMedicosNome[0];
            n377ProcedimentosMedicosNome = H006Z6_n377ProcedimentosMedicosNome[0];
            AV26Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void S122( )
      {
         ...
         {
            A402BancoId = H006Z7_A402BancoId[0];
            A404BancoCodigo = H006Z7_A404BancoCodigo[0];
            n404BancoCodigo = H006Z7_n404BancoCodigo[0];
            A403BancoNome = H006Z7_A403BancoNome[0];
            n403BancoNome = H006Z7_n403BancoNome[0];
            AV26Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void E156Z2( )
      {
         ...
         returnInSub = false;
         new prdownloadblob(context ).execute(  AV30ResumoDocumento,  AV76NomeArquivo,  AV31ResumoExtensao, out  AV77Arquivo) ;
         Novajanela_Target = AV77Arquivo;
      ...
      protected void wb_table1_124_6Z2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavConveniovencimentoano, cmbavConveniovencimentoano_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV39ConvenioVencimentoAno), 4, 0)), 1, cmbavConveniovencimentoano_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavConveniovencimentoano.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,128);\"", "", true, 0, "HLP_WPropostaResumo.htm");
            cmbavConveniovencimentoano.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV39ConvenioVencimentoAno), 4, 0));
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavConveniovencimentomes, cmbavConveniovencimentomes_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV40ConvenioVencimentoMes), 4, 0)), 1, cmbavConveniovencimentomes_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavConveniovencimentomes.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,132);\"", "", true, 0, "HLP_WPropostaResumo.htm");
            cmbavConveniovencimentomes.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV40ConvenioVencimentoMes), 4, 0));
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_124_6Z2e( true) ;
         }
         else
         {
            wb_table1_124_6Z2e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wpropostaresumo", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019172610", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wpropostaresumo.js", "?202561019172611", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_1382( )
      {
         ...
         SubsflControlProps_1382( ) ;
         WB6Z0( ) ;
         if ( ( subGriddocres_Rows * 1 == 0 ) || ( nGXsfl_138_idx <= subGriddocres_fnc_Recordsperpage( ) * 1 ) )
         {
            GriddocresRow = GXWebRow.GetNew(context,GriddocresContainer);
            if ( subGriddocres_Backcolorstyle == 0 )
            {
               /* None style subfile background logic. */
               subGriddocres_Backstyle = 0;
               if ( StringUtil.StrCmp(subGriddocres_Class, "") != 0 )
               {
                  subGriddocres_Linesclass = subGriddocres_Class+"Odd";
               }
            }
            else if ( subGriddocres_Backcolorstyle == 1 )
            {
               /* Uniform style subfile background logic. */
               subGriddocres_Backstyle = 0;
               subGriddocres_Backcolor = subGriddocres_Allbackcolor;
               if ( StringUtil.StrCmp(subGriddocres_Class, "") != 0 )
               {
                  subGriddocres_Linesclass = subGriddocres_Class+"Uniform";
               }
            }
            else if ( subGriddocres_Backcolorstyle == 2 )
            {
               /* Header style subfile background logic. */
               subGriddocres_Backstyle = 1;
               if ( StringUtil.StrCmp(subGriddocres_Class, "") != 0 )
               {
                  subGriddocres_Linesclass = subGriddocres_Class+"Odd";
               }
               subGriddocres_Backcolor = (int)(0x0);
            }
            else if ( subGriddocres_Backcolorstyle == 3 )
            {
               ...
               if ( ((int)((nGXsfl_138_idx) % (2))) == 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(subGriddocres_Class, "") != 0 )
                  {
                     subGriddocres_Linesclass = subGriddocres_Class+"Even";
                  }
               }
               else
               {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GriddocresRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavResumodocumentosid_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV27ResumoDocumentosId), 9, 0, ",", "")),StringUtil.LTrim( ((edtavResumodocumentosid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV27ResumoDocumentosId), "ZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV27ResumoDocumentosId), "ZZZZZZZZ9")))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+""+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" ",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavResumodocumentosid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavResumodocumentosid_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)9,(short)0,(short)0,(short)138,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GriddocresContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl138( )
      {
         if ( GriddocresContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<div id=\""+sPrefix+"GriddocresContainer"+"DivS\" data-gxgridid=\"138\">") ;
            sStyleString = "";
            GxWebStd.gx_table_start( context, subGriddocres_Internalname, subGriddocres_Internalname, "", "GridWithBorderColor WorkWith", 0, "", "", 1, 2, sStyleString, "", "", 0);
            /* Subfile titles */
            context.WriteHtmlText( "<tr") ;
            context.WriteHtmlTextNl( ">") ;
            if ( subGriddocres_Backcolorstyle == 0 )
            {
               subGriddocres_Titlebackstyle = 0;
               if ( StringUtil.Len( subGriddocres_Class) > 0 )
               {
                  subGriddocres_Linesclass = subGriddocres_Class+"Title";
               }
            }
            else
            {
               subGriddocres_Titlebackstyle = 1;
               if ( subGriddocres_Backcolorstyle == 1 )
               {
                  subGriddocres_Titlebackcolor = subGriddocres_Allbackcolor;
                  if ( StringUtil.Len( subGriddocres_Class) > 0 )
                  {
                     subGriddocres_Linesclass = subGriddocres_Class+"UniformTitle";
                  }
               }
               else
               {
         ...
         {
            GriddocresContainer.AddObjectProperty("GridName", "Griddocres");
            GriddocresContainer.AddObjectProperty("Header", subGriddocres_Header);
            GriddocresContainer.AddObjectProperty("Class", "GridWithBorderColor WorkWith");
            GriddocresContainer.AddObjectProperty("Cellpadding", StringUtil.LTrim( StringUtil.NToC( (decimal)(1), 4, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("Cellspacing", StringUtil.LTrim( StringUtil.NToC( (decimal)(2), 4, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("Backcolorstyle", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Backcolorstyle), 1, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("CmpContext", sPrefix);
            GriddocresContainer.AddObjectProperty("InMasterPage", "false");
            GriddocresColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GriddocresColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV32AdicionarAnexo)));
            GriddocresColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavAdicionaranexo_Enabled), 5, 0, ".", "")));
            GriddocresContainer.AddColumnProperties(GriddocresColumn);
            GriddocresColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GriddocresColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(AV27ResumoDocumentosId), 9, 0, ".", ""))));
            GriddocresColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavResumodocumentosid_Enabled), 5, 0, ".", "")));
            GriddocresContainer.AddColumnProperties(GriddocresColumn);
            GriddocresColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GriddocresColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV28ResumoDocumentosDescricao));
            GriddocresColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavResumodocumentosdescricao_Enabled), 5, 0, ".", "")));
            GriddocresContainer.AddColumnProperties(GriddocresColumn);
            GriddocresColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GriddocresColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( AV29ResumoDocumentoObrigatorio)));
            GriddocresColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(cmbavResumodocumentoobrigatorio.Enabled), 5, 0, ".", "")));
            GriddocresContainer.AddColumnProperties(GriddocresColumn);
            GriddocresColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GriddocresColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV30ResumoDocumento));
            GriddocresColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavResumodocumento_Enabled), 5, 0, ".", "")));
            GriddocresContainer.AddColumnProperties(GriddocresColumn);
            GriddocresColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GriddocresColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV31ResumoExtensao));
            GriddocresColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavResumoextensao_Enabled), 5, 0, ".", "")));
            GriddocresContainer.AddColumnProperties(GriddocresColumn);
            GriddocresColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GriddocresColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV75Nome));
            GriddocresColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavNome_Enabled), 5, 0, ".", "")));
            GriddocresContainer.AddColumnProperties(GriddocresColumn);
            GriddocresColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GriddocresColumn.AddObjectProperty("Value", GXUtil.ValueEncode( AV76NomeArquivo));
            GriddocresColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavNomearquivo_Enabled), 5, 0, ".", "")));
            GriddocresContainer.AddColumnProperties(GriddocresColumn);
            GriddocresContainer.AddObjectProperty("Selectedindex", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Selectedindex), 4, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("Allowselection", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Allowselection), 1, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("Selectioncolor", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Selectioncolor), 9, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("Allowhover", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Allowhovering), 1, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("Hovercolor", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Hoveringcolor), 9, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("Allowcollapsing", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Allowcollapsing), 1, 0, ".", "")));
            GriddocresContainer.AddObjectProperty("Collapsed", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGriddocres_Collapsed), 1, 0, ".", "")));
         }
      }
      ...
      protected void init_default_properties( )
      {
         ...
         Griddocres_empowerer_Internalname = sPrefix+"GRIDDOCRES_EMPOWERER";
         divHtml_bottomauxiliarcontrols_Internalname = sPrefix+"HTML_BOTTOMAUXILIARCONTROLS";
         divLayoutmaintable_Internalname = sPrefix+"LAYOUTMAINTABLE";
         Form.Internalname = sPrefix+"FORM";
         subGriddocres_Internalname = sPrefix+"GRIDDOCRES";
      }
      ...
      public override void initialize_properties( )
      {
         ...
         init_default_properties( ) ;
         subGriddocres_Allowcollapsing = 0;
         subGriddocres_Allowselection = 0;
         subGriddocres_Header = "";
         ...
         subGriddocres_Class = "GridWithBorderColor WorkWith";
         subGriddocres_Backcolorstyle = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDDOCRES_nFirstRecordOnPage","type":"int"},{"av":"GRIDDOCRES_nEOF","type":"int"},{"av":"subGriddocres_Rows","ctrl":"GRIDDOCRES","prop":"Rows"},{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""},{"av":"sPrefix","type":"char"},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV35PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","hsh":true,"type":"decimal"},{"av":"AV36PropostaDescricao","fld":"vPROPOSTADESCRICAO","hsh":true,"type":"svchar"},{"av":"cmbavConveniovencimentoano"},{"av":"AV39ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV40ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavClientepixtipo"},{"av":"AV41ClientePixTipo","fld":"vCLIENTEPIXTIPO","hsh":true,"type":"svchar"},{"av":"AV42ClientePix","fld":"vCLIENTEPIX","hsh":true,"type":"svchar"},{"av":"AV44ContaAgencia","fld":"vCONTAAGENCIA","hsh":true,"type":"svchar"},{"av":"AV45ContaNumero","fld":"vCONTANUMERO","hsh":true,"type":"svchar"},{"av":"AV46ResponsavelClienteRazaoSocial","fld":"vRESPONSAVELCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV47ResponsavelClienteDocumento","fld":"vRESPONSAVELCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV48ResponsavelContatoEmail","fld":"vRESPONSAVELCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV49ClienteRazaoSocial","fld":"vCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV50ClienteDocumento","fld":"vCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV51ContatoEmail","fld":"vCONTATOEMAIL","hsh":true,"type":"svchar"}]}""");
         setEventMetadata("GRIDDOCRES.LOAD","""{"handler":"E146Z2","iparms":[{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""}]""");
         setEventMetadata("GRIDDOCRES.LOAD",""","oparms":[{"av":"AV30ResumoDocumento","fld":"vRESUMODOCUMENTO","type":"bitstr"},{"av":"AV28ResumoDocumentosDescricao","fld":"vRESUMODOCUMENTOSDESCRICAO","hsh":true,"type":"svchar"},{"av":"AV27ResumoDocumentosId","fld":"vRESUMODOCUMENTOSID","pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"AV31ResumoExtensao","fld":"vRESUMOEXTENSAO","hsh":true,"type":"svchar"},{"av":"AV76NomeArquivo","fld":"vNOMEARQUIVO","hsh":true,"type":"svchar"},{"av":"AV32AdicionarAnexo","fld":"vADICIONARANEXO","type":"char"}]}""");
         setEventMetadata("ENTER","""{"handler":"E116Z2","iparms":[{"av":"A332LimiteAprovacaoValorMinimo","fld":"LIMITEAPROVACAOVALORMINIMO","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","type":"decimal"},{"av":"AV35PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","hsh":true,"type":"decimal"},{"av":"A334LimiteAprovacaoAprovacoes","fld":"LIMITEAPROVACAOAPROVACOES","pic":"ZZZ9","type":"int"},{"av":"AV34ProcedimentosMedicosId","fld":"vPROCEDIMENTOSMEDICOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV36PropostaDescricao","fld":"vPROPOSTADESCRICAO","hsh":true,"type":"svchar"},{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""},{"av":"A226SecUserOwnerId","fld":"SECUSEROWNERID","pic":"ZZZZZZZZ9","type":"int"},{"av":"A210SecUserClienteId","fld":"SECUSERCLIENTEID","pic":"ZZZ9","type":"int"},{"av":"A133SecUserId","fld":"SECUSERID","pic":"ZZZ9","type":"int"},{"av":"AV68HTTPREQUEST.BaseURL","ctrl":"vHTTPREQUEST","prop":"Baseurl"},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"AV37ConvenioId","fld":"vCONVENIOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV38ConvenioCategoriaId","fld":"vCONVENIOCATEGORIAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"cmbavConveniovencimentoano"},{"av":"AV39ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV40ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavClientepixtipo"},{"av":"AV41ClientePixTipo","fld":"vCLIENTEPIXTIPO","hsh":true,"type":"svchar"},{"av":"AV42ClientePix","fld":"vCLIENTEPIX","hsh":true,"type":"svchar"},{"av":"AV43BancoId","fld":"vBANCOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV44ContaAgencia","fld":"vCONTAAGENCIA","hsh":true,"type":"svchar"},{"av":"AV45ContaNumero","fld":"vCONTANUMERO","hsh":true,"type":"svchar"},{"av":"AV46ResponsavelClienteRazaoSocial","fld":"vRESPONSAVELCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV47ResponsavelClienteDocumento","fld":"vRESPONSAVELCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV48ResponsavelContatoEmail","fld":"vRESPONSAVELCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV49ClienteRazaoSocial","fld":"vCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV50ClienteDocumento","fld":"vCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV51ContatoEmail","fld":"vCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV27ResumoDocumentosId","fld":"vRESUMODOCUMENTOSID","grid":138,"pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"GRIDDOCRES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_138","ctrl":"GRIDDOCRES","prop":"GridRC","grid":138,"type":"int"},{"av":"AV28ResumoDocumentosDescricao","fld":"vRESUMODOCUMENTOSDESCRICAO","grid":138,"hsh":true,"type":"svchar"},{"av":"AV29ResumoDocumentoObrigatorio","fld":"vRESUMODOCUMENTOOBRIGATORIO","grid":138,"hsh":true,"type":"boolean"},{"av":"AV30ResumoDocumento","fld":"vRESUMODOCUMENTO","grid":138,"type":"bitstr"},{"av":"AV31ResumoExtensao","fld":"vRESUMOEXTENSAO","grid":138,"hsh":true,"type":"svchar"},{"av":"AV75Nome","fld":"vNOME","grid":138,"hsh":true,"type":"svchar"},{"av":"AV76NomeArquivo","fld":"vNOMEARQUIVO","grid":138,"hsh":true,"type":"svchar"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV71ClinicaClienteId","fld":"vCLINICACLIENTEID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""}]}""");
         setEventMetadata("'WIZARDPREVIOUS'","""{"handler":"E126Z2","iparms":[{"av":"AV6WebSessionKey","fld":"vWEBSESSIONKEY","type":"svchar"},{"av":"AV34ProcedimentosMedicosId","fld":"vPROCEDIMENTOSMEDICOSID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV35PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","hsh":true,"type":"decimal"},{"av":"AV36PropostaDescricao","fld":"vPROPOSTADESCRICAO","hsh":true,"type":"svchar"},{"av":"AV37ConvenioId","fld":"vCONVENIOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV38ConvenioCategoriaId","fld":"vCONVENIOCATEGORIAID","pic":"ZZZZZZZZ9","type":"int"},{"av":"cmbavConveniovencimentoano"},{"av":"AV39ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV40ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavClientepixtipo"},{"av":"AV41ClientePixTipo","fld":"vCLIENTEPIXTIPO","hsh":true,"type":"svchar"},{"av":"AV42ClientePix","fld":"vCLIENTEPIX","hsh":true,"type":"svchar"},{"av":"AV43BancoId","fld":"vBANCOID","pic":"ZZZZZZZZ9","type":"int"},{"av":"AV44ContaAgencia","fld":"vCONTAAGENCIA","hsh":true,"type":"svchar"},{"av":"AV45ContaNumero","fld":"vCONTANUMERO","hsh":true,"type":"svchar"},{"av":"AV46ResponsavelClienteRazaoSocial","fld":"vRESPONSAVELCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV47ResponsavelClienteDocumento","fld":"vRESPONSAVELCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV48ResponsavelContatoEmail","fld":"vRESPONSAVELCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV49ClienteRazaoSocial","fld":"vCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV50ClienteDocumento","fld":"vCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV51ContatoEmail","fld":"vCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV27ResumoDocumentosId","fld":"vRESUMODOCUMENTOSID","grid":138,"pic":"ZZZZZZZZ9","hsh":true,"type":"int"},{"av":"GRIDDOCRES_nFirstRecordOnPage","type":"int"},{"av":"nRC_GXsfl_138","ctrl":"GRIDDOCRES","prop":"GridRC","grid":138,"type":"int"},{"av":"AV28ResumoDocumentosDescricao","fld":"vRESUMODOCUMENTOSDESCRICAO","grid":138,"hsh":true,"type":"svchar"},{"av":"AV29ResumoDocumentoObrigatorio","fld":"vRESUMODOCUMENTOOBRIGATORIO","grid":138,"hsh":true,"type":"boolean"},{"av":"AV30ResumoDocumento","fld":"vRESUMODOCUMENTO","grid":138,"type":"bitstr"},{"av":"AV31ResumoExtensao","fld":"vRESUMOEXTENSAO","grid":138,"hsh":true,"type":"svchar"},{"av":"AV75Nome","fld":"vNOME","grid":138,"hsh":true,"type":"svchar"},{"av":"AV76NomeArquivo","fld":"vNOMEARQUIVO","grid":138,"hsh":true,"type":"svchar"}]""");
         setEventMetadata("'WIZARDPREVIOUS'",""","oparms":[{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""}]}""");
         setEventMetadata("VADICIONARANEXO.CLICK","""{"handler":"E156Z2","iparms":[{"av":"AV30ResumoDocumento","fld":"vRESUMODOCUMENTO","type":"bitstr"},{"av":"AV76NomeArquivo","fld":"vNOMEARQUIVO","hsh":true,"type":"svchar"},{"av":"AV31ResumoExtensao","fld":"vRESUMOEXTENSAO","hsh":true,"type":"svchar"}]""");
         setEventMetadata("VADICIONARANEXO.CLICK",""","oparms":[{"av":"Novajanela_Target","ctrl":"NOVAJANELA","prop":"Target"}]}""");
         setEventMetadata("GRIDDOCRES_FIRSTPAGE","""{"handler":"subgriddocres_firstpage","iparms":[{"av":"GRIDDOCRES_nFirstRecordOnPage","type":"int"},{"av":"GRIDDOCRES_nEOF","type":"int"},{"av":"subGriddocres_Rows","ctrl":"GRIDDOCRES","prop":"Rows"},{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV35PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","hsh":true,"type":"decimal"},{"av":"AV36PropostaDescricao","fld":"vPROPOSTADESCRICAO","hsh":true,"type":"svchar"},{"av":"cmbavConveniovencimentoano"},{"av":"AV39ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV40ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavClientepixtipo"},{"av":"AV41ClientePixTipo","fld":"vCLIENTEPIXTIPO","hsh":true,"type":"svchar"},{"av":"AV42ClientePix","fld":"vCLIENTEPIX","hsh":true,"type":"svchar"},{"av":"AV44ContaAgencia","fld":"vCONTAAGENCIA","hsh":true,"type":"svchar"},{"av":"AV45ContaNumero","fld":"vCONTANUMERO","hsh":true,"type":"svchar"},{"av":"AV46ResponsavelClienteRazaoSocial","fld":"vRESPONSAVELCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV47ResponsavelClienteDocumento","fld":"vRESPONSAVELCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV48ResponsavelContatoEmail","fld":"vRESPONSAVELCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV49ClienteRazaoSocial","fld":"vCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV50ClienteDocumento","fld":"vCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV51ContatoEmail","fld":"vCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"sPrefix","type":"char"}]}""");
         setEventMetadata("GRIDDOCRES_PREVPAGE","""{"handler":"subgriddocres_previouspage","iparms":[{"av":"GRIDDOCRES_nFirstRecordOnPage","type":"int"},{"av":"GRIDDOCRES_nEOF","type":"int"},{"av":"subGriddocres_Rows","ctrl":"GRIDDOCRES","prop":"Rows"},{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV35PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","hsh":true,"type":"decimal"},{"av":"AV36PropostaDescricao","fld":"vPROPOSTADESCRICAO","hsh":true,"type":"svchar"},{"av":"cmbavConveniovencimentoano"},{"av":"AV39ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV40ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavClientepixtipo"},{"av":"AV41ClientePixTipo","fld":"vCLIENTEPIXTIPO","hsh":true,"type":"svchar"},{"av":"AV42ClientePix","fld":"vCLIENTEPIX","hsh":true,"type":"svchar"},{"av":"AV44ContaAgencia","fld":"vCONTAAGENCIA","hsh":true,"type":"svchar"},{"av":"AV45ContaNumero","fld":"vCONTANUMERO","hsh":true,"type":"svchar"},{"av":"AV46ResponsavelClienteRazaoSocial","fld":"vRESPONSAVELCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV47ResponsavelClienteDocumento","fld":"vRESPONSAVELCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV48ResponsavelContatoEmail","fld":"vRESPONSAVELCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV49ClienteRazaoSocial","fld":"vCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV50ClienteDocumento","fld":"vCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV51ContatoEmail","fld":"vCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"sPrefix","type":"char"}]}""");
         setEventMetadata("GRIDDOCRES_NEXTPAGE","""{"handler":"subgriddocres_nextpage","iparms":[{"av":"GRIDDOCRES_nFirstRecordOnPage","type":"int"},{"av":"GRIDDOCRES_nEOF","type":"int"},{"av":"subGriddocres_Rows","ctrl":"GRIDDOCRES","prop":"Rows"},{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV35PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","hsh":true,"type":"decimal"},{"av":"AV36PropostaDescricao","fld":"vPROPOSTADESCRICAO","hsh":true,"type":"svchar"},{"av":"cmbavConveniovencimentoano"},{"av":"AV39ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV40ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavClientepixtipo"},{"av":"AV41ClientePixTipo","fld":"vCLIENTEPIXTIPO","hsh":true,"type":"svchar"},{"av":"AV42ClientePix","fld":"vCLIENTEPIX","hsh":true,"type":"svchar"},{"av":"AV44ContaAgencia","fld":"vCONTAAGENCIA","hsh":true,"type":"svchar"},{"av":"AV45ContaNumero","fld":"vCONTANUMERO","hsh":true,"type":"svchar"},{"av":"AV46ResponsavelClienteRazaoSocial","fld":"vRESPONSAVELCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV47ResponsavelClienteDocumento","fld":"vRESPONSAVELCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV48ResponsavelContatoEmail","fld":"vRESPONSAVELCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV49ClienteRazaoSocial","fld":"vCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV50ClienteDocumento","fld":"vCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV51ContatoEmail","fld":"vCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"sPrefix","type":"char"}]}""");
         setEventMetadata("GRIDDOCRES_LASTPAGE","""{"handler":"subgriddocres_lastpage","iparms":[{"av":"GRIDDOCRES_nFirstRecordOnPage","type":"int"},{"av":"GRIDDOCRES_nEOF","type":"int"},{"av":"subGriddocres_Rows","ctrl":"GRIDDOCRES","prop":"Rows"},{"av":"AV11WizardData","fld":"vWIZARDDATA","type":""},{"av":"AV10HasValidationErrors","fld":"vHASVALIDATIONERRORS","hsh":true,"type":"boolean"},{"av":"AV35PropostaValor","fld":"vPROPOSTAVALOR","pic":"ZZZ,ZZZ,ZZZ,ZZ9.99","hsh":true,"type":"decimal"},{"av":"AV36PropostaDescricao","fld":"vPROPOSTADESCRICAO","hsh":true,"type":"svchar"},{"av":"cmbavConveniovencimentoano"},{"av":"AV39ConvenioVencimentoAno","fld":"vCONVENIOVENCIMENTOANO","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavConveniovencimentomes"},{"av":"AV40ConvenioVencimentoMes","fld":"vCONVENIOVENCIMENTOMES","pic":"ZZZ9","hsh":true,"type":"int"},{"av":"cmbavClientepixtipo"},{"av":"AV41ClientePixTipo","fld":"vCLIENTEPIXTIPO","hsh":true,"type":"svchar"},{"av":"AV42ClientePix","fld":"vCLIENTEPIX","hsh":true,"type":"svchar"},{"av":"AV44ContaAgencia","fld":"vCONTAAGENCIA","hsh":true,"type":"svchar"},{"av":"AV45ContaNumero","fld":"vCONTANUMERO","hsh":true,"type":"svchar"},{"av":"AV46ResponsavelClienteRazaoSocial","fld":"vRESPONSAVELCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV47ResponsavelClienteDocumento","fld":"vRESPONSAVELCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV48ResponsavelContatoEmail","fld":"vRESPONSAVELCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"AV49ClienteRazaoSocial","fld":"vCLIENTERAZAOSOCIAL","pic":"@!","hsh":true,"type":"svchar"},{"av":"AV50ClienteDocumento","fld":"vCLIENTEDOCUMENTO","hsh":true,"type":"svchar"},{"av":"AV51ContatoEmail","fld":"vCONTATOEMAIL","hsh":true,"type":"svchar"},{"av":"sPrefix","type":"char"},{"av":"subGriddocres_Recordcount","type":"int"}]}""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         hsh = "";
         Griddocres_empowerer_Gridinternalname = "";
         AV74Grid = new SdtWPropostaData_Documentos_GridDocItem(context);
         GriddocresRow = new GXWebRow();
         ...
         H006Z2_A331LimiteAprovacaoId = new int[1] ;
         H006Z2_A332LimiteAprovacaoValorMinimo = new decimal[1] ;
         H006Z2_n332LimiteAprovacaoValorMinimo = new bool[] {false} ;
         H006Z2_A334LimiteAprovacaoAprovacoes = new short[1] ;
         H006Z2_n334LimiteAprovacaoAprovacoes = new bool[] {false} ;
         AV58Proposta = new SdtProposta(context);
         H006Z3_A210SecUserClienteId = new short[1] ;
         H006Z3_n210SecUserClienteId = new bool[] {false} ;
         H006Z3_A226SecUserOwnerId = new int[1] ;
         H006Z3_n226SecUserOwnerId = new bool[] {false} ;
         H006Z3_A133SecUserId = new short[1] ;
         ...
         AV73GridDocResItem = new SdtWPropostaData_Resumo_GridDocResItem(context);
         H006Z4_A495ConvenioCategoriaStatus = new bool[] {false} ;
         H006Z4_n495ConvenioCategoriaStatus = new bool[] {false} ;
         H006Z4_A493ConvenioCategoriaId = new int[1] ;
         H006Z4_A494ConvenioCategoriaDescricao = new string[] {""} ;
         H006Z4_n494ConvenioCategoriaDescricao = new bool[] {false} ;
         A494ConvenioCategoriaDescricao = "";
         AV26Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         Combo_conveniocategoriaid_Selectedvalue_set = "";
         H006Z5_A412ConvenioStatus = new bool[] {false} ;
         H006Z5_A410ConvenioId = new int[1] ;
         H006Z5_A411ConvenioDescricao = new string[] {""} ;
         H006Z5_n411ConvenioDescricao = new bool[] {false} ;
         A411ConvenioDescricao = "";
         Combo_convenioid_Selectedvalue_set = "";
         H006Z6_A376ProcedimentosMedicosId = new int[1] ;
         H006Z6_A379ProcedimentosMedicosArea = new string[] {""} ;
         H006Z6_n379ProcedimentosMedicosArea = new bool[] {false} ;
         H006Z6_A377ProcedimentosMedicosNome = new string[] {""} ;
         H006Z6_n377ProcedimentosMedicosNome = new bool[] {false} ;
         ...
         H006Z7_A402BancoId = new int[1] ;
         H006Z7_A404BancoCodigo = new int[1] ;
         H006Z7_n404BancoCodigo = new bool[] {false} ;
         H006Z7_A403BancoNome = new string[] {""} ;
         H006Z7_n403BancoNome = new bool[] {false} ;
         A403BancoNome = "";
         ...
         sCtrlAV7GoingBack = "";
         subGriddocres_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         gxblobfileaux = new GxFile(context.GetPhysicalPath());
         GriddocresColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wpropostaresumo__default(),
            new Object[][] {
                new Object[] {
               H006Z2_A331LimiteAprovacaoId, H006Z2_A332LimiteAprovacaoValorMinimo, H006Z2_n332LimiteAprovacaoValorMinimo, H006Z2_A334LimiteAprovacaoAprovacoes, H006Z2_n334LimiteAprovacaoAprovacoes
               }
               , new Object[] {
               H006Z3_A210SecUserClienteId, H006Z3_n210SecUserClienteId, H006Z3_A226SecUserOwnerId, H006Z3_n226SecUserOwnerId, H006Z3_A133SecUserId
               }
               , new Object[] {
               H006Z4_A495ConvenioCategoriaStatus, H006Z4_n495ConvenioCategoriaStatus, H006Z4_A493ConvenioCategoriaId, H006Z4_A494ConvenioCategoriaDescricao, H006Z4_n494ConvenioCategoriaDescricao
               }
               , new Object[] {
               H006Z5_A412ConvenioStatus, H006Z5_A410ConvenioId, H006Z5_A411ConvenioDescricao, H006Z5_n411ConvenioDescricao
               }
               , new Object[] {
               H006Z6_A376ProcedimentosMedicosId, H006Z6_A379ProcedimentosMedicosArea, H006Z6_n379ProcedimentosMedicosArea, H006Z6_A377ProcedimentosMedicosNome, H006Z6_n377ProcedimentosMedicosNome
               }
               , new Object[] {
               H006Z7_A402BancoId, H006Z7_A404BancoCodigo, H006Z7_n404BancoCodigo, H006Z7_A403BancoNome, H006Z7_n403BancoNome
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short subGriddocres_Backcolorstyle ;
      private short AV57PropostaQuantidadeAprovadores ;
      private short AV72SecUserId ;
      private short AV60ContratoSLA ;
      private short gxcookieaux ;
      private short nGXWrapped ;
      private short subGriddocres_Backstyle ;
      private short subGriddocres_Titlebackstyle ;
      private short subGriddocres_Allowselection ;
      private short subGriddocres_Allowhovering ;
      private short subGriddocres_Allowcollapsing ;
      private short subGriddocres_Collapsed ;
      private int nRC_GXsfl_138 ;
      private int subGriddocres_Recordcount ;
      private int subGriddocres_Rows ;
      ...
      private int subGriddocres_Islastpage ;
      private int GRIDDOCRES_nGridOutOfScope ;
      private int AV78GXV1 ;
      private int AV71ClinicaClienteId ;
      ...
      private int idxLst ;
      private int subGriddocres_Backcolor ;
      private int subGriddocres_Allbackcolor ;
      private int subGriddocres_Titlebackcolor ;
      private int subGriddocres_Selectedindex ;
      private int subGriddocres_Selectioncolor ;
      private int subGriddocres_Hoveringcolor ;
      private long GRIDDOCRES_nFirstRecordOnPage ;
      private long GRIDDOCRES_nCurrentRecord ;
      ...
      private string subGriddocres_Internalname ;
      ...
      private string Griddocres_empowerer_Internalname ;
      ...
      private string Griddocres_empowerer_Gridinternalname ;
      ...
      private string subGriddocres_Class ;
      private string subGriddocres_Linesclass ;
      ...
      private string subGriddocres_Header ;
      ...
      private string AV75Nome ;
      private string AV76NomeArquivo ;
      ...
      private string AV77Arquivo ;
      private string AV30ResumoDocumento ;
      private IGxSession AV5WebSession ;
      private GxFile gxblobfileaux ;
      private GXProperties forbiddenHiddens ;
      private GXWebGrid GriddocresContainer ;
      private GXWebRow GriddocresRow ;
      private GXWebColumn GriddocresColumn ;
      ...
      private GXUserControl ucGriddocres_empowerer ;
      ...
      private SdtWPropostaData_Documentos_GridDocItem AV74Grid ;
      ...
      private int[] H006Z2_A331LimiteAprovacaoId ;
      private decimal[] H006Z2_A332LimiteAprovacaoValorMinimo ;
      private bool[] H006Z2_n332LimiteAprovacaoValorMinimo ;
      private short[] H006Z2_A334LimiteAprovacaoAprovacoes ;
      private bool[] H006Z2_n334LimiteAprovacaoAprovacoes ;
      private SdtProposta AV58Proposta ;
      private short[] H006Z3_A210SecUserClienteId ;
      private bool[] H006Z3_n210SecUserClienteId ;
      private int[] H006Z3_A226SecUserOwnerId ;
      private bool[] H006Z3_n226SecUserOwnerId ;
      private short[] H006Z3_A133SecUserId ;
      ...
      private SdtWPropostaData_Resumo_GridDocResItem AV73GridDocResItem ;
      private bool[] H006Z4_A495ConvenioCategoriaStatus ;
      private bool[] H006Z4_n495ConvenioCategoriaStatus ;
      private int[] H006Z4_A493ConvenioCategoriaId ;
      private string[] H006Z4_A494ConvenioCategoriaDescricao ;
      private bool[] H006Z4_n494ConvenioCategoriaDescricao ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV26Combo_DataItem ;
      private bool[] H006Z5_A412ConvenioStatus ;
      private int[] H006Z5_A410ConvenioId ;
      private string[] H006Z5_A411ConvenioDescricao ;
      private bool[] H006Z5_n411ConvenioDescricao ;
      private int[] H006Z6_A376ProcedimentosMedicosId ;
      private string[] H006Z6_A379ProcedimentosMedicosArea ;
      private bool[] H006Z6_n379ProcedimentosMedicosArea ;
      private string[] H006Z6_A377ProcedimentosMedicosNome ;
      private bool[] H006Z6_n377ProcedimentosMedicosNome ;
      private GxSimpleCollection<string> AV23ComboTitles ;
      private int[] H006Z7_A402BancoId ;
      private int[] H006Z7_A404BancoCodigo ;
      private bool[] H006Z7_n404BancoCodigo ;
      private string[] H006Z7_A403BancoNome ;
      private bool[] H006Z7_n403BancoNome ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class wpropostaresumo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV71ClinicaClienteId",GXType.Int32,9,0)
          };
          Object[] prmH006Z4;
          ...
          def= new CursorDef[] {
              new CursorDef("H006Z2", "SELECT LimiteAprovacaoId, LimiteAprovacaoValorMinimo, LimiteAprovacaoAprovacoes FROM LimiteAprovacao WHERE LimiteAprovacaoValorMinimo <= :AV35PropostaValor ORDER BY LimiteAprovacaoValorMinimo DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Z2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H006Z3", "SELECT SecUserClienteId, SecUserOwnerId, SecUserId FROM SecUser WHERE (SecUserOwnerId = :AV71ClinicaClienteId) AND (SecUserClienteId IS NULL or (SecUserClienteId = 0)) ORDER BY SecUserOwnerId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Z3,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006Z4", "SELECT ConvenioCategoriaStatus, ConvenioCategoriaId, ConvenioCategoriaDescricao FROM ConvenioCategoria WHERE ConvenioCategoriaStatus = TRUE ORDER BY ConvenioCategoriaDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Z4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006Z5", "SELECT ConvenioStatus, ConvenioId, ConvenioDescricao FROM Convenio WHERE ConvenioStatus = TRUE ORDER BY ConvenioDescricao ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Z5,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006Z6", "SELECT ProcedimentosMedicosId, ProcedimentosMedicosArea, ProcedimentosMedicosNome FROM ProcedimentosMedicos ORDER BY ProcedimentosMedicosNome ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Z6,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H006Z7", "SELECT BancoId, BancoCodigo, BancoNome FROM Banco ORDER BY BancoNome ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006Z7,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
