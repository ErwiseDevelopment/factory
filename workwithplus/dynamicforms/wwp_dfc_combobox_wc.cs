   ...
   public class wwp_dfc_combobox_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_combobox_wc"+UrlEncode(StringUtil.RTrim(AV11WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV14WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV9SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_combobox_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB200( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_combobox_wc");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            wb_table1_20_202( true) ;
         }
         else
         {
            wb_table1_20_202( false) ;
         }
         return  ;
      }

      protected void wb_table1_20_202e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_33_202( true) ;
         }
         else
         {
            wb_table2_33_202( false) ;
         }
         return  ;
      }

      protected void wb_table2_33_202e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_38_202( true) ;
         }
         else
         {
            wb_table3_38_202( false) ;
         }
         return  ;
      }

      protected void wb_table3_38_202e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_combobox_wc")), "workwithplus.dynamicforms.wwp_dfc_combobox_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_combobox_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void S112( )
      {
         ...
         AV26GXV1 = 1;
         while ( AV26GXV1 <= AV10WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Options.Count )
         {
            AV18WWP_DF_CharMetadata_Option = ((string)AV10WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Options.Item(AV26GXV1));
      ...
      protected void wb_table3_38_202( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_38_202e( true) ;
         }
         else
         {
            wb_table3_38_202e( false) ;
         }
      }

      protected void wb_table2_33_202( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_33_202e( true) ;
         }
         else
         {
            wb_table2_33_202e( false) ;
         }
      }

      protected void wb_table1_20_202( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_20_202e( true) ;
         }
         else
         {
            wb_table1_20_202e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918384258", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_combobox_wc.js", "?202551918384258", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV7IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true,"type":"boolean"},{"av":"AV8IsLastElement","fld":"vISLASTELEMENT","hsh":true,"type":"boolean"},{"av":"AV24ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV20WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"}]""");
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E16202","iparms":[{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E17202","iparms":[{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E11202","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE",""","oparms":[{"av":"AV12WWPForm","fld":"vWWPFORM","type":""},{"av":"AV13WWPFormElement","fld":"vWWPFORMELEMENT","type":""}]}""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13202","iparms":[{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12202","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV19NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"AV13WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV24ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV20WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"},{"av":"AV21WWP_DF_CharControlType","fld":"vWWP_DF_CHARCONTROLTYPE","pic":"ZZZ9","type":"int"},{"av":"AV22AllowMultipleSelection","fld":"vALLOWMULTIPLESELECTION","type":"boolean"},{"av":"AV23WWP_DynamicForms_Char_MultipleOptions_ControlType","fld":"vWWP_DYNAMICFORMS_CHAR_MULTIPLEOPTIONS_CONTROLTYPE","pic":"9","type":"int"},{"av":"AV10WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","type":""},{"av":"AV15Data_Data","fld":"vDATA_DATA","type":""}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV12WWPForm","fld":"vWWPFORM","type":""},{"av":"AV13WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV19NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"AV10WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA","type":""},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"lblTextblockcombo_data_Caption","ctrl":"TEXTBLOCKCOMBO_DATA","prop":"Caption"},{"av":"AV21WWP_DF_CharControlType","fld":"vWWP_DF_CHARCONTROLTYPE","pic":"ZZZ9","type":"int"},{"av":"AV23WWP_DynamicForms_Char_MultipleOptions_ControlType","fld":"vWWP_DYNAMICFORMS_CHAR_MULTIPLEOPTIONS_CONTROLTYPE","pic":"9","type":"int"},{"av":"AV22AllowMultipleSelection","fld":"vALLOWMULTIPLESELECTION","type":"boolean"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"},{"av":"AV15Data_Data","fld":"vDATA_DATA","type":""},{"av":"Combo_data_Selectedvalue_set","ctrl":"COMBO_DATA","prop":"SelectedValue_set"},{"av":"Combo_data_Allowmultipleselection","ctrl":"COMBO_DATA","prop":"AllowMultipleSelection"},{"av":"Combo_data_Includeonlyselectedoption","ctrl":"COMBO_DATA","prop":"IncludeOnlySelectedOption"},{"av":"Combo_data_Emptyitemtext","ctrl":"COMBO_DATA","prop":"EmptyItemText"}]}""");
         return  ;
      }
