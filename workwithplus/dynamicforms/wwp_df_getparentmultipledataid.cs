...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_getparentmultipledataid : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV14WWPFormElementIdAux = AV12WWPFormElementId;
         ...
         if ( AV8CurrentElement.gxTpr_Wwpformelementtype != 3 )
         {
            ...
            {
               AV14WWPFormElementIdAux = AV8CurrentElement.gxTpr_Wwpformelementparentid;
               /* Execute user subroutine: 'GETELEMENTBYID' */
               S111 ();
               if ( returnInSub )
               {
      ...
      protected void S111( )
      {
         ...
         returnInSub = false;
         AV15GXV1 = 1;
         while ( AV15GXV1 <= AV11WWPForm.gxTpr_Element.Count )
         {
            AV13ElementAux = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV11WWPForm.gxTpr_Element.Item(AV15GXV1));
            if ( ( AV13ElementAux.gxTpr_Wwpformelementid == AV14WWPFormElementIdAux ) && ( AV13ElementAux.gxTpr_Wwpformelementparentid >= 0 ) )
            {
               AV8CurrentElement = AV13ElementAux;
               if (true) break;
            }
      ...
      public override void initialize( )
      {
         ...
         AV13ElementAux = new GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element(context);
         /* GeneXus formulas. */
      }

      private short AV12WWPFormElementId ;
      private short AV10ParentMultipleDataId ;
      private short AV14WWPFormElementIdAux ;
      ...
      private GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element AV13ElementAux ;
