...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="GxMap.Circle" , Namespace="Factory21" )]
	[Serializable]
	public class SdtGxMap_Circle : GxUserType
	{
		...
		public string gxTpr_Circlefillopacity_double
		{
			...
			set {
				gxTv_SdtGxMap_Circle_Circlefillopacity = NumberUtil.Val(value);
			}
		}
		[XmlIgnore]
		...
		public string gxTpr_Circlestrokeopacity_double
		{
			...
			set {
				gxTv_SdtGxMap_Circle_Circlestrokeopacity = NumberUtil.Val(value);
			}
		}
		[XmlIgnore]
	...
	[DataContract(Name=@"GxMap.Circle", Namespace="Factory21")]
	public class SdtGxMap_Circle_RESTInterface : GxGenericCollectionItem<SdtGxMap_Circle>, System.Web.SessionState.IRequiresSessionState
	{
		...
		[JsonPropertyName("CircleFillOpacity")]
		[JsonPropertyOrder(4)]
		...
		[JsonPropertyName("CircleStrokeOpacity")]
		[JsonPropertyOrder(6)]
		...
		[JsonPropertyName("CirclestrokeWeight")]
		[JsonPropertyOrder(7)]
