...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_dynamicform : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dynamicform"+UrlEncode(StringUtil.RTrim(AV14WWPFormReferenceName)) + "," + UrlEncode(StringUtil.LTrimStr(AV9WWPFormInstanceId,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV8WWPDynamicFormMode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dynamicform") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "WWPFORMISWIZARD", A120WWPFormIsWizard);
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dynamicform"+UrlEncode(StringUtil.RTrim(AV14WWPFormReferenceName)) + "," + UrlEncode(StringUtil.LTrimStr(AV9WWPFormInstanceId,6,0)) + "," + UrlEncode(StringUtil.RTrim(AV8WWPDynamicFormMode));
         return formatLink("workwithplus.dynamicforms.wwp_dynamicform") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB110( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "Confirmar", bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, bttBtnenter_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WorkWithPlus/DynamicForms/WWP_DynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "Fechar", bttBtncancel_Jsonclick, 1, "Fechar", "", StyleString, ClassString, bttBtncancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WorkWithPlus/DynamicForms/WWP_DynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuaresume_Internalname, "", "Resume", bttBtnuaresume_Jsonclick, 7, "Resume", "", StyleString, ClassString, bttBtnuaresume_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11111_client"+"'", TempTags, "", 2, "HLP_WorkWithPlus/DynamicForms/WWP_DynamicForm.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_29_112( true) ;
         }
         else
         {
            wb_table1_29_112( false) ;
         }
         return  ;
      }

      protected void wb_table1_29_112e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void PA112( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dynamicform")), "workwithplus.dynamicforms.wwp_dynamicform") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dynamicform")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E13112( )
      {
         ...
         if ( StringUtil.StrCmp(AV10HttpRequest.Method, "GET") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(AV8WWPDynamicFormMode, "INS") == 0 )
            {
               ...
               {
                  BRK113 = false;
                  A95WWPFormVersionNumber = H00112_A95WWPFormVersionNumber[0];
                  A94WWPFormId = H00112_A94WWPFormId[0];
                  A96WWPFormReferenceName = H00112_A96WWPFormReferenceName[0];
                  A104WWPFormResume = H00112_A104WWPFormResume[0];
                  A123WWPFormResumeMessage = H00112_A123WWPFormResumeMessage[0];
                  if ( StringUtil.StrCmp(A96WWPFormReferenceName, AV14WWPFormReferenceName) == 0 )
                  {
                     AV7WWPFormInstance.gxTpr_Wwpformid = A94WWPFormId;
                     AV7WWPFormInstance.gxTpr_Wwpformversionnumber = A95WWPFormVersionNumber;
                     AV15WWPFormResume = A104WWPFormResume;
                     AssignAttri("", false, "AV15WWPFormResume", StringUtil.Str( (decimal)(AV15WWPFormResume), 1, 0));
                     AV18WWPFormResumeMessage = A123WWPFormResumeMessage;
                     AssignAttri("", false, "AV18WWPFormResumeMessage", AV18WWPFormResumeMessage);
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                  }
                  while ( (pr_default.getStatus(0) != 101) && ( H00112_A94WWPFormId[0] == A94WWPFormId ) )
                  {
                     BRK113 = false;
                     A95WWPFormVersionNumber = H00112_A95WWPFormVersionNumber[0];
                     A96WWPFormReferenceName = H00112_A96WWPFormReferenceName[0];
      ...
      protected void E12112( )
      {
         ...
         if ( StringUtil.StrCmp(Dvelop_confirmpanel_uaresume_Result, "No") == 0 )
         {
            ...
            {
               A96WWPFormReferenceName = H00113_A96WWPFormReferenceName[0];
               A94WWPFormId = H00113_A94WWPFormId[0];
               A95WWPFormVersionNumber = H00113_A95WWPFormVersionNumber[0];
               AV7WWPFormInstance.gxTpr_Wwpformid = A94WWPFormId;
               AV7WWPFormInstance.gxTpr_Wwpformversionnumber = A95WWPFormVersionNumber;
               /* Exit For each command. Update data (if necessary), close cursors & exit. */
               if (true) break;
            ...
            if ( ! AV11WWPFormIsWizard )
            {
               if ( StringUtil.StrCmp(AV8WWPDynamicFormMode, "DSP") != 0 )
               {
                  ...
                  if ( AV20HasErrors )
                  {
                     ...
                     {
                        AV27GXV1 = 1;
                        while ( AV27GXV1 <= AV21Messages.Count )
                        {
                           AV19Message = ((GeneXus.Utils.SdtMessages_Message)AV21Messages.Item(AV27GXV1));
      ...
      protected void S112( )
      {
         ...
         if ( ! AV7WWPFormInstance.Success() )
         {
            GX_msglist.addItem(StringUtil.Format( "Erro carregando uma nova forma de forma (%1)", ((GeneXus.Utils.SdtMessages_Message)AV7WWPFormInstance.GetMessages().Item(1)).gxTpr_Description, "", "", "", "", "", "", "", ""));
         }
      ...
      protected void S122( )
      {
         ...
         {
            A95WWPFormVersionNumber = H00114_A95WWPFormVersionNumber[0];
            A94WWPFormId = H00114_A94WWPFormId[0];
            A120WWPFormIsWizard = H00114_A120WWPFormIsWizard[0];
            A97WWPFormTitle = H00114_A97WWPFormTitle[0];
            AV11WWPFormIsWizard = A120WWPFormIsWizard;
            AssignAttri("", false, "AV11WWPFormIsWizard", AV11WWPFormIsWizard);
            Form.Caption = A97WWPFormTitle;
      ...
      protected void wb_table1_29_112( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_29_112e( true) ;
         }
         else
         {
            wb_table1_29_112e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918525795", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dynamicform.js", "?202551918525797", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/ConfirmPanel/BootstrapConfirmPanelRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV14WWPFormReferenceName","fld":"vWWPFORMREFERENCENAME","hsh":true,"type":"svchar"},{"av":"AV8WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","hsh":true,"type":"char"},{"av":"AV9WWPFormInstanceId","fld":"vWWPFORMINSTANCEID","pic":"ZZZZZ9","hsh":true,"type":"int"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"ctrl":"BTNUARESUME","prop":"Visible"}]}""");
         setEventMetadata("'DOUARESUME'","""{"handler":"E11111","iparms":[]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_UARESUME.CLOSE","""{"handler":"E12112","iparms":[{"av":"Dvelop_confirmpanel_uaresume_Result","ctrl":"DVELOP_CONFIRMPANEL_UARESUME","prop":"Result"},{"av":"AV5SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"A95WWPFormVersionNumber","fld":"WWPFORMVERSIONNUMBER","pic":"ZZZ9","type":"int"},{"av":"A96WWPFormReferenceName","fld":"WWPFORMREFERENCENAME","type":"svchar"},{"av":"AV14WWPFormReferenceName","fld":"vWWPFORMREFERENCENAME","hsh":true,"type":"svchar"},{"av":"A94WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"A120WWPFormIsWizard","fld":"WWPFORMISWIZARD","type":"boolean"},{"av":"A97WWPFormTitle","fld":"WWPFORMTITLE","type":"svchar"},{"av":"AV8WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","hsh":true,"type":"char"},{"av":"AV22DefaultStep","fld":"vDEFAULTSTEP","type":"svchar"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_UARESUME.CLOSE",""","oparms":[{"av":"AV5SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV22DefaultStep","fld":"vDEFAULTSTEP","type":"svchar"},{"av":"AV11WWPFormIsWizard","fld":"vWWPFORMISWIZARD","type":"boolean"},{"ctrl":"FORM","prop":"Caption"},{"av":"divTablemain_Class","ctrl":"TABLEMAIN","prop":"Class"},{"ctrl":"WCWWP_DYNAMICFORMFS_WC"},{"ctrl":"BTNENTER","prop":"Visible"},{"ctrl":"BTNCANCEL","prop":"Visible"}]}""");
         setEventMetadata("ENTER","""{"handler":"E15112","iparms":[{"av":"AV23ExecuteEnterEvent","fld":"vEXECUTEENTEREVENT","type":"boolean"},{"av":"AV11WWPFormIsWizard","fld":"vWWPFORMISWIZARD","type":"boolean"},{"av":"AV8WWPDynamicFormMode","fld":"vWWPDYNAMICFORMMODE","hsh":true,"type":"char"},{"av":"AV5SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV7WWPFormInstance","fld":"vWWPFORMINSTANCE","type":""},{"av":"AV23ExecuteEnterEvent","fld":"vEXECUTEENTEREVENT","type":"boolean"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H00112_A95WWPFormVersionNumber = new short[1] ;
         H00112_A94WWPFormId = new short[1] ;
         H00112_A96WWPFormReferenceName = new string[] {""} ;
         H00112_A104WWPFormResume = new short[1] ;
         H00112_A123WWPFormResumeMessage = new string[] {""} ;
         ...
         H00113_A96WWPFormReferenceName = new string[] {""} ;
         H00113_A94WWPFormId = new short[1] ;
         H00113_A95WWPFormVersionNumber = new short[1] ;
         ...
         H00114_A95WWPFormVersionNumber = new short[1] ;
         H00114_A94WWPFormId = new short[1] ;
         H00114_A120WWPFormIsWizard = new bool[] {false} ;
         H00114_A97WWPFormTitle = new string[] {""} ;
         sStyleString = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_dynamicform__default(),
            new Object[][] {
                new Object[] {
               H00112_A95WWPFormVersionNumber, H00112_A94WWPFormId, H00112_A96WWPFormReferenceName, H00112_A104WWPFormResume, H00112_A123WWPFormResumeMessage
               }
               , new Object[] {
               H00113_A96WWPFormReferenceName, H00113_A94WWPFormId, H00113_A95WWPFormVersionNumber
               }
               , new Object[] {
               H00114_A95WWPFormVersionNumber, H00114_A94WWPFormId, H00114_A120WWPFormIsWizard, H00114_A97WWPFormTitle
               }
            }
         );
      ...
      private short[] H00112_A95WWPFormVersionNumber ;
      private short[] H00112_A94WWPFormId ;
      private string[] H00112_A96WWPFormReferenceName ;
      private short[] H00112_A104WWPFormResume ;
      private string[] H00112_A123WWPFormResumeMessage ;
      private string[] H00113_A96WWPFormReferenceName ;
      private short[] H00113_A94WWPFormId ;
      private short[] H00113_A95WWPFormVersionNumber ;
      ...
      private short[] H00114_A95WWPFormVersionNumber ;
      private short[] H00114_A94WWPFormId ;
      private bool[] H00114_A120WWPFormIsWizard ;
      private string[] H00114_A97WWPFormTitle ;
   ...
   public class wwp_dynamicform__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00112", "SELECT WWPFormVersionNumber, WWPFormId, WWPFormReferenceName, WWPFormResume, WWPFormResumeMessage FROM WWP_Form ORDER BY WWPFormId DESC, WWPFormVersionNumber DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00112,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00113", "SELECT WWPFormReferenceName, WWPFormId, WWPFormVersionNumber FROM WWP_Form WHERE WWPFormReferenceName = ( :AV14WWPFormReferenceName) ORDER BY WWPFormReferenceName, WWPFormVersionNumber DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00113,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H00114", "SELECT WWPFormVersionNumber, WWPFormId, WWPFormIsWizard, WWPFormTitle FROM WWP_Form WHERE WWPFormId = :AV7WWPFormInstance__Wwpformid and WWPFormVersionNumber = :AV7WWPFo_1Wwpformversionnumbe ORDER BY WWPFormId, WWPFormVersionNumber ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00114,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
