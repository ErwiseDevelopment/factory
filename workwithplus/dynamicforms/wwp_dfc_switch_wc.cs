   ...
   public class wwp_dfc_switch_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_switch_wc"+UrlEncode(StringUtil.RTrim(AV10WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV9WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV8SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_switch_wc") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB1V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_switch_wc");
               context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
               context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            wb_table1_17_1V2( true) ;
         }
         else
         {
            wb_table1_17_1V2( false) ;
         }
         return  ;
      }

      protected void wb_table1_17_1V2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table2_26_1V2( true) ;
         }
         else
         {
            wb_table2_26_1V2( false) ;
         }
         return  ;
      }

      protected void wb_table2_26_1V2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_39_1V2( true) ;
         }
         else
         {
            wb_table3_39_1V2( false) ;
         }
         return  ;
      }

      protected void wb_table3_39_1V2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_44_1V2( true) ;
         }
         else
         {
            wb_table4_44_1V2( false) ;
         }
         return  ;
      }

      protected void wb_table4_44_1V2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_switch_wc")), "workwithplus.dynamicforms.wwp_dfc_switch_wc") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_switch_wc")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void wb_table4_44_1V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table4_44_1V2e( true) ;
         }
         else
         {
            wb_table4_44_1V2e( false) ;
         }
      }

      protected void wb_table3_39_1V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_39_1V2e( true) ;
         }
         else
         {
            wb_table3_39_1V2e( false) ;
         }
      }

      protected void wb_table2_26_1V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_26_1V2e( true) ;
         }
         else
         {
            wb_table2_26_1V2e( false) ;
         }
      }

      protected void wb_table1_17_1V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_17_1V2e( true) ;
         }
         else
         {
            wb_table1_17_1V2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202551918384656", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_switch_wc.js", "?202551918384657", false, true);
         context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
         context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E161V2","iparms":[{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E171V2","iparms":[{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E111V2","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"}]""");
         ...
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E131V2","iparms":[{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E121V2","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9","type":"int"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9","type":"int"},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"AV7WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV17ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true,"type":"boolean"},{"av":"AV16WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true,"type":"int"}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV6WWPForm","fld":"vWWPFORM","type":""},{"av":"AV7WWPFormElement","fld":"vWWPFORMELEMENT","type":""},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC","type":"boolean"},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"AV5Data","fld":"vDATA","type":"boolean"},{"av":"lblTextblockdata_Caption","ctrl":"TEXTBLOCKDATA","prop":"Caption"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"}]}""");
         return  ;
      }
