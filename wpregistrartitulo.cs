...
namespace GeneXus.Programs {
   public class wpregistrartitulo : GXDataArea
   {
      ...
      protected void S252( )
      {
         ...
         returnInSub = false;
         AV146SelectedRows = new GXBaseCollection<SdtWPRegistrarTituloSDT_WPRegistrarTituloSDTItem>( context, "WPRegistrarTituloSDTItem", "Factory2");
         AV149TituloIdCol.FromJSonString(AV150TituloIdJson, null);
         AV191GXV2 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025519190663", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpregistrartitulo.js", "?2025519190664", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
