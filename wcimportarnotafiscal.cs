...
namespace GeneXus.Programs {
   public class wcimportarnotafiscal : GXWebComponent
   {
      ...
      protected void S112( )
      {
         /* 'LERXMLS' Routine */
         returnInSub = false;
         AV14Array_SdNotaFiscal = new GXBaseCollection<SdtSdNotaFiscal>( context, "SdNotaFiscal", "Factory2");
         AV20GXV2 = 1;
         ...
         AV15Array_SdProdutoNotaFiscal = new GXBaseCollection<SdtSdProdutoNotaFiscal>( context, "SdProdutoNotaFiscal", "Factory2");
         AV21GXV3 = 1;
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV8UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV9FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Factory2");
         AV14Array_SdNotaFiscal = new GXBaseCollection<SdtSdNotaFiscal>( context, "SdNotaFiscal", "Factory2");
         GX_FocusControl = "";
         ClassString = "";
         StyleString = "";
