...
namespace GeneXus.Programs.wwpbaseobjects {
   public class menuoptionsdataseguranca : GXProcedure
   {
      public menuoptionsdataseguranca( )
      {
      ...
      public menuoptionsdataseguranca( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         Gxm1dvelop_menu.gxTpr_Link = formatLink("seguranca") ;
         Gxm1dvelop_menu.gxTpr_Linktarget = "";
         Gxm1dvelop_menu.gxTpr_Caption = "Início";
         Gxm1dvelop_menu.gxTpr_Authorizationkey = "inicio_seguranca";
         Gxm1dvelop_menu = new GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item(context);
         Gxm2rootcol.Add(Gxm1dvelop_menu, 0);
         AV5id = (short)(AV5id+1);
         Gxm1dvelop_menu.gxTpr_Id = StringUtil.Str( (decimal)(AV5id), 4, 0);
         Gxm1dvelop_menu.gxTpr_Tooltip = "";
         Gxm1dvelop_menu.gxTpr_Link = formatLink("secuserww") ;
         Gxm1dvelop_menu.gxTpr_Iconclass = "fas fa-user";
         Gxm1dvelop_menu.gxTpr_Caption = "Usuário";
         Gxm1dvelop_menu.gxTpr_Authorizationkey = "usuario";
         Gxm1dvelop_menu = new GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item(context);
         Gxm2rootcol.Add(Gxm1dvelop_menu, 0);
         AV5id = (short)(AV5id+1);
         Gxm1dvelop_menu.gxTpr_Id = StringUtil.Str( (decimal)(AV5id), 4, 0);
         ...
         Gxm1dvelop_menu.gxTpr_Caption = "Perfil";
         Gxm1dvelop_menu.gxTpr_Authorizationkey = "perfil";
         Gxm1dvelop_menu = new GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item(context);
         Gxm2rootcol.Add(Gxm1dvelop_menu, 0);
         AV5id = (short)(AV5id+1);
         Gxm1dvelop_menu.gxTpr_Id = StringUtil.Str( (decimal)(AV5id), 4, 0);
         ...
         Gxm1dvelop_menu.gxTpr_Id = StringUtil.Str( (decimal)(AV5id), 4, 0);
         Gxm1dvelop_menu.gxTpr_Tooltip = "";
         Gxm1dvelop_menu.gxTpr_Link = formatLink("webserviceww") ;
         Gxm1dvelop_menu.gxTpr_Iconclass = "fas fa-network-wired";
         Gxm1dvelop_menu.gxTpr_Caption = "Configurações de API";
