...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_userextended : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_label_element( context, edtWWPUserExtendedId_Internalname, "Extended Id", "col-sm-3 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 34,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtWWPUserExtendedId_Internalname, StringUtil.RTrim( A7WWPUserExtendedId), StringUtil.RTrim( context.localUtil.Format( A7WWPUserExtendedId, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPUserExtendedId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPUserExtendedId_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPBaseObjects/WWP_UserExtended.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPUserExtendedDeletedIn_Internalname, context.localUtil.TToC( A18WWPUserExtendedDeletedIn, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A18WWPUserExtendedDeletedIn, "99/99/99 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'por',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',5,24,'por',false,0);"+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPUserExtendedDeletedIn_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPUserExtendedDeletedIn_Enabled, 0, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WWPBaseObjects/WWP_UserExtended.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPUserExtendedDeletedIn_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A18WWPUserExtendedDeletedIn", context.localUtil.TToC( A18WWPUserExtendedDeletedIn, 8, 5, 0, 3, "/", ":", " "));
            }
            else
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.wwp_userextended") +"\">") ;
      ...
      {
         return formatLink("wwpbaseobjects.wwp_userextended")  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202561019122322", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/wwp_userextended.js", "?202561019122323", false, true);
      ...
      public void Valid_Wwpuserextendedid( )
      {
         ...
         AssignAttri("", false, "A14WWPUserExtendedDesktopNotif", A14WWPUserExtendedDesktopNotif);
         AssignAttri("", false, "A17WWPUserExtendedDeleted", A17WWPUserExtendedDeleted);
         AssignAttri("", false, "A18WWPUserExtendedDeletedIn", context.localUtil.TToC( A18WWPUserExtendedDeletedIn, 10, 8, 0, 3, "/", ":", " "));
         ...
         GxWebStd.gx_hidden_field( context, "Z18WWPUserExtendedDeletedIn", context.localUtil.TToC( Z18WWPUserExtendedDeletedIn, 10, 8, 0, 3, "/", ":", " "));
         AssignProp("", false, bttBtn_delete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtn_delete_Enabled), 5, 0), true);
         AssignProp("", false, bttBtn_enter_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(bttBtn_enter_Enabled), 5, 0), true);
         SendCloseFormHiddens( ) ;
      }
      ...
      {
         setEventMetadata("ENTER","""{"handler":"UserMainFullajax","iparms":[{"postForm":true},{"av":"A12WWPUserExtendedSMSNotif","fld":"WWPUSEREXTENDEDSMSNOTIF","type":"boolean"},{"av":"A13WWPUserExtendedMobileNotif","fld":"WWPUSEREXTENDEDMOBILENOTIF","type":"boolean"},{"av":"A14WWPUserExtendedDesktopNotif","fld":"WWPUSEREXTENDEDDESKTOPNOTIF","type":"boolean"},{"av":"A17WWPUserExtendedDeleted","fld":"WWPUSEREXTENDEDDELETED","type":"boolean"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"A12WWPUserExtendedSMSNotif","fld":"WWPUSEREXTENDEDSMSNOTIF","type":"boolean"},{"av":"A13WWPUserExtendedMobileNotif","fld":"WWPUSEREXTENDEDMOBILENOTIF","type":"boolean"},{"av":"A14WWPUserExtendedDesktopNotif","fld":"WWPUSEREXTENDEDDESKTOPNOTIF","type":"boolean"},{"av":"A17WWPUserExtendedDeleted","fld":"WWPUSEREXTENDEDDELETED","type":"boolean"}]}""");
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A12WWPUserExtendedSMSNotif","fld":"WWPUSEREXTENDEDSMSNOTIF","type":"boolean"},{"av":"A13WWPUserExtendedMobileNotif","fld":"WWPUSEREXTENDEDMOBILENOTIF","type":"boolean"},{"av":"A14WWPUserExtendedDesktopNotif","fld":"WWPUSEREXTENDEDDESKTOPNOTIF","type":"boolean"},{"av":"A17WWPUserExtendedDeleted","fld":"WWPUSEREXTENDEDDELETED","type":"boolean"}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"A12WWPUserExtendedSMSNotif","fld":"WWPUSEREXTENDEDSMSNOTIF","type":"boolean"},{"av":"A13WWPUserExtendedMobileNotif","fld":"WWPUSEREXTENDEDMOBILENOTIF","type":"boolean"},{"av":"A14WWPUserExtendedDesktopNotif","fld":"WWPUSEREXTENDEDDESKTOPNOTIF","type":"boolean"},{"av":"A17WWPUserExtendedDeleted","fld":"WWPUSEREXTENDEDDELETED","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPUSEREXTENDEDID","""{"handler":"Valid_Wwpuserextendedid","iparms":[{"av":"A7WWPUserExtendedId","fld":"WWPUSEREXTENDEDID","type":"char"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"A12WWPUserExtendedSMSNotif","fld":"WWPUSEREXTENDEDSMSNOTIF","type":"boolean"},{"av":"A13WWPUserExtendedMobileNotif","fld":"WWPUSEREXTENDEDMOBILENOTIF","type":"boolean"},{"av":"A14WWPUserExtendedDesktopNotif","fld":"WWPUSEREXTENDEDDESKTOPNOTIF","type":"boolean"},{"av":"A17WWPUserExtendedDeleted","fld":"WWPUSEREXTENDEDDELETED","type":"boolean"}]""");
         setEventMetadata("VALID_WWPUSEREXTENDEDID",""","oparms":[{"av":"A10WWPUserExtendedPhoto","fld":"WWPUSEREXTENDEDPHOTO","type":"bits"},{"av":"A40000WWPUserExtendedPhoto_GXI","fld":"WWPUSEREXTENDEDPHOTO_GXI","type":"svchar"},{"av":"A16WWPUserExtendedName","fld":"WWPUSEREXTENDEDNAME","type":"svchar"},{"av":"A8WWPUserExtendedFullName","fld":"WWPUSEREXTENDEDFULLNAME","type":"svchar"},{"av":"A15WWPUserExtendedPhone","fld":"WWPUSEREXTENDEDPHONE","type":"char"},{"av":"A9WWPUserExtendedEmail","fld":"WWPUSEREXTENDEDEMAIL","type":"svchar"},{"av":"A11WWPUserExtendedEmaiNotif","fld":"WWPUSEREXTENDEDEMAINOTIF","type":"boolean"},{"av":"A18WWPUserExtendedDeletedIn","fld":"WWPUSEREXTENDEDDELETEDIN","pic":"99/99/99 99:99","type":"dtime"},{"av":"Gx_mode","fld":"vMODE","pic":"@!","type":"char"},{"av":"Z7WWPUserExtendedId","type":"char"},{"av":"Z10WWPUserExtendedPhoto","type":"bits"},{"av":"Z40000WWPUserExtendedPhoto_GXI","type":"svchar"},{"av":"Z16WWPUserExtendedName","type":"svchar"},{"av":"Z8WWPUserExtendedFullName","type":"svchar"},{"av":"Z15WWPUserExtendedPhone","type":"char"},{"av":"Z9WWPUserExtendedEmail","type":"svchar"},{"av":"Z11WWPUserExtendedEmaiNotif","type":"boolean"},{"av":"Z12WWPUserExtendedSMSNotif","type":"boolean"},{"av":"Z13WWPUserExtendedMobileNotif","type":"boolean"},{"av":"Z14WWPUserExtendedDesktopNotif","type":"boolean"},{"av":"Z17WWPUserExtendedDeleted","type":"boolean"},{"av":"Z18WWPUserExtendedDeletedIn","type":"dtime"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"},{"av":"A12WWPUserExtendedSMSNotif","fld":"WWPUSEREXTENDEDSMSNOTIF","type":"boolean"},{"av":"A13WWPUserExtendedMobileNotif","fld":"WWPUSEREXTENDEDMOBILENOTIF","type":"boolean"},{"av":"A14WWPUserExtendedDesktopNotif","fld":"WWPUSEREXTENDEDDESKTOPNOTIF","type":"boolean"},{"av":"A17WWPUserExtendedDeleted","fld":"WWPUSEREXTENDEDDELETED","type":"boolean"}]}""");
         setEventMetadata("VALID_WWPUSEREXTENDEDEMAIL","""{"handler":"Valid_Wwpuserextendedemail","iparms":[{"av":"A12WWPUserExtendedSMSNotif","fld":"WWPUSEREXTENDEDSMSNOTIF","type":"boolean"},{"av":"A13WWPUserExtendedMobileNotif","fld":"WWPUSEREXTENDEDMOBILENOTIF","type":"boolean"},{"av":"A14WWPUserExtendedDesktopNotif","fld":"WWPUSEREXTENDEDDESKTOPNOTIF","type":"boolean"},{"av":"A17WWPUserExtendedDeleted","fld":"WWPUSEREXTENDEDDELETED","type":"boolean"}]""");
         setEventMetadata("VALID_WWPUSEREXTENDEDEMAIL",""","oparms":[{"av":"A12WWPUserExtendedSMSNotif","fld":"WWPUSEREXTENDEDSMSNOTIF","type":"boolean"},{"av":"A13WWPUserExtendedMobileNotif","fld":"WWPUSEREXTENDEDMOBILENOTIF","type":"boolean"},{"av":"A14WWPUserExtendedDesktopNotif","fld":"WWPUSEREXTENDEDDESKTOPNOTIF","type":"boolean"},{"av":"A17WWPUserExtendedDeleted","fld":"WWPUSEREXTENDEDDELETED","type":"boolean"}]}""");
         return  ;
      }
