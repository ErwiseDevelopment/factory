...
namespace GeneXus.Programs {
   public class clientenotas_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      public void ScanKeyStart2R28( )
      {
         ...
         {
            RcdFound28 = 1;
            A168ClienteId = BC002R33_A168ClienteId[0];
            n168ClienteId = BC002R33_n168ClienteId[0];
            A886ClienteCountNotas_F = BC002R33_A886ClienteCountNotas_F[0];
            n886ClienteCountNotas_F = BC002R33_n886ClienteCountNotas_F[0];
         }
      ...
      public override void initialize( )
      {
         ...
         BC002R14_A323PropostaId = new int[1] ;
         BC002R15_A323PropostaId = new int[1] ;
         BC002R16_A323PropostaId = new int[1] ;
         BC002R17_A323PropostaId = new int[1] ;
         BC002R18_A227ContratoId = new int[1] ;
         BC002R19_A261TituloId = new int[1] ;
         BC002R20_A133SecUserId = new short[1] ;
         BC002R21_A978RepresentanteId = new int[1] ;
         BC002R22_A856CreditoId = new int[1] ;
         BC002R23_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         BC002R24_A794NotaFiscalId = new Guid[] {Guid.Empty} ;
         BC002R25_A662SerasaId = new int[1] ;
         BC002R26_A599ClienteDocumentoId = new int[1] ;
         BC002R27_A551ClienteReponsavelId = new int[1] ;
         BC002R28_A551ClienteReponsavelId = new int[1] ;
         BC002R29_A242AssinaturaParticipanteId = new int[1] ;
         BC002R30_A223FinanciamentoId = new int[1] ;
         BC002R31_A223FinanciamentoId = new int[1] ;
         BC002R33_A168ClienteId = new int[1] ;
         BC002R33_n168ClienteId = new bool[] {false} ;
         BC002R33_A886ClienteCountNotas_F = new short[1] ;
         BC002R33_n886ClienteCountNotas_F = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientenotas_bc__default(),
            new Object[][] {
               ...
               , new Object[] {
               BC002R18_A227ContratoId
               }
               , new Object[] {
               BC002R19_A261TituloId
               }
               , new Object[] {
               BC002R20_A133SecUserId
               }
               , new Object[] {
               BC002R21_A978RepresentanteId
               }
               , new Object[] {
               BC002R22_A856CreditoId
               }
               , new Object[] {
               BC002R23_A794NotaFiscalId
               }
               , new Object[] {
               BC002R24_A794NotaFiscalId
               }
               , new Object[] {
               BC002R25_A662SerasaId
               }
               , new Object[] {
               BC002R26_A599ClienteDocumentoId
               }
               , new Object[] {
               BC002R27_A551ClienteReponsavelId
               }
               , new Object[] {
               BC002R28_A551ClienteReponsavelId
               }
               , new Object[] {
               BC002R29_A242AssinaturaParticipanteId
               }
               , new Object[] {
               BC002R30_A223FinanciamentoId
               }
               , new Object[] {
               BC002R31_A223FinanciamentoId
               }
               , new Object[] {
               BC002R33_A168ClienteId, BC002R33_A886ClienteCountNotas_F, BC002R33_n886ClienteCountNotas_F
               }
            }
         );
         INITTRN();
      ...
      private int[] BC002R14_A323PropostaId ;
      private int[] BC002R15_A323PropostaId ;
      private int[] BC002R16_A323PropostaId ;
      private int[] BC002R17_A323PropostaId ;
      private int[] BC002R18_A227ContratoId ;
      private int[] BC002R19_A261TituloId ;
      private short[] BC002R20_A133SecUserId ;
      private int[] BC002R21_A978RepresentanteId ;
      private int[] BC002R22_A856CreditoId ;
      private Guid[] BC002R23_A794NotaFiscalId ;
      private Guid[] BC002R24_A794NotaFiscalId ;
      private int[] BC002R25_A662SerasaId ;
      private int[] BC002R26_A599ClienteDocumentoId ;
      private int[] BC002R27_A551ClienteReponsavelId ;
      private int[] BC002R28_A551ClienteReponsavelId ;
      private int[] BC002R29_A242AssinaturaParticipanteId ;
      private int[] BC002R30_A223FinanciamentoId ;
      private int[] BC002R31_A223FinanciamentoId ;
      private int[] BC002R33_A168ClienteId ;
      private bool[] BC002R33_n168ClienteId ;
      private short[] BC002R33_A886ClienteCountNotas_F ;
      private bool[] BC002R33_n886ClienteCountNotas_F ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("BC002R14", "SELECT PropostaId FROM Proposta WHERE PropostaEmpresaClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R14,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R15", "SELECT PropostaId FROM Proposta WHERE PropostaClinicaId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R15,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R16", "SELECT PropostaId FROM Proposta WHERE PropostaResponsavelId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R16,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R17", "SELECT PropostaId FROM Proposta WHERE PropostaPacienteClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R17,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R18", "SELECT ContratoId FROM Contrato WHERE ContratoClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R18,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R19", "SELECT TituloId FROM Titulo WHERE TituloClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R19,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R20", "SELECT SecUserId FROM SecUser WHERE SecUserOwnerId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R20,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R21", "SELECT RepresentanteId FROM Representante WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R21,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R22", "SELECT CreditoId FROM Credito WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R22,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R23", "SELECT NotaFiscalId FROM NotaFiscal WHERE NotaFiscalDestinatarioClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R23,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R24", "SELECT NotaFiscalId FROM NotaFiscal WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R24,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R25", "SELECT SerasaId FROM Serasa WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R25,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R26", "SELECT ClienteDocumentoId FROM ClienteDocumento WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R26,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R27", "SELECT ClienteReponsavelId FROM ClienteReponsavel WHERE ReponsavelClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R27,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R28", "SELECT ClienteReponsavelId FROM ClienteReponsavel WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R28,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R29", "SELECT AssinaturaParticipanteId FROM AssinaturaParticipante WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R29,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R30", "SELECT FinanciamentoId FROM Financiamento WHERE IntermediadorClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R30,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R31", "SELECT FinanciamentoId FROM Financiamento WHERE ClienteId = :ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R31,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("BC002R33", "SELECT TM1.ClienteId, COALESCE( T2.ClienteCountNotas_F, 0) AS ClienteCountNotas_F FROM (Cliente TM1 LEFT JOIN LATERAL (SELECT COUNT(*) AS ClienteCountNotas_F, ClienteId FROM NotaFiscal WHERE TM1.ClienteId = ClienteId GROUP BY ClienteId ) T2 ON T2.ClienteId = TM1.ClienteId) WHERE TM1.ClienteId = :ClienteId ORDER BY TM1.ClienteId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC002R33,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
