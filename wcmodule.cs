...
namespace GeneXus.Programs {
   public class wcmodule : GXWebComponent
   {
      ...
      protected void S122( )
      {
         ...
         AV12DVelop_Menu = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item>( context, "Item", "Factory2");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255289141783", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wcmodule.js", "?20255289141783", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV13InDVelop_Menu = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item>( context, "Item", "Factory2");
         sStyleString = "";
         lblLabel_Jsonclick = "";
